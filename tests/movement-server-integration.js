...
async function run() {
    ...
    try {
        ...
        reportStages(first.client, "MOVEMENT_ACTION", firstStart.state.sessionId, 8);
        first.client.send({ type: "MOVEMENT_ACTION", action: "SUBMIT", sessionId: firstStart.state.sessionId });
        ...
        reportStages(second.client, "MOVEMENT_ACTION", secondStart.state.sessionId, 10);
        second.client.send({ type: "MOVEMENT_ACTION", action: "SUBMIT", sessionId: secondStart.state.sessionId });
