...
async function run() {
    ...
    try {
        ...
        reportStages(first.client, "IMMUNE_ACTION", firstStart.state.sessionId, 8);
        first.client.send({ type: "IMMUNE_ACTION", action: "SUBMIT", sessionId: firstStart.state.sessionId });
        ...
        reportStages(second.client, "IMMUNE_ACTION", secondStart.state.sessionId, 10);
        second.client.send({ type: "IMMUNE_ACTION", action: "SUBMIT", sessionId: secondStart.state.sessionId });
