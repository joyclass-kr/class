...
const images = [
    path.join(dir, "assets", "images", "nervous-hero-v2.webp"),
...
for (const asset of ["nervous-hero-v2.webp", "nervous-sensory.webp", "nervous-response.webp", "signal-explorer.webp"]) {
