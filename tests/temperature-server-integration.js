...
async function run() {
    ...
    try {
        ...
        reportStages(first.client, "TEMPERATURE_ACTION", firstStart.state.sessionId, 8);
        first.client.send({ type: "TEMPERATURE_ACTION", action: "SUBMIT", sessionId: firstStart.state.sessionId });
        ...
        reportStages(second.client, "TEMPERATURE_ACTION", secondStart.state.sessionId, 10);
        second.client.send({ type: "TEMPERATURE_ACTION", action: "SUBMIT", sessionId: secondStart.state.sessionId });
