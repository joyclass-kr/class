...
async function run() {
    ...
    try {
        ...
        reportStages(first.client, "EXCRETION_ACTION", firstStart.state.sessionId, 8);
        first.client.send({ type: "EXCRETION_ACTION", action: "SUBMIT", sessionId: firstStart.state.sessionId });
        ...
        reportStages(second.client, "EXCRETION_ACTION", secondStart.state.sessionId, 10);
        second.client.send({ type: "EXCRETION_ACTION", action: "SUBMIT", sessionId: secondStart.state.sessionId });
