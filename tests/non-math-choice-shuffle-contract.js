...
const checks = [
  ...
  ['한국 문화유산', 'learning/academics/korean-museum/treasure-map.js', /const randomizedOptions = quiz\.options\.map/],
  ...
  ['태양계', 'learning/academics/space/solar-system/app.js', /var shuffled = qObj\.opts\.slice\(\)\.sort/],
