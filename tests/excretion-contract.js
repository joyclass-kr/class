...
const images = ["excretion-hero-v2.webp", "excretion-kidney.webp", "excretion-path.webp", "excretion-explorer.webp"]
...
for (const asset of ["excretion-hero-v2.webp", "excretion-kidney.webp", "excretion-path.webp", "excretion-explorer.webp"]) {
...
for (const episodeFile of ["index.html", "digestion.html", "respiration.html", "nervous.html", "immune.html", "movement.html"]) {
    assert.match(fs.readFileSync(path.join(dir, episodeFile), "utf8"), /href="excretion(?:\.html)?"/, `${episodeFile} must offer episode 07.`);
}
