...
async function run() {
    ...
    try {
        ...
        reportStages(first.client, "DIGESTION_ACTION", firstStart.state.sessionId, 7);
        first.client.send({ type: "DIGESTION_ACTION", action: "SUBMIT", sessionId: firstStart.state.sessionId });
        ...
        reportStages(second.client, "DIGESTION_ACTION", secondStart.state.sessionId, 10);
        second.client.send({ type: "DIGESTION_ACTION", action: "SUBMIT", sessionId: secondStart.state.sessionId });
