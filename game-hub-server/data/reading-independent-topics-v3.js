...
// Short-form, language-native topics. These deliberately have no translated
// twin: Korean and English practice should not become a memory test after a
// learner switches tracks.
module.exports = [
  {
    key: "KO-MEDIA-EVIDENCE",
    tracks: ["ko"],
    ko: "정보의 근거 판단",
    facts: [
    ...
    wrong: [
      ...
      "그래프에 정확한 숫자가 표시되면 축의 범위보다 표시된 값의 차이가 해석에 더 중요하다.",
    ...
    applications: [
      ...
      "막대그래프의 차이가 커 보일 때 세로축이 어디에서 시작하는지 확인한다.",
      "식품에 관한 조언을 한 전문가가 영양학을 연구하는지 확인한다.",
      "초기 조사 결과를 공유하면서 표본이 작아 결론이 바뀔 수 있다고 덧붙인다."
    ]
  },
  {
    key: "KO-RULES-EXCEPTIONS",
    tracks: ["ko"],
    ko: "규칙과 예외의 판단",
    facts: [
    ...
    applications: [
      ...
      "대피 상황에서 출입 금지문의 문구보다 사람을 안전하게 보호하려는 목적을 먼저 고려한다.",
      "과제 기한의 예외를 요청하면서 비슷한 상황에도 적용할 수 있는 조건을 제시한다.",
      "사진 촬영의 자유와 다른 사람의 사생활이 충돌할 때 양쪽에 미칠 영향을 비교한다.",
      "같은 시간 안에 계단을 오르게 하는 조건이 이동이 불편한 사람에게 공정한지 검토한다.",
      "교실 소음을 줄이는 규칙을 만들며 발표 활동이 어려워질 가능성도 함께 살핀다.",
      "다른 학교의 성공한 규칙을 도입하기 전에 학생 수와 공간 조건이 같은지 확인한다.",
      "학급 투표 결과와 선택 근거, 다시 논의할 수 있는 시점을 함께 알린다."
    ]
  },
  {
    key: "EN-ATTENTION-NOTIFICATIONS",
    tracks: ["en"],
    ...
    wrong: [
      ...
      "A short notification leaves a task's flow intact because reading it requires little time.",
      "Returning to an earlier thought is immediate once the distracting message disappears.",
      "Frequent device checks show that each notification contains useful information.",
      "Turning off low-priority alerts also delays access to important messages.",
      "A planned checking time protects focus by assigning the same urgency to each message.",
      "Complex reasoning is easier to resume because it contains more clues than a simple routine.",
      "Managing attention is best achieved by avoiding digital tools during serious work."
    ],
    applications: [
      ...
      "A learner protects a proof from interruptions more carefully than a familiar copying task.",
      "A designer chooses a quiet work period and then uses online tools at a scheduled time."
    ]
  },
  {
    key: "EN-URBAN-TREES",
    ...
    wrong: [
      ...
      "A tree canopy cools a street mainly by reflecting heat after pavement becomes warm.",
      "Water released by leaves warms nearby air when the water changes into vapor.",
    ...
    applications: [
      ...
      "A planting plan considers root space and long-term care before choosing fast-growing trees.",
      "A school combines trees with drinking water and covered outdoor waiting areas."
    ]
  }
];
