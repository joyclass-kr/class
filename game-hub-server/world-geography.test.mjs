...
assert.match(html, /id="themeLayerControls"/);
assert.match(html, /id="themeItemCard"[\s\S]*?id="speakThemeItem"/);
assert.match(html, /theme-items\.js\?v=20260903-3[\s\S]*?app\.js\?v=20260903-3/);
...
assert.match(app, /activeThemeCategories = new Set\(\["animal", "landmark"\]\)/);
...
assert.match(styles, /\.theme-layer-control/);
assert.match(styles, /\.theme-item-card/);
