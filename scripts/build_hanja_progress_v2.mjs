...
</style></head><body><main class="page"><header class="topbar"><h1>한자 진도표</h1><a class="back" href="../">기존 진도표</a></header><div class="section-head"><h2>전체 차시</h2><span class="count">${lessons.length}차시 · ${learned.size}자</span></div><section class="stages" aria-label="단계별 진도">${stageHtml}</section></main></body></html>`;
