    ...
    const lessons = [
        {
            ...
            activity: ["휴대기기 부품에 맡기기", "동작 카드를 가장 직접 담당하는 부품 칸으로 드래그하거나, 카드와 칸을 차례로 선택하세요.", [["soc", "SoC", "System on a Chip"], ["ram", "RAM", "Random Access Memory"], ["storage", "플래시 저장 장치", "Flash Storage"], ["sensor", "센서·통신", "Sensors and Radios"], ["battery", "배터리", "Battery"], ["display", "터치 화면", "Touch Display"]], [["b02i1", "앱의 명령을 계산한다", "Compute App Instructions", "soc"], ["b02i2", "실행 중인 화면 데이터를 잠시 둔다", "Hold Active Screen Data", "ram"], ["b02i3", "꺼져도 남을 사진 파일을 기록한다", "Keep a Photo File", "storage"], ["b02i4", "기울어진 방향을 감지한다", "Detect Device Tilt", "sensor"], ["b02i5", "Wi-Fi 신호를 주고받는다", "Send and Receive Wi-Fi", "sensor"], ["b02i6", "부품에 전력을 공급한다", "Supply Electrical Power", "battery"], ["b02i7", "터치 위치를 입력받고 픽셀을 보여 준다", "Read Touch and Show Pixels", "display"]], "RAM과 저장 장치, 배터리와 터치 화면의 서로 다른 역할까지 나누어 연결했습니다."],
            questions: [
