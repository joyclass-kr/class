(function () {
  ...
  const questions = [
    ...
    },
    {
      ...
      stimulus: {
        type: "table", title: "두 지역의 월평균 기온(가상 자료)",
    ...
    },
    {
      ...
      options: ["전라남도와 경상남도의 경계를 이루는 구간이 있다.", "충청북도와 강원특별자치도의 경계를 이룬다.", "서울과 인천의 경계를 따라 서해로 흐른다.", "제주특별자치도를 동서로 나눈다.", "북한과 중국의 국경을 이룬다."],
      answer: 0,
      explanation: "섬진강 하류의 일부 구간은 전라남도와 경상남도의 자연 경계가 됩니다. 큰 하천이나 산지의 능선은 이동과 생활권을 나누기 쉬워 행정 경계로 활용되곤 합니다.",
      focus: { theme: "terrain", lat: 35.17, lng: 127.72, zoom: 9, label: "구례에서 하동으로 이어지는 섬진강 하류와 도 경계를 비교하세요." }
    },
    {
      id: "climate-07", topic: "climate", difficulty: "basic",
      prompt: "초여름 장마 전선의 일반적인 이동을 가장 잘 설명한 것은?",
      options: ["남쪽에서 북쪽으로 이동하며 영향을 준다.", "북쪽에서 남쪽으로만 이동한다.", "동해에서 황해로만 이동한다.", "한라산 정상에만 머문다.", "겨울 내내 같은 위치에 정체한다."],
      answer: 0,
      explanation: "초여름에는 북태평양 고기압의 세력이 커지면서 장마 전선이 제주와 남부 지방에서 중부 지방 쪽으로 북상합니다. 해마다 시기와 강수 분포에는 차이가 있습니다.",
      focus: { theme: "climate", lat: 35.50, lng: 127.60, zoom: 6, label: "제주·남부에서 중부로 이어지는 남북 방향을 확인하세요." }
    },
    {
      id: "climate-08", topic: "climate", difficulty: "basic",
      prompt: "같은 위도에서 대관령이 동해안 도시보다 여름 기온이 낮은 주된 이유는?",
      options: ["해발 고도가 높기 때문이다.", "조차가 크기 때문이다.", "도시 인구가 더 많기 때문이다.", "용암 대지이기 때문이다.", "난류의 영향을 더 크게 받기 때문이다."],
      answer: 0,
      explanation: "대관령은 주변 해안 도시보다 해발 고도가 높습니다. 대체로 고도가 높아질수록 기온이 낮아지므로 여름에도 비교적 서늘한 기후가 나타납니다.",
      focus: { theme: "climate", lat: 37.68, lng: 128.72, zoom: 10, label: "대관령과 강릉의 거리보다 고도 차이에 주목하세요." }
    },
    {
      ...
      answer: 0,
      explanation: "콘크리트와 아스팔트는 낮에 받은 열을 저장했다가 밤에 방출하고, 인공열과 건물 밀집은 열의 배출을 방해합니다. 그 결과 도심이 교외보다 따뜻한 도시 열섬이 나타납니다.",
      focus: { theme: "climate", lat: 37.57, lng: 126.98, zoom: 11, label: "서울 도심과 주변 교외의 토지 피복을 비교하세요." }
    },
    {
      id: "climate-10", topic: "climate", difficulty: "advanced",
      prompt: "습윤한 공기가 산맥을 넘을 때 바람받이 사면과 바람그늘 사면에서 나타나는 변화를 바르게 연결한 것은?",
      options: ["바람받이－상승·냉각·강수 / 바람그늘－하강·가열·건조", "바람받이－하강·가열 / 바람그늘－상승·냉각", "양쪽 사면 모두 기온과 습도가 변하지 않음", "바람받이－건조 / 바람그늘－강수 증가", "양쪽 사면 모두 해수면 상승"],
      answer: 0,
      explanation: "공기는 산지의 바람받이 사면에서 상승하며 냉각되어 구름과 비를 만들기 쉽습니다. 반대편에서는 하강하며 기온이 오르고 상대 습도가 낮아져 건조해질 수 있습니다.",
      focus: { theme: "climate", lat: 37.55, lng: 128.75, zoom: 9, label: "태백산맥의 동서 사면에서 공기의 상승과 하강을 비교하세요." }
    },
    {
      id: "population-06", topic: "population", difficulty: "basic",
      prompt: "출생아 수가 오랫동안 줄고 평균 수명이 늘어날 때 나타날 가능성이 가장 큰 변화는?",
      options: ["고령 인구 비율 상승", "유소년 인구 비율의 급상승", "모든 지역의 인구 증가", "통근 이동의 완전한 소멸", "1차 산업 종사자의 자동 증가"],
      answer: 0,
      explanation: "저출산이 지속되면 유소년 인구가 줄고 평균 수명이 늘면서 고령 인구의 비중이 커집니다. 생산연령인구 감소와 지역별 돌봄·의료 수요 변화도 함께 살펴야 합니다.",
      focus: { theme: "population", lat: 36.35, lng: 127.90, zoom: 6, label: "전국적으로 나타나는 인구 구조 변화입니다." }
    },
    {
      id: "population-07", topic: "population", difficulty: "basic",
      prompt: "수도권 주변 도시에서 서울로 출근하는 사람이 많은 현상을 가장 잘 설명하는 것은?",
      options: ["대도시권의 통근권 확대", "농촌의 자급자족 강화", "국제 인구 이동의 중단", "산지 촌락의 고립", "어업 인구의 집중"],
      answer: 0,
      explanation: "광역 철도와 도로가 발달하고 주거지가 외곽으로 확산되면 생활권이 행정 경계를 넘어 연결됩니다. 서울과 주변 도시 사이의 통근은 대도시권 확대를 보여 줍니다.",
      focus: { theme: "population", lat: 37.48, lng: 127.15, zoom: 9, label: "서울과 인천·경기의 광역 교통망을 함께 보세요." }
    },
    {
      id: "population-08", topic: "population", difficulty: "basic",
      prompt: "외국인 근로자의 거주 비율이 비교적 높게 나타날 가능성이 큰 지역은?",
      options: ["제조업 공장이 모인 산업 단지 주변", "상주 인구가 없는 산 정상", "군사 분계선 내부", "접근이 금지된 무인도", "빙하가 발달한 고산 지대"],
      answer: 0,
      explanation: "제조업·농축산업 등에서 노동 수요가 큰 지역은 외국인 근로자의 유입이 비교적 많습니다. 산업 단지와 일자리의 분포가 인구의 공간 분포에 영향을 줍니다.",
      focus: { theme: "population", lat: 37.02, lng: 127.20, zoom: 9, label: "경기 남부와 충청 북부의 산업 도시를 살펴보세요." }
    },
    {
      id: "population-09", topic: "population", difficulty: "advanced",
      prompt: "다음 인구 구성 자료에서 추론하기 어려운 것은?",
      stimulus: {
        type: "bars", title: "가상 지역 A의 연령별 인구 비율",
        unit: "%", items: [
          { label: "0~14세", value: 10 },
          { label: "15~64세", value: 69 },
          { label: "65세 이상", value: 21 }
        ],
        note: "막대 길이는 각 연령층이 전체 인구에서 차지하는 비율을 나타냅니다."
      },
      options: ["최근 출생아 수가 많다.", "저출산이 지속되었다.", "고령화가 진행되고 있다.", "생산연령인구 감소 가능성이 있다.", "노인 부양 부담이 커질 수 있다."],
      answer: 0,
      explanation: "밑부분이 좁다는 것은 최근 출생 집단의 규모가 작다는 뜻입니다. 중·고령층 비중이 큰 구조는 저출산·고령화와 앞으로의 생산연령인구 감소 가능성을 보여 줍니다.",
      focus: { theme: "population", lat: 36.35, lng: 127.90, zoom: 6, label: "지도 위치보다 연령별 인구 구조를 해석하는 문제입니다." }
    },
    {
      id: "population-10", topic: "population", difficulty: "advanced",
      prompt: "다음 자료에서 이 지역의 총인구가 증가한 가장 직접적인 이유는?",
      stimulus: {
        type: "table", title: "가상 지역 A의 한 해 인구 변동",
        columns: ["지역", "출생", "사망", "전입", "전출"],
        rows: [["A", "800명", "1,200명", "5,000명", "3,800명"]]
      },
      options: ["전입자가 전출자보다 충분히 많았다.", "자연 증가가 매우 컸다.", "출생자가 사망자보다 많았다.", "인구 이동이 전혀 없었다.", "고령 인구가 모두 감소했다."],
      answer: 0,
      explanation: "출생자보다 사망자가 많으면 자연 감소 상태입니다. 그런데도 총인구가 늘었다면 전입 초과, 즉 사회적 증가가 자연 감소분보다 컸다고 해석할 수 있습니다.",
      focus: { theme: "population", lat: 36.48, lng: 127.29, zoom: 10, label: "세종처럼 전입의 영향을 크게 받는 성장 지역을 떠올리세요." }
    },
    {
      id: "industry-06", topic: "industry", difficulty: "basic",
      prompt: "부산·울산·창원·거제로 이어지는 지역에 공통적으로 발달한 산업 입지의 특징은?",
      options: ["항만을 활용하는 동남 임해 공업", "고산 지대의 유목", "내륙 석회암 지대의 관광업만 발달", "수도권 본사 기능만 집중", "갯벌을 이용한 천일제염만 발달"],
      answer: 0,
      explanation: "남동 해안은 큰 항만과 공업 단지를 바탕으로 조선·자동차·기계·석유 화학 등의 제조업이 발달했습니다. 원료 수입과 제품 수출에 해상 교통이 유리합니다.",
      focus: { theme: "industry", lat: 35.22, lng: 129.00, zoom: 8, label: "부산에서 울산·창원·거제로 이어지는 해안 공업축입니다." }
    },
    {
      id: "industry-07", topic: "industry", difficulty: "basic",
      prompt: "기업 본사·금융·정보 통신·전문 서비스업이 가장 집중된 권역은?",
      options: ["수도권", "제주권", "강원 산간권", "북부 고원권", "서남해 도서권"],
      answer: 0,
      explanation: "수도권에는 인구와 시장, 기업 본사, 대학과 전문 인력이 집중되어 생산자 서비스업과 정보 통신 산업이 발달했습니다. 중추 관리 기능의 집중과도 연결됩니다.",
      focus: { theme: "industry", lat: 37.55, lng: 127.00, zoom: 8, label: "서울을 중심으로 한 수도권의 중추 관리 기능을 확인하세요." }
    },
    {
      id: "industry-08", topic: "industry", difficulty: "advanced",
      prompt: "대도시 주변에서 채소·꽃·우유처럼 신선도가 중요한 상품 생산이 발달하는 주된 이유는?",
      options: ["큰 소비 시장과 가까워 빠르게 공급할 수 있어서", "철광석 산지와 가까워서", "항상 토지 가격이 가장 낮아서", "조차가 커서", "겨울 적설량이 가장 많아서"],
      answer: 0,
      explanation: "대도시 주변 농업은 큰 소비 시장과의 접근성을 활용합니다. 부패하기 쉽거나 신선도가 중요한 채소·화훼·낙농 제품은 운송 시간과 비용을 줄이는 것이 중요합니다.",
      focus: { theme: "industry", lat: 37.42, lng: 127.25, zoom: 9, label: "수도권 외곽의 시장 접근성과 농업 입지를 연결하세요." }
    },
    {
      ...
      stimulus: {
        ...
        columns: ["지역", "주요 재배 시기", "대표 조건"],
        rows: [["태백 고원", "여름", "높은 해발"], ["남부 평야", "겨울", "온실·비닐하우스"]]
      },
      options: ["전자는 서늘한 고도, 후자는 온난한 기후를 활용한다.", "둘 다 큰 조차만을 이용한다.", "전자는 갯벌, 후자는 석회 동굴을 이용한다.", "둘 다 원료 수입항과 가까워야 한다.", "전자는 겨울, 후자는 여름에만 재배한다."],
      answer: 0,
      explanation: "고랭지 농업은 높은 고도의 서늘한 여름을 이용해 평지와 출하시기를 달리합니다. 남부의 시설 농업은 비교적 온난한 겨울과 온실을 이용해 채소를 생산합니다.",
      focus: { theme: "industry", lat: 37.16, lng: 128.99, zoom: 9, label: "태백 고원과 남부 평야의 계절·고도 조건을 비교하세요." }
    },
    {
      id: "industry-10", topic: "industry", difficulty: "advanced",
      prompt: "대규모 화력 발전소와 원자력 발전소가 해안에 입지하는 공통 이유로 가장 적절한 것은?",
      options: ["많은 냉각수를 얻기 쉽다.", "모든 연료가 해안에서 생산된다.", "송전 시설이 필요 없어진다.", "인구가 가장 밀집하기 때문이다.", "조차만으로 전력을 생산하기 때문이다."],
      answer: 0,
      explanation: "대규모 발전소는 발전 과정에서 발생한 열을 식히기 위한 많은 냉각수가 필요해 해안 입지가 유리합니다. 화력은 수입 연료 운송에 항만을 이용하기도 합니다.",
      focus: { theme: "industry", lat: 36.45, lng: 129.42, zoom: 8, label: "동해안 발전소 입지와 바닷물 이용을 연결하세요." }
    },
    {
      id: "region-07", topic: "region", difficulty: "basic",
      prompt: "서울·인천·경기를 하나의 권역으로 묶을 수 있는 가장 중요한 이유는?",
      options: ["통근·통학과 산업·서비스 기능이 긴밀하게 연결되어서", "모두 같은 광역 자치 단체여서", "세 지역 모두 농업 인구만 거주해서", "태백산맥 동쪽에만 있어서", "제주 화산 지형이 이어져서"],
      answer: 0,
      explanation: "서울·인천·경기는 행정 구역은 다르지만 광역 교통망, 통근·통학, 주거와 일자리, 산업과 서비스 기능이 긴밀하게 연결된 수도권을 이룹니다.",
      focus: { theme: "region", lat: 37.50, lng: 126.95, zoom: 8, label: "행정 경계를 넘어 이어지는 수도권 생활권을 확인하세요." }
    },
    {
      id: "region-08", topic: "region", difficulty: "basic",
      prompt: "대동강과 청천강이 서해로 흐르고 평양이 중심 도시인 전통 지역은?",
      options: ["관서", "관북", "관동", "영남", "호남"],
      answer: 0,
      explanation: "관서는 평안도를 중심으로 한 한반도 서북부 지역을 가리킵니다. 대동강과 청천강이 서쪽으로 흐르며 평양이 대표적인 중심 도시입니다.",
      focus: { theme: "region", lat: 39.30, lng: 125.80, zoom: 7, label: "평양과 대동강·청천강이 있는 서북부를 확인하세요." }
    },
    {
      ...
      answer: 0,
      explanation: "관북은 함경도를 중심으로 한 한반도 동북부 지역을 가리킵니다. 함경산맥과 동해안, 두만강 유역의 지형을 함께 살펴보면 위치를 파악하기 쉽습니다.",
      focus: { theme: "region", lat: 41.00, lng: 129.10, zoom: 7, label: "함경도와 두만강이 있는 동북부를 확인하세요." }
    },
    {
      id: "region-10", topic: "region", difficulty: "advanced",
      prompt: "대관령을 사이에 둔 영동과 영서의 비교로 옳은 것은?",
      options: ["영동은 태백산맥 동쪽, 영서는 서쪽에 놓인다.", "영동은 대동강 유역, 영서는 압록강 유역이다.", "영동은 모두 수도권, 영서는 모두 제주권이다.", "영동에는 해안이 없고 영서에는 동해안이 있다.", "두 지역은 지형과 기후 차이가 전혀 없다."],
      answer: 0,
      explanation: "태백산맥 동쪽의 영동과 서쪽의 영서는 대관령 같은 고개로 연결됩니다. 산맥은 하천 유역과 교통을 나누고, 겨울 강수와 기온 같은 기후 차이에도 영향을 줍니다.",
      focus: { theme: "region", lat: 37.68, lng: 128.72, zoom: 9, label: "대관령을 중심으로 태백산맥의 동쪽과 서쪽을 비교하세요." }
    }
  ];
