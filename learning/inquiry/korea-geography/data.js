(function () {
  ...
  const questions = [
    ...
    },
    {
      ...
      prompt: "유소년층이 좁고 중·고령층이 넓은 항아리형 인구 피라미드에서 추론하기 어려운 것은?",
    ...
    },
    {
      ...
      prompt: "어느 지역의 한 해 출생자는 사망자보다 적지만 전체 인구는 증가했다. 가장 타당한 설명은?",
    ...
    },
    {
      ...
      prompt: "태백 고원의 여름철 채소 재배와 남부 평야의 겨울철 시설 채소 재배를 바르게 비교한 것은?",
