...
(function () {
    ...
    function setVisible(on) {
        ...
        else if (canvas && !document.querySelector('.eye-optics-layer:not([hidden]), .pupil-layer:not([hidden]), .reflex-layer:not([hidden]), .ear-layer:not([hidden]), .centers-layer:not([hidden]), .brain-layer:not([hidden])')) canvas.style.visibility = 'visible';
        if (on) placeLabels();
        toggleHud(on);
    }
