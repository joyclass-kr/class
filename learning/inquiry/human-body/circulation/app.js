...
(function () {
    ...
    var hotspots = {
        immune: [
            { x: 0.28, y: 0.65, r: 45, title: '백혈구 (Leukocyte) - 식균 작용', desc: '상처 부위로 침투한 세균을 세포 안으로 끌어들여 소화 분해(식균 작용)하여 체내를 방어합니다.' },
            { x: 0.68, y: 0.78, r: 40, title: '항체 (Antibody) - 항원-항체 반응', desc: 'Y자 모양의 단백질로, 특정 세균/바이러스(항원)에 결합하여 무력화하고 백혈구의 식균을 돕습니다.' },
            { x: 0.15, y: 0.82, r: 40, title: '적혈구 (Erythrocyte) - 헤모글로빈', desc: '도넛 모양의 핵이 없는 세포로, 헤모글로빈을 통해 산소를 온몸의 조직 세포로 운반합니다.' },
            { x: 0.82, y: 0.35, r: 40, title: '침투 세균 (Pathogen)', desc: '피부 상처를 통해 혈관으로 침투한 병원체로, 백혈구와 항체의 주요 표적이 됩니다.' }
        ],
        torso: [
