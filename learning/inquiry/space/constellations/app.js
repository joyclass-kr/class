...
// Mode 4: Diurnal vs Annual Motion Interactive JS Engine
        ...
        (function() {
            ...
            const quizData = [
                { cat: "일주 운동", q: "별과 별자리가 하루 동안 동쪽에서 서쪽으로 움직이는 것처럼 보이는 근본 원인은?", ans: 0, opts: ["지구의 자전", "지구의 공전", "별의 실제 공전", "달의 자전"], exp: "해설: 지구가 서쪽에서 동쪽으로 자전하므로 천체는 반대 방향인 동쪽에서 서쪽으로 움직이는 것처럼 보입니다." },
                { cat: "일주 운동", q: "남쪽 하늘의 별이 하루 동안 움직이는 일반적인 순서로 옳은 것은?", ans: 2, opts: ["서쪽에서 떠서 북쪽을 지나 동쪽으로 진다", "남쪽에서 떠서 천정을 지나 북쪽으로 진다", "동쪽에서 떠서 남쪽에서 남중하고 서쪽으로 진다", "북쪽에서 떠서 동쪽을 지나 남쪽으로 진다"], exp: "해설: 우리나라에서 남쪽 하늘의 별은 동쪽에서 떠서 남쪽 하늘에서 가장 높이 남중한 뒤 서쪽으로 집니다." },
                { cat: "일주 운동", q: "별의 일주 운동 각속도는 대략 얼마인가?", ans: 1, opts: ["1시간에 1°", "1시간에 15°", "1시간에 30°", "하루에 15°"], exp: "해설: 천구가 약 24시간에 360° 회전하는 것처럼 보이므로 1시간에는 약 15° 움직입니다." },
                ...
                { cat: "일주 운동", q: "지구의 자전 방향과 별의 겉보기 일주 운동 방향을 바르게 짝지은 것은?", ans: 0, opts: ["지구: 서→동, 별: 동→서", "지구: 동→서, 별: 동→서", "지구: 서→동, 별: 서→동", "둘 다 방향이 일정하지 않다"], exp: "해설: 관측자가 탄 지구가 서쪽에서 동쪽으로 자전하기 때문에 별은 반대로 이동하는 것처럼 보입니다." },
                { cat: "일주 운동", q: "시뮬레이션에서 월은 그대로 두고 ‘시각’만 3시간 뒤로 옮겼다. 가장 직접적으로 관찰할 수 있는 것은?", ans: 2, opts: ["계절 변화", "태양의 연주 운동", "별자리의 일주 운동", "지구 자전축의 세차 운동"], exp: "해설: 같은 날짜에서 시각을 바꾸면 지구 자전에 따른 별자리의 하루 중 위치 변화를 볼 수 있습니다." },
                { cat: "일주 운동", q: "오후 8시에 동쪽 하늘에서 보이던 별자리는 시간이 흐르면 대체로 어느 쪽으로 이동하는가?", ans: 1, opts: ["북쪽 지평선 아래", "남쪽 하늘을 거쳐 서쪽", "동쪽 지평선 아래", "북극성 쪽으로 직선 이동"], exp: "해설: 별자리는 동쪽에서 떠서 남쪽 하늘을 지나 서쪽으로 지는 일주 운동을 합니다." },
                { cat: "일주 운동", q: "재생 버튼으로 저녁부터 다음 날 새벽까지 한 번 관찰하는 활동의 주된 목적은?", ans: 3, opts: ["별의 탄생 과정 확인", "계절별 기온 비교", "지구의 공전 속도 측정", "밤사이 별자리의 위치 변화 확인"], exp: "해설: 하루 밤 동안의 재생은 지구 자전에 따른 별자리의 일주 운동을 관찰하기 위한 것입니다." },

                { cat: "북쪽 하늘", q: "우리나라에서 북쪽 하늘을 바라볼 때 별들은 북극성을 중심으로 어느 방향으로 도는 것처럼 보이는가?", ans: 1, opts: ["시계 방향", "시계 반대 방향", "동쪽으로 직선 이동", "위아래로 왕복"], exp: "해설: 북반구에서 북쪽 하늘을 보면 별들은 북극성 부근을 중심으로 시계 반대 방향으로 도는 것처럼 보입니다." },
                { cat: "북극성", q: "북극성이 밤새 거의 움직이지 않는 것처럼 보이는 까닭은?", ans: 2, opts: ["지구와 가장 가까운 별이어서", "지구와 함께 공전해서", "지구 자전축의 북쪽 연장선 가까이에 있어서", "실제로 움직이지 않는 별이어서"], exp: "해설: 북극성은 북천구의 북극 가까이에 있어 지구가 자전해도 하늘에서의 위치 변화가 매우 작습니다." },
                { cat: "북극성", q: "북반구에서 북극성의 고도는 무엇과 거의 같은가?", ans: 0, opts: ["관측지의 북위", "관측지의 경도", "현재 시각", "태양의 고도"], exp: "해설: 북반구에서 북극성의 고도는 관측지의 위도와 거의 같습니다." },
                { cat: "북극성", q: "북위 37.5° 부근에서 관측한 북극성의 고도로 가장 알맞은 것은?", ans: 2, opts: ["약 0°", "약 23.5°", "약 37.5°", "약 90°"], exp: "해설: 북극성의 고도는 관측지의 북위와 거의 같으므로 약 37.5°입니다." },
                ...
                { cat: "북극성", q: "북극점에서 북극성은 이론적으로 어디에 가까이 보이는가?", ans: 3, opts: ["동쪽 지평선", "남쪽 지평선", "고도 45°", "천정"], exp: "해설: 북위 90°인 북극점에서는 북극성의 고도가 약 90°이므로 천정 가까이에 보입니다." },
                { cat: "북극성", q: "남반구의 대부분 지역에서 북극성을 볼 수 없는 까닭은?", ans: 0, opts: ["북천구의 북극이 북쪽 지평선 아래에 있기 때문", "북극성이 낮에만 뜨기 때문", "남반구에는 별빛이 약하기 때문", "달이 항상 북극성을 가리기 때문"], exp: "해설: 남반구에서는 북천구의 북극 방향이 북쪽 지평선 아래에 있어 북극성을 볼 수 없습니다." },
                { cat: "북극성", q: "관측자가 적도에서 북쪽으로 이동할수록 북극성의 고도는 어떻게 변하는가?", ans: 2, opts: ["낮아진다", "항상 0°이다", "높아진다", "계절에 따라 반대로 변한다"], exp: "해설: 북쪽으로 갈수록 북위가 커지므로 북극성의 고도도 높아집니다." },
                { cat: "북극성 찾기", q: "큰곰자리의 북두칠성을 이용해 북극성을 찾을 때 사용하는 별은?", ans: 1, opts: ["국자 손잡이 끝의 두 별", "국자 그릇 바깥쪽의 두 별", "국자 가운데 한 별", "북두칠성의 모든 별을 이은 원"], exp: "해설: 북두칠성 국자 그릇 바깥쪽 두 별을 이은 방향으로 약 다섯 배 연장하면 북극성 부근을 찾을 수 있습니다." },
                { cat: "북극성 찾기", q: "북두칠성이 잘 보이지 않을 때 북극성을 찾는 또 다른 길잡이로 알맞은 것은?", ans: 3, opts: ["오리온자리의 허리띠", "황도", "남십자자리", "W 모양의 카시오페이아자리"], exp: "해설: 북쪽 하늘의 W 모양 카시오페이아자리도 북극성을 찾는 대표적인 길잡이입니다." },
                ...
                { cat: "연주 운동", q: "같은 시각에 관찰한 별자리의 연주 운동 크기로 가장 알맞은 것은?", ans: 0, opts: ["하루 약 1° 서쪽", "하루 약 15° 동쪽", "한 달 약 1° 서쪽", "한 달 약 180° 동쪽"], exp: "해설: 별자리는 같은 시각을 기준으로 하루 약 1°, 한 달 약 30°씩 서쪽으로 이동해 보입니다." },
                ...
                { cat: "연주 운동", q: "시뮬레이션에서 시각을 고정하고 ‘월’ 슬라이더만 바꿀 때 관찰하는 운동은?", ans: 2, opts: ["달의 자전", "별자리의 일주 운동", "별자리의 연주 운동", "지구 자전축의 세차 운동"], exp: "해설: 같은 시각에서 날짜나 월을 바꾸면 지구 공전에 따른 별자리의 계절별 위치 변화, 즉 연주 운동을 볼 수 있습니다." },
                ...
                { cat: "계절 별자리", q: "계절에 따라 한밤중에 보이는 별자리가 달라지는 까닭은?", ans: 1, opts: ["별들이 계절마다 생겼다 사라져서", "지구 공전으로 밤에 바라보는 우주 방향이 달라져서", "지구 자전축이 계절마다 뒤집혀서", "태양이 별자리를 밀어내서"], exp: "해설: 지구의 공전 위치가 달라지면 태양 반대편인 한밤중 하늘의 방향도 달라집니다." },
                ...
                { cat: "계절 별자리", q: "어떤 별자리가 현재 태양과 같은 방향에 있다. 이 별자리를 관측하기 어려운 가장 큰 까닭은?", ans: 3, opts: ["별자리가 지평선 아래에만 있어서", "별자리가 지구 뒤에 있어서", "별자리가 사라져서", "낮의 밝은 하늘에 가려지기 때문"], exp: "해설: 태양과 같은 방향의 별자리는 낮하늘에 있으므로 태양빛 때문에 관측하기 어렵습니다." },
                { cat: "계절 별자리", q: "현재 태양과 같은 방향이라 보이지 않는 별자리는 대략 언제 한밤중에 잘 보이게 되는가?", ans: 1, opts: ["약 1주 뒤", "약 6개월 뒤", "약 24시간 뒤", "약 10년 뒤"], exp: "해설: 약 6개월 뒤에는 지구가 궤도의 반대편에 와서 그 별자리가 태양 반대 방향의 밤하늘에 놓입니다." },
                ...
                { cat: "일주·연주 비교", q: "오늘보다 별자리가 약 4분 일찍 같은 위치에 오는 현상과 가장 관련 깊은 것은?", ans: 2, opts: ["달의 위상 변화", "지구 자전축의 기울기", "지구 공전에 따른 별의 연주 운동", "별의 온도 변화"], exp: "해설: 지구가 하루 동안 공전한 만큼 더 자전해야 태양 기준 하루가 되므로 별은 매일 약 4분 일찍 같은 위치에 옵니다." },
                { cat: "일주·연주 비교", q: "시뮬레이션에서 ‘시각’과 ‘월’ 슬라이더의 역할을 바르게 설명한 것은?", ans: 3, opts: ["둘 다 별의 밝기만 바꾼다", "시각은 연주 운동, 월은 일주 운동", "둘 다 일주 운동만 보여 준다", "시각은 일주 운동, 월은 연주 운동"], exp: "해설: 시각을 바꾸면 하루 중 위치 변화를, 월을 바꾸면 같은 시각에서 계절별 위치 변화를 확인할 수 있습니다." },

                { cat: "황도 12궁", q: "황도란 천구에서 무엇의 겉보기 연간 이동 경로인가?", ans: 1, opts: ["달", "태양", "북극성", "천구의 북극"], exp: "해설: 황도는 지구의 공전 때문에 태양이 1년에 걸쳐 천구 위를 이동하는 것처럼 보이는 길입니다." },
                { cat: "황도 12궁", q: "황도 12궁 별자리들이 대체로 황도 부근에 놓이는 까닭은?", ans: 0, opts: ["태양의 겉보기 연간 경로 주변에 있는 별자리들이기 때문", "모두 북극성 주변에 있기 때문", "모두 지구와 같은 거리에 있기 때문", "달이 그 별자리들을 만들기 때문"], exp: "해설: 황도 12궁은 태양이 지나가는 것처럼 보이는 황도 주변의 별자리들입니다." },
                { cat: "황도 12궁", q: "한밤중 남쪽 하늘에서 잘 보이는 황도 별자리는 태양이 있는 방향과 어떤 관계인가?", ans: 2, opts: ["거의 같은 방향", "약 90° 떨어진 방향", "거의 반대 방향", "항상 북쪽 방향"], exp: "해설: 한밤중에는 관측자가 태양의 반대편 우주를 바라보므로 태양 방향과 거의 반대인 별자리가 남중합니다." },
                { cat: "황도 12궁", q: "특정 달에 태양이 어느 황도 별자리 방향에 있다는 말의 의미로 옳은 것은?", ans: 3, opts: ["그 별자리가 지구와 태양 사이에 실제로 붙어 있다", "태양이 그 별자리를 공전한다", "그 별자리가 낮 동안 사라진다", "지구에서 볼 때 태양과 그 별자리가 거의 같은 방향에 있다"], exp: "해설: 천구에서 같은 방향에 겹쳐 보인다는 뜻이며 실제 거리가 가깝다는 뜻은 아닙니다." },
                ...
                { cat: "천구", q: "천구의 적도는 무엇을 연장해 천구와 만난 큰 원인가?", ans: 2, opts: ["지구의 공전 궤도", "관측자의 지평선", "지구의 적도면", "달의 공전 궤도"], exp: "해설: 지구의 적도면을 천구까지 연장한 큰 원을 천구의 적도라고 합니다." },
                { cat: "천구", q: "천구의 북극과 남극은 무엇을 연장해 천구와 만나는 점인가?", ans: 1, opts: ["지구의 적도", "지구의 자전축", "황도", "태양 광선"], exp: "해설: 지구 자전축의 양쪽 연장선이 천구와 만나는 두 점이 천구의 북극과 남극입니다." },
                ...
                { cat: "천구", q: "관측자의 위치가 달라질 때 천구에서 가장 직접적으로 달라지는 것은?", ans: 0, opts: ["지평선과 천체의 고도", "별의 실제 온도", "별 사이의 실제 거리", "별의 수명"], exp: "해설: 관측 장소의 위도와 방향이 달라지면 지평선에 대한 천체의 고도와 보이는 범위가 달라집니다." },
                { cat: "남쪽 하늘", q: "남반구에서 남쪽 방향을 찾는 대표적인 별자리로 알맞은 것은?", ans: 2, opts: ["작은곰자리", "카시오페이아자리", "남십자자리", "북두칠성"], exp: "해설: 남반구에서는 북극성이 보이지 않으므로 남십자자리가 남쪽 방향을 찾는 중요한 길잡이가 됩니다." },

                { cat: "별의 색과 온도", q: "표면 온도가 가장 높은 별의 색은 일반적으로 무엇에 가까운가?", ans: 1, opts: ["붉은색", "청백색", "주황색", "노란색"], exp: "해설: 별은 표면 온도가 높을수록 청백색, 낮을수록 붉은색에 가깝습니다." },
                { cat: "별의 밝기", q: "별의 겉보기 밝기에 직접 영향을 주는 두 요인의 조합은?", ans: 3, opts: ["별자리 모양과 계절", "자전 방향과 공전 방향", "별의 색과 관측자의 경도", "별의 실제 광도와 지구까지의 거리"], exp: "해설: 실제로 밝은 별도 멀면 어둡게 보일 수 있으므로 겉보기 밝기는 광도와 거리의 영향을 함께 받습니다." },
                { cat: "별의 밝기", q: "겉보기 등급이 1등급인 별과 5등급인 별 중 더 밝게 보이는 별은?", ans: 0, opts: ["1등급 별", "5등급 별", "두 별의 밝기는 같다", "색을 알아야만 판단할 수 있다"], exp: "해설: 별의 등급은 숫자가 작을수록 더 밝습니다." },
                { cat: "별의 일생", q: "태양과 비슷한 질량의 별이 진화하는 순서로 가장 알맞은 것은?", ans: 2, opts: ["성운→초신성→블랙홀", "주계열성→중성자별→적색거성", "성운→주계열성→적색거성→백색왜성", "성운→백색왜성→주계열성"], exp: "해설: 태양 정도 질량의 별은 성운에서 태어나 주계열성과 적색거성 단계를 거쳐 마지막에 백색왜성이 됩니다." },
                { cat: "별의 일생", q: "질량이 매우 큰 별이 초신성 폭발 뒤 남길 수 있는 천체는?", ans: 1, opts: ["행성이나 달", "중성자별이나 블랙홀", "황도 12궁", "백색왜성만"], exp: "해설: 질량이 큰 별의 중심부는 초신성 폭발 뒤 중성자별이 되거나, 매우 무거우면 블랙홀이 될 수 있습니다." },
