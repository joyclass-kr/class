  ...
  const ROOM_QUIZZES = {
    ...
    space:{
      ...
      questions:[
        ...
        {q:'정선의 〈금강전도〉는 어떤 시점에서 금강산을 그렸을까요?',options:['하늘 위에서 내려다보는 부감법','땅 아래에서 올려다보는 시점','오직 정면에서 보는 시점'],answer:0,explain:'하늘 높이 떠서 내려다보듯 봉우리 전체를 한 화면에 담아 깊은 공간감을 만들었어요.'},
        {q:'카날레토의 〈베네치아 대운하〉에서 운하가 실제처럼 깊어 보이는 까닭은?',options:['건축물 선들이 정확한 선원근법으로 그려져서','색을 전혀 사용하지 않아서','인물을 아주 크게 그려서'],answer:0,explain:'건물의 창문과 다리 난간까지 정확한 선원근법으로 그려 운하가 실제처럼 깊게 뻗어 나가요.'},
