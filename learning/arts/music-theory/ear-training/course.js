        ...
        lessons: [
            {
                ...
                body: [
                    ...
                    "P5​(완전5도)를 뒤집으면 P4​(완전4도)가 되고, P4​(완전4도)를 뒤집으면 P5​(완전5도)가 됩니다. 이것을 Inversion​(자리바꿈)이라고 하며, 아래 음을 한 옥타브 올려 보면 확인할 수 있습니다."
                ],
                examples: ["P4", "P5", "P8"]
            },
            {
            ...
            },
            {
                ...
                body: [
                    ...
                    "좁은 음정은 Harmonic​(화성)으로 함께 울릴 때와 Melodic​(선율)으로 차례로 울릴 때가 아주 다르게 들립니다. 두 방법을 모두 들어 보세요."
                ],
                examples: ["m2", "M2"]
            },
            {
            ...
            },
            {
                ...
                title: "Sixths​(6도)",
                body: [
                    "M6​(장6도)는 m3​(단3도)를 뒤집은 음정이고, m6​(단6도)는 M3​(장3도)를 뒤집은 음정입니다. 아래 음을 한 옥타브 올려 Third​(3도)로 바꿔 생각하면 알아맞히기 쉬워집니다.",
                    "Triad​(3화음)을 뒤집었을 때 바깥 두 음이 Sixth​(6도)가 되므로 화음 차시에서 다시 만납니다."
                ],
                examples: ["m6", "M6"]
            },
            {
            ...
            },
            {
                ...
                body: [
                    ...
                    "M7​(장7도)는 m2​(단2도)를, m7​(단7도)는 M2​(장2도)를 뒤집은 음정입니다. 좁은 음정으로 바꿔 생각하면 훨씬 잡기 쉽습니다."
                ],
                examples: ["m7", "M7"]
            },
            {
            ...
            },
            {
                ...
                body: [
                    ...
                    "가장 불안하게 들리는 음정이라 한 번 익히면 다른 음정과 헷갈리지 않습니다."
                ],
                examples: ["P4", "A4", "P5"]
            },
            {
        ...
        lessons: [
            {
                ...
                body: [
                    ...
                    "아래 3도가 M3​(장3도)인지 m3​(단3도)인지, 그리고 바깥 5도가 P5​(완전5도)인지 아닌지에 따라 maj​(장)·min​(단)·dim​(감)·aug​(증) 네 가지로 갈립니다. 화음이 통째로 안 들리면 Arpeggio​(분산)으로 한 음씩 확인해 보세요."
                ],
                examples: [
                    { chord: "maj" },
                    { chord: "min" },
            ...
            },
            {
                ...
                body: [
                    ...
                    "첫째 자리바꿈은 바깥 두 음이 Sixth​(6도)가 되고, 둘째 자리바꿈은 아래 두 음이 P4​(완전4도)가 됩니다. 이 두 소리를 먼저 익히면 자리를 가릴 수 있습니다.",
            ...
            },
            {
                ...
                body: [
                    ...
                    "아래 3화음이 장인지 단인지를 먼저 듣고, 그다음 맨 위 7음이 m7​(단7도)인지 M7​(장7도)인지를 듣는 순서로 가리면 헷갈리지 않습니다."
                ],
                examples: [
                    { chord: "min7" },
                    { chord: "mmaj7" }
            ...
            },
            {
                ...
                body: [
                    ...
                    "Augmented Triad​(증3화음) 위에 M3​(장3도)를 얹으면 Augmented Major 7th​(증장7화음)입니다. 셋 다 흔하지는 않지만 소리가 뚜렷해서 한 번 익히면 잘 잊히지 않습니다."
                ],
                examples: [
                    { chord: "m7b5" },
                    { chord: "dim7" },
