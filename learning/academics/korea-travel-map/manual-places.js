(() => {
  const entries = [
    ...
    ['yeongju-sunbi-world','영주 선비세상','경상북도 영주시','culture','📖',36.8228,128.6255,'https://sunbeeworld.kr/','한글·한복·한식·한옥·한지·국악을 연결한 전통문화 체험','여섯 주제 중 하나를 골라 오늘날 생활에 이어진 모습을 찾아보세요.'],
