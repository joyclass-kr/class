    ...
    return `
        <div class="page page-cover">
            ...
            <div class="story-page-right">
                <h1>예수님의 비유</h1>
                <p class="cover-tag">지혜를 배우는 열여섯 가지 이야기</p>
                <p>아주 오래전, 예수님은 어려운 가르침을 그대로 전하는 대신 우리 주변에서 흔히 볼 수 있는 이야기에 빗대어 들려주곤 하셨어요. 그런 이야기를 '비유'라고 불러요.</p>
                <p>비유 속에는 농부와 씨앗, 잔치와 손님, 아버지와 아들처럼 우리에게 친숙한 인물들이 등장해요. 짧은 이야기지만, 그 안에는 살면서 되새길 만한 지혜가 가득 담겨 있답니다.</p>
                <p>이천 년이 지난 지금 들어도 여전히 고개가 끄덕여지는 이야기들이에요. 이 책에는 그중 열여섯 편을 담았어요.</p>
            </div>
        </div>`;
}
