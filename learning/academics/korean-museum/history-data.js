(function () {
  ...
  const RELICS_MASTER = [
    ...
    { id: 'p03', title: '비파형 동검', titleEn: 'Lute-shaped Bronze Dagger', eraCategory: 'prehistoric', era: '청동기 시대 / 고조선', route: '경부선', lat: 37.5239, lng: 126.9804, location: '만주 요령 ~ 한반도 전역', museum: '국립중앙박물관', designation: '청동기 대표 유물', docent: '실제 무기로 사용할 수 있었지만, 청동기 시대 수장의 권위와 지위를 드러내는 상징물로도 쓰였습니다.', examTip: '📌 [내신/수능 핵심] 비파형 동검 = 고조선 문화 범위 + 지배층의 권위!', quiz: { question: '고조선의 문화 범위와 지배층의 권위를 보여 주는 청동검은?', options: ['비파형 동검', '세형 동검', '칠지도', '주먹도끼'], answer: 0, explanation: '비파형 동검은 무기이면서 수장의 권위를 나타내는 상징물이었습니다.' } },
