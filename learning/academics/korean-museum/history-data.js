(function () {
  ...
  const RELICS_MASTER = [
    ...
    { id: 'p06', title: '미송리식 토기', titleEn: 'Misong-ri Style Pottery', eraCategory: 'prehistoric', era: '청동기 시대 / 고조선', route: '영동선', lat: 40.0520, lng: 124.4500, location: '평북 의주 미송리 동굴', museum: '국립중앙박물관', designation: '청동기 대표 유물', docent: '양쪽에 손잡이가 달린 토기로 고조선의 문화적 범위를 보여줍니다.', examTip: '📌 [내신/수능 핵심] 미송리식 토기 = 고조선 세력 범위!', quiz: { question: '손잡이가 달린 고조선 세력 범위 토기는?', options: ['미송리식 토기', '빗살무늬토기', '분청사기', '순백자'], answer: 0, explanation: '고조선 세력 범위 토기입니다.' } },
    ...
    { id: 's13', title: '발해 상경 용천부 석등', titleEn: 'Balhae Stone Lantern', eraCategory: 'unified_silla', era: '발해 (8세기)', route: '해외선', lat: 44.1500, lng: 129.1000, location: '중국 길림성 영안시 상경용천부', museum: '중국 길림성 박물관', designation: '발해 대표 석조 유물', docent: '발해 상경용천부 궁궐 터의 6m 석등으로 고구려 기상을 계승했습니다.', examTip: '📌 [내신/수능 핵심] 발해 = 고구려 계승 (발해 석등, 모줄임 천장)!', quiz: { question: '고구려 기상을 계승한 발해 상경용천부 6m 석등은?', options: ['발해 상경 용천부 석등', '정림사지 석탑', '원각사지 석탑', '다보탑'], answer: 0, explanation: '고구려 계승 증명 발해 석등입니다.' } },
    { id: 's14', title: '발해 이불병좌상', titleEn: 'Balhae Twin Buddhas', eraCategory: 'unified_silla', era: '발해', route: '해외선', lat: 44.1600, lng: 129.1100, location: '중국 길림성 팔련성', museum: '국립중앙박물관 소장', designation: '발해 불교 유물', docent: '두 부처님이 나란히 앉은 불상으로 고구려 불교 양식을 계승했습니다.', examTip: '📌 [내신/수능 핵심] 발해 이불병좌상 = 고구려 불교 양식 계승!', quiz: { question: '고구려 불교 양식을 계승해 두 부처님이 나란히 앉은 불상은?', options: ['이불병좌상', '석굴암 본존불', '은진미륵', '마애삼존불'], answer: 0, explanation: '고구려 불교 계승 발해 불상입니다.' } },
    ...
    { id: 'j14', title: '칠정산 (세종 한양 중심 역법)', titleEn: 'Chiljeongsan Calendar', eraCategory: 'joseon', era: '조선 세종 (1444년)', route: '경부선', lat: 37.5784, lng: 126.9766, location: '서울 경복궁 집현전', museum: '세종대왕 과학 유적', designation: '조선 최초 한양 기준 역법', docent: '우리나라 역사상 최초로 한양(서울)을 기준 위치로 하여 해, 달, 5행성의 운행을 정밀 계산해 간행한 자주적 역법 서책입니다.', examTip: '📌 [내신/수능 핵심] 칠정산 = 세종대왕, 우리나라 최초 한양 기준 자주적 역법 서책!', quiz: { question: '세종대왕 때 우리나라 역사상 최초로 한양을 기준으로 천체 운행을 계산해 작성한 자주적 역법은?', options: ['칠정산', '농사직설', '삼강행실도', '훈민정음'], answer: 0, explanation: '세종대왕 때 작성된 최초 한양 기준 자주적 역법입니다.' } },
