const CHAPTERS = [
    {
        ...
        beats: [
            ...
            },
            {
                ...
                emoji: "💰",
                left: [
                    "그날은 장이 아주 잘됐어요. 봇짐이 텅 비도록 물건이 다 팔렸지요.",
                    "\"허허, 오늘은 운수가 좋구먼.\""
                ],
                right: [
            ...
            },
            {
                ...
                emoji: "🍲",
                left: [
                    "해가 저물어 주막에 들었습니다. 장수는 국밥을 시켜 바둑이와 나눠 먹었어요."
                ],
                right: [
                    "그런데 옆자리 사내가 자꾸 이쪽을 흘끔거렸지요. 장수의 허리춤을, 정확히는 그 돈주머니를요. 바둑이가 낮게 으르렁거렸습니다."
                ]
            }
        ]
    },
        ...
        beats: [
            {
                ...
                emoji: "🌫️",
                left: [
                    "이튿날 새벽, 장수는 일찍 길을 나섰어요. 고갯길에는 안개가 자욱했습니다.",
                    "\"오늘 안에 집에 닿아야 할 텐데.\""
                ],
                right: [
            ...
            },
            {
                ...
                emoji: "😱",
                left: [
                    "고갯마루에 이르렀을 때였습니다. 안개 속에서 누군가 불쑥 튀어나왔어요. 주막에서 흘끔거리던 그 사내였지요."
                ],
                right: [
                    "사내는 장수를 밀치고 돈주머니를 낚아챘습니다. 그러고는 숲속으로 쏜살같이 사라졌어요.",
                    "\"도, 도둑이야!\""
                ]
            },
            {
                ...
                emoji: "😞",
                left: [
                    "장수는 숲으로 뛰어들었어요. 하지만 안개 속에서 이내 방향을 잃고 말았습니다."
                ],
                right: [
                    "\"한 해를 벌어 모은 돈인데…\"",
                    "장수는 길바닥에 털썩 주저앉았어요. 바둑이가 그 곁에서 코를 킁킁거렸지요."
                ]
            }
        ]
    },
        ...
        beats: [
            {
                ...
                right: [
                    "\"바둑아! 어디 가느냐!\"",
                    "바둑이는 대답 대신 안개 속으로 뛰어들었어요. 네 다리가 보이지 않을 만큼 빨랐답니다."
                ]
            },
            {
                art: "08-chase.png",
                ...
                right: [
                    "골짜기 하나를 넘었을 때였습니다. 바위 뒤에 웅크린 사내가 보였어요. 돈주머니를 품에 꼭 안고 있었지요."
                ]
            },
            {
                art: "09-bark.png",
            ...
            },
            {
                ...
                emoji: "🍖",
                left: [
                    "사내는 그 자리에서 붙잡혔습니다. 돈주머니는 고스란히 장수에게 돌아왔지요. 장수는 바둑이를 끌어안고 한참을 놓지 못했어요."
                ],
                right: [
                    "\"네가 아니었으면 어쩔 뻔했느냐.\"",
