const CHAPTERS = [
    {
        ...
        beats: [
            ...
            },
            {
                ...
                right: [
                    "아버지도 알고 있었던 거예요.",
                    "그런데 대문을 나서려는데 뒤에서 발소리가 났지요. 일곱 살 난 아들이 따라 나온 것이었어요."
                ]
            },
            {
                art: "04-follow.png",
                ...
                right: [
                    "아무리 달래도 아이는 물러서지 않았어요.",
                    "결국 셋이 함께 산길을 올랐습니다. 아무도 입을 열지 않았지요."
                ]
            }
        ]
    },
        ...
        beats: [
            {
                ...
                right: [
                    "아이는 나쁜 마음으로 한 말이 아니었어요. 그저 아버지가 하는 것을 보고 그대로 배운 것이었지요.",
                    "그것이 더 무서웠답니다."
                ]
            },
            {
            ...
            },
            {
                ...
                emoji: "🏡",
                left: [
                    "그날부터 아들은 아버지를 정성껏 모셨어요.",
                    "이 일은 곧 온 마을에 퍼졌습니다."
                ],
                right: [
                    "이야기를 들은 사람들이 하나둘 산으로 올라갔지요. 그리고 저마다 부모를 다시 모시고 내려왔답니다.",
