        ...
        beats: [
            {
                ...
                left: [
                    "옛날 어느 마을에 형제가 살았습니다.",
                    "논도 나란히, 집도 나란히.",
                    "어릴 때부터 한 번도 다툰 적이 없는 형제였어요."
                ],
                right: [
                    "\"형님, 오늘은 형님 논부터 물을 대시지요.\"",
                    "\"아니다, 네 논이 더 마르지 않았느냐.\"",
                    "동네 사람들은 두 사람을 의좋은 형제라고 불렀답니다."
                ]
            },
            {
                art: "02-harvest.webp",
        ...
        beats: [
            ...
            },
            {
                ...
                left: [
                    "동생도 자기 볏단을 지게에 얹었어요.",
                    "영차, 영차.",
                    "형이 다녀간 그 길을 이번에는 반대로 걸었지요."
                ],
                right: [
                    "동생은 형네 무더기에 볏단을 올려놓고 얼른 돌아왔어요.",
    ...
    },
    {
        ...
        beats: [
            ...
            },
            {
                ...
                left: [
                    "사흘째 되는 밤.",
                    "형이 지게를 지고 논둑길을 걸어갔어요. 저쪽에서도 누군가 지게를 지고 오고 있었지요. 달빛 아래에서 두 사람은 딱 마주쳤습니다."
                ],
                right: [
                    "\"형님?\"",
                    "\"너, 너는…\"",
                    "두 지게에는 똑같이 볏단이 실려 있었어요."
                ]
            },
            {
                art: "10-laugh.webp",
                emoji: "😄",
                left: [
                    "그제야 두 사람은 모든 것을 알아차렸어요. 형이 웃음을 터뜨렸습니다.",
                    "\"이 녀석, 너였구나!\"",
                    "\"형님이야말로요!\""
                ],
                right: [
                    "두 형제는 지게를 내려놓고 논둑에 나란히 앉아 한참을 웃었어요.",
