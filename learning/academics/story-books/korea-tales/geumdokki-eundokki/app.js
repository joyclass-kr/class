        ...
        beats: [
            {
                ...
                left: [
                    ...
                    "아내와 어린 아이 둘이 그 도끼 하나만 바라보고 살았지요.",
                    "새벽에 산에 올라 해가 져야 내려왔어요."
                ],
                right: [
                    "\"이 도끼가 우리 식구를 먹여 살린다.\"",
                    "도끼는 제 몸처럼 아끼는 물건이었지요.",
        ...
        beats: [
            ...
            },
            {
                ...
                left: [
                    ...
                    "손잡이에는 은실까지 감겨 있었어요.",
                    "\"그러면 이것이 네 도끼냐?\"",
                    "평생 한 번도 본 적 없는 도끼였지요."
                ],
                right: [
                    "나무꾼은 또 고개를 저었어요.",
                    "산신령이 나무꾼의 얼굴을 가만히 살폈어요.",
                    "\"그것도 제 것이 아닙니다.\"",
                    "목소리가 조금도 흔들리지 않았답니다."
                ]
            },
            {
                ...
                left: [
                    ...
                    "여기저기 이가 빠진 볼품없는 도끼였지요."
                ],
                right: [
                    "나무꾼의 얼굴이 대번에 환해졌습니다.",
                    "나무꾼은 저도 모르게 소리를 질렀어요.",
                    "\"예! 그겁니다! 그게 제 도끼입니다!\"",
        ...
        beats: [
            {
                ...
                left: [
                    ...
                    "같은 마을에 사는 욕심 많은 사람이었어요.",
                    "\"연못에 도끼만 빠뜨리면 된다고?\"",
                    "이튿날 욕심쟁이는 제 도끼를 들고 연못으로 달려갔습니다.",
                    "밤새 잠도 자지 않고 궁리했지요."
                ],
                right: [
    ...
    spreads: [
        {
            ...
            left: [
                ...
                "다시 보면 나무꾼이 금도끼를 마다한 것은 욕심이 없어서가 아닙니다. 가난한 사람에게 금도끼가 왜 탐나지 않았겠습니까.",
                "다만 제 것이 아닌 것을 제 것이라고 말할 수가 없었을 뿐입니다. 그것은 욕심이 없는 것과 다릅니다."
            ],
            right: [
                "욕심쟁이가 잃은 것도 다시 보십시오. 금도끼를 못 얻은 것이 아니라 제 쇠도끼마저 잃었습니다. 얻으러 갔다가 있던 것을 놓친 것이지요.",
                "산신령은 왜 금도끼를 먼저 내밀었을까요? 답은 적어 두지 않겠습니다."
            ]
        }
    ]
};
