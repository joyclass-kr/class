const CHAPTERS = [
    {
        ...
        beats: [
            ...
            },
            {
                ...
                right: [
                    "마침내 저 멀리 불국사 지붕이 보였어요. 아사녀는 치마를 걷어붙이고 뛰었습니다.",
                    "기와지붕이 아침 햇살에 반짝였지요.",
                    "\"저 안에 그이가 있구나!\"",
    ...
    return `
        <div class="page page-cover">
            ...
            <div class="story-page-right">
                ...
                <p>불국사 아래에는 영지라는 못이 있어요. 못가에는 얼굴이 뭉개진 오래된 돌부처가 지금도 앉아 있는데, 사람들은 그 돌부처를 이 이야기와 이어서 말한답니다.</p>
