        ...
        beats: [
            ...
            },
            {
                ...
                left: [
                    ...
                    "병을 고치는 법도, 옳고 그름을 가리는 법도요."
                ],
                right: [
                    "\"널리 사람을 이롭게 하라.\"",
                    "그것이 환웅이 늘 하던 말이었지요.",
                    "신시에는 웃음소리가 끊이지 않았습니다."
                ]
            },
            {
                art: "05-two.png",
                emoji: "🐻",
                left: [
                    "어느 날 곰 한 마리와 호랑이 한 마리가 찾아왔어요.",
                    "둘은 신단수 아래에 나란히 엎드렸습니다."
                ],
                right: [
                    "\"사람이 되고 싶습니다.\"",
                    "\"저희도 저들처럼 살고 싶습니다.\"",
    ...
    },
    {
        ...
        beats: [
            ...
            },
            {
                ...
                emoji: "🐯",
                left: [
                    "사흘이 지나자 호랑이가 안절부절못했어요.",
                    "이레가 지나자 벌떡 일어섰습니다."
                ],
                right: [
                    "\"못 하겠다! 나는 이렇게는 못 산다!\"",
                    "호랑이는 동굴 밖으로 뛰쳐나갔어요.",
                    "곰은 그 뒷모습을 물끄러미 바라보았지요."
                ]
            },
            {
                art: "09-bear.png",
        ...
        beats: [
            {
                ...
                emoji: "🙏",
                left: [
                    "웅녀는 사람이 되었지만 곁에 아무도 없었어요.",
                    "날마다 신단수 아래에 앉아 빌었습니다."
                ],
                right: [
                    "\"아이를 하나만 갖게 해 주십시오.\"",
                    "그 소리가 어찌나 간절했던지",
            ...
            },
            {
                ...
                right: [
                    "조선 역시 아침이라는 뜻이었지요. 곰이 깊은 어둠 속에서 견뎌 얻은 것이 결국 아침이었던 셈이에요.",
