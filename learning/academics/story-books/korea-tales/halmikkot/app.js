        ...
        beats: [
            {
                ...
                right: [
                    "\"우리 딸들 배곯게는 안 한다.\"",
                    "나물을 캐고 삯바느질을 하며 딸 셋을 키웠지요. 손마디가 굵어지고 허리가 조금씩 굽어 갔답니다."
                ]
            },
            {
                art: "02-married.png",
                ...
                left: [
                    ...
                    "첫째는 고개 너머 큰 기와집으로, 둘째는 강 건너 부잣집으로."
                ],
                right: [
            ...
            },
            {
                ...
                emoji: "🏚️",
                left: [
                    "혼자 남은 할머니는 해가 갈수록 기운이 빠졌어요. 이제는 나물 바구니도 무겁게 느껴졌습니다."
                ],
                right: [
        ...
        beats: [
            {
                ...
                left: [
                    "먼저 첫째 딸네 대문을 두드렸어요.",
                    "\"애기야, 어미다.\"",
                    "안에서 부스럭거리는 소리가 나더니 이내 조용해졌습니다."
                ],
                right: [
                    "문은 끝내 열리지 않았어요. 할머니는 한참을 서 있다가 돌아섰지요."
                ]
            },
            {
                art: "05-second.png",
                emoji: "🌊",
                left: [
                    "강을 건너 둘째 딸네로 갔어요. 마당에서 둘째가 할머니를 보았습니다.",
                    "\"어머니, 지금은 집안이 바빠서요.\""
                ],
                right: [
                    "\"다음에 오세요. 예?\"",
            ...
            },
            {
                ...
                right: [
                    "할머니는 지팡이에 몸을 기대고 언덕을 오르기 시작했습니다. 산 아래 막내네 초가집 지붕이 저 멀리 보였어요.",
                    "하지만 언덕은 자꾸만 높아 보였지요."
                ]
            }
        ]
        ...
        beats: [
            {
                ...
                emoji: "🌾",
                left: [
                    "언덕 중턱에서 할머니는 그만 주저앉고 말았어요. 숨이 가빠 더는 걸을 수가 없었습니다.",
                    "\"조금만… 조금만 쉬었다 가자.\""
                ],
                right: [
            ...
            },
            {
                ...
                right: [
                    "줄기가 활처럼 굽어 고개를 폭 숙이고, 온몸에 흰 솜털이 난 꽃이었지요. 사람들은 그 꽃을 할미꽃이라고 불렀답니다."
                ]
            }
        ],
