...
const CHAPTERS = [
    {
        ...
        paras: [
            ...
            "콩쥐가 태어난 지 백일 만에 어머니가 세상을 떠났습니다. 아버지는 딸을 업고 다니며 젖동냥을 하여 길렀습니다. 아버지는 그 뒤로 다시 장가들 생각을 하지 않았습니다.",
            ...
            "아버지가 장에 나간 첫날부터 배 씨의 얼굴이 달라졌습니다. 콩쥐에게 부엌일을 몽땅 맡기고, 팥쥐에게는 손끝 하나 까딱하지 못하게 했습니다. 문지방을 넘는 소리부터 달랐습니다.",
            ...
            "그때마다 배 씨는 콩쥐의 종아리를 때렸습니다. 콩쥐는 울지 않았습니다. 울면 아버지가 아실까 봐 걱정되었기 때문입니다. 종아리에 자국이 가실 날이 없었습니다.",
            ...
            "소는 콩쥐 앞으로 와서 크고 검은 눈으로 한참을 들여다보았습니다. 그러고는 밭으로 들어가 앞발로 땅을 갈기 시작했습니다. 콩쥐는 무섭다는 생각이 들지 않았습니다.",
    ...
    },
    {
        ...
        paras: [
            ...
            "배 씨는 팥쥐에게 새 옷을 입히고 머리를 곱게 땋아 주었습니다. 콩쥐는 부엌에 서서 그 모습을 보고 있었습니다. 팥쥐는 거울 앞에서 몇 번이나 돌아보았습니다.",
            "\"어머니, 저도 가고 싶습니다.\"<br>배 씨가 돌아보았습니다.<br>\"가고 싶으면 가려무나. 다만 집안일은 다 하고 가야지.\" 배 씨의 입가에 웃음이 스쳤습니다.",
            "\"무엇을 하면 됩니까.\"<br>\"마당의 저 독에 물을 가득 채워 놓아라. 그것만 하면 된다.\"",
            "콩쥐는 얼른 물동이를 이었습니다. 우물을 열 번이나 오갔습니다. 그런데 아무리 부어도 독이 차지 않았습니다. 물동이가 어깨를 짓눌렀습니다.",
            "이상해서 손을 넣어 보니 독 밑바닥에 주먹만 한 구멍이 뚫려 있었습니다. 물은 붓는 족족 땅으로 새어 나갔습니다. 누가 일부러 뚫어 놓은 구멍이었습니다.",
            "콩쥐는 그 자리에 주저앉았습니다. 대문 밖에서 배 씨와 팥쥐가 웃는 소리가 들려왔습니다. 두 사람은 이미 잔칫집으로 떠난 뒤였습니다. 마당에 물이 흥건했습니다.",
            "해가 뉘엿뉘엿 기울었습니다. 콩쥐는 그래도 물동이를 다시 이었습니다. 붓고 새고, 붓고 새고를 되풀이했습니다. 팔이 저리고 다리가 후들거렸습니다.",
            ...
            "독이 가득 찬 것을 본 배 씨의 얼굴이 굳었습니다. 그러나 곧 아무렇지 않은 척 말했습니다.<br>\"참, 한 가지를 깜빡했구나. 곳간에 벼 석 섬이 있다. 그것을 다 찧어 놓고 오너라.\" 말끝이 유난히 부드러웠습니다.",
            "\"석 섬을요? 오늘 안에요?\"<br>\"그럼 하지 말든가. 대신 잔치에도 오지 마라.\"",
            "배 씨는 그 말만 남기고 다시 나갔습니다.",
            "곳간 문을 열어 보니 벼가 산더미처럼 쌓여 있었습니다. 혼자서는 사흘이 걸려도 못 할 일이었습니다. 문턱까지 벼가 쏟아져 나올 지경이었습니다.",
            "콩쥐는 절구를 끌어다 놓고 벼를 한 됫박 부었습니다. 절굿공이가 어찌나 무거운지 두 손으로 겨우 들었습니다.",
            "쿵. 쿵. 쿵.<br>스무 번을 찧고 나니 팔이 떨어져 나갈 것 같았습니다. 그런데 껍질을 벗긴 쌀은 겨우 한 줌이었습니다. 이마에서 땀이 뚝뚝 떨어졌습니다.",
    ...
    },
    {
        ...
        paras: [
            ...
            "콩쥐가 우물가에서 얼굴을 씻고 있는데, 물 위에 무언가가 비쳤습니다. 돌아보니 하늘에서 무엇이 내려오고 있었습니다. 햇빛이 아닌 다른 빛이었습니다.",
            "연둣빛 저고리와 다홍치마가 마당에 사뿐 내려앉았습니다. 그 위에는 곱게 수를 놓은 꽃신 한 켤레가 놓여 있었습니다. 옷감에서 은은한 향이 났습니다.",
            "콩쥐는 한참 동안 그것을 만지지 못했습니다. 그러다 문득 검은 소가 떠올랐습니다. 두꺼비가, 참새 떼가 떠올랐습니다. 모두 아무 말 없이 도와준 것들이었습니다.",
            "콩쥐는 옷을 갈아입고 꽃신을 신었습니다. 발에 꼭 맞았습니다.",
            "잔칫집으로 가는 길에 개울이 하나 있었습니다. 다리라고는 통나무 하나뿐이었습니다. 콩쥐가 조심조심 건너기 시작했습니다. 물살이 제법 셌습니다.",
            ...
            "집집마다 처녀들이 나와 신을 신어 보았습니다. 그러나 발에 맞는 사람이 하나도 없었습니다. 크면 헐렁하고 작으면 들어가지 않았습니다. 하인들이 고을을 사흘이나 돌았습니다.",
            "사흘째 되던 날, 하인들이 최만춘의 집 앞에 이르렀습니다.",
            "배 씨는 소식을 듣자마자 팥쥐를 안방으로 끌고 들어갔습니다.<br>\"이건 하늘이 준 기회다.\" 문을 닫고 목소리를 낮추었습니다.",
            "배 씨는 팥쥐의 발에 참기름을 바르고 억지로 신을 밀어 넣었습니다. 팥쥐의 발은 콩쥐보다 훨씬 컸습니다. 발가락이 접혀 들어갔습니다.",
            ...
            "그때 부엌 문틈으로 지켜보던 콩쥐가 있었습니다. 배 씨는 콩쥐를 부엌에 가두고 밖에서 빗장을 질러 놓았습니다. 부엌에는 창도 없었습니다.",
    ...
    },
    {
        ...
        paras: [
            ...
            "대신 이상한 일이 있었습니다. 감사 댁 뒤뜰 연못가에 어느 날부터 두꺼비 한 마리가 나와 앉아 있게 된 것입니다. 콩쥐는 날마다 그 앞에 밥알을 놓아 주었습니다. 아무리 쫓아도 이튿날이면 그 자리에 다시 와 있었습니다.",
            ...
            "그날부터 팥쥐는 자주 드나들었습니다. 콩쥐는 올 때마다 반가워하며 밥을 차리고 옷감을 내주었습니다. 감사도 처제라 하여 잘 대접했습니다. 콩쥐는 그것을 조금도 아까워하지 않았습니다.",
            ...
            "팥쥐는 한참 동안 연못을 내려다보았습니다. 그러고는 콩쥐가 벗어 놓은 옷을 주워 입고, 콩쥐의 방으로 들어가 문을 걸어 잠갔습니다. 손끝이 잘게 떨렸습니다.",
    ...
    },
    {
        ...
        paras: [
            ...
            "감사는 고개를 갸웃했습니다. 얼굴만 달라진 것이 아니었습니다. 부인은 더 이상 새벽에 마당을 쓸지 않았고, 두꺼비에게 밥알을 놓아 주지 않았습니다. 웃음소리도 달라져 있었습니다.",
            ...
            "그것을 발견한 것은 부엌일을 하던 늙은 할멈이었습니다. 할멈은 그 구슬을 주워 치마 주머니에 넣었습니다. 어쩐지 버릴 수가 없었습니다. 구슬이 손안에서 따뜻했습니다.",
    ...
    },
    {
        ...
        paras: [
            ...
            "진흙 속에 무언가 있었습니다. 하인들이 조심조심 진흙을 걷어 냈습니다. 아무도 숨을 쉬지 못했습니다.",
            ...
            "그 소식이 안채에 닿았습니다. 팥쥐는 옷도 제대로 갖춰 입지 못한 채 담을 넘어 달아나려 했습니다. 그러나 대문 앞에서 붙들리고 말았습니다. 짐도 챙기지 못한 채였습니다.",
            ...
            "\"팥쥐야.\"<br>\"…언니.\"<br>\"나는 네가 왜 나를 밀었는지 안다. 어릴 적부터 어머니가 너에게 나보다 앞서라고만 하셨지.\"<br>배 씨가 그 말에 얼굴을 감쌌습니다. 콩쥐의 목소리에는 미움이 없었습니다.",
            ...
            "콩쥐가 다가가자 소가 고개를 들었습니다. 크고 검은 눈이 그때와 똑같았습니다. 콩쥐의 눈에 눈물이 고였습니다.",
