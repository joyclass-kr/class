...
const CHAPTERS = [
    ...
    },
    {
        ...
        paras: [
            ...
            "해가 뉘엿뉘엿 기울었습니다. 콩쥐는 그래도 물동이를 다시 이었습니다. 붓고 새고, 붓고 새고를 되풀이했습니다. 팔이 저리고 다리가 후들거렸습니다. 치맛자락이 다 젖었습니다.",
    ...
    },
    {
        ...
        paras: [
            ...
            "\"언니가 먼저 들어가 봐. 물이 시원한지.\"<br>콩쥐가 옷을 걷고 물가에 앉았습니다. 발을 담그니 정말로 시원했습니다. 물이 무릎까지 찼습니다.",
    ...
    },
    {
        ...
        paras: [
            ...
            "감사는 그 꽃이 마음에 들어 날마다 연못가에 나가 보았습니다. 그런데 이상한 일이 있었습니다. 감사가 지나가면 연꽃이 고개를 들었고, 부인이 지나가면 꽃잎이 오므라들었습니다. 감사가 고개를 갸웃했습니다.",
