        ...
        beats: [
            {
                ...
                left: [
                    ...
                    "해가 뉘엿뉘엿 기울어 걸음이 급했지요.",
                    "그런데 어디선가 소리가 들렸어요.",
                    "\"사람 살려! 사람 살려!\"",
                    "나그네는 걸음을 멈추고 귀를 기울였어요."
                ],
                right: [
                    "소리 나는 쪽으로 가 보니 커다란 구덩이가 있었습니다.",
                    "구덩이가 어른 키의 두 배는 되어 보였어요.",
                    "그 안에서 호랑이 한 마리가 껑충껑충 뛰고 있었지요. 아무리 뛰어도 앞발이 구덩이 턱에 닿지 않았어요.",
                    "사냥꾼이 파 놓은 함정에 빠진 것이었습니다.",
                    "나그네는 조심조심 가장자리로 다가갔지요."
                ]
            },
            {
                art: "02-beg.webp",
                ...
                right: [
                    ...
                    "호랑이의 목소리가 아주 간절했어요.",
                    "호랑이는 앞발을 모으고 고개를 조아렸어요.",
                    "커다란 눈에서 눈물까지 뚝뚝 흘렸답니다.",
                    "나그네는 한참을 망설였답니다."
                ]
            },
            {
                ...
                left: [
                    ...
                    "나그네가 봇짐을 내려놓았어요.",
                    "'저렇게까지 비는데…'",
                    "그러고는 산에서 굵은 나무를 구해다 구덩이에 걸쳐 주었지요."
                ],
                right: [
                    "호랑이는 나무를 타고 성큼성큼 올라왔어요.",
                    "나그네가 손을 내밀어 도와주기까지 했어요.",
                    "\"고맙습니다, 나그네님!\"",
                    "그런데 땅에 발을 딛는 순간, 호랑이의 눈빛이 싹 달라졌습니다.",
                    "나그네는 그제야 아차 싶었지요."
                ]
            }
        ]
        ...
        beats: [
            {
                ...
                right: [
                    ...
                    "호랑이가 어깨를 으쓱했어요.",
                    "\"나는 지금 배가 고프단 말이다!\"",
                    "나그네는 기가 막혀 말이 나오지 않았습니다.",
                    "세상에 이런 법이 어디 있나 싶었지요."
                ]
            },
            {
                art: "05-pine.webp",
                ...
                left: [
                    ...
                    "나그네가 두 팔을 벌리며 소리쳤어요.",
                    "\"좋다. 세 번만 물어보자.\"",
                    "호랑이가 못 이기는 척 고개를 끄덕였지요.",
                    "두 사람은 먼저 길가의 늙은 소나무에게 물었어요."
                ],
                right: [
                    "\"소나무님, 어느 쪽이 옳습니까?\"",
                    "소나무가 가지를 흔들며 대답했어요.",
            ...
            },
            {
                ...
                emoji: "🐂",
                left: [
                    "다음은 밭에서 쟁기를 끌던 소에게 물었습니다.",
                    "소는 온몸이 땀에 젖어 있었어요.",
                    "\"소님, 어느 쪽이 옳습니까?\"",
                    "소는 무거운 고개를 천천히 들었어요.",
                    "멍에 자국이 목에 깊이 파여 있었지요."
                ],
                right: [
                    "\"사람은 우리를 죽도록 부려먹지 않소.\"",
                    "소가 다시 고개를 숙였어요.",
                    "\"나도 호랑이 편이오.\"",
                    "나그네는 그만 자리에 주저앉고 말았습니다. 이제 한 번밖에 남지 않았지요."
                ]
            }
        ]
    },
        ...
        beats: [
            {
                ...
                left: [
                    "\"이제 한 번 남았다. 어서 물어보아라.\"",
                    "호랑이가 어서 하라는 듯 재촉했어요.",
                    "바로 그때, 토끼 한 마리가 깡충깡충 지나갔어요.",
                    "나그네가 다급하게 사정을 이야기했습니다.",
                    "나그네는 마지막 희망을 걸었지요."
                ],
                right: [
                    "토끼는 귀를 쫑긋 세우고 끝까지 들었어요.",
                    "토끼는 아무리 들어도 모르겠다는 얼굴이었어요.",
                    "그러더니 고개를 갸웃했지요.",
                    "\"음… 무슨 말인지 하나도 모르겠는데요?\"",
                    "호랑이가 답답해서 발을 굴렀답니다."
                ]
            },
            {
                ...
                right: [
                    ...
                    "토끼가 눈을 동그랗게 떴어요.",
                    "\"아니다! 내가 안에 있었다니까!\"",
                    "호랑이는 발을 동동 굴렀어요. 토끼는 여전히 눈만 껌뻑였지요.",
                    "나그네는 그제야 토끼의 속을 알아챘지요."
                ]
            },
            {
                art: "09-back-in.webp",
                ...
                right: [
                    "\"에잇, 답답해서 원!\"",
                    "호랑이는 성큼성큼 구덩이로 내려갔습니다.",
                    "\"자! 내가 이렇게 여기 있었단 말이다!\"",
                    "나그네는 저도 모르게 입을 틀어막았지요.",
                    "웃음이 터질까 봐 애를 썼답니다."
                ]
            },
            {
                ...
                right: [
                    "구덩이 속에서 호랑이가 펄쩍펄쩍 뛰었지만 소용없었어요.",
                    "나그네가 토끼에게 절을 했어요.",
                    "토끼와 나그네는 마주 보고 웃으며 산을 내려갔답니다.",
                    "\"그래도 다음부터는 조심하세요.\""
                ]
            }
        ],
    ...
    return `
        <div class="page page-cover">
            ...
            <div class="story-page-right">
                <h1>토끼의 재판</h1>
                <p>토끼의 재판은 지은이가 없는 구전 설화예요. 은혜 모르는 호랑이라는 이름으로도 전해진답니다.</p>
                <p>이 이야기의 뼈대는 세계 곳곳에 퍼져 있어요. 인도에는 우리에 갇힌 호랑이가, 유럽에는 함정에 빠진 늑대나 뱀이 나오는 이야기가 있는데, 갇힌 짐승을 풀어 준 사람이 도리어 위험에 빠지고 꾀 많은 동물이 구해 준다는 짜임은 똑같아요. 아주 오래전부터 여러 나라를 오가며 퍼진 이야기로 봅니다.</p>
                <p>우리 옛이야기에서 토끼는 힘이 아니라 꾀로 이기는 동물이에요. 토끼전에서는 용왕을 속이고, 이 이야기에서는 호랑이를 속이지요. 몸집 작은 동물이 큰 짐승을 이기는 이야기를 옛사람들이 특히 좋아했답니다.</p>
                ${coverToc()}
            </div>
        </div>`;
}
    ...
    spreads: [
        {
            ...
            right: [
                "힘으로 맞설 수 없을 때 쓸 수 있는 방법이 하나 더 있다는 것을, 이 이야기가 조용히 알려 줍니다.",
                "소와 나무는 왜 호랑이 편을 들었을까요? 답은 적어 두지 않겠습니다."
            ]
        }
    ]
};
