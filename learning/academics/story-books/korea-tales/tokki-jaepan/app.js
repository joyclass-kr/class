        ...
        beats: [
            {
                ...
                right: [
                    "소리 나는 쪽으로 가 보니 커다란 구덩이가 있었어요. 그 안에서 호랑이 한 마리가 껑충껑충 뛰고 있었지요.",
            ...
            },
            {
                ...
                left: [
                    "나그네는 그만 마음이 약해졌어요.",
                    "'저렇게까지 비는데…'",
                    "그러고는 굵은 나무를 구해다 구덩이에 걸쳐 주었지요."
                ],
                right: [
                    "호랑이는 나무를 타고 성큼성큼 올라왔습니다.",
                    "\"고맙습니다, 나그네님!\"",
                    "그런데 다음 순간, 호랑이의 눈빛이 달라졌어요."
                ]
            }
        ]
    },
        ...
        beats: [
            {
                ...
                left: [
                    "\"이제 한 번 남았다. 어서 물어보아라.\"",
                    "바로 그때, 토끼 한 마리가 깡충깡충 지나갔어요. 나그네가 다급하게 사정을 이야기했습니다."
                ],
                right: [
                    "토끼는 귀를 쫑긋 세우고 듣더니 고개를 갸웃했어요.",
                    "\"음… 무슨 말인지 하나도 모르겠는데요?\""
                ]
            },
            {
