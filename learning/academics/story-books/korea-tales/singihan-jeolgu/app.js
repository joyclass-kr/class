const CHAPTERS = [
    {
        ...
        beats: [
            ...
            },
            {
                ...
                emoji: "🪨",
                left: [
                    "노인은 작은 돌절구 하나를 내밀었어요.",
                    "\"이것을 가져가게.\"",
                    "\"나와라, 하고 부르면 무엇이든 나온다네.\""
                ],
                right: [
                    "\"멈출 때는 그만, 하고 말하면 되고.\"",
                    "나무꾼이 고개를 들었을 때 노인은 이미 사라지고 없었답니다."
                ]
            },
            {
                art: "03-rice.webp",
                emoji: "🍚",
                left: [
                    "집에 돌아온 나무꾼이 조심스레 말해 보았어요.",
                    "\"쌀아, 나와라.\"",
                    "그러자 절구에서 하얀 쌀이 쏟아져 나왔습니다!"
                ],
                right: [
                    "\"그만!\"",
                    "쌀은 딱 멈췄어요.",
                    "나무꾼은 이웃들을 불러 배불리 나누어 먹었답니다."
                ]
            }
        ]
    },
        ...
        beats: [
            {
                ...
                left: [
                    "\"저 집 절구에서 쌀이 나온대!\"",
                    "소문은 온 마을에, 그리고 옆 마을까지 퍼졌어요. 그 소문을 도둑 하나가 들었지요."
                ],
                right: [
                    "'그 절구만 있으면 평생 놀고먹겠구나.'",
                    "도둑은 침을 꿀꺽 삼켰답니다."
            ...
            },
            {
                ...
                left: [
                    "그날 밤, 도둑은 담을 넘었습니다.",
                    "살금살금.",
                    "절구를 자루에 담아 등에 지고 달아났지요."
                ],
                right: [
                    "\"이제 나는 부자다!\"",
                    "도둑은 뒤도 안 돌아보고 바닷가로 내달렸어요. 작은 배 한 척을 풀어 노를 저었답니다."
                ]
            },
            {
                art: "06-salt.webp",
                emoji: "🧂",
                left: [
                    "배가 먼바다로 나아갔을 때였어요. 도둑은 절구를 꺼내 놓고 생각했습니다.",
                    "'무엇을 달라고 할까?'"
                ],
                right: [
                    "\"옳지, 소금이다! 소금은 비싸니까.\"",
                    "\"소금아, 나와라!\"",
                    "그러자 절구에서 하얀 소금이 콸콸 쏟아졌어요."
                ]
            }
        ]
    },
        ...
        beats: [
            {
                ...
                right: [
                    "\"멈춰! 서! 이러다 큰일 난다!\"",
                    "아무리 소리쳐도 소용없었지요. 도둑은 멈추는 말을 듣지 못했거든요."
                ]
            },
            {
                art: "08-sinking.webp",
                emoji: "🌊",
                left: [
                    "소금은 도둑의 무릎까지, 허리까지 차올랐어요. 배가 기우뚱 기울기 시작했습니다."
                ],
                right: [
                    "\"살려 줘! 누가 좀 살려 줘!\"",
                    "하지만 먼바다에는 아무도 없었답니다."
            ...
            },
            {
                ...
                emoji: "🪵",
                left: [
                    "마침내 배가 가라앉았어요. 도둑은 떠다니는 널빤지를 겨우 붙잡았습니다."
                ],
                right: [
                    "밤새 파도에 떠밀려 다니다가 이튿날 아침에야 뭍에 닿았지요.",
                    "손에는 아무것도 남아 있지 않았어요."
                ]
            },
            {
                ...
                right: [
                    "지금도 저 깊은 바닷속에서 소금을 내고 있대요. 바닷물이 짠 것은 그 때문이라고 한답니다."
                ]
            }
        ],
