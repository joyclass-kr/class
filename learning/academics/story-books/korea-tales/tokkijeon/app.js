...
const CHAPTERS = [
    {
        ...
        paras: [
            `남해 바다 깊은 곳에 수정으로 지은 궁궐이 하나 있었습니다. 기둥은 산호요 지붕은 자개라, 물살이 지날 때마다 온 궁이 무지갯빛으로 일렁였습니다. 그곳을 다스리는 이가 남해 용왕이었습니다.`,
            `그해 봄, 용왕은 큰 잔치를 열었습니다. 동해와 서해와 북해의 용왕들까지 불러 모아 사흘 밤낮을 놀았습니다. 풍악이 그치지 않았고 술잔이 마를 새가 없었습니다.`,
            `나흘째 되던 날 아침이었습니다. 용왕이 자리에서 일어나려다 그대로 주저앉고 말았습니다.<br>"어, 어지럽구나."`,
            `그날부터 용왕은 자리에 누웠습니다. 밥을 넘기지 못하고 물조차 겨우 축였습니다. 온몸이 불덩이처럼 달아올랐다가 이내 얼음장처럼 식었습니다.`,
            `수궁이 발칵 뒤집혔습니다. 이름난 의원이란 의원은 다 불려 왔습니다. 잉어 의원이 맥을 짚어 보고, 문어 의원이 온몸을 주물러 보고, 해마 의원이 침을 놓아 보았습니다. 그러나 아무 소용이 없었습니다.`,
            `약도 지어 보았습니다. 미역과 다시마를 달여 보고, 진주를 갈아 넣어 보고, 천 년 묵은 조개의 살을 고아 보았습니다. 용왕은 한 모금 넘기고는 도로 고개를 저었습니다.`,
            `달이 두 번 바뀌었습니다. 그사이 용왕의 얼굴에서 살이 다 빠지고 비늘에서 빛이 사라졌습니다. 신하들은 궁 앞에 모여 서서 발만 굴렀습니다.`,
            `"이러다 큰일 나겠소."<br>"천하의 명의를 다 데려왔는데 어쩌란 말이오."<br>"바다에 없으면 육지에서라도 찾아야지요."`,
            `그러나 아무도 육지 이야기를 크게 하지는 못했습니다. 바다에 사는 것들에게 육지란 숨을 쉴 수 없는 무서운 곳이었기 때문입니다.`,
            `그러던 어느 날 밤이었습니다. 잠결에 용왕이 눈을 떠 보니, 침상 곁에 흰 옷을 입은 노인이 서 있었습니다. 수염이 가슴까지 내려오고 손에는 지팡이를 들고 있었습니다.`,
            `"뉘, 뉘시오?"<br>"나는 이 바다를 오래 지켜본 사람이오. 대왕의 병을 고칠 약을 하나 알고 있어 왔소."`,
            `용왕이 겨우 몸을 일으켰습니다.<br>"말씀해 주시오. 무엇이든 구해 오겠소."`,
            `노인은 한참 동안 용왕을 내려다보았습니다. 그러고는 천천히 입을 열었습니다.<br>"대왕의 병은 물에서 난 병이 아니오. 그러니 물에서 난 약으로는 낫지 않소."`,
            `"그럼 어찌해야 합니까?"<br>"뭍에 사는 짐승 가운데 토끼라는 것이 있소. 그 토끼의 간을 산 채로 얻어 잡수시면 씻은 듯이 나을 것이오."`,
            `"토끼라……." 용왕이 되뇌었습니다. "그것이 어떻게 생긴 짐승입니까?"<br>"귀가 길고 눈이 붉고 뒷다리가 앞다리보다 긴 짐승이오. 산속을 뛰어다니며 풀을 뜯어 먹고 사는데, 겁이 아주 많고 꾀도 아주 많소."`,
            `"꾀가 많다니요?"<br>노인이 처음으로 웃었습니다.<br>"세상 짐승 가운데 제 목숨을 지키는 재주로 그만한 것이 없소. 그러니 데려오려거든 힘으로 될 일이 아니라는 것만은 알아 두시오."`,
            `용왕이 무어라 물으려는데 노인의 모습이 스르르 흐려졌습니다. 정신을 차려 보니 침상 곁에는 아무도 없었습니다. 다만 방 안에 낯선 풀 냄새가 남아 있었습니다.`,
            `이튿날 아침, 용왕은 신하들을 모두 불러들였습니다. 목소리에 오랜만에 힘이 실려 있었습니다.<br>"간밤에 신선이 다녀갔다. 내 병에는 토끼의 간이 약이라 하더구나."`,
            `수궁 대신들이 서로 얼굴을 마주 보았습니다.<br>"토끼라 하면 육지 짐승이 아닙니까."<br>"그렇다. 그러니 누군가 육지로 나가야 한다."`,
            `순간 넓은 조정이 물속처럼 조용해졌습니다. 아니, 물속이었지만 그보다 더 조용했습니다.`,
            `용왕이 신하들의 얼굴을 하나하나 훑어보았습니다.<br>"누가 가겠느냐?"`,
            `아무도 대답하지 않았습니다. 문어 승상은 다리 여덟 개를 슬그머니 몸 아래로 말아 넣었고, 상어 장군은 갑자기 천장을 올려다보았습니다. 조기 대감은 눈을 껌뻑껌뻑하기만 했습니다.`,
            `"어허, 대답이 없구나."<br>용왕의 목소리가 조금 높아졌습니다. 그제야 신하들이 하나둘 입을 열었습니다. 그런데 그것이 하나같이 남에게 미루는 말이었습니다.`
        ]
    },
    {
        num: 2,
        ...
        paras: [
            `먼저 문어 승상이 나섰습니다.<br>"신은 다리가 여덟이라 헤엄은 잘 칩니다만, 뭍에 오르면 다리가 하나도 소용이 없습니다. 바싹 말라붙고 말 것이니 아무래도 상어 장군이 마땅할 듯합니다."`,
            `상어 장군이 펄쩍 뛰었습니다.<br>"신이 뭍에 오르면 어찌 되겠습니까. 이 큰 몸이 모래밭에 얹히면 그대로 끝입니다. 게다가 신은 생김새가 험해서 토끼가 보기만 해도 달아날 것입니다. 조기 대감이 어떻겠습니까."`,
            `조기 대감이 지느러미를 홰홰 저었습니다.<br>"신은 뭍에 오르면 곧바로 소금에 절여져 굴비가 되고 맙니다. 그것은 신 하나 죽는 일로 끝나지 않고 나라의 체면이 걸린 일입니다."`,
            `듣고 있던 용왕의 얼굴이 붉어졌다 푸르러졌다 했습니다.<br>"그러면 게 대감은 어떠한가."<br>"신은 옆으로만 걷습니다. 곧장 가야 할 길을 옆으로만 가서야 언제 산에 닿겠습니까."`,
            `"고래 장군은?"<br>"신은 몸이 너무 커서 갯가에 닿기도 전에 배가 땅에 걸립니다."`,
            `"새우 대감은?"<br>"신은 몸이 너무 작아 산길에서 밟혀 죽습니다."`,
            `크면 커서 못 가고, 작으면 작아서 못 가고, 험하게 생겨서 못 가고, 옆으로 걸어서 못 갔습니다. 온 조정이 못 간다는 말로만 가득 찼습니다.`,
            `용왕이 마침내 자리에서 몸을 일으켰습니다. 야윈 손이 부들부들 떨렸습니다.<br>"내가 그동안 너희를 어떻게 대접하였느냐. 좋은 자리에 앉히고 좋은 것을 먹였다. 그런데 이 나라에 나를 위해 뭍에 오를 자가 하나도 없단 말이냐."`,
            `그 말에 신하들이 일제히 고개를 숙였습니다. 그러나 여전히 나서는 이는 없었습니다.`,
            `그때 조정 맨 끝자리에서 목소리 하나가 들려왔습니다. 크지도 않고 떨리지도 않는 목소리였습니다.<br>"신이 다녀오겠습니다."`,
            `모두가 소리 나는 쪽을 돌아보았습니다. 기둥 아래 자리에 자라 한 마리가 엎드려 있었습니다. 벼슬이 높지 않아 평소에는 말할 차례조차 오지 않던 별주부였습니다.`,
            `대신들이 웅성거렸습니다.<br>"저 작은 것이 무슨 수로."<br>"헤엄이 느리기로는 수궁에서 으뜸인데."`,
            `자라는 그 말들을 못 들은 척하고 앞으로 걸어 나왔습니다. 걸음이 정말로 느렸습니다. 조정을 가로지르는 데만 한참이 걸렸습니다.`,
            ...
            `용왕이 자라를 오래 내려다보았습니다.<br>"그동안 내가 너를 몰라보았구나."<br>"신을 알아보고 말고 할 것이 무엇 있겠습니까. 다만 갈 수 있는 자가 가는 것이 마땅할 뿐입니다."`,
            `그러자 아까까지 못 간다던 대신들이 갑자기 말이 많아졌습니다.<br>"과연 별주부요!"<br>"내 진작부터 저 사람이 보통이 아니라 생각했소."<br>자라는 고개를 돌리지 않았습니다.`,
            `용왕이 물었습니다.<br>"그래, 무엇이 필요하냐. 군사를 붙여 주랴? 보물을 지워 주랴?"`,
            `"군사는 소용없습니다. 여럿이 가면 토끼가 먼저 달아납니다. 보물도 무겁기만 합니다."<br>"그러면 무엇이 필요하냐."<br>"토끼의 생김새를 그린 그림 한 장이면 됩니다."`,
            `"그림이라?"<br>"신은 평생 바닷속에서만 살아 토끼라는 것을 본 적이 없습니다. 산에 올라가서 아무나 붙들고 물을 수도 없는 노릇이니, 눈으로 알아볼 수 있어야 합니다."`,
            `용왕이 무릎을 쳤습니다.<br>"과연 생각이 깊구나. 화공을 부르라."`,
            `그날 밤 자라는 제 집으로 돌아가 늙은 어머니에게 절을 올렸습니다.<br>"먼 길을 다녀오겠습니다."<br>어머니 자라가 아들의 등딱지를 오래 쓰다듬었습니다.<br>"몸조심하여라. 그리고 무슨 일이 있어도 거짓말은 하지 마라."<br>자라는 그 말에 얼른 대답하지 못했습니다.`
        ]
    },
    {
        num: 3,
        ...
        paras: [
            `이튿날 아침, 수궁에서 가장 그림을 잘 그린다는 화공이 불려 왔습니다. 화공은 붓과 벼루를 갖추어 놓고 자리에 앉았습니다.`,
            `그러나 곧 난처한 얼굴이 되었습니다.<br>"신도 토끼를 본 적이 없습니다."`,
            `조정이 다시 술렁였습니다. 그때 늙은 거북 하나가 앞으로 나왔습니다. 젊었을 적에 갯가에 여러 번 올라가 보았다는 거북이었습니다.<br>"내가 말하는 대로 그려 보시오."`,
            `거북이 눈을 감고 옛 기억을 더듬으며 말했습니다.<br>"먼저 몸은 어른 주먹 두 개를 붙여 놓은 만하게 그리시오. 털은 잿빛이 도는 갈색이고, 배 쪽은 희끗하오."`,
            `붓이 종이 위를 스윽 지나갔습니다.<br>"귀를 그리시오. 아주 길게. 그 몸에 어울리지 않을 만큼 길게 그려야 하오. 끝은 검은빛이 도오."`,
            `"눈은 어떠하오?"<br>"눈은 붉소. 놀란 것처럼 늘 동그랗게 뜨고 있소. 코는 작고 늘 실룩거리며, 입술은 위쪽이 셋으로 갈라져 있소."`,
            `"다리는?"<br>"앞다리는 짧고 뒷다리가 아주 기오. 그래서 걷는 것이 아니라 뛰오. 앉아 있을 때는 뒷다리를 접고 앞다리로 몸을 세우오. 꼬리는 짧고 동그랗소."`,
            `화공의 붓이 마지막으로 한 번 지나가자, 종이 위에 없던 짐승 한 마리가 나타났습니다. 귀가 길고 눈이 붉고 뒷다리가 긴 짐승이었습니다.`,
            `수궁 신하들이 그림을 빙 둘러싸고 들여다보았습니다.<br>"거참 우습게도 생겼구나."<br>"저것의 간이 그렇게 좋다는 말이지."`,
            `용왕이 그림을 자라에게 내주었습니다. 자라는 그림을 곱게 말아 등딱지 밑에 단단히 끼워 넣었습니다.`,
            `"별주부야."<br>"예, 대왕."<br>"살아서 돌아오너라. 토끼를 못 데려와도 좋다."<br>자라가 처음으로 고개를 들어 용왕을 마주 보았습니다. 그러고는 아무 말 없이 절을 올렸습니다.`,
            `수궁의 온 신하가 궁문 밖까지 나와 자라를 배웅했습니다. 자라는 뒤를 한 번도 돌아보지 않고 물살을 헤치며 위로, 위로 올라갔습니다.`,
            `물빛이 점점 밝아지더니 어느 순간 머리 위가 환해졌습니다. 자라가 처음으로 물 밖에 머리를 내밀었습니다.`,
            `숨이 턱 막혔습니다. 공기라는 것이 이렇게 가볍고 마른 것인 줄 몰랐습니다. 햇빛이 어찌나 밝은지 눈을 제대로 뜰 수가 없었습니다.`,
            `자라는 모래밭을 기어올라 갔습니다. 물속에서는 몸이 저절로 떠올랐는데 뭍에서는 등딱지가 바위처럼 무거웠습니다. 백 걸음을 가고 한 번 쉬고, 백 걸음을 가고 또 쉬었습니다.`,
            `그렇게 사흘을 기어 마침내 산자락에 닿았습니다. 소나무가 늘어서고 시냇물이 흐르는 곳이었습니다. 자라는 바위 그늘에 엎드려 숨을 골랐습니다.`,
            `그때 산 위쪽에서 왁자한 소리가 들려왔습니다. 자라가 조심조심 다가가 보니, 넓은 풀밭에 온갖 짐승이 모여 있었습니다.`,
            ...
            `그때 뒤쪽에서 조그만 목소리가 튀어나왔습니다.<br>"그러지 말고 이렇게 합시다. 여기 있는 이들 가운데 아침 해를 가장 먼저 본 이가 윗자리에 앉기로."`,
            `짐승들이 일제히 그쪽을 돌아보았습니다. 뒷다리를 접고 앉은 작은 짐승 하나가 앞발을 들고 있었습니다. 귀가 길고 눈이 붉었습니다.`,
            `자라의 가슴이 쿵 내려앉았습니다. 얼른 등딱지 밑에서 그림을 꺼내 펼쳐 보았습니다. 그림 속 짐승과 저 짐승이 꼭 같았습니다.`,
            `"찾았다."<br>자라는 숨을 죽이고 바위 뒤에 몸을 낮추었습니다.`,
            `풀밭에서는 다툼이 계속되고 있었습니다. 결국 아무도 윗자리에 앉지 못했고, 짐승들은 저마다 투덜거리며 흩어졌습니다. 토끼는 마지막까지 남아 남이 흘린 밤톨을 주워 먹고 있었습니다.`
        ]
    },
    {
        num: 4,
        ...
        paras: [
            `자라가 슬금슬금 걸어 나갔습니다. 토끼가 먼저 알아채고 뒷다리에 힘을 주었습니다.<br>"거 누구요?"`,
            `"놀라지 마시오. 나는 남해 수궁에서 온 별주부라 하오."<br>토끼가 자라의 등딱지를 위아래로 훑어보았습니다.<br>"수궁? 물속에 있다는 그 궁궐 말이오?"<br>"그렇소."`,
            `토끼가 코를 실룩거렸습니다.<br>"그런 데서 여기까지는 왜 왔소."<br>"인재를 찾으러 왔소."`,
            `"인재?"<br>"우리 대왕께서 뭍에 슬기로운 짐승이 하나 있다는 말을 들으셨소. 데려다 벼슬을 내리고 싶어 하시오. 아까 그 자리싸움에서 나서는 것을 보니, 과연 그 말이 헛말이 아니었소."`,
            `토끼의 두 귀가 쫑긋 섰습니다.<br>"내가……. 그렇소? 하기야 이 산중에서 나만한 머리가 어디 있겠소."`,
            `자라는 속으로만 웃고 겉으로는 정색을 했습니다.<br>"그런데 산중 살림이 어떠하오?"`,
            `그 말에 토끼의 얼굴이 대번에 어두워졌습니다.<br>"말도 마시오. 봄에는 굶주린 짐승들이 눈에 불을 켜고 다니고, 여름에는 뱀이 들끓고, 가을에는 사냥꾼이 덫을 놓고, 겨울에는 먹을 것이 없어 나무껍질을 갉아 먹소. 하루도 마음 놓고 잠들어 본 적이 없소."`,
            `"그럴 것이오." 자라가 고개를 끄덕였습니다. "그러니 수궁 이야기를 좀 들어 보시오."`,
            `자라가 목소리를 낮추었습니다.<br>"수궁에는 사냥꾼이 없소. 덫도 없고 독수리도 없소. 궁궐은 수정으로 지어 기둥이 산호요 지붕이 자개라, 물살이 지날 때마다 무지개가 이오. 상에는 진주가 굴러다니고, 먹을 것은 사철 넘치오."`,
            `토끼의 붉은 눈이 점점 커졌습니다.<br>"게다가 대왕께서 그대에게 벼슬을 내리겠다 하셨소. 관을 쓰고 옥대를 두르고 높은 자리에 앉게 되는 것이오."`,
            `"벼, 벼슬을……." 토끼가 침을 꿀꺽 삼켰습니다.<br>"어떻소, 나와 함께 가지 않겠소?"`,
            `토끼는 얼른 대답하지 못했습니다. 그러나 두 귀는 이미 자라 쪽으로 바짝 기울어 있었습니다.`,
            `그때 머리 위 소나무 가지에서 까마귀 한 마리가 깍 하고 울었습니다.<br>"토끼야, 가지 마라."`,
            `토끼가 위를 올려다보았습니다.<br>"너는 또 왜 참견이냐."<br>"내가 그 바닷가에서 오래 살았다. 물에 사는 것들이 뭍에 올라오는 일은 없다. 하물며 벼슬을 주겠다고 기어 올라오는 일은 더더욱 없다."`,
            `자라의 등딱지 밑에서 식은땀이 흘렀습니다. 그러나 겉으로는 껄껄 웃었습니다.<br>"저 새가 나를 시기하는 모양이오. 남이 잘되는 꼴을 못 보는 것이지."`,
            `까마귀가 다시 울었습니다.<br>"토끼야, 잘 생각해라. 저 짐승이 너에게 무엇을 얻으려 하는지 물어보아라. 세상에 까닭 없이 좋은 것을 주는 이는 없다."`,
            `토끼가 잠시 망설였습니다. 그 순간 자라가 한 걸음 물러섰습니다.<br>"정 그러면 그만두시오. 나도 여기까지 오느라 사흘을 기었소. 그대가 싫다면 다른 이를 찾아보겠소. 이 산에 슬기로운 짐승이 그대 하나뿐이겠소."`,
            `그러고는 정말로 몸을 돌려 내려가기 시작했습니다. 걸음이 어찌나 느린지 열 걸음을 가는 데도 한참이 걸렸습니다.`,
            `토끼가 그 뒷모습을 보았습니다. 그러자 다른 짐승이 관을 쓰고 옥대를 두르고 높은 자리에 앉아 있는 모습이 눈앞에 어른거렸습니다. 아까 풀밭에서 저를 밀어내던 여우의 얼굴도 떠올랐습니다.`,
            `"자, 잠깐!"<br>토끼가 껑충 뛰어 자라를 앞질렀습니다.<br>"가겠소. 내가 가겠소."`,
            `까마귀가 가지 위에서 몇 번이나 더 울었습니다. 토끼는 한 번도 위를 올려다보지 않았습니다.`,
            `자라가 물었습니다.<br>"헤엄은 칠 줄 아오?"<br>"그건 못 하오."<br>"그러면 내 등에 타시오. 눈을 감고 있으면 물이 코로 들어오지 않소."`,
            `토끼가 자라의 등딱지 위에 올라앉았습니다. 등딱지는 넓고 단단해서 앉기에 꼭 알맞았습니다.`,
            `모래밭을 지나 물가에 이르렀습니다. 자라가 물속으로 몸을 들이밀자 토끼는 두 눈을 꼭 감았습니다. 마지막으로 산 쪽에서 까마귀 우는 소리가 아득하게 들려왔습니다.`
        ]
    },
    {
        num: 5,
        ...
        paras: [
            `얼마쯤 갔을까요. 자라가 말했습니다.<br>"이제 눈을 떠도 되오."`,
            `토끼가 눈을 뜬 순간 숨이 멎는 줄 알았습니다. 사방이 푸른 빛으로 가득했습니다. 물고기 떼가 무리 지어 지나가고, 산호가 숲처럼 자라 있고, 바닥에서는 조개가 입을 벌렸다 오므렸다 했습니다.`,
            `그리고 저 앞에 궁궐이 있었습니다. 자라가 말한 그대로였습니다. 기둥은 산호요 지붕은 자개라, 물살이 지날 때마다 온 궁이 무지갯빛으로 일렁였습니다.`,
            `"과연!" 토끼가 감탄했습니다. "내 평생 이런 것은 처음 보오."`,
            `궁문이 열리고 신하들이 죽 늘어서 있었습니다. 그런데 토끼를 보는 눈들이 어쩐지 이상했습니다. 반가워하는 것도 아니고 놀라는 것도 아닌, 무언가를 아까워하는 듯한 눈이었습니다.`,
            `토끼는 잠깐 걸음을 멈추었습니다. 그러나 곧 스스로를 다독였습니다. 새로 온 자를 처음부터 반겨 주는 자리가 어디 있겠느냐고 말입니다.`,
            `너른 대궐 안으로 들어서니 높은 자리에 용왕이 앉아 있었습니다. 야윈 얼굴이었지만 두 눈만은 무섭게 빛나고 있었습니다.`,
            `"저것이 토끼렷다."<br>"그러하옵니다." 자라가 엎드려 아뢰었습니다.<br>"수고했다. 물러가 쉬어라."`,
            `자라가 물러났습니다. 그런데 물러나면서 토끼 쪽을 한 번도 보지 않았습니다.`,
            `토끼가 앞으로 나아가 절을 올렸습니다.<br>"산중에 사는 미천한 것이 대왕을 뵈옵니다. 벼슬을 내리신다는 말씀을 듣고 왔사옵니다."`,
            `그 말에 대궐 안이 잠시 조용해졌습니다. 그러고는 여기저기서 킥킥거리는 소리가 났습니다.`,
            `용왕이 손을 들어 조용히 시켰습니다. 그러고는 아주 천천히 입을 열었습니다.<br>"벼슬이라……. 그래, 벼슬보다 더 큰 것을 주마. 네 이름이 이 바다에 길이 남을 것이다."`,
            `"여봐라."<br>용왕의 목소리가 대궐을 울렸습니다.<br>"저 토끼의 배를 갈라 간을 꺼내어라."`,
            `토끼의 온몸이 얼음이 되었습니다.<br>"예? 지, 지금 무어라 하셨습니까?"`,
            `"내 병에는 산 토끼의 간이 약이라 하였다. 네가 여기까지 온 것은 그 때문이다."<br>군사들이 창을 들고 다가왔습니다.`,
            `토끼의 머릿속이 새하얘졌습니다. 소나무 가지에서 울던 까마귀 소리가 그제야 또렷하게 되살아났습니다. 세상에 까닭 없이 좋은 것을 주는 이는 없다던 그 말이었습니다.`,
            `그러나 토끼는 산중에서 제 목숨을 지키며 살아온 짐승이었습니다. 다리가 후들거리는 그 순간에도 머리만은 무섭게 돌아갔습니다.`,
            `창끝이 목에 닿기 직전, 토끼가 갑자기 무릎을 치며 큰 소리로 웃었습니다.<br>"아이고, 이런 낭패가 있나!"`,
            `용왕이 손을 들어 군사를 멈춰 세웠습니다.<br>"무엇이 낭패란 말이냐."`,
            `"대왕이시여, 진작 말씀을 하셨더라면 좋았을 것을. 소인의 간이 필요하셨다면 그저 그렇게 말씀하시면 될 일이 아니었습니까. 무엇하러 벼슬이니 무어니 하는 거짓말로 사람을 데려오셨습니까."`,
            `"그게 무슨 말이냐."<br>"소인의 간은 지금 뱃속에 없습니다."`,
            `대궐 안이 술렁였습니다. 용왕의 눈썹이 꿈틀했습니다.<br>"간이 없다니. 그런 짐승이 어디 있느냐."`,
            ...
            `"그러면 지금은?"<br>"마침 어제가 씻는 날이었습니다. 지금 소인의 간은 산속 바위틈에 볕을 쬐고 있습니다. 배를 가르셔도 헛수고이십니다. 못 믿으시겠거든 어디 갈라 보십시오."<br>그러고는 배를 쭉 내밀었습니다.`
        ]
    },
    {
        num: 6,
        ...
        paras: [
            `용왕이 한참 동안 토끼를 노려보았습니다. 토끼는 눈 하나 깜짝하지 않았습니다.`,
            `문어 승상이 조심스레 아뢰었습니다.<br>"대왕이시여, 배를 갈랐다가 정말로 간이 없으면 저것도 잃고 약도 잃습니다."<br>다른 대신들도 고개를 끄덕였습니다.`,
            `그때 자라가 앞으로 나섰습니다.<br>"대왕이시여, 저 말은 거짓입니다. 짐승이 어찌 간을 꺼내 두고 삽니까."`,
            `토끼가 자라를 돌아보았습니다. 그리고 아주 서운한 얼굴을 지어 보였습니다.<br>"별주부, 그대야말로 나에게 벼슬을 준다 하지 않았소. 그 말은 참이었소?"`,
            `자라가 말문이 막혔습니다. 대궐 안이 조용해졌습니다. 거짓말을 한 쪽은 자라였고, 그것을 모두가 보고 있었습니다.`,
            `용왕이 길게 숨을 내쉬었습니다.<br>"토끼야, 네 말이 참이라면 어찌하겠느냐."<br>"소인을 뭍에 데려다주십시오. 반나절이면 간을 찾아 돌아오겠습니다. 대왕의 병을 고치고 큰 상까지 받을 일을 무엇하러 마다하겠습니까."`,
            `그 말이 그럴듯하게 들렸습니다. 용왕은 마침내 고개를 끄덕였습니다.<br>"그리하여라. 다만 오늘 저지른 무례는 잊어 주마. 네 간을 가져오면 그때는 정말로 벼슬을 내리겠다."`,
            `그날 저녁 수궁에서는 큰 잔치가 열렸습니다. 토끼는 상석에 앉아 진귀한 음식을 배가 터지도록 먹었습니다. 다만 술만은 한 방울도 입에 대지 않았습니다.`,
            `이튿날 새벽, 자라가 토끼를 등에 태우고 다시 물길을 올랐습니다. 둘 다 아무 말이 없었습니다.`,
            `모래밭에 닿자 토끼가 등딱지에서 폴짝 뛰어내렸습니다. 그러고는 앞발로 흙을 몇 번 긁어 보고, 코를 실룩거려 풀 냄새를 맡아 보았습니다.`,
            `"별주부."<br>"어서 가서 간을 가져오시오."<br>토끼가 씩 웃었습니다.<br>"세상에 간을 꺼내 놓고 사는 짐승이 어디 있소."`,
            `자라가 그 자리에 굳어 버렸습니다. 토끼는 이미 열 걸음 밖에 있었습니다.<br>"그대가 나를 속였으니 나도 그대를 속인 것이오. 이만하면 셈이 맞지 않소?"<br>그러고는 산 쪽으로 껑충껑충 뛰어 사라졌습니다.`,
            `자라는 한나절이 넘도록 그 모래밭에 그대로 엎드려 있었습니다. 해가 기울고 물이 발끝까지 밀려와도 움직이지 않았습니다.`,
            `무슨 낯으로 수궁에 돌아간단 말입니까. 대왕은 여전히 자리에 누워 계신데 저는 빈손이었습니다. 게다가 대궐 한복판에서 거짓말쟁이가 되었습니다.`,
            `자라의 눈에서 눈물이 뚝뚝 떨어져 모래에 스몄습니다.<br>"어머니께서 무슨 일이 있어도 거짓말은 하지 말라 하셨는데."`,
            `그때 등 뒤에서 목소리가 들려왔습니다.<br>"울지 마라."`,
            ...
            `자라가 얼른 엎드렸습니다.<br>"어르신, 소인은 토끼를 놓쳤습니다. 대왕을 살릴 길이 없어졌습니다."`,
            `노인이 지팡이로 모래를 짚으며 말했습니다.<br>"내가 토끼의 간을 말한 것은 약을 알려 준 것이 아니었다. 이 넓은 나라에 임금을 위해 뭍에 오를 자가 하나라도 있는지 보고자 한 것이다."`,
            `"예?"<br>"큰 벼슬을 한 자들은 모두 못 간다 하였고, 아무 벼슬도 없던 네가 가겠다 하였다. 그것으로 되었다."`,
            `노인이 품에서 조그만 뿌리 하나를 꺼내 자라 앞에 놓았습니다. 흙빛이 도는 늙은 산삼이었습니다.<br>"이것을 달여 드시게 하여라. 사흘이면 일어나실 것이다."`,
            `자라가 고개를 들었을 때 노인은 이미 없었습니다. 모래밭에는 지팡이 자국만 몇 개 남아 있었습니다.`,
            `자라가 산삼을 등딱지 밑에 끼우고 물로 들어갔습니다. 사흘 뒤, 남해 용왕은 자리를 털고 일어났습니다.`,
            ...
            `용왕은 한참 만에 고개를 끄덕였습니다. 그러고는 자라를 조정 맨 앞자리에 앉히되 벼슬 이름은 붙이지 않았습니다. 벼슬 없이 앞자리에 앉은 신하는 수궁이 생긴 이래 처음이었습니다.`,
    ...
    return `
        <div class="page page-cover">
            ...
            <div class="story-page-right">
                ...
                <p>조선 후기에는 같은 이야기의 결말이 수십 가지로 갈렸어요. 토끼가 달아나는 데서 끝나는 것도 있고, 자라가 벌을 받는 것도 있고, 이 책처럼 용왕이 다른 약으로 낫는 것도 있지요. 듣는 사람들이 저마다 바라는 결말이 달랐던 것이랍니다.</p>
            </div>
        </div>`;
}
...
const QUIZ = [
    ...
    { q: "도사가 일러 준 약은 무엇입니까?", choices: ["천 년 묵은 산삼", "용의 비늘 가루", "산 토끼의 간"], answer: 2 },
    ...
    { q: "용왕의 병은 끝내 무엇으로 나았습니까?", choices: ["토끼가 보낸 간", "수궁 의원의 침", "도사가 준 선약"], answer: 2 },
