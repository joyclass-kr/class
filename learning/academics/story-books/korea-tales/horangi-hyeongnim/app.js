    ...
    return `
        <div class="page page-cover">
            ...
            <div class="story-page-right">
                <h1>나무꾼과 호랑이 형님</h1>
                <p>나무꾼과 호랑이 형님은 지은이가 없는 구전 설화예요. 잡아먹힐 뻔한 나무꾼이 호랑이를 형님이라 부르면서 살아나는 이야기랍니다.</p>
                <p>우리 옛이야기의 호랑이는 무섭기도 하지만 정이 많고 어수룩하기도 해요. 이 이야기의 호랑이는 그 가운데 가장 마음이 여린 축이지요.</p>
                <p>옛날에는 산에서 죽거나 사라진 사람을 두고 호랑이가 되었다고 말하는 일이 있었어요. 무서운 짐승을 식구로 여겨 두려움을 달래던 마음이 담긴 말이랍니다.</p>
                <p>고을마다 끝이 달라요. 호랑이가 끝내 정체를 모르는 판본도 있고, 이 책처럼 알면서도 모른 척했다는 판본도 전해진답니다.</p>
            </div>
        </div>`;
}
