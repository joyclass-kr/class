        ...
        beats: [
            {
                ...
                left: [
                    ...
                    "논이 몇십 마지기에 곳간이 세 채나 되었지요.",
                    "그런데 그 집을 보면 아무도 부자인 줄 몰랐어요.",
                    "대문 앞에 서면 다 쓰러져 가는 초가집 같았어요."
                ],
                right: [
                    "지붕은 군데군데 내려앉고 담은 기울어져 있었지요.",
                    "마당에는 잡초가 무성했어요.",
                    "\"저 집이 부잣집이라고?\"",
                    "\"쉿, 자린고비 어른 댁일세.\"",
                    "사람들이 지나가며 수군거렸지요."
            ...
            },
            {
                ...
                left: [
                    ...
                    "온 식구가 상 앞에 둘러앉았어요.",
                    "밥과 물 한 사발.",
                    "그것이 전부였습니다. 대신 천장에 굴비 한 마리가 대롱대롱 매달려 있었지요.",
                    "나물 한 접시도 없었지요."
                ],
                right: [
                    "\"자, 한 술 뜨고 한 번 보아라.\"",
                    "자린고비가 숟가락을 들며 말했어요.",
                    "식구들이 밥을 한 술 뜨고 고개를 들어 굴비를 보았어요.",
                    "그것이 이 집의 반찬이었답니다."
                ]
            },
            {
            ...
            },
            {
                ...
                left: [
                    "여름날이었어요.",
                    "땀이 등줄기로 줄줄 흘렀어요.",
                    "자린고비가 부채를 펴 들고 가만히 앉아 있었습니다.",
                    "그런데 부채질을 하지 않는 거예요."
                ],
                right: [
                    "그러고는 부채는 꼼짝도 않고 제 고개만 좌우로 흔드는 거예요.",
                    "옆에서 보던 아들이 눈이 휘둥그레졌어요.",
                    "\"부채를 부치면 부채가 닳지 않느냐.\"",
                    "\"아이고, 어르신…\"",
                    "아들은 그만 할 말을 잃었답니다."
                ]
        ...
        beats: [
            ...
            },
            {
                ...
                left: [
                    ...
                    "파리를 한양까지 쫓아갔다는 이야기였지요.",
                    "\"충주에 나보다 더한 자가 있다고?\"",
                    "구두쇠는 그 말을 듣고 발끈했어요."
                ],
                right: [
                    "구두쇠는 봇짐을 지고 충주로 길을 떠났어요.",
                    "봇짐에는 주먹밥 하나뿐이었어요.",
                    "\"어디 한번 겨루어 보자.\"",
                    "사흘을 꼬박 걸어 충주에 닿았지요."
                ]
            },
            {
                ...
                left: [
                    "구두쇠가 대문을 두드렸어요.",
                    "구두쇠는 인사도 없이 안으로 들어섰어요.",
                    "자린고비는 반갑게 맞아들여 밥상을 내주었습니다.",
                    "밥 한 그릇에 물 한 사발이었지요."
                ],
                right: [
                    "천장에는 어김없이 굴비가 매달려 있었지요.",
                    "구두쇠는 밥만 먹고 굴비는 한 번도 쳐다보지 않았어요.",
                    "\"보면 밥을 더 먹게 되지 않소.\"",
                    "자린고비가 그만 무릎을 탁 쳤답니다."
                ]
            }
        ...
        beats: [
            {
                ...
                right: [
                    "가을이 되어도 거둘 것이 없었지요. 마을 사람들은 나무껍질을 벗겨 죽을 쑤었어요. 아이들 울음소리가 밤새 끊이지 않았답니다.",
                    "벼는 다 말라 죽었어요.",
                    "온 마을이 굶주렸답니다."
                ]
            },
            {
                ...
                left: [
                    ...
                    "곳간 세 채가 그대로 있었으니까요.",
                    "\"그 양반이 쌀 한 톨을 내놓겠나.\"",
                    "사람들이 담 너머를 흘깃거리며 수군거렸어요.",
                    "\"어림도 없지.\""
                ],
                right: [
                    "그날 밤, 자린고비네 곳간에 불이 환하게 켜졌습니다.",
                    "사람들이 담 밖에서 그것을 지켜보았어요.",
                    "\"보게, 밤새 쌀가마나 세고 있겠지.\"",
                    "다들 그렇게만 여겼지요."
                ]
            },
            {
                ...
                left: [
                    ...
                    "동이 트기도 전이었어요.",
                    "쌀가마가 마당 가득 줄지어 나와 있었지요.",
                    "자린고비가 손수 문을 밀어젖혔지요."
                ],
                right: [
                    "\"한 집에 한 가마씩 가져가시오!\"",
                    "자린고비가 마당에서 큰 소리로 외쳤어요.",
                    "마을 사람들이 그 자리에 얼어붙었어요.",
                    "잘못 들은 줄 알았거든요."
                ]
            },
            {
            ...
            },
            {
                ...
                right: [
                    ...
                    "막내가 슬쩍 두 번을 쳐다보았지요. 이번에는 자린고비도 못 본 척했답니다.",
                    "그저 물그릇만 내밀었답니다."
                ]
            }
        ],
...
const QUIZ = [
    { q: "자린고비는 천장에 무엇을 매달았나요?", choices: ["엽전 한 꾸러미", "굴비 한 마리", "말린 나물 한 줌"], answer: 1 },
    { q: "밥 한 술에 굴비를 몇 번 보게 했나요?", choices: ["세 번", "마음껏", "한 번"], answer: 2 },
    ...
    { q: "흉년이 들었을 때 자린고비는 무엇을 했나요?", choices: ["곳간을 열었다", "곳간을 더 잠갔다", "곡식을 비싸게 팔았다"], answer: 0 },
    ...
    spreads: [
        {
            ...
            right: [
                "그러니 무엇을 아끼느냐보다 무엇을 위해 아끼느냐가 그 사람을 말해 줍니다.",
                "자린고비는 처음부터 그날을 생각하고 아꼈을까요? 답은 적어 두지 않겠습니다."
            ]
        }
    ]
};
