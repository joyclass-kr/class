        ...
        beats: [
            {
                ...
                emoji: "🐯",
                left: [
                    "깊은 산속에 호랑이 한 마리가 살았습니다.",
                    "\"어흥… 배고파 죽겠네.\"",
                    "사흘째 아무것도 못 먹은 호랑이였어요."
                ],
                right: [
                    "호랑이는 어슬렁어슬렁 산을 내려왔습니다.",
                    "'마을에 가면 뭐라도 있겠지.'",
                    "어느새 캄캄한 밤이었어요."
                ]
            },
            {
                ...
                emoji: "👶",
                left: [
                    "마을 어귀 어느 집 앞에서 호랑이가 발을 멈췄습니다.",
                    "\"으앙! 으아앙!\""
                ],
                right: [
                    "안에서 아기 우는 소리가 들렸거든요. 호랑이는 침을 꿀꺽 삼켰어요.",
                    "'옳지, 오늘 저녁은 저걸로 하자.'",
                    "그러고는 문에 귀를 딱 붙였습니다."
                ]
            },
        ...
        beats: [
            {
                ...
                right: [
                    "방 안이 조용해졌습니다. 문밖의 호랑이는 그 자리에 얼어붙었어요.",
                    "'고, 곶감?'"
                ]
            },
            {
            ...
            },
            {
                ...
                emoji: "🥷",
                left: [
                    "바로 그때, 담을 넘는 그림자가 있었습니다. 소도둑이었어요.",
                    "'오늘은 이 집 소를 끌고 가야지.'"
                ],
                right: [
                    "소도둑은 캄캄한 외양간으로 살금살금 들어갔습니다.",
                    "손을 뻗자 털이 북슬북슬한 등이 만져졌어요.",
                    "'옳지, 여기 있구나!'"
                ]
            }
        ]
        ...
        beats: [
            {
                ...
                left: [
                    "소도둑은 그 등에 훌쩍 올라탔습니다.",
                    "그런데 그건 소가 아니었어요. 겁에 질려 외양간에 숨어 있던 호랑이였지요."
                ],
                right: [
                    "호랑이는 소스라치게 놀랐습니다.",
                    "'으악! 고, 곶감이다!'",
            ...
            },
            {
                ...
                left: [
                    ...
                    "바람처럼, 화살처럼.",
                    "논두렁을 지나고 개울을 뛰어넘었습니다."
                ],
                right: [
                    "등에 탄 소도둑은 눈이 휘둥그레졌어요.",
                    "\"어? 이 소가 왜 이렇게 빨라?\"",
                    "\"세워라! 세우라니까!\""
                ]
            },
            {
                ...
                left: [
                    "동쪽 하늘이 부옇게 밝아 왔습니다.",
                    "소도둑이 아래를 힐끗 내려다본 순간, 노랗고 까만 줄무늬가 눈에 들어왔어요."
                ],
                right: [
                    "\"허, 헉! 호랑이잖아!\"",
                    "소도둑은 머리 위로 지나가는 나뭇가지를 냅다 붙잡고 대롱대롱 매달렸습니다."
                ]
            },
            {
                art: "10-flee.webp",
                ...
                right: [
                    "나뭇가지에 매달린 소도둑도 반대쪽으로 줄행랑을 쳤습니다.",
