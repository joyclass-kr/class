...
const CHAPTERS = [
    {
        ...
        paras: [
            ...
            "그래도 열두 아이의 입을 채우기에는 턱없이 모자랐습니다. 아이들은 하나같이 배를 곯았습니다. 젖먹이는 빈 젖을 물고 울다 지쳐 잠들었습니다. 젖먹이는 젖이 나오지 않아 밤새 보챘습니다.",
    ...
    },
    {
        ...
        paras: [
            ...
            "제비 부부는 진흙을 물어다 부지런히 집을 지었습니다. 얼마 뒤 새끼 다섯 마리가 깨어났습니다. 노란 입을 짝짝 벌리는 소리가 온종일 그치지 않았습니다. 흥부네 식구는 그 소리를 들으며 하루를 시작했습니다. 새끼들이 자라는 것을 보는 것이 흥부네 낙이었습니다.",
            ...
            "흥부가 지게 작대기를 들고 뛰어들었습니다.<br>\"이놈! 저리 가라!\"<br>작대기로 땅을 요란하게 두드리자 구렁이가 스르르 담 밖으로 빠져나갔습니다. 흥부의 등에서 식은땀이 흘렀습니다. 구렁이가 담 위에서 한 번 뒤를 돌아보았습니다.",
            ...
            "아내가 반짇고리에서 실을 꺼냈습니다. 흥부는 부러진 다리에 얇은 나뭇조각을 대고 실로 조심조심 감았습니다. 손이 커서 몇 번이나 놓칠 뻔했습니다. 아이들이 숨을 죽이고 둘러앉았습니다.",
            "\"살겠소?\" 아내가 물었습니다.<br>\"살아야지요.\" 아내가 등잔을 가까이 대 주었습니다.",
            "흥부는 며칠 동안 그 새끼를 방 안에 두고 돌보았습니다. 제 밥은 굶어도 좁쌀을 구해다 먹였습니다. 열흘쯤 지나자 새끼 제비가 다리를 짚고 일어섰고, 보름째 되던 날 마당을 낮게 한 바퀴 돌아 처마로 올라갔습니다. 그 자리에서 몇 번이나 미끄러졌지만 다시 일어섰습니다. 흥부네 식구가 모두 마당에 나와 손뼉을 쳤습니다.",
            ...
            "제비 한 마리가 마당 위를 몇 바퀴 돌더니 흥부의 발 앞에 무언가를 떨어뜨렸습니다. 그러고는 처마 위에 앉아 지지배배 울었습니다. 온 식구가 마당으로 뛰어나왔습니다.",
            ...
            "과연 제비는 한쪽 다리를 조금 절었습니다. 흥부는 한참 동안 그 제비를 올려다보았습니다. 틀림없이 그 제비였습니다.",
            ...
            "싹이 트더니 덩굴이 무섭게 뻗었습니다. 사흘 만에 지붕에 올라가고, 열흘 만에 지붕을 다 덮었습니다. 잎이 어른 손바닥보다 컸습니다. 이웃들이 담 너머로 구경을 왔습니다.",
    ...
    },
    {
        ...
        paras: [
            ...
            "아이들이 둘러앉아 구경했습니다. 톱날이 반쯤 들어갔을 때였습니다. 박 속에서 갑자기 환한 빛이 새어 나왔습니다. 눈이 부실 만큼 환한 빛이었습니다.",
            ...
            "아이가 상을 마당에 내려놓고 말했습니다.<br>\"많이 드십시오.\"<br>그러고는 연기처럼 사라졌습니다. 김이 마당 가득 퍼졌습니다.",
            ...
            "그런데 이상한 일이었습니다. 상을 다 비우고 나면 그릇에 밥이 도로 그득 차 있었습니다. 아무리 먹어도 줄지 않았습니다. 흥부 내외는 서로 얼굴만 쳐다보았습니다.",
            "\"여보.\" 아내가 말했습니다. \"저 박이 아직 세 통 남았어요.\" 아내의 목소리가 떨렸습니다.",
            "이튿날 아침, 흥부 부부는 다시 톱을 잡았습니다. 이번에는 손이 떨렸습니다. 아이들도 숨을 죽이고 지켜보았습니다.",
            "두 번째 박이 갈라지자 그 속에서 비단이 쏟아져 나왔습니다. 빛깔이 눈이 부실 지경이었습니다.",
            "붉은 비단, 푸른 비단, 노란 비단이 파도처럼 밀려 나와 마당을 덮었습니다. 아이들이 그 위에서 뒹굴었습니다. 빛깔이 어찌나 고운지 눈이 다 부셨습니다.",
            ...
            "목수들은 그 자리에서 낡은 오두막을 헐고 새 집을 짓기 시작했습니다. 기둥을 세우고 대들보를 올리고 기와를 얹는 데 사흘이 걸렸습니다. 망치 소리가 온 산자락에 울렸습니다.",
            "사흘째 저녁, 산자락에 커다란 기와집 한 채가 서 있었습니다. 방이 열두 칸이요 곳간이 세 채였습니다. 기와가 아침 햇살에 반짝였습니다.",
            "마지막 네 번째 박이 남았습니다. 흥부가 톱을 잡으며 아내에게 말했습니다.<br>\"이제 그만 탈까요. 너무 과합니다.\"<br>\"열어는 봐야지요.\" 아내가 흥부의 손을 잡았습니다.",
            "네 번째 박이 갈라지자 금은보화가 쏟아졌습니다. 금덩이와 은덩이가 마당에 산처럼 쌓였습니다. 햇빛에 눈을 뜰 수가 없었습니다.",
            ...
            "이튿날 흥부는 마을로 내려갔습니다. 그러고는 굶는 집을 찾아다니며 쌀을 나누어 주었습니다. 빚에 눌린 집의 빚을 대신 갚아 주었습니다. 누가 시킨 것이 아니었습니다.",
            "한 달이 지나자 그 고을에 굶는 사람이 없어졌습니다. 사람들은 흥부네 집을 지날 때마다 담 너머로 인사를 했습니다. 그래도 흥부는 늘 먼저 고개를 숙였습니다. 누구도 흥부에게 갚으라는 말을 듣지 않았습니다.",
    ...
    },
    {
        ...
        paras: [
            ...
            "놀부는 인사도 받지 않고 집 안을 휘휘 둘러보았습니다. 곳간 문을 열어 보고, 방마다 문을 열어 보았습니다. 쌀가마를 세어 보기까지 했습니다.",
            "\"바른대로 말해라. 도둑질을 했느냐.\"<br>\"형님도 참. 제비 덕입니다.\" 흥부는 조금도 성내지 않았습니다.",
            "놀부의 눈이 번쩍 뜨였습니다.<br>\"제비라니.\" 놀부의 목소리가 갈라졌습니다.",
            "흥부는 있었던 일을 하나도 빼지 않고 이야기했습니다. 처마 밑 제비집, 구렁이, 부러진 다리, 실로 싸매 준 일, 이듬해 봄에 물어다 준 박씨. 말하는 내내 흥부의 얼굴이 환했습니다.",
            ...
            "그날부터 놀부는 제비를 기다렸습니다. 그러나 놀부네 처마에는 제비가 오지 않았습니다. 처마 밑이 텅 빈 채로 봄이 다 갔습니다. 종들도 그 짓을 말리지 못했습니다.",
            "놀부는 종을 시켜 처마 밑에 미리 흙집을 지어 놓게 했습니다. 마당에 좁쌀도 뿌렸습니다. 그래도 제비는 오지 않았습니다. 애가 타서 잠도 오지 않았습니다. 종들이 밤새 처마 밑을 지켰습니다.",
            "놀부는 대나무 장대를 들고 마을을 돌아다니며 남의 집 제비집을 헐었습니다. 갈 곳을 잃은 제비 한 쌍이 마침내 놀부네 처마로 날아들었습니다. 갈 곳 없는 제비들이 온 마을을 맴돌았습니다.",
            "\"오냐, 어서 오너라.\"<br>놀부는 그날 밤 잠도 오지 않았습니다.",
            "제비 부부가 새끼를 쳤습니다. 새끼 세 마리가 노란 입을 벌렸습니다. 놀부는 하루에도 몇 번씩 사다리를 놓고 올라가 들여다보았습니다. 사다리가 삐걱거려도 아랑곳하지 않았습니다. 어미 제비가 놀부의 머리 위를 맴돌았습니다.",
            "\"아직 다리가 가늘구나. 조금만 더 굵어지면…….\"",
            "보름이 지나자 새끼들의 다리에 힘이 붙었습니다. 놀부는 사다리를 놓고 올라가 새끼 한 마리를 꺼냈습니다. 둥지 안에서 어미 제비가 자지러지게 울었습니다.",
            "새끼 제비가 손안에서 파닥거렸습니다. 놀부는 잠깐 망설였습니다. 손끝에 작고 따뜻한 것이 뛰고 있었습니다. 새끼는 놀부의 손가락을 꼭 붙들었습니다.",
    ...
    },
    {
        ...
        paras: [
            ...
            "해가 기울 무렵 제비 한 마리가 날아들었습니다. 한쪽 다리를 심하게 절었습니다. 놀부는 두 팔을 벌리고 뛰어나갔습니다. 온 식구가 마당으로 몰려나왔습니다. 온 식구가 마당으로 뛰어나왔습니다.",
            "제비가 무언가를 떨어뜨리고 곧바로 하늘로 솟아올랐습니다. 놀부가 얼른 주웠습니다. 흥부가 받았다는 것보다 더 큰 박씨였습니다. 어른 두 손으로 겨우 쥘 만했습니다.",
            "\"됐다! 됐어!\"<br>놀부는 그 자리에서 덩실덩실 춤을 추었습니다.",
            "놀부는 마당 한복판을 파고 박씨를 심었습니다. 그러고는 하루에 열 번씩 물을 주었습니다. 종들에게는 밤새 지키게 했습니다. 행여 누가 파 갈까 담까지 높였습니다.",
            "싹이 트더니 덩굴이 무섭게 뻗었습니다. 지붕을 덮고 담을 넘고 이웃집 지붕까지 올라갔습니다. 잎이 어찌나 무성한지 낮에도 마당이 어두웠습니다. 담이 덩굴 무게에 기울었습니다.",
            "박이 열렸습니다. 하나, 둘, 셋…… 세다 보니 열두 통이었습니다. 흥부네보다 세 배가 많았습니다. 하나하나가 사람 키를 넘었습니다. 이웃들이 담 너머로 그 박을 세어 보았습니다.",
            ...
            "놀부가 톱을 잡고 목청을 돋우었습니다.<br>\"슬근슬근 톱질하세! 이 박을 타서 금은보화 쏟아지면 온 나라 제일가는 부자가 되어 보세!\" 구경꾼들이 목을 빼고 들여다보았습니다.",
            ...
            "장부에는 놀부가 평생 부린 심술이 하나도 빠짐없이 적혀 있었습니다. 놀부는 곳간에서 엽전 궤짝을 내주어야 했습니다. 구경꾼들이 술렁였습니다.",
            ...
            "놀부는 박이 하나 갈라질 때마다 곳간 문을 열어야 했습니다.<br>\"그만! 그만 타자!\"<br>그런데 손이 말을 듣지 않았습니다. 톱이 저절로 움직였습니다. 팔이 저절로 움직였습니다.",
            "다섯 번째, 여섯 번째, 일곱 번째. 박은 계속 갈라졌습니다. 그때마다 무언가가 나와 놀부의 재산을 한 짐씩 지고 나갔습니다. 놀부의 얼굴이 점점 하얘졌습니다.",
            "여덟 번째 박에서는 흙탕물이 쏟아져 나와 마당을 뒤덮었습니다. 아홉 번째 박에서는 똥이 쏟아져 나왔습니다. 냄새가 어찌나 지독한지 구경꾼들이 다 달아났습니다.",
            "열 번째 박에서는 온갖 벌레가 쏟아져 나와 곳간의 곡식을 다 갉아 먹었습니다. 열한 번째 박에서는 커다란 구렁이가 나와 마당을 한 바퀴 돌고 담을 넘어갔습니다. 아내가 아이들을 안고 담 밖으로 나갔습니다.",
            "마지막 열두 번째 박이 남았습니다. 놀부는 그 앞에 주저앉아 있었습니다. 이미 곳간은 텅 비었고 종들은 다 달아난 뒤였습니다. 아내는 아이들을 데리고 담 밖에 나가 있었습니다.",
            "열두 번째 박이 갈라지자 갑옷을 입은 장수들이 걸어 나왔습니다. 그들은 아무 말 없이 놀부의 집을 헐기 시작했습니다. 아무도 말리지 못했습니다.",
    ...
    },
    {
        ...
        paras: [
            ...
            "흥부는 놀부네 식구를 모두 집 안으로 들였습니다. 아궁이에 불을 지피게 하고, 마른 옷을 내오게 하고, 밥상을 차리게 했습니다. 아이들에게는 마른 수건부터 내주었습니다. 아이들에게는 따뜻한 물부터 먹였습니다.",
            ...
            "놀부는 그해 봄부터 흥부네 논에 나가 일을 했습니다. 평생 남을 부리기만 하던 사람이 처음으로 제 손에 흙을 묻혔습니다. 손바닥이 터지고 아물기를 여러 번 했습니다. 종들이 하던 일을 제 손으로 했습니다. 아침마다 제일 먼저 들에 나갔습니다.",
