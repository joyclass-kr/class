...
const CHAPTERS = [
    ...
    },
    {
        ...
        paras: [
            ...
            "한참 만에 대문이 열리고 옹고집이 나왔습니다. 스님을 위아래로 훑어보더니 대뜸 물었습니다.<br>\"무슨 일이오.\"<br>\"소승은 월출봉 취암사에서 왔습니다. 목소리에 반가운 기색이라고는 하나도 없었습니다. 절이 낡아 지붕을 고치려 하니 시주를 좀 하십시오.\"",
    ...
    },
    {
        ...
        paras: [
            ...
            "가짜 옹고집이 천천히 돌아보았습니다. 그러고는 아주 태연하게 되물었습니다.<br>\"그 말은 내가 물어야겠구나. 조금도 놀라거나 당황하는 기색이 없었습니다. 남의 집에 들어와 남의 옷을 입고 있는 네가 누구냐.\"",
    ...
    },
    {
        ...
        paras: [
            ...
            "그 순간 문득 어머니 방이 떠올랐습니다. 한겨울에도 불을 때지 않던 그 방. 이불 한 채로 여러 해를 나던 여든 넘은 노인. 그 방에서 어머니는 여러 해를 났습니다.",
            ...
            "배가 고파 견딜 수 없으면 남의 집 문 앞에 서서 손을 내밀었습니다. 처음에는 그 짓이 죽기보다 싫었습니다. 손을 내밀면서 그는 늘 고개를 숙였습니다. 사흘을 굶고 나서야 손이 저절로 나갔습니다.",
    ...
    },
    {
        ...
        paras: [
            ...
            "'이대로 끝나는구나.'<br>옹고집은 눈을 감았습니다. 이상하게도 억울하다는 생각이 들지 않았습니다. 다만 한 가지가 마음에 걸렸습니다. 재물도 집도 하나도 아쉽지 않았습니다.",
            ...
            "\"스님, 저는 벌을 받아 마땅한 사람입니다. 절에서 오신 스님을 몽둥이로 때려 내쫓은 일이 있습니다.\"<br>\"알고 있소.\" 말하고 나니 오히려 속이 후련했습니다.",
            ...
            "\"스님, 그 사람은 대체 누구입니까.\"<br>노승이 담담하게 말했습니다.<br>\"짚으로 엮은 것이오. 부적 한 장으로 사람 노릇을 하고 있을 뿐이오.\" 옹고집은 제 귀를 의심했습니다.",
            ...
            "그러나 옹고집은 큰길로 걸어 들어갔습니다. 숨어 들어가고 싶지 않았습니다. 고개를 들고 걸었습니다.",
