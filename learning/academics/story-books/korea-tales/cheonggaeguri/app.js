const CHAPTERS = [
    {
        ...
        beats: [
            ...
            },
            {
                ...
                emoji: "🙃",
                left: [
                    "앞으로 가라고 하면 뒤로 갔어요. 위로 뛰라고 하면 아래로 뛰었지요.",
                    "\"아이고, 내 팔자야.\""
                ],
                right: [
                    "\"얘야, 오늘은 제발 한 번만 엄마 말대로 해 보렴.\"",
                    "\"네!\"",
                    "엄마가 깜짝 놀라 돌아보니, 아들은 벌써 반대쪽으로 폴짝 뛰어가고 있었답니다."
                ]
            },
            {
                art: "03-gulgae.webp",
    ...
    },
    {
        ...
        beats: [
            ...
            },
            {
                ...
                emoji: "🪨",
                left: [
                    "청개구리는 엄마를 개울가에 모셨어요. 돌을 하나하나 옮겨 무덤을 둥글게 쌓았지요."
                ],
                right: [
                    "태어나서 처음으로 엄마 말을 그대로 따른 날이었어요.",
                    "'엄마, 이제 마음 놓으세요.'"
                ]
            },
            {
                ...
                emoji: "🌧️",
                left: [
                    "그런데 며칠 뒤부터 비가 쏟아지기 시작했어요. 개울물이 점점 불어 올랐지요.",
                    "\"엄마 무덤이 떠내려가면 어떡해!\""
                ],
                right: [
                    "청개구리는 개울가로 달려가 목이 쉬도록 울었습니다.",
                    "\"개굴개굴! 개굴개굴!\"",
                    "비 오는 날 개구리가 유난히 크게 우는 것은 그때부터라고 해요."
                ]
            }
        ],
