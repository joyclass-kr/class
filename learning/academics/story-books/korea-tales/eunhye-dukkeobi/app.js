        ...
        beats: [
            {
                ...
                emoji: "🍚",
                left: [
                    "옛날 어느 마을에 가난한 소녀가 살았습니다.",
                    "부모를 일찍 여의고 남의 집 부엌일을 하며 지냈지요."
                ],
                right: [
                    "밥을 지어도 소녀 몫은 늘 한 줌뿐이었어요. 그래도 소녀는 투덜대는 법이 없었답니다."
                ]
            },
            {
                art: "02-toad.png",
                emoji: "🐸",
                left: [
                    "어느 날 저녁, 부뚜막 구석에서 무언가 꿈틀했어요.",
                    "\"어머!\""
                ],
                right: [
                    "두꺼비 한 마리가 눈을 껌뻑이고 있었습니다. 소녀는 빗자루를 들다가 그만 내려놓았어요.",
                    "\"너도 배가 고파서 여기까지 왔구나.\""
                ]
            },
            {
                ...
                emoji: "🤲",
                left: [
                    "소녀는 자기 밥그릇에서 밥알을 조금 덜어 놓아 주었어요.",
                    "두꺼비가 우물우물 받아먹었지요."
                ],
                right: [
                    "\"내일도 오려무나.\"",
                    "그날부터 소녀는 날마다 밥을 덜어 두었답니다.",
                    "적을 때는 몇 알, 많을 때는 한 숟갈."
                ]
            },
            {
                art: "04-grow.png",
                emoji: "📏",
                left: [
                    "달이 가고 해가 갔어요. 두꺼비는 점점 자랐습니다."
                ],
                right: [
                    "처음에는 손바닥만 하더니, 어느새 소녀의 두 손으로도 다 안기지 않을 만큼 커졌지요.",
                    "\"너 참 많이 컸구나.\""
                ]
            }
        ]
        ...
        beats: [
            {
                ...
                left: [
                    ...
                    "지네가 성이 나면 논밭이 마르고 짐승이 병든다고 했습니다."
                ],
                right: [
                    "그래서 해마다 한 사람이 사당에서 밤을 지켜야 했어요.",
                    "그 밤은 무섭기로 이름이 났지요."
                ]
            },
            {
                ...
                emoji: "😰",
                left: [
                    "그해에 뽑힌 사람은 소녀였습니다. 소녀는 아무 말도 하지 않았어요.",
                    "\"미안하구나. 우리도 어쩔 수가 없단다.\""
                ],
                right: [
                    "마을 사람들은 눈을 마주치지 못했지요.",
                    "해가 기울자 소녀는 혼자 산길을 올랐답니다."
                ]
            },
            {
                art: "07-hidden.png",
                emoji: "🫥",
                left: [
                    "낡은 사당 안은 어둡고 조용했어요. 소녀가 무릎을 안고 앉았을 때였습니다."
                ],
                right: [
                    "치마폭이 묵직했어요. 들춰 보니 두꺼비가 그 안에 웅크리고 있었지요.",
                    "\"너… 언제부터 따라온 거니?\""
                ]
            },
            {
                ...
                left: [
                    "한밤중이었어요.",
                    "천장에서 스르륵— 무언가 쓸리는 소리가 났습니다.",
                    "소녀가 천천히 고개를 들었지요."
                ],
                right: [
                    "들보를 칭칭 감은 것은 어마어마하게 큰 지네였어요.",
                    "수없이 많은 다리가 스멀스멀 움직였습니다.",
                    "몸에서 시퍼런 빛이 뿜어져 나왔지요."
                ]
            }
        ]
        ...
        beats: [
            {
                ...
                emoji: "✨",
                left: [
                    "그때 치마폭이 들썩하더니 두꺼비가 뛰어나왔어요.",
                    "소녀 앞을 딱 가로막고 섰지요.",
                    "두꺼비의 몸이 점점 부풀기 시작했습니다."
                ],
                right: [
                    "등에서 따뜻한 노란빛이 피어올랐어요. 시퍼런 빛과 노란빛이 사당 한가운데서 쩌엉— 맞부딪혔습니다.",
                    "낡은 기둥이 부르르 떨렸지요."
                ]
            },
            {
                ...
                emoji: "🌀",
                left: [
                    "얼마나 지났을까요. 노란빛이 한 뼘, 또 한 뼘 밀고 올라갔어요. 시퍼런 빛이 조금씩 흐려지기 시작했습니다."
                ],
                right: [
                    "지네는 들보에서 스르르 내려와 어둠 속으로 물러갔어요.",
                    "그러고는 다시 나타나지 않았지요.",
                    "노란빛도 스러지듯 사그라들었습니다."
                ]
            },
            {
                ...
                emoji: "🌅",
                left: [
                    "날이 밝자 마을 사람들이 조심조심 사당으로 올라왔어요.",
                    "\"설마…\""
                ],
                right: [
                    "문을 열자 소녀가 무사히 앉아 있었습니다. 품에는 축 늘어진 두꺼비를 안고 있었지요.",
                    "\"제발… 눈 좀 떠 봐.\""
                ]
            },
            {
                ...
                emoji: "🌿",
                left: [
                    "소녀는 두꺼비를 집으로 데려가 정성껏 돌보았어요.",
                    "이레가 지나자 두꺼비가 눈을 껌뻑 떴습니다."
                ],
                right: [
                    "\"고맙다. 정말 고맙다.\"",
                    "그 뒤로 마을에서는 사당에서 밤을 지키는 일이 없어졌어요.",
                    "지네가 다시는 나타나지 않았거든요."
                ]
            }
        ],
