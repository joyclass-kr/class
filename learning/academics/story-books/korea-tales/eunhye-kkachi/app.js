        ...
        beats: [
            {
                ...
                emoji: "🏞️",
                left: [
                    "옛날에 활을 아주 잘 쏘는 선비가 하나 있었습니다. 과거를 보러 한양으로 가는 길이었지요.",
                    "등에는 봇짐, 어깨에는 아버지가 물려준 활을 메고 있었어요.",
                    "\"과거에 붙어야 어머니께 면목이 서지.\"",
                    "산길은 깊고 인적은 없었습니다. 해는 벌써 서쪽으로 기울고 있었지요."
                ],
                right: [
            ...
            },
            {
                ...
                left: [
                    ...
                    "선비가 걸음을 멈췄어요.",
                    "\"깍깍! 깍깍깍!\"",
                    "고개를 드니 커다란 나무 꼭대기에 까치 둥지가 하나 있었습니다. 어미 까치 두 마리가 미친 듯이 날개를 퍼덕이고 있었지요."
                ],
                right: [
                    "둥지 쪽으로 시커먼 구렁이가 스르르 기어오르고 있었어요. 어른 팔뚝만 한 놈이었습니다.",
                    "까치들은 구렁이 머리 위로 달려들었다가 튕겨 나기를 되풀이했어요.",
                    "\"저런, 저 새끼들이 다 잡아먹히겠구나!\"",
                    "하지만 구렁이는 조금씩, 조금씩 둥지에 가까워졌습니다."
                ]
            },
            {
                art: "03-arrow.webp",
                ...
                right: [
                    "화살은 구렁이의 몸을 꿰뚫었어요. 구렁이는 나무 아래로 툭 떨어졌습니다.",
                    "까치 두 마리가 선비의 머리 위를 몇 바퀴나 맴돌며 울었지요.",
                    "\"됐다!\"",
                    "\"깍깍! 깍깍!\"",
        ...
        beats: [
            ...
            },
            {
                ...
                left: [
                    ...
                    "어디서 나는 소리인지 알 수가 없었어요.",
                    "구렁이가 쉭쉭거리며 말했어요.",
                    "\"그이가 바로 내 남편이다.\"",
                    "분명 문을 열어 주던 그 여인의 목소리였습니다."
                ],
                right: [
                    "\"까치 몇 마리 살리자고 내 남편을 죽였으니, 오늘 밤 네 목숨으로 갚아야겠다.\"",
                    "구렁이가 몸을 조금씩 조여 왔어요.",
                    "\"살려 주십시오!\"",
                    "선비는 입술이 바짝 말랐습니다. 이대로 죽는구나 싶었지요."
                ]
            },
            {
                art: "07-bell.webp",
                ...
                right: [
                    ...
                    "선비의 가슴이 철렁 내려앉았어요.",
                    "\"그런 절이 어디 있단 말입니까!\"",
                    "그 절은 스님이 모두 떠난 지 오래된 빈 절이었거든요. 종을 칠 사람이 있을 리 없었지요."
                ]
            }
        ]
    },
        ...
        beats: [
            {
                ...
                left: [
                    "밤은 자꾸만 깊어 갔습니다.",
                    "창밖이 희끄무레해질 무렵이었어요. 이제 정말 끝이구나 하는 순간이었지요.",
                    "선비는 눈을 질끈 감았어요.",
                    "뎅—",
                    "\"뭐?\"",
                    "구렁이의 몸이 움찔했습니다."
                ...
                right: [
                    ...
                    "틀림없이 세 번이었어요.",
                    "\"…어찌 된 일이지?\"",
                    "구렁이는 한참 동안 꼼짝도 하지 않았습니다. 그러더니 스르르 몸을 풀고 어둠 속으로 사라졌답니다."
                ]
            },
            {
                art: "09-temple.webp",
                emoji: "⛩️",
                left: [
                    "날이 밝자마자 선비는 산 위 절로 뛰어 올라갔어요.",
                    "도대체 누가 종을 쳤는지 알고 싶었거든요.",
                    "낡은 종 아래에 무언가 툭 떨어져 있었습니다."
                ],
                right: [
                    "까치 두 마리였어요.",
                    "어제 그 까치들이었지요.",
                    "\"너희였구나…\"",
                    "제 몸으로 종을 들이받아 세 번을 울린 것이었습니다. 머리에는 피가 묻어 있었어요.",
            ...
            },
            {
                ...
                right: [
                    "선비는 과거 보는 일도 미루고 까치를 돌보았습니다. 물을 먹이고 약을 발라 주었어요.",
                    "이레가 지나자 까치들은 다시 하늘로 날아올랐지요.",
                    "\"이 은혜를 어찌 갚을까.\"",
                    "그 뒤로 까치는 해마다 선비의 집 마당에 둥지를 틀었답니다."
                ]
            }
        ],
