const CHAPTERS = [
    {
        ...
        beats: [
            ...
            },
            {
                ...
                emoji: "💭",
                left: [
                    "딸이 시집갈 나이가 되자 부부는 큰 고민에 빠졌어요.",
                    "\"아무한테나 보낼 수는 없지요.\"",
                    "\"그렇고말고요.\""
                ],
                right: [
                    "한참을 궁리하던 쥐 아버지가 무릎을 탁 쳤습니다.",
                    "\"옳지! 세상에서 가장 센 이를 사위로 삼읍시다.\"",
                    "\"그거 참 좋은 생각이오!\"",
                    "부부는 그길로 짐을 꾸려 길을 나섰지요."
                ]
            },
            {
                art: "03-sun.png",
                ...
                left: [
                    "가장 먼저 찾아간 것은 해였어요.",
                    "부부는 산꼭대기에 올라 넙죽 절을 했습니다.",
                    "\"해님, 세상에서 제일 센 분은 해님이시지요?\""
                ],
                right: [
                    "해가 껄껄 웃었어요.",
                    "\"나? 나보다 센 이가 있다네.\"",
                    "\"예? 해님보다 센 이가요? 그게 누구인가요?\"",
                    "부부는 귀를 쫑긋 세웠답니다."
                ]
            },
            {
                ...
                left: [
                    "\"구름일세.\"",
                    "\"구름이 나를 슬쩍 가려 버리면 나는 아무것도 하지 못해.\"",
                    "해가 겸연쩍은 듯 말했어요."
                ],
                right: [
                    "쥐 부부는 눈이 휘둥그레졌습니다.",
                    "\"그럼 구름님을 찾아가야겠군요!\"",
                    "부부는 고맙다고 절을 하고 부지런히 돌아섰답니다."
                ]
            }
        ]
    },
    {
        ...
        beats: [
            ...
            },
            {
                ...
                left: [
                    "\"저 고갯마루의 돌부처라네.\"",
                    "\"내가 아무리 세게 불어도 눈 하나 깜짝하지 않아.\"",
                    "바람은 그렇게 말하고 어디론가 가 버렸어요."
                ],
                right: [
                    "쥐 부부는 서로를 물끄러미 쳐다보았습니다.",
                    "\"이번에는 정말 마지막이겠지요?\"",
                    "\"암, 그래야지요. 다리가 다 부었소.\""
                ]
            },
            {
                ...
                emoji: "🙏",
                left: [
                    "고갯마루에는 커다란 돌부처가 우뚝 서 있었습니다.",
                    "부부는 옷매무새를 고치고 공손히 여쭈었어요.",
        ...
        beats: [
            {
                ...
                left: [
                    "\"대체 그게 무엇입니까?\"",
                    "쥐 아버지가 답답한 듯 물었어요.",
                    "돌부처는 아무 말 없이 자기 발밑을 물끄러미 내려다보았습니다."
                ],
                right: [
                    "\"쥐라네.\"",
                    "\"예?!\"",
                    "쥐 부부의 입이 딱 벌어졌지요. 잘못 들은 줄 알았거든요."
                ]
            },
            {
                art: "10-explain.png",
                ...
                right: [
                    "고갯마루에 한참 동안 아무 소리도 나지 않았어요.",
                    "바람만 휘잉 지나갔지요.",
                    "쥐 부부는 자기 발을 내려다보았답니다."
                ]
            },
            {
                art: "11-realize.png",
            ...
            },
            {
                ...
                emoji: "🎊",
                left: [
                    "며칠 뒤, 곳간 밑에서 조촐한 혼례가 열렸어요.",
                    "신랑은 이웃집 총각 쥐였습니다.",
                    "부지런하고 마음씨 곧은 총각이었지요."
                ],
                right: [
                    "딸은 볼이 발그레해져 고개를 숙였답니다.",
