        ...
        beats: [
            {
                ...
                left: [
                    ...
                    "자식도 없이 둘이서만 살았지요.",
                    "그날도 할아버지는 종일 그물을 던졌지만 잡힌 것이 없었어요.",
                    "강물만 바라보며 하루를 보냈어요."
                ],
                right: [
                    "해질 무렵에야 커다란 잉어 한 마리가 걸려 올라왔지요.",
                    "그물이 묵직해 손이 다 떨렸어요.",
                    "\"오늘 저녁은 걱정 없겠구나.\"",
                    "할아버지의 얼굴이 환해졌지요."
                ]
            },
            {
                ...
                left: [
                    ...
                    "잉어의 눈이 사람의 눈 같았어요.",
                    "커다란 눈에서 눈물이 뚝 떨어졌습니다.",
                    "할아버지는 그만 손을 멈췄지요."
                ],
                right: [
                    "할아버지는 한참을 들여다보다가 그물을 풀었어요.",
                    "잉어를 두 손으로 안아 물에 놓아 주었지요.",
                    "\"에라, 오늘도 굶지 뭐.\"",
                    "잉어는 물속으로 쏙 사라졌답니다.",
            ...
            },
            {
                ...
                left: [
                    "그날 밤이었어요.",
                    "할아버지 내외가 막 잠자리에 들려던 참이었어요.",
                    "문을 두드리는 소리에 나가 보니 낯선 젊은이가 서 있었습니다.",
                    "옷차림이 예사롭지 않았지요."
                ],
                right: [
                    "\"저는 용왕의 아들입니다. 낮에 살려 주셔서 고맙습니다.\"",
                    "젊은이가 넙죽 절을 했어요.",
                    "젊은이는 푸른 구슬 하나를 내밀었어요.",
                    "\"무엇이든 원하는 것을 말해 보십시오.\"",
                    "손바닥만 한 푸른 구슬이 은은하게 빛났지요."
                ]
            },
            {
                art: "04-rich.png",
                ...
                left: [
                    "\"쌀 한 가마니만 나오너라.\"",
                    "할아버지가 반신반의하며 말해 보았어요.",
                    "정말로 방 안에 쌀가마가 척 놓였어요.",
                    "할머니가 입을 딱 벌렸지요."
                ],
                right: [
                    "얼마 지나지 않아 낡은 집은 기와집으로 바뀌었습니다.",
                    "방마다 곡식이 그득했어요.",
        ...
        beats: [
            {
                ...
                right: [
                    "할멈은 이런저런 말로 할머니를 꾀어 구슬을 손에 넣었어요. 그러고는 나룻배를 타고 강을 건너가 버렸지요.",
                    "할멈은 며칠이나 드나들며 살갑게 굴었어요.",
                    "그날부터 기와집은 다시 낡은 집이 되었답니다.",
                    "할머니는 그제야 속은 줄을 알았지요."
                ]
            },
            {
                ...
                left: [
                    ...
                    "내외가 밥도 못 먹고 앓아누웠거든요.",
                    "\"우리가 찾아오자.\"",
                    "둘 다 이 집에서 배불리 먹고 자란 사이였어요."
                ],
                right: [
                    "\"그래. 우리라도 해야지.\"",
                    "개가 앞장을 섰어요.",
                    "둘은 그날 밤 몰래 집을 나섰습니다. 강까지 가는 데만 한나절이 걸렸어요.",
                    "둘은 밤새 들길을 걸었지요."
                ]
            },
            {
                ...
                right: [
                    ...
                    "개가 물속으로 첨벙 들어갔어요.",
                    "개는 네 다리를 열심히 저었답니다.",
                    "개가 등을 내밀었어요. 고양이는 개 등에 납작 엎드려 강을 건넜답니다."
                ]
            },
            {
                art: "08-chest.png",
                ...
                right: [
                    "발톱으로 긁어도, 이빨로 물어도 꿈쩍하지 않았어요.",
                    "고양이가 자물쇠를 이리저리 만져 보았어요.",
                    "\"이걸 어쩌지…\"",
                    "둘은 서로 얼굴만 쳐다보았지요."
                ]
            },
        ...
        beats: [
            ...
            },
            {
                ...
                left: [
                    ...
                    "수십 마리가 줄지어 나왔어요.",
                    "사각사각, 사각사각.",
                    "수십 마리가 달라붙어 궤짝을 갉았습니다.",
                    "나무 부스러기가 소복이 쌓였지요."
                ],
                right: [
                    "곧 구멍이 뚫리고 푸른 구슬이 데구루루 굴러 나왔지요. 고양이는 구슬을 입에 물고 쏜살같이 달렸답니다.",
                    "고양이가 얼른 구슬을 낚아챘어요.",
                    "개가 뒤따라 달렸답니다."
                ]
            },
            ...
            },
            {
                ...
                left: [
                    ...
                    "\"네가 다 망쳤어!\"",
                    "고양이는 차마 집에 갈 수가 없었지요."
                ],
                right: [
                    "해가 기울 무렵, 모래밭에 죽은 물고기 한 마리가 밀려와 있었어요.",
                    "고양이는 사흘을 굶은 참이었어요.",
                    "배가 고팠던 고양이가 그것을 뜯어먹는데, 무언가 단단한 것이 이에 딱 걸렸지요.",
                    "푸른 것이 이 사이에서 반짝였지요."
                ]
            },
            {
                ...
                left: [
                    ...
                    "잉어가 삼킨 것을 고양이가 찾아낸 것이었어요.",
                    "\"아이고, 우리 고양이가 다 찾아왔구나!\"",
                    "숨이 턱에 차도록 달렸지요."
                ],
                right: [
                    "그날부터 고양이는 따뜻한 방 안에서 지내게 되었고, 개는 마당에 남았지요. 둘이 사이가 나빠진 것도 그때부터래요.",
                    "할머니가 고양이를 끌어안았어요.",
                    "개는 그것이 두고두고 서운했지요."
                ]
            }
...
const QUIZ = [
    { q: "할아버지는 잉어를 어떻게 했나요?", choices: ["장에 내다 팔았다", "강으로 놓아 주었다", "끓여서 먹었다"], answer: 1 },
    ...
    { q: "고양이는 구슬을 꺼내려고 누구를 붙잡았나요?", choices: ["쥐들의 왕", "집 지키는 개", "할멈의 손자"], answer: 0 },
    ...
    spreads: [
        {
            art: 'end.png',
            left: [
                "개와 고양이가 함께 잃어버린 물건을 찾아오는 이야기는 우리 옛이야기에 널리 전해 옵니다. 개와 고양이가 사이가 나쁜 까닭을 풀어 주는 이야기이기도 합니다.",
                "물을 건널 때 고양이가 개 등에 업히는 대목이 어느 판본에나 나옵니다. 고양이는 물을 싫어하고 개는 헤엄을 칠 줄 알기 때문입니다.",
                "다시 보면 둘은 똑같이 애를 썼습니다. 쥐구멍을 판 것도, 강을 건넌 것도 나눠서 한 일입니다.",
                "그런데 마지막 한 걸음을 해낸 쪽만 방 안으로 들어갔습니다. 함께 한 일을 한 쪽의 공으로만 세면 남은 쪽에는 서운함이 남습니다."
            ],
            right: [
                "그래서 지금도 개와 고양이가 서로 으르렁거린다고 이 이야기는 말합니다.",
                "주인은 무엇을 놓친 걸까요? 답은 적어 두지 않겠습니다."
            ]
        }
    ]
};
