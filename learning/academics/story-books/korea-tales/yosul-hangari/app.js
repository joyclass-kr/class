        ...
        beats: [
            {
                ...
                left: [
                    ...
                    "어느 봄날, 농부가 밭을 갈다가 호미 끝에 무언가 걸렸습니다.",
                    "\"올해는 좀 나으려나.\""
                ],
                right: [
                    "쨍!",
            ...
            },
            {
                ...
                left: [
                    "\"쓸 만한 항아리로구먼.\"",
                    "흙을 털어 내고 이리저리 살펴보았지요.",
                    "농부는 항아리를 지게에 얹어 집으로 지고 왔어요.",
    ...
    },
    {
        ...
        beats: [
            ...
            },
            {
                ...
                emoji: "😳",
                left: [
                    "부자는 허둥지둥 팔을 뻗어 아버지를 끌어냈어요.",
                    "아버지가 물에 빠진 사람처럼 헐떡였어요.",
                    "\"아이고, 아버지! 괜찮으세요?\"",
                    "아버지는 옷을 털며 헛기침을 했지요.",
                    "부자는 가슴을 쓸어내렸지요."
                ],
                right: [
                    "그런데 항아리 속에서 목소리가 또 들렸습니다.",
                    "분명 아버지 목소리였어요.",
                    "\"얘야, 나도 좀 꺼내 다오.\"",
                    "\"이, 이게 무슨 일이야!\"",
                    "부자의 얼굴이 하얗게 질렸어요.",
            ...
            },
            {
                ...
                left: [
                    ...
                    "\"얘야, 배고프다.\"",
                    "부자는 팔이 저리도록 아버지를 꺼냈지요."
                ],
                right: [
                    "\"얘야, 나도 배고프다.\"",
                    "아버지들이 저마다 손을 내밀었어요.",
                    "\"얘야, 나도!\"",
                    "수십 명이 한꺼번에 부자를 불렀답니다. 부자는 귀를 막고 주저앉았지요.",
                    "\"이걸 어쩐담!\""
                ]
            },
            {
...
const QUIZ = [
    { q: "농부는 항아리를 어디에서 찾았나요?", choices: ["냇물 속에서", "밭을 갈다가", "산길에서"], answer: 1 },
    ...
    { q: "욕심 많은 부자는 결국 어떻게 되었나요?", choices: ["항아리를 팔았다", "재산을 다 썼다", "마을을 떠났다"], answer: 1 }
];
    ...
    spreads: [
        {
            ...
            left: [
                ...
                "다시 보면 부자가 빼앗아 간 것은 항아리입니다. 그 안에 무엇이 들었는지는 보지 않았습니다.",
                "억지로 가져오면 그 안에 무엇이 들었는지도 모른 채 가져오게 됩니다. 부자가 손에 넣은 것은 재물이 아니라 감당할 수 없는 짐이었습니다."
            ],
            right: [
                "농부는 항아리를 잃고도 크게 아쉬워하지 않았습니다. 처음부터 밭에서 나온 것이었으니까요.",
                "부자는 어느 대목에서 멈췄어야 했을까요? 답은 적어 두지 않겠습니다."
            ]
        }
    ]
};
