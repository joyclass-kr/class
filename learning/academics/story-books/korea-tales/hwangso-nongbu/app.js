        ...
        beats: [
            {
                ...
                left: [
                    ...
                    "밭에는 잡초가 사람 키만큼 자랐지요.",
                    "해가 중천에 떠도 자리에서 일어나지 않았지요. 방바닥에 등을 딱 붙이고 하늘만 올려다보았습니다.",
                    "\"아이고, 팔자도 사납지.\"",
                    "\"내일 하지 뭐. 내일.\""
                ],
                right: [
        ...
        beats: [
            {
                ...
                right: [
                    ...
                    "농부는 커다란 황소가 되어 버렸답니다. 노인은 그 모습을 보고 빙긋 웃었어요.",
                    "노인은 그것을 보고 웃기만 했답니다."
                ]
            },
            {
                ...
                right: [
                    "'나는 소가 아니오! 사람이란 말이오!'",
                    "장에서 사람들이 몰려들었어요.",
                    "황소는 목이 터져라 외쳤지만 음메 소리만 났어요.",
                    "소를 산 사람에게 노인이 한마디 덧붙였습니다.",
                    "\"단, 무는 절대 먹이지 마시오. 먹으면 그 자리에서 죽소.\"",
                    "소 임자는 고개를 갸웃하며 고삐를 받았지요."
                ]
            },
            {
                art: "06-work.webp",
        ...
        beats: [
            {
                ...
                right: [
                    "황소는 밤마다 외양간에서 눈물을 흘렸습니다.",
                    "짚더미가 눈물로 축축해졌어요.",
                    "커다란 눈에서 굵은 눈물이 뚝뚝 떨어져 짚더미를 적셨지요.",
                    "하지만 아무도 그 마음을 알아주지 않았어요.",
                    "소 임자는 그저 여물만 더 주었답니다."
                ]
            },
            {
                art: "08-radish.webp",
                ...
                left: [
                    ...
                    "'무는 먹으면 죽는다고 했지.'",
                    "'차라리 죽는 게 낫겠다. 에라, 모르겠다!'",
                    "황소는 이제 늙어 가고 있었지요."
                ],
                right: [
                    "황소는 무를 하나 쑥 뽑아 우적우적 씹어 먹었어요.",
                    "아삭, 아삭.",
                    "시원하고 아삭한 맛이 온몸에 쫙 퍼졌습니다.",
