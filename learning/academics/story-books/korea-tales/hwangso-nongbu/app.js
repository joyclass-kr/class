const CHAPTERS = [
    {
        ...
        beats: [
            ...
            },
            {
                ...
                emoji: "🎭",
                left: [
                    "커다란 나무 아래에 노인이 앉아 있었어요.",
                    "손에는 소 얼굴 모양의 탈이 들려 있었지요.",
                    "\"어르신, 그건 뭡니까?\""
                ],
                right: [
        ...
        beats: [
            {
                ...
                left: [
                    "\"어서 주십시오!\"",
                    "농부는 탈을 냉큼 받아 얼굴에 썼습니다.",
                    "그 순간이었어요."
                ],
                right: [
                    "\"음메—!\"",
                    "손은 발굽이 되고 등에는 털이 돋았어요.",
                    "농부는 커다란 황소가 되어 버렸답니다."
                ]
            },
            {
                art: "05-sold.webp",
...
const QUIZ = [
    ...
    { q: "노인이 만들고 있던 것은 무엇이었나요?", choices: ["나무 지게", "짚신 한 켤레", "소 얼굴 탈"], answer: 2 },
