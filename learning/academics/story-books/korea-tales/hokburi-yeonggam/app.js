        ...
        beats: [
            {
                ...
                left: [
                    ...
                    "걸을 때마다 그 혹이 덜렁덜렁 흔들렸어요. 아이들은 그것이 신기해서 자꾸 쳐다보곤 했답니다.",
                    "\"이 혹도 나하고 한평생이지.\"",
                    "그래도 영감은 하루 종일 싱글벙글이었지요."
                ],
                right: [
                    "영감은 노래를 어찌나 잘 부르는지 몰랐어요. 밭에서 영감이 노래를 시작하면 온 마을 사람이 일손을 멈추고 귀를 기울였지요.",
                    "\"허, 저 소리 한번 좋구먼.\"",
                    "아이들도 영감 곁에 몰려 앉았어요.",
                    "\"영감, 한 곡 더 해 보시게!\"",
                    "사람들은 영감의 혹을 흉보는 대신 노래를 청하곤 했답니다."
                ]
            },
            {
                ...
                right: [
                    "산속은 눈 깜짝할 사이에 캄캄해졌습니다. 어디가 길인지 어디가 벼랑인지도 알 수 없었지요.",
                    "\"이거 큰일 났구먼.\"",
                    "나뭇가지에 옷이 자꾸 걸렸어요.",
                    "\"오늘 밤은 꼼짝없이 산에서 새우겠는걸.\"",
                    "영감은 지게를 지고 더듬더듬 골짜기 쪽으로 걸음을 옮겼어요."
                ]
            },
            {
                art: "03-hut.webp",
                emoji: "🏚️",
                left: [
                    "다행히 골짜기 안쪽에 낡은 빈 오두막이 하나 있었습니다. 영감은 문을 밀고 들어가 지게를 내려놓았지요.",
                    "방바닥에 먼지가 뽀얗게 쌓여 있었어요. 오래도록 아무도 살지 않은 집이 분명했답니다.",
                    "\"아무도 없는 게 확실하지?\"",
                    "그런데 어찌나 조용한지 오히려 무서웠지요."
                ],
                right: [
            ...
            },
            {
                ...
                right: [
                    "문이 벌컥 열리더니 시뻘건 도깨비 하나가 성큼 들어섰습니다. 뿔이 지붕에 닿을 듯이 컸지요.",
        ...
        beats: [
            ...
            },
            {
                ...
                left: [
                    ...
                    "\"이, 이 혹에서 나옵니다.\"",
                    "말해 놓고 영감이 더 놀랐습니다. 어쩌자고 그런 말이 나왔는지 스스로도 몰랐거든요."
                ],
                right: [
    ...
    },
    {
        ...
        beats: [
            ...
            },
            {
                ...
                right: [
                    "그런데 소리가 영 신통치 않았어요. 갈라지고 흔들리고 박자도 하나 맞지 않았지요.",
                    "그래도 얼마 지나지 않아 쿵, 쿵, 쿵 소리가 났습니다.",
                    "\"옳지, 걸렸다!\"",
                    "도깨비들이 정말로 나타난 것이었어요. 영감은 속으로 쾌재를 불렀답니다."
                ]
            },
            {
                art: "11-angry.webp",
    ...
    return `
        <div class="page page-cover">
            ...
            <div class="story-page-right">
                <h1>혹부리 영감</h1>
                <p>혹부리 영감은 지은이가 없는 구전 설화예요. 우리가 흔히 쓰는 속담 하나가 이 이야기에서 나왔는데, 그것이 무엇인지는 다 읽고 나면 알게 된답니다.</p>
