        ...
        beats: [
            {
                ...
                right: [
                    "그래도 영감은 늘 싱글벙글했어요. 노래를 어찌나 잘 부르는지, 밭에서 영감이 노래를 시작하면 온 마을 사람이 일손을 멈추고 들었답니다."
                ]
            },
            {
                ...
                right: [
                    "그러다 그만 해가 넘어가 버렸습니다. 산속이 순식간에 캄캄해졌지요.",
                    "\"이거 큰일 났구먼.\""
                ]
            },
            {
                ...
                emoji: "🏚️",
                left: [
                    "다행히 골짜기에 낡은 빈 오두막이 있었어요. 영감은 문을 열고 들어가 지게를 내려놓았습니다.",
            ...
            },
            {
                ...
                right: [
                    "누가 발로 땅을 구르며 오는 소리였어요.",
                    "문이 벌컥 열리더니 시뻘건 도깨비 하나가 성큼 들어섰어요. 뒤로 초록 도깨비와 새파란 아기 도깨비가 따라 들어왔지요.",
        ...
        beats: [
            {
                ...
                right: [
                    ...
                    "영감은 머리가 하얘졌습니다. 무슨 말이라도 해야 할 것 같았지요."
                ]
            },
            {
                art: "06-lie.webp",
            ...
            },
            {
                ...
                left: [
                    ...
                    "\"예? 아니, 그건…\"",
                    "\"값은 넉넉히 쳐주마!\"",
                    "대장 도깨비가 노란 방망이를 뚝딱! 뚝딱! 두드렸어요."
                ],
                right: [
                    "금덩이가, 은덩이가, 구슬이 쏟아져 무릎까지 쌓였지요.",
                    "그러고는 영감의 턱에서 혹을 쏙 떼어 갔답니다."
                ]
            },
            {
                art: "08-home.webp",
        ...
        beats: [
            {
                ...
                emoji: "😏",
                left: [
                    "이웃 마을에도 혹부리 영감이 하나 살았어요. 이 영감은 욕심이 아주 많았지요.",
            ...
            },
            {
                ...
                right: [
                    "욕심쟁이 영감은 혹을 둘이나 달고 터덜터덜 산을 내려왔답니다. 혹 떼러 갔다 혹 붙여 온다는 말이 그래서 생겼대요."
                ]
            }
        ],
