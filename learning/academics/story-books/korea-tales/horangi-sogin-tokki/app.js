const CHAPTERS = [
    {
        ...
        beats: [
            ...
            },
            {
                ...
                left: [
                    "\"눈을 꼭 감고 입을 크게 벌리세요.\"",
                    "\"신호하면 참새가 입으로 쏙 들어갈 거예요.\"",
                    "호랑이는 시키는 대로 했습니다."
                ],
                right: [
                    "토끼는 살금살금 물러나 마른 풀에 부싯돌을 그었어요.",
                    "치익—",
                    "\"자, 지금이에요! 꽉 다무세요!\""
                ]
            },
            {
                ...
                right: [
                    "호랑이는 수염이 발라당 그을린 채 개울로 뛰어들었습니다.",
                    "\"이놈의 토끼! 다음에 만나기만 해 봐라!\"",
                    "토끼는 벌써 저 멀리 달아난 뒤였지요."
                ]
            }
        ]
    },
        ...
        beats: [
            ...
            },
            {
                ...
                left: [
                    ...
                    "토끼는 그 말을 남기고 쏙 사라졌습니다."
                ],
                right: [
                    "호랑이는 기다리다 못해 돌 하나를 덥석 물었어요.",
                    "\"앗 뜨거! 뜨거워!\"",
                    "이번에도 개울로 내달렸답니다."
                ]
            }
    ...
    },
    {
        ...
        beats: [
            ...
            },
            {
                ...
                left: [
                    "날이 밝았어요.",
                    "꼬리가 얼음에 꽝꽝 붙어 꼼짝도 하지 않았지요.",
                    "\"어라? 이거 왜 안 빠져!\""
                ],
                right: [
                    "저쪽에서 마을 사람들 소리가 들려왔어요. 호랑이가 온 힘을 다해 당기자 얼음이 쩍 갈라졌습니다.",
                    "그 뒤로 호랑이는 토끼만 보면 슬금슬금 피했대요."
                ]
            }
        ],
