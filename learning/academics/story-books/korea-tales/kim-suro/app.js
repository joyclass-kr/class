        ...
        beats: [
            {
                ...
                left: [
                    ...
                    "땅이 기름지고 물이 넉넉해 살기 좋은 곳이었어요.",
                    "아홉 마을은 저마다 따로 농사를 짓고 따로 잔치를 열었지요."
                ],
                right: [
        ...
        beats: [
            {
                ...
                left: [
                    ...
                    "만져 보니 따뜻한 기운이 돌았어요.",
                    "아홉 간은 상자를 아진이라는 집에 모셔 두었습니다.",
                    "아진은 아홉 간 가운데 가장 나이 많은 이였지요."
                ],
                right: [
                    "아홉 간은 번갈아 가며 상자를 지켰어요.",
                    "밤새 문 앞을 지켰어요. 아무도 잠을 이루지 못했답니다.",
                    "\"이 알에서 무엇이 나올까.\"",
                    "다들 그 생각뿐이었지요."
                ]
            },
            {
                ...
                left: [
                    ...
                    "새벽부터 사람들이 집 앞에 모여 있었어요.",
                    "알 여섯이 모두 깨어 사내아이 여섯이 앉아 있었지요.",
                    "상자 안이 온통 환했지요."
                ],
                right: [
                    "여섯이 한꺼번에 방긋 웃었어요.",
                    "아이들의 몸에서 은은한 빛이 돌았어요.",
                    "\"아이고, 이게 무슨 일이냐!\"",
                    "아홉 간이 그 자리에 털썩 주저앉았답니다."
                ]
            },
            {
                art: "08-suro.png",
                ...
                left: [
                    ...
                    "아이는 눈이 크고 이마가 훤했어요.",
                    "보름이 지나자 키가 아홉 자나 되었지요."
                ],
                right: [
                    "\"이 아이가 우리 임금이오.\"",
                    "아홉 간 가운데 누구도 딴말을 하지 않았어요.",
            ...
            },
            {
                ...
                left: [
                    ...
                    "여섯 형제는 생김새가 꼭 닮아 있었어요.",
                    "수로가 형제들의 손을 하나씩 잡았지요."
                ],
                right: [
                    "\"나 혼자 다 다스릴 수는 없다.\"",
                    "\"저마다 한 골짜기씩 맡아 다스리자.\"",
        ...
        beats: [
            {
                ...
                left: [
                    ...
                    "산을 파면 검붉은 쇳돌이 쏟아져 나왔지요.",
                    "땅땅.",
                    "대장장이들이 그것을 녹여 쟁기와 칼을 만들었어요."
                ],
                right: [
                    "땅땅.",
                    "망치 소리가 그칠 새가 없었지요.",
                    "가야의 쇠는 바다 건너까지 팔려 나갔습니다. 나루에는 배가 그득했답니다."
                ]
            },
            {
                art: "11-alone.png",
            ...
            },
            {
                ...
                left: [
                    ...
                    "신을 신은 채 언덕을 뛰어 내려갔지요.",
                    "그날 밤 온 가야에 불이 밝혀졌습니다.",
                    "아무 말도 필요하지 않았어요."
                ],
                right: [
                    "북과 징 소리가 새벽까지 이어졌어요.",
            ...
            },
            {
                ...
                left: [
                    ...
                    "가야 사람들은 낯선 것을 무서워하지 않게 되었어요.",
                    "\"우리는 아홉 마을이었소.\"",
                    "수로가 언덕에 올라 아홉 마을을 내려다보았지요."
                ],
                right: [
                    "수로가 나루를 내려다보며 말했습니다.",
                    "나루에는 배가 빼곡했어요.",
    ...
    spreads: [
        {
            ...
            left: [
                ...
                "다시 보면 아홉 간이 한 일은 알을 기다린 것이 아닙니다. 함께 노래하고 함께 발을 굴렀습니다. 그러고 나서야 알이 내려왔지요.",
            ...
            right: [
                ...
                "아홉 간은 왜 저마다 임금이 되려 하지 않았을까요? 답은 적어 두지 않겠습니다."
            ]
        }
    ]
};
