...
const CHAPTERS = [
    {
        ...
        paras: [
            ...
            "길동은 나면서부터 남달랐습니다. 세 살에 글을 읽고 다섯 살에 문장을 지었습니다. 열 살이 되자 병서<span class=\"gloss\">(군사를 부리고 싸움을 하는 법을 적은 책)</span>를 읽고 그 뜻을 다 헤아렸습니다. 글방 선생이 더 가르칠 것이 없다며 물러갔습니다.",
    ...
    },
    {
        ...
        paras: [
            ...
            "초란은 무당을 불러다 홍 판서에게 말을 넣게 했습니다.<br>\"저 도련님의 상을 보니 장차 나라를 뒤집을 상입니다. 집안에 큰 화가 미칠 것입니다.\" 무당은 초란이 시킨 대로 말했습니다.",
    ...
    },
    {
        ...
        paras: [
            ...
            "홍 판서가 여덟 앞을 하나하나 지나갔습니다. 늙은 눈으로 아무리 들여다보아도 가릴 수가 없었습니다. 점 하나 사마귀 하나 다르지 않았습니다.",
