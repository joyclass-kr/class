const CHAPTERS = [
    {
        ...
        beats: [
            ...
            },
            {
                ...
                emoji: "🦌",
                left: [
                    "그날도 나무를 하는데 무언가 다리에 부딪혔어요.",
                    "사슴 한 마리가 부들부들 떨고 있었지요."
                ],
                right: [
                    "\"살려 주세요! 사냥꾼이 쫓아옵니다!\"",
                    "나무꾼은 얼른 나뭇더미를 헤쳐 사슴을 숨겼어요.",
                    "잠시 뒤 사냥꾼이 헐레벌떡 지나갔습니다."
                ]
            },
            {
                art: "03-tell.png",
            ...
            },
            {
                ...
                right: [
                    "보름날 밤, 나무꾼은 연못가 바위 뒤에 앉았어요.",
                    "정말로 하늘에서 빛이 내려오지 뭐예요. 선녀 일곱이 물속으로 들어갔습니다."
                ]
            },
            {
                art: "05-robe.png",
    ...
    },
    {
        ...
        beats: [
            ...
            },
            {
                ...
                left: [
                    "\"저, 이거 찾으시는 것 아닙니까?\"",
                    "나무꾼이 날개옷을 두 손으로 내밀었습니다."
                ],
                right: [
                    "선녀가 눈물 범벅인 얼굴로 고개를 들었어요.",
                    "\"…감추지 않으셨어요?\"",
                    "\"남의 것을 왜 감춥니까?\""
                ]
            },
            ...
            },
            {
                ...
                emoji: "🏠",
                left: [
                    "나무꾼은 선녀를 제 집으로 데려갔어요.",
                    "어머니가 아랫목을 내주었습니다."
                ],
                right: [
                    "선녀는 밥 짓는 법도 빨래하는 법도 몰랐지요. 대신 산나물 이름을 하나도 빠짐없이 알았어요.",
        ...
        beats: [
            {
                ...
                right: [
                    "나무꾼은 나무를 하고 선녀는 약초를 캤습니다. 어머니는 손주들에게 옛이야기를 들려주었어요.",
                    "집은 가난했지만 웃음소리가 끊이지 않았답니다."
                ]
            },
            {
                art: "12-homesick.png",
