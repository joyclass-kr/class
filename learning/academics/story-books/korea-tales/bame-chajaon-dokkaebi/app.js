        ...
        beats: [
            {
                ...
                emoji: "🌙",
                left: [
                    "김 서방이 밤늦게 집으로 가는 길이었습니다. 주막에서 한잔 걸친 터라 걸음이 흥겨웠지요.",
                    "\"에헤라, 달도 밝구나.\""
                ],
                right: [
                    "개울에 놓인 징검다리를 건너려는데, 저쪽 끝에 웬 사내가 떡 버티고 서 있었어요.",
                    "\"뉘시오?\""
                ]
            },
            {
    ...
    },
    {
        ...
        beats: [
            ...
            },
            {
                ...
                emoji: "🧹",
                left: [
                    "개울가 버드나무 앞에 다다랐을 때였습니다. 허리띠는 그대로 나무를 칭칭 감고 있었어요."
                ],
                right: [
                    "그런데 그 안에 묶여 있는 것은, 몽당비가 다 된 낡은 빗자루 한 자루였답니다."
                ]
            },
            {
                art: "10-laugh.png",
