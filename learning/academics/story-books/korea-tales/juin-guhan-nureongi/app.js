        ...
        beats: [
            {
                ...
                left: [
                    ...
                    "밭에 나갈 때도, 장에 갈 때도 한 번도 떨어지는 법이 없었어요."
                ],
                right: [
                    "\"이 녀석은 내 그림자야.\"",
                    "김 서방은 그렇게 말하며 껄껄 웃곤 했답니다."
                ]
            },
            {
                art: "02-tavern.png",
                ...
                left: [
                    "그날은 장에 다녀오는 길이었어요.",
                    "주막에서 아는 사람을 만나 한잔, 두 잔.",
                    "\"김 서방, 한 잔만 더!\""
                ],
                right: [
                    "해가 다 지고서야 김 서방은 자리에서 일어났습니다.",
                    "걸음이 이리 비틀 저리 비틀했지요.",
                    "누렁이가 그 곁을 바싹 따라 걸었어요."
                ]
            },
            {
                art: "03-asleep.png",
                ...
                left: [
                    "들판을 반쯤 건넜을 때였어요.",
                    "\"아이고, 다리야. 잠깐만 쉬었다 가자.\"",
                    "김 서방은 마른 풀밭에 벌렁 드러누웠습니다."
                ],
                right: [
                    "그러고는 그대로 코를 골기 시작했어요.",
                    "누렁이는 옆에 앉아 귀를 쫑긋 세우고 밤을 지켰지요."
                ]
            }
        ]
    },
        ...
        beats: [
            {
                ...
                emoji: "🔥",
                left: [
                    "한밤중이었습니다. 저 멀리 들판 끝에서 붉은 빛이 일렁였어요.",
                    "누군가 버린 불씨가 마른 풀에 옮아붙은 것이었지요."
                ],
                right: [
                    "바람을 타고 불길이 성큼성큼 다가왔습니다. 누렁이가 벌떡 일어났어요."
                ]
            },
            {
                art: "05-wake.png",
                ...
                left: [
                    "\"컹! 컹! 컹컹컹!\"",
                    "누렁이가 주인의 얼굴에 대고 짖었어요.",
                    "\"으음… 시끄럽다…\""
                ],
                right: [
                    "옷자락을 물고 흔들어도 소용없었습니다. 김 서방은 돌아누워 다시 코를 골았지요. 불길은 이미 코앞까지 와 있었어요."
                ]
            },
            {
                art: "06-stream.png",
                emoji: "💧",
                left: [
                    "누렁이는 몸을 홱 돌려 달렸습니다. 들판 저쪽 개울로요."
                ],
                right: [
                    "첨벙!",
                    "물속에 온몸을 담갔다가 다시 뛰쳐나왔어요. 털에서 물이 뚝뚝 떨어졌지요."
                ]
            }
        ]
    },
    {
        ...
        beats: [
            ...
            },
            {
                ...
                left: [
                    "불길이 마침내 그 자리까지 닿았어요.",
                    "그런데 젖은 풀 앞에서 스르르 힘을 잃었습니다."
                ],
                right: [
                    "동그랗게 젖은 땅 한가운데, 김 서방은 그대로 코를 골고 있었지요.",
                    "그 옆에 누렁이가 지쳐 쓰러졌어요."
                ]
            },
            {
                ...
                emoji: "🌄",
                left: [
                    "새벽에 눈을 뜬 김 서방은 벌떡 일어났습니다. 들판이 온통 까맣게 타 있었거든요. 타지 않은 곳은 자기가 누워 있던 자리뿐이었어요."
                ],
                right: [
                    "그리고 그 옆에 흠뻑 젖은 누렁이가 눈을 감고 있었지요.",
                    "\"누렁아! 누렁아!\""
                ]
            },
            {
                ...
                emoji: "🌳",
                left: [
                    "김 서방은 누렁이를 들쳐 업고 집으로 달렸어요.",
                    "며칠을 꼬박 돌보자 누렁이는 겨우 기운을 차렸습니다."
                ],
                right: [
                    "김 서방은 불이 멈춘 그 자리에 나무 한 그루를 심었어요. 사람들은 그 나무를 개 나무라고 불렀지요.",
                    "그 고을 이름이 오수가 된 것도 그래서라고 한답니다."
                ]
            }
        ],
    ...
    return `
        <div class="page page-cover">
            ...
            <div class="story-page-right">
                <h1>주인을 구한 누렁이</h1>
                <p>주인을 구한 누렁이는 지은이가 없는 구전 설화예요. 오수의 의견 이야기라는 이름으로 더 널리 알려져 있답니다.</p>
                <p>이 이야기는 전라북도 임실군 오수에 실제로 전해 내려와요. 오수라는 땅 이름은 개를 뜻하는 글자와 나무를 뜻하는 글자를 합친 말이지요. 마을에는 개를 기리는 비석과 무덤이 지금도 남아 있고, 해마다 개를 기리는 잔치도 열린답니다.</p>
                <p>기록으로도 아주 오래된 이야기예요. 고려 시대에 엮인 책에 이미 실려 있으니, 적어도 칠백 년 넘게 전해져 온 셈이지요. 우리나라 의견 설화를 대표하는 이야기랍니다.</p>
                ${coverToc()}
            </div>
        </div>`;
}
...
const QUIZ = [
    ...
    { q: "김 서방은 그 자리에 무엇을 남겼나요?", choices: ["커다란 비석", "나무 한 그루", "작은 우물"], answer: 1 }
];
