const CHAPTERS = [
    {
        ...
        beats: [
            ...
            },
            {
                ...
                right: [
                    "해가 다 지고서야 김 서방은 자리에서 일어났습니다. 걸음이 이리 비틀 저리 비틀했지요.",
        ...
        beats: [
            {
                ...
                left: [
                    "한밤중이었습니다.",
                    "저 멀리 들판 끝에서 붉은 빛이 일렁였어요."
                ],
                right: [
                    "누군가 버린 불씨가 마른 풀에 옮아붙은 것이었지요. 바람을 타고 불길이 성큼성큼 다가왔습니다.",
                    "누렁이가 벌떡 일어났어요."
                ]
            },
            {
                ...
                right: [
                    "옷자락을 물고 흔들어도 소용없었습니다. 김 서방은 돌아누워 다시 코를 골았지요.",
                    "불길은 이미 코앞까지 와 있었어요."
                ]
            },
            {
    ...
    },
    {
        ...
        beats: [
            ...
            },
            {
                ...
                emoji: "🌄",
                left: [
                    "새벽에 눈을 뜬 김 서방은 벌떡 일어났습니다.",
                    "들판이 온통 까맣게 타 있었거든요."
                ],
                right: [
                    "타지 않은 곳은 자기가 누워 있던 자리뿐이었어요.",
