...
const CHAPTERS = [
    {
        ...
        paras: [
            "전라도 남원 땅에 광한루라는 누각이 있었습니다. 앞으로는 맑은 물이 흐르고 둘레에는 버드나무가 늘어져, 남원에서 경치 좋기로 으뜸가는 자리였습니다. 봄이면 꽃구경 온 사람으로 난간이 비좁았습니다.",
            "그해 단오였습니다. 단오는 음력 오월 초닷샛날로, 여자들은 창포물에 머리를 감고 그네를 뛰고 남자들은 씨름을 하는 큰 명절이었습니다. 아침부터 강가에 사람이 그득했습니다.",
            "남원 사또의 아들 이몽룡은 그날 방자<span class=\"gloss\">(관가에서 심부름하던 남자 하인)</span>를 데리고 광한루에 올랐습니다. 나이 열여섯, 글은 잘 읽었으나 아직 세상 구경은 못 해 본 도령이었습니다. 아버지가 글만 읽으라 하여 바깥출입이 드물었습니다.",
            "\"방자야, 저 아래가 다 보이는구나.\"<br>\"그럼입쇼. 남원 바닥에서 여기보다 높은 데가 어디 있습니까.\"",
            "이몽룡이 난간에 기대어 사방을 둘러보는데, 문득 저 건너 버드나무 숲에서 무언가 오르락내리락했습니다. 버들잎이 바람에 뒤집혔습니다.",
            ...
            "이몽룡은 스스로 걸어서 버드나무 숲으로 갔습니다. 춘향이 그네에서 내려 옷매무새를 고치고 서 있었습니다. 숲 안이 서늘했습니다.",
            ...
            "그러고는 그네 줄을 걷어 어깨에 걸치고 돌아섰습니다. 이몽룡은 그 뒷모습이 버드나무 사이로 사라질 때까지 그 자리에 서 있었습니다. 버들잎이 그 자리를 덮었습니다.",
    ...
    },
    {
        ...
        paras: [
            ...
            "관가 마당에는 이미 사람이 그득했습니다. 무슨 구경이라도 난 듯 담 밖까지 사람이 늘어섰습니다. 담장 위에까지 사람이 올라앉았습니다.",
    ...
    },
    {
        ...
        paras: [
            ...
            "이웃 고을 수령들까지 불려 와 대청에 늘어앉았습니다. 상마다 고기와 술이 그득했습니다. 광에서 곡식이 자루째 실려 나갔습니다.",
            ...
            "잔을 들고 있던 수령 하나가 슬그머니 잔을 내려놓았습니다. 다른 하나는 자리에서 일어나 뒷걸음질을 쳤습니다. 대청에 술 냄새만 남았습니다.",
            ...
            "춘향은 그러고는 이몽룡을 지나쳐 걸었습니다. 담 밖에 월매가 서 있었습니다. 춘향은 어머니를 끌어안고 그제야 소리 내어 울었습니다. 월매가 딸의 이름을 부르며 달려왔습니다.",
