...
const CHAPTERS = [
    {
        ...
        paras: [
            `전라도 남원 땅에 광한루라는 누각이 있었습니다. 앞으로는 맑은 물이 흐르고 둘레에는 버드나무가 늘어져, 남원에서 경치 좋기로 으뜸가는 자리였습니다.`,
            `그해 단오였습니다. 단오는 음력 오월 초닷샛날로, 여자들은 창포물에 머리를 감고 그네를 뛰고 남자들은 씨름을 하는 큰 명절이었습니다.`,
            `남원 사또의 아들 이몽룡은 그날 방자<span class="gloss">(관가에서 심부름하던 남자 하인)</span>를 데리고 광한루에 올랐습니다. 나이 열여섯, 글은 잘 읽었으나 아직 세상 구경은 못 해 본 도령이었습니다.`,
            `"방자야, 저 아래가 다 보이는구나."<br>"그럼입쇼. 남원 바닥에서 여기보다 높은 데가 어디 있습니까."`,
            `이몽룡이 난간에 기대어 사방을 둘러보는데, 문득 저 건너 버드나무 숲에서 무언가 오르락내리락했습니다.`,
            `다홍치마 자락이 바람을 안고 하늘로 솟았다가 다시 내려오고, 또 솟았다가 내려왔습니다. 그네였습니다.`,
            `"방자야. 저기 저것이 무엇이냐."<br>"그네입지요."<br>"그네 말고, 그네 탄 사람 말이다."`,
            `방자가 눈을 가늘게 뜨더니 대수롭지 않게 대답했습니다.<br>"아, 저건 춘향이올시다. 월매라는 이의 딸인데, 남원에서 글도 잘하고 인물도 곱기로 소문났습지요."`,
            `이몽룡은 한참 동안 아무 말도 하지 못했습니다. 그러다 겨우 입을 열었습니다.<br>"…불러 오너라."`,
            `방자가 펄쩍 뛰었습니다.<br>"도련님, 그 댁 아가씨가 오라 한다고 올 사람이 아닙니다."<br>"그래도 가 보아라."`,
            `방자가 버드나무 숲으로 건너갔습니다. 한참 뒤에 혼자 돌아와 머리를 긁적였습니다.<br>"뭐라 하더냐."<br>"…제가 기생의 딸이기는 하나 부르면 가는 사람은 아니라고, 하실 말씀이 있으면 직접 오시라고 하옵니다."`,
            `이몽룡의 얼굴이 붉어졌습니다. 그러나 화가 난 것은 아니었습니다.<br>"…옳은 말이다."`,
            `이몽룡은 스스로 걸어서 버드나무 숲으로 갔습니다. 춘향이 그네에서 내려 옷매무새를 고치고 서 있었습니다.`,
            `"내가 아까 사람을 보낸 것은 무례였소. 용서하시오."<br>춘향이 그제야 고개를 들었습니다. 두 사람의 눈이 마주쳤습니다.`,
            `"성함이 어찌 되시오."<br>"성은 성이요, 이름은 춘향이라 합니다."<br>"봄 향기라는 뜻이오?"<br>"예."`,
            `이몽룡이 저도 모르게 웃었습니다.<br>"오늘 광한루에 봄이 왜 이리 짙은가 했더니 까닭이 있었구려."`,
            `춘향은 대꾸하지 않았습니다. 다만 귀 끝이 발갛게 물들었습니다.`,
            `"오늘 저녁에 댁으로 찾아가도 되겠소."<br>"저희 어머니께 여쭈어 보십시오. 저 혼자 정할 일이 아닙니다."`,
            `그러고는 그네 줄을 걷어 어깨에 걸치고 돌아섰습니다. 이몽룡은 그 뒷모습이 버드나무 사이로 사라질 때까지 그 자리에 서 있었습니다.`,
            `돌아오는 길에 방자가 슬쩍 물었습니다.<br>"도련님, 무슨 이야기를 그리 오래 하셨습니까."<br>"…책에 없는 것을 하나 배웠다."`,
            `그날 밤 이몽룡은 글이 눈에 들어오지 않았습니다. 책장을 넘겨도 그네가 오르내리고, 붓을 들어도 다홍치마가 어른거렸습니다.`,
            `마침내 이몽룡은 책을 덮고 일어섰습니다.<br>"방자야. 등불을 들어라."`
        ]
    },
    {
        num: 2,
        ...
        paras: [
            `춘향의 집은 남원 성 밖 조용한 골목에 있었습니다. 담 안에 대나무가 서 있고 마당에는 국화 화분이 줄지어 놓여 있었습니다.`,
            `문을 열어 준 것은 춘향의 어머니 월매였습니다. 월매는 젊은 시절 기생이었다가 이제는 딸 하나를 키우며 조용히 사는 사람이었습니다.`,
            `"사또 댁 도련님이 이 밤중에 어인 일이십니까."<br>"춘향과 백년가약<span class="gloss">(평생을 함께하기로 맺는 약속)</span>을 맺고 싶어 왔습니다."`,
            `월매의 얼굴이 굳었습니다. 한참 만에 입을 열었는데 목소리가 낮았습니다.`,
            `"도련님, 저는 기생이었습니다. 그러니 제 딸도 세상 눈에는 기생의 딸입니다."<br>"압니다."`,
            `"사또께서 아시면 어찌 되겠습니까. 도련님은 언젠가 한양으로 올라가실 분입니다. 그때 우리 아이는 무엇이 됩니까."`,
            `이몽룡은 한동안 아무 말도 하지 못했습니다. 월매의 말이 하나도 틀리지 않았기 때문입니다.`,
            `"…어머님 말씀이 다 옳습니다. 그래서 종이에 적어 드리려 합니다."`,
            `이몽룡은 붓을 청해 종이에 글을 썼습니다. 춘향을 아내로 맞아 평생 저버리지 않겠다는 글이었습니다. 그리고 끝에 제 이름을 적고 손도장을 찍었습니다.`,
            `"도련님, 이런 종이가 무슨 힘이 있겠습니까."<br>"힘이 없으면 없는 대로 두십시오. 다만 제가 스스로에게 한 약속입니다."`,
            `월매는 그 종이를 한참 들여다보다가 접어서 품에 넣었습니다. 그러고는 방문 쪽을 돌아보았습니다.<br>"춘향아, 나오너라."`,
            `그해 여름 두 사람은 혼례를 올렸습니다. 큰 잔치는 아니었습니다. 월매와 방자와 이웃 몇이 모인 조촐한 자리였습니다.`,
            `그 뒤로 이몽룡은 낮에는 글을 읽고 저녁이면 춘향의 집으로 갔습니다.`,
            `둘은 마루에 나란히 앉아 이야기를 했습니다. 이몽룡이 책에서 읽은 것을 이야기하면 춘향이 되물었습니다.`,
            `"도련님, 그 책에는 백성 이야기가 나옵니까."<br>"…나오지 않는구려."<br>"그럼 그 책은 반쪽이네요."`,
            `이몽룡은 그 말에 한참을 웃었습니다. 그러고는 진지해졌습니다.<br>"그대는 어디서 그런 것을 배웠소."<br>"저잣거리에서요. 거기 앉아 있으면 다 들립니다."`,
            `가을이 되자 춘향이 이몽룡에게 글씨를 가르쳐 달라 했습니다. 이몽룡이 붓을 잡아 주었습니다.`,
            `"무슨 글자부터 쓰고 싶소."<br>"사람 인 자요."<br>"어찌 그 글자요?"<br>"제일 어려운 글자라고 들었습니다."`,
            `그렇게 한 해가 갔습니다. 두 사람은 그 시절이 그냥 이어질 줄로만 알았습니다.`,
            `그러나 이듬해 봄, 한양에서 사람이 내려왔습니다. 남원 사또가 벼슬이 올라 한양으로 가게 되었다는 기별이었습니다.`,
            `이몽룡이 그 소식을 들은 것은 아버지의 방에서였습니다.<br>"짐을 꾸려라. 사흘 뒤에 떠난다."<br>"아버님, 저는…"<br>"너도 함께 간다. 과거를 보아야지."`,
            `이몽룡은 그 자리에 한참을 서 있다가 밖으로 나왔습니다. 마당에 봄볕이 환했습니다. 광한루에서 그네를 처음 본 날과 꼭 같은 볕이었습니다.`
        ]
    },
    {
        num: 3,
        ...
        paras: [
            `그날 저녁 이몽룡은 춘향의 집으로 갔습니다. 대문 앞에서 몇 번이나 걸음을 돌렸다가 다시 섰습니다.`,
            `방으로 들어서자 춘향이 먼저 알아보았습니다.<br>"…무슨 일이 있으셨군요."`,
            `이몽룡은 그 자리에 앉아 이야기를 다 했습니다. 아버지의 벼슬, 사흘 뒤의 출발, 한양의 과거.`,
            `말이 끝나고도 한참 동안 방 안이 조용했습니다. 등잔불만 흔들렸습니다.`,
            `"언제 돌아오십니까."<br>"…모르겠소."`,
            `춘향이 고개를 끄덕였습니다. 울지 않았습니다. 다만 손끝이 떨렸습니다.`,
            `"도련님. 한 가지만 여쭙겠습니다."<br>"말하시오."<br>"한양에 가시면 저를 잊으십니까."`,
            `이몽룡이 벌떡 일어났습니다.<br>"그 무슨 말이오!"<br>"화내지 마십시오. 저는 답을 들으려는 것이 아닙니다."`,
            `춘향이 조용히 말을 이었습니다.<br>"사람 마음은 사람이 어찌하지 못하는 것입니다. 다만 저는 제 마음을 압니다. 그것만 말씀드리려는 것입니다."`,
            `그러고는 반짇고리에서 무언가를 꺼냈습니다. 손바닥만 한 거울이었습니다.`,
            `"이것을 가져가십시오. 거울은 있는 그대로를 비추지요. 도련님이 어떤 사람이 되시든 이 거울은 그것을 그대로 비출 겁니다."`,
            `이몽룡은 그 거울을 두 손으로 받았습니다. 그러고는 제 손가락에서 옥가락지를 빼어 춘향에게 주었습니다.`,
            `"이것은 우리 어머니가 주신 것이오. 이 가락지가 내 손에 없는 동안, 나는 아직 남원에 있는 것이오."`,
            `이튿날 새벽, 사또 일행이 남원을 떠났습니다. 관속들이 늘어서고 짐수레가 줄지어 섰습니다.`,
            `춘향은 성 밖 오리정<span class="gloss">(고을에서 오 리쯤 떨어진 곳에 세워, 오가는 사람을 보내고 맞던 정자)</span>까지 따라 나왔습니다. 월매도 뒤에 서 있었습니다.`,
            `"몸조심하시오."<br>"도련님도요."<br>더 할 말이 있었지만 두 사람 다 하지 못했습니다.`,
            `말이 움직이기 시작했습니다. 이몽룡은 몇 번이나 뒤를 돌아보았습니다. 춘향은 그 자리에 그대로 서 있었습니다.`,
            `고갯마루를 넘을 때까지, 이몽룡의 눈에 춘향이 점점 작아졌습니다. 마침내 점이 되었다가 사라졌습니다.`,
            `춘향은 해가 다 기울도록 오리정에 서 있었습니다. 월매가 몇 번이나 소매를 잡아끌었습니다.`,
            `"들어가자. 남들이 본다."<br>"조금만 더요."`,
            `그날 밤 춘향은 옥가락지를 실에 꿰어 목에 걸었습니다. 그러고는 등잔불 아래에서 사람 인 자를 쓰고 또 썼습니다.`,
            `한양에서는 이몽룡이 밤새 책을 읽었습니다. 거울은 책상 위에 세워 두었습니다. 고개를 들 때마다 제 얼굴이 보였습니다.`
        ]
    },
    {
        num: 4,
        ...
        paras: [
            `두 해가 지나고 이듬해 봄, 남원에 새 사또가 왔습니다. 이름은 변학도라 했습니다.`,
            `부임 행차부터 요란했습니다. 가마 뒤로 짐수레가 열 대나 따라왔고, 그 안에는 비단이며 그릇이며 세간이 그득했습니다.`,
            `변학도는 자리에 앉자마자 관속들을 불러 모았습니다. 그런데 묻는 것이 이상했습니다.`,
            `"이 고을 창고에 곡식이 얼마나 있느냐."<br>"예, 그것이…"<br>"됐다. 그건 나중에 보고. 이 고을에 이름난 기생이 몇이나 되느냐?"`,
            `관속들이 서로 눈치를 보았습니다. 아무도 얼른 대답하지 못했습니다.`,
            `"어허, 귀가 먹었느냐. 기생 명부를 가져오너라."`,
            `그날부터 남원 관가에서는 날마다 잔치가 벌어졌습니다. 풍악 소리가 담을 넘어 저잣거리까지 들렸습니다.`,
            `잔치에 드는 것은 다 고을 창고에서 나갔습니다. 그해 봄에 걷은 세금이 석 달 만에 바닥났습니다.`,
            `그러자 변학도는 아직 걷지 않은 이듬해 세금까지 미리 걷으라 했습니다. 못 내는 집에서는 솥을 떼어 갔습니다.`,
            `그러던 어느 날, 변학도가 기생 명부를 넘기다가 손을 멈췄습니다.<br>"이 고을에 춘향이라는 아이가 있다지."`,
            `옆에 있던 아전<span class="gloss">(관가에서 실무를 보던 하급 관리)</span>이 조심스레 아뢰었습니다.<br>"있사옵니다. 그런데 그 아이는 기생이 아니옵니다."`,
            `"기생의 딸이 어찌 기생이 아니냐."<br>"이미 지아비가 있는 몸이라 하옵니다. 전 사또 댁 도련님과…"`,
            `변학도가 껄껄 웃었습니다.<br>"그 도련님이 지금 어디 있느냐. 한양에 있지 않느냐. 한양이 여기서 몇 리인고?"`,
            `"…칠백 리쯤 되옵니다."<br>"칠백 리 밖의 사내가 무슨 지아비냐. 데려오너라."`,
            `사령들이 춘향의 집으로 갔습니다. 월매가 대문을 막고 섰습니다.<br>"우리 아이는 기생이 아닙니다!"<br>"사또 분부요. 비키시오."`,
            `춘향이 방에서 나왔습니다. 옷매무새를 단정히 하고 머리를 곱게 빗은 채였습니다.<br>"어머니, 괜찮습니다. 다녀오겠습니다."`,
            `"춘향아!"<br>"불려 가는 것을 안 갈 수는 없지요. 다만 갔다가 그냥 돌아오면 됩니다."`,
            `관가 마당에는 이미 사람이 그득했습니다. 무슨 구경이라도 난 듯 담 밖까지 사람이 늘어섰습니다.`,
            `변학도가 대청에 앉아 춘향을 내려다보았습니다. 한참을 보더니 흡족한 얼굴이 되었습니다.`,
            `"과연 소문대로구나. 오늘부터 네 이름을 기생 명부에 올리겠다. 관가에 들어와 내 곁에서 시중을 들어라."`,
            `마당이 조용해졌습니다. 사람들이 숨을 죽이고 춘향의 입을 보았습니다.`,
    ...
    },
    {
        ...
        paras: [
            `변학도의 얼굴에서 웃음이 사라졌습니다.<br>"지아비라니. 혼서<span class="gloss">(혼인을 약속하며 주고받던 문서)</span>가 있느냐. 나라에 올린 문서가 있느냐."`,
            `"종이는 있습니다."<br>"기생의 딸이 도령과 주고받은 종이 쪼가리가 무슨 문서란 말이냐!"`,
            `"사또께서 문서가 아니라 하시면 문서가 아니겠지요."<br>춘향이 담담하게 말했습니다.<br>"그래도 제 마음은 제 것입니다. 그것까지 사또께서 정하실 수는 없습니다."`,
            `변학도가 상을 내리쳤습니다.<br>"저것이 사또를 능멸하는구나! 매를 들어라!"`,
            `사령들이 머뭇거렸습니다. 남원 사람이라면 춘향을 모르는 이가 없었기 때문입니다.<br>"무엇들 하느냐!"`,
            `춘향은 매를 맞으면서도 소리를 지르지 않았습니다. 대신 매 한 대에 한마디씩 말을 했습니다.`,
            `"하나. 한 지아비를 섬기는 것이 무슨 죄입니까."<br>"둘. 두 마음을 품지 않는 것이 무슨 죄입니까."`,
            `"셋. 세상이 뒤집혀도 저는 이 말을 바꾸지 않습니다."<br>매질하던 사령의 손이 떨렸습니다.`,
            `담 밖에서 사람들이 울기 시작했습니다. 어떤 이는 돌아섰고 어떤 이는 주먹을 쥐었습니다.`,
            `"옥에 가두어라! 제 입으로 그러겠다 할 때까지 내보내지 마라!"`,
            `춘향은 그날로 남원 옥에 갇혔습니다. 옥은 어둡고 축축했습니다. 쥐가 다니고 벽에서 물이 배어 나왔습니다.`,
            `월매가 날마다 옥 앞으로 왔습니다. 창살 사이로 밥을 넣어 주며 울었습니다.<br>"내가 그때 그 종이를 받지 말았어야 했다."`,
            `"어머니, 그런 말씀 마세요."<br>"네가 무슨 죄가 있다고…"<br>"제가 죄가 없으니까 여기 있는 겁니다."`,
            `달이 바뀌고 또 바뀌었습니다. 춘향의 얼굴에서 살이 빠지고 손목이 가늘어졌습니다.`,
            `그래도 춘향은 날마다 옥 바닥에 손가락으로 글씨를 썼습니다. 사람 인 자였습니다.`,
            `남원을 떠난 지 삼 년째 되던 해, 한양에서 과거가 열렸습니다. 이몽룡이 그 시험을 보았습니다.`,
            `시험 문제는 백성을 다스리는 법에 관한 것이었습니다. 이몽룡은 붓을 들고 한참을 생각했습니다.`,
            `그러다 문득 오래전에 들은 말이 떠올랐습니다. 그 책에는 백성 이야기가 나옵니까. 그럼 그 책은 반쪽이네요.`,
            `이몽룡은 그날 장원으로 뽑혔습니다. 임금이 그를 불러 물었습니다.<br>"무슨 벼슬을 하고 싶으냐."`,
            `"전하, 저를 암행어사로 보내 주십시오."<br>"어느 고을로 가겠느냐."<br>"…전라도 남원이옵니다."`,
            `임금이 마패<span class="gloss">(암행어사임을 증명하던 둥근 쇠패. 말 그림이 새겨져 있다)</span>를 내렸습니다.`,
            `이몽룡은 그 마패를 품에 넣고, 책상 위의 거울도 함께 챙겼습니다. 그러고는 남쪽으로 길을 잡았습니다.`
        ]
    },
    {
        num: 6,
        ...
        paras: [
            `남원에 가까워지자 이몽룡은 옷을 갈아입었습니다. 다 해진 옷에 짚신을 신고, 갓은 챙이 부러진 것을 썼습니다.`,
            `암행어사는 그렇게 다녔습니다. 아무도 알아보지 못해야 그 고을의 진짜 모습을 볼 수 있기 때문입니다.`,
            `남원 땅에 들어서자마자 이몽룡은 걸음을 멈췄습니다. 논에 물이 말라 있었습니다. 사람이 다니지 않아 길에 풀이 자랐습니다.`,
            `주막에 들어가 국밥 한 그릇을 시켰습니다. 옆자리 사람들이 나누는 이야기가 그대로 들렸습니다.`,
            `"올해도 세금을 두 번 걷는다지."<br>"작년 것도 아직 못 냈는데."<br>"그 양반은 밤마다 잔치라던데."`,
            `이몽룡의 숟가락이 멈췄습니다.`,
            `"그건 그렇고, 춘향이는 아직 옥에 있나."<br>"석 달째지. 이제 사람 꼴이 아니라던데."`,
            `이몽룡이 그 자리에서 일어섰습니다. 국밥은 반도 못 먹었습니다.`,
            `해가 진 뒤 이몽룡은 춘향의 집을 찾아갔습니다. 담이 무너지고 마당의 국화 화분이 다 말라 있었습니다.`,
            `월매가 등불을 들고 나왔습니다. 그러고는 이몽룡을 보고 한참을 알아보지 못했습니다.`,
            `"…도련님?"<br>"예, 접니다."<br>월매의 눈이 이몽룡의 행색을 훑었습니다. 해진 옷, 부러진 갓, 흙투성이 짚신.`,
            `월매가 그 자리에 주저앉았습니다.<br>"아이고… 아이고, 우리 춘향이…"`,
            `"어머님."<br>"우리 애가 저 지경이 되도록 기다린 사람이 겨우… 겨우 이 꼴로 왔단 말입니까."`,
            `이몽룡은 아무 변명도 하지 않았습니다. 다만 이렇게 말했습니다.<br>"옥으로 데려다주십시오."`,
            `옥 앞에 이르자 이몽룡이 창살에 얼굴을 붙였습니다. 안은 캄캄했습니다.<br>"춘향아."`,
            `어둠 속에서 무언가 움직였습니다. 그러고는 아주 낮은 목소리가 들려왔습니다.<br>"…도련님이십니까."`,
            `"어찌 알았소. 얼굴도 안 보일 텐데."<br>"목소리는 안 변했습니다."`,
            `달빛이 들어와 춘향의 얼굴을 비췄습니다. 이몽룡은 그 얼굴을 보고 숨이 막혔습니다.`,
            `춘향도 이몽룡의 행색을 보았습니다. 한참을 보다가 조용히 물었습니다.<br>"…한양에서 뜻을 못 이루셨군요."`,
            `이몽룡은 대답하지 않았습니다. 사실을 말해 버리면 춘향이 옥 안에서 티를 낼 것이고, 그러면 일이 어그러질 것이었습니다.`,
            `그런데 춘향이 창살 사이로 손을 내밀었습니다. 그 손에 옥가락지가 들려 있었습니다.<br>"이건 도로 가져가십시오. 제가 지니고 있다가 잃을까 겁납니다."`,
    ...
    },
    {
        ...
        paras: [
            `이튿날은 변학도의 생일이었습니다. 관가에서는 아침부터 큰 잔치가 벌어졌습니다.`,
            `이웃 고을 수령들까지 불려 와 대청에 늘어앉았습니다. 상마다 고기와 술이 그득했습니다.`,
            `그때 다 해진 옷을 입은 사내 하나가 슬그머니 마당으로 들어섰습니다.<br>"어허, 웬 거지가 잔칫상에 끼어드느냐!"`,
            `사령들이 밀어내려 하자 옆 고을 수령 하나가 손을 저었습니다.<br>"두어라. 잔칫날에 사람 쫓는 것도 흉하다. 저 끝에 상 하나 내주어라."`,
            `이몽룡은 마당 끝 구석에 앉았습니다. 상에는 식은 국 한 그릇과 나물 한 접시가 놓였습니다.`,
            `술이 몇 순배 돌자 변학도가 흥이 올랐습니다.<br>"오늘같이 좋은 날에 시가 없어서 되겠는가. 누가 한 수 지어 보게."`,
            `그때 마당 끝의 거지가 일어섰습니다.<br>"소인이 한 수 지어 올려도 되겠습니까."`,
            `좌중이 웃음바다가 되었습니다.<br>"거지가 시를 짓는다!"<br>"어디 들어나 보자!"`,
            `이몽룡이 붓을 청해 종이에 글을 썼습니다. 그러고는 소리 내어 읽었습니다.`,
            `"금 술잔에 담긴 좋은 술은 천 사람의 피요,"<br>"옥쟁반에 놓인 좋은 안주는 만백성의 기름이라."`,
            `대청이 조용해졌습니다.`,
            `"촛농이 떨어질 때 백성의 눈물이 떨어지고,"<br>"노랫소리 높은 곳에 원망 소리 또한 높더라."`,
            `잔을 들고 있던 수령 하나가 슬그머니 잔을 내려놓았습니다. 다른 하나는 자리에서 일어나 뒷걸음질을 쳤습니다.`,
            `변학도의 얼굴이 붉으락푸르락해졌습니다.<br>"이, 이놈이 어디서 무엄한 소리를! 당장 끌어내라!"`,
            `사령들이 달려들었습니다. 그 순간 이몽룡이 품에서 무언가를 꺼내 높이 들었습니다.`,
            `둥근 쇠붙이에 말이 새겨져 있었습니다. 마패였습니다.`,
            `동시에 담 밖에서 우렁찬 소리가 터졌습니다.<br>"암행어사 출두야!"`,
            `대문이 부서지듯 열리고 역졸들이 쏟아져 들어왔습니다. 상이 뒤집히고 술병이 굴렀습니다. 수령들이 갓도 못 챙기고 담을 넘었습니다.`,
            `변학도가 자리에서 굴러떨어졌습니다.<br>"어, 어사또… 소인은 그저…"<br>"남원 사또는 인장을 내놓으시오. 오늘로 그 자리에서 물러나시오."`,
            `이몽룡은 곧바로 옥 문을 열게 했습니다. 춘향이 부축을 받으며 걸어 나왔습니다. 햇빛이 눈부셔 한참을 눈을 뜨지 못했습니다.`,
            `겨우 눈을 뜬 춘향 앞에, 어사 관복을 입은 이몽룡이 서 있었습니다. 춘향은 놀라지 않았습니다. 다만 이렇게 말했습니다.<br>"…어젯밤에 말씀하시지 그러셨어요."<br>"말했으면 그대가 티를 냈을 것이오."<br>"그건 그렇습니다."`,
            `춘향은 그러고는 이몽룡을 지나쳐 걸었습니다. 담 밖에 월매가 서 있었습니다. 춘향은 어머니를 끌어안고 그제야 소리 내어 울었습니다.`,
            `그해 가을 두 사람은 한양으로 올라갔습니다. 월매도 함께 갔습니다.`,
            `떠나기 전날, 춘향이 광한루에 올랐습니다. 이몽룡이 뒤따라 올라왔습니다.<br>"여기서 처음 보았지요."<br>"그때 내가 방자를 시켜 그대를 불렀소. 참으로 무례한 짓이었소."`,
            `"그때 제가 뭐라 했는지 기억하십니까."<br>"하실 말씀이 있으면 직접 오시라고 했지."<br>"예. 그 말을 들어주셔서 제가 여기 있는 겁니다."`,
            `이몽룡이 품에서 거울을 꺼냈습니다. 삼 년을 지니고 다녀 테두리가 다 닳아 있었습니다.<br>"이건 도로 주겠소. 이제 내가 어떤 사람이 되었는지는 그대가 보아 주시오."`
        ]
    }
];
    ...
    return `
        <div class="page page-cover">
            ...
            <div class="story-page-right">
                ...
                <p>판소리 다섯 마당 가운데 가장 널리 불리고 가장 많이 읽힌 것이 춘향가예요. 남아 있는 판본만 백 가지가 넘는답니다.</p>
...
const QUIZ = [
    ...
    { q: "암행어사가 꺼내 보인 것은 무엇입니까?", choices: ["임금의 편지", "마패", "옥으로 만든 도장"], answer: 1 },
