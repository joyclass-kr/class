...
const QUIZ = [
    { q: "바르보 영감이 두 아들을 떼어 놓으려 한 까닭은 무엇입니까?", choices: ["일손이 남아서", "서로 말고는 아무도 필요로 하지 않아서", "싸워서"], answer: 1 },
    { q: "프리슈 농장에 간 것은 누구입니까?", choices: ["실비네", "랑드리", "둘 다"], answer: 1 },
    { q: "랑드리가 자기가 가겠다고 한 진짜 까닭은 무엇입니까?", choices: ["돈을 벌고 싶어서", "형이 남의 집에서 못 견딜 것을 알아서", "집이 싫어서"], answer: 1 },
    { q: "마을 아이들이 팡셰를 부르던 이름은 무엇입니까?", choices: ["작은 파데트", "마녀", "거지"], answer: 0 },
    { q: "팡셰가 실비네가 있는 곳을 알아낸 방법은 무엇입니까?", choices: ["마법으로", "하루 종일 들에 있어서 사람들이 어디로 가는지 보아서", "누가 알려 줘서"], answer: 1 },
    { q: "실비네가 개울가에 이틀 동안 앉아 있던 까닭은 무엇입니까?", choices: ["길을 잃어서", "누가 찾으러 오기를 기다려서", "다쳐서"], answer: 1 },
    { q: "팡셰가 랑드리에게 요구한 것은 무엇입니까?", choices: ["돈", "축제에서 일곱 번 춤춰 달라는 것", "일자리"], answer: 1 },
    { q: "팡셰가 일부러 옷을 더럽게 하고 다닌 까닭은 무엇입니까?", choices: ["가난해서", "곱게 하면 사람들이 어머니 이야기를 꺼내서", "귀찮아서"], answer: 1 },
    { q: "팡셰가 달라진 것은 누구 때문입니까?", choices: ["랑드리가 시켜서", "할머니가 시켜서", "스스로 정해서"], answer: 2 },
    { q: "실비네가 팡셰를 미워한 진짜 까닭은 무엇입니까?", choices: ["팡셰가 나빠서", "동생을 빼앗길까 두려워서", "소문 때문에"], answer: 1 },
    { q: "팡셰가 마을을 떠난 까닭은 무엇입니까?", choices: ["쫓겨나서", "병자 돌보는 일을 배우려고", "돈을 벌려고"], answer: 1 },
    { q: "파데 할머니가 남긴 것은 무엇입니까?", choices: ["약초밭", "평생 모은 사만 프랑", "집"], answer: 1 },
    { q: "팡셰가 실비네를 낫게 한 방법은 무엇입니까?", choices: ["약초", "사흘 동안 이야기를 들어 준 것", "의사를 불러서"], answer: 1 },
    { q: "팡셰가 바르보 영감에게 판단해 달라고 한 기준은 무엇입니까?", choices: ["자기가 가진 돈", "자기가 그 집에 한 일", "집안 내력"], answer: 1 },
    { q: "팡셰가 혼인한 뒤 제일 먼저 한 일은 무엇입니까?", choices: ["큰 집을 지었다", "가난한 집 아이들을 돌볼 집을 마련했다", "밭을 샀다"], answer: 1 },
    { q: "팡셰가 자기를 놀리던 사람들에게 화를 계속 내지 않은 까닭은 무엇입니까?", choices: ["잊어서", "화를 계속 내면 그 사람들 손에 계속 잡혀 있는 것이라서", "무서워서"], answer: 1 }
];
