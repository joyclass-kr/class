...
const CHAPTERS = [
    {
        ...
        paras: [
            ...
            `마흔이 넘은 사람이었습니다.`,
            `백칠십 년쯤 전 이야기입니다.`,
            `그 시절 시골 사람들은 태어난 마을에서 평생을 살았습니다.`,
            `바르보 영감은 밭이 제법 있었고, 소가 여섯 마리 있었고, 아이가 여럿이었습니다. 마을에서 살림이 넉넉한 축에 들었습니다.`,
            `마을 일을 정할 때 그 사람 말이 무거웠습니다.`,
            `그런데 집안일에는 서툴렀습니다.`,
            ...
            `사내아이 둘이었습니다.`,
            `똑같이 생겼습니다.`,
            `어느 쪽이 먼저 나왔는지도 헷갈렸습니다.`,
            `그 시절 시골에서는 쌍둥이가 태어나면 사람들이 걱정을 했습니다. 쌍둥이는 서로 너무 붙어서 자라기 때문에, 나중에 하나가 없으면 다른 하나가 못 산다는 말이 있었습니다.`,
            `그런 일이 실제로 있었다고들 했습니다.`,
            `옆 마을에서 그런 일이 있었다는 이야기였습니다.`,
            `아기를 받으러 온 나이 든 여자가 바르보 영감에게 이렇게 말했습니다.<br>"둘을 똑같이 키우지 마시오. 옷도 다르게 입히고, 이름도 헷갈리지 않게 짓고, 되도록 떼어 놓으시오."`,
            `그 여자는 그 고장에서 아기를 받은 지 사십 년이 된 사람이었습니다.`,
            `바르보 영감은 그 말을 새겨들었습니다.`,
            `그리고 아내에게도 그 말을 전했습니다.`,
            `아내는 대꾸하지 않았습니다.`,
            `그런데 실제로는 그렇게 되지 않았습니다. 아이들이 너무 예뻤기 때문입니다.`,
            `똑같이 생긴 아이 둘을 나란히 놓으면 누구든 그렇게 됩니다.`,
            `구경하러 오는 사람도 있었습니다.`,
            `어머니는 두 아이에게 똑같은 옷을 입혔습니다. 둘을 나란히 놓고 보는 것이 좋았기 때문입니다.`,
            `마을 사람들도 그것을 보러 왔습니다.`,
            `그리고 다들 예쁘다고 했습니다.`,
            `형은 실비네, 동생은 랑드리라고 지었습니다.`,
            `두 아이는 아주 닮았습니다. 마을 사람들도 구별하지 못했습니다. 그런데 성격은 달랐습니다.`,
            `얼굴은 같은데 속은 달랐습니다.`,
            `그것이 이 이야기에서 아주 중요합니다.`,
            `어머니만 겨우 구별했습니다.`,
            `귀 뒤에 점이 하나 있었습니다.`,
            `실비네는 마음이 여리고 생각이 많았습니다. 랑드리는 몸이 튼튼하고 겁이 없었습니다.`,
            `밤에 잘 자지 못했습니다.`,
            `같은 날 태어난 아이 둘이 그랬습니다.`,
            `그래서 사람들이 더 신기해했습니다.`,
            `실비네는 나비를 잡았다가도 놓아 주었습니다.`,
            `랑드리는 개울에 뛰어들어 물고기를 손으로 잡았습니다. 실비네는 낯선 사람이 오면 어머니 뒤로 숨었습니다.`,
            `실비네는 그것을 개울가에서 보고 있었습니다.`,
            `랑드리는 앞으로 나가 이름을 물었습니다. 그리고 두 아이는 서로를 몹시 아꼈습니다.`,
            `그것이 이 이야기의 시작입니다.`,
            `늘 함께 놀았고, 함께 잤고, 하나가 울면 다른 하나도 울었습니다. 누가 실비네를 놀리면 랑드리가 달려들어 싸웠습니다.`,
            `떨어져 있는 것을 본 사람이 없었습니다.`,
            `그런데 실비네가 놀림을 당하는 일이 더 많았습니다.`,
            `약해 보였기 때문입니다.`,
            `사람들은 그것을 보고 참 보기 좋다고 했습니다. 그런데 바르보 영감만은 마음이 편치 않았습니다.`,
            `두 아이가 서로 말고는 아무도 필요로 하지 않았기 때문입니다.`,
            `다른 아이들과 놀지 않았습니다.`,
            `둘이면 충분했습니다.`,
            `바르보 영감은 밭에서 일하다가 가끔 두 아이를 지켜보았습니다. 그리고 이런 생각을 했습니다.`,
            `농부는 밭을 보면서 여러 가지를 생각합니다.`,
            `저 둘은 언젠가 떨어져야 합니다. 사람은 누구나 자기 몫의 삶을 따로 살아야 하기 때문입니다.`,
            `나란히 심은 나무도 자라면 뿌리가 서로를 밉니다.`,
            `바르보 영감은 밭에서 그것을 여러 번 보았습니다.`,
            `그런데 언제 어떻게 떼어 놓아야 하는지는 알 수 없었습니다.`,
            `그것을 알려 주는 사람은 아무도 없었습니다.`,
            `바르보 영감은 그 일을 여러 해 미루었습니다.`,
            `열네 살이 될 때까지요.`
        ]
    },
    {
        ...
        paras: [
            ...
            `더 미루면 안 되겠다고 여긴 것입니다.`,
            `아이들이 자랄수록 더 붙어 다녔기 때문입니다.`,
            ...
            `밤에 아이들이 잠든 뒤였습니다.`,
            `아내는 더 말하지 못했습니다.`,
            `살림 이야기라 대꾸할 말이 없었습니다.`,
            `그 시절 시골에서는 그렇게 하는 집이 많았습니다. 아이가 여럿이면 하나쯤은 남의 농장에 일꾼으로 보냈습니다. 새경이라는 것은 한 해 일하고 받는 삯입니다.`,
            `부끄러운 일이 아니었습니다.`,
            `오히려 일찍 나가면 일을 빨리 배웠습니다.`,
            `돈으로 받기도 하고 곡식으로 받기도 했습니다. 열네 살이면 어른의 절반쯤 받았습니다.`,
            `그 돈을 집에 보탰습니다.`,
            `한 해에 사십 프랑쯤이었습니다.`,
            ...
            `언덕 하나만 넘으면 되었습니다.`,
            `그런데 두 아이에게는 아주 멀었습니다.`,
            `한 번도 떨어져 본 적이 없었기 때문입니다.`,
            `바르보 영감은 두 아이를 불렀습니다.<br>"둘 중에 하나가 프리슈에 가야 한다. 누가 갈지 너희가 정해라."`,
            `둘을 나란히 앉혔습니다.`,
            `그것이 제일 어려운 말이었습니다.`,
            `아버지도 정하지 못해서 아이들에게 넘긴 것이었습니다.`,
            ...
            `실비네는 그 말에 대꾸하지 못했습니다.`,
            `그것은 사실이었습니다.`,
            `랑드리가 한 뼘쯤 더 컸습니다.`,
            `그런데 그것 때문만은 아니었습니다. 랑드리는 형이 남의 집에서 견디지 못하리라는 것을 알고 있었습니다.`,
            `형은 낯선 데서 하룻밤도 못 자는 사람이었습니다.`,
            `랑드리는 그것을 아버지보다 잘 알았습니다.`,
            `랑드리가 떠나던 날 아침, 실비네는 집 뒤로 가서 나오지 않았습니다.`,
            `보면 못 보낼 것 같았기 때문입니다.`,
            `담 뒤에 웅크리고 있었습니다.`,
            `랑드리는 어머니에게 인사하고 길을 나섰습니다. 마을 어귀까지 갔다가 뒤를 돌아보았습니다.`,
            `형이 나와 있을 줄 알았습니다.`,
            `나와 있지 않았습니다.`,
            ...
            `그 생각 하나로 한 시간을 걸었습니다.`,
            `프리슈 농장이 보이는 언덕에 이르렀을 때 해가 높이 떠 있었습니다.`,
            `랑드리는 그 자리에 서서 옷을 털었습니다. 그리고 얼굴을 문질러 눈물 자국을 지웠습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `그 집에서 제일 어린 일꾼이었습니다.`,
            `카요 영감은 사람이 나쁘지 않았습니다. 그 집 사람들도 랑드리를 잘 대해 주었습니다.`,
            `다만 집은 아니었습니다.`,
            `랑드리는 일을 아주 잘했습니다. 소를 다루는 솜씨가 좋아서 곧 그 집에서 없어서는 안 될 사람이 되었습니다.`,
            `소가 랑드리 말을 잘 들었습니다.`,
            `새벽 네 시에 일어나 소에게 여물을 주고, 해가 뜨면 밭으로 나갔습니다.`,
            `겨울에는 캄캄할 때 일어났습니다.`,
            `낮에는 쟁기를 잡았고, 저녁에는 다시 소를 돌보았습니다. 손에 물집이 잡혔다가 굳은살이 되었습니다.`,
            `석 달 만에 손이 어른 손이 되었습니다.`,
            `석 달이 지나자 카요 영감이 이렇게 말했습니다.<br>"저 아이는 열네 살인데 스무 살 몫을 한다."`,
            `카요 영감은 사람 앞에서 칭찬을 잘 하지 않는 사람이었습니다.`,
            `일요일마다 랑드리는 집에 갔습니다.`,
            `일주일에 한 번이었습니다.`,
            `그날은 실비네가 마을 어귀까지 나와 기다렸습니다. 두 아이는 하루 종일 붙어 있었습니다.`,
            `할 이야기가 아주 많았습니다.`,
            `그러다 해가 기울면 실비네의 얼굴이 어두워졌습니다.`,
            `랑드리가 돌아가야 했기 때문입니다.`,
            `실비네는 프리슈까지 따라갔다가 돌아왔습니다. 그리고 밤에 울었습니다.`,
            `아무도 모르게 울었습니다.`,
            `랑드리도 처음 몇 달은 힘들었습니다.`,
            `그런데 랑드리는 낮에 일이 많았습니다. 일이 많으면 생각할 겨를이 없습니다. 그래서 랑드리는 조금씩 견딜 만해졌습니다.`,
            `그것이 랑드리를 살렸습니다.`,
            `실비네는 그러지 못했습니다. 실비네는 집에서 아버지와 일했는데, 밭일을 하다가도 자꾸 프리슈 쪽을 보았습니다.`,
            `언덕 너머라 보이지도 않았습니다.`,
            `그리고 야위어 갔습니다.`,
            `어머니가 걱정했습니다.<br>"저러다 병이 나겠어요."`,
            `밥을 잘 먹지 않았습니다.`,
            `바르보 영감은 아무 말도 하지 않았습니다.`,
            `속으로는 그도 걱정하고 있었습니다. 그런데 이제 와서 되돌리면 아무 소용이 없다고 생각했습니다.`,
            `한 번 시작한 일이었습니다.`,
            `그렇게 한 해가 지났습니다. 실비네는 점점 이상해졌습니다. 랑드리가 프리슈에서 다른 사람과 웃고 있는 것을 보면 하루 종일 말을 하지 않았습니다.`,
            `그것이 실비네에게는 견디기 힘든 일이었습니다.`,
            `랑드리는 열다섯이 되었습니다.`,
            `랑드리가 그것을 알아채고 물었습니다.<br>"형, 왜 그래."<br>"아무것도 아니야."<br>`,
            `어느 일요일, 랑드리가 돌아가는 길에 실비네가 이렇게 물었습니다.<br>"거기 사람들이 잘해 줘?"<br>"응."<br>"거기가 우리 집보다 좋아?"`,
            `랑드리는 그 물음에 대답하지 못했습니다. 어떻게 대답해도 형이 아플 것 같았기 때문입니다.`,
            `좋다고 해도, 아니라고 해도 그랬습니다.`,
            `실비네는 그 침묵을 자기 나름대로 알아들었습니다. 그리고 그날 밤 더 오래 울었습니다.`,
            `그 겨울이 제일 힘들었습니다.`
        ]
    },
    {
        ...
        paras: [
            `그해 여름 어느 날이었습니다. 실비네가 집에서 없어졌습니다.`,
            `아무 말도 남기지 않았습니다.`,
            `아주 더운 날이었습니다.`,
            `밀을 벨 무렵이었습니다.`,
            ...
            `밭에 나가 보니 아무도 없었습니다.`,
            `연장만 그 자리에 있었습니다.`,
            `밤이 되자 온 마을이 나섰습니다. 개울을 뒤지고, 숲을 뒤지고, 이웃 마을까지 사람을 보냈습니다.`,
            `종을 쳐서 사람을 모았습니다.`,
            `횃불을 든 사람이 스무 명이 넘었습니다.`,
            `밤새 개울을 따라 오르내렸습니다.`,
            `랑드리도 프리슈에서 달려왔습니다.`,
            `한 시간 길을 이십 분에 왔습니다.`,
            `밤새 찾았지만 나오지 않았습니다.`,
            `새벽이 되었습니다.`,
            `이튿날도 못 찾았습니다. 어머니는 앓아누웠습니다.`,
            `이틀째였습니다.`,
            `다들 말수가 줄었습니다.`,
            `바르보 영감은 개울가에 서서 물을 오래 보았습니다.`,
            `아무 말도 하지 않았습니다.`,
            `아무도 그 말을 입 밖에 내지 않았습니다. 그런데 다들 같은 생각을 하고 있었습니다.`,
            `개울 쪽이었습니다.`,
            `개울은 그해 여름 물이 많았습니다. 물레방앗간 아래는 어른 키를 넘었습니다. 마을에서는 몇 해 전에도 그 자리에서 사람이 하나 나온 적이 있었습니다. 그래서 다들 그쪽을 보면서도 아무 말도 하지 않았습니다.`,
            `장마가 길었기 때문입니다.`,
            `그 말을 입에 올리면 정말이 될 것 같았습니다.`,
            `그날 저녁, 랑드리는 혼자 개울 쪽으로 걸었습니다.`,
            `아무에게도 말하지 않고 갔습니다.`,
            `혼자 확인하고 싶었습니다.`,
            `그러다 물레방앗간 근처에서 걸음을 멈췄습니다. 그 옆 비탈에 낡은 오두막이 하나 있었습니다.`,
            `지붕이 반쯤 내려앉은 집이었습니다.`,
            `담도 없었습니다.`,
            `파데 할머니가 사는 집이었습니다. 마을 사람들은 그 할머니를 조금 무서워했습니다. 약초를 잘 알아서 아픈 사람을 고쳐 주었는데, 사람들은 그것을 마법이라고 했습니다.`,
            `고쳐 주면 고맙다고 하고 돌아서서는 그렇게 말했습니다.`,
            `그런데 아프면 다들 그 집에 갔습니다.`,
            `의사가 오려면 하루가 걸렸기 때문입니다.`,
            `그 집에는 손녀가 둘 있었습니다. 팡셰라는 여자아이와, 그 남동생 자네였습니다.`,
            `아니, 손녀와 손자였습니다.`,
            `두 아이의 어머니는 몇 해 전에 마을을 떠났고, 그 뒤로 소식이 없었습니다.`,
            `군인을 따라갔다고들 했습니다.`,
            `그것이 사실인지는 아무도 몰랐습니다.`,
            `마을에서는 그 어머니에 대해 좋지 않은 말이 돌았습니다. 그래서 두 아이도 그 말을 듣고 자랐습니다.`,
            `어른들이 아이들 앞에서도 그 말을 했습니다.`,
            `그러니 아이들도 따라 했습니다.`,
            `팡셰는 랑드리와 나이가 비슷했습니다. 그런데 아이들은 팡셰를 '작은 파데트'라고 불렀습니다.`,
            `그 마을 말로 파데트는 도깨비라는 뜻이었습니다. 팡셰는 키가 작고 말랐고, 머리가 헝클어져 있었고, 옷이 늘 더러웠습니다.`,
            `신발도 없이 다녔습니다.`,
            `겨울에도 그랬습니다.`,
            `할머니의 성이 파데였기 때문에 더 그렇게 불렀습니다.`,
            `이름을 부르는 사람이 없었습니다.`,
            `그리고 말이 아주 험했습니다.`,
            `아이들이 놀리면 팡셰는 더 심한 말로 되받았습니다.`,
            `아주 아픈 데를 골라 되받았습니다.`,
            `그래서 아무도 팡셰와 놀지 않았습니다. 팡셰는 소를 쳤습니다.`,
            `여덟 살 때부터 했습니다.`,
            `학교에는 한 번도 가지 않았습니다.`,
            `마을 사람들의 소를 맡아 하루 종일 들에서 먹이고 저녁에 돌려주는 일이었습니다.`,
            `그 삯으로 세 식구가 먹고살았습니다. 동생 자네는 다리를 절었습니다.`,
            `어릴 때 앓고 나서 그렇게 되었습니다.`,
            `그래서 아이들이 자네도 놀렸습니다.`,
            `팡셰는 누가 자네를 놀리면 돌을 던졌습니다. 그래서 팡셰가 더 미움을 받았습니다.`,
            `동생을 지키다가 그렇게 된 것이었습니다.`
        ]
    },
    {
        num: 5,
        ...
        paras: [
            ...
            `다리를 흔들고 있었습니다.`,
            `"형을 찾는다며?"`,
            `랑드리는 대꾸하지 않았습니다.<br>"내가 어디 있는지 아는데."`,
            `랑드리가 걸음을 멈췄습니다.`,
            `그 아이와 말을 섞고 싶지 않았습니다.`,
            `랑드리가 고개를 들었습니다.`,
            ...
            `길이 아닌 데로 갔습니다.`,
            `가는 동안 팡셰는 뒤도 돌아보지 않았습니다. 걸음이 아주 빨랐습니다.`,
            `맨발인데도 빨랐습니다.`,
            `랑드리는 뛰다시피 따라갔습니다.`,
            `가면서 랑드리는 이런 생각을 했습니다. 이 아이가 거짓말을 하는 것이면 어쩌나. 그런데 그런 것 같지는 않았습니다.`,
            `거짓말을 하는 사람은 자꾸 뒤를 돌아보기 때문입니다.`,
            `랑드리는 그것을 어디서 배운 것도 아닌데 알고 있었습니다.`,
            `그리고 물이 굽어 도는 자리에서 멈췄습니다. 그 자리에 커다란 물푸레나무가 있었고, 그 아래 풀이 무성했습니다.`,
            `길에서는 보이지 않는 자리였습니다.`,
            `그 안에 실비네가 웅크리고 앉아 있었습니다.`,
            `이틀 동안 아무것도 먹지 않고 그 자리에 있었던 것입니다. 랑드리가 달려가 형을 안았습니다.`,
            `실비네가 아주 가벼워져 있었습니다.`,
            `옷이 젖어 있었습니다.`,
            `실비네는 울면서 말했습니다.<br>"집에 못 가겠어."<br>"왜."<br>"내가 집을 나오면 다들 나를 찾을 줄 알았어. 그런데 막상 아무도 안 오니까······."<br>"다들 밤새 찾았어."`,
            `실비네는 그 말을 몰랐던 것입니다.`,
            `실비네는 그 말을 듣고 더 울었습니다.`,
            `랑드리는 형을 업고 집으로 갔습니다. 가면서 뒤를 돌아보았습니다.`,
            `형이 등에서 잠들었습니다.`,
            ...
            `아버지도 우는 것을 아무에게도 보이지 않았습니다.`,
            `그날 밤 랑드리는 프리슈로 돌아가지 않고 집에서 잤습니다.`,
            `형 옆에 누웠는데 잠이 오지 않았습니다. 팡셰가 한 말이 자꾸 생각났기 때문입니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `겨울 개울가였습니다.`,
            `말리지 않았습니다. 웃지도 않았지만 말리지도 않았습니다.`,
            `자네가 그 지팡이를 주우러 절뚝거리며 가는 것을 보고만 있었습니다.`,
            `그때는 그것이 아무것도 아닌 일 같았습니다. 지금은 아니었습니다.`,
            `랑드리는 그날 밤 그 일을 여러 번 떠올렸습니다.`
        ]
    },
    {
        num: 7,
        ...
        paras: [
            ...
            `그날 처음 함께 춤을 춘 두 사람이 가을에 혼인하는 일이 흔했습니다. 그래서 누가 누구와 춤을 추는지를 온 마을이 지켜보았습니다.`,
            `그날의 춤이 곧 소문이 되었습니다.`,
            `그날의 춤은 그냥 춤이 아니었습니다.`,
            `젊은 사람들에게는 아주 큰 일이었습니다.`,
            `랑드리는 그날 마들롱이라는 아이와 춤을 추기로 되어 있었습니다. 마들롱은 카요 영감의 조카딸인데, 마을에서 예쁘기로 소문난 아이였습니다.`,
            `여러 사람이 마들롱과 춤추고 싶어 했습니다.`,
            `랑드리는 그것이 아주 좋았습니다. 첫 번째 춤을 추려고 손을 내미는데,`,
            `음악이 막 시작된 참이었습니다.`,
            `여러 날 전부터 기다렸습니다.`,
            `옆에서 누가 팔을 잡았습니다. 팡셰였습니다.`,
            `언제 왔는지도 몰랐습니다.`,
            `머리가 헝클어져 있었고, 옷이 낡았습니다.<br>"약속 기억나?"`,
            `축제 날인데도 그랬습니다.`,
            `랑드리의 얼굴이 하얘졌습니다.`,
            `"······기억나."<br>"오늘 나랑 춤춰. 일곱 번."`,
            `일곱 번이면 그날 춤을 다 추는 것이었습니다.`,
            `광장이 조용해졌습니다.`,
            `그리고 웃음이 터졌습니다.`,
            `광장이 다 웃었습니다.`,
            `"저 도깨비가 랑드리한테 춤을 추재!"`,
            `마들롱이 얼굴을 붉히며 돌아섰습니다.`,
            `그 자리에 서 있을 수가 없었습니다.`,
            `랑드리는 그 자리에 서 있었습니다. 도망칠 수도 있었습니다.`,
            `약속이라고 해도 아무도 나무라지 않았을 것입니다.`,
            `그런데 랑드리는 손을 내밀었습니다.`,
            `"그러자."`,
            `광장이 다시 조용해졌습니다.`,
            `두 사람은 춤을 추었습니다. 한 번, 두 번, 세 번.`,
            `팡셰는 춤을 아주 잘 추었습니다.`,
            `사람들이 둘러서서 놀렸습니다.`,
            `팡셰는 고개를 들고 춤을 추었습니다.`,
            `한 번도 눈을 내리지 않았습니다.`,
            `일곱 번을 다 추었습니다. 네 번째 춤부터 사람들이 조금 조용해졌습니다.`,
            `놀림이 오래가지 않았습니다.`,
            `다섯 번째부터는 아무도 웃지 않았습니다. 여섯 번째와 일곱 번째는 거의 아무 소리도 나지 않았습니다. 무엇 때문에 조용해졌는지는 그 자리에 있던 사람들도 몰랐습니다.`,
            `다만 다들 그 두 사람을 보고 있었습니다.`,
            `그리고 춤이 끝나자 팡셰는 광장을 빠져나갔습니다.`,
            `랑드리는 마들롱을 찾으러 갔습니다. 마들롱은 다른 사람과 춤을 추고 있었고, 랑드리를 보고도 못 본 척했습니다.`,
            `랑드리는 그날 아무 말도 하지 못했습니다.`
        ]
    },
    {
        num: 8,
        ...
        paras: [
            ...
            `랑드리는 가지 않았습니다.`,
            `랑드리는 옆에 앉았습니다.`,
            `채석장에는 아무도 없었습니다. 저 아래 광장에서 아직 음악 소리가 났습니다.`,
            `돌이 다 파여 나간 자리였습니다.`,
            `그 소리가 여기까지 들렸습니다.`,
            `멀어서 아주 작게 들렸습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `낡은 옷은 그대로였습니다.`,
            `아무도 그 까닭을 몰랐습니다.`,
            `말을 험하게 하지 않았습니다. 누가 놀려도 되받지 않고 그냥 지나갔습니다.`,
            `처음에는 아이들이 더 심하게 놀렸습니다.`,
            `그런데 여기서 한 가지 짚어 둘 것이 있습니다.`,
            `팡셰는 랑드리가 시켜서 그렇게 한 것이 아닙니다. 랑드리는 아무것도 시키지 않았습니다.`,
            `그날 채석장에서 한 말이 전부였습니다.`,
            `팡셰는 그 말을 듣고 며칠을 혼자 생각한 끝에, 자기가 정해서 그렇게 한 것입니다.`,
            `그것이 중요합니다.`,
            `그 가운데 제일 어려운 것이 되받지 않는 일이었습니다. 되받지 않으면 이기지 못한 것 같았기 때문입니다.`,
            `팡셰는 몇 번이나 참지 못하고 되받았습니다. 그러고는 집에 와서 스스로에게 화를 냈습니다.`,
            `그 겨울이 팡셰에게는 제일 긴 겨울이었습니다.`,
            `팡셰는 나중에 이렇게 말했습니다.<br>"나는 사람들이 나를 어떻게 보든 상관없다고 생각했어. 그런데 아니었어. 상관있었어. 그걸 인정하는 게 제일 어려웠어."`,
            `봄이 되자 마을 사람들이 놀랐습니다. 그 도깨비 같던 아이가 사라지고, 그 자리에 조용하고 눈이 맑은 소녀가 있었기 때문입니다.`,
            `같은 아이였습니다.`,
            `팡셰는 여전히 키가 작고 얼굴이 예쁘지 않았습니다. 그런데 사람들이 자꾸 그 아이를 다시 보게 되었습니다.`,
            `까닭은 아무도 몰랐습니다.`,
            `팡셰는 할머니에게서 약초를 배웠습니다.`,
            `어릴 때부터 옆에서 보고 있었습니다.`,
            `그리고 아픈 사람의 집에 가서 밤을 새우고 오는 일이 많아졌습니다. 그러면서 마을에서 팡셰를 좋게 말하는 사람이 하나둘 생겼습니다.`,
            `신세를 진 집부터 그랬습니다.`,
            `랑드리는 그동안 프리슈에서 일했습니다.`,
            `그리고 일요일마다 개울가에서 팡셰를 만났습니다. 두 사람은 물푸레나무 아래에 앉아서 이야기를 했습니다.`,
            `실비네를 찾아낸 그 자리였습니다.`,
            `랑드리는 팡셰와 이야기하는 것이 좋았습니다. 팡셰는 랑드리가 아는 누구보다 아는 것이 많았습니다. 풀 이름을 다 알았고, 새 소리를 구별했고, 사람 마음을 잘 읽었습니다.`,
            `그리고 남의 이야기를 오래 들어 주었습니다.`,
            `랑드리는 그것이 제일 좋았습니다.`,
            `랑드리는 그해 봄에 이런 생각을 했습니다. '나는 이 사람이 좋다.'`,
            `그리고 그 생각을 하고 나서 며칠 동안 밥이 안 넘어갔습니다.`,
            `열일곱 살이었습니다.`,
            `그해 여름 마을에 열병이 돌았습니다. 여러 집에서 아이들이 앓았습니다.`,
            `그해 여름은 아주 더웠습니다.`,
            `팡셰는 그 집들을 다니면서 밤을 새웠습니다.`,
            `그 가운데는 팡셰를 도깨비라고 부르던 아이들의 집도 있었습니다. 팡셰는 그 집에도 갔습니다.`,
            `문 앞에서 쫓아냈던 집도 있었습니다.`,
    ...
    },
    {
        ...
        paras: [
            `여름이 되자 소문이 났습니다. 프리슈의 랑드리가 파데트와 만난다는 소문이었습니다.`,
            `개울가에서 함께 있는 것을 누가 본 것이었습니다.`,
            ...
            `랑드리는 그 말을 똑바로 했습니다.`,
            `바르보 영감이 손을 들었습니다. 그런데 때리지는 않았습니다.`,
            `예전 같으면 때렸을 것입니다.`,
            `랑드리가 열여덟이 되어 있었기 때문입니다.`,
            `키가 아버지보다 컸습니다.`,
            `"내가 반대하면 어쩌겠느냐."<br>"기다리겠습니다."<br>"언제까지."<br>"아버지가 그 아이를 한 번이라도 만나 보실 때까지요."`,
            `바르보 영감은 그 말에 대꾸하지 못했습니다.`,
            `바르보 영감은 아들의 얼굴을 보았습니다. 그 얼굴에서 자기 젊을 때가 보였습니다.`,
            `자기도 그런 적이 있었습니다.`,
            `그래서 더 화가 났습니다.`,
            `"나가 봐라."`,
            `랑드리가 나가고 나서 바르보 영감은 오래 앉아 있었습니다.`,
            `담배도 피우지 않았습니다.`,
            `그 무렵 실비네도 힘들어했습니다. 실비네는 팡셰를 아주 미워했습니다.`,
            `이름도 부르지 않았습니다.`,
            `그런데 그 까닭이 이상했습니다.`,
            `실비네는 팡셰가 나쁜 아이라서 미워한 것이 아니었습니다. 동생이 자기 말고 다른 사람을 좋아하는 것이 견디기 힘들었던 것입니다.`,
            `그것을 말로 하면 부끄러운 일이었습니다.`,
            `실비네는 그것을 스스로 인정하지 못했습니다. 그래서 팡셰의 흠을 자꾸 찾았습니다.`,
            `흠이 있어야 미워해도 되기 때문입니다.`,
    ...
    },
    {
        ...
        paras: [
            `그해 가을, 파데 할머니가 세상을 떠났습니다. 팡셰는 열여덟이었고, 남동생 자네는 열두 살이었습니다.`,
            `두 아이만 남았습니다.`,
            `집에 어른이 하나도 없게 된 것입니다.`,
            `여든이 넘은 나이였습니다.`,
            `앓지 않고 갔습니다.`,
            `장례를 치르고 나서 팡셰가 랑드리를 찾아왔습니다.`,
            `검은 옷을 입고 있었습니다.`,
            `할머니의 옷을 줄여 입은 것이었습니다.`,
            `"나 마을을 떠날 거야." 랑드리가 놀랐습니다.`,
            `그런 말은 생각도 하지 못했습니다.`,
            `"왜."<br>"여기 있으면 네 아버지가 너를 못 견디게 하실 테니까."<br>"그건 내 일이야."<br>"그리고 나도 좀 배우고 싶어."`,
            `랑드리가 목소리를 높였습니다.`,
            `그 말이 진짜 까닭이었습니다.`,
            `팡셰는 그 소문을 다 듣고 있었습니다.`,
            `팡셰는 도시로 가서 병자를 돌보는 일을 배우겠다고 했습니다.`,
            `가까운 도시가 사흘 길이었습니다.`,
            `할머니에게 배운 것이 있으니 그것을 제대로 배워 보겠다는 것이었습니다.`,
            `약초를 다루는 손이 이미 좋았습니다.`,
            `할머니가 그것을 알아보고 가르친 것이었습니다.`,
            `그 무렵 도시에는 병자를 돌보는 사람을 구하는 큰 집이 많았습니다.`,
            `글을 읽을 줄 알고 약을 다룰 줄 알면 자리를 얻을 수 있었습니다. 팡셰는 할머니에게서 글을 배웠습니다.`,
            `그런 사람이 드물었습니다.`,
            `시골에서는 더 그랬습니다.`,
            `파데 할머니는 젊을 때 어느 집에서 일하며 글을 배운 사람이었습니다.`,
            `그리고 손녀에게 그것을 다 가르쳤습니다.`,
            `그것을 아는 사람은 마을에 하나도 없었습니다.`,
            `마을에서는 그 집을 그냥 도깨비 집이라고 불렀습니다.`,
            `글을 아는 집인 줄은 아무도 몰랐습니다.`,
            `"자네는 우리 이모가 봐 주기로 했어."<br>랑드리가 말했습니다.<br>"언제 올 거야."<br>"몰라."<br>"기다릴게."`,
            `동생 걱정이 제일 컸습니다.`,
            `랑드리는 그 말을 아주 쉽게 했습니다.`,
            `팡셰는 그 말에 아무 대답도 하지 않았습니다.`,
            `기다린다는 말을 받아 두지 않은 것이었습니다.`,
            `받아 두면 그 사람을 묶는 것이기 때문입니다.`,
            `대신 이렇게 말했습니다.<br>"랑드리, 나 하나만 물어볼게."<br>"응."<br>"내가 지금 이대로 여기 있으면, 너희 아버지는 평생 나를 안 받아 주실 거야. 그런데 내가 밖에서 뭔가 되어서 돌아오면 받아 주실까?"`,
            `아주 어려운 물음이었습니다.`,
            `랑드리는 그 답을 알고 있었습니다.`,
            `랑드리는 대답하지 못했습니다.`,
            `대답하면 아버지 이야기가 되기 때문입니다.`,
            `팡셰가 말했습니다.<br>"그럼 그건 나를 받아 주시는 게 아니지."`,
            `랑드리는 그 말이 맞다고 생각했습니다.`,
            `그러고는 웃었습니다.`,
            `처음으로 시원하게 웃었습니다.`,
            `"그래도 갈래. 나를 위해서 가는 거야."`,
            `그것이 팡셰가 처음으로 자기를 위해 정한 일이었습니다.`,
            `그때까지는 늘 남이 정해 준 자리에 있었습니다.`,
            `팡셰는 그해 겨울에 마을을 떠났습니다.`,
            `겨울 아침이었습니다. 길에 서리가 내려 있었습니다.`,
            `해가 뜨기 전이었습니다.`,
            `아무도 배웅 나오지 않았습니다.`,
            `팡셰는 보따리를 하나 들고 있었습니다. 그 안에 옷 두 벌과 할머니의 약초 주머니가 들어 있었습니다.`,
            `가진 것 전부였습니다.`,
            `돈은 얼마 되지 않았습니다.`,
            `랑드리는 큰길까지 배웅했습니다. 큰길에서 두 사람은 아무 말도 하지 않았습니다.`,
            `마차가 오자 팡셰가 올라탔습니다. 그리고 그때 한 번 돌아보았습니다.`,
            `그것이 전부였습니다.`,
            `짐칸에 앉았습니다.`,
            `삯이 싼 자리였습니다.`,
            `랑드리는 그 뒤로 한 해 동안 소식을 듣지 못했습니다.`
        ]
    },
    {
        num: 12,
        ...
        paras: [
            ...
            `한 해를 그 집에서 살았습니다.`,
            `그 집에서 팡셰는 아침 여섯 시부터 밤 열 시까지 일했습니다. 그러면서 의사가 오면 옆에 서서 보고 물었습니다.`,
            `쉬는 날이 한 달에 하루였습니다.`,
            ...
            `대개는 시키는 대로만 했습니다.`,
            `그 노부인이 세상을 떠나면서 팡셰에게 얼마간의 돈을 남겼습니다. 그리고 또 한 가지가 있었습니다.`,
            `마을에 돌아와서 알게 된 일이었습니다.`,
            `파데 할머니가 남긴 것이었습니다. 할머니는 평생 아주 가난하게 살았습니다.`,
            `옷도 기워 입었습니다.`,
            `그런데 사실은 돈을 모아 두고 있었습니다.`,
            `약초로 병을 고쳐 준 값을 사람들이 조금씩 주었는데, 할머니는 그것을 하나도 쓰지 않고 항아리에 모았습니다.`,
            `사십 년 동안 모은 것이었습니다.`,
            `그 돈이 사만 프랑이었습니다. 마을에서 제일 잘사는 집보다 많은 돈이었습니다.`,
            `바르보 영감의 재산보다 많았습니다.`,
            `할머니는 그것을 손녀와 손자에게 반씩 남겼습니다.`,
            `그 소식이 마을에 퍼지자 사람들의 태도가 달라졌습니다. 그전까지 팡셰를 도깨비라고 부르던 사람들이 이제는 팡셰 양이라고 불렀습니다.`,
            `하루 만에 그렇게 되었습니다.`,
            `팡셰는 그것을 다 보았습니다.`,
            `돈이 사람을 어떻게 바꾸는지를요.`,
            `그리고 아무 말도 하지 않았습니다. 바르보 영감도 그 소식을 들었습니다.`,
            `그리고 마음이 흔들렸습니다.`,
            `사만 프랑이면 큰돈이었습니다.`,
            `그것을 스스로도 알았습니다. 그래서 부끄러웠습니다.`,
            `여러 해 반대하던 사람이 돈 이야기에 흔들린 것입니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `바르보 영감이 팡셰를 보았습니다.`,
            `바르보 영감은 잠깐 망설였습니다.`,
            `그러다 허락했습니다. 팡셰는 그 방에 들어가 문을 닫았습니다.`,
            `아무도 들어오지 못하게 했습니다.`,
            `다른 수가 없었기 때문입니다.`,
            `의사도 손을 든 참이었습니다.`,
            ...
            `밥도 그 방에서 먹었습니다.`,
            `잠도 그 방에서 잤습니다.`,
            `방 안은 어두웠습니다. 실비네가 빛을 싫어해서 덧문을 닫아 두었기 때문입니다.`,
            `여러 달 그러고 있었습니다.`,
            `방에서 눅눅한 냄새가 났습니다.`,
            ...
            `실비네가 얼굴을 돌렸습니다.`,
            `아무 말도 하지 않았습니다.`,
            `팡셰는 아무 말도 하지 않고 그 옆에 앉았습니다. 팡셰가 한 일은 약을 먹인 것이 아니었습니다.`,
            `약은 이미 여러 가지를 써 본 뒤였습니다.`,
            `팡셰는 약을 꺼내지도 않았습니다.`,
            `팡셰는 실비네 옆에 앉아서 이야기를 들었습니다. 실비네는 처음에는 아무 말도 하지 않았습니다. 팡셰를 미워하고 있었기 때문입니다.`,
            `동생을 빼앗아 간 사람이라고 여겼습니다.`,
            `하루하고 반이 그렇게 지났습니다.`,
            `그러다 이틀째 밤에 입을 열었습니다.`,
            `밤이 아주 길었습니다.`,
            `둘 다 잠들지 않았습니다.`,
            `그리고 자기가 열네 살 때부터 어떤 마음으로 살았는지를 다 말했습니다. 동생이 떠나던 날 집 뒤에 숨어 있었던 것. 일요일마다 동생이 돌아가는 뒷모습을 보면서 무슨 생각을 했는지.`,
            `여러 해 동안 아무에게도 하지 않은 말이었습니다.`,
            `아무에게도 하지 않은 이야기였습니다.`,
            `부모에게도 하지 않았습니다.`,
            `동생이 다른 사람과 웃으면 왜 그렇게 화가 났는지. 그리고 개울가에 이틀 동안 앉아 있었던 날, 사실은 누가 찾으러 오기를 기다리고 있었다는 것.`,
            `그 말을 하고 실비네가 울었습니다.`,
            `팡셰는 그 이야기를 다 들었습니다.`,
            `한 번도 끊지 않았습니다.`,
            `나무라지도 않았습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `그 말이 나오기까지 십 년이 걸린 셈이었습니다.`,
            `팡셰는 고개를 저었습니다.`,
            `팡셰가 고개를 저었습니다.`,
            `"어른만 그러신 게 아닙니다. 이 마을이 다 그랬습니다."`,
            `팡셰는 그것을 알고 있었습니다.`,
            `"그래도 나는 어른이다."`,
            `그것이 그 사람이 한 말 가운데 제일 무거운 말이었습니다.`,
            `바르보 영감은 그 말을 하고 나서 손을 무릎에 놓았습니다.`,
            `그 손이 조금 떨렸습니다. 그 사람은 평생 남에게 잘못했다는 말을 해 본 적이 없었습니다.`,
            `농부에게 그런 말은 쉽지 않습니다.`,
            `더구나 아이에게 하는 말이었습니다.`,
            ...
            `바르보 영감은 마을에서 말이 무거운 사람이었습니다. 그래서 그 한마디가 여러 사람의 입을 다물게 했습니다.`,
            `말은 그런 데서 힘이 있습니다.`
        ]
    },
    {
        ...
        paras: [
            ...
            `개울가 성당에서였습니다.`,
            `마을 사람들이 다 왔습니다. 그 가운데는 팡셰를 도깨비라고 부르던 사람들도 있었습니다.`,
            `그 사람들이 제일 잘 차려입고 왔습니다.`,
            `다들 아무 일도 없었던 것처럼 웃으며 왔습니다. 팡셰는 그 사람들을 다 맞았습니다.`,
            `한 사람도 돌려보내지 않았습니다.`,
            `랑드리가 나중에 물었습니다.<br>"화 안 나?"<br>"나."<br>"그런데 왜 그래?"<br>"화를 계속 내면 내가 그 사람들 손에 계속 잡혀 있는 거야."`,
            `팡셰는 그것을 도시에서 배웠다고 했습니다.`,
            `혼인한 뒤 팡셰가 제일 먼저 한 일이 있습니다. 할머니가 남긴 돈으로 마을에 집을 하나 마련한 것입니다.`,
            `개울가의 낡은 집을 고쳤습니다.`,
            ...
            `도깨비 집 아이였기 때문입니다.`,
            `우유 한 잔을 얻으러 갔다가 그냥 돌아왔습니다. 팡셰는 그것을 기억하고 있었습니다.`,
            `할머니가 빈손으로 돌아오던 그 밤이었습니다.`,
            `실비네는 그 뒤로 나았습니다. 그런데 마을에 남지 않았습니다.`,
            `몸이 먼저 나았고 마음이 나중에 나았습니다.`,
            `군대에 들어간 것입니다.`,
            `스무 살이었습니다.`,
            `떠나던 날 실비네가 랑드리에게 말했습니다.<br>"나는 여기 있으면 계속 너만 보고 살 것 같아."<br>"형."<br>"괜찮아. 나도 이제 알아."`,
            `랑드리가 형을 안았습니다.`,
            `실비네는 그것을 스스로 알아낸 것이었습니다.`,
            `그러고는 팡셰에게 고개를 숙였습니다.<br>"고맙습니다."`,
            `그 말을 팡셰에게 한 것이었습니다.`,
            `실비네는 그 뒤로 편지를 자주 보냈습니다. 그리고 여러 해 뒤에는 아주 다른 사람이 되어 돌아왔습니다.`,
            `그때는 혼자 서 있을 수 있는 사람이 되어 있었습니다.`,
            `이 이야기는 여기서 끝납니다.`,
