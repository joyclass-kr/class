...
const CHAPTERS = [
    {
        ...
        paras: [
            ...
            `그 책을 쓴 사람은 마크 트웨인이라는 사람인데, 이 책도 그 사람이 썼다.`,
            `그 사람도 이 강가에서 자랐다. 증기선 물길잡이 노릇을 한 적도 있다.`,
            `내 이름은 허클베리 핀이다. 다들 헉이라고 부른다.`,
            `나이는 열세 살이나 열네 살쯤 된다. 정확히는 나도 모른다.`,
            `아버지가 술을 마시고 세는 바람에 해마다 나이가 달랐다.`,
            `그 책 끝에서 나와 톰은 동굴에서 돈을 찾아냈다. 우리는 각각 육천 달러씩 갖게 되었고, 대처 판사님이 그 돈을 은행에 넣어 주셔서 하루에 일 달러씩 이자가 나왔다.`,
            `강도들이 동굴에 숨겨 둔 것이었다.`,
            `그것을 찾아낸 이야기가 그 책에 다 나온다.`,
            `그 시절 하루 일 달러면 어른이 하루 일해서 버는 것보다 많았다.`,
            `그리고 더글러스 과부 아주머니가 나를 데려다 아들처럼 키우겠다고 하셨다. 그 집에 사는 것은 참 힘들었다.`,
            `나는 그때까지 빈 통이나 남의 집 헛간에서 자던 아이였다.`,
            `학교에 다닌 적도 없고, 옷을 갈아입어 본 적도 별로 없었다.`,
            `그러다 갑자기 침대와 식탁과 학교가 생긴 것이다.`,
            `아주머니는 좋은 분이었다. 그건 분명하다. 다만 그 집에서는 밥 먹기 전에 종이 울리고, 종이 울리면 밥상에 앉아야 하고, 앉으면 곧바로 먹으면 안 되고, 아주머니가 음식을 두고 뭐라고 한참 말씀하시는 것을 기다려야 했다.`,
            `나를 때린 적이 한 번도 없었다. 그런 어른은 그때까지 처음이었다.`,
            `다만 나를 좋게 만들려고 하셨다. 그게 힘들었다.`,
            `음식은 다 식었다. 그런데 그것도 규칙이라고 했다.`,
            `옷은 뻣뻣했고 신발은 발을 죄었다. 담배도 못 피우게 했다.`,
            `여름에도 신발을 신어야 했다.`,
            `그러면서 아주머니는 코담배를 하셨다. 그건 괜찮다고 하셨다.`,
            `세상에는 그런 규칙이 아주 많았다.`,
            ...
            `학교도 나쁘지 않았다. 글을 조금 읽게 되었다.`,
            `처음에는 매를 맞았는데 나중에는 그럭저럭 다녔다.`,
            `석 달쯤 지나니 곱셈까지 하게 되었다.`,
            `그러던 어느 겨울날 아침, 눈 위에 발자국이 나 있었다.`,
            `마당을 가로질러 뒤뜰 담까지 나 있었다.`,
            `나는 그 앞에 쪼그리고 앉아 한참 보았다.`,
            `눈이 그친 뒤에 생긴 발자국이었다. 그러니까 밤사이에 누가 다녀간 것이었다.`,
            `왼쪽 구두 뒤축에 못을 박아 십자 모양을 낸 발자국이었다. 나는 그것을 보자마자 온몸이 굳었다.`,
            `그 십자를 낸 사람이 누구인지 나는 알았다.`,
            `악귀를 쫓는 표시라고 했다. 그런데 그 표시를 낸 사람이 나에게는 악귀였다.`,
            `나는 그길로 달렸다.`,
            `나는 그길로 대처 판사님께 달려갔다.`,
            ...
            `까닭을 묻지 않으신 것이 고마웠다.`,
            `판사님은 어른 가운데 드물게 그런 분이었다.`,
            `판사님이 그 종이를 접어 서랍에 넣으셨다. 아무것도 묻지 않으셨다.`,
            `그날 밤 내 방에 촛불을 켜고 들어가 보니, 의자에 사람이 하나 앉아 있었다. 우리 아버지였다.`,
            `나는 촛불을 떨어뜨릴 뻔했다.`,
            `문을 닫고 나갈 수도 있었다. 그런데 다리가 움직이지 않았다.`,
            `아버지가 나를 위아래로 훑어보았다.`,
            `한 해가 넘도록 보지 못한 사람이었다. 다들 강에서 죽었다고 했었다.`,
            `나는 그 소식을 듣고 마음이 놓였었다. 그런 것을 두고 마음이 놓이는 아들도 있는 법이다.`,
            `나는 그 말을 부끄러워하지 않겠다.`,
            ...
            `"네."<br>"다시 그 집에 들어가면 가만 안 둔다."`,
            `나는 그날 밤 잠을 자지 못했다.`,
            `"돈이 육천 달러 있다던데."<br>"없어요. 다 넘겼어요."<br>"거짓말 마라."`,
            `아버지가 의자에서 일어섰다. 나는 벽 쪽으로 물러섰다.`,
            `아버지는 다음 날 대처 판사님을 찾아갔고, 그 뒤로 몇 주 동안 그 돈을 뺏으려고 별짓을 다 했다.`,
            `재판을 걸었고, 판사님을 찾아가 울었고, 술을 끊겠다고 약속했다. 그러고는 그날 밤 또 마셨다.`,
            `판사님은 결국 그 돈을 내주지 않으셨다. 그래서 아버지는 다른 수를 냈다.`
        ]
    },
    {
        num: 2,
        ...
        paras: [
            ...
            `물소리 말고는 아무 소리도 없었다. 나는 노를 놓고 한참 떠내려갔다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `길이가 사람 아홉 걸음쯤 되었고, 가운데에 오두막처럼 지붕을 얹을 자리가 있었다.`,
            `또 어느 밤에는 집이 통째로 떠내려왔다. 이층집인데 한쪽으로 기울어 떠 있었다.`,
            `창이 다 깨져 있었고, 안에서 물이 찰랑거렸다.`,
            ...
            `나는 사라 윌리엄스라고 했다. 저 아래 마을에서 왔다고 둘러댔다.`,
            `아주머니는 내가 여자아이가 아니라는 것을 금방 알아차렸다. 실을 던지는 자세와 무릎을 모으는 방식으로 알았다고 했다.`,
            `여자아이는 무릎을 모으고 치마로 받는데 나는 무릎을 벌리고 받았다는 것이다.`,
            ...
            `삼백 달러였다. 그 마을에서 그만한 돈이면 누구든 나섰다.`,
            `아버지에게 걸린 돈은 이백 달러라고 했다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `노는 방향을 잡을 때만 썼다. 물살이 알아서 데려갔다.`,
            `강은 넓었다. 어떤 데는 이 킬로미터가 넘었다.`,
            `한가운데로 나가면 양쪽 기슭이 다 멀었다.`,
            ...
            `거기 닿으면 짐은 붙잡히지 않는다. 그것이 우리 계획의 전부였다.`,
            ...
            `짐은 그 말을 아무렇지 않게 했다. 자기 아이를 데려오는 것을 훔친다고 말해야 하는 사람이었다.`,
            `그 말을 듣고 나는 등이 오싹했다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `일을 하다 말고 웃었다. 그런 짐을 나는 그때 처음 보았다.`,
            `짐이 웃으면 나는 웃지 못했다.`,
            `짐은 밤마다 강 왼쪽을 보았다. 카이로가 그쪽에 있었다.`,
            `지나가는 마을마다 저기가 카이로냐고 물었다.`,
            `나는 아니라고 했다. 나도 몰랐다.`,
            `그런데 나는 그 말을 들을 때마다 마음이 나빠졌다.`,
            `짐이 기뻐할수록 나는 더 그랬다.`,
            `나는 이렇게 생각했다. 왓슨 아주머니는 나에게 잘못한 것이 없다. 나에게 글을 가르쳐 주었고 밥을 먹여 주었다. 그런데 나는 그 집 사람을 데리고 도망치고 있다.`,
            `가만히 앉아 있는데도 자꾸 그 생각이 났다.`,
            `그런데 그 아주머니가 짐을 팔려고 했다는 것은 그때 내 셈에 들어가지 않았다.`,
            `그때 나는 사람이 사람의 것이 될 수 있다는 것을 한 번도 의심해 본 적이 없었다.`,
            `어른들이 다 그렇다고 했기 때문이다.`,
            ...
            `그렇게 하면 마음이 편해질 줄 알았다.`,
            `짐이 노를 건네주면서 잘 다녀오라고 했다. 나는 그 손을 못 보고 받았다.`,
            `노를 젓기 시작하자 뒤에서 짐이 또 말을 걸었다.`,
            `짐은 내가 무엇을 하러 가는지 몰랐다.`,
            `"다녀오세요, 도련님." 짐이 뒤에서 말했다.<br>"도련님은 늙은 짐이 만난 사람 중에 가장 좋은 사람입니다. 약속을 지킨 사람은 도련님뿐이에요."`,
            `나는 노를 저으면서 그 말을 계속 들었다.`,
            `귀에서 지워지지 않았다. 노를 저을수록 더 크게 들렸다.`,
            `나는 노를 더 세게 저었다.`,
            `얼마 못 가서 배 한 척을 만났다. 남자 둘이 총을 들고 있었다.`,
            `도망친 사람을 찾아다니는 사람들이었다. 그런 일로 먹고사는 사람들이 있었다.`,
            `잡으면 현상금이 나왔다.`,
            `그러니 강가에서 아이 하나가 카누를 젓고 있으면 반드시 세웠다.`,
            `"얘야, 저기 저 뗏목에 누가 있냐?"<br>"······있어요."<br>"백인이냐?"`,
            `나는 잠깐 아무 말도 하지 못했다.`,
            `백인이라고 하면 짐이 산다. 아니라고 하면 짐이 끝난다.`,
            `나는 그때 신고하러 나온 참이었다. 그런데 입이 안 떨어졌다.`,
            `한마디만 하면 되었다.`,
            `"저희 아버지예요." 내가 말했다.<br>"그런데 병에 걸리셨어요. 좀 도와주시면 안 될까요? 아무도 안 도와줘요."`,
            `나는 나도 모르게 그렇게 말했다.`,
            `말을 해 놓고 나도 놀랐다.`,
            `두 사람이 노를 저어 가까이 왔다.`,
            `나는 그때 무슨 말을 할지 정하지 않은 채로 입을 열었다.`,
            `"무슨 병인데?"<br>"그게······ 그러니까······."`,
            `내가 말을 흐리자 두 사람이 노를 뒤로 저었다.`,
            `그때 나는 알았다. 이 사람들이 겁을 먹고 있다는 것을.`,
            ...
            `널빤지에 얹어 밀어 준 것이었다. 손으로 건네지는 않았다.`,
            `"그 돈 받아라. 그리고 아버지 잘 봐드려라."`,
            `금화 두 닢이면 이십 달러였다. 딱하게 여긴 것이었다.`,
            `가까이 오지는 못하면서 돈은 준 것이다.`,
            `나는 뗏목으로 돌아갔다.`,
            `짐은 물속에 들어가 뗏목 옆에 매달려 있었다. 목만 내놓고 있었다.`,
            `그 물이 아직 찬 철이었다.`,
            `"도련님, 잘하셨습니다." 짐이 말했다.<br>"그렇게 잘하는 사람은 없을 겁니다."`,
            `짐은 물속에서 다 듣고 있었던 것이다.`,
            `내가 무슨 말을 할지 몰라서 물에 들어가 있었던 것이다.`,
            `나는 뗏목 위에 앉아서 오래 생각했다.`,
            `금화 두 닢이 손에 있었다. 그것을 어디에 놓아야 할지 몰랐다.`,
            `내가 옳은 일을 했으면 마음이 좋아야 하는데 그렇지 않았다. 그리고 나쁜 일을 했으면 마음이 나빠야 하는데 그렇지도 않았다.`,
            `그래서 나는 그냥 생각하기를 그만두기로 했다. 그게 편했다.`,
            `그런데 그것이 잘 안 되었다.`,
            `그날 밤 짙은 안개가 왔다.`,
            `강이 사라졌다.`,
            `우리는 카이로를 지나쳤다. 안개 속에서 강줄기가 갈라지는 것을 보지 못한 것이다.`,
            `강 왼쪽에 마을 불빛이 몇 개 지나갔는데, 그게 카이로인 줄 몰랐다.`,
            `안개가 아주 짙었다. 손을 뻗으면 손끝이 안 보일 정도였다.`,
            `그리고 알아차렸을 때는 이미 한참 아래로 내려온 뒤였다.`,
            `카이로 아래로는 물살이 남쪽으로만 간다. 남쪽은 짐이 가면 안 되는 쪽이었다.`,
            `짐은 그날 아무 말도 하지 않았다. 그리고 하루 종일 강 뒤쪽만 보았다.`
        ]
    },
    {
        num: 7,
        ...
        paras: [
            ...
            `불빛이 다가오는데도 방향을 안 바꿨다. 그 배 사람들은 뗏목 따위는 보지도 않았다.`,
            `뗏목이 부서지는 소리가 났다. 나는 물속에서 그 소리를 들었다.`,
            `우리는 물로 뛰어들었다. 나는 한참을 헤엄쳐 왼쪽 강기슭으로 올라갔다.`,
            `짐을 부르며 돌아다녔지만 대답이 없었다.`,
            `목이 쉬도록 불렀다.`,
            `대답이 없어서 나는 짐이 죽은 줄 알았다.`,
            `숲을 헤매다 큰 집을 하나 만났다. 그레인저퍼드라는 집안의 집이었다.`,
            `그 집 사람들은 나를 받아 주었다. 나는 조지 잭슨이라는 이름을 대고 그 집에 며칠 묵게 되었다.`,
            `아무 데서나 이름을 지어내는 것은 그 무렵 내가 제일 잘하는 일이었다.`,
            `처음에는 총을 들고 나왔다. 셰퍼드슨네 사람인 줄 알았던 것이다.`,
            `문틈으로 나를 살펴보고 나서야 문을 열었다.`,
            `그 집은 훌륭했다. 방마다 그림이 걸려 있고 피아노가 있었다.`,
            `식탁에 앉는 자리가 정해져 있었고, 밥 먹기 전에 기도를 했다. 나는 더글러스 아주머니 댁이 떠올랐다.`,
            `좋은 집은 다 그런 모양이었다.`,
            `그 집에는 벅이라는 아이가 있었다. 나와 나이가 같았다.`,
            `벅은 나에게 사냥하는 법을 가르쳐 주었고, 우리는 곧 친해졌다.`,
            `벅은 숲을 아주 잘 알았다. 나무 하나하나에 이름을 붙여 두고 있었다.`,
            `나는 그 집에서 며칠 동안 아주 잘 지냈다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `뗏목이 텅 비어 있었다. 짐이 앉던 자리가 그대로 있었다.`,
            `담요가 개어져 있었다.`,
            `나는 이렇게 배웠다. 남의 재산을 도망치게 돕는 것은 나쁜 짓이다. 그런 짓을 하면 지옥에 간다.`,
            `나는 그 말을 어릴 때부터 들었다. 한 번도 의심해 본 적이 없었다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `집이 낮고 마당이 넓었다. 뒤쪽에 오두막이 몇 채 있었다.`,
            `나는 그 가운데 하나에 짐이 있다는 것을 알고 있었다.`,
            `문을 두드리기도 전에 아주머니 한 분이 뛰어나와 나를 끌어안았다.`,
            `나는 그 아주머니를 그때 처음 보았다.`,
            `그런데 아주머니는 나를 아는 사람처럼 굴었다.`,
            ...
            `짐이 알아듣고 입을 다물었다. 그리고 아주 오래 나를 보았다.`
        ]
    },
    {
        num: 12,
        ...
        paras: [
            ...
            `톰에게 그것은 놀이였다. 짐에게는 아니었다.`,
            `그때 나는 톰에게 화를 내지 못했다. 지금 생각하면 화를 냈어야 했다.`,
            `그때 나는 톰이 옳은 줄 알았다. 톰은 책을 많이 읽은 아이였기 때문이다.`,
    ...
    },
    {
        ...
        paras: [
            `톰은 사흘 만에 정신을 차렸다.`,
            `그동안 샐리 이모가 그 옆을 떠나지 않았다.`,
            `나도 그 방에서 잤다.`,
            `눈을 뜨자마자 톰이 물었다.<br>"짐은 어떻게 됐어?"<br>"묶여 있어."`,
            `눈을 뜨자마자 그것부터 물은 것은 톰다웠다.`,
            `톰이 침대에서 벌떡 일어나 앉았다.`,
            `다리가 아픈 것도 잊은 모양이었다.`,
            `"당장 풀어 줘! 짐은 나만큼 자유로운 사람이야!"`,
            `방 안이 조용해졌다.`,
            `샐리 이모가 톰의 이마를 짚었다. 열이 나서 헛소리를 하는 줄 안 것이었다.`,
            `방에 있던 사람들이 다 톰을 보았다. 그리고 톰이 말했다.`,
            `왓슨 아주머니는 두 달 전에 세상을 떠났다고 했다. 그리고 돌아가시기 전에 유언장에 짐을 자유롭게 한다고 써 두셨다는 것이었다.`,
            `톰이 그 소식을 마을에서 듣고 왔던 것이다.`,
            `그러니까 짐은 우리가 굴을 파던 그 삼 주 내내 이미 자유인이었다.`,
            `사슬에 묶여서, 쥐를 받고, 벽을 긁으면서 말이다.`,
            `짐을 팔려고 했던 것을 두고 두고두고 마음이 편치 않으셨던 모양이라고 했다. 나는 톰을 쳐다보았다.`,
            `그 아주머니도 나쁜 사람은 아니었다. 다만 그것을 팔 수 있는 일로 알고 살았을 뿐이다.`,
            `톰은 내 눈을 피했다.`,
            `나는 그때 처음으로 톰에게 화가 났다.`,
            `"그럼 너는 그걸 알고 있었어?"<br>"응."<br>"처음부터?"<br>"응."`,
            `"그런데 왜 그 삼 주 동안······."`,
            `톰은 대답하지 못했다.`,
            `나는 그 대답을 기다렸다. 아주 오래 기다렸다.`,
            `톰은 끝내 그것을 잘못이라고 하지 않았다.`,
            ...
            `짐은 톰에게 사람이 아니라 이야기 속의 죄수였던 것이다.`,
            `짐은 아무 말도 하지 않았다.`,
            `화도 내지 않았다. 나는 짐이 화를 냈으면 했다.`,
            `"괜찮습니다, 도련님." 그 말만 했다.`,
            `나중에 내가 미안하다고 하자 짐은 이렇게 말했다.<br>"도련님은 저를 찾으러 오셨잖습니까."`,
            `짐은 그 한 가지만 셈에 넣고 있었다.`,
            `나머지는 다 지워 버린 것이었다.`,
            ...
            `나는 그 일을 그때까지 잊고 있었다.`,
            `그 봄에 짐이 왜 나를 돌려세웠는지도 잊고 있었다.`,
            `"그 사람이 도련님 아버지였습니다."`,
            `나는 아무 말도 하지 못했다.`,
            `봄이 오고 여름이 가는 동안 나는 아버지가 어디선가 나를 찾고 있을 것이라고 여겼다.`,
            `밤에 발소리가 나면 그 생각을 했다.`,
            `"그때 말씀드리면 도련님이 못 견디실 것 같았습니다." 짐이 말했다.<br>"그래서 여태 안 했습니다."`,
            `짐은 그 말을 하면서 나를 보지 않았다.`,
            `강 쪽을 보고 있었다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `그게 톰이었다.`,
            `나는 그 총알을 볼 때마다 짐이 갇혀 있던 삼 주가 떠올랐다.`,
            `짐은 사십 달러를 받았다. 톰이 준 것이었다. 죄수 노릇을 아주 잘해 주었다면서.`,
            `삼 주 동안 쥐와 뱀을 받고 벽을 긁은 값이 사십 달러였다.`,
            ...
            `신발을 신고 자면 발이 아프다. 그런데 아침에 늦지 않으려면 그래야 했다.`,
            `그래서 나는 서쪽으로 가기로 했다. 서쪽에는 아직 아무도 살지 않는 땅이 있다고 한다.`,
            `거기 가면 종을 치는 사람도, 앉음새를 고쳐 주는 사람도 없을 것이다.`,
            `톰도 같이 가겠다고 했다. 그런데 톰은 늘 그렇게 말하고 안 간다. 나는 혼자 갈 작정이다.`,
            `짐이 한 번 더 지나가는 길에 나를 만났으면 좋겠다.`,
            `이 이야기는 여기서 끝이다.`,
