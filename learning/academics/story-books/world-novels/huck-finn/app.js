...
const CHAPTERS = [
    {
        ...
        paras: [
            ...
            `그리고 더글러스 과부 아주머니가 나를 데려다 아들처럼 키우겠다고 하셨다. 그 집에 사는 것은 참 힘들었다.`,
            ...
            `그날 밤 내 방에 촛불을 켜고 들어가 보니, 의자에 사람이 하나 앉아 있었다. 우리 아버지였다.`,
            `한 해가 넘도록 보지 못한 사람이었다. 다들 강에서 죽었다고 했었다.`,
            `아버지는 쉰 살쯤 되어 보였다. 머리가 길고 기름졌고, 얼굴은 살아 있는 사람 것 같지 않게 하얬다. 그 하얀 얼굴을 보고 있으면 등에 소름이 돋았다.`,
            `"제법 차려입었구나." 아버지가 말했다.<br>"학교에도 다닌다며."<br>"네."<br>"글도 읽는다며. 네 아비는 못 읽는데 네가 읽어? 그런 건 그만둬라."`,
    ...
    },
    {
        ...
        paras: [
            ...
            `준비가 끝난 날, 아버지는 마을에 술을 마시러 갔다. 나는 벽의 통나무를 밀어내고 나왔다. 그리고 오두막 안을 아주 자세히 꾸며 놓았다.`,
            `도끼로 문을 부수어 놓고, 마당에서 잡은 멧돼지를 끌어와 바닥에 피를 흘려 놓고, 그 피를 문밖까지 끌리게 했다. 내 머리카락 몇 올을 도끼날에 붙여 두었다.`,
            `돌을 자루에 담아 강 쪽으로 끌고 간 자국을 냈다. 누가 보아도 강도가 들어 나를 죽이고 시신을 강에 버린 것처럼 보이게 했다. 그러고는 카누에 먹을 것과 담요를 싣고 강으로 나갔다.`,
            `달이 뜨자 강이 아주 넓게 보였다. 나는 강 아래쪽의 잭슨 섬으로 갔다.`,
    ...
    },
    {
        ...
        paras: [
            `이튿날 낮에 배 한 척이 섬 둘레를 돌며 대포를 쏘았다. 물에 빠져 죽은 사람을 찾을 때 그렇게 한다고들 했다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `안은 어두웠다. 짐이 먼저 들어갔다.`,
            `방 한구석에 사람이 하나 누워 있었다. 짐이 다가가 살펴보더니, 곧 담요를 덮어 주었다.`,
            `"헉 도련님, 보지 마세요." 짐이 말했다.<br>"죽은 사람입니다. 죽은 지 한참 됐어요."`,
            `"누군데?"<br>"보실 것 없습니다."`,
            ...
            `나는 인사를 하고 나와 카누로 뛰었다. 섬에 닿자마자 소리를 질렀다.`,
            `"짐! 빨리 일어나! 사람들이 온대!"`,
    ...
    },
    {
        ...
        paras: [
            ...
            `내 평생에 그때만큼 편했던 적이 없었다. 우리 계획은 이랬다.`,
            ...
            `"그래서 뭘 하려고?"<br>"제 아내를 사겠습니다." 짐이 말했다.<br>"아내가 있는 그 집 주인한테 돈을 주고요. 그러고 나서 둘이 벌어서 아이들을 데려올 겁니다."`,
            `"안 팔겠다고 하면?"<br>"그러면······ 사람을 사서 훔쳐 오겠습니다."`,
            `그 말을 듣고 나는 등이 오싹했다.`,
            `그때 내가 배운 대로 하자면 그건 남의 재산을 훔치는 것이었다. 그리고 나는 그것을 옆에서 도와주고 있는 것이었다.`,
            `나는 그 밤에 잠이 잘 오지 않았다. 짐은 뗏목 뒤쪽에서 자기 아이들 이야기를 혼자 중얼거리고 있었다. 한번은 짐이 이런 이야기를 했다.`,
            `딸 엘리자베스가 네 살 때 성홍열을 앓았다고 했다. 낫고 나서 어느 날 짐이 문을 닫으라고 했는데 아이가 가만히 서 있더란다.`,
            `짐은 화가 나서 아이를 때렸다. 그런데 잠시 뒤 바람이 불어 문이 쾅 닫혔는데, 아이가 돌아보지도 않았다. 그 병을 앓고 나서 아이는 귀가 들리지 않게 되었던 것이다.`,
    ...
    },
    {
        ...
        paras: [
            `카이로가 가까워질수록 짐은 들떴다.<br>"이제 며칠만 있으면 자유입니다, 헉 도련님." 그런데 나는 그 말을 들을 때마다 마음이 나빠졌다.`,
            ...
            `"천연두구나!" 하나가 소리쳤다.<br>"이 녀석, 왜 진작 말 안 했어!"`,
    ...
    },
    {
        ...
        paras: [
            ...
            `"응. 아버지도 모르시고 할아버지도 모르셨대. 아주 오래전에 뭔가 있었는데 그게 뭔지는 아무도 몰라." 벅이 말했다.<br>"다만 우리 집안에서 셋이 죽었고 저쪽에서 넷이 죽었어."`,
            `"삼십 년쯤 됐대."`,
            `일요일에 두 집안 사람들이 다 같은 교회에 갔다. 총을 무릎 사이에 세워 두고 앉아서, 사람을 사랑하라는 말씀을 들었다.`,
            `그리고 집에 돌아와 다들 그 설교가 참 좋았다고 했다. 며칠 뒤 그 집 딸 소피아가 셰퍼드슨네 젊은이와 달아났다.`,
            `그날 강가에서 싸움이 났다. 나는 나무 위에서 그것을 보았다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `나는 그것을 보면서 사람이라는 게 참 그렇구나 하고 생각했다. 짐은 그 두 사람을 아주 싫어했다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `왕은 그 이야기를 다 듣고 나서 공작을 불렀다. 그날 오후, 두 사람은 그 집에 나타났다.`,
            `"우리가 피터의 동생들입니다."`,
            ...
            `그리고 다음 날, 왕은 집과 땅까지 다 팔아 치우겠다고 했다. 그런데 그 집 살림을 하던 사람들도 함께 팔았다. 어머니 하나와 아들 둘이었는데, 어머니는 저 아래 뉴올리언스로, 아들 둘은 다른 데로 팔렸다.`,
            `세 사람이 서로 붙잡고 우는 것을 나는 그날 마당에서 보았다. 메리 제인이 온종일 방에서 울었다. 나는 그날 밤 결심했다.`,
            ...
            `그날 오후, 진짜 동생 둘이 도착했다. 마을이 뒤집혔고, 사람들이 두 패로 갈렸고, 결국 무덤을 파서 관을 열게 되었다.`,
    ...
    },
    {
        ...
        paras: [
            `그 뒤로 두 사람은 돈이 떨어져 갔다. 밤마다 뗏목 구석에서 무언가를 소곤거렸다.`,
            `어느 날 아침, 나는 뗏목에 짐이 없는 것을 알았다. 한참 찾다가 강가에서 만난 아이에게 물었더니, 저 아래 펠프스 씨네 농장에 도망친 사람이 하나 잡혀 있다고 했다.`,
            ...
            `나는 왓슨 아주머니께 편지를 쓰기로 했다. 종이를 꺼내 이렇게 썼다.`,
            `"왓슨 아주머니께. 아주머니의 짐이 여기 펠프스 씨 농장에 있습니다. 사십 달러를 주면 돌려받으실 수 있습니다. 헉 핀 올림."`,
            `쓰고 나니 마음이 아주 가벼워졌다. 나는 그 종이를 놓고 앉아서, 이제 나는 나쁜 아이가 아니라고 생각했다. 그런데 그러고 있으려니 자꾸 다른 것이 떠올랐다.`,
            ...
            `나는 잠깐 숨을 참았다. 그리고 이렇게 말했다.`,
            `"그럼 좋다. 나는 지옥에 가겠다."`,
            `그러고는 편지를 찢었다. 찢고 나니 이상하게 마음이 편해졌다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `그 집은 톰 소여의 이모 댁이었다. 그리고 그 집에서는 톰이 오기를 기다리고 있었다. 그러니까 나는 그날부터 톰 소여가 되었다.`,
            `그날 오후, 나는 길에서 진짜 톰 소여를 만났다. 톰은 나를 보고 유령을 본 사람처럼 뒷걸음질을 쳤다.`,
            `"헉! 너 죽었잖아!"`,
    ...
    },
    {
        ...
        paras: [
            ...
            `"그건 너무 시시해."<br>"시시하면 어때. 되기만 하면 되지."<br>"안 되지." 톰이 말했다.<br>"책에 나오는 대로 해야 해. 죄수를 빼낼 때는 굴을 파야 하고, 밧줄 사다리를 넣어 줘야 하고, 벽에 글을 새겨야 해."`,
            `그때부터 나는 삼 주 동안 고생을 했다.`,
            `톰은 굴을 파야 한다고 해서 우리는 칼로 흙을 팠다. 사흘을 파고 나서 톰이 삽을 가져왔다.`,
            `밧줄 사다리를 넣어 줘야 한다고 해서 이모의 침대보를 잘라 만들었다. 죄수는 벽에 사연을 새겨야 한다고 해서, 짐이 못으로 벽을 긁게 했다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `"나는 이 사람만큼 훌륭한 사람을 본 적이 없소." 사람들이 조용해졌다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `방에 있던 사람들이 다 톰을 보았다. 그리고 톰이 말했다.`,
            `왓슨 아주머니는 두 달 전에 세상을 떠났다고 했다. 그리고 돌아가시기 전에 유언장에 짐을 자유롭게 한다고 써 두셨다는 것이었다.`,
            `짐을 팔려고 했던 것을 두고 두고두고 마음이 편치 않으셨던 모양이라고 했다. 나는 톰을 쳐다보았다.`,
            `"그럼 너는 그걸 알고 있었어?"<br>"응."<br>"처음부터?"<br>"응."`,
            `"그런데 왜 그 삼 주 동안······." 톰은 대답하지 못했다.`,
            ...
            `"그 사람이 도련님 아버지였습니다." 나는 아무 말도 하지 못했다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `"찾으면 어떻게 할 거야?"<br>"일을 하겠습니다." 짐이 말했다.<br>"이제는 제가 번 것이 제 것이니까요."<br>짐이 그 말을 할 때 목소리가 조금 떨렸다.`,
            ...
            `그리고 샐리 이모가 나를 아들로 삼겠다고 하셨다. 학교에 보내 주고, 옷을 입혀 주고, 예의범절을 가르쳐 주겠다고 하셨다. 나는 그 말을 듣고 등이 서늘해졌다.`,
            `나는 그것을 이미 한 번 해 봤다. 더글러스 과부 아주머니 댁에서였다.`,
            `그 아주머니는 나쁜 분이 아니었다. 다만 나를 좋게 만들려고 하셨고, 나는 그게 견디기 힘들었다.`,
            `그 집에서 나는 밥 먹기 전에 종을 기다리고, 옷깃을 세우고, 신발을 신고 잤다. 그래서 나는 서쪽으로 가기로 했다. 서쪽에는 아직 아무도 살지 않는 땅이 있다고 한다.`,
            `톰도 같이 가겠다고 했다. 그런데 톰은 늘 그렇게 말하고 안 간다. 나는 혼자 갈 작정이다.`,
            `이 이야기는 여기서 끝이다.`,
            `쓰기가 얼마나 힘든지 미리 알았으면 시작도 안 했을 것이다. 그리고 다시는 안 쓸 작정이다.`,
            `그런데 한 가지는 적어 두고 싶다. 나는 그해 강 위에서 배운 것이 학교에서 배운 것보다 많았다. 그리고 그때 내가 옳다고 배운 것과 내가 옳다고 느낀 것이 서로 달랐을 때, 나는 느낀 쪽을 골랐다.`,
