...
const CHAPTERS = [
    {
        ...
        paras: [
            ...
            `칠 년 동안 이어진 전쟁이었습니다.`,
            `유럽에서 시작해 아메리카까지 번진 전쟁이었습니다.`,
            `영국과 프랑스가 그 땅을 놓고 싸운 전쟁이었습니다. 그런데 그 땅은 원래 두 나라 것이 아니었습니다.`,
            `두 나라 다 바다 건너에서 온 나라였습니다.`,
            `배를 타고 몇 달을 건너온 것이었습니다.`,
            `수천 년 전부터 그곳에 살던 사람들이 있었습니다. 모히컨, 델라웨어, 휴런, 이로쿼이, 모호크······ 부족이 아주 많았습니다.`,
            `콜럼버스가 오기 훨씬 전부터요.`,
            `지금 미국 땅에만 오백 갈래가 넘었다고 합니다.`,
            `말도 백 가지가 넘었습니다.`,
            `저마다 말이 달랐고, 살아온 방식이 달랐고, 이웃과 사이가 좋기도 하고 나쁘기도 했습니다.`,
            `유럽에 여러 나라가 있는 것과 마찬가지였습니다.`,
            `그것을 한 덩어리로 묶어 부르는 것부터가 잘못입니다.`,
            `이것부터 짚어 두어야 합니다. '인디언'이라는 말은 그 사람들이 스스로 쓰던 말이 아닙니다.`,
            `남이 붙인 이름이었습니다.`,
            `콜럼버스가 그 땅을 인도인 줄 알고 그렇게 불렀고, 그 말이 그대로 굳었습니다.`,
            `잘못 부른 이름이 오백 년을 간 것입니다.`,
            `지금은 그 말을 쓰지 않으려는 사람이 많습니다.`,
            `그 사람들에게는 저마다 자기 이름이 있었습니다.`,
            `그러니 이 책에서는 될 수 있으면 부족 이름으로 부르겠습니다.`,
            `모히컨, 델라웨어, 휴런이라고요.`,
            `그것이 그 사람들이 자기를 부르던 이름에 더 가깝습니다.`,
            `유럽 사람들이 배를 타고 오면서 그 땅이 뒤집혔습니다. 유럽에서 온 병이 먼저 퍼졌습니다. 천연두 같은 병이었습니다.`,
            `백 년 사이에 다 달라졌습니다.`,
            `사람보다 병이 먼저 퍼져 나갔습니다.`,
            `백인을 한 번도 못 본 마을에도 병이 먼저 닿았습니다.`,
            `그 병에 대한 저항력이 그 땅 사람들에게는 없었습니다. 어떤 지방에서는 열에 아홉이 세상을 떠났습니다.`,
            `유럽에서는 오래 앓아 온 병이라 어느 정도 견뎠는데, 그 땅에는 없던 병이었습니다.`,
            `마을이 통째로 비는 일이 흔했습니다.`,
            `나중에 온 사람들은 그 땅이 원래 비어 있었다고 여겼습니다.`,
            `싸움이 나기도 전에 그렇게 되었습니다.`,
            `그다음에 땅을 빼앗겼습니다.`,
            `조약을 맺고 빼앗기고, 다시 맺고 또 빼앗겼습니다.`,
            `종이에 적은 것이 지켜지지 않았습니다.`,
            `그리고 영국과 프랑스가 싸울 때, 각 부족은 어느 한쪽 편에 서야 했습니다. 어느 쪽에도 안 서는 것이 제일 위험했기 때문입니다. 그래서 그 땅 사람들끼리 서로 싸우게 되었습니다.`,
            `그것이 이 이야기에서 제일 슬픈 대목입니다.`,
            `그리고 이 소설은 그 대목을 제대로 그리지 못했습니다.`,
            `어느 편에도 안 서면 양쪽에서 다 적으로 여겼습니다.`,
            `그러니 고르는 것이 아니라 떠밀린 것이었습니다.`,
            `그것이 이 이야기의 배경입니다.`,
            ...
            `사람을 그렇게 두 가지로 나눌 수는 없습니다.`,
            `어느 무리에나 여러 사람이 있습니다.`,
            `실제로는 그렇지 않았습니다. 양쪽 다 살아남으려고 어느 편엔가 선 것이었습니다.`,
            `그 자리에 있어 보지 않은 사람이 함부로 말할 일이 아닙니다.`,
            `살아남는 일이 걸려 있었기 때문입니다.`,
            `그리고 제목도 사실과 다릅니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `호수와 강이 많은 데였습니다.`,
            `배로 다니는 것이 걸어 다니는 것보다 빨랐습니다.`,
            `전쟁이 시작된 지 세 해째였습니다.`,
            `끝이 보이지 않는 전쟁이었습니다.`,
            `호숫가에 통나무로 지은 요새였습니다.`,
            `병사가 이천 명쯤 있었습니다.`,
            `요새라고 해도 돌로 지은 것이 아니었습니다.`,
            `그 요새의 사령관은 먼로 대령이었습니다. 먼로 대령에게 딸이 둘 있었습니다. 언니 코라와 동생 앨리스였습니다.`,
            `예순이 넘은 스코틀랜드 사람이었습니다.`,
            `아내를 여의고 혼자 키운 딸들이었습니다.`,
            `그래서 더 아꼈습니다.`,
            `코라는 검은 머리에 눈이 깊었고, 앨리스는 금발에 얼굴이 하얬습니다.`,
            `어머니가 서로 달랐습니다.`,
            `코라의 어머니는 서인도 제도 사람이었습니다. 그 시절 그것은 큰 흠으로 여겨졌습니다.`,
            `두 사람은 남쪽 에드워드 요새에 있다가, 아버지가 있는 곳으로 가는 길이었습니다. 일행은 여섯이었습니다.`,
            `아버지가 위험하다는 말을 들었기 때문입니다.`,
            `말을 타고 갔습니다.`,
            `짐은 거의 없었습니다.`,
            `숲길이라 실을 수가 없었습니다.`,
            `코라와 앨리스, 두 사람을 데려다주는 던컨 헤이워드라는 젊은 소령, 노래 선생 데이비드 가무트, 그리고 길잡이였습니다.`,
            `길잡이의 이름은 마과였습니다. 휴런 부족 사람이라고 했는데, 영국군에서 일하고 있었습니다.`,
            `헤이워드는 그 사람을 믿었습니다.`,
            `군에서 오래 일한 사람이었기 때문입니다.`,
            `헤이워드는 그 사람의 지난 일을 몰랐습니다.`,
            `일행은 큰길로 가지 않고 숲길로 갔습니다. 마과가 그쪽이 빠르다고 했기 때문입니다.`,
            `그것이 첫 번째 잘못이었습니다.`,
            `큰길은 프랑스군이 지키고 있다고 했습니다.`,
            `그 말은 맞는 말이기도 했습니다.`,
            `거짓말에는 대개 참말이 섞여 있습니다.`,
            `그 무렵 그 숲은 사람이 다니기 아주 어려운 곳이었습니다. 나무가 빽빽해서 한낮에도 어두웠고, 길이라고 할 만한 것이 거의 없었습니다. 길을 아는 사람 없이 들어가면 나오지 못했습니다. 그래서 길잡이가 반드시 필요했습니다.`,
            `나침반도 소용이 없었습니다.`,
            `나무 때문에 해도 보이지 않았습니다.`,
            `길잡이가 마음을 바꾸면 그것으로 끝이었습니다.`,
            `그리고 그 일이 벌어지고 있었습니다.`,
            `일행은 그것을 반나절이 지나서야 눈치챘습니다.`,
            `그런데 한나절이 지나자 헤이워드는 이상하다고 느꼈습니다. 길이 자꾸 깊어졌기 때문입니다.`,
            `요새 쪽이 아니라 반대쪽으로 가는 것 같았습니다.`,
            `해가 엉뚱한 쪽에 있었습니다.`,
            `헤이워드는 그것을 말하지 못했습니다. 잘못 보았을까 봐서요.`,
            ...
            `글은 못 읽었지만 숲은 다 읽었습니다.`,
            `발자국만 보고 며칠 전 일을 알아냈습니다.`,
            `몇 사람이 지나갔는지도 알았습니다.`,
            `늙은 사람은 칭가치국, 젊은 사람은 그 아들 웅카스였습니다. 두 사람은 모히컨 사람이었습니다.`,
            `부족에서 남은 사람이 그 둘뿐이라고 했습니다.`,
            `아버지와 아들이었습니다.`,
            `웅카스는 스무 살쯤 되어 보였습니다.`,
            `매의 눈은 백인이었지만 백인 마을에서 살지 않았습니다.`,
            `어릴 때부터 숲에서 지냈고, 델라웨어 사람들에게 사냥을 배웠습니다.`,
            `칭가치국과는 이십 년 넘게 함께 다녔습니다.`,
            `말이 없어도 서로 다 알았습니다.`,
            `손짓 하나로 뜻이 통했습니다.`,
            `그래서 두 세계를 다 알았습니다. 그런데 어느 쪽에도 온전히 속하지 못했습니다.`,
            `백인들은 그를 야인이라고 했고, 부족들은 그를 백인이라고 했습니다.`,
            `어디를 가도 그랬습니다.`,
            `그래서 그는 숲에서만 편했습니다.`,
            `이 소설에서 매의 눈이 자기가 '피가 섞이지 않은 백인'이라고 여러 번 말하는 대목이 나오는데, 그것은 그 사람이 늘 자기 자리를 확인해야 했다는 뜻이기도 합니다.`,
            `말하지 않으면 아무도 알아주지 않기 때문입니다.`,
            `그 말이 나올 때마다 칭가치국은 아무 말도 하지 않았습니다.`,
            `헤이워드가 길을 물었습니다. 그리고 마과의 이야기를 했습니다.`,
            `휴런 사람 하나가 길잡이를 하고 있다고요.`,
            `이름이 마과라고 했습니다.`,
            `그 이름이 나오자 셋이 다 움직임을 멈췄습니다.`,
            `매의 눈이 그 말을 듣고 얼굴빛이 달라졌습니다.`,
            `칭가치국과 눈짓을 주고받았습니다.`,
            `두 사람 다 그 이름을 알고 있었습니다.`,
            `"그 사람이 지금 어디 있소?"<br>"저기 나무 아래에 있습니다."<br>매의 눈이 아주 낮은 소리로 말했습니다.<br>"저 사람은 당신들을 엉뚱한 데로 데려가고 있소."`,
            `헤이워드는 그 말을 얼른 믿지 못했습니다.`,
            `처음 만난 사람의 말이었기 때문입니다.`
        ]
    },
    {
        num: 3,
        ...
        paras: [
            ...
            `마과는 그 숲을 아주 잘 알았습니다.`,
            `나고 자란 숲이었습니다.`,
            `총소리가 한 번 났는데 맞지 않았습니다.`,
            `숲이 어두웠기 때문입니다.`,
            `그날 밤 매의 눈이 헤이워드에게 마과 이야기를 했습니다. 마과는 원래 휴런 부족 사람이었습니다. 그런데 몇 해 전에 부족에서 쫓겨났습니다. 그리고 모호크 부족에게 갔다가 다시 영국군에서 일하게 되었습니다.`,
            `젊어서는 이름난 사냥꾼이었다고 합니다.`,
            `부족에서 앞자리에 앉던 사람이었습니다.`,
            `어디에도 자기 자리가 없는 사람이었습니다.`,
            `부족에도, 백인 쪽에도요.`,
            `술 때문이었다고 했습니다.`,
            `그 술도 원래 그 땅에 없던 것이었습니다.`,
            `백인들이 물건을 바꿀 때 술을 얹어 주었습니다.`,
            `그 사이에 이런 일이 있었습니다. 마과가 영국군 진영에서 술에 취해 소란을 피운 적이 있었습니다.`,
            `그 술은 백인들이 가져온 것이었습니다.`,
            `그리고 그것으로 물건을 바꿔 갔습니다.`,
            `가죽과 땅을 그렇게 가져갔습니다.`,
            `그때 사령관이 마과를 병사들 앞에서 채찍으로 때리게 했습니다. 그 사령관이 먼로 대령이었습니다.`,
            `코라와 앨리스의 아버지였습니다.`,
            `그때 먼로 대령은 그 일을 곧 잊었습니다.`,
            `그에게는 흔한 일이었기 때문입니다.`,
            `여기서 짚어 둘 것이 있습니다.`,
            `이 대목이 이 이야기 전체를 움직입니다.`,
            `이것을 모르면 마과가 그냥 미친 사람이 됩니다.`,
            `원작에서 마과는 그저 못된 사람으로 나옵니다. 그런데 그 사람이 왜 그렇게 되었는지를 원작도 이 대목에서 밝혀 놓았습니다.`,
            `웃는 얼굴로 나쁜 짓을 하는 사람으로요.`,
            `그러니 원작이 아주 모르고 쓴 것은 아닙니다.`,
            `다만 그 뒤로는 그것을 잊은 듯이 썼습니다.`,
            `밝혀 놓고 쓰지 않은 것입니다.`,
            ...
            `부족에 따라 다르기는 했지만 대개 그랬습니다.`,
            `그 사람들에게 벌은 부끄러움을 주는 것이 아니었습니다. 잘못을 하면 값을 물게 하거나 무리에서 내보냈습니다.`,
            `때리는 벌은 없었습니다.`,
            `몸을 상하게 하는 것보다 무리에서 내보내는 것이 더 무거운 벌이었습니다.`,
            `혼자서는 살 수 없었기 때문입니다.`,
            `그런데 사람을 묶어 놓고 여럿이 보는 앞에서 때리는 것은 그 사람을 사람으로 안 본다는 뜻이었습니다.`,
            `마과에게는 목숨을 잃는 것보다 무거운 일이었습니다.`,
            `그 자리에 있던 사람이 여럿이었습니다.`,
            `그 사람들이 다 보았습니다.`,
            `먼로 대령은 그것을 몰랐습니다. 그리고 알아보려고 하지도 않았습니다.`,
            `몰라서 한 일이 그렇게 오래갔습니다.`,
            `모르는 것도 잘못이 될 때가 있습니다.`,
            `특히 힘을 가진 쪽이 모를 때 그렇습니다.`,
            `마과는 그것을 잊지 않았습니다.`,
            `몇 해를 벼르고 있었습니다.`,
            `그리고 그 딸들이 그 숲으로 들어온 것이었습니다.`,
            `마과에게는 기다리던 날이었습니다.`,
            `그리고 먼로 대령의 딸들을 노린 것이었습니다.`,
            `이 이야기에서 마과가 하는 일은 잔인합니다.`,
            `사람을 붙잡고 죽이고 겁을 줍니다.`,
            `그것을 좋게 볼 수는 없습니다. 다만 이 이야기를 읽을 때, 그 사람 하나만 나쁜 사람이었던 것으로 읽으면 이 책을 잘못 읽는 것입니다.`,
            `나쁜 일에는 대개 그 앞이 있습니다.`,
            `그 앞을 보지 않으면 같은 일이 또 일어납니다.`,
            `그래서 이 대목을 길게 적었습니다.`,
            `그날 밤 일행은 강 한가운데 바위섬의 동굴에 숨었습니다.`,
            `폭포 뒤쪽의 굴이었습니다.`,
            `물소리가 커서 말소리가 들리지 않았습니다.`,
            `숨기에는 좋은 데였습니다.`,
            `그런데 새벽에 마과가 무리를 데리고 왔습니다. 싸움이 벌어졌습니다.`,
            `좁은 바위 위에서였습니다.`,
            `뒤로 물러설 데가 없었습니다.`,
            `아래는 폭포였습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `숲에서 사람이 뛰어나왔습니다.`,
            `매의 눈이 앞장서고 있었습니다.`,
            `매의 눈과 칭가치국과 웅카스가 돌아온 것이었습니다. 싸움 끝에 사람들이 풀려났습니다.`,
            `매의 눈이 약속을 지킨 것이었습니다.`,
            `동굴에서 한 그 약속이었습니다.`,
            `이틀 만에 지켰습니다.`,
            `마과는 또 달아났습니다. 일행은 다시 요새로 향했습니다.`,
            `이번에는 매의 눈이 길잡이였습니다.`,
            ...
            `웅카스는 그 말을 나무라듯이 한 것이 아니었습니다.`,
            `걱정해서 한 말이었습니다.`,
            `그 말을 아주 담담하게 했습니다.`,
            `코라는 그다음 말을 잇지 못했습니다.`,
            `무슨 말을 해야 할지 몰랐습니다.`,
            `부족이 둘이라는 말을 그때 처음 들었습니다.`,
            `나라 하나가 두 사람인 것이었습니다.`,
            ...
            `매의 눈은 그 말을 아주 짧게 했습니다.`,
            `헤이워드는 그 말을 오래 생각했습니다.`,
            `그때까지 그는 그 두 사람이 자기들을 위해 나선 줄 알았습니다.`,
            `그런데 아니었습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `묻지도 않았는데 시작했습니다.`,
            `그런 이야기를 하는 것은 처음이라고 했습니다.`,
            `여러 해 동안 아무에게도 하지 않았습니다.`,
            `"내 부족은 원래 저 아래 바다 쪽에 살았소."<br>"우리는 그곳을 흐르는 물의 땅이라고 불렀소."<br>"거기서 우리는 오래 살았소. 마을이 여럿이었고, 강마다 우리 사람이 있었소."`,
            `"그러다 큰 배가 왔소."<br>"처음에는 사이가 나쁘지 않았소. 우리가 그 사람들에게 먹을 것을 주었고, 그 사람들이 우리에게 물건을 주었소."`,
            `"그런데 그 사람들이 자꾸 늘었소."<br>"그리고 우리는 자꾸 줄었소."`,
            `"병이 먼저 왔소. 한 마을이 한 달 만에 비었소."<br>"그다음에 땅이 갔소."`,
            `"우리는 서쪽으로 옮겼고, 또 옮겼고, 또 옮겼소."<br>"옮길 때마다 조약을 맺었소."<br>"여기까지가 너희 땅이라고 종이에 적었소."`,
            `"그리고 그 종이가 몇 해를 못 갔소."<br>"나는 그런 종이를 여러 장 보았소."`,
            ...
            `그 말 뒤에 불 타는 소리만 났습니다.`,
            `웅카스는 고개를 숙이고 있었습니다.`,
            `아버지가 그 말을 하는 것을 처음 들었습니다.`,
            `아무도 아무 말도 하지 못했습니다.`,
            `헤이워드도 코라도 그랬습니다.`,
            `할 말이 없었기 때문입니다.`,
            `미안하다는 말도 나오지 않았습니다.`,
            `여기서 이 책이 무엇을 잘못 말했는지를 다시 짚어 두겠습니다. 쿠퍼는 이 대목을 아주 슬프게 썼습니다.`,
            `이야기가 좋을수록 더 조심해서 읽어야 합니다.`,
            `읽는 사람이 울게 써 놓았습니다.`,
            `그리고 정말로 사람들이 울었습니다.`,
            `백구십 년 동안 울었습니다.`,
            `그리고 사람들이 그 슬픔에 감동했습니다.`,
            `그런데 그 슬픔에는 이상한 점이 있습니다. 그것은 '저 사람들은 사라지게 되어 있다'는 생각입니다.`,
            `사라지게 되어 있는 사람은 없습니다.`,
            `누가 그렇게 만들었는지가 빠져 있습니다.`,
            `슬퍼하기만 하면 그것으로 끝납니다.`,
            `그리고 아무것도 달라지지 않습니다.`,
            `그 시절 백인들이 그렇게 여겼습니다.`,
            `해가 지듯이 저 사람들도 지는 것이라고요.`,
            `그렇게 말하면 아무도 잘못한 사람이 없어집니다.`,
            `그것이 그 말의 무서운 데입니다.`,
            `아주 부드럽게 들리는데 아주 셉니다.`,
            `그런데 사라진 것이 아닙니다. 사라지게 만든 것입니다.`,
            `그 둘은 아주 다른 말입니다.`,
            `하나는 아무도 책임이 없고, 하나는 책임이 있습니다.`,
            `말 한 마디 차이입니다.`,
            `병을 옮긴 것도, 땅을 가져간 것도, 조약을 어긴 것도 사람이 한 일이었습니다.`,
            `해가 지는 것과는 다릅니다.`,
            `사람이 한 일은 사람이 되돌릴 수도 있습니다.`,
            `그래서 이 말을 바로잡는 것이 중요합니다.`,
            `그리고 앞에서 말했듯이 모히컨 사람들은 사라지지 않았습니다. 지금도 살고 있습니다.`,
            `그 이야기는 마지막 장에서 하겠습니다.`,
            `끝까지 읽어 주십시오.`
        ]
    },
    {
        ...
        paras: [
            ...
            `여러 날 걸린 길이었습니다.`,
            `처음에 사흘이면 될 길이라고 했습니다.`,
            `그런데 그 요새는 이미 프랑스군에 포위되어 있었습니다.`,
            `둘레에 프랑스군 천막이 가득했습니다.`,
            `대포도 여러 문이었습니다.`,
            `안개 낀 새벽에 일행이 몰래 들어갔습니다.`,
            `매의 눈이 앞장섰습니다.`,
            `안개가 없었으면 못 들어갔을 것입니다.`,
            `먼로 대령이 두 딸을 맞았습니다.`,
            `딸들을 안고 한참 아무 말도 하지 못했습니다.`,
            `여러 달 만에 보는 딸들이었습니다.`,
            `요새 안 사정은 아주 나빴습니다. 프랑스군이 대포를 계속 쏘았고, 성벽이 무너져 가고 있었습니다.`,
            `안에 있는 대포는 몇 문 되지 않았습니다.`,
            `화약도 얼마 남지 않았습니다.`,
            `먼로 대령은 남쪽 에드워드 요새에 여러 번 사람을 보내 도움을 청했습니다. 그런데 답이 오지 않았습니다.`,
            `에드워드 요새는 걸어서 사흘 거리였습니다.`,
            `거기에는 군대가 있었습니다.`,
            `그러던 어느 날, 프랑스군이 편지를 하나 보내왔습니다. 에드워드 요새의 사령관이 쓴 편지였습니다. 프랑스군이 그 편지를 가로챈 것이었습니다.`,
            `그리고 일부러 먼로 대령에게 보낸 것이었습니다.`,
            `항복을 받아 내려던 것이었습니다.`,
            `그 편지에는 이렇게 적혀 있었습니다.`,
            `"보낼 군대가 없다. 알아서 하라."`,
            `그것이 전부였습니다.`,
            ...
            `요새 안에는 이천 명이 있었습니다.`,
            `병사만 있는 것이 아니었습니다.`,
            `프랑스군 사령관 몽칼름 장군이 회담을 청했습니다. 몽칼름은 그 시절 프랑스군에서 가장 이름난 장수였습니다.`,
            `나중에 퀘벡에서 세상을 떠나는 그 사람입니다.`,
            `두 해 뒤의 일입니다.`,
            `그리고 규칙을 지키는 사람으로 알려져 있었습니다.`,
            `그 사람은 요새를 부수고 사람을 다 없애는 방식을 좋아하지 않았습니다. 그래서 이런 조건을 낸 것입니다.`,
            `유럽식 규칙을 지키려고 한 것이었습니다.`,
            `그런데 그 규칙은 유럽에서 만든 규칙이었습니다.`,
            `그리고 이렇게 말했습니다.<br>"요새를 넘기십시오. 그 대신 여러분은 무기를 들고 남쪽으로 걸어 나가도 좋습니다. 아무도 건드리지 않겠습니다."`,
            `먼로 대령은 그 말을 오래 생각했습니다.`,
            `믿어도 되는 말인지 알 수 없었습니다.`,
            `그 시절 전쟁에서는 그런 방식이 있었습니다. 싸움을 끝내는 대신 진 쪽이 안전하게 물러가게 해 주는 것이었습니다.`,
            `명예로운 항복이라고 불렀습니다.`,
            `무기를 들고 나가게 해 주는 것이 그 표시였습니다.`,
            `먼로 대령은 그것을 받아들였습니다.`,
            `다른 수가 없었기 때문입니다.`,
            `더 버티면 다 죽습니다.`,
            `병사와 여자와 아이가 이천 명 가까이 되었습니다.`,
            `이튿날 아침 그 사람들이 요새를 나섰습니다. 그런데 몽칼름이 미처 생각하지 못한 것이 있었습니다.`,
            `안개가 짙은 아침이었습니다.`,
            `줄이 아주 길었습니다.`,
            `프랑스군과 함께 싸운 여러 부족 사람들이 있었습니다. 그 사람들은 그 조건에 동의한 적이 없었습니다.`,
            `회담 자리에 부르지도 않았습니다.`,
            `함께 싸운 사람들이었는데도요.`,
            `그리고 그 사람들에게 프랑스군이 약속한 것을 주지 않았습니다.`,
            `그 사람들은 먼 데서 여러 달을 걸어와 싸웠습니다. 그런데 아무것도 받지 못한 채 돌아가게 되어 있었습니다.`,
            `그 일이 그날 아침의 배경입니다.`,
            `그날 그 길에서 큰일이 났습니다.`,
            `몽칼름은 그 뒤로 오랫동안 그 일로 비난을 받았습니다. 그리고 그 사람 자신도 그 일을 무겁게 여겼다는 기록이 있습니다.`,
            `막지 못한 것도 잘못이라고 했습니다.`
        ]
    },
    {
        ...
        paras: [
            ...
            `아이들이 읽는 책이기 때문입니다.`,
            `그리고 그날 그 자리에 있던 사람들 때문이기도 합니다.`,
            `다만 이것은 적어 두겠습니다. 실제로 있었던 일입니다.`,
            `소설이 지어낸 일이 아닙니다.`,
            `날짜와 자리가 다 남아 있습니다.`,
            `지금도 그 자리에 표지가 서 있습니다.`,
            `천칠백오십칠 년 팔월, 윌리엄 헨리 요새에서 물러나던 사람들이 길에서 습격을 받았습니다. 몇 사람이 목숨을 잃었는지는 지금도 정확히 모릅니다. 백 명이 안 된다는 기록도 있고, 훨씬 많다는 기록도 있습니다.`,
            `요새를 나선 지 얼마 되지 않아서였습니다.`,
            `기록마다 아주 다릅니다.`,
            `그 자리에 있던 사람들도 다 다르게 말했습니다.`,
            `혼란 속에서는 다들 자기가 본 것만 봅니다.`,
            `이 소설이 나온 뒤 오랫동안 사람들은 그 수를 아주 크게 알고 있었습니다. 이 소설이 그렇게 썼기 때문입니다.`,
            `소설이 사실보다 먼저 퍼졌기 때문입니다.`,
            `소설에는 수천 명이 죽은 것처럼 적혀 있습니다.`,
            `실제보다 훨씬 크게 적은 것이었습니다.`,
            `소설이니 그럴 수 있다고 할 수도 있습니다.`,
            `나중에 학자들이 실제 기록을 조사해서 수를 다시 셈했습니다.`,
            `백 년도 더 지나서였습니다.`,
            `그때는 이미 늦었습니다.`,
            `사람들 머릿속에 이미 그림이 박혀 있었습니다.`,
            `그런데 사람들 머릿속에 남은 것은 소설이었습니다.`,
            `이야기가 사실보다 오래 남는 일이 있습니다.`,
            `대개 이야기가 더 셉니다.`,
            `이야기는 사람 마음에 들어가 앉기 때문입니다.`,
            `숫자는 그렇게 앉지 못합니다.`,
            `그리고 이런 일은 지금도 일어납니다. 어떤 사건이 있으면, 그 사건 자체보다 그 사건을 다룬 이야기가 사람들 머릿속에 남습니다.`,
            `영화 한 편이 사실 한 권을 이깁니다.`,
            `지금도 그렇습니다.`,
            `여러분이 아는 옛일도 대개 이야기로 아는 것입니다.`,
            `그러니 이야기를 만드는 사람은 그것을 알고 만들어야 합니다.`,
            `그것이 이 장에서 하고 싶은 말입니다.`,
            `그리고 읽는 사람도 그것을 알고 읽어야 합니다.`,
            `누가 쓴 이야기인지를 보아야 합니다.`,
            `그리고 그 이야기가 어느 한쪽만 잔인하게 그려 놓으면, 그 그림이 백 년을 갑니다.`,
            `그 그림을 지우는 데는 그보다 더 걸립니다.`,
            `아직도 다 지워지지 않았습니다.`,
            `그래서 이 장을 넣었습니다.`,
            `그날 그 혼란 속에서 마과가 코라와 앨리스를 데려갔습니다.`,
            `아무도 그것을 보지 못했습니다.`,
            `다들 제 목숨을 챙기고 있었기 때문입니다.`,
            `헤이워드도 그 자리에 없었습니다.`,
            `그리고 북쪽으로 갔습니다.`,
            `며칠 뒤 매의 눈과 칭가치국과 웅카스와 헤이워드가 그 자리에 도착했습니다. 아무도 없었습니다.`,
            `요새는 이미 불타 있었습니다.`,
            `프랑스군이 태우고 물러간 것이었습니다.`,
            `잿더미만 남아 있었습니다.`,
            `웅카스가 땅을 살폈습니다. 그리고 발자국을 찾아냈습니다.`,
            `무릎을 꿇고 풀을 헤쳤습니다.`,
            `한참을 그러고 있었습니다.`,
            `아무도 말을 걸지 않았습니다.`,
            `"이쪽입니다."`,
            `다른 사람들 눈에는 아무것도 보이지 않았습니다.`,
            `그냥 풀밭이었습니다.`,
            `웅카스에게만 보였습니다.`,
            ...
            `웅카스에게는 읽히는 글자였습니다.`,
            `웅카스는 그것을 다 읽었습니다.`,
            `헤이워드는 그것을 옆에서 보면서 아무것도 알아보지 못했습니다. 그리고 이런 생각을 했습니다.`,
            `소령이었고 배운 사람이었는데도 그랬습니다.`,
            `여기서는 그것이 아무 소용이 없었습니다.`,
            `숲에서는 다른 것을 알아야 했습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `일부러 그렇게 한 것이었습니다.`,
            `둘을 함께 두면 쫓기 쉽기 때문입니다.`,
            `마과는 그런 것을 잘 알았습니다.`,
            `마과가 두 사람을 따로 떼어 놓은 것이었습니다. 앨리스는 휴런 마을에, 코라는 그 근처 델라웨어 마을에 맡겨져 있었습니다.`,
            `두 마을은 골짜기 하나를 사이에 두고 있었습니다.`,
            `사이가 좋지 않았습니다.`,
            `한쪽은 프랑스 편이고 한쪽은 아니었습니다.`,
            `네 사람은 나뉘어 두 마을에 들어갔습니다.`,
            `들키면 그것으로 끝이었습니다.`,
            `그리고 여러 가지 방법을 썼습니다. 헤이워드는 의원 행세를 하고 휴런 마을에 들어갔습니다.`,
            `힘으로는 될 일이 아니었기 때문입니다.`,
            `넷이서 마을 둘을 상대할 수는 없었습니다.`,
            `마을마다 사람이 백 명이 넘었습니다.`,
            `그 마을에 앓는 사람이 있었기 때문입니다.`,
            `헤이워드는 의술을 몰랐습니다.`,
            `아는 척을 한 것이었습니다.`,
            `얼굴에 색을 칠하고 들어갔습니다.`,
            `그 마을 사람들은 앓는 사람이 있으면 낯선 이라도 들여보내 주었습니다. 고칠 수 있는 사람이면 부족이 달라도 상관하지 않았습니다.`,
            `그것이 그 사람들의 규칙이었습니다.`,
            `사람을 살리는 일에는 편을 가르지 않았습니다.`,
            `아픈 사람 앞에서는 다 같다고 여겼습니다.`,
            `헤이워드는 그것을 이용한 것입니다. 나중에 헤이워드는 그 일을 오래 마음에 두었습니다.`,
            `남의 규칙을 이용한 것이었기 때문입니다.`,
            `좋은 규칙일수록 이용하기 쉽습니다.`,
            `믿는 사람이 손해를 봅니다.`,
            `매의 눈은 곰 가죽을 뒤집어쓰고 들어갔습니다. 그리고 웅카스는 붙잡혔습니다.`,
            `일부러 붙잡힌 것인지도 모릅니다.`,
            `원작에는 그 까닭이 적혀 있지 않습니다.`,
            `다만 그 덕에 마을 한가운데로 들어가게 됩니다.`,
            `곰 흉내를 아주 잘 냈습니다.`,
            `숲에서 오래 산 사람이었기 때문입니다.`,
            `곰이 걷는 모양을 그대로 냈습니다.`,
            `여기서 이 이야기에서 가장 중요한 장면이 나옵니다. 델라웨어 마을에는 타메눈드라는 아주 늙은 사람이 있었습니다. 백 살이 넘었다고 했습니다.`,
            `마을 한가운데의 재판 자리입니다.`,
            `앞을 잘 보지 못했습니다.`,
            `그래도 그 마을에서 제일 무거운 말을 하는 사람이었습니다.`,
            `그 말 한마디로 사람의 목숨이 오갔습니다.`,
            `그 마을의 일을 정하는 사람이었습니다. 마과가 그 앞에 나와 코라를 자기에게 달라고 했습니다.`,
            `손님으로 온 것이니 법을 지키라고 했습니다.`,
            `마과는 그 법을 알고 온 것이었습니다.`,
            `그래서 마을 한가운데로 걸어 들어왔습니다.`,
            `붙잡힌 웅카스도 그 앞에 끌려 나왔습니다.`,
            `타메눈드가 웅카스를 보았습니다.`,
            `가까이 오라고 했습니다.`,
            `눈이 어두워 잘 보이지 않았기 때문입니다.`,
            `손으로 얼굴을 더듬었습니다.`,
    ...
    },
    {
        ...
        paras: [
            `타메눈드는 웅카스를 풀어 주었습니다.`,
            `밧줄을 손수 끊게 했습니다.`,
            `마을 사람들이 그것을 보고 있었습니다.`,
            `웅카스는 그 자리에 그대로 서 있었습니다.`,
            ...
            `대꾸할 말이 없었습니다.`,
            `그 말이 맞았기 때문입니다.`,
            `헤이워드는 그 말에 아무 대답도 하지 못했습니다. 그 시절 유럽 사람들이 그 땅에서 사람을 잡아다 팔고 있었기 때문입니다.`,
            `사람을 물건으로 셈한 것은 그쪽이 먼저였습니다.`,
            `배에 실어 바다를 건네기까지 했습니다.`,
            `아프리카에서 아메리카로요.`,
            `그리고 부족들 사이의 오래된 규칙도 그것 때문에 뒤틀려 있었습니다.`,
            `그 전에는 사로잡은 사람을 식구로 들이는 일이 흔했습니다.`,
            `싸움에서 잃은 사람 자리를 그렇게 채웠습니다.`,
            `그러니 사로잡힌 사람이 그 집안 사람이 되었습니다.`,
            ...
            `웅카스도 그 자리에 서 있었습니다.`,
            `주먹을 쥐고 있었습니다.`,
            `해가 지자 웅카스가 일어섰습니다. 델라웨어 사람들이 함께 일어섰습니다.`,
            `해가 지기를 기다린 것이었습니다.`,
            `법은 법이고 그다음은 그다음이었습니다.`,
            `해가 지자마자 움직였습니다.`,
            `그날 저녁 그 골짜기에서 싸움이 벌어졌습니다. 그것이 이 이야기의 마지막 싸움입니다.`,
            `휴런 쪽 사람이 더 많았습니다.`,
            `그리고 아주 짧게 끝납니다.`,
            `한나절도 걸리지 않았습니다.`,
            `그리고 여러 사람이 그 자리에서 목숨을 잃었습니다.`
        ]
    },
    {
        num: 10,
        ...
        paras: [
            ...
            `무리 둘이 함께 갔습니다.`,
            `코라는 걸어서 갔습니다.`,
            `웅카스가 그 뒤를 쫓았습니다. 벼랑 위 좁은 바위 길에서 마과가 걸음을 멈췄습니다.`,
            `더 갈 데가 없었습니다.`,
            `아래는 낭떠러지였습니다.`,
            `아주 빨랐습니다.`,
            `델라웨어 사람들이 그 뒤를 따랐습니다.`,
            ...
            `칼을 든 손이 내려오지 않았습니다.`,
            `그 몇 초가 아주 길었습니다.`,
            `원작에는 이 대목이 이렇게 적혀 있습니다. 마과의 손이 떨렸다고요.`,
            `그 한 줄이 이 소설에서 제일 중요한 줄인지도 모릅니다.`,
            `그 줄 하나로 마과가 사람이 됩니다.`,
            `이 대목은 이 소설에서 아주 중요한 자리입니다.`,
            `쿠퍼는 마과를 처음부터 끝까지 무서운 사람으로 그려 왔습니다. 그런데 마지막 순간에 그 손이 떨렸다고 적었습니다.`,
            `한 번도 좋게 그리지 않았습니다.`,
            `그런데 마지막에 손이 떨렸다고 적었습니다.`,
            `그러니까 이 소설을 쓴 사람도, 자기가 만든 인물이 괴물이 아니라는 것을 알고 있었던 것입니다.`,
            `알면서도 그렇게 그린 것입니다.`,
            `그것이 이 소설의 제일 아쉬운 데입니다.`,
            `그때 마과의 무리 가운데 하나가 뒤에서 나섰습니다. 그리고 그 일을 했습니다.`,
            `마과가 못 한 일이었습니다.`,
            `코라가 그 자리에서 세상을 떠났습니다.`,
            `마과는 그것을 보고 그 사람에게 달려들었습니다.`,
            `자기가 하지 못한 일을 남이 했다고 화를 낸 것입니다.`,
            `그 화가 무엇이었는지는 아무도 모릅니다.`,
            `마과 자신도 몰랐을 것입니다.`,
            `그 순간 웅카스가 벼랑 위에서 뛰어내렸습니다. 그리고 마과와 부딪쳤습니다.`,
            `둘이 바위 위에서 엉켰습니다.`,
            `좁은 자리였습니다.`,
            `그 자리에서 웅카스가 마과의 손에 쓰러졌습니다.`,
            `아주 빠르게 벌어진 일이었습니다.`,
            `아래에서는 손을 쓸 수 없었습니다.`,
            `매의 눈이 바위 아래에서 그것을 보았습니다. 그리고 마과가 벼랑을 건너뛰려는 순간에 총을 쏘았습니다.`,
            `아주 먼 거리였습니다.`,
            `매의 눈은 그런 거리에서도 맞혔습니다.`,
            `마과는 그 자리에서 떨어졌습니다.`,
            `그날 그 벼랑에서 코라와 웅카스가 세상을 떠났습니다. 그리고 마과도요.`,
            `세 사람이 다 같은 자리에서 끝났습니다.`,
            `그 벼랑은 지금도 그 자리에 있습니다.`,
            `뉴욕주 북쪽입니다.`
        ]
    },
    {
    ...
    },
    {
        ...
        paras: [
            ...
            `그 그림이 아주 오래갔습니다. 그리고 그 그림에는 한 가지 편한 점이 있었습니다.`,
            `지금도 남아 있습니다.`,
            `영화에도, 만화에도 남아 있습니다.`,
            ...
            `빼앗는 데에도 이유가 필요합니다.`,
            `사람은 이유 없이 나쁜 일을 하기 어려워합니다.`,
            `'저 사람들은 어차피 사라지는 중이다'라는 말이 그 설명이 되어 주었습니다.`,
            `그러면 빼앗는 것이 아니라 물려받는 것이 됩니다.`,
            `말 하나로 그렇게 됩니다.`,
            `그런데 사실은 이랬습니다.`,
            `이 소설이 나온 바로 그 무렵, 미국에서는 법이 하나 만들어졌습니다.`,
            `소설이 나온 지 네 해 뒤였습니다.`,
            `소설을 읽은 사람들이 그 법에 찬성했습니다.`,
            `천팔백삼십 년에 만들어진 법인데, 동쪽에 살던 부족들을 미시시피강 서쪽으로 옮기게 하는 법이었습니다.`,
            `살던 데를 떠나라는 법이었습니다.`,
            `조상의 무덤도 두고 가야 했습니다.`,
            `그 법에 따라 여러 부족이 걸어서 서쪽으로 갔습니다.`,
            `체로키 부족의 경우, 그 길에서 사람이 아주 많이 세상을 떠났습니다. 그 길을 지금 '눈물의 길'이라고 부릅니다.`,
            `넷 가운데 하나가 그 길에서 죽었다고 합니다.`,
            `겨울에 걸었기 때문입니다.`,
            `그러니까 그 사람들은 사라진 것이 아닙니다.`,
            `옮겨진 것입니다.`,
            `스스로 간 것이 아닙니다.`,
            `군인들이 뒤에서 몰았습니다.`,
            `그리고 옮긴 사람들이 있었습니다. 모히컨 사람들도 마찬가지였습니다.`,
            `법을 만든 사람도 있고, 그 법을 집행한 사람도 있습니다.`,
            `다 이름이 남아 있습니다.`,
            ...
            `네 번을 옮긴 것입니다.`,
            `옮길 때마다 사람이 줄었습니다.`,
            `학교가 있고, 도서관이 있고, 자기들 말을 다시 가르치는 수업이 있습니다. 그 사람들은 이 소설의 제목을 잘 알고 있습니다.`,
            `말을 잃었다가 다시 배우는 것입니다.`,
            `할머니들이 기억하는 말을 적어 두었습니다.`,
            `그리고 그 제목에 대해 이렇게 말합니다.`,
            `"우리는 아직 여기 있습니다."`,
            `그 사람들이 자기 누리집에 그렇게 적어 두었습니다.`,
            `소설 제목에 대한 대답이었습니다.`,
