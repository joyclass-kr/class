...
const CHAPTERS = [
    {
        ...
        paras: [
            ...
            `사냥을 하고, 밥을 먹고, 낮잠을 자고, 다시 사냥을 했습니다. 그 시절 시골 양반의 하루가 대개 그랬습니다.`,
            `그 사람에게는 한 가지 취미가 있었습니다. 기사 이야기 책을 읽는 것이었습니다.`,
            `취미라고 하기에는 좀 지나쳤습니다.`,
            `기사 이야기라는 것은 이런 것입니다.`,
            `갑옷을 입은 기사가 말을 타고 세상을 돌아다니면서, 거인을 무찌르고 마법사를 물리치고 어려움에 빠진 사람을 구해 줍니다. 그리고 그 모든 일을 자기가 사랑하는 여인에게 바칩니다.`,
            `읽고 나면 마음이 뜨거워지는 이야기였습니다.`,
            ...
            `조카딸은 그 말에 대꾸하지 못했습니다.`,
            `그렇게 몇 해가 지나자, 그 사람의 머릿속에서 책과 세상이 뒤섞였습니다. 책에 나오는 일이 다 진짜로 있었던 일이라고 믿게 된 것입니다.`,
            `그리고 어느 날, 그 사람은 이런 생각을 했습니다.`,
            `'요즘 세상에는 왜 기사가 없을까.'`,
            `'그럼 내가 하면 되지 않나.'`,
            `그때부터 그 사람은 준비를 시작했습니다. 먼저 다락에서 조상의 갑옷을 꺼냈습니다.`,
            `준비하는 데 여러 주가 걸렸습니다. 그 여러 주 동안 그 사람은 아주 행복했습니다.`,
            `백 년쯤 된 것이라 녹이 슬어 있었습니다. 그것을 사흘 동안 닦았습니다.`,
            `손이 다 헤졌습니다.`,
            `투구는 얼굴 가리개가 없었습니다. 그래서 두꺼운 종이로 만들어 붙였습니다. 잘 붙었는지 보려고 칼로 쳐 보았더니 한 번에 부서졌습니다.`,
            `기사에게 투구는 제일 중요한 것이었습니다.`,
            `다시 만들었습니다. 이번에는 쇠막대를 안에 대고 만들었습니다.`,
            `그리고 그것을 아주 좋은 투구라고 여겼습니다.`,
            `그리고 이번에는 쳐 보지 않았습니다.`,
            `그다음은 말이었습니다. 그 집에는 늙고 마른 말이 한 마리 있었습니다.`,
            `갈비뼈가 다 드러나 보였고, 걸음이 느렸습니다. 그 말에게 이름을 지어 주는 데 나흘이 걸렸습니다.`,
            `그런 말을 타고 세상을 돌겠다고 한 것입니다.`,
            ...
            `돈키호테 데 라만차. 라만차의 돈키호테라는 뜻이었습니다.`,
            `그 이름을 정하고 나서 그는 거울 앞에 섰습니다.`,
            `거울 속에 마르고 나이 든 사람이 갑옷을 입고 서 있었습니다. 그런데 그 사람 눈에는 그렇게 보이지 않았습니다. 그 눈에는 젊은 기사가 서 있었습니다.`,
            `사람은 자기가 보고 싶은 것을 봅니다. 이 이야기는 그것에 대한 이야기이기도 합니다.`,
            `그것이 이 이야기의 시작입니다.`,
            `사백 년 전에 나온 책인데, 지금까지 온 세상에서 읽히고 있습니다.`
        ]
    },
    {
        num: 2,
        ...
        paras: [
            ...
            `기사가 하는 모든 일은 그 여인에게 바치는 것이었습니다.`,
            `돈키호테는 한참 생각했습니다. 그러다 이웃 마을의 어느 농사꾼 딸을 떠올렸습니다. 그 여자의 이름은 알돈사 로렌소였습니다.`,
            `알돈사라는 이름은 그 고장에서 아주 흔한 이름이었습니다.`,
            `젊었을 때 몇 번 본 적이 있었습니다. 그런데 말을 걸어 본 적은 없었습니다.`,
            `길에서 마주쳐도 그 여자는 인사도 하지 않았습니다.`,
            `그 여자는 돈키호테가 자기를 좋아하는 줄도 몰랐습니다. 평생 몰랐습니다.`,
            `그러니까 이 이야기에서 가장 아름다운 여인은, 자기가 그렇게 불리는 줄도 모르고 밀을 까부르고 있었습니다.`,
            `그 여자는 밭일을 하는 사람이었습니다. 팔이 굵고 목소리가 크고, 밀을 까부르는 솜씨가 마을에서 제일이었습니다. 그런 사람이었습니다.`,
            `이름을 붙이는 데 또 여러 날이 걸렸습니다.`,
            `돈키호테는 그 사람에게 새 이름을 붙였습니다. 둘시네아 델 토보소. 토보소의 둘시네아라는 뜻이었습니다.`,
            `달콤한 사람이라는 뜻이 들어 있는 이름이었습니다.`,
            `그렇게 준비가 끝났습니다.`,
            `칠월 어느 몹시 더운 날 새벽, 돈키호테는 아무에게도 말하지 않고 집을 나섰습니다.`,
            `갑옷을 입고, 창을 들고, 로시난테를 탔습니다. 들판으로 나섰을 때 그는 몹시 기뻤습니다. 그러다 갑자기 멈춰 섰습니다.`,
            `쉰 해 가까이 살면서 그날 처음으로 마을 밖으로 나간 것이었습니다.`,
            `아주 큰일이 생각났기 때문입니다. 자기는 아직 정식 기사가 아니었습니다. 기사가 되려면 누가 정식으로 기사로 만들어 주는 의식을 치러야 했습니다.`,
            `기사가 아닌 사람이 기사 노릇을 하는 것은 규칙에 어긋났습니다.`,
            `'제일 먼저 만나는 성에서 부탁해야겠다.'`,
            `그날 그는 해가 질 때까지 걸었습니다. 몹시 더운 날이었습니다.`,
            `해가 질 무렵, 저 앞에 건물이 하나 보였습니다. 길가의 허름한 여관이었습니다.`,
            `그런데 돈키호테의 눈에는 그것이 성으로 보였습니다.`,
            `탑이 있고, 도개교가 있고, 해자가 있는 성이었습니다.`,
            `사실은 벽이 갈라지고 지붕이 내려앉은 낡은 여관이었습니다.`,
            `문 앞에 여자 둘이 서 있었습니다. 돈키호테는 그 앞에 말을 세우고 정중하게 인사했습니다.`,
            `여자들은 갑옷을 입은 깡마른 노인이 시를 읊는 것을 보고 웃음을 터뜨렸습니다. 돈키호테는 그것을 나쁘게 여기지 않았습니다.`,
            `기사는 사람들이 자기를 알아보지 못하는 법이라고 책에 적혀 있었기 때문입니다.`,
            `돈키호테는 그 여자들에게 아주 정중한 말투를 썼습니다. 귀부인에게 하는 말투였습니다.`,
            ...
            `그날 밤 돈키호테는 마당의 물통 옆에서 갑옷을 지키며 밤을 새웠습니다. 기사가 되기 전날 밤에 무기를 지키는 것이 규칙이었기 때문입니다.`,
            `밤새 한 번도 앉지 않았습니다.`,
            `새벽에 노새몰이꾼이 물을 먹이러 왔다가 그 갑옷을 치우려고 했습니다. 돈키호테는 창으로 그를 때려눕혔습니다.`,
            `노새몰이꾼은 영문도 모르고 맞았습니다.`,
            ...
            `그런데 그날 밤 여관 주인은 잠자리에 들면서 문득 이런 생각을 했습니다.`,
            `저 노인은 자기가 무엇을 하려는지 알고 있었습니다. 여관 주인은 자기가 무엇을 하려는지 오래전에 잊어버렸습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `자기가 이제 진짜 기사라고 믿고 있었습니다.`,
            `열대여섯 살쯤 된 양치기 소년이었습니다.`,
            `웃통이 벗겨져 있었고, 등에 붉은 자국이 여러 줄 나 있었습니다. 농부는 손에 가죽끈을 들고 있었습니다.`,
            `등에 매 자국이 나 있었습니다.`,
            ...
            `소년이 말했습니다.<br>"기사님, 저 사람 말을 믿지 마세요."`,
            `"약속을 했으니 지킬 것이다."<br>돈키호테는 그렇게 말하고 말 머리를 돌렸습니다.`,
            `돈키호테는 아주 흐뭇해하며 떠났습니다. 자기가 세상의 잘못을 하나 바로잡았다고 생각했습니다.`,
            `돌아보지 않은 것이 잘못이었습니다.`,
            ...
            `그래도 돈키호테는 그것을 끝내 알지 못했습니다. 자기가 도운 사람이 그 뒤에 어떻게 되었는지 한 번도 돌아가 보지 않았기 때문입니다.`,
            `좋은 뜻만으로는 일이 되지 않습니다. 이 책은 그것을 자꾸 보여 줍니다.`,
            `그날 오후, 돈키호테는 상인 여섯 명을 만났습니다.`,
            `비단을 사러 가는 사람들이었습니다.`,
            `그는 길을 막고 이렇게 외쳤습니다.<br>"세상에서 둘시네아 델 토보소보다 아름다운 여인은 없다! 그렇다고 말하라!"`,
            `상인들은 어리둥절했습니다.`,
            `길 한가운데를 막고 서 있는 사람이 무슨 말을 하는지 알 수 없었습니다.`,
            ...
            `여섯 명을 혼자 상대하려던 것입니다.`,
            `상인들의 하인 하나가 달려와 창을 빼앗아 부러뜨리고, 그 토막으로 돈키호테를 실컷 때렸습니다. 사람들은 그를 길에 두고 가 버렸습니다.`,
            `저녁에 같은 마을 사람이 그 길을 지나다가 돈키호테를 발견했습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `그 시골에서 글을 아는 사람은 몇 되지 않았고, 그래서 셋은 자주 이야기를 나누던 사이였습니다.`,
            `"저 책들 때문입니다." 아주머니가 말했습니다.<br>"저것들을 다 태워야 합니다."`,
            `이튿날 아침, 네 사람이 서재에 들어갔습니다. 책이 백 권이 넘었습니다.`,
            `그 방에는 창이 하나 있었고 벽이 온통 책이었습니다.`,
            `신부는 그것을 하나씩 넘겨 보았습니다. 그런데 이상한 일이 일어났습니다.`,
            `신부가 책을 넘기다가 자꾸 멈췄습니다.`,
            `제목을 읽다가 자기도 모르게 첫 장을 넘겼습니다.`,
            `"이건 잘 쓴 책인데. 이건 남깁시다."`,
            `"이것도 재미있게 읽었지. 이것도 남기고."`,
            `이발사도 마찬가지였습니다. 아주머니가 답답해했습니다.`,
            `두 사람은 그 책들을 다 읽은 사람들이었습니다.`,
            `"신부님, 태우러 오신 거 아닙니까."`,
            `결국 대부분은 마당에서 태웠습니다. 그리고 서재 문을 벽으로 막아 버렸습니다.`,
            `백 권 가운데 스무 권쯤이 살아남았습니다.`,
            ...
            `기사에게는 시종이 하나 있어야 한다는 것을 알아낸 것입니다.`,
            `기사 이야기에는 시종이 반드시 나왔습니다.`,
            `그래서 이웃에 사는 농부를 찾아갔습니다. 이름은 산초 판사였습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `라만차 벌판에는 바람이 늘 불어서 그런 풍차가 많았습니다.`,
            ...
            `그 뒤로 산초는 이 말을 아주 여러 번 듣게 됩니다.`,
            `산초는 부러진 창 토막을 주워 들었습니다. 그리고 그것을 한참 들여다보았습니다.`,
            `풍차 날개는 아무 일도 없었다는 듯이 계속 돌고 있었습니다.`,
            `사람들은 이 대목을 두고 여러 가지 이야기를 합니다. 어리석은 사람의 이야기라고 하는 사람도 있고, 세상이 알아주지 않아도 자기가 옳다고 믿는 것을 하는 사람의 이야기라고 하는 사람도 있습니다.`,
            `이 책은 그 두 가지를 다 담고 있습니다.`,
            `읽는 사람에 따라 다르게 읽히는 것이 이 책의 힘입니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `그해 여름은 몹시 말라서 흙먼지가 잘 일었습니다.`,
            `"산초야, 오늘이 내 인생에서 가장 큰 날이다."<br>"왜요?"<br>"저기 군대가 둘 온다. 곧 큰 싸움이 벌어질 것이다."`,
            `산초가 보니 양 떼였습니다. 양치기들이 양을 몰고 가는 것이었습니다.`,
            `먼지가 크게 일어난 것은 양이 많아서였습니다. 오백 마리는 되어 보였습니다.`,
            `방울 소리가 딸랑딸랑 났습니다. 그리고 매애 하는 소리가 끊이지 않았습니다.`,
            `양이 이천 마리쯤 되어 보였습니다.`,
            `"나리, 저건 양인데요."<br>"잘 보아라. 저기 오른쪽에 오는 것이 알리판파론 황제의 군대다. 그 옆에 노란 갑옷을 입은 자는······."`,
            `돈키호테는 사람마다 이름을 붙여 가며 설명했습니다. 이름이 삼십 개도 넘었습니다.`,
            `듣고 있으면 정말로 군대가 오는 것 같았습니다.`,
            `그런데 그것을 다 어디서 알았을까요. 다 책에서 읽은 것이었습니다.`,
            `그 사람 머릿속에는 세상에 없는 나라와 세상에 없는 왕들이 가득 들어 있었습니다.`,
            ...
            `그날 밤 산초는 나리의 부러진 이를 헝겊에 싸서 자루에 넣어 두었습니다. 왜 그랬는지는 산초도 몰랐습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `비가 그 위에 떨어져 튀었습니다. 멀리서 보면 정말로 금빛이 도는 것 같기도 했습니다.`,
            `길이 질척해서 로시난테가 자꾸 미끄러졌습니다.`,
            `두 사람 다 흠뻑 젖어 있었습니다.`,
            `"산초야! 저기 황금 투구가 온다!"`,
            `산초가 손차양을 하고 그쪽을 보았습니다.`,
            `"저건 이발사인데요. 놋대야를 머리에 얹었네요. 비 맞기 싫어서요."`,
            `그 시절 이발사는 면도도 하고 피도 뽑았습니다. 그래서 놋대야를 들고 다녔습니다.`,
            `산초는 그것을 마을에서 여러 번 보았습니다.`,
            `그 시절 이발사는 머리를 깎고 피도 뽑았습니다. 그 놋대야가 그 일에 쓰는 것이었습니다.`,
            `"저것은 맘브리노의 투구다. 책에서 읽었다."`,
            `맘브리노는 기사 이야기에 나오는 임금이었습니다. 그 사람의 투구를 쓰면 아무 무기에도 다치지 않는다고 했습니다.`,
            `그 투구를 얻으려고 기사들이 여러 나라를 돌아다녔다는 이야기였습니다.`,
            `돈키호테는 그 대목을 여러 번 읽었습니다. 그리고 언젠가 그것을 얻겠다고 마음먹고 있었습니다.`,
            `돈키호테는 창을 겨누고 달려갔습니다. 이발사는 그것을 보고 나귀에서 뛰어내려 들판으로 달아났습니다. 놋대야가 땅에 떨어졌습니다.`,
            `이발사는 뒤도 돌아보지 않고 달렸습니다. 나귀만 길에 남아 풀을 뜯었습니다.`,
            `이발사는 그날 나귀와 대야를 다 두고 갔습니다.`,
            `돈키호테는 그것을 주워 머리에 썼습니다. 가운데가 움푹하고 가장자리가 넓은 놋대야였습니다. 쓰고 보니 얼굴이 반쯤 가려졌습니다.`,
            `턱 밑에 걸리는 데가 없어서 자꾸 앞으로 미끄러졌습니다. 돈키호테는 그것을 손으로 밀어 올리며 다녔습니다.`,
            `가장자리가 목까지 내려왔습니다.`,
            `"이건 아주 좋은 투구다. 다만 어느 거인이 자기 머리에 맞게 고쳐 쓴 모양이구나."`,
            `"고쳐 썼다고요?"<br>"아래쪽 반이 없지 않느냐. 잘라 낸 것이다."`,
            `산초는 아무 말도 하지 않았습니다.`,
            `산초는 웃음을 참느라 애를 썼습니다.`,
            `참는 데 실패해서 나귀 뒤로 돌아가 웃었습니다.`,
            `돈키호테는 그 뒤로 그 놋대야를 계속 쓰고 다녔습니다. 사람들이 그를 보고 다 웃었습니다. 돈키호테는 그것을 자기를 부러워하는 것이라고 여겼습니다.`,
            `길에서 마주치는 사람마다 걸음을 멈추었습니다.`,
            `길에서 만난 아이들이 뒤를 따라오며 소리를 질렀습니다. 어른들은 문간에 나와서 구경했습니다. 개들도 짖었습니다.`,
            `아이들은 돌멩이를 던지기도 했습니다. 맞아도 돈키호테는 돌아보지 않았습니다.`,
            `놋대야가 햇빛을 받아 번쩍였기 때문입니다.`,
            `그런데 산초는 조금 달랐습니다. 산초는 그것이 놋대야라는 것을 알고 있었습니다.`,
            `그런데 사람들이 나리를 보고 웃으면 기분이 좋지 않았습니다.`,
            `자기가 웃을 때는 괜찮았습니다. 남이 웃는 것은 달랐습니다.`,
            `왜 그런지는 산초도 잘 몰랐습니다.`,
            `산초는 아직 자기 마음을 설명할 말을 가지고 있지 않았습니다.`,
            `그날 밤 산초가 물었습니다.<br>"나리, 왜 이러고 다니십니까."`,
            `"무슨 말이냐."<br>"집에 밭도 있고 조카딸도 있는데, 왜 얻어맞으면서 다니십니까."`,
            `돈키호테는 한참 있다가 대답했습니다.<br>"산초야, 세상에는 두 가지 사람이 있다. 세상을 있는 그대로 두는 사람과, 조금이라도 낫게 하려는 사람이다."`,
            `"저는 앞쪽인 것 같습니다."<br>"너는 아직 모른다."`,
            `산초는 그 말을 오래 기억했습니다. 나중에 이 이야기가 다 끝난 뒤에도 기억했습니다.`,
            `밭을 갈다가도 그 말이 떠올랐고, 아이들을 재우다가도 떠올랐습니다.`,
            `무슨 뜻인지 다 알아서 기억한 것은 아니었습니다.`,
            `그 뒤로 산초는 사람들이 웃을 때마다 나리보다 앞에 서서 걸었습니다. 왜 그러는지는 스스로도 설명하지 못했습니다.`,
            `나귀를 몰아 앞으로 나가면 사람들이 먼저 산초를 보게 됩니다. 산초는 뚱뚱하고 우스꽝스러웠으니 웃음이 거기서 한 번 끊겼습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `그런 행렬은 그 시절 에스파냐 길에서 이따금 볼 수 있었습니다.`,
            `왕의 갤리선으로 끌려가는 죄수들이었습니다. 갤리선은 노를 젓는 배인데, 그 노를 젓는 일은 아주 고된 일이었습니다.`,
            `한번 그 배에 오르면 몇 해 동안 내리지 못했습니다. 살아 돌아오는 사람이 많지 않았습니다.`,
            ...
            `두 번째 사람은 노래를 잘못 불러서 간다고 했습니다. 그것은 고문을 못 이겨 자백했다는 뜻이었습니다.`,
            `세 번째 사람은 돈이 십 두카트만 있었으면 안 갔을 거라고 했습니다.`,
            `그 돈으로 관리에게 손을 썼으면 됐을 거라는 뜻이었습니다.`,
            `돈키호테는 그 이야기를 다 듣고 나서 호송하는 사람들에게 말했습니다.<br>"이 사람들을 풀어 주시오."`,
            `"뭐라고요?"<br>"사람이 사람을 사슬에 묶어 끌고 가는 것은 옳지 않소."`,
            `"이건 왕의 명령입니다."<br>"나는 하늘의 명령을 받았소."`,
            `그리고 돈키호테는 창을 겨누고 달려들었습니다. 이번에는 이겼습니다. 호송하는 사람들이 놀라 달아났고, 죄수들은 사슬을 끊었습니다.`,
            `죄수들이 돌을 주워 호송하던 사람들에게 던졌습니다. 그 사람들은 총도 버리고 달아났습니다.`,
            `돈키호테는 아주 흡족했습니다.`,
            `이번에야말로 세상의 잘못을 바로잡았다고 여겼습니다.`,
            `그리고 죄수들에게 이렇게 말했습니다.<br>"이제 여러분은 자유요. 다만 한 가지 부탁이 있소. 토보소에 가서 둘시네아 부인께 이 일을 알려 주시오."`,
            `죄수들은 서로 얼굴을 보았습니다.`,
            `그 가운데 여럿은 정말로 나쁜 짓을 한 사람들이었습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `바위가 많고 길이 없는 산이었습니다. 나귀가 여러 번 미끄러졌습니다.`,
            `바위가 많고 사람이 살지 않는 산이었습니다.`,
            `산속에서 두 사람은 여러 날을 지냈습니다.`,
            ...
            `산초는 그것을 보고 있다가 눈을 돌렸습니다. 차마 보고 있기가 어려웠습니다.`,
            `산초가 그것을 보고 말렸습니다. 돈키호테는 규칙이라고 했습니다.`,
            `"이것을 토보소에 가서 전해라."`,
            `돈키호테는 그 편지를 아주 오래 걸려 썼습니다.`,
            `산초는 그 편지를 품에 넣었습니다.`,
            `산초는 산을 내려갔습니다. 그런데 가는 길에 그 편지를 잃어버렸습니다. 산초는 글을 읽을 줄 몰랐으므로 외울 수도 없었습니다.`,
            `자루를 다 뒤집어 털었습니다. 없었습니다.`,
            `어디서 흘렸는지도 몰랐습니다. 되돌아가 찾아볼 수도 없었습니다.`,
            `편지는 나귀 등에 매단 자루에 넣어 두었는데, 어디서 빠졌는지 알 수 없었습니다.`,
            ...
            `그리고 산초는 그 뒤로 그 거짓말 때문에 여러 번 곤란해집니다.`,
            `두 사람은 돈키호테를 찾으러 나온 참이었습니다. 산초가 사정을 다 이야기했습니다.`,
            `마을에서는 그 노인이 또 없어졌다고 난리가 나 있었습니다.`,
            ...
            `저녁마다 나리 등에 약을 발라 드리는 것도 산초였습니다. 멍이 겹쳐서 어디가 새 멍인지 알 수 없었습니다.`,
            `그날 밤 산초는 오래 뒤척였습니다.`
        ]
    },
    {
        ...
        paras: [
            ...
            `여관에서 술 부대를 거인이라고 여기고 칼로 다 찢어 놓기도 했습니다.`,
            `포도주가 방바닥에 흘러넘쳤는데, 돈키호테는 그것을 거인의 피라고 했습니다.`,
            `그 여관에는 그날 손님이 여럿 들어 있었습니다. 다들 방에서 뛰어나와 그 광경을 보았습니다.`,
            `방바닥이 온통 붉었고, 찢어진 가죽 부대가 여기저기 널려 있었습니다. 돈키호테는 칼을 든 채 잠옷 바람으로 서 있었습니다. 눈을 뜨고 있었지만 아직 꿈속에 있었습니다.`,
            `여관 주인이 값을 물어내라고 소리를 질렀습니다. 그런데 돈키호테는 기사는 여관비를 내지 않는다고 했습니다. 그것도 책에 적혀 있었기 때문입니다.`,
            `결국 신부가 대신 값을 치렀습니다.`,
            `신부와 이발사는 결국 다른 방법을 썼습니다.`,
            `밤에 돈키호테가 잠든 사이에 손발을 묶고, 나무 우리를 짜서 그 안에 넣고, 소달구지에 실은 것입니다.`,
            `우리는 소를 실어 나르는 우리였습니다. 사람이 들어가면 허리를 펴지 못했습니다.`,
            ...
            `산초는 그 말에 아무 대꾸도 하지 못했습니다. 나리가 알아채신 것 같았기 때문입니다.`,
            `그런데 돈키호테는 그 뒤로 아무 말도 하지 않았습니다.`,
            `소달구지는 엿새 걸려 마을에 닿았습니다. 마을 사람들이 다 나와서 그것을 구경했습니다. 조카딸과 아주머니가 울면서 뛰어나왔습니다.`,
            `우리 안에서 돈키호테가 사람들에게 손을 들어 인사했습니다. 마법에 걸린 기사가 지나가는 것이라고 여겼기 때문입니다.`,
            `돈키호테는 자기 침대에 눕혀졌습니다. 그리고 한 달을 앓았습니다.`,
            `산초는 집으로 돌아갔습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `산초는 그 말을 들을 때마다 속이 좋지 않았습니다. 자기가 한 거짓말이 자꾸 커지고 있었기 때문입니다.`,
            `그 목표는 끝까지 이루지 못합니다.`
        ]
    },
    {
        ...
        paras: [
            ...
            `그러니까 이 책 안에서 돈키호테는 이미 유명한 사람이었습니다.`,
            ...
            `돌계단을 오르는데 다리가 떨렸습니다. 그런데 걸음은 아주 천천히 걸었습니다. 기사는 서두르지 않는다고 책에 적혀 있었기 때문입니다.`,
            `돈키호테는 그 초대를 자기가 이룬 일의 열매라고 여겼습니다.`,
            `하인들이 줄을 서서 절을 했고, 시녀들이 물을 받쳐 손을 씻겨 주었습니다. 돈키호테는 몹시 감격했습니다.`,
            `돈키호테는 그 대접을 하나도 이상하게 여기지 않았습니다. 여태 자기가 마땅히 받아야 한다고 믿어 온 것이었기 때문입니다.`,
            `산초도 좋은 옷을 얻어 입고 잘 먹었습니다.`,
            `그런데 그것이 다 꾸민 일이었습니다.`,
            `공작 부부는 하인들에게 미리 시켜 두었습니다. 저 노인이 무슨 말을 하든 진지하게 받아 주라고요. 그리고 그 노인이 어떻게 하는지 보면서 웃자고요.`,
            `하인들 가운데 몇은 그 일을 하기 싫어했습니다.`,
            `그 사람들은 여러 가지 장난을 꾸몄습니다. 수염 난 시녀들이 나타나 마법에 걸렸다고 울며 도움을 청했고, 나무로 만든 말을 타면 하늘을 난다고 속였습니다.`,
            `돈이 많은 사람들이 심심해서 하는 장난이었습니다.`,
            `돈키호테는 눈을 가리고 나무 말에 올라탔습니다.`,
            `하인들이 옆에서 풀무로 바람을 불었습니다.`,
            `그리고 얼굴에 대고 뜨거운 헝겊을 흔들었습니다. 해가 가까워졌다고 여기게 하려던 것입니다.`,
            `"산초야, 우리가 지금 아주 높이 올라왔구나."<br>"저는 무섭습니다, 나리."`,
            `사람들이 뒤에서 웃음을 참느라 배를 잡았습니다.`,
            `그 나무 말은 마당에서 한 치도 움직이지 않았습니다.`,
            `이 대목을 읽으면 웃음이 나옵니다. 그런데 웃다가 문득 이상해집니다.`,
            `그전까지 돈키호테를 때린 사람들은 화가 나서 때린 것이었습니다. 양치기들은 자기 양을 지키려고 돌을 던졌고, 죄수들은 도망치려고 돌을 던졌습니다. 그런데 공작 부부는 아무 이유도 없었습니다.`,
            `그러니까 그 사람들에게는 까닭이 있었습니다.`,
            `그저 심심해서였습니다.`,
            `산초는 그것을 어렴풋이 느꼈습니다. 그리고 밤에 잠이 오지 않았습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `"산초야, 사람을 다스리게 되었으니 몇 가지를 일러 주겠다."<br>"말씀하십시오."`,
            `"먼저 너 자신을 알아라. 네가 농부의 아들이라는 것을 잊지 마라. 그것을 부끄러워하지도 말고, 감추지도 마라."`,
            `"눈물이 나면 죄인 쪽으로 기울어라. 다만 법을 어기지는 마라."`,
            `"부자의 말과 가난한 사람의 말을 똑같이 들어라. 가난한 사람의 말은 대개 짧고 서툴러서 지기 쉽다."`,
            `"그리고 뇌물을 받지 마라."`,
            `"나리, 그건 걱정 마십시오. 저는 남의 것에 손대 본 적이 없습니다."<br>"안다."`,
            `"그런데 나리, 하나 여쭙겠습니다. 제가 총독 노릇을 잘 못하면 어떻게 됩니까?"`,
            `"그만두면 된다."<br>"그만두어도 됩니까?"<br>"잘 못하는 자리에 앉아 있는 것이 더 나쁘다."`,
            `산초는 그 말을 마음에 새겼습니다.`,
            `그리고 총독이 되었습니다. 그런데 아주 이상한 일이 일어났습니다.`,
            `사람들이 어려운 문제를 가져오면 산초가 다 풀어 버린 것입니다.`,
            ...
            `여자는 결국 사실을 털어놓았습니다.`,
            `그런 일이 여러 번 있었습니다. 마을 사람들은 웃으려고 모였다가 감탄하며 돌아갔습니다.`,
            `산초는 글을 읽을 줄 몰랐습니다. 그런데 사람은 아주 잘 읽었습니다.`,
            `열흘째 되는 날, 산초는 총독을 그만두겠다고 했습니다.`,
    ...
    },
    {
        ...
        paras: [
            `그 뒤 두 사람은 바르셀로나까지 갔습니다. 돈키호테는 거기서 처음으로 바다를 보았습니다.`,
            `라만차에서 바르셀로나까지는 아주 먼 길이었습니다.`,
            `그리고 어느 아침, 바닷가 모래밭에서 기사 하나가 나타났습니다.`,
            `갑옷에 흰 달이 그려져 있었습니다.`,
            `젊고 키가 컸습니다.`,
            ...
            `로시난테는 첫 걸음부터 뒤처졌습니다.`,
            `돈키호테는 그때 쉰이 넘었고, 로시난테는 그보다 더 늙어 있었습니다.`,
            `돈키호테는 첫 번째 부딪침에서 말과 함께 나가떨어졌습니다. 흰 달의 기사가 창끝을 그 목에 댔습니다.`,
            `모래밭이라 소리도 크게 나지 않았습니다.`,
            `"졌다고 하라."`,
            `돈키호테는 투구 안에서 말했습니다. 목소리가 아주 작았습니다.`,
            `모래가 입에 들어가 있었습니다. 그래도 또박또박 말했습니다.`,
            ...
            `이길 생각으로 온 사람이었는데, 이기고 나니 마음이 편치 않았습니다.`,
            `"그것으로 됐다. 약속만 지키시오."`,
            `그러고는 돌아갔습니다.`,
            `카라스코는 그 마을의 젊은 사람 가운데 제일 똑똑하다는 사람이었습니다.`,
            ...
            `길가에 풍차가 보여도 그쪽을 보지 않았습니다.`,
            `한번은 산초가 이렇게 말했습니다.<br>"나리, 지는 건 흔한 일입니다. 오늘 진 사람이 내일 이기고요."`,
            `"산초야."<br>"예."`,
            `"나는 지금 처음으로 세상이 제대로 보인다."`,
            `산초는 그 말이 반갑지 않았습니다. 왜 그런지는 몰랐습니다.`,
            `제대로 보이는 것이 늘 좋은 것은 아닙니다.`
        ]
    },
    {
        num: 15,
        ...
        paras: [
            ...
            `공증인이 그 대목을 적다가 손을 멈췄습니다. 유언에 그런 것을 적는 사람은 처음이었기 때문입니다.`,
            `산초가 침대 옆에 앉아 있었습니다.`,
            `모자를 두 손으로 쥐고 있었습니다. 아까부터 그것을 계속 접었다 폈다 했습니다.`,
            `들어올 때 신을 벗고 들어왔습니다. 소리가 날까 봐서였습니다.`,
            `그러다 산초가 이렇게 말했습니다.<br>"나리, 그러지 마십시오."`,
            `"산초야."<br>"저는 섬 때문에 따라다닌 게 아닙니다."`,
            `"그럼 무엇 때문이었느냐."`,
            `산초는 모자를 더 세게 쥐었습니다.`,
            `돈키호테가 산초를 보았습니다.<br>"그럼 왜 따라다녔느냐."`,
            `산초는 대답하지 못했습니다.`,
            `그러다 이렇게 말했습니다.<br>"나리, 지지 마십시오. 일어나서 다시 가십시다. 이번에는 제가 양치기라도 하겠습니다."`,
            `"나리는 미치신 게 아니었습니다."`,
            `"산초야, 나는 미쳤었다."<br>"그래도요."<br>"그래도 뭐냐."`,
            `산초는 울면서 말했습니다.<br>"그래도 나리 옆에 있는 동안 저는 제가 괜찮은 사람 같았습니다."`,
            `돈키호테는 그 말을 듣고 웃었습니다. 그리고 그날 오후에 세상을 떠났습니다.`,
            `사람들은 그 무덤 앞에 이렇게 적었다고 합니다. 살아서는 미친 사람이었고, 죽어서는 제정신이었다고요.`,
            `그 무덤은 마을 교회 옆에 있었습니다. 조카딸이 해마다 거기에 꽃을 놓았습니다.`,
            `그런데 그 마을에서는 그 뒤로도 오랫동안 이런 이야기가 돌았습니다.`,
            `그 노인이 나무에 창을 겨누고 달려간 뒤로, 그 마을의 농부 하나가 사람을 판단할 때 옷을 보지 않게 되었다고요. 그 농부의 이름은 산초 판사였습니다.`,
            `산초는 그 뒤로 오래 살았습니다. 그리고 손자들에게 그 이야기를 여러 번 해 주었습니다.`
        ]
    }
];
/* ── 쪽 나누기 ─────────────────────────────────────────
