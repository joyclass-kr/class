...
const CHAPTERS = [
    {
        ...
        paras: [
            ...
            `제노바는 항구 도시입니다. 언덕을 따라 집이 다닥다닥 붙어 있고, 그 아래로 배가 드나듭니다.`,
            ...
            `배는 대개 제노바나 나폴리에서 떠났습니다. 부두에는 떠나는 사람과 배웅하는 사람이 늘 가득했습니다. 왜 남아메리카였는지에는 까닭이 있습니다. 그 나라들은 그때 사람이 모자랐고, 일자리가 있었습니다.`,
            `그 무렵 아르헨티나는 넓은 벌판을 밭으로 만들고 있었습니다. 밀과 소고기를 유럽에 팔면 돈이 되던 시절이었습니다.`,
            `그런데 그 넓은 땅을 갈 사람이 모자랐습니다. 그래서 아르헨티나 정부가 유럽에 사람을 보내 오라고 선전을 했습니다. 그 선전을 보고 이탈리아 사람들이 배를 탔습니다.`,
            `마르코의 집도 형편이 아주 나빠졌습니다. 아버지가 빚을 졌고, 갚을 길이 없었습니다.`,
            `그때 어머니가 말했습니다.<br>"제가 가겠습니다."`,
            `온 식구가 상 앞에 앉아 있다가 다 고개를 들었습니다. 제노바에 어머니와 아는 집안이 하나 있었는데, 그 집이 아르헨티나로 옮겨 가면서 살림을 맡아 줄 사람을 구하고 있었습니다. 삯이 이탈리아에서 받는 것의 서너 배였습니다. 아버지가 반대했습니다.`,
            `"먼 데다."<br>"이 년만 있다 오겠습니다."`,
            `어머니는 그 말을 아주 조용히 했습니다. 그리고 그 말을 한 뒤로는 다시 꺼내지 않았습니다. 떠나기 전날 밤 어머니가 마르코의 옷을 다 꿰매 놓았습니다. 이 년치를 미리 해 놓으려는 것 같았습니다.`,
            `그렇게 어머니가 배를 탔습니다. 마르코가 열한 살 때였습니다. 배가 떠나던 날 마르코는 부두에서 오래 서 있었습니다. 배가 아주 컸는데, 항구를 나가자 점처럼 작아졌습니다.`,
            `그 뒤로 어머니의 편지가 왔습니다. 한 달에 한 번쯤이었습니다. 그리고 돈도 부쳐 왔습니다.`,
            `편지는 늘 짧았습니다. 잘 있다는 말과 몸조심하라는 말이 전부였습니다. 그 돈으로 집안이 다시 일어섰습니다. 아버지의 빚도 갚았습니다.`,
            `그런데 두 해째 되던 해부터 편지가 뜸해졌습니다. 그리고 어느 날부터 아예 끊겼습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `그동안 온 식구가 우편배달부만 기다렸습니다. 골목에 발소리가 나면 형이 먼저 뛰어나갔습니다. 편지 한 통이 그 먼 데까지 갔다 오는 데 넉 달이 걸렸습니다. 그래서 한 번 물어보고 답을 듣는 데 계절이 두 번 바뀌었습니다.`,
            `어머니가 일하던 집 주인이 부에노스아이레스에서 코르도바라는 도시로 옮겨 갔고, 어머니도 함께 갔다는 것이었습니다. 그런데 그 뒤로는 어디 있는지 모른다고 했습니다. 그리고 그 편지에 이런 줄이 있었습니다.`,
            `아버지가 그 편지를 소리 내어 읽었습니다. 그러다 한 줄에서 멈췄습니다.`,
            `"그분이 몸이 좋지 않으셨습니다."`,
            `그 줄을 읽고 온 집안이 조용해졌습니다.`,
            `그날 밤 마르코가 아버지에게 말했습니다.<br>"제가 가겠습니다."`,
            `아버지가 웃었습니다. 웃었지만 웃는 얼굴이 아니었습니다.`,
            `"무슨 소리를 하는 거냐."<br>"제가 가서 찾아오겠습니다."<br>"거기까지 몇 달이 걸리는지 아느냐."<br>"압니다."<br>"돈은 어떻게 하고."<br>"뱃삯은 알아보았습니다. 삼등실이면 됩니다."`,
            `마르코는 그동안 혼자 다 알아보고 있었습니다. 아버지는 그것을 그때 알았습니다. 열세 살짜리가 몇 달 동안 혼자 그것을 하고 있었던 것입니다.`,
            `마르코는 항구에 몇 번이나 나가서 물어보았습니다. 열세 살짜리가 항구에 나가서 그런 것을 묻고 다니면 대개 쫓겨납니다. 마르코는 여러 번 쫓겨나면서 조금씩 알아냈습니다.`,
            `삼등실 삯이 얼마인지, 어느 배가 언제 떠나는지, 가는 데 며칠이 걸리는지. 그리고 종이에 다 적어 두었습니다. 아버지가 그 종이를 보고 아무 말도 하지 못했습니다.`,
            `여러 날 다투었습니다. 그런데 결국 아버지가 허락했습니다. 아버지도 이제 방법이 없었기 때문입니다. 병원 일 때문에 자기가 갈 수는 없었고, 형은 가게를 그만둘 수 없었습니다.`,
            `그리고 마침 제노바에서 아르헨티나로 가는 배에, 아버지가 아는 선장이 타고 있었습니다. 그 사람이 마르코를 봐 주기로 했습니다.`,
            `형이 마르코에게 이렇게 말했습니다.<br>"네가 가서 못 찾으면 어떻게 할래."<br>"찾을 때까지 안 옵니다."<br>"찾을 때까지가 몇 년이면."`,
            `마르코는 대답하지 않았습니다. 사월 어느 날 아침, 마르코가 배를 탔습니다. 열세 살이었습니다. 짐은 작은 가방 하나였습니다.`,
            `아버지가 부두까지 따라 나왔습니다. 배에 오르기 전에 마르코의 어깨를 한 번 잡았습니다. 그리고 아무 말도 하지 않았습니다.`,
            `그 안에 옷 두 벌과, 어머니의 편지 묶음과, 아버지가 준 돈이 들어 있었습니다. 그리고 어머니 주소가 적힌 종이가 있었습니다. 이미 소용없어진 주소였습니다. 그래도 마르코는 그 종이를 여행 내내 가지고 다녔습니다.`
        ]
    },
    {
        num: 3,
        ...
        paras: [
            `배를 타고 가는 데 스물일곱 날이 걸렸습니다. 삼등실은 배 밑바닥이었습니다. 창이 없었고, 사람이 아주 많았습니다. 한 칸에 백 명이 넘게 들어갔습니다.`,
            ...
            `불은 등불 몇 개뿐이었습니다. 낮인지 밤인지는 밥이 나오는 것으로 알았습니다.`,
            `북쪽에서 온 사람도 있고 남쪽 시칠리아에서 온 사람도 있었습니다. 그런데 서로 말이 잘 안 통했습니다. 그 시절 이탈리아는 지방마다 말이 달랐기 때문입니다. 그래서 사람들이 손짓을 섞어 가며 이야기했습니다.`,
            `물을 달라는 말, 아이가 아프다는 말, 어디까지 가느냐는 말. 그런 것부터 서로 배웠습니다. 그때 이탈리아는 나라가 합쳐진 지 스무 해쯤밖에 되지 않았습니다. 그전까지는 여러 나라로 나뉘어 있었습니다.`,
            `그런데 배 위에서 여러 주를 함께 지내면서 조금씩 통하게 되었습니다. 이탈리아 말이 하나로 되는 데는 그 뒤로도 오래 걸렸습니다.`,
            `배가 지중해를 지나 대서양으로 나갔습니다. 첫 열흘은 견딜 만했습니다. 그런데 열흘이 지나자 다들 지쳤습니다.`,
            `밑바닥이라 공기가 나빴습니다. 배 안에서 물이 상하고 음식이 상했습니다. 사람이 아프기 시작했습니다.`,
            `아이 하나가 배 위에서 세상을 떠났습니다. 그 시절 이런 배에서 사람이 죽는 일은 드물지 않았습니다. 그날 갑판에서 짧은 장례가 있었습니다. 마르코는 그것을 보고 밤에 잠을 자지 못했습니다.`,
            `천으로 싸서 바다에 내려놓았습니다. 배는 멈추지 않았습니다. 그 아이의 어머니가 갑판 난간을 붙잡고 오래 서 있었습니다. 아무도 말을 걸지 않았습니다.`,
            ...
            `그 대신 처음 보는 별들이 낮게 떴습니다. 뱃사람 하나가 그 가운데 십자 모양을 가리켜 주었습니다. 남쪽 하늘에만 뜨는 별이라고 했습니다. 마르코는 그것을 보고 자기가 아주 멀리 왔다는 것을 알았습니다.`
        ]
    },
    {
        num: 4,
        ...
        paras: [
            ...
            `제노바는 언덕에 붙어 있는 도시라 길이 좁고 굽어 있었습니다. 여기는 길이 바둑판처럼 곧게 나 있었습니다. 마차가 다니고, 가로등이 서 있고, 새로 지은 집이 줄지어 있었습니다. 벽에 아직 페인트 냄새가 나는 집도 있었습니다.`,
            `마르코는 그 길 한가운데 서서 한참 위를 올려다보았습니다. 배에서 내리는 데만 반나절이 걸렸습니다. 이름을 적고, 어디로 가는지를 대고, 짐을 검사받았습니다.`,
            `줄이 아주 길었습니다. 앞뒤로 다 이탈리아 사람이었습니다. 어디로 가느냐고 묻자 마르코는 종이를 내밀었습니다. 적힌 주소를 관리가 읽고 고개를 끄덕였습니다.`,
            `그런데 그 사람들 가운데 절반쯤이 이탈리아 말을 했습니다. 그 시절 부에노스아이레스는 인구의 상당수가 이탈리아에서 온 사람들이었습니다. 마르코는 어머니를 소개해 준 사람의 사촌을 찾아갔습니다. 아버지가 그 주소를 알려 준 것이었습니다.`,
            `그런데 그 도시는 마르코가 생각한 것보다 훨씬 컸습니다. 같은 이름의 거리가 여럿 있었습니다. 그 집을 찾는 데 하루가 걸렸습니다. 그리고 그 집에 가 보니 문이 잠겨 있었습니다.`,
            `이웃 사람이 말했습니다.<br>"그 사람은 죽었소. 지난달에."`,
            `마르코는 그 말을 두 번 되물었습니다. 잘못 들은 줄 알았기 때문입니다.`,
            `마르코는 그 자리에 주저앉았습니다. 그 도시에 아는 사람이 그 한 사람뿐이었습니다. 그리고 마르코에게 남은 돈은 며칠치였습니다.`,
            `문 앞 계단에 앉아 있는데 사람들이 그 앞을 지나갔습니다. 아무도 마르코를 보지 않았습니다. 그 자리에 얼마나 앉아 있었는지 마르코는 기억하지 못했습니다.`,
            `이탈리아 말을 하는 사람은 많았지만, 그 가운데 마르코를 아는 사람은 없었습니다. 낯선 사람이 많은 것과 아는 사람이 있는 것은 아주 다릅니다. 그런데 그 이웃이 이런 말을 했습니다. 그 이웃은 문간에 서서 마르코를 한참 보고 있던 참이었습니다.`,
            ...
            `글씨가 삐뚤었습니다. 손이 떨렸기 때문입니다. 그 종이를 주머니에 넣고 몇 번이나 꺼내 보았습니다.`,
            `코르도바까지는 기차로 갈 수 있었습니다. 그런데 삯이 마르코가 가진 것보다 많았습니다. 마르코는 그 도시에서 며칠 일을 했습니다. 항구에서 짐을 나르는 일이었습니다.`,
            `열세 살에게 시키는 일은 삯이 적었습니다. 그래도 마르코는 하루도 쉬지 않았습니다. 그리고 삯을 모아 기차를 탔습니다. 가는 데 하루가 걸렸습니다.`,
            `기차 창밖으로 팜파스라는 벌판이 지나갔습니다. 아무리 가도 끝이 없었습니다. 나무도 집도 없이 풀만 있었습니다.`,
            `소 떼가 아주 멀리 점처럼 보였습니다. 그것 말고는 움직이는 것이 없었습니다. 기차가 한나절을 달렸는데 창밖이 똑같았습니다. 마르코는 몇 번이나 잠들었다가 깼습니다.`,
            `해가 뜨고 지는 것을 창밖으로 다 볼 수 있었습니다. 가리는 것이 하나도 없었기 때문입니다. 마르코는 그 창밖을 보면서, 배에서 만난 그 사람이 한 말을 생각했습니다. 저기가 얼마나 넓은지 너는 모른다는 말이었습니다.`,
            `이탈리아에서는 반나절만 가면 산이 나오고 바다가 나옵니다. 여기서는 하루를 가도 같은 풀밭이었습니다. 그때 마르코는 그 말이 무슨 뜻인지 조금 알게 되었습니다. 그런데 돌아갈 생각은 하지 않았습니다.`
        ]
    },
    {
        num: 5,
        ...
        paras: [
            `코르도바는 부에노스아이레스보다 작았습니다. 오래된 성당이 여럿 있고 길이 좁았습니다. 흙벽에 기와를 얹은 집이 많았습니다. 낮에는 사람이 별로 다니지 않았습니다.`,
            `마르코는 메키네스 집안의 집을 사흘 만에 찾아냈습니다. 그런데 또 늦었습니다. 그 집안은 다시 옮겨 간 뒤였습니다.`,
            ...
            `그 사람은 그 말을 하면서 마르코를 제대로 보지 않았습니다. 마르코는 코르도바를 뒤졌습니다. 여러 날 걸었습니다.`,
            `이탈리아 사람이 하는 가게, 이탈리아 사람이 다니는 성당, 이탈리아 사람이 묵는 여관을 다 찾아갔습니다. 그리고 같은 말을 되풀이했습니다. 이런 부인을 보셨습니까. 그리고 마침내 어머니를 아는 사람을 하나 만났습니다.`,
            `그 사람이 이렇게 말했습니다.<br>"그 부인은 회복하고 나서 그 집안을 따라 투쿠만으로 갔소."<br>"언제요?"<br>"두 달쯤 됐소."`,
            `두 달 차이였습니다. 두 달만 빨랐으면 만났을 것이었습니다. 마르코는 그 자리에서 웃었습니다. 웃음이 나와서 웃은 것이 아니었습니다.`,
            `투쿠만까지는 또 아주 멀었습니다. 코르도바에서 투쿠만까지가 오백 킬로미터가 넘습니다. 그리고 그 길은 사막에 가까운 땅을 지나갑니다.`,
            `걸어서 가면 한 달이 넘게 걸립니다. 그리고 그 길에는 마을이 드물었습니다. 하루를 걸어도 집 한 채 안 나오는 데가 있었습니다.`,
            `그 무렵에는 기차가 거기까지 다 닿지 않았습니다. 그래서 짐은 소달구지로 날랐습니다. 그리고 마르코에게는 돈이 없었습니다. 가진 돈은 부에노스아이레스에서 기차를 타면서 다 썼습니다.`,
            `그때 마르코가 한 가지를 알아냈습니다. 그 방향으로 짐을 실어 나르는 소달구지 행렬이 있었습니다. 여러 대가 줄지어 몇 주씩 걸려 가는 것이었습니다. 마르코는 그 행렬의 우두머리를 찾아갔습니다.`,
            `"저를 태워 주십시오. 삯 대신 일하겠습니다."`,
            `행렬 우두머리는 담배를 물고 있었습니다. 그것을 한 번 빨고 나서 대답했습니다. 그 사람이 마르코를 위아래로 보았습니다.`,
            `마르코는 그때 몹시 말라 있었습니다. 신발은 다 해져 있었습니다. 바지 아랫단이 닳아서 실이 늘어져 있었습니다.`,
            `"어디까지 가나."<br>"투쿠만까지요."<br>"몇 주가 걸리는지 아나."<br>"압니다."`,
            `그 사람은 결국 태워 주었습니다. 고개를 한 번 끄덕이고 달구지 쪽을 턱으로 가리켰습니다. 그것이 전부였습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `한낮에는 그림자가 발밑에만 있었습니다. 사람들이 모자챙을 눌러쓰고 말없이 걸었습니다.`,
            ...
            `마르코는 그 행렬에서 여러 가지 일을 했습니다. 소에게 물을 먹이고, 짐을 묶고, 밥 짓는 것을 거들었습니다. 처음에는 매듭 하나 제대로 못 묶었습니다. 며칠 지나자 손이 저절로 움직였습니다.`,
            `밤이면 사람들이 불가에 모여 이야기를 했습니다. 그 사람들도 대개 어디선가 온 사람들이었습니다. 이탈리아, 스페인, 그리고 그 땅에 원래 살던 사람들.`,
            `다들 두고 온 것이 하나씩 있었습니다. 그래서 마르코의 이야기를 듣고도 아무도 웃지 않았습니다. 불은 마른 나무와 소똥으로 피웠습니다. 그 지방에는 땔나무가 귀했기 때문입니다.`,
            `그 가운데 늙은 사람이 하나 있었습니다.`,
            `그 사람이 마르코에게 이렇게 물었습니다.<br>"너는 어머니 얼굴을 아직 기억하나."`,
            `마르코가 대답하지 못했습니다. 두 해가 지났기 때문입니다. 얼굴이 흐려져 있었습니다.`,
            `눈이 어땠는지, 웃을 때 입가가 어땠는지가 떠오르지 않았습니다. 마르코는 그것이 제일 무서웠습니다.`,
            `그 사람이 말했습니다.<br>"괜찮다. 만나면 알게 된다."`,
            `그 사람들이 부르는 노래가 있었습니다. 마르코는 그 노래의 말을 알아듣지 못했습니다. 그런데 여러 밤을 듣다 보니 가락은 외웠습니다. 나중에 이탈리아로 돌아간 뒤에도 마르코는 그 가락을 기억했습니다.`,
            `그 길에서 마르코는 여러 번 앓았습니다. 발이 부었고, 열이 났습니다. 한번은 사흘 동안 달구지에 실려 갔습니다.`,
            ...
            `그 대신 오늘 할 일만 생각했습니다. 소에게 물을 먹이고, 짐을 묶고, 밥 짓는 것을 거들고, 자는 것입니다. 그리고 그것을 다 하고 나면 하루가 지나 있었습니다. 그것을 여러 주 되풀이했습니다.`
        ]
    },
    {
        num: 7,
        ...
        paras: [
            `여러 주 만에 투쿠만에 닿았습니다. 투쿠만은 사탕수수를 심는 지방이었습니다. 코르도바 쪽의 마른 땅과 달리 푸르고 축축했습니다. 마르코는 몇 주 만에 처음으로 나무 그늘에 앉았습니다.`,
            `마르코는 그 도시에서 메키네스 집안을 찾아냈습니다. 그리고 문 앞에서 물었습니다.<br>"이 댁에 이탈리아 부인이 계십니까."<br>"있었소."<br>"있었다니요."<br>"그 부인은 여기 없소. 살타로 갔소."`,
            `마르코는 그 말을 듣고 문설주를 붙잡았습니다. 다리에 힘이 빠졌기 때문입니다. 몇 주를 걸어온 끝에 들은 말이었습니다.`,
            `살타는 또 북쪽으로 먼 곳이었습니다. 그런데 이번에는 사정이 달랐습니다. 이번에는 어머니가 어디 있는지를 알았기 때문입니다. 그전까지는 그것도 몰랐습니다.`,
            `그 집 사람들은 어머니를 좋게 말했습니다. 일을 잘하고 말수가 적은 사람이었다고 했습니다. 그리고 이런 이야기를 해 주었습니다. 어머니는 그 집안 주인 부부가 살타로 옮겨 갈 때 함께 갔습니다.`,
            `그런데 가서 크게 앓았다고 했습니다. 배에 병이 생겨서 수술을 받아야 하는데, 어머니가 그것을 거부했다는 것입니다.`,
            `"왜 거부하십니까."<br>"모르겠소. 그 부인이 그냥 싫다고 했다더군."`,
            `마르코는 그 까닭을 알 것 같았습니다. 수술을 받으려면 돈이 들었습니다. 그리고 어머니는 그 돈을 집으로 부치고 있었습니다. 제노바로 가는 돈에서 한 푼도 덜지 않으려고 한 것입니다.`,
            `어머니는 제 몸에 쓸 돈을 아까워하는 사람이었습니다. 제노바에 있을 때도 그랬습니다. 이가 아파도 그냥 참았고, 신발이 해져도 꿰매 신었습니다.`,
            ...
            `이번에는 삯을 낼 것이 아무것도 없었습니다. 그래서 걸었습니다.`,
            `가는 길에 마르코는 어느 농가에서 며칠 일을 하고 밥을 얻어먹었습니다. 그리고 또 걸었습니다. 길에서 자고, 얻어먹고, 또 걸었습니다. 마르코는 그때 이미 열 달째 길 위에 있었습니다.`,
            `그러다 어느 마을에서 이탈리아 사람을 만났습니다. 그 사람이 사정을 듣고 말을 한 마리 빌려주었습니다. 늙은 말이었습니다. 그래도 걸어가는 것보다는 훨씬 나았습니다.`,
            `"살타까지 타고 가라. 그리고 그쪽 여관에 맡겨 두면 내가 찾아온다."`,
            `마르코가 물었습니다.<br>"왜 저를 도와주십니까."<br>그 사람이 말했습니다.<br>"나도 어머니를 두고 왔다."`,
            `그 사람은 그 말을 하면서 다른 데를 보고 있었습니다. 그 사람은 그 말만 하고 더 묻지 않았습니다. 마르코도 더 묻지 않았습니다.`
        ]
    },
    {
        num: 8,
        ...
        paras: [
            ...
            `그 도시에서 서쪽을 보면 눈 덮인 산이 보입니다. 마르코가 태어난 제노바에서도 산이 보였습니다. 그런데 이 산은 훨씬 높았습니다. 열세 살이 그렇게 왔습니다.`,
            `살타에 닿아서 마르코는 그 집을 찾아냈습니다. 그리고 문을 두드렸습니다.`,
            `주인이 나왔습니다.<br>"저희 어머니를 찾으러 왔습니다."`,
            `목소리가 갈라져 나왔습니다. 며칠 동안 사람과 말을 나눈 적이 없었기 때문입니다.`,
            `주인은 마르코를 한참 보았습니다. 문 앞에 선 아이는 신발이 다 해져 있었고 얼굴이 새까맣게 타 있었습니다. 그런데 눈만은 또렷했습니다.`,
            `주인은 마르코를 안으로 들여보냈습니다. 부엌으로 데려가 먼저 밥부터 먹였습니다. 마르코는 그것을 다 먹고 나서 물었습니다. 그러자 그 집 사람들이 이런 이야기를 했습니다.`,
            `어머니는 그 집에서 여러 달 앓았습니다. 의사가 여러 번 왔고, 수술을 해야 한다고 했습니다. 그런데 어머니가 계속 거절했습니다.`,
            `그 집 사람들이 여러 번 권했습니다. 그런데 그때마다 어머니가 고개를 저었습니다.`,
            `"그럼 지금은요?"<br>"이 집에 계시오."`,
            `마르코는 그 말을 듣고 아무 말도 하지 못했습니다. 여기 계신다는 말이었습니다. 열 달 동안 마르코가 듣고 싶어 하던 말이었습니다.`,
            ...
            `부에노스아이레스에서 코르도바로, 코르도바에서 투쿠만으로, 투쿠만에서 살타로요. 편지는 그 뒤를 따라가다가 다 어디선가 멈췄습니다. 어머니는 자기가 잊혔다고 여기고 있었습니다. 그런데 그 사이에 아들이 바다를 건너와 있었습니다.`,
            `마르코는 이층으로 올라갔습니다. 계단이 열두 칸이었습니다. 마르코는 그 열두 칸을 오르는 데 아주 오래 걸렸습니다.`
        ]
    },
    {
        num: 9,
        ...
        paras: [
            `방문 앞에서 마르코가 걸음을 멈췄습니다. 그리고 한참 서 있었습니다. 무서웠기 때문입니다. 손잡이에 손을 얹어 놓고 그대로 있었습니다.`,
            ...
            `마르코는 문을 열어 둔 채로 서 있었습니다. 복도의 빛이 방바닥에 길게 들어왔습니다.`,
            `침대에 사람이 하나 누워 있었습니다. 마르코는 그 사람이 자기 어머니인지 알아보지 못했습니다. 너무 여위어 있었기 때문입니다. 이불 밑의 몸이 거의 표가 나지 않았습니다.`,
            `그 침대에 누운 사람은 마르코가 기억하는 어머니보다 작았습니다. 머리가 하얗게 세어 있었습니다.`,
            `마르코가 아주 작은 소리로 불렀습니다.<br>"어머니."`,
            `그 사람이 눈을 떴습니다. 그런데 아무 반응이 없었습니다. 천장을 보고 있었습니다. 소리가 난 쪽을 돌아보지도 않았습니다.`,
            `마르코가 한 발 다가갔습니다.<br>"어머니, 저예요."`,
            `그 사람이 몸을 일으키려다가 다시 누웠습니다.`,
            `그리고 이렇게 말했습니다.<br>"······누구세요."`,
            `그 목소리는 마르코가 아는 목소리였습니다. 마르코는 그것으로 알아보았습니다. 얼굴은 달라져 있었습니다. 그런데 목소리는 제노바에서 듣던 그대로였습니다.`,
            `마르코는 그 자리에 무릎을 꿇었습니다.`,
            `"저 마르코예요. 제노바에서 왔어요."`,
            `그 방에서 마르코가 한 말은 그것뿐이었습니다. 다른 말은 생각나지 않았습니다.`,
            `그 순간이었습니다. 어머니가 몸을 일으켰습니다. 그때까지 여러 주 동안 혼자 일어나 앉지 못하던 사람이었습니다.`,
            `그리고 두 손으로 마르코의 얼굴을 잡았습니다. 그리고 소리를 냈습니다. 말이 아니었습니다. 사람이 아주 오래 참았던 것을 한꺼번에 놓을 때 내는 소리였습니다.`,
            `그 방 밖에 있던 사람들이 그 소리를 듣고 뛰어 올라왔습니다. 어머니가 마르코를 안고 놓지 않았습니다. 집 주인도, 하녀도, 아까 문을 열어 준 사람도 다 계단에 서 있었습니다. 아무도 방 안으로 들어가지 않았습니다.`,
            `어머니가 이렇게 말했습니다.<br>"네가 어떻게······ 네가 어떻게 여기를······."`,
            `마르코는 대답하지 못했습니다. 열 달 동안 걸어온 이야기를 어디서부터 해야 할지 몰랐기 때문입니다. 제노바 부두부터 이야기하면 밤을 새워야 했습니다.`,
    ...
    },
    {
        ...
        paras: [
            `그날 저녁 의사가 왔습니다. 그 도시에서 제일 나은 의사였습니다. 그 집 주인이 불러온 것이었습니다.`,
            `의사는 어머니를 살펴보고 나서 이렇게 말했습니다.<br>"수술을 받으셔야 합니다. 지금도 늦었습니다."`,
            `의사는 마르코 쪽을 한 번 보고 말했습니다. 어머니가 아니라 아들에게 하는 말 같았습니다. 어머니는 또 고개를 저었습니다. 여러 달 동안 되풀이한 몸짓이었습니다.`,
            `그때 마르코가 어머니의 손을 잡았습니다.`,
            `"어머니, 받으세요."<br>"······."<br>"제가 여기까지 온 게 무엇 때문이겠어요."`,
            `어머니가 마르코를 보았습니다. 그 얼굴에 흙과 볕에 탄 자국이 있었습니다. 열한 살에 두고 온 아이의 얼굴이 아니었습니다.`,
            ...
            `그 시절 수술은 지금과 아주 달랐습니다. 마취도 지금 같지 않았고 상처가 곪는 일이 많았습니다. 살아날 확률이 반이 안 되는 일도 있었습니다. 수술을 받겠다고 하는 것 자체가 큰 결심이었습니다.`,
            ...
            `창가까지 걷는 데 여러 날이 걸렸습니다. 마르코가 팔을 붙들고 함께 걸었습니다. 마르코는 그것을 하나씩 다 보았습니다.`,
            `그리고 나중에 이렇게 말했습니다.<br>"저는 어머니가 다시 걷는 걸 봤어요. 그게 제일 좋았어요."`,
            `그동안 마르코는 살타에서 일을 했습니다. 돌아갈 뱃삯을 벌어야 했기 때문입니다. 가게에서 짐을 나르고, 마구간을 치우고, 심부름을 했습니다. 그러면서 돈을 모았습니다.`,
            `그리고 저녁이면 어머니 곁에 앉아 그동안 있었던 일을 하나씩 이야기했습니다. 배 밑바닥 이야기, 팜파스 이야기, 소달구지 이야기, 말을 빌려준 사람 이야기. 어머니는 그 이야기를 들으면서 여러 번 울었습니다.`,
    ...
    },
    {
        ...
        paras: [
            `이듬해 봄, 두 사람은 부에노스아이레스로 내려갔습니다. 내려가는 길은 올라온 길과 같았습니다. 그런데 이번에는 기차를 탈 수 있었습니다. 그리고 옆자리에 어머니가 있었습니다.`,
            `그리고 제노바로 가는 배를 탔습니다. 이번에도 삼등실이었습니다. 그런데 마르코는 이번에는 무섭지 않았습니다. 가는 길이 어떤지 이미 알고 있었기 때문입니다.`,
            ...
            `두 사람은 갑판 난간에 나란히 서 있었습니다. 배가 대서양 한가운데를 지나고 있었습니다. 어머니는 그 말을 듣고 한참 아무 말도 하지 않았습니다.`,
            `그리고 이렇게 말했습니다.<br>"나는 네가 문 앞에 서 있는 동안 이런 생각을 했다."<br>"밖에 누가 왔구나. 그런데 나는 이제 아무도 안 기다린다."<br>"그런데 네가 어머니라고 부르더구나."`,
            `배가 제노바에 닿은 것은 그해 여름이었습니다. 마르코가 떠난 지 열여섯 달 만이었습니다. 부두에 아버지와 형이 나와 있었습니다.`,
            `아버지는 마르코가 떠난 뒤로 그 부두에 자주 나왔다고 합니다. 배가 들어올 때마다 나가 보았다고 합니다.`,
            `형도 함께 나왔습니다. 가게가 쉬는 날이면 둘이 부두에 앉아 있었습니다. 그리고 아무 말도 하지 않았습니다.`,
            `배가 들어와도 아는 얼굴이 없으면 그냥 일어나 돌아갔습니다. 그것을 열여섯 달 동안 했습니다. 이 이야기는 사실 더 큰 책의 한 부분입니다. 에드몬도 데 아미치스라는 이탈리아 사람이 쓴 『쿠오레』라는 책입니다.`,
            `초등학교 삼학년 아이의 한 해 일기 형식으로 된 책인데, 그 안에 선생님이 달마다 읽어 주는 짧은 이야기가 아홉 편 들어 있습니다. 이 이야기는 그 가운데 오월 이야기입니다. 오월에 선생님이 교실에서 이 이야기를 읽어 줍니다. 아이들이 그것을 듣습니다.`,
            `선생님이 교실에서 소리 내어 읽어 주는 이야기라는 뜻입니다. 그래서 문장이 짧고 장면이 또렷합니다. 원래 제목은 「아펜니노에서 안데스까지」입니다. 이탈리아의 산에서 남아메리카의 산까지라는 뜻입니다.`,
            `그 시절 이탈리아 사람들이 실제로 그렇게 갔습니다. 천팔백팔십 년부터 오십 년 동안 이탈리아를 떠난 사람이 천삼백만 명이 넘습니다. 그 무렵 이탈리아 인구가 삼천만 명쯤이었습니다. 그러니까 세 사람 가운데 하나가 떠난 셈입니다.`,
            `그러니까 이 이야기는 지어낸 이야기이면서, 그 시절 아주 많은 집에서 실제로 있었던 이야기입니다. 배를 타고 떠난 어머니와 아버지가 그만큼 많았다는 뜻입니다. 그 사람들이 무엇을 겪었는지를 이 이야기가 대신 적어 두었습니다.`
        ]
    }
];
/* ── 쪽 나누기 ─────────────────────────────────────────
