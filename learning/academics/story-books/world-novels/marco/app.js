...
const CHAPTERS = [
    ...
    },
    {
        ...
        paras: [
            ...
            `마르코는 그 말을 듣고 문설주를 붙잡았습니다. 살타는 또 북쪽으로 먼 곳이었습니다. 그런데 이번에는 사정이 달랐습니다.`,
            `다리에 힘이 빠졌기 때문입니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `주인은 마르코를 한참 보았습니다. 그리고 안으로 들여보냈습니다. 그 집 사람들이 이런 이야기를 했습니다.`,
            `문 앞에 선 아이는 신발이 다 해져 있었고 얼굴이 새까맣게 타 있었습니다. 그런데 눈만은 또렷했습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `방 안이 어두웠습니다. 침대에 사람이 하나 누워 있었습니다. 마르코는 그 사람이 자기 어머니인지 알아보지 못했습니다.`,
            `덧문이 닫혀 있었습니다. 창틈으로 들어온 빛이 바닥에 줄 하나를 그어 놓고 있었습니다. 방 안에서는 약 냄새가 났습니다.`,
            `너무 여위어 있었기 때문입니다.`,
            ...
            `말이 아니었습니다. 그 방 밖에 있던 사람들이 그 소리를 듣고 뛰어 올라왔습니다. 어머니가 마르코를 안고 놓지 않았습니다.`,
            `사람이 아주 오래 참았던 것을 한꺼번에 놓을 때 내는 소리였습니다.`,
