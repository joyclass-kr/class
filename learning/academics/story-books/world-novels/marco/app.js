...
const CHAPTERS = [
    {
        ...
        paras: [
            `백사십 년쯤 전, 이탈리아 제노바에 마르코라는 아이가 살았습니다.`,
            `열세 살이었습니다.`,
            `아버지는 병원에서 일했고, 형은 가게 점원이었습니다.`,
            `그 무렵 이탈리아는 아주 가난했습니다.`,
            `나라가 하나로 합쳐진 지 얼마 되지 않았고, 남쪽과 북쪽 다 일자리가 없었습니다.`,
            `그래서 그 시절 이탈리아 사람들이 배를 타고 밖으로 나갔습니다.`,
            `한 해에 수십만 명이 나갔습니다.`,
            `제일 많이 간 곳이 남아메리카였습니다.`,
            `아르헨티나와 브라질이었습니다.`,
            `그 나라들은 그때 사람이 모자랐고, 일자리가 있었습니다.`,
            `왜 남아메리카였는지에는 까닭이 있습니다.`,
            `그 무렵 아르헨티나는 넓은 벌판을 밭으로 만들고 있었습니다.`,
            `밀과 소고기를 유럽에 팔면 돈이 되던 시절이었습니다.`,
            `그런데 그 넓은 땅을 갈 사람이 모자랐습니다.`,
            `그래서 아르헨티나 정부가 유럽에 사람을 보내 오라고 선전을 했습니다.`,
            `그 선전을 보고 이탈리아 사람들이 배를 탔습니다.`,
            `마르코의 집도 형편이 아주 나빠졌습니다.`,
            `아버지가 빚을 졌고, 갚을 길이 없었습니다.`,
            `그때 어머니가 말했습니다.`,
            `"제가 가겠습니다."`,
            `제노바에 어머니와 아는 집안이 하나 있었는데, 그 집이 아르헨티나로 옮겨 가면서 살림을 맡아 줄 사람을 구하고 있었습니다.`,
            `삯이 이탈리아에서 받는 것의 서너 배였습니다.`,
            `아버지가 반대했습니다.`,
            `"먼 데다."`,
            `"이 년만 있다 오겠습니다."`,
            `그렇게 어머니가 배를 탔습니다.`,
            `마르코가 열한 살 때였습니다.`,
            `배가 떠나던 날 마르코는 부두에서 오래 서 있었습니다.`,
            `배가 아주 컸는데, 항구를 나가자 점처럼 작아졌습니다.`,
            `그 뒤로 어머니의 편지가 왔습니다.`,
            `한 달에 한 번쯤이었습니다.`,
            `그리고 돈도 부쳐 왔습니다.`,
            `그 돈으로 집안이 다시 일어섰습니다.`,
            `아버지의 빚도 갚았습니다.`,
            `그런데 두 해째 되던 해부터 편지가 뜸해졌습니다.`,
            `그리고 어느 날부터 아예 끊겼습니다.`,
            `마르코는 그해에 학교를 그만두었습니다.`,
            `집안 형편 때문이 아니었습니다.`,
            `어머니가 부친 돈으로 형편은 나아졌습니다.`,
            `그런데 마르코는 앉아 있지를 못했습니다.`,
            `선생님이 아버지를 불러 이렇게 말했습니다.`,
            `"이 아이는 지금 여기 없습니다."`
        ]
    },
    {
        ...
        paras: [
            `아버지는 여러 군데에 편지를 썼습니다.`,
            `어머니가 일하던 집으로도 쓰고, 이탈리아 영사관에도 썼습니다.`,
            `그리고 여러 달 만에 답이 하나 왔습니다.`,
            `어머니가 일하던 집 주인이 부에노스아이레스에서 코르도바라는 도시로 옮겨 갔고, 어머니도 함께 갔다는 것이었습니다.`,
            `그런데 그 뒤로는 어디 있는지 모른다고 했습니다.`,
            `그리고 그 편지에 이런 줄이 있었습니다.`,
            `"그분이 몸이 좋지 않으셨습니다."`,
            `그 줄을 읽고 온 집안이 조용해졌습니다.`,
            `그날 밤 마르코가 아버지에게 말했습니다.`,
            `"제가 가겠습니다."`,
            `아버지가 웃었습니다.`,
            `"무슨 소리를 하는 거냐."`,
            `"제가 가서 찾아오겠습니다."`,
            ...
            `"압니다."`,
            `"돈은 어떻게 하고."`,
            `"뱃삯은 알아보았습니다. 삼등실이면 됩니다."`,
            `마르코는 그동안 혼자 다 알아보고 있었습니다.`,
            `아버지는 그것을 그때 알았습니다.`,
            `마르코는 항구에 몇 번이나 나가서 물어보았습니다.`,
            `삼등실 삯이 얼마인지, 어느 배가 언제 떠나는지, 가는 데 며칠이 걸리는지.`,
            `그리고 종이에 다 적어 두었습니다.`,
            `아버지가 그 종이를 보고 아무 말도 하지 못했습니다.`,
            `여러 날 다투었습니다.`,
            `그런데 결국 아버지가 허락했습니다.`,
            `아버지도 이제 방법이 없었기 때문입니다.`,
            `병원 일 때문에 자기가 갈 수는 없었고, 형은 가게를 그만둘 수 없었습니다.`,
            `그리고 마침 제노바에서 아르헨티나로 가는 배에, 아버지가 아는 선장이 타고 있었습니다.`,
            `그 사람이 마르코를 봐 주기로 했습니다.`,
            `사월 어느 날 아침, 마르코가 배를 탔습니다.`,
            `열세 살이었습니다.`,
            `짐은 작은 가방 하나였습니다.`,
            `그 안에 옷 두 벌과, 어머니의 편지 묶음과, 아버지가 준 돈이 들어 있었습니다.`,
            `그리고 어머니 주소가 적힌 종이가 있었습니다.`,
            `이미 소용없어진 주소였습니다.`
        ]
    },
    {
        ...
        paras: [
            `배를 타고 가는 데 스물일곱 날이 걸렸습니다.`,
            `삼등실은 배 밑바닥이었습니다.`,
            `창이 없었고, 사람이 아주 많았습니다.`,
            `침상이 벽에 삼층으로 붙어 있었습니다.`,
            `그 배에 탄 사람들은 다 마르코와 비슷한 처지였습니다.`,
            `이탈리아 여러 곳에서 온 사람들이었습니다.`,
            `북쪽에서 온 사람도 있고 남쪽 시칠리아에서 온 사람도 있었습니다.`,
            `그런데 서로 말이 잘 안 통했습니다.`,
            `그 시절 이탈리아는 지방마다 말이 달랐기 때문입니다.`,
            `그래서 사람들이 손짓을 섞어 가며 이야기했습니다.`,
            `그때 이탈리아는 나라가 합쳐진 지 스무 해쯤밖에 되지 않았습니다.`,
            `그전까지는 여러 나라로 나뉘어 있었습니다.`,
            `그래서 북쪽 사람과 남쪽 사람이 서로 말이 안 통했습니다.`,
            `그런데 배 위에서 여러 주를 함께 지내면서 조금씩 통하게 되었습니다.`,
            `이탈리아 말이 하나로 되는 데는 그 뒤로도 오래 걸렸습니다.`,
            `배가 지중해를 지나 대서양으로 나갔습니다.`,
            `첫 열흘은 견딜 만했습니다.`,
            `그런데 열흘이 지나자 다들 지쳤습니다.`,
            `밑바닥이라 공기가 나빴고, 사람이 아프기 시작했습니다.`,
            `아이 하나가 배 위에서 세상을 떠났습니다.`,
            `그날 갑판에서 짧은 장례가 있었습니다.`,
            `마르코는 그것을 보고 밤에 잠을 자지 못했습니다.`,
            `어떤 사람이 마르코에게 이렇게 물었습니다.`,
            `"너는 왜 혼자 가니?"`,
            `"어머니를 찾으러 갑니다."`,
            `"어디 계신데?"`,
            `"모릅니다."`,
            `그 사람이 한참 마르코를 보다가 말했습니다.`,
            `"돌아가라."`,
            `"안 돌아갑니다."`,
            `그 사람이 다시 말했습니다.`,
            `"저기가 얼마나 넓은지 너는 모른다."`,
            `그 말은 맞는 말이었습니다.`,
            `아르헨티나는 이탈리아의 아홉 배가 넘습니다.`,
            `마르코는 그것을 그때 몰랐습니다.`
        ]
    },
    {
        ...
        paras: [
            ...
            `길이 아주 넓고 곧았습니다.`,
            `그리고 사람이 아주 많았습니다.`,
            `그런데 그 사람들 가운데 절반쯤이 이탈리아 말을 했습니다.`,
            `그 시절 부에노스아이레스는 인구의 상당수가 이탈리아에서 온 사람들이었습니다.`,
            `마르코는 어머니를 소개해 준 사람의 사촌을 찾아갔습니다.`,
            `아버지가 그 주소를 알려 준 것이었습니다.`,
            `그 집을 찾는 데 하루가 걸렸습니다.`,
            `그리고 그 집에 가 보니 문이 잠겨 있었습니다.`,
            `이웃 사람이 말했습니다.`,
            `"그 사람은 죽었소. 지난달에."`,
            `마르코는 그 자리에 주저앉았습니다.`,
            `그 도시에 아는 사람이 그 한 사람뿐이었습니다.`,
            `그리고 마르코에게 남은 돈은 며칠치였습니다.`,
            `이탈리아 말을 하는 사람은 많았지만, 그 가운데 마르코를 아는 사람은 없었습니다.`,
            `낯선 사람이 많은 것과 아는 사람이 있는 것은 아주 다릅니다.`,
            `그런데 그 이웃이 이런 말을 했습니다.`,
            `"그런데 그 사람 물건을 정리한 사람이 있소. 그리로 가 보시오."`,
            `마르코는 그 사람을 찾아갔습니다.`,
            `그리고 그 사람에게서 실마리를 하나 얻었습니다.`,
            `어머니가 일하던 집안의 성이 메키네스였고, 그 집이 코르도바로 옮겨 갔다는 것이었습니다.`,
            `코르도바까지는 기차로 갈 수 있었습니다.`,
            `그런데 삯이 마르코가 가진 것보다 많았습니다.`,
            `마르코는 그 도시에서 며칠 일을 했습니다.`,
            `항구에서 짐을 나르는 일이었습니다.`,
            `그리고 삯을 모아 기차를 탔습니다.`,
            `가는 데 하루가 걸렸습니다.`,
            `기차 창밖으로 팜파스라는 벌판이 지나갔습니다.`,
            `아무리 가도 끝이 없었습니다.`,
            `나무도 집도 없이 풀만 있었습니다.`,
            `마르코는 그 창밖을 보면서, 배에서 만난 그 사람이 한 말을 생각했습니다.`,
            `저기가 얼마나 넓은지 너는 모른다는 말이었습니다.`
        ]
    },
    {
        num: 5,
        ...
        paras: [
            `코르도바에서 마르코는 메키네스 집안을 찾아냈습니다.`,
            `그런데 또 늦었습니다.`,
            `그 집안은 다시 옮겨 간 뒤였습니다.`,
            `투쿠만이라는 도시였습니다.`,
            `코르도바에서 북쪽으로 아주 먼 곳이었습니다.`,
            `그리고 그 집 사람이 이렇게 말해 주었습니다.`,
            `"그 부인은 함께 안 갔소."`,
            `"그럼 어디 계십니까."`,
            `"몸이 나빠져서 이 도시 어느 집에 남았소. 그러다 어떻게 됐는지는 모르겠소."`,
            `마르코는 코르도바를 뒤졌습니다.`,
            `여러 날 걸었습니다.`,
            `이탈리아 사람이 모이는 데를 다 찾아다녔습니다.`,
            `그리고 마침내 어머니를 아는 사람을 하나 만났습니다.`,
            `그 사람이 이렇게 말했습니다.`,
            `"그 부인은 회복하고 나서 그 집안을 따라 투쿠만으로 갔소."`,
            `"언제요?"`,
            `"두 달쯤 됐소."`,
            `마르코는 그 자리에서 웃었습니다.`,
            `웃음이 나와서 웃은 것이 아니었습니다.`,
            `투쿠만까지는 또 아주 멀었습니다.`,
            `코르도바에서 투쿠만까지가 오백 킬로미터가 넘습니다.`,
            `그리고 그 길은 사막에 가까운 땅을 지나갑니다.`,
            `그 무렵에는 기차가 거기까지 다 닿지 않았습니다.`,
            `그래서 짐은 소달구지로 날랐습니다.`,
            `그리고 마르코에게는 돈이 없었습니다.`,
            `기차 삯이 없었습니다.`,
            `그때 마르코가 한 가지를 알아냈습니다.`,
            `그 방향으로 짐을 실어 나르는 소달구지 행렬이 있었습니다.`,
            `여러 대가 줄지어 몇 주씩 걸려 가는 것이었습니다.`,
    ...
    },
    {
        ...
        paras: [
            `그 길이 이 이야기에서 제일 긴 대목입니다.`,
            `달구지 행렬은 하루에 아주 조금씩 갔습니다.`,
            `소가 끌기 때문에 사람 걸음보다 느렸습니다.`,
            `마르코는 그 옆에서 걸었습니다.`,
            `밤에는 달구지 아래에서 잤습니다.`,
            `낮에는 몹시 더웠습니다.`,
            `그 지방은 물이 귀했습니다.`,
            `우물이 있는 자리까지 하루씩 걸리기도 했습니다.`,
            `사람들이 물을 아껴 나눠 마셨습니다.`,
            `마르코는 그 행렬에서 여러 가지 일을 했습니다.`,
            `소에게 물을 먹이고, 짐을 묶고, 밥 짓는 것을 거들었습니다.`,
            `밤이면 사람들이 불가에 모여 이야기를 했습니다.`,
            `그 사람들도 대개 어디선가 온 사람들이었습니다.`,
            `이탈리아, 스페인, 그리고 그 땅에 원래 살던 사람들.`,
            `그 가운데 늙은 사람이 하나 있었습니다.`,
            `그 사람이 마르코에게 이렇게 물었습니다.`,
            `"너는 어머니 얼굴을 아직 기억하나."`,
            `마르코가 대답하지 못했습니다.`,
            `두 해가 지났기 때문입니다.`,
            `얼굴이 흐려져 있었습니다.`,
            `그 사람이 말했습니다.`,
            `"괜찮다. 만나면 알게 된다."`,
            `그 사람들이 부르는 노래가 있었습니다.`,
            `마르코는 그 노래의 말을 알아듣지 못했습니다.`,
            `그런데 여러 밤을 듣다 보니 가락은 외웠습니다.`,
            `나중에 이탈리아로 돌아간 뒤에도 마르코는 그 가락을 기억했습니다.`,
            `그 길에서 마르코는 여러 번 앓았습니다.`,
            `발이 부었고, 열이 났습니다.`,
            `한번은 사흘 동안 달구지에 실려 갔습니다.`,
            `사람들이 마르코에게 이렇게 말했습니다.`,
            `"돌아가라."`,
            `그 말을 이 여행에서 마르코는 몇 번이나 들었습니다.`,
            `배에서도 들었고, 부에노스아이레스에서도 들었고, 코르도바에서도 들었습니다.`,
            `그리고 그때마다 마르코는 같은 대답을 했습니다.`,
            `"안 돌아갑니다."`,
            `그 길에서 마르코가 배운 것이 하나 있습니다.`,
            `하루에 얼마나 갔는지를 세지 않는 것이었습니다.`,
            `세면 견딜 수가 없었기 때문입니다.`,
            `그 대신 오늘 할 일만 생각했습니다.`,
            `소에게 물을 먹이고, 짐을 묶고, 밥 짓는 것을 거들고, 자는 것입니다.`
        ]
    },
    {
        num: 7,
        ...
        paras: [
            `여러 주 만에 투쿠만에 닿았습니다.`,
            `마르코는 그 도시에서 메키네스 집안을 찾아냈습니다.`,
            `그리고 문 앞에서 물었습니다.`,
            `"이 댁에 이탈리아 부인이 계십니까."`,
            `"있었소."`,
            `"있었다니요."`,
            `"그 부인은 여기 없소. 살타로 갔소."`,
            `마르코는 그 말을 듣고 문설주를 붙잡았습니다.`,
            `살타는 또 북쪽으로 먼 곳이었습니다.`,
            `그런데 이번에는 사정이 달랐습니다.`,
            `그 집 사람이 이런 이야기를 해 주었습니다.`,
            `어머니는 그 집안 주인 부부가 살타로 옮겨 갈 때 함께 갔습니다.`,
            `그런데 가서 크게 앓았다고 했습니다.`,
            `배에 병이 생겨서 수술을 받아야 하는데, 어머니가 그것을 거부했다는 것입니다.`,
            `"왜 거부하십니까."`,
            `"모르겠소. 그 부인이 그냥 싫다고 했다더군."`,
            `마르코는 그 까닭을 알 것 같았습니다.`,
            `수술을 받으려면 돈이 들었습니다.`,
            `그리고 어머니는 그 돈을 집으로 부치고 있었습니다.`,
            `그 집 사람이 이렇게 덧붙였습니다.`,
            `"주인 나리가 값을 대 주겠다고 하셨소. 그런데도 안 받겠다고 하셨소."`,
            `"왜요?"`,
            `"신세를 지기 싫다고 하셨소."`,
            `마르코는 그 말을 듣고 어머니가 어떤 사람인지 다시 생각났습니다.`,
            `마르코는 그날 밤 잠들지 못했습니다.`,
            `그리고 새벽에 다시 길을 나섰습니다.`,
            `이번에는 삯을 낼 것이 아무것도 없었습니다.`,
            `그래서 걸었습니다.`,
            `가는 길에 마르코는 어느 농가에서 며칠 일을 하고 밥을 얻어먹었습니다.`,
            `그리고 또 걸었습니다.`,
            `그러다 어느 마을에서 이탈리아 사람을 만났습니다.`,
            `그 사람이 사정을 듣고 말을 한 마리 빌려주었습니다.`,
    ...
    },
    {
        ...
        paras: [
            `살타에 닿는 데 또 여러 날이 걸렸습니다.`,
            `길이 산으로 올라갔습니다.`,
            `공기가 얇아져서 숨이 찼습니다.`,
            `살타는 안데스 산맥 자락에 있는 도시입니다.`,
            `제노바에서 여기까지, 마르코가 온 거리를 이어 보면 지구를 사분의 일쯤 돈 것입니다.`,
            `그리고 그 대부분을 배와 소달구지와 두 발로 왔습니다.`,
            `열세 살이 그렇게 왔습니다.`,
            `살타에 닿아서 마르코는 그 집을 찾아냈습니다.`,
            `그리고 문을 두드렸습니다.`,
            `주인이 나왔습니다.`,
            `"저희 어머니를 찾으러 왔습니다."`,
            `주인은 마르코를 한참 보았습니다.`,
            `그리고 안으로 들여보냈습니다.`,
            `그 집 사람들이 이런 이야기를 했습니다.`,
            `어머니는 그 집에서 여러 달 앓았습니다.`,
            `의사가 여러 번 왔고, 수술을 해야 한다고 했습니다.`,
            `그런데 어머니가 계속 거절했습니다.`,
            `"그럼 지금은요?"`,
            `"이 집에 계시오."`,
            ...
            `"그런데 알아 두어야 할 것이 있소."`,
            `"뭡니까."`,
            `"그 부인은 이제 아무것도 하려고 하지 않으시오."`,
            `"무슨 말씀입니까."`,
            `"밥도 잘 안 드시고, 약도 안 드시고, 수술도 안 받겠다고 하시오."`,
            `"저희 어머니가 왜 그러십니까."`,
            `주인이 말했습니다.`,
            `"고향 소식이 끊긴 지 오래되어서 그럴 거요. 그 부인은 자기 식구들이 자기를 잊었다고 여기고 있소."`,
            `마르코는 그 말을 듣고 얼굴을 감쌌습니다.`,
            `편지는 끊긴 것이 아니었습니다.`,
            `양쪽에서 다 보냈는데, 그 사이에 어머니가 세 번 옮겨 다녔던 것입니다.`,
            `그래서 어느 편지도 닿지 않았습니다.`,
            `마르코는 이층으로 올라갔습니다.`
        ]
    },
    {
        ...
        paras: [
            `방문 앞에서 마르코가 걸음을 멈췄습니다.`,
            `그리고 한참 서 있었습니다.`,
            `무서웠기 때문입니다.`,
            `문을 열고 들어갔는데 어머니가 자기를 못 알아보면 어떻게 하나.`,
            `그리고 열 달 동안 걸어온 것이 다 무엇이 되나.`,
            `마르코는 문을 열었습니다.`,
            `방 안이 어두웠습니다.`,
            `침대에 사람이 하나 누워 있었습니다.`,
            `마르코는 그 사람이 자기 어머니인지 알아보지 못했습니다.`,
            `너무 여위어 있었기 때문입니다.`,
            `마르코가 아주 작은 소리로 불렀습니다.`,
            `"어머니."`,
            `그 사람이 눈을 떴습니다.`,
            `그리고 아무 반응이 없었습니다.`,
            `마르코가 한 발 다가갔습니다.`,
            ...
            `"저 마르코예요. 제노바에서 왔어요."`,
            `그 순간이었습니다.`,
            `어머니가 두 손으로 마르코의 얼굴을 잡았습니다.`,
            `그리고 소리를 냈습니다.`,
            `말이 아니었습니다.`,
            `그 방 밖에 있던 사람들이 그 소리를 듣고 뛰어 올라왔습니다.`,
            `어머니가 마르코를 안고 놓지 않았습니다.`,
            `그리고 이렇게 말했습니다.`,
            `"네가 어떻게······ 네가 어떻게 여기를······."`,
            `마르코는 대답하지 못했습니다.`,
            `열 달 동안 걸어온 이야기를 어디서부터 해야 할지 몰랐기 때문입니다.`
        ]
    },
    {
        num: 10,
        ...
        paras: [
            `그날 저녁 의사가 왔습니다.`,
            `의사는 어머니를 살펴보고 나서 이렇게 말했습니다.`,
            `"수술을 받으셔야 합니다. 지금도 늦었습니다."`,
            `어머니는 또 고개를 저었습니다.`,
            `그때 마르코가 어머니의 손을 잡았습니다.`,
            `"어머니, 받으세요."`,
            `"······."`,
            `"제가 여기까지 온 게 무엇 때문이겠어요."`,
            `어머니가 마르코를 보았습니다.`,
            `마르코가 말했습니다.`,
            `"저는 배를 스물일곱 날 탔어요. 그리고 소달구지 옆에서 몇 주를 걸었어요. 발이 다 부었어요."`,
            `"어머니가 안 받으시면 그게 다 무엇이 됩니까."`,
            `어머니는 한참 아무 말도 하지 않았습니다.`,
            `그러고는 의사에게 이렇게 말했습니다.`,
            `"받겠습니다."`,
            `그 뒤에 있었던 일을 이 책은 이렇게 적었습니다.`,
            `그 시절 수술은 지금과 아주 달랐습니다.`,
            `살아날 확률이 반이 안 되는 일도 있었습니다.`,
            `그런데 어머니는 살았습니다.`,
            `수술을 마치고 나서 의사가 이렇게 말했다고 합니다.`,
            `"이분은 살고 싶어 하셨습니다. 그것이 절반입니다."`,
            `어머니가 회복하는 데 여러 달이 걸렸습니다.`,
            `처음 몇 주는 일어나 앉지도 못했습니다.`,
            `그러다 앉게 되었고, 창가까지 걷게 되었고, 마당에 나가게 되었습니다.`,
            `마르코는 그것을 하나씩 다 보았습니다.`,
            `그리고 나중에 이렇게 말했습니다.`,
            `"저는 어머니가 다시 걷는 걸 봤어요. 그게 제일 좋았어요."`,
            `그동안 마르코는 살타에서 일을 했습니다.`,
            `돌아갈 뱃삯을 벌어야 했기 때문입니다.`,
            `그리고 저녁이면 어머니 곁에 앉아 그동안 있었던 일을 하나씩 이야기했습니다.`,
            `배 밑바닥 이야기, 팜파스 이야기, 소달구지 이야기, 말을 빌려준 사람 이야기.`,
            `어머니는 그 이야기를 들으면서 여러 번 울었습니다.`,
            `그리고 한번은 이렇게 말했습니다.`,
            `"내가 그 이 년 동안 무엇을 하고 있었는지 모르겠구나."`,
            `마르코가 말했습니다.`,
            `"어머니가 보내 주신 돈으로 저희가 살았어요."`
        ]
    },
    {
        num: 11,
        ...
        paras: [
            ...
            `그리고 제노바로 가는 배를 탔습니다.`,
            `이번에도 삼등실이었습니다.`,
            `그런데 마르코는 이번에는 무섭지 않았습니다.`,
            `가는 길이 어떤지 이미 알고 있었기 때문입니다.`,
            `배 위에서 어머니가 물었습니다.`,
            `"마르코야, 그때 문 앞에서 왜 그렇게 오래 서 있었니?"`,
            `"알고 계셨어요?"`,
            `"발소리가 났는데 문이 안 열렸잖니."`,
            `마르코가 말했습니다.`,
            `"어머니가 저를 못 알아보실까 봐 무서웠어요."`,
            `어머니는 그 말을 듣고 한참 아무 말도 하지 않았습니다.`,
            `그리고 이렇게 말했습니다.`,
            `"나는 네가 문 앞에 서 있는 동안 이런 생각을 했다."`,
            `"밖에 누가 왔구나. 그런데 나는 이제 아무도 안 기다린다."`,
            `"그런데 네가 어머니라고 부르더구나."`,
            `배가 제노바에 닿은 것은 그해 여름이었습니다.`,
            `부두에 아버지와 형이 나와 있었습니다.`,
            `아버지는 마르코가 떠난 뒤로 그 부두에 자주 나왔다고 합니다.`,
            `배가 들어올 때마다 나가 보았다고 합니다.`,
            `형도 함께 나왔습니다.`,
            `가게가 쉬는 날이면 둘이 부두에 앉아 있었습니다.`,
            `그리고 아무 말도 하지 않았습니다.`,
            `배가 들어와도 아는 얼굴이 없으면 그냥 일어나 돌아갔습니다.`,
            `그것을 열 달 동안 했습니다.`,
            `이 이야기는 사실 더 큰 책의 한 부분입니다.`,
            `에드몬도 데 아미치스라는 이탈리아 사람이 쓴 『쿠오레』라는 책입니다.`,
            `초등학교 삼학년 아이의 한 해 일기 형식으로 된 책인데, 그 안에 선생님이 달마다 읽어 주는 짧은 이야기가 아홉 편 들어 있습니다.`,
            `이 이야기는 그 가운데 오월 이야기입니다.`,
            `원래 제목은 「아펜니노에서 안데스까지」입니다.`,
            `이탈리아의 산에서 남아메리카의 산까지라는 뜻입니다.`,
            `그 시절 이탈리아 사람들이 실제로 그렇게 갔습니다.`,
            `천팔백팔십 년부터 오십 년 동안 이탈리아를 떠난 사람이 천삼백만 명이 넘습니다.`,
            `그러니까 이 이야기는 지어낸 이야기이면서, 그 시절 아주 많은 집에서 실제로 있었던 이야기입니다.`,
            `배를 타고 떠난 어머니와 아버지가 그만큼 많았다는 뜻입니다.`
        ]
    }
];
/* ── 쪽 나누기 ─────────────────────────────────────────
