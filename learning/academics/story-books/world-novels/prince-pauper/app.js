...
const CHAPTERS = [
    {
        ...
        paras: [
            ...
            `그러나 두 아이 다 자기가 태어난 날에 무슨 일이 있었는지 몰랐습니다. 톰은 골목에서 자랐습니다.`,
    ...
    },
    {
        ...
        paras: [
            `어느 날 톰은 걷다가 자기도 모르게 아주 멀리까지 갔습니다. 그리고 커다란 문 앞에 이르렀습니다.`,
            `쇠창살 너머로 넓은 마당이 보였습니다. 그 안에 아이가 하나 있었습니다.`,
            `비단옷을 입고 있었고, 허리에 짧은 칼을 차고 있었습니다. 옆에 사람들이 여럿 서서 그 아이가 무엇을 하는지 지켜보고 있었습니다.`,
            `톰은 창살에 얼굴을 대고 그 아이를 보았습니다. 그 순간 병사 하나가 톰의 목덜미를 잡아 길바닥으로 던졌습니다.`,
            `"거지 놈이 어딜."`,
            `사람들이 웃었습니다. 그때 마당 안에서 목소리가 났습니다.`,
            `"어떻게 감히 저 아이에게 그런 짓을 하는가!" 비단옷을 입은 아이가 창살 앞으로 뛰어왔습니다.`,
            `"문을 열어라! 저 아이를 들여보내라!"`,
            `사람들이 모자를 벗고 무릎을 꿇었습니다. 병사도 얼굴이 하얘져 뒤로 물러났습니다.`,
            `그 아이가 웨일스 왕자 에드워드였습니다. 톰은 궁전 안으로 들어갔습니다.`,
            ...
            `"나는 그런 걸 한 번도 해 본 적이 없다." 왕자가 말했습니다.<br>"나는 아침에 일어나서 밤에 잘 때까지 무엇을 할지 다 정해져 있다. 걸음걸이도 정해져 있고 웃는 것도 정해져 있다."`,
            `그러다 두 아이는 문득 서로를 바라보았습니다. 머리 색이 같았고, 눈 색이 같았고, 키가 같았고, 얼굴이 같았습니다.`,
    ...
    },
    {
        ...
        paras: [
            `두 아이는 옷을 바꿔 입고 거울 앞에 나란히 섰습니다. 그리고 둘 다 아무 말도 하지 못했습니다.`,
            `거울 속에는 아까와 똑같은 두 아이가 서 있었습니다. 다만 자리가 바뀌어 있었습니다.`,
            `"이게 어떻게 된 일이냐." 왕자가 말했습니다.<br>"네가 나고 내가 너로구나."`,
            `그때 왕자가 톰의 손등에 난 자국을 보았습니다.`,
            `"이건 뭐냐."<br>"아까 병사가······."<br>"뭐라고?"`,
            `왕자의 얼굴이 붉어졌습니다.<br>"내가 저놈을 그냥 두지 않겠다." 왕자는 옷을 갈아입을 생각도 하지 않고 문을 박차고 나갔습니다.`,
            `마당을 가로질러 문으로 뛰어가며 소리쳤습니다.<br>"문을 열어라! 그리고 저 병사를 잡아 오너라!"`,
            `병사가 그 아이를 붙잡아 길바닥으로 내던졌습니다.<br>"두 번은 못 봐준다, 이 거지 놈아."`,
            `문이 닫혔습니다. 사람들이 몰려들어 그 아이를 놀렸습니다.`,
            `"나는 웨일스 왕자다!" 아이가 소리쳤습니다.<br>"나에게 손을 대는 자는 반역죄로 다스릴 것이다!"`,
            `사람들이 더 크게 웃었습니다. 그날 저녁 궁전에서는 다른 일이 벌어지고 있었습니다. 사람들이 방으로 들어와 비단옷을 입은 아이 앞에 무릎을 꿇었습니다.`,
            `"저는 왕자가 아닙니다." 톰이 말했습니다.<br>"저는 오팔 골목의 톰 캔티입니다. 제발 저를 내보내 주십시오."`,
            `사람들의 얼굴이 굳었습니다. 그 소식이 곧 왕에게 올라갔습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `밤이 되자 비가 왔습니다. 그때 커다란 손이 그의 팔을 붙잡았습니다.`,
            `"이 녀석, 어딜 싸돌아다니다 이제 오느냐. 오늘 얼마 벌었어."`,
            `존 캔티였습니다. 톰의 아버지가 아들인 줄 알고 붙잡은 것입니다.`,
            `"나는 당신 아들이 아니다." 에드워드가 말했습니다.<br>"나는 웨일스 왕자다. 손을 놓아라."`,
            `존 캔티는 몽둥이를 들었습니다.`,
            ...
            `캔티 집안은 그길로 런던을 떠나야 했습니다. 그 소동 틈에 에드워드는 달아났습니다.`,
    ...
    },
    {
        ...
        paras: [
            `에드워드는 길드홀 근처에서 다시 사람들에게 둘러싸였습니다. 누군가 그를 밀치고 누군가 옷자락을 잡아당겼습니다.`,
            ...
            `헨든은 그 아이를 여관으로 데려갔습니다. 그리고 밥을 시켜 주었습니다.`,
            `아이가 자리에 앉으며 말했습니다.<br>"너는 내 목숨을 구했다. 소원을 하나 말해 보아라."`,
            `헨든은 웃음이 나오려는 것을 참았습니다. 이 아이가 머리가 좀 상했다고 생각한 것입니다. 그래서 맞춰 주기로 했습니다.`,
            `"그러면······ 저와 제 자손이 왕 앞에서 앉을 수 있게 해 주십시오." 그것은 영국에서 아주 오래된 특권이었습니다.`,
            `"그리하라." 아이가 말했습니다.<br>"일어나 앉아라, 켄트의 마일스 헨든 경."`,
            `헨든은 무릎을 꿇었다가 일어나 앉았습니다. 속으로는 웃으면서요.`,
            `그날 밤 헨든은 그 아이가 잠든 것을 보았습니다.`,
            `아이는 자리에 눕자마자 잠들었습니다. 며칠 동안 제대로 자지 못한 것이 분명했습니다.`,
            `헨든은 담요를 덮어 주며 생각했습니다. 이 아이가 누구든 나는 이 아이를 돌봐야겠다고요. 그런데 밤중에 심부름꾼이 와서, 다리 아래에 젊은이 하나가 기다린다며 아이를 데려갔습니다.`,
            `헨든이 돌아왔을 때 방은 비어 있었습니다. 그 심부름꾼은 존 캔티의 사람이었습니다.`
        ]
    },
    {
        num: 6,
        ...
        paras: [
            ...
            `그러다 어느 날 밤, 궁전에 종이 울렸습니다. 헨리 팔세가 세상을 떠난 것이었습니다.`,
            `그날 밤 사람들이 톰 앞에 무릎을 꿇고 이렇게 불렀습니다.<br>"국왕 폐하."`,
            `톰은 그 말을 듣고 온몸이 떨렸습니다. 그러나 곧 한 가지를 알아차렸습니다. 자기가 말하면 사람들이 그대로 한다는 것이었습니다.`,
            ...
            `그자에게 내려진 벌은 끓는 물에 넣는 것이었습니다. 톰이 자리에서 일어섰습니다.`,
            `"그 벌을 없애라." 톰이 말했습니다.<br>"그런 벌은 이 나라에 다시 없게 하라."`,
            `사람들이 술렁였습니다.`,
            ...
            `아무 일도 일어나지 않았습니다.`,
            `"폭풍이 어디 있는가." 톰이 말했습니다.<br>"이 사람들을 놓아주라."`,
    ...
    },
    {
        ...
        paras: [
            ...
            `존 캔티는 이름을 바꾸고 그 무리에 들어갔습니다. 그날 밤 에드워드는 그 사람들 이야기를 들었습니다.`,
            `무리 가운데 요크셔에서 온 사람이 하나 있었습니다. 그는 자기 이야기를 했습니다.`,
            `"나는 원래 농사꾼이었소. 땅을 부치고 아내와 아이들과 살았지." 그가 말했습니다.<br>"그런데 흉년이 들어 굶게 되었고, 아내가 아파서 구걸을 나갔소. 그러다 붙잡혔소."`,
            ...
            `그때 요크셔 사람이 막아섰습니다.<br>"이 아이는 건드리지 마시오." 그 사람의 도움으로 에드워드는 그 밤에 달아났습니다.`,
            `요크셔 사람은 아무 말 없이 헛간 뒤쪽 널빤지를 들어 주었습니다. 그러고는 이렇게만 말했습니다.<br>"가시오, 꼬마 왕자님."`,
            `달아나면서 에드워드는 이렇게 생각했습니다. 나는 지금까지 이 나라를 궁전 창문으로만 보았구나.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `그때 헨든이 그를 찾아냈습니다. 헨든은 그동안 온 나라를 뒤지고 다닌 참이었습니다.`,
            ...
            `"너는 왜 나를 계속 찾았느냐." 에드워드가 물었습니다.<br>"모르겠습니다." 헨든이 말했습니다.<br>"그냥 그래야 할 것 같았습니다."`,
            `그들은 켄트로 갔습니다. 헨든의 고향이었습니다.`,
            `헨든 홀은 큰 집이었습니다.`,
            `"저 집에서 내 아버지가 나를 기다리실 겁니다." 헨든이 말했습니다.<br>"그리고 이디스라는 사람이 있습니다. 제가 떠날 때 혼인을 약속했지요."`,
            `그런데 문을 열고 들어가자 낯선 사람이 앉아 있었습니다. 동생 휴였습니다.`,
            `"형님?" 휴가 말했습니다.<br>"우리 형님은 칠 년 전에 전쟁에서 죽었소. 당신은 누구요."`,
    ...
    },
    {
        ...
        paras: [
            ...
            `에드워드는 그 두 사람과 며칠을 함께 지냈습니다. 그런데 어느 날 아침 간수가 와서 두 사람을 데려갔습니다.`,
            `"어디로 데려가는가?"<br>"오늘이 그날이오."`,
            `그날 마당에서 그 두 사람이 죽었습니다. 남들과 다른 방식으로 기도했다는 것이 죄였습니다.`,
            `그 두 사람의 딸들이 마당에서 그것을 보았습니다. 에드워드는 창살을 잡고 그것을 보았습니다.`,
            `그 뒤로 그는 오랫동안 말을 하지 않았습니다. 헨든은 그가 무슨 생각을 하는지 알 수 없었습니다.`,
            `며칠 뒤, 에드워드가 헨든에게 말했습니다.`,
            `"헨든."<br>"네."<br>"나는 지금까지 왕이 무엇을 하는 사람인지 몰랐다."`,
            `"이 나라에는 잘못된 법이 아주 많다. 그런데 그 법을 만든 사람들은 그 법에 걸릴 일이 없는 사람들이다."`,
            `헨든은 그 말을 듣고 처음으로 이 아이를 다시 보았습니다. 그날부터 헨든은 이 아이가 정말로 왕자일지도 모른다고 생각하기 시작했습니다.`,
            `헨든은 매를 맞는 벌을 받게 되었습니다. 휴가 그렇게 만들었습니다.`,
            `형벌이 집행되던 날, 에드워드가 앞으로 뛰어나갔습니다.`,
            `"저 사람을 때리지 마라! 내가 대신 맞겠다!"`,
            `사람들이 그 아이를 붙잡아 끌어냈습니다. 헨든은 그 광경을 보며 매를 맞았습니다.`,
    ...
    },
    {
        ...
        paras: [
            `두 사람이 풀려난 것은 대관식을 며칠 앞둔 때였습니다. 런던은 온통 잔치 준비로 시끄러웠습니다.`,
            ...
            `그런데 마음 한구석이 늘 무거웠습니다. 며칠 전, 사람들 틈에서 어머니를 보았기 때문입니다.`,
            `어머니가 사람들을 헤치고 나와 그의 손을 잡으려 했습니다. 병사들이 어머니를 밀쳐 냈습니다.`,
            `그때 톰은 이렇게 말했습니다.<br>"나는 저 여인을 모른다."`,
            `그 말을 하고 나서 톰은 그날 하루 종일 아무것도 먹지 못했습니다. 대관식이 시작되었습니다.`,
            `사원 안이 사람으로 가득 찼습니다. 노랫소리가 울렸습니다.`,
            `캔터베리 대주교가 왕관을 들었습니다. 그것을 톰의 머리 위로 가져가는 순간이었습니다. 사원 안쪽에서 목소리가 났습니다.`,
            `"그 왕관을 그 아이의 머리에 씌우는 것을 금한다! 나는 잉글랜드의 왕이다!"`,
            `사람들이 돌아보았습니다. 누더기를 걸친 아이 하나가 통로를 걸어오고 있었습니다. 병사들이 그 아이를 붙잡으려 했습니다.`,
            `그때 톰 캔티가 자리에서 일어섰습니다.`,
            `"그 손을 놓아라!" 톰이 소리쳤습니다.<br>"저분이 왕이시다!"`,
            `사원 안이 조용해졌습니다. 톰은 계단을 내려가 그 아이 앞에 무릎을 꿇었습니다.`,
            `"폐하."`,
    ...
    },
    {
        ...
        paras: [
            `그러나 그것으로 끝난 것은 아니었습니다. 두 아이가 똑같이 생겼기 때문에, 누가 진짜인지 아무도 알 수 없었습니다. 호민관 서머싯 공작이 앞으로 나섰습니다.`,
            ...
            `왕이 세상을 떠난 뒤 그 옥새가 사라져 몇 주째 찾지 못하고 있었습니다. 에드워드는 눈을 감고 생각했습니다.`,
            `그러다 이렇게 말했습니다.<br>"내 방의 벽에 그림이 걸려 있다. 그 그림 뒤에 팔뚝이 들어갈 만한 구멍이 있다. 그 안에 있다."`,
            `사람들이 뛰어갔습니다. 그런데 한참 뒤에 돌아와 고개를 저었습니다.`,
            `"없습니다."`,
            `사원 안이 술렁였습니다. 에드워드의 얼굴이 하얘졌습니다.`,
            ...
            `에드워드가 눈을 크게 떴습니다.`,
            `"그렇다. 그러고는······."`,
            `"제가 그것을 찾아오겠습니다." 톰이 말했습니다.<br>"그날 폐하께서는 그것을 아무 데나 놓으셨습니다. 그리고 저는 그것을 여러 날 동안 호두 까는 데 썼습니다."`,
    ...
    },
    {
        ...
        paras: [
            `며칠 뒤, 왕궁에서 큰 자리가 열렸습니다. 그 자리에 마일스 헨든이 불려 왔습니다.`,
            `헨든은 낡은 옷차림 그대로였습니다. 옷을 새로 살 돈이 없었기 때문입니다.`,
            `화려한 방에 들어서자 다들 그를 쳐다보았습니다. 헨든은 자기가 무슨 일로 불려 왔는지 몰랐습니다. 그런데 방 안을 둘러보다가 빈 의자를 하나 보았습니다.`,
            `헨든은 그 의자로 걸어가 털썩 주저앉았습니다. 방 안이 얼어붙었습니다. 왕 앞에서 앉는 것은 있을 수 없는 일이었습니다.`,
            `사람들이 달려들어 그를 끌어내려 했습니다. 그때 왕좌에서 목소리가 났습니다.`,
            `"그를 두어라."`,
            `헨든이 고개를 들었습니다. 왕좌에 앉은 아이를 보고 그는 벌떡 일어섰습니다.`,
            `며칠 동안 함께 길을 걷던 그 아이였습니다.`,
            `"그는 앉을 권리가 있다." 왕이 말했습니다.<br>"내가 그 권리를 주었다. 그리고 나는 약속을 지킨다."`,
    ...
    },
    {
        ...
        paras: [
            `왕은 톰 캔티를 불렀습니다.<br>"너는 몇 주 동안 이 나라를 다스렸다." 왕이 말했습니다.<br>"네가 무엇을 했는지 다 들었다."<br>"저는 아무것도 모르고 한 것입니다."<br>"끓는 물의 형벌을 없앤 것도 아무것도 모르고 한 것이냐."`,
            `톰은 대답하지 못했습니다.`,
            `"양말을 벗게 한 것도 아무것도 모르고 한 것이냐."<br>"그건······ 그 사람들이 딱해서요."<br>"그것이 아는 것이다." 왕이 말했습니다.`,
            ...
            `"그리고 한 가지 더." 왕이 말했습니다.<br>"네 어머니를 모셔 오너라. 그분과 네 누이들이 살 곳을 마련해 주겠다."`,
            `톰은 그 자리에서 울었습니다.`,
            `몇 주 동안 왕 노릇을 하면서 그는 한 번도 울지 않았습니다. 그날 처음 울었습니다.`,
            `며칠 뒤 톰은 어머니를 만났습니다.`,
            `어머니는 아들을 알아보지 못할 뻔했습니다. 옷이 너무 좋았기 때문입니다.`,
            `"어머니." 톰이 말했습니다.<br>"그때 제가 모른다고 했지요."`,
            ...
            `사람들은 길에서 그 옷을 입은 노인을 보면 길을 비켰습니다. 그가 몇 주 동안 왕이었던 아이라는 것을 다들 알았기 때문입니다.`
        ]
    },
    {
        num: 14,
        ...
        paras: [
            ...
            `누가 그에게 어떤 벌을 내리자고 하면, 그는 이렇게 물었습니다.<br>"그 사람이 무엇을 했는가. 그리고 그 사람은 왜 그렇게 되었는가."`,
            ...
            `신하들은 왕이 그런 것을 어떻게 아는지 이상하게 여겼습니다. 가끔 왕이 너무 무르다고 말하는 사람도 있었습니다.`,
            ...
            `다만 그것이 무슨 뜻인지 아는 사람이 셋 있었습니다. 헨든 백작과 톰 캔티, 그리고 왕 자신이었습니다. 에드워드가 세상을 떠난 뒤, 사람들은 그를 자비로운 왕이었다고 기록했습니다.`,
    ...
    },
    {
        ...
        paras: [
            `여러 해가 지난 뒤의 일입니다. 머리가 하얗게 센 톰 캔티가 강가를 걷고 있었습니다.`,
            ...
            `톰은 그 아이 곁에 섰습니다.`,
            `"저 안이 궁금하냐?"<br>"네."`,
            `"저 안에도 사람이 산단다." 톰이 말했습니다.<br>"그리고 저 안에서 밖을 내다보는 사람도 있지."`,
            ...
            `톰은 웃었습니다.`,
            `"글쎄다." 그가 말했습니다.<br>"다만 이건 알아 두렴. 창살 이쪽에 서 있느냐 저쪽에 서 있느냐는, 그 사람이 어떤 사람인가와는 아무 상관이 없단다."`,
            `아이는 그 말을 잘 알아듣지 못한 얼굴이었습니다.<br>"언젠가 알게 될 거다."`,
            `톰은 지팡이를 짚고 다시 걷기 시작했습니다. 아이는 한참 동안 그 뒷모습을 보다가, 다시 창살에 얼굴을 대고 안을 들여다보았습니다.`
        ]
    }
];
/* ── 쪽 나누기 ─────────────────────────────────────────
