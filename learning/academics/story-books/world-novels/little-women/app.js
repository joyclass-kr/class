...
const CHAPTERS = [
    {
        ...
        paras: [
            ...
            `집에는 하녀 한 사람만 남았습니다.`,
            `군목은 군대에서 목사 노릇을 하는 사람입니다. 총을 들지 않고 다친 사람을 돌봅니다.`,
            `네 자매는 이렇게 생겼습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `독일에서 온 사람이라 말이 잘 통하지 않았습니다.`,
            `자매들은 불을 지피고 아이들에게 옷을 입히고 밥을 먹였습니다. 그러고는 자기들은 빈손으로 돌아왔습니다.`,
            `돌아오는 길에 아무도 배고프다는 말을 하지 않았습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `로리는 그 말을 하고 커튼 밖을 보았습니다.`,
            `할아버지가 그 자리에 와 있었습니다.`,
            `그날 밤 돌아가는 길에 메그가 발목을 삐었습니다. 하이힐을 신은 탓이었습니다.`,
            `메그는 그 신발을 그날 처음 신었습니다.`,
            `로리가 자기 집 마차를 내주었습니다.`,
            `메그는 그 마차를 타고 돌아왔습니다.`,
            ...
            `하인들도 발소리를 내지 않고 다녔습니다.`,
            `조는 그 집에 들어서자마자 숨이 막혔습니다.`,
            `조는 방을 정리해 주고 이야기를 해 주고 창문을 열어 주었습니다.`,
            `로리는 그것을 가만히 보고 있었습니다.`,
            `그 방에 그렇게 들어온 사람이 없었습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `어머니는 그렇게 말했습니다.`,
            `메그는 그 말을 알아들었지만 곧 다시 잊었습니다.`,
            `조는 마치 대고모 댁에 다녔습니다. 부자였지만 성질이 사나운 노부인이었습니다. 하루 종일 책을 읽어 드리고 잔소리를 들어야 했습니다.`,
            `아랫사람에게 특히 그랬습니다.`,
            `대고모는 조가 하는 것마다 못마땅해했습니다.`,
            `앉는 자세부터 나무랐습니다.`,
            `다만 그 집에는 커다란 서재가 있었습니다. 조는 노부인이 낮잠을 자는 동안 그 서재에서 책을 읽었습니다.`,
            `먼지 쌓인 책장 사이에 앉아 사과를 먹으며 책을 읽는 그 시간이 조에게는 하루 중 가장 좋은 때였습니다.`,
            `그 서재에 오래된 책이 아주 많았습니다.`,
            `조는 그 책을 한 권씩 다 읽어 나갔습니다.`,
            `베스는 집에서 살림을 도왔습니다. 학교는 부끄러워서 다니지 못했습니다.`,
            `사람이 많은 데를 견디지 못했습니다.`,
            `아침에 제일 먼저 일어났습니다.`,
            `난로에 불을 지피는 것이 베스 몫이었습니다.`,
            `대신 낡은 피아노를 쳤습니다. 건반 몇 개는 소리가 나지 않았지만 베스는 개의치 않았습니다.`,
            `소리 나는 건반만으로도 칠 수 있었습니다.`,
            `안 나는 자리는 손을 건너뛰었습니다.`,
            `베스는 그 피아노에게도 이름을 붙여 주었고, 낡은 인형들을 버리지 않고 하나하나 고쳐 두었습니다. 남들이 버린 인형만 골라 데려왔기 때문입니다.`,
            `팔이 없는 인형에게 팔을 만들어 달아 주었습니다.`,
            `여섯이나 되었습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `손이 떨렸습니다.`,
            `"고맙습니다." 베스가 말했습니다.`,
            `그러고는 얼굴이 새빨개져 도망쳤습니다.`,
            `로렌스 씨는 문간에 서서 그 뒷모습을 보았습니다.`,
            `그러고는 한참 동안 그 자리에 있었습니다. 그의 딸이 어릴 때 그 피아노를 쳤습니다.`,
            `그 딸은 세상을 떠났고, 로리가 그 딸의 아들이었습니다.`,
            `베스는 몇 주 동안 슬리퍼를 하나 만들었습니다. 밤늦게까지 수를 놓아 만든 것이었습니다.`,
            `보라색 팬지꽃을 놓았습니다.`,
            `그리고 그것을 로렌스 씨의 서재에 놓고 왔습니다.`,
            `이튿날 오후, 커다란 짐이 왔습니다.`,
            `사람 넷이 들고 왔습니다.`,
            ...
            `평생 부끄럼을 타던 아이가 그날은 달랐습니다.`,
            `자매들이 말릴 새도 없이 베스는 옆집으로 달려갔습니다. 서재 문을 열고 들어가, 놀라서 돌아보는 노인의 목을 끌어안았습니다.`,
            `노인은 한참 아무 말도 하지 못했습니다.`,
            `그날부터 로렌스 씨는 그 집에서 베스를 가장 아꼈습니다.`,
            `다른 자매들에게도 잘해 주었지만 베스는 달랐습니다.`,
            `두 사람은 말을 많이 하지 않았습니다. 베스가 피아노를 치는 동안 노인이 문 밖 의자에 앉아 있는 것이 전부였습니다. 그것으로 충분했습니다.`,
            `둘 다 말이 많은 사람이 아니었습니다.`
        ]
    },
    {
        num: 7,
        ...
        paras: [
            ...
            `대고모에게 부탁하는 것은 어머니도 싫어하는 일이었습니다.`,
            `조가 말없이 밖으로 나갔습니다.`,
            `아무에게도 어디 간다고 하지 않았습니다.`,
            ...
            `"내일 갈게." 조가 말했습니다.`,
            `그러나 그날 조는 원고를 쓰느라 잊었습니다.`,
            `다음 날도 잊었습니다.`,
            `메그도 잊었습니다. 에이미는 무섭다고 했습니다.`,
            `병이 옮을까 봐 그런 것이었습니다.`,
            `베스는 아무도 나무라지 않았습니다.`,
            `다만 숄을 두르고 혼자 나갔습니다. 그것이 베스가 늘 하던 방식이었습니다.`,
            `부탁도 하지 않고 나무라지도 않았습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `의사가 손목을 짚어 보았습니다.`,
            `의사가 말했습니다.<br>"넘겼습니다."`,
            `조는 그 말을 듣고 아무 대답도 하지 못했습니다.`,
            `그리고 부엌으로 내려가 아무도 없는 데서 한참을 서 있었습니다.`,
            `다리에 힘이 없었습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `그 웃음소리를 다들 오래 기다렸습니다.`,
            `그날 오후, 마차 소리가 났습니다.`,
            `창가로 다 몰려갔습니다.`,
            `문이 열리고 브룩 씨가 들어왔습니다.`,
            `그리고 그 뒤에서 마치 씨가 들어왔습니다.`,
            ...
            `브룩 씨는 가진 것이 없었습니다. 그래서 삼 년 동안 집을 마련하기로 한 것입니다.`,
            `그동안 브룩 씨는 군에도 다녀왔습니다.`,
            `마치 대고모는 그 혼사를 반대하며 재산을 한 푼도 주지 않겠다고 했습니다. 메그는 그래도 좋다고 했습니다.`,
            `그 말을 대고모 앞에서 했습니다.`
        ]
    },
    {
        ...
        paras: [
            ...
            `삼 년 사이에 다들 자랐습니다.`,
            `조는 그동안 이야기를 써서 신문에 팔기 시작했습니다.`,
            `처음 원고료를 받은 날, 조는 그 돈으로 베스와 어머니를 바닷가에 보냈습니다.`,
            `자기 것은 아무것도 사지 않았습니다.`,
            `베스는 몸이 예전 같지 않았습니다. 성홍열을 앓은 뒤로 쉽게 지쳤습니다.`,
            `의사는 그것이 나을 것이라고 했습니다. 낫지 않았습니다.`,
            `계단을 오르면 한참을 앉아 있어야 했습니다.`,
            `에이미는 그림을 배우고 있었습니다.`,
            `마치 대고모가 에이미를 마음에 들어 해서, 여러 곳에 데리고 다녔습니다.`,
            `에이미는 그 집에서 예절을 배웠습니다.`,
            `에이미는 그동안 많이 달라졌습니다. 예쁜 것을 여전히 좋아했지만, 이제는 그것 때문에 남을 부러워하지는 않았습니다.`,
            `가지지 못한 것을 셈하지 않게 된 것입니다.`,
            `유월의 어느 날 아침, 메그의 결혼식이 있었습니다.`,
            `화려한 결혼식이 아니었습니다. 메그는 자기가 지은 흰 옷을 입었고, 조와 베스와 에이미가 들러리를 섰습니다.`,
            `손님도 몇 사람뿐이었습니다.`,
            `로리가 마당에 꽃을 엮어 아치를 만들었습니다.`,
            `밤새 만든 것이었습니다.`,
            ...
            `조는 그 말을 하고 창밖을 보았습니다.`,
            `로리가 창턱에 걸터앉았습니다.`,
            `"조." 그가 말했습니다.<br>"우리는 안 변할 거야. 나는 어디에도 안 가."`,
            `로리는 그 말을 아주 진지하게 했습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `로리는 그 말을 오래 준비했습니다.`,
            `유럽에서 돌아오는 길에도 그 생각을 했습니다.`,
            `조는 오래 아무 말도 하지 못했습니다.`,
            `무슨 말을 해도 로리가 아플 것이기 때문입니다.`,
            `조는 로리를 정말로 아꼈습니다.`,
            ...
            `조는 그것을 여러 번 생각해 두었습니다.`,
            `조는 그 말을 하면서 자기 마음을 처음으로 똑바로 보았습니다.`,
            `그동안은 보지 않으려고 했습니다.`,
            ...
            `그 말이 그날 조가 한 말 가운데 제일 어려운 말이었습니다.`,
            ...
            `집을 떠나 본 것은 처음이었습니다.`,
            `아이들을 가르치고 남는 시간에 글을 썼습니다.`,
            `그 하숙집에 베어라는 독일 사람이 살고 있었습니다. 마흔 살쯤 되었고, 옷차림이 허름했고, 손이 컸습니다.`,
            `말투가 서툴렀습니다. 독일에서 온 지 얼마 되지 않았기 때문입니다.`,
            `가난한 아이들을 무료로 가르치고 있었습니다.`,
            `자기도 가난했습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `창가에 앉아 손이 떨릴 때까지 했습니다.`,
            `"내가 할 수 있는 게 이것뿐이야." 베스가 말했습니다.`,
            `그것으로 충분했습니다.`,
            `봄이 오기 전 어느 새벽, 베스는 조용히 갔습니다. 조가 손을 잡고 있었습니다.`,
            `아주 조용했습니다.`,
            ...
            `조는 그 말을 듣고 오래 앉아 있었습니다.`,
            `조는 여러 달 동안 한 줄도 쓰지 못했습니다.`
        ]
    },
    {
        num: 13,
        ...
        paras: [
            ...
            `팔릴 글이 아니라고 여겼기 때문입니다.`,
            `그런데 그 이야기는 실렸고, 사람들이 편지를 보내오기 시작했습니다.`,
            `처음에는 몇 통이었는데 곧 아주 많아졌습니다.`,
            ...
            `팔리는 글이 아니라 자기가 아는 것을 쓰는 것이었습니다.`,
            ...
            `그러고는 짐을 쌌습니다.`,
            `그날부터 로리는 할아버지의 일을 배우기 시작했습니다.`,
            `음악은 취미로 남겨 두기로 했습니다. 자기가 그렇게 뛰어난 음악가는 못 된다는 것을 스스로 알아차린 것입니다.`,
            `에이미와 같은 것을 배운 셈이었습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `해마다 그 자리였습니다.`,
            `메그의 아이들이 가장 어렸고,`,
            `학교 아이들이 그 아이들을 목말 태우고 다녔습니다. 에이미는 그 광경을 그렸습니다.`,
            `해마다 한 장씩 그려 두었습니다.`,
            `어느 해 그 자리에서 어머니가 말했습니다.<br>"오늘보다 좋은 날은 없을 것 같구나."`,
            `아버지도 고개를 끄덕였습니다.`,
            `조는 사과나무에 기대어 마당을 보았습니다.`,
            `아이들이 뛰어다니고 있었습니다.`,
            `열다섯 살에 조는 이 세상 어딘가로 나가 큰 사람이 되겠다고 생각했습니다.`,
            `이름난 작가가 되어 혼자 살 생각이었습니다.`,
            `그때 조가 그린 자기 모습은 이런 것이 아니었습니다.`,
            `그러나 조는 지금이 더 좋았습니다.`,
            `다락방에서 혼자 쓰던 아이가 마당 가득한 아이들 사이에 서 있었습니다.`,
            `그것이 조가 얻은 것이었습니다.`,
