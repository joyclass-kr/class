...
const CHAPTERS = [
    {
        ...
        paras: [
            ...
            `"우리 잘 지내자." 메그가 말했습니다. "아버지가 돌아오셨을 때 부끄럽지 않게."`
        ]
    },
    {
        num: 2,
        ...
        paras: [
            ...
            `그런데 어머니가 들어오면서 말했습니다.`,
            `"얘들아, 한 가지 부탁이 있단다. 저 아래 후멜 아주머니 댁에 갓난아기가 있는데, 여섯 아이가 한 침대에 누워 있더구나. 불도 없고 먹을 것도 없단다. 우리 아침을 그 집에 가져다주면 어떻겠니?"`,
            `잠깐 아무도 말을 하지 못했습니다. 다들 배가 몹시 고픈 참이었습니다.`,
            `"가져가요." 조가 먼저 일어섰습니다. "제가 들게요."`,
            ...
            `"저 집 아이는 왜 밖에 안 나올까." 조가 말했습니다. "저 집 창가에서 우리 집을 보고 있는 걸 몇 번이나 봤는데."`,
    ...
    },
    {
        ...
        paras: [
            ...
            `"등을 벽에 붙이고 있으면 돼." 메그가 말했습니다. "그리고 제발 손을 뒤로 하고 있지 마. 그리고 휘파람 불지 마. 그리고 팔짝팔짝 뛰지 마."`,
            `"알았어, 알았어."`,
    ...
    },
    {
        ...
        paras: [
            ...
            `"부러워하는 게 나쁜 건 아니란다." 어머니가 말했습니다. "다만 부러움이 커지면 네가 가진 걸 못 보게 되지."`,
            ...
            `"그런 학교에는 안 보내겠다." 어머니가 말했습니다. "다만 에이미, 너도 배울 것이 있다. 남들이 가진 것을 부러워하는 마음 말이다."`,
            `그해 봄, 네 자매는 어머니에게 한 가지를 배웠습니다.`,
            `일주일 동안 아무 일도 하지 말고 놀아 보라는 것이었습니다.`,
            `첫날은 좋았습니다. 사흘째부터는 지루해졌습니다. 엿새째 되던 날 부엌에 먹을 것이 없었고, 베스의 카나리아가 물을 못 먹어 죽었습니다.`,
            `일곱째 날 저녁, 자매들은 아무 말도 하지 못했습니다.`,
            `"일이 없으면 좋을 것 같지." 어머니가 말했습니다. "그런데 사람은 할 일이 있어야 마음이 편하단다. 놀이도 일이 있어야 재미있는 거고."`,
    ...
    },
    {
        ...
        paras: [
            ...
            `조가 돌아보았을 때 에이미는 이미 물속에 있었습니다.`,
            `로리가 달려와 두 사람이 함께 에이미를 끌어냈습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `그런데 그 집에는 훌륭한 피아노가 있었습니다.`,
            `어느 날 로렌스 씨가 자매들의 집에 들렀다가, 어머니에게 들으라는 듯이 큰 소리로 말했습니다.`,
            `"우리 집 피아노가 요즘 소리가 죽습니다. 아무도 안 치니까요. 누가 와서 좀 쳐 주면 좋겠는데. 아무 때나 와서 치기만 하고 가면 됩니다. 인사도 필요 없고 말 붙일 것도 없고요."`,
            ...
            `다만 피아노 위에 새 악보가 자꾸 놓였습니다.`,
            `베스는 여러 주 만에 처음으로 그 집 문을 두드렸습니다.`,
            ...
            `베스는 그 자리에서 자기가 무엇을 해야 하는지 알았습니다.`,
            `자매들이 말릴 새도 없이 베스는 옆집으로 달려갔습니다.`,
            `서재 문을 열고 들어가, 놀라서 돌아보는 노인의 목을 끌어안았습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `"돈이 있어야 하는데." 어머니가 말했습니다. "마치 대고모께 가서 부탁드려야겠구나."`,
            `조가 말없이 밖으로 나갔습니다.`,
            `저녁에 조가 돌아와 어머니 앞에 지폐 뭉치를 내놓았습니다. 이십오 달러였습니다.`,
            `"이게 어디서 났니?"`,
            `조는 모자를 벗었습니다.`,
            `자매들이 비명을 질렀습니다. 조의 긴 밤색 머리가 없어져 있었습니다. 목덜미 위로 짧게 잘려 있었습니다.`,
            `"조! 네 머리!"<br>"팔았어." 조가 말했습니다. "괜찮아. 다시 자랄 거야."`,
            `"조지핀······." 어머니가 말했습니다.`,
            `"아버지를 위한 일인데요." 조가 씩씩하게 말했습니다. "그리고 저는 원래 이 머리가 무거웠어요."`,
            `그날 밤 메그가 잠에서 깨어 보니 조가 이불 속에서 울고 있었습니다.`,
            `"조, 머리 때문에 그러니?"<br>"아니야." 조가 말했습니다. "······응, 조금은."`,
    ...
    },
    {
        ...
        paras: [
            ...
            `"베스, 왜 그래?"<br>"그 집 아기가 오늘 아침에 갔어." 베스가 말했습니다. "제 무릎 위에서."`,
    ...
    },
    {
        ...
        paras: [
            ...
            `"조는······." 아버지가 웃었습니다. "머리가 짧아졌구나. 그런데 그것보다, 조가 아주 조용해졌구나. 목소리가 낮아지고 앉는 자세가 달라졌어. 나는 우리 아들 같던 조가 조금 그립기도 하다만, 이 조가 더 자랑스럽다."`,
            ...
            `그날 저녁 식탁에는 오랜만에 모두가 모였습니다.`,
            `저녁을 먹고 나서 브룩 씨가 메그에게 무언가를 말했습니다.`,
            `조는 그 뒤로 며칠 동안 기분이 좋지 않았습니다.`,
            `"메그가 결혼하면 우리 집이 부서지는 거야." 조가 어머니에게 말했습니다.<br>"부서지는 게 아니라 늘어나는 거란다."`,
            `"저는 언니가 그냥 우리랑 있으면 좋겠어요."<br>"조." 어머니가 말했습니다. "사람은 자기 길을 가야 한단다. 그것이 네 길과 다르더라도 말이야."`,
    ...
    },
    {
        ...
        paras: [
            `삼 년이 지났습니다.`,
            `메그는 스무 살이 되었고, 조는 열아홉, 베스는 열일곱, 에이미는 열여섯이 되었습니다.`,
            ...
            `자매들이 돌아온 뒤, 조는 다락방으로 올라갔습니다.`,
            `그리고 창가에 앉아 오래 있었습니다.`,
            `로리가 올라왔습니다.`,
            `"조, 왜 여기 있어?"<br>"아무것도 아니야."`,
            `"섭섭하지."<br>"응." 조가 말했습니다. "우리 넷은 언제까지나 넷일 줄 알았거든."`,
            `로리가 창턱에 걸터앉았습니다.`,
            `"조." 그가 말했습니다. "우리는 안 변할 거야. 나는 어디에도 안 가."`,
    ...
    },
    {
        ...
        paras: [
            ...
            `낙엽이 쌓인 언덕에서 로리가 말했습니다.`,
            `"조, 너도 알잖아. 나는 열다섯 살 때부터 너를 좋아했어."`,
            `조는 오래 아무 말도 하지 못했습니다.`,
            `"로리." 마침내 조가 말했습니다. "나는 너를 아주 좋아해. 세상 누구보다 좋아해. 그런데 그건 그 좋아함이 아니야."`,
            `"왜 안 되는데."`,
            `"우리는 둘 다 성질이 급해. 너도 나도 하고 싶은 말은 다 하고. 그렇게 사는 두 사람이 한집에 있으면 서로를 못 견딜 거야." 조가 말했습니다. "그리고 나는 결혼이 나에게 맞는지 아직 모르겠어. 나는 글을 쓰고 싶어."`,
            `"나는 기다릴 수 있어."<br>"기다려도 안 바뀔 거야. 그건 너한테 더 못할 짓이야."`,
            `로리는 발로 낙엽을 찼습니다.`,
            `"그럼 나는 어떡해."<br>"너는 나보다 훨씬 좋은 사람을 만날 거야." 조가 말했습니다. "그게 나는 아니야."`,
            `로리는 그날 저녁 집을 떠나 할아버지와 함께 유럽으로 갔습니다.`,
            `조는 그 뒤로 며칠 동안 아무것도 쓰지 못했습니다.`,
            `로리가 떠난 뒤 조는 그 언덕에 몇 번 올라갔습니다. 그리고 자기가 옳은 말을 했는데도 왜 이렇게 마음이 안 좋은지 생각했습니다.`,
            `"어머니, 제가 잘못한 걸까요?"<br>"아니다." 어머니가 말했습니다. "좋아하지 않는 마음으로 그러겠다고 하는 것이 훨씬 나쁜 일이야."`,
            ...
            `그는 조가 쓴 글을 읽고 이렇게 말했습니다.`,
            `"이건 잘 팔리는 글이오. 그런데 이건 당신이 정말 쓰고 싶은 글이오?"`,
            `조는 화가 나서 사흘 동안 말을 하지 않았습니다.`,
            `그러다 자기가 쓴 것을 다시 읽어 보고, 그것을 난로에 넣었습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `"조 언니." 베스가 말했습니다. "언니는 알고 있지?"`,
            `조는 대답하지 못했습니다.`,
            `"나는 오래전부터 알고 있었어." 베스가 말했습니다. "그러니까 이제 그만 아닌 척해도 돼."`,
            `"베스."`,
            `"나는 무섭지 않아." 베스가 말했습니다. "언니들은 다 어딘가로 가잖아. 메그 언니는 결혼했고, 언니는 글을 쓰고, 에이미는 그림을 그리고. 나는 갈 데가 없었어. 나는 원래 집에 있는 사람이었으니까."`,
            `"그런 말 하지 마."`,
            `"나는 슬프지 않아. 다만 언니들을 두고 가는 게 걸려." 베스가 말했습니다. "언니가 제일 걱정돼. 언니는 나를 제일 아꼈으니까."`,
            `조는 모래에 얼굴을 묻었습니다.`,
            `그해 겨울 베스는 자기 방에서 지냈습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `한편 에이미는 유럽에 있었습니다.`,
            `에이미는 그곳에서 그림을 배우다가 자기가 아주 뛰어난 화가는 되지 못하리라는 것을 알게 되었습니다.`,
            ...
            `베스가 세상을 떠났다는 소식이 왔을 때, 두 사람은 함께 그 소식을 들었습니다.`,
            `그해 가을 두 사람은 결혼해서 돌아왔습니다.`,
            `조는 그 소식을 듣고 놀랐습니다. 그러나 곧 웃었습니다.`,
            `"로리한테는 에이미가 훨씬 나아." 조가 말했습니다. "나는 로리를 이겨 먹으려고만 했을 텐데."`
        ]
    },
    {
        num: 14,
        ...
        paras: [
            `그해 십일월, 조는 이상하게 마음이 허전했습니다.`,
            `메그는 남편과 아이들이 있었고, 에이미는 로리와 함께였고, 베스는 없었습니다.`,
            `조는 다락방에서 혼자 글을 썼습니다.`,
            ...
            `어느 날 저녁, 베어 교수가 이제 서쪽으로 떠나야 한다고 말했습니다.`,
            `조는 그날 밤 잠을 못 잤습니다.`,
            `이튿날 조는 우산도 없이 밖으로 나갔습니다. 비가 오는 날이었습니다.`,
            `거리에서 조는 그를 만났습니다. 그도 우산을 하나만 들고 있었습니다.`,
            `두 사람은 그 우산 아래에서 한참을 걸었습니다.`,
            `"조." 그가 말했습니다. "나는 가진 것이 없소. 이 낡은 우산 하나뿐이오. 그리고 나이도 많고."`,
            `"저도 가진 게 없어요." 조가 말했습니다. "그리고 성질도 급하고 글씨도 엉망이고요."`,
            `"그럼 우리 둘이 합치면 무엇이 되겠소."`,
            `"아무것도 안 되겠죠." 조가 말했습니다. "그래도 저는 좋아요."`,
            `두 사람은 빗속에서 웃었습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `조는 팔지 않았습니다.`,
            `"저는 이 집에서 무서웠던 기억밖에 없어요." 조가 말했습니다. "그러니까 이 집이 다른 집이 되는 걸 보고 싶어요."`,
            ...
            `말썽꾸러기일수록 조가 잘 봤습니다. 자기가 그런 아이였기 때문입니다.<br>"저 애는 못 고쳐요." 누가 그렇게 말하면 조는 이렇게 대답했습니다. "저도 그랬어요."`,
            `마당에서는 하루 종일 소리가 났습니다. 조는 그 소리가 좋았습니다.`,
            `로리는 그 학교에 돈을 댔고, 에이미는 아이들에게 그림을 가르쳤습니다. 메그의 아이들도 그곳에서 놀았습니다.`,
            `해마다 시월이면 어머니의 생일에 온 식구가 그 집에 모였습니다.`,
            `메그가 아이들을 데리고 왔고, 에이미와 로리가 왔고, 아버지와 어머니가 왔습니다.`,
...
const QUIZ = [
    { q: "네 자매의 아버지는 어디에 계셨습니까?", choices: ["전쟁터", "먼 바다", "다른 도시"], answer: 0 },
    { q: "성탄절 아침에 네 자매가 한 일은 무엇입니까?", choices: ["선물을 나눴다", "아침밥을 이웃에게 주었다", "교회에 갔다"], answer: 1 },
    { q: "조가 무도회에서 커튼 뒤에서 만난 사람은 누구입니까?", choices: ["브룩 씨", "로렌스 씨", "로리"], answer: 2 },
    { q: "조가 마치 대고모 댁에서 가장 좋아한 것은 무엇입니까?", choices: ["큰 서재", "정원", "받는 돈"], answer: 0 },
    { q: "에이미가 화가 나서 태운 것은 무엇입니까?", choices: ["편지", "조가 쓴 원고", "메그의 옷"], answer: 1 },
    { q: "얼음이 깨졌을 때 물에 빠진 사람은 누구입니까?", choices: ["에이미", "조", "로리"], answer: 0 },
    { q: "로렌스 씨가 베스에게 보낸 것은 무엇입니까?", choices: ["악보", "피아노", "돈"], answer: 1 },
    { q: "조가 어머니의 여비를 마련한 방법은 무엇입니까?", choices: ["원고를 팔았다", "대고모께 빌렸다", "머리를 잘라 팔았다"], answer: 2 },
    { q: "베스가 병에 걸린 까닭은 무엇입니까?", choices: ["아픈 이웃집을 돌봐서", "눈길에서 넘어져서", "굶어서"], answer: 0 },
    { q: "조가 로리의 고백에 어떻게 대답했습니까?", choices: ["기다려 달라고 했다", "받아들였다", "거절했다"], answer: 2 },
    { q: "뉴욕에서 만난 베어 교수가 조에게 한 말은 무엇입니까?", choices: ["글을 그만두라고 했다", "정말 쓰고 싶은 글이냐고 물었다", "책을 내라고 했다"], answer: 1 },
    { q: "베스가 마지막까지 한 일은 무엇입니까?", choices: ["피아노를 쳤다", "아이들에게 줄 것을 만들었다", "편지를 썼다"], answer: 1 },
    { q: "어머니가 조에게 다시 쓰라며 권한 것은 무엇입니까?", choices: ["베스 이야기", "아버지 이야기", "잘 팔리는 이야기"], answer: 0 },
    { q: "유럽에서 로리와 결혼한 사람은 누구입니까?", choices: ["메그", "에이미", "조"], answer: 1 },
    { q: "조가 마치 대고모에게 물려받은 집을 어떻게 했습니까?", choices: ["팔았다", "세를 놓았다", "학교로 만들었다"], answer: 2 },
    { q: "그 학교에서 조가 지킨 원칙은 무엇입니까?", choices: ["부잣집 아이만 받았다", "돈을 못 내는 아이도 똑같이 대했다", "남자아이만 받았다"], answer: 1 }
];
