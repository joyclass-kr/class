...
const CHAPTERS = [
    {
        ...
        paras: [
            ...
            `그런 사람이었습니다.`,
            `어터슨에게는 먼 친척인 엔필드라는 사람이 있었습니다. 두 사람은 일요일마다 함께 산책을 했습니다.`,
            `그런데 걷는 동안 거의 말을 하지 않았습니다. 그래도 두 사람은 그 산책을 한 주의 가장 좋은 시간으로 여겼습니다.`,
            `어느 일요일, 두 사람은 런던의 어느 뒷골목을 지나고 있었습니다. 그 골목은 깨끗하고 가게들이 잘 정돈되어 있었습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `아이의 아버지와 오빠가 왔고, 이웃 사람들이 나왔습니다. 다들 그 남자를 노려보았습니다.`,
            `의사도 그랬습니다. 엔필드는 나중에 이렇게 말했습니다. 그 자리에 있던 사람이 다 그 남자를 죽이고 싶어 했다고요.`,
            `"경찰을 부릅시다."<br>그러자 그 남자가 말했습니다.<br>"소란 피우고 싶지 않소. 돈을 내지."`,
            `그리고 백 파운드를 물어내겠다고 했습니다. 그 시절 백 파운드는 아주 큰돈이었습니다.`,
            `사람들은 그 남자를 놓아주지 않고 함께 그 문 앞까지 갔습니다.`,
            `남자는 열쇠를 꺼내 그 문을 열고 들어갔습니다. 그리고 잠시 뒤 금화 열 닢과 수표 한 장을 들고 나왔습니다.`,
            `엔필드가 수표를 보고 놀랐습니다.`,
            ...
            `헨리 지킬 박사의 유언장.`,
            `그것을 쓴 것은 지킬 자신이었습니다. 어터슨은 그 문서를 만드는 데 손도 대지 않았습니다. 변호사로서 도와줄 수 없다고 했기 때문입니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `학회에서 상도 여럿 받았고, 가난한 사람을 돌보는 일에도 돈을 냈습니다.`,
            ...
            `그리고 그 사람의 집에 그대로 들어가 살고, 그 집 하인들에게 아무것도 물어주지 않아도 된다고 적혀 있었습니다.`,
            ...
            `어터슨은 그 하이드라는 사람이 누구인지 물은 적이 있었습니다. 그러자 지킬이 이렇게 말했습니다.`,
            `"그건 자네가 상관할 일이 아닐세."`,
            `어터슨은 한 번 묻고 그만두었습니다. 남에게 두 번 묻는 사람이 아니었습니다.`,
            `다만 이렇게 짐작했습니다. 지킬이 젊었을 때 무슨 잘못을 저질렀고, 그것을 그 하이드라는 자가 알고 있어서 협박을 하고 있는 것이라고요.`,
            `어터슨은 그날 밤 잠을 이루지 못했습니다.`,
            `자꾸 그 이야기가 떠올랐습니다. 새벽 세 시의 빈 거리, 뛰어오는 아이, 그리고 그 위를 밟고 지나가는 발. 그 발의 주인 얼굴이 보이지 않았습니다.`,
            `꿈에서도 그 장면이 되풀이되었습니다. 그리고 그때마다 그 얼굴이 있어야 할 자리가 비어 있었습니다.`,
            `어터슨은 그 얼굴을 보고 싶었습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `남자가 잠깐 망설이다가 고개를 들었습니다. 가로등 하나뿐인 골목이었고 안개가 끼어 있었습니다.`,
            `그 불빛이 얼굴에 닿았습니다. 어터슨은 그 얼굴을 오래 보았습니다.`,
            `그 얼굴은 어디가 어떻다고 말할 수 있는 얼굴이 아니었습니다. 눈, 코, 입이 다 제자리에 있었습니다.`,
            `키가 작고 몸이 조금 굽었지만, 그런 사람은 얼마든지 있습니다. 그런데 그 사람을 보고 있으면 속이 뒤집혔습니다.`,
            ...
            `목소리가 쉬어 있었고 조금 갈라져 있었습니다.`,
            `그리고 소호의 어느 거리를 댔습니다. 소호는 그 무렵 런던에서 값싼 방을 얻어 사는 사람들이 모이던 데였습니다.`,
            `어터슨은 그것이 이상했습니다. 묻지도 않았는데 주소를 알려 주었기 때문입니다.`,
            `그러다 유언장 생각이 났습니다. 이 사람은 나중에 재산을 받으려면 이 변호사를 찾아와야 한다는 것을 알고 있었던 것입니다.`,
            `"그럼 이만."`,
            `그러고는 어터슨을 한 번 더 보았습니다. 웃는 것 같기도 했습니다.`,
            `하이드는 문을 열고 들어가 버렸습니다. 어터슨은 한참 그 자리에 서 있었습니다.`,
            `그리고 골목을 돌아 큰길로 나갔습니다. 그 뒷골목의 문과, 지킬 박사의 크고 훌륭한 집이 같은 건물의 앞뒤라는 것을 그때 알았습니다.`,
            `그 문은 지킬의 실험실 뒷문이었습니다.`,
            `집에 돌아와 어터슨은 이런 생각을 했습니다. 저 사람이 지킬의 재산을 노리고 있다면, 지킬이 살아 있는 것이 저 사람에게는 걸림돌입니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `지킬은 쉰 살쯤 된 크고 잘생긴 사람이었습니다. 얼굴이 반듯하고 목소리가 좋았습니다.`,
            `사람들이 그 사람과 이야기하고 나면 기분이 좋아졌습니다. 그런 사람이었습니다.`,
            `난롯가에 앉아 손님을 배웅하고 나서 지킬이 어터슨 쪽을 보았습니다.`,
            ...
            `그러고는 이렇게 말했습니다.<br>"이건 아무에게도 말할 수 없는 일일세."`,
            `"그리고 내가 원하면 언제든 그자를 떼어 낼 수 있네. 그건 자네에게 손을 걸고 약속하겠네."`,
            `"정말인가."<br>"정말일세."`,
            ...
            `그리고 그날 밤 집으로 돌아왔습니다. 지킬이 한 말 가운데 한 대목이 계속 걸렸습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `달이 아주 밝은 밤이었습니다. 길에 나이 지긋한 신사가 하나 걸어오고 있었습니다.`,
            `머리가 하얗고, 몸가짐이 점잖았습니다. 하녀는 그 사람의 얼굴이 아주 다정해 보였다고 말했습니다.`,
            ...
            `하녀는 나중에 그 남자가 원숭이처럼 뛰었다고 말했습니다. 사람이 그렇게 움직이는 것을 본 적이 없다고요.`,
            ...
            `그날 아침 런던에 안개가 아주 짙었습니다. 마차가 걸음 속도로 갔습니다.`,
            `안개가 옅어지면 거리가 보였다가, 다시 짙어지면 아무것도 안 보였습니다.`,
            ...
            `경찰이 그 조각을 집어 들었습니다. 그리고 온 나라에 사람 찾는 광고를 냈습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `그날 밤 어터슨은 이렇게 생각했습니다. 지킬이 살인자를 위해 편지를 위조해 준 것이라고요. 그것 말고 다른 설명은 떠오르지 않았습니다.`,
            `그런데 그 뒤 두 달 동안 이상한 일이 있었습니다. 지킬이 아주 좋아진 것입니다.`,
            `집 문을 열고 손님을 맞았고, 사람들과 어울렸고, 가난한 사람들을 돕는 일에 다시 나섰습니다. 얼굴이 밝아졌습니다.`,
            `어터슨은 그것을 보고 마음을 놓았습니다. 저 사람이 마침내 그 굴레에서 빠져나왔구나 하고 여긴 것입니다.`,
            `래니언도 그 무렵 지킬의 집 저녁 자리에 왔습니다. 오래 끊겼던 왕래가 다시 이어지는 것 같았습니다.`,
            ...
            `열 걸음쯤 가다가 돌아서고, 다시 열 걸음쯤 가다가 돌아섰습니다. 그것이 몇 시간씩 이어졌습니다.`,
            `밤낮으로 그랬습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `같은 학교에 다녔고, 같은 하숙에 살았습니다. 서른 해 가까이 된 사귐이었습니다.`,
            `래니언은 런던에서 손꼽히는 의사였습니다. 환자가 많았고 학회에서 이름이 높았습니다.`,
            `다만 래니언과 지킬은 몇 해 전에 사이가 틀어졌습니다. 지킬이 하는 연구가 말이 안 된다고 래니언이 말했기 때문입니다.`,
            `"그건 학문이 아니라 헛소리일세."`,
            `그 뒤로 두 사람은 왕래를 끊었습니다. 말다툼이 크게 났던 것도 아니었습니다. 그냥 서로 부르지 않게 된 것입니다.`,
            `오래된 사귐은 대개 그렇게 끊어집니다.`,
            ...
            `래니언은 그 말을 하면서 손을 무릎에 얹고 있었습니다. 그 손이 계속 떨렸습니다.`,
            `그 이름이 나오자 래니언이 손을 들어 막았습니다.`,
            `"그 사람 이름을 내 앞에서 말하지 말게."<br>"셋이 오랜 친구 아닌가."<br>"헨리 지킬은 나에게 이미 죽은 사람일세."`,
            `어터슨은 더 묻지 못했습니다.`,
            `래니언은 두 주 뒤에 세상을 떠났습니다. 의사들이 까닭을 대지 못했습니다. 몸에 병이 없었기 때문입니다.`,
            ...
            `열쇠를 손에 쥐고 서 있다가 그냥 주머니에 넣기를 여러 번 했습니다.`,
            ...
            `한 사람은 그 일이 일어나기 전에 그것을 적었고, 한 사람은 그 일을 보고 나서 그것을 적었습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `지킬은 그 실험실을 어느 외과 의사에게서 사들였습니다. 그 의사가 죽고 나서 오래 비어 있던 건물이었습니다.`,
            ...
            `말을 하다 말고 닫힌 것이었습니다. 아직 문장이 끝나지도 않았습니다.`,
            ...
            `목소리가 아주 작았습니다. 자기에게 하는 말 같기도 했습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `하녀 하나가 어터슨을 보고 울음을 터뜨렸습니다. 다른 사람들이 그 입을 막았습니다.`,
            `가는 길에 바람이 몹시 불었습니다. 거리에 사람이 하나도 없었습니다.`,
            `두 사람은 실험실로 갔습니다. 풀이 문을 두드렸습니다.`,
            `마당을 건너는 동안 비가 얼굴을 때렸습니다. 실험실 창에 불빛이 있었습니다.`,
            `"박사님, 어터슨 변호사님이 오셨습니다."`,
            ...
            `약을 찾으러 나온 참이었다고 했습니다. 얼굴에는 천을 덮고 있었습니다.`,
            ...
            `"어터슨, 제발! 제발 그러지 말게!"`,
            `그 목소리는 지킬의 목소리였습니다.`,
            `어터슨이 도끼를 들었습니다. 그때 그 안에서 무언가 떨어지는 소리가 났습니다. 그리고 조용해졌습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `그리고 바닥에 사람이 하나 쓰러져 있었습니다. 작은 사람이었습니다.`,
            `지킬의 옷을 입고 있었는데 소매와 바짓단이 접혀 있었습니다. 얼굴은 하이드였습니다.`,
            ...
            `봉투 안에 또 봉투가 있었습니다. 그 안쪽 봉투에도 같은 말이 적혀 있었습니다. 열지 말라는 말이었습니다.`,
            ...
            `편지가 몹시 다급했습니다. 래니언은 시키는 대로 했습니다.`,
            ...
            `거품이 일고 김이 났습니다. 남자는 그것을 들여다보며 숨을 죽였습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `나는 오랫동안 두 사람으로 살았다. 낮에는 존경받는 의사였고, 그러면서 속으로는 다른 것을 원했다.`,
            `그 두 가지가 다 나였다. 그런데 나는 그것을 견디지 못했다.`,
            ...
            `하이드가 쓸 집을 소호에 얻었고, 하이드 이름으로 은행에 계좌를 텄다. 글씨를 왼쪽으로 눕혀 쓰는 연습도 했다.`,
            `유언장을 고쳐 쓴 것도 그때였다. 지킬에게 무슨 일이 생겨도 하이드가 그 돈을 쓸 수 있게 해 둔 것이다.`,
            `나는 그것을 아주 잘 짜 놓았다고 여겼다.`,
            `그런데 어느 아침, 나는 깨어나 손을 보고 놀랐다. 약을 마시지 않았는데 하이드의 손이었다.`,
            `내 침대에 누워 있는데 손만 그의 것이었다. 마르고 털이 나고 마디가 굵은 손이었다.`,
            `나는 그 손을 한참 들여다보았다. 그리고 실험실로 뛰어 내려가 약을 마셨다.`,
            ...
            `나는 다시 사람들 사이에 나갔다. 아픈 사람을 보았고, 친구를 만났고, 밤에 잘 잤다. 그 두 달이 내 인생에서 가장 좋은 때였다.`,
