...
const CHAPTERS = [
    {
        ...
        paras: [
            ...
            `어터슨은 남을 잘 나무라지 않았습니다. 누가 잘못을 저질러도 그 사람과 끝까지 사귀었습니다. 그래서 그 사람의 친구 가운데는 남들이 상대하지 않는 이도 여럿 있었습니다. 어터슨은 그것에 대해 이렇게 말한 적이 있습니다.`,
            `"나는 카인의 편에 서겠소. 형제를 자기 방식으로 지옥에 가게 두는 거요."`,
            `그런 사람이었습니다. 어터슨에게는 먼 친척인 엔필드라는 사람이 있었습니다. 두 사람은 일요일마다 함께 산책을 했습니다.`,
            `그런데 걷는 동안 거의 말을 하지 않았습니다. 그래도 두 사람은 그 산책을 한 주의 가장 좋은 시간으로 여겼습니다. 어느 일요일, 두 사람은 런던의 어느 뒷골목을 지나고 있었습니다. 그 골목은 깨끗하고 가게들이 잘 정돈되어 있었습니다.`,
            `그런데 그 가운데 건물 하나만 이상했습니다. 창이 하나도 없고, 문이 하나뿐이었습니다. 그 문은 칠이 벗겨졌고, 아래쪽이 발길에 채여 움푹 들어가 있었습니다. 문 앞에 아이들이 앉아 놀고, 부랑자들이 자고 갔습니다.`,
            `이층에도 창이 없었습니다. 벽이 그냥 벽이었습니다. 옆집들은 새로 칠을 하고 놋쇠 손잡이를 닦아 놓았는데, 그 건물만 이십 년쯤 손을 대지 않은 것 같았습니다. 엔필드가 그 문을 보더니 걸음을 멈췄습니다.`,
            `"저 문 말인데요."<br>"응."<br>"이상한 일이 있었습니다."`,
            `그리고 엔필드가 이야기를 시작했습니다. 언젠가 겨울 새벽 세 시쯤, 엔필드는 어디를 다녀오는 길에 이 골목을 지났습니다. 거리에 아무도 없었습니다.`,
            `가로등만 줄지어 켜져 있었습니다. 자기 발소리가 골목 끝까지 울렸습니다.`,
            ...
            `아이가 돌바닥에 그대로 넘어졌습니다. 무릎에서 피가 났습니다.`,
    ...
    },
    {
        ...
        paras: [
            `아이의 식구들이 몰려왔고, 의사도 왔습니다. 사람들이 그 남자를 둘러쌌습니다. 아이의 아버지와 오빠가 왔고, 이웃 사람들이 나왔습니다. 다들 그 남자를 노려보았습니다.`,
            ...
            `엔필드와 의사와 아이의 아버지가 그 남자를 가운데 두고 밤을 새웠습니다. 그 남자는 그동안 한마디도 하지 않았습니다.`,
            ...
            `어터슨은 그 말을 오래 생각했습니다. 사람이 까닭 없이 미울 수는 있습니다. 그런데 온 자리에 있던 사람이 다 그랬다는 것은 다른 이야기였습니다.`,
            `그날 밤 어터슨은 집에 와서 금고를 열었습니다. 그리고 봉투를 하나 꺼냈습니다. 겉에 이렇게 적혀 있었습니다. 헨리 지킬 박사의 유언장.`,
            `그것을 쓴 것은 지킬 자신이었습니다. 어터슨은 그 문서를 만드는 데 손도 대지 않았습니다. 변호사로서 도와줄 수 없다고 했기 때문입니다. 그러자 지킬이 혼자 써서 봉해 맡긴 것이었습니다.`,
    ...
    },
    {
        ...
        paras: [
            `헨리 지킬은 어터슨의 오랜 친구였습니다. 의사이자 학자였고, 큰 집에 살았고, 사람들이 존경했습니다. 그 유언장은 지킬이 직접 써서 어터슨에게 맡긴 것이었습니다. 학회에서 상도 여럿 받았고, 가난한 사람을 돌보는 일에도 돈을 냈습니다.`,
            `둘은 학생 때부터 알던 사이였습니다. 서른 해 가까이 된 사귐이었습니다. 어터슨은 그것을 처음 받았을 때부터 마음에 들지 않았습니다. 거기에는 이렇게 적혀 있었습니다.<br>"내가 죽으면 내 모든 재산을 에드워드 하이드에게 물려준다." 그리고 한 줄이 더 있었습니다.<br>"내가 석 달 넘게 사라지거나 소식이 없을 경우에도, 아무런 지체 없이 에드워드 하이드가 내 자리를 대신한다."`,
            `그리고 그 사람의 집에 그대로 들어가 살고, 그 집 하인들에게 아무것도 물어주지 않아도 된다고 적혀 있었습니다. 어터슨은 그 두 번째 줄이 특히 마음에 걸렸습니다. 보통 유언장에는 그런 것을 적지 않습니다. 그것은 사람이 없어지는 것을 미리 생각해 두었다는 뜻이었습니다.`,
            ...
            `어터슨은 한 번 묻고 그만두었습니다. 남에게 두 번 묻는 사람이 아니었습니다. 다만 이렇게 짐작했습니다. 지킬이 젊었을 때 무슨 잘못을 저질렀고, 그것을 그 하이드라는 자가 알고 있어서 협박을 하고 있는 것이라고요.`,
            `어터슨은 그날 밤 잠을 이루지 못했습니다. 자꾸 그 이야기가 떠올랐습니다. 새벽 세 시의 빈 거리, 뛰어오는 아이, 그리고 그 위를 밟고 지나가는 발. 그 발의 주인 얼굴이 보이지 않았습니다.`,
            `꿈에서도 그 장면이 되풀이되었습니다. 그리고 그때마다 그 얼굴이 있어야 할 자리가 비어 있었습니다. 어터슨은 그 얼굴을 보고 싶었습니다.`,
            `이름은 알았습니다. 그런데 이름만으로는 아무것도 알 수 없었습니다. 이튿날부터 어터슨은 그 문 앞을 지키기 시작했습니다. 밤에 일을 마치고 그 골목에 가서 서 있었습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `작은 남자가 문 앞으로 다가와 열쇠를 꺼냈습니다. 열쇠를 쓰는 손이 익숙했습니다. 처음 오는 사람의 손이 아니었습니다.`,
            ...
            `남자가 잠깐 망설이다가 고개를 들었습니다. 가로등 하나뿐인 골목이었고 안개가 끼어 있었습니다. 그 불빛이 얼굴에 닿았습니다. 어터슨은 그 얼굴을 오래 보았습니다.`,
            ...
            `목소리가 쉬어 있었고 조금 갈라져 있었습니다. 그리고 소호의 어느 거리를 댔습니다. 소호는 그 무렵 런던에서 값싼 방을 얻어 사는 사람들이 모이던 데였습니다.`,
            `어터슨은 그것이 이상했습니다. 묻지도 않았는데 주소를 알려 주었기 때문입니다. 그러다 유언장 생각이 났습니다. 이 사람은 나중에 재산을 받으려면 이 변호사를 찾아와야 한다는 것을 알고 있었던 것입니다.`,
            `"그럼 이만."`,
            `그러고는 어터슨을 한 번 더 보았습니다. 웃는 것 같기도 했습니다. 하이드는 문을 열고 들어가 버렸습니다. 어터슨은 한참 그 자리에 서 있었습니다.`,
            `그리고 골목을 돌아 큰길로 나갔습니다. 그 뒷골목의 문과, 지킬 박사의 크고 훌륭한 집이 같은 건물의 앞뒤라는 것을 그때 알았습니다. 그 문은 지킬의 실험실 뒷문이었습니다.`,
            `집에 돌아와 어터슨은 이런 생각을 했습니다. 저 사람이 지킬의 재산을 노리고 있다면, 지킬이 살아 있는 것이 저 사람에게는 걸림돌입니다. 그리고 유언장에는 지킬이 사라지기만 해도 된다고 적혀 있었습니다. 어터슨은 그날 밤 잠자리에서 몸을 일으켰습니다.`,
    ...
    },
    {
        ...
        paras: [
            `보름 뒤, 지킬의 집에서 저녁 모임이 있었습니다. 그 집은 런던에서도 좋은 자리에 있었습니다. 앞은 넓은 길에 면해 있었고 창이 크고 밝았습니다. 그 집 뒤가 그 뒷골목이라는 것을 아는 사람은 별로 없었습니다.`,
            `손님들이 다 돌아간 뒤 어터슨이 남았습니다. 지킬은 쉰 살쯤 된 크고 잘생긴 사람이었습니다. 얼굴이 반듯하고 목소리가 좋았습니다.`,
            `사람들이 그 사람과 이야기하고 나면 기분이 좋아졌습니다. 그런 사람이었습니다. 난롯가에 앉아 손님을 배웅하고 나서 지킬이 어터슨 쪽을 보았습니다.`,
            ...
            `놀란 사람은 눈이 커집니다. 들킨 사람은 얼굴에서 핏기가 가십니다.`,
            `"헨리, 자네가 무슨 곤란한 일에 걸려 있다면 나에게 말하게. 나는 자네 변호사일세. 내가 꺼내 주겠네."`,
            `지킬은 어터슨의 손을 잡았습니다. 그 손이 뜨거웠습니다.`,
            ...
            `지킬이 웃었습니다. 그 웃음이 조금 이상했습니다. 웃는 얼굴인데 눈이 웃지 않았습니다.`,
            `"좋아할 필요 없네. 그건 나도 마찬가지니까. 그래도 되네. 다만 지켜만 주게."`,
            `어터슨은 그 말을 그때는 흘려들었습니다. 그러면서도 그러겠다고 했습니다.`,
            `변호사로서 한 약속이었습니다. 그리고 어터슨은 한번 한 약속을 어기는 사람이 아니었습니다. 그것이 나중에 그 사람을 오래 괴롭힙니다.`,
            `그리고 그날 밤 집으로 돌아왔습니다. 지킬이 한 말 가운데 한 대목이 계속 걸렸습니다. 내가 원하면 언제든 떼어 낼 수 있다는 말이었습니다. 사람이 그런 말을 할 때는, 대개 아직 해 보지 않은 것입니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `달이 아주 밝은 밤이었습니다. 길에 나이 지긋한 신사가 하나 걸어오고 있었습니다. 머리가 하얗고, 몸가짐이 점잖았습니다. 하녀는 그 사람의 얼굴이 아주 다정해 보였다고 말했습니다.`,
            `그 신사가 맞은편에서 오는 작은 남자를 만났습니다. 신사가 모자를 들고 무언가를 물었습니다. 길을 묻는 것 같았습니다.`,
            ...
            `깨어난 것은 새벽 두 시였습니다. 하녀는 경찰을 불렀습니다. 그 신사는 댄버스 커루 경이라는 사람이었습니다. 국회 의원이었고, 온 나라가 아는 사람이었습니다.`,
            `그 사람은 어터슨의 의뢰인이기도 했습니다. 그래서 어터슨은 그 얼굴을 잘 알고 있었습니다. 그 사람이 그렇게 되었다는 소식에 런던이 발칵 뒤집혔습니다.`,
            ...
            `그날 아침 런던에 안개가 아주 짙었습니다. 마차가 걸음 속도로 갔습니다. 안개가 옅어지면 거리가 보였다가, 다시 짙어지면 아무것도 안 보였습니다.`,
            ...
            `그 재 속에서 수표책의 남은 조각이 나왔습니다. 하이드는 이미 떠난 뒤였습니다. 경찰이 그 조각을 집어 들었습니다. 그리고 온 나라에 사람 찾는 광고를 냈습니다.`,
    ...
    },
    {
        ...
        paras: [
            `그다음 날 어터슨은 지킬을 찾아갔습니다. 그 집에 들어가 본 것이 여러 달 만이었습니다.`,
            `지킬은 실험실 안쪽 방에서 나왔습니다. 몹시 상해 있었습니다. 살이 빠졌고, 얼굴빛이 나빴습니다.`,
            ...
            `글씨가 이상하게 기울어 있었습니다. 오른쪽으로 눕지 않고 왼쪽으로 누워 있었습니다.`,
            ...
            `그 서기는 글씨를 보는 데 아주 밝은 사람이었습니다. 서기는 그 편지와 지킬이 쓴 다른 글을 나란히 놓고 한참 들여다보았습니다. 여러 해 동안 계약서를 다룬 사람이라 남의 글씨를 보는 눈이 있었습니다.`,
            `그리고 이렇게 말했습니다.<br>"기울기만 다릅니다. 나머지는 같은 사람 글씨입니다."`,
            `어터슨은 그 말을 듣고 아무 말도 하지 못했습니다. 그날 밤 어터슨은 이렇게 생각했습니다. 지킬이 살인자를 위해 편지를 위조해 준 것이라고요. 그것 말고 다른 설명은 떠오르지 않았습니다.`,
            `그런데 그 뒤 두 달 동안 이상한 일이 있었습니다. 지킬이 아주 좋아진 것입니다. 집 문을 열고 손님을 맞았고, 사람들과 어울렸고, 가난한 사람들을 돕는 일에 다시 나섰습니다. 얼굴이 밝아졌습니다.`,
            `어터슨은 그것을 보고 마음을 놓았습니다. 저 사람이 마침내 그 굴레에서 빠져나왔구나 하고 여긴 것입니다. 래니언도 그 무렵 지킬의 집 저녁 자리에 왔습니다. 오래 끊겼던 왕래가 다시 이어지는 것 같았습니다.`,
            `그렇게 두 달이 지난 어느 날, 어터슨이 찾아가자 하인이 이렇게 말했습니다.<br>"박사님은 아무도 만나지 않으십니다."`,
            `그 뒤로 지킬은 다시 나오지 않았습니다. 어터슨은 여러 번 그 집에 갔습니다. 그때마다 하인이 같은 말을 했습니다.`,
            `"박사님은 실험실에 계십니다. 아무도 만나지 않으십니다."`,
            `어터슨은 그 실험실 문 앞까지 가 본 적도 있었습니다. 안에서 발소리가 났습니다. 아주 느린 발소리가 방 안을 왔다 갔다 했습니다.`,
            `열 걸음쯤 가다가 돌아서고, 다시 열 걸음쯤 가다가 돌아섰습니다. 그것이 몇 시간씩 이어졌습니다. 밤낮으로 그랬습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `같은 학교에 다녔고, 같은 하숙에 살았습니다. 서른 해 가까이 된 사귐이었습니다. 래니언은 런던에서 손꼽히는 의사였습니다. 환자가 많았고 학회에서 이름이 높았습니다.`,
            `다만 래니언과 지킬은 몇 해 전에 사이가 틀어졌습니다. 지킬이 하는 연구가 말이 안 된다고 래니언이 말했기 때문입니다.`,
            `"그건 학문이 아니라 헛소리일세."`,
            `그 뒤로 두 사람은 왕래를 끊었습니다. 말다툼이 크게 났던 것도 아니었습니다. 그냥 서로 부르지 않게 된 것입니다. 오래된 사귐은 대개 그렇게 끊어집니다.`,
            `젊었을 때 세 사람은 자주 어울렸습니다. 래니언은 목소리가 크고 잘 웃는 사람이었습니다. 지킬은 늘 무언가를 골똘히 생각했습니다. 어터슨은 그 사이에서 듣는 쪽이었습니다.`,
            `어터슨이 래니언의 집에 들어섰을 때, 그는 놀라서 걸음을 멈췄습니다. 래니언이 죽어 가는 사람처럼 보였기 때문입니다. 보름 전에 만났을 때만 해도 혈색이 좋고 목소리가 컸습니다. 그런데 지금은 얼굴이 하얗고 손이 떨렸습니다.`,
            `"자네 어디 아픈가."<br>"나는 곧 죽네."<br>"무슨 소린가."<br>"나는 무언가를 보았네. 그리고 그것을 보고 나서 살고 싶은 마음이 없어졌네."<br>어터슨이 물었습니다.<br>"지킬 때문인가."`,
            `래니언은 그 말을 하면서 손을 무릎에 얹고 있었습니다. 그 손이 계속 떨렸습니다. 그 이름이 나오자 래니언이 손을 들어 막았습니다.`,
            `"그 사람 이름을 내 앞에서 말하지 말게."<br>"셋이 오랜 친구 아닌가."<br>"헨리 지킬은 나에게 이미 죽은 사람일세."`,
            `어터슨은 더 묻지 못했습니다. 래니언은 두 주 뒤에 세상을 떠났습니다. 의사들이 까닭을 대지 못했습니다. 몸에 병이 없었기 때문입니다.`,
            `장례를 치른 뒤 어터슨에게 봉투가 하나 전해졌습니다. 래니언의 글씨로 이렇게 적혀 있었습니다.<br>"어터슨에게. 헨리 지킬이 죽거나 사라지기 전에는 열지 말 것."`,
            `어터슨은 그것을 금고에 넣었습니다. 그리고 여러 번 그 앞에 서서 망설였습니다. 열쇠를 손에 쥐고 서 있다가 그냥 주머니에 넣기를 여러 번 했습니다.`,
            `그때마다 문을 닫았습니다. 직업이 변호사였기 때문입니다. 변호사는 남이 맡긴 것을 함부로 열지 않습니다.`,
            `어터슨은 그 봉투를 볼 때마다 지킬의 유언장이 떠올랐습니다. 두 문서가 다 같은 말을 하고 있었습니다. 헨리 지킬이 사라질 수 있다는 말이었습니다. 한 사람은 그 일이 일어나기 전에 그것을 적었고, 한 사람은 그 일을 보고 나서 그것을 적었습니다.`,
            `한 사람은 그것을 미리 준비해 두었고, 다른 사람은 그것을 보고 죽어 갔습니다. 어터슨은 그 두 문서를 같은 금고에 넣어 두었습니다.`
        ]
    },
    {
        num: 9,
        ...
        paras: [
            `어느 일요일, 어터슨과 엔필드가 또 산책을 하다가 그 골목에 이르렀습니다. 겨울이 지나고 볕이 조금 따뜻해진 날이었습니다. 그 산책은 여러 해 동안 이어진 것이었습니다. 그리고 두 사람은 그날 이후로 다시는 그 골목으로 가지 않았습니다.`,
            `"저 문이 그 문일세." 어터슨이 말했습니다.<br>"저 뒤가 지킬의 집이야."`,
            `두 사람은 그 뒷마당 쪽으로 돌아 들어갔습니다. 마당은 눅눅하고 어두웠습니다. 해가 거의 들지 않아 낮인데도 벽 아래가 어두웠습니다.`,
            `그 마당은 원래 무언가를 짓던 자리라고 했습니다. 지금은 아무것도 없고, 돌바닥에 이끼가 끼어 있었습니다. 지킬은 그 실험실을 어느 외과 의사에게서 사들였습니다. 그 의사가 죽고 나서 오래 비어 있던 건물이었습니다.`,
            `이층에 창이 셋 있었는데, 그 가운데 하나가 반쯤 열려 있었습니다. 그 창가에 지킬이 앉아 있었습니다. 죄수처럼 앉아 있었습니다.`,
            `창틀에 팔을 걸치고 밖을 보고 있었습니다. 그 자세로 오래 앉아 있었던 것 같았습니다.`,
            `"헨리!"`,
            ...
            `두 사람은 마당에 서서 잠깐 이야기를 나누었습니다. 날씨 이야기를 했습니다. 그것 말고 할 이야기가 없었기 때문입니다.`,
            `그러다 어터슨이 무슨 말을 하려는데, 지킬의 얼굴이 갑자기 달라졌습니다. 무엇을 본 것 같았습니다.`,
            `아니면 무엇이 안에서 올라온 것 같았습니다. 그 얼굴에 아주 짧게 무서움과 절망이 지나갔습니다. 그리고 창이 쾅 닫혔습니다.`,
            `말을 하다 말고 닫힌 것이었습니다. 아직 문장이 끝나지도 않았습니다. 커튼이 내려왔습니다. 그 뒤로 아무 소리도 나지 않았습니다.`,
            `어터슨과 엔필드는 그 자리에 굳어 섰습니다. 한참 뒤에 두 사람은 아무 말 없이 마당을 나왔습니다.`,
            `큰길에 이르러서야 어터슨이 입을 열었습니다.<br>"하느님, 저희를 용서하십시오."`,
            `목소리가 아주 작았습니다. 자기에게 하는 말 같기도 했습니다. 엔필드는 고개만 끄덕였습니다. 두 사람은 그날 그 이야기를 더 하지 않았습니다.`,
            `그날 밤 어터슨은 잠을 이루지 못했습니다. 그 얼굴이 눈앞에서 사라지지 않았습니다. 지킬은 무언가를 무서워하고 있었습니다. 그런데 그것은 밖에 있는 것이 아니었습니다.`,
            `밖에 있는 것이라면 도망칠 수 있습니다. 지킬은 도망치지 않고 그 방에 앉아 있었습니다. 그러니 그것은 그 방 안에 있는 것이었습니다. 아니면 그보다 더 가까운 데 있는 것이었습니다.`
        ]
    },
    {
        num: 10,
        ...
        paras: [
            `어느 밤, 지킬의 늙은 하인 풀이 어터슨을 찾아왔습니다. 얼굴이 하얗게 질려 있었습니다. 비바람이 치는 밤이었습니다. 풀은 우산도 없이 왔습니다.`,
            ...
            `하녀 하나가 어터슨을 보고 울음을 터뜨렸습니다. 다른 사람들이 그 입을 막았습니다. 가는 길에 바람이 몹시 불었습니다. 거리에 사람이 하나도 없었습니다.`,
            `두 사람은 실험실로 갔습니다. 풀이 문을 두드렸습니다. 마당을 건너는 동안 비가 얼굴을 때렸습니다. 실험실 창에 불빛이 있었습니다.`,
            `"박사님, 어터슨 변호사님이 오셨습니다."`,
            ...
            `약을 찾으러 나온 참이었다고 했습니다. 얼굴에는 천을 덮고 있었습니다. 그 사람이 풀을 보고 짐승 같은 소리를 내며 안으로 달아났다고 했습니다.`,
            `"변호사님, 저 안에 있는 게 우리 주인님이 아닙니다."`,
            `풀은 스무 해 넘게 그 집에서 일한 사람이었습니다. 주인의 발소리와 기침 소리를 다 아는 사람이었습니다. 그런 사람이 그렇게 말하고 있었습니다. 어터슨은 그 말을 흘려들을 수 없었습니다.`,
            `어터슨은 도끼를 가져오라고 했습니다. 변호사가 남의 집 문을 부수는 것은 법에 어긋나는 일이었습니다. 어터슨은 그것을 알면서 했습니다.`,
    ...
    },
    {
        ...
        paras: [
            `방 안은 조용했습니다. 난롯불이 타고 있었고, 찻잔이 놓여 있었습니다.`,
            `실험 도구가 늘어서 있었고 종이가 흩어져 있었습니다. 그리고 거울이 하나 서 있었습니다. 실험실에 있을 만한 물건이 아니었습니다.`,
            `그리고 바닥에 사람이 하나 쓰러져 있었습니다. 작은 사람이었습니다. 지킬의 옷을 입고 있었는데 소매와 바짓단이 접혀 있었습니다. 얼굴은 하이드였습니다.`,
            `그 손에 작은 병이 쥐여 있었습니다. 병은 비어 있었습니다. 방 안에 쓴 냄새가 났습니다.`,
            `두 사람은 온 집을 뒤졌습니다. 지킬은 어디에도 없었습니다. 책상 위에 봉투가 셋 놓여 있었습니다. 하나는 지킬이 어터슨에게 남긴 짧은 쪽지였습니다.`,
            `잉크가 아직 마르지 않은 것도 있었습니다.`,
            `"이것을 읽거든 나는 이미 없을 걸세. 어떻게 없어졌는지는 나도 모르네. 다만 그때가 왔다는 것은 아네."<br>"래니언이 준 봉투를 먼저 읽게. 그리고 이 두꺼운 것을 읽게."`,
            `어터슨은 집으로 돌아가 래니언의 봉투를 열었습니다. 봉투 안에 또 봉투가 있었습니다. 그 안쪽 봉투에도 같은 말이 적혀 있었습니다. 열지 말라는 말이었습니다.`,
            ...
            `그때 두 사람은 여러 해 동안 말을 하지 않던 사이였습니다. 그런데도 편지가 온 것입니다. 편지가 몹시 다급했습니다. 래니언은 시키는 대로 했습니다.`,
            `서랍 안에는 흰 가루가 든 종이 봉지 몇 개와, 붉은 액체가 든 병이 있었습니다. 자정에 사람이 왔습니다. 키가 작고 몸이 굽은 남자였습니다. 래니언은 그 사람을 보고 견디기 힘든 기분이 들었습니다.`,
            `남자는 그 서랍을 보고 손을 떨었습니다. 그리고 가루와 액체를 섞었습니다. 색이 붉은빛에서 보랏빛으로, 다시 옅은 초록빛으로 변했습니다.`,
            `거품이 일고 김이 났습니다. 남자는 그것을 들여다보며 숨을 죽였습니다. 남자가 잔을 들고 래니언을 보았습니다.`,
            `"당신은 학자요. 나가 있겠소, 아니면 볼 거요?"<br>"보겠소."<br>"그럼 보시오. 그리고 오늘 본 것을 잊지 마시오."`,
            `그리고 남자가 그것을 마셨습니다. 래니언은 그다음에 무엇을 보았는지 그 편지에 적었습니다. 그 몸이 부풀고 얼굴이 바뀌더니, 거기에 헨리 지킬이 서 있었다고요. 편지의 마지막 줄은 이랬습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `마지막 장에서는 줄이 아래로 처져 있었습니다. 어터슨은 그 글씨를 보면서 이 사람이 어떤 상태로 이것을 썼는지를 짐작했습니다.`,
            ...
            `나는 오랫동안 두 사람으로 살았다. 낮에는 존경받는 의사였고, 그러면서 속으로는 다른 것을 원했다. 그 두 가지가 다 나였다. 그런데 나는 그것을 견디지 못했다.`,
            ...
            `왜 그런가 하면, 그것은 내 안의 한쪽만 떼어 낸 것이었기 때문이다. 내 평생의 대부분은 좋은 쪽으로 살았으므로 그쪽이 컸다. 그러니 나쁜 쪽만 떼어 내면 작을 수밖에 없었다.`,
            `나는 그를 하이드라고 불렀다. 숨는다는 뜻이었다. 이름을 그렇게 지은 것도 나였다. 나는 그때 그것이 재치 있다고 생각했다.`,
            `처음 얼마 동안은 즐거웠다. 나는 밤에 하이드가 되어 나갔다. 그리고 아침에 약을 마시고 지킬로 돌아와 아무 일 없었던 얼굴로 살았다.`,
            `하이드가 쓸 집을 소호에 얻었고, 하이드 이름으로 은행에 계좌를 텄다. 글씨를 왼쪽으로 눕혀 쓰는 연습도 했다. 유언장을 고쳐 쓴 것도 그때였다. 지킬에게 무슨 일이 생겨도 하이드가 그 돈을 쓸 수 있게 해 둔 것이다.`,
            `나는 그것을 아주 잘 짜 놓았다고 여겼다. 그런데 어느 아침, 나는 깨어나 손을 보고 놀랐다. 약을 마시지 않았는데 하이드의 손이었다.`,
            `내 침대에 누워 있는데 손만 그의 것이었다. 마르고 털이 나고 마디가 굵은 손이었다. 나는 그 손을 한참 들여다보았다. 그리고 실험실로 뛰어 내려가 약을 마셨다.`,
            `그날부터 무너지기 시작했다. 약을 두 배로 마셔야 지킬로 돌아올 수 있게 되었다. 그리고 곧 세 배가 되었다.`,
            `잠이 들면 하이드가 되어 깼다. 그래서 나는 잠을 자지 않으려고 했다.`,
            `나는 두려웠다. 그런데 그만두지 못했다. 그때는 이미 그만두는 것이 내 손에 있지 않았다.`,
            `커루 경의 일이 있고 나서 나는 다시는 하이드가 되지 않겠다고 맹세했다. 두 달을 지켰다.`,
            `나는 다시 사람들 사이에 나갔다. 아픈 사람을 보았고, 친구를 만났고, 밤에 잘 잤다. 그 두 달이 내 인생에서 가장 좋은 때였다. 그러다 어느 날 공원 벤치에 앉아 있다가, 나는 내가 남들보다 낫다는 생각을 했다.`,
            `그 생각을 하는 순간 몸이 뒤틀렸다. 약을 마시지 않았는데 하이드가 되었다.`,
            `그때부터는 그가 주인이었다. 내가 약을 마셔야 잠깐 지킬이 되었다. 그리고 마지막에는 약을 만들 수 없게 되었다.`,
            `그가 나를 미워한다는 것을 나는 알고 있었다. 그런데 그도 나 없이는 살 수 없었다. 내 몸이 그의 몸이었기 때문이다.`,
            ...
            `떼어 내고 보니 좋은 쪽도 온전한 사람이 아니었다. 사람은 그 둘을 다 데리고 살아야 하는 것이었다. 그것이 힘들다고 해서 하나를 잘라 내면, 남은 쪽도 사람이 아니게 된다. 나는 그것을 알아내는 데 평생을 썼다.`,
