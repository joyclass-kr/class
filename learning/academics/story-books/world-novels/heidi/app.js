...
const CHAPTERS = [
    {
        ...
        paras: [
            ...
            `데테는 그렇게 말하고 다시 걷기 시작했습니다.`,
            `길이 가팔라졌습니다.`,
            `한참 오르자 염소 떼가 나타났습니다. 그 뒤로 열한 살쯤 된 남자아이가 맨발로 따라오고 있었습니다.`,
            `"페터구나." 데테가 말했습니다. "그래, 아직도 염소를 치니?"`,
            `하이디는 그 염소들을 보고 눈을 뗄 수가 없었습니다.`,
            `그러다 갑자기 걸음을 멈추고 옷을 벗기 시작했습니다.`,
            `"하이디, 뭐 하는 거야!"<br>"더워요."`,
            `아이는 겉옷을 벗고, 그 아래 옷도 벗고, 목도리도 풀었습니다. 그러고는 그것을 한 무더기로 쌓아 길가 풀밭에 놓았습니다.`,
            `그리고 속치마 차림으로 염소들 뒤를 따라 뛰어 올라갔습니다.`,
            `데테는 소리를 질렀지만 아이는 이미 저만치 가 있었습니다.`
        ]
    },
    {
        num: 2,
        ...
        paras: [
            ...
            `저녁으로 노인은 빵을 자르고 치즈를 불에 녹여 그 위에 얹어 주었습니다.`,
            `하이디는 그것을 다 먹었습니다.`,
    ...
    },
    {
        ...
        paras: [
            `이튿날 아침, 페터가 휘파람을 불며 올라왔습니다.`,
            `마을 사람들의 염소를 모아 산꼭대기 목장으로 데리고 가는 것이 페터의 일이었습니다.`,
            ...
            `하이디는 그곳에서 처음 보는 것들을 배웠습니다.`,
            `노란 꽃이 무리 지어 피는 자리, 매가 도는 시각, 염소마다 성질이 다르다는 것.`,
            `"저 매는 왜 저렇게 소리를 질러?"<br>"화가 나서 그래." 페터가 말했습니다.<br>"왜 화가 나?"<br>"저 아래 사람들이 시끄러워서."`,
            `해가 질 무렵이면 산봉우리가 붉게 물들었습니다.`,
            `하이디는 처음 그것을 본 날 울었습니다.`,
            `"산에 불이 났어요!"<br>"안 났다." 할아버지가 말했습니다. "해가 산에게 잘 자라고 인사하는 거다."`,
            `"내일 또 그래요?"<br>"날마다 그런다."`,
            `그해 여름 하이디는 볕에 새까맣게 탔고 살이 붙었습니다.`,
            `할아버지는 겨울이 오기 전에 아이 침대를 만들었습니다. 그리고 다락 창에 덧문을 달았습니다.`,
            `그러면서도 아이가 있어서 그런다는 말은 한 번도 하지 않았습니다.`,
            `그해 가을, 할아버지는 하이디에게 신발과 두꺼운 옷을 마련해 주었습니다.`,
            `마을에서 그것을 산 날, 가게 주인이 몹시 놀랐습니다.`,
            `알름 할아버지가 마을에 내려온 것이 여러 해 만이었기 때문입니다.`,
            `가을이 되자 산 아래가 온통 붉고 노랬습니다.`,
            `페터는 그 무렵 학교에 가야 했습니다. 눈이 오면 산에서 못 내려간다고 겨울에만 다녔습니다.`,
            `하이디는 페터가 학교에 간다는 말을 듣고 부러워했습니다.`,
            `"학교에서 뭘 배워?"<br>"글자."<br>"재미있어?"<br>"하나도 안 재미있어."`,
            `하이디는 그 말을 믿지 않았습니다.`,
            `그해 겨울, 눈이 오두막 문 높이까지 쌓였습니다.`,
            `할아버지는 아침마다 나가서 눈을 치웠습니다.`,
            `하이디는 그 옆에서 작은 삽으로 따라 했습니다.`,
            `눈을 다 치우고 나면 두 사람은 안에 들어가 불을 쬐었습니다.`,
            `할아버지는 나무를 깎아 숟가락과 그릇을 만들었습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `그러다 어느 날 할머니가 말했습니다.`,
            `"저 선반에 낡은 책이 하나 있단다. 찬송가 책이야. 내가 젊었을 때 좋아하던 노래가 그 안에 있는데, 이제는 읽어 줄 사람이 없구나."`,
            `"제가 읽어 드릴게요!"`,
            `하이디가 그 책을 꺼내 펼쳤습니다.`,
            `그리고 한참 들여다보다가 책을 내려놓았습니다.`,
            `"할머니, 저 글을 못 읽어요."`,
            `그리고 그날, 하이디는 처음으로 글을 배우고 싶다고 생각했습니다.`,
            `돌아오는 길에 하이디는 할아버지에게 말했습니다.`,
            `"할아버지, 그 집 덧문이 다 부서졌어요. 바람이 들어와요."`,
            `할아버지는 아무 말도 하지 않았습니다.`,
            `그런데 며칠 뒤, 그 집에서 망치질 소리가 났습니다.`,
            `할아버지가 못과 나무를 지고 내려가 덧문을 고쳐 놓은 것이었습니다.`
        ]
    },
    {
        num: 5,
        ...
        paras: [
            ...
            `할아버지가 파이프를 내려놓았습니다.`,
            `"뭐라고?"`,
            `"프랑크푸르트의 좋은 댁에서 사람을 찾습니다. 그 댁 따님이 다리를 못 써서 늘 집에만 있는데, 또래 아이가 함께 있어 주기를 바라신답니다."`,
            `"그 댁은 아주 부자예요. 하이디는 좋은 옷을 입고 좋은 것을 먹고 공부도 하게 됩니다. 이런 자리가 어디 있습니까."`,
            `"안 된다."`,
            `"아버님, 이 아이를 언제까지 이 산에 두실 겁니까? 여기서 뭘 배웁니까? 이 아이는 여덟 살이 되도록 글도 못 읽습니다."`,
            `할아버지가 자리에서 일어섰습니다.`,
            `"나가라."`,
            `"아버님이 이 아이 앞길을 막으시는 겁니다." 데테가 말했습니다. "사람들이 뭐라고 하는지 아세요? 저 노인이 손녀까지 산에 가둬 놓고 있다고 합니다."`,
            `할아버지는 아무 말도 하지 않았습니다.`,
            `그러고는 안으로 들어가 문을 닫았습니다.`,
            `데테는 하이디를 데리고 산을 내려갔습니다.`,
            `"이모, 저는 할아버지한테 갈래요."<br>"조금 있다 오면 돼."<br>"언제요?"<br>"곧."`,
            `데테는 그렇게 말하면서 걸음을 늦추지 않았습니다.`,
            `하이디는 페터의 집 앞을 지나면서 소리쳤습니다.`,
            `"할머니! 제가 글을 배워 올게요! 그러면 책을 읽어 드릴게요!"`,
            `할머니는 문가로 나와 손을 흔들었습니다. 그러고는 아이의 발소리가 멀어질 때까지 그 자리에 서 있었습니다.`,
            `그날 저녁, 할아버지는 오두막에서 나오지 않았습니다.`,
            `이튿날 아침 그는 아이가 자던 다락으로 올라갔습니다.`,
            `건초 위에 홑이불이 그대로 있었습니다.`,
            `그는 그 창밖을 오래 보았습니다.`,
            `산길을 내려가는 동안 하이디는 여러 번 뒤를 돌아보았습니다.`,
            `전나무 세 그루가 점점 작아졌습니다.`,
            ...
            `하이디는 기차를 처음 탔습니다.`,
            `창밖으로 산이 뒤로 밀려 갔습니다.`,
            `산이 낮아지고, 낮아지다가, 마침내 보이지 않게 되었습니다.`,
    ...
    },
    {
        ...
        paras: [
            `프랑크푸르트의 제제만 씨 댁은 아주 큰 집이었습니다.`,
            `방마다 융단이 깔려 있었고, 계단이 넓었고, 창에 두꺼운 커튼이 쳐져 있었습니다.`,
            ...
            `"이건 아이가 아니라······."`,
            `그때 클라라가 말했습니다.`,
            `"로텐마이어 부인, 저는 이 아이가 좋아요."`,
            `그날부터 하이디는 그 집에서 살게 되었습니다.`,
            `클라라와 하이디는 곧 친해졌습니다.`,
            ...
            `클라라는 그 이야기를 들을 때마다 창밖을 보았습니다.`,
            `그 창밖에는 맞은편 집 벽밖에 보이지 않았습니다.`,
            `그 집에는 하인이 여럿이었습니다.`,
            `제바스티안이라는 하인이 하이디에게 친절했습니다.`,
            `그 사람은 하이디가 야단을 맞고 나면 몰래 빵을 가져다주었습니다.`,
            `"아가씨, 여기 사람들은 원래 저래요. 마음에 담지 마세요."`,
            `하이디는 그 집에서 좋은 것을 많이 받았습니다.`,
            `부드러운 침대, 따뜻한 물, 하루 세 번 나오는 밥.`,
            `그런데 그 어느 것도 마음에 들지 않았습니다.`,
            `왜 그런지는 하이디도 몰랐습니다.`
        ]
    },
    {
        ...
        paras: [
            `그 집에는 규칙이 아주 많았습니다.`,
            `식탁에서는 등을 펴야 했고, 손은 무릎 위에 두어야 했고, 어른이 말을 걸기 전에 먼저 말하면 안 되었습니다.`,
            `하이디는 그 규칙을 다 어겼습니다.`,
            ...
            `며칠 뒤 하이디는 혼자 밖에 나갔습니다.`,
            `산이 보이는 데를 찾으려고 한 것이었습니다.`,
            `높은 데 올라가면 보일 것 같아 교회 탑에 올라갔습니다. 그런데 꼭대기에서 보인 것은 지붕과 굴뚝뿐이었습니다.`,
            `내려오는 길에 종지기 노인이 하이디에게 고양이 새끼를 보여 주었습니다.`,
            `하이디는 그중 두 마리를 얻어 주머니에 넣고 돌아왔습니다.`,
            `그날 오후 공부 시간에 주머니에서 야옹 소리가 났습니다.`,
            `로텐마이어 부인이 의자 위로 올라갔습니다. 부인은 고양이를 아주 무서워했습니다.`,
            `클라라는 그날 배가 아플 때까지 웃었습니다.`,
            `그날 저녁 하이디는 크게 야단을 맞았습니다.`,
            `그런데 하이디는 자기가 무엇을 잘못했는지 알지 못했습니다.`,
            `그 집에는 하이디를 나무라지 않는 사람이 하나 있었습니다.`,
            `제제만 씨의 어머니, 그러니까 클라라의 할머니였습니다.`,
    ...
    },
    {
        ...
        paras: [
            `그런데 하이디는 점점 야위어 갔습니다.`,
            `밥을 잘 먹지 못했고, 웃는 일이 줄었습니다.`,
            ...
            `그 뒤로 그 집에 이상한 일이 생겼습니다.`,
            `밤마다 현관문이 열려 있는 것이었습니다.`,
            ...
            `새벽 한 시가 지났을 때, 계단에서 아주 작은 소리가 났습니다.`,
            `두 사람은 문틈으로 내다보았습니다.`,
            ...
            `그러고는 울기 시작했습니다.`,
            `참았던 것이 한꺼번에 터져 나왔습니다.`,
            `의사는 그 아이가 우는 것을 한참 지켜보았습니다.`,
            `그리고 방을 나와 제제만 씨에게 말했습니다.`,
            `"이 아이는 병이 났습니다. 그런데 약으로 낫는 병이 아닙니다."`,
    ...
    },
    {
        ...
        paras: [
            `이튿날 아침, 하이디는 자기가 산으로 돌아간다는 말을 들었습니다.`,
            `아이는 그 말을 처음에는 믿지 못했습니다.`,
            `"오늘요? 정말 오늘요?"`,
            `짐을 꾸리는데 클라라가 말했습니다.`,
            `"하이디, 이거 가져가."`,
            ...
            `기차가 산 쪽으로 갈수록 창밖이 달라졌습니다.`,
            `마이엔펠트에 닿았을 때 하이디는 뛰기 시작했습니다.`,
            `도르플리를 지나 페터의 집에 먼저 갔습니다.`,
            `문을 열고 들어가자 할머니가 물레 앞에 앉아 있었습니다.`,
            `"할머니!"`,
            `할머니가 물레를 놓았습니다.`,
            `"하이디냐. 정말 하이디냐."`,
            ...
            `"그리고 할머니, 저 이제 글 읽어요."`,
            `하이디는 선반에서 찬송가 책을 꺼내 펴고 읽기 시작했습니다.`,
            `할머니는 두 손을 모으고 그것을 들었습니다.`,
            `해가 기울 무렵 하이디는 산으로 올라갔습니다.`,
            `전나무 세 그루가 보였습니다.`,
            `그 아래 걸상에 할아버지가 앉아 있었습니다.`,
            `하이디는 산길을 뛰어 올라가 그 목에 매달렸습니다.`,
            `할아버지는 아무 말도 하지 못했습니다.`,
            `한참 뒤에 이렇게 말했습니다.`,
            `"돌아왔구나."`,
            `그리고 손등으로 눈을 닦았습니다.`,
            `그날 저녁 세 사람이 오두막 앞에 앉았습니다.`,
            `할아버지가 빵을 자르고 치즈를 불에 녹여 얹었습니다.`,
            `하이디가 그것을 받아 들고 말했습니다.`,
            `"할아버지, 저는 프랑크푸르트에서 이걸 제일 생각했어요."`,
            `"그 집에는 더 좋은 게 많았을 텐데."`,
            `"많았어요. 그런데 이게 더 맛있어요."`,
            `할아버지는 대답 대신 한 조각을 더 잘라 주었습니다.`,
            `그날 밤 하이디는 다락에 올라가 둥근 창을 열었습니다.`,
            `별이 가득했습니다.`,
            `하이디는 그것을 한참 보다가 잠들었습니다.`,
            `그리고 그날 밤에는 걸어 나가지 않았습니다.`
        ]
    },
    {
        num: 10,
        ...
        paras: [
            ...
            `그리고 하이디는 학교에 다녔습니다.`,
            `마을 사람들은 알름 할아버지가 마을에 내려온 것을 보고 처음에는 어색해했습니다.`,
            `그런데 겨울이 지나는 동안 조금씩 달라졌습니다.`,
            ...
            `그해 겨울이 끝날 무렵, 페터가 처음으로 한 줄을 읽었습니다.`,
            `할머니는 그 소리를 듣고 손자의 손을 잡았습니다.`,
            `그해 겨울 하이디는 처음으로 학교에 갔습니다.`,
            `글을 이미 읽을 줄 알아서 선생님이 놀랐습니다.`,
            `"이 아이는 어디서 배웠습니까?"<br>"프랑크푸르트에서요."`,
            `선생님은 그 말을 듣고 고개를 끄덕였습니다.`,
            `하이디는 학교에서 셈도 배우고 글씨 쓰는 법도 배웠습니다.`,
            `학교가 끝나면 곧장 페터의 집으로 갔습니다.`,
            `그리고 할머니에게 그날 배운 것을 다 이야기했습니다.`,
            `"할머니, 오늘은 이만큼 배웠어요."`,
            `할머니는 그 이야기를 들으면서 물레를 돌렸습니다.`,
            `그 겨울 페터의 할머니는 오랜만에 살이 조금 붙었습니다.`
        ]
    },
    {
        num: 11,
        ...
        paras: [
            ...
            `유월의 어느 날, 산길로 사람들이 올라왔습니다.`,
            `가마에 앉은 클라라와 그 할머니, 그리고 짐꾼들이었습니다.`,
            `하이디는 산길을 뛰어 내려가 마중을 나갔습니다.`,
            `클라라는 오두막 앞에 이르러 주위를 둘러보았습니다.`,
            `전나무 세 그루가 바람에 울고 있었습니다. 아래로 골짜기가 펼쳐졌고, 위로는 바위산이 솟아 있었습니다.`,
            `"하이디." 클라라가 말했습니다. "네가 말한 그대로야."`,
            `할아버지는 클라라를 안아 바퀴 의자에서 걸상으로 옮겨 앉혔습니다.`,
            `그리고 염소젖을 한 잔 짜서 가져왔습니다.`,
            `클라라는 그 냄새를 맡고 얼굴을 찌푸렸습니다.`,
            `"드셔 보십시오." 할아버지가 말했습니다.`,
            `클라라는 한 모금 마시고 눈을 크게 떴습니다.`,
            `"맛있어요."`,
            `그날 저녁, 산봉우리가 붉게 물들었습니다.`,
            `클라라는 그것을 보고 아무 말도 하지 못했습니다.`,
            ...
            `그해 여름 클라라는 그 산에서 지냈습니다.`,
            `클라라는 그 여름 산에서 하루하루가 달라졌습니다.`,
            `볕에 얼굴이 그을렸고, 밥을 두 그릇씩 먹었습니다.`,
            `밤에는 깊이 잤습니다.`,
            `프랑크푸르트에서는 늘 잠을 설쳤는데 여기서는 그러지 않았습니다.`,
            `아침에는 하이디가 클라라를 밖으로 데리고 나갔습니다.`,
            `그리고 산에 대해 하나씩 알려 주었습니다.`,
            `어느 바위 밑에 물이 나는지, 어느 풀을 염소가 좋아하는지, 매가 어느 시각에 뜨는지.`,
            `클라라는 그것을 다 외웠습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `"하이디, 나 걸었어."`,
            `그날부터 세 아이는 날마다 그 연습을 했습니다.`,
            `두 걸음이 세 걸음이 되고, 세 걸음이 열 걸음이 되었습니다.`,
            `그동안 페터는 아무에게도 그 이야기를 하지 않았습니다.`,
            `그리고 어느 날 하이디에게 털어놓았습니다.`,
            `"하이디, 그 의자······ 내가 그랬어."`,
            ...
            `"그러니까 나쁜 짓을 한 건 맞는데, 결과가 좋았다는 거야." 하이디가 말했습니다. "그래도 할아버지한테는 말해."`,
    ...
    },
    {
        ...
        paras: [
            ...
            `"무엇으로 갚아야 할지 모르겠습니다."`,
            `"갚을 것 없습니다." 할아버지가 말했습니다. "산이 한 일입니다. 그리고 저 아이들이 한 일이고요."`,
            `"그래도 무엇이든 말씀해 주십시오."`,
            `할아버지는 잠깐 아무 말도 하지 않았습니다.`,
            `그러고는 이렇게 말했습니다.`,
            `"저는 늙었습니다. 제가 죽고 나면 하이디에게는 아무도 없습니다."`,
            `"그 아이는 제 딸과 같습니다." 제제만 씨가 말했습니다. "제가 살아 있는 동안 그 아이가 어려운 일을 겪는 일은 없을 겁니다. 약속드립니다."`,
            `그날 저녁 클라라의 할머니도 올라왔습니다.`,
            `할머니는 손녀가 걷는 것을 보고 아무 말도 하지 못했습니다.`,
            `그리고 페터를 불러 세웠습니다.`,
            `"너에게도 무언가 주고 싶구나. 무엇을 갖고 싶으냐?"`,
            `페터는 얼굴이 새빨개져서 아무 말도 못 했습니다.`,
            `그는 며칠 동안 자기가 벌을 받을 거라고 생각하고 있었기 때문입니다.`,
            `제제만 씨는 그날 저녁 하이디를 따로 불렀습니다.`,
            `"하이디야, 너에게 무엇을 해 주면 좋겠느냐. 무엇이든 말해 보아라."`,
            `하이디는 한참 생각했습니다.`,
            `그러고는 이렇게 말했습니다.`,
            `"페터의 할머니께 부드러운 빵을 보내 주세요."`,
            `"그것뿐이냐?"<br>"네. 할머니는 이가 없으셔서 딱딱한 빵을 못 드세요."`,
            `제제만 씨는 잠깐 아무 말도 하지 못했습니다.`,
            `그러고는 그렇게 하겠다고 했습니다.`,
            `그리고 그 약속은 할머니가 살아 계신 동안 지켜졌습니다.`
        ]
    },
    {
        num: 15,
        ...
        paras: [
            ...
            `밤에 다락 창으로 별을 보다가 하이디는 가끔 이런 생각을 했습니다.`,
            `프랑크푸르트의 그 큰 집에서 밤마다 문 앞에 서 있던 때를요.`,
            `그때 아이는 자기가 무엇을 그리워하는지도 몰랐습니다. 다만 견딜 수가 없어서 자면서 걸어 나갔던 것입니다.`,
            `이제는 압니다.`,
            `창밖에서 전나무 세 그루가 낮게 울고 있었습니다.`,
            `하이디는 그 소리를 들으며 잠들었습니다.`,
            `클라라의 할머니는 페터를 다시 불렀습니다.`,
            `페터는 이번에도 얼굴이 새빨개졌습니다.`,
            `"무엇을 갖고 싶으냐?"<br>"······없습니다."`,
            `할머니는 웃으면서 페터의 손에 돈을 쥐여 주었습니다.`,
            `"이건 해마다 보내마. 겨울에 쓰거라."`,
            `페터는 그 돈을 들고 집으로 뛰어갔습니다.`,
            `그리고 할머니에게 그것을 다 드렸습니다.`,
