...
const CHAPTERS = [
    {
        ...
        paras: [
            ...
            `가진 옷이 그것뿐이기도 했습니다.`,
            `아이는 걸을 때마다 땀을 흘렸습니다.`,
            `도르플리라는 마을을 지날 때 사람들이 데테를 불러 세웠습니다.`,
            `산에 가려면 그 마을을 꼭 지나야 했습니다.`,
            `마을 사람들이 문 앞에 나와 있었습니다.`,
            ...
            `그 노인에 대해서는 이런저런 소문이 많았습니다.`,
            `젊어서 재산을 다 잃고 산으로 들어갔다는 이야기도 있었습니다.`,
            ...
            `염소를 그렇게 가까이서 본 것은 처음이었습니다.`,
            `아이가 손을 뻗자 염소가 냄새를 맡았습니다.`,
            `"하이디, 뭐 하는 거야!"<br>"더워요."`,
            `아이는 그 말만 하고 계속 벗었습니다.`,
            `데테가 말릴 새도 없었습니다.`,
            `아이는 겉옷을 벗고, 그 아래 옷도 벗고, 목도리도 풀었습니다. 그러고는 그것을 한 무더기로 쌓아 길가 풀밭에 놓았습니다.`,
            `나중에 페터가 그것을 챙겨 왔습니다.`,
            `그러지 않았으면 그 옷은 그 자리에 그대로 있었을 것입니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `데테는 그 말을 아주 빠르게 했습니다.`,
            `오래 있으면 마음이 흔들릴까 봐 그랬습니다.`,
            ...
            `한 번도 뒤를 돌아보지 않았습니다.`,
            `돌아보면 못 갈 것 같았기 때문입니다.`,
            `노인은 그 뒷모습을 한참 보았습니다. 그러고는 걸상에 앉아 다시 파이프를 물었습니다.`,
            `하이디는 그동안 그 자리에 없었습니다.`,
            `울고 있을 줄 알았는데 아니었습니다.`,
            `노인은 아이를 찾아 둘러보았습니다.`,
            `아이는 오두막 뒤로 돌아가 염소 우리를 들여다보고, 전나무 밑에 서서 바람 소리를 듣고, 산 아래를 내려다보고 있었습니다.`,
            `아이는 그 집이 마음에 들었습니다.`,
            `넓고 조용했기 때문입니다.`,
            `한참 뒤에 하이디가 돌아왔습니다.`,
            `"할아버지, 저 나무들이 소리를 내요."<br>"바람이 그러는 거다."`,
            `그것이 노인이 아이에게 한 첫마디였습니다.`,
            `말이 아주 짧았습니다.`,
            `"저는 어디서 자요?"`,
    ...
    },
    {
        ...
        paras: [
            ...
            `그래서 재미없다고 한 것이었습니다.`,
            `하이디는 그 말을 믿지 않았습니다.`,
            `그해 겨울, 눈이 오두막 문 높이까지 쌓였습니다. 할아버지는 아침마다 나가서 눈을 치웠습니다.`,
            `문을 열려면 먼저 파야 했습니다.`,
            `아침마다 그 일이 한 시간이었습니다.`,
            `하이디는 그 옆에서 작은 삽으로 따라 했습니다.`,
            `눈을 다 치우고 나면 두 사람은 안에 들어가 불을 쬐었습니다. 할아버지는 나무를 깎아 숟가락과 그릇을 만들었습니다.`,
            `손재주가 아주 좋았습니다.`,
            `젊어서 목수 일을 한 적이 있다고 했습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `글자가 무슨 모양인지도 몰랐습니다.`,
            `"할머니, 저 글을 못 읽어요."`,
            `그리고 그날, 하이디는 처음으로 글을 배우고 싶다고 생각했습니다.`,
            `누가 시킨 것이 아니었습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `그 말이 노인을 찔렀습니다.`,
            `아이 앞길을 막는다는 말이었습니다.`,
            `할아버지는 아무 말도 하지 않았습니다.`,
            `그러고는 안으로 들어가 문을 닫았습니다. 데테는 하이디를 데리고 산을 내려갔습니다.`,
            `아이 손을 꼭 잡고 갔습니다.`,
            `놓으면 뛰어 올라갈 것이기 때문입니다.`,
            `말릴 말이 없었기 때문입니다.`,
            `그 말이 맞을지도 모른다고 생각한 것입니다.`,
            ...
            `앞이 보이지 않으니 소리로만 배웅한 것이었습니다.`,
            `그 뒤로 한 해 동안 그 발소리를 기다렸습니다.`,
            `그날 저녁, 할아버지는 오두막에서 나오지 않았습니다.`,
            `불도 켜지 않았습니다.`,
            `이튿날 아침 그는 아이가 자던 다락으로 올라갔습니다. 건초 위에 홑이불이 그대로 있었습니다.`,
            `아이가 자던 자리가 눌려 있었습니다.`,
            `여러 해 만에 다시 혼자가 된 것이었습니다.`,
            `그런데 이번에는 전보다 훨씬 견디기 어려웠습니다.`,
            `그는 그 창밖을 오래 보았습니다.`,
            `산길을 내려가는 동안 하이디는 여러 번 뒤를 돌아보았습니다. 전나무 세 그루가 점점 작아졌습니다.`,
            `이모가 자꾸 손을 당겼습니다.`,
            `전나무 세 그루가 점점 작아졌습니다.`,
            `"이모, 정말 곧 와요?"<br>"그래."<br>"할아버지한테 말도 안 하고 왔는데."<br>"아까 봤잖니."`,
            `그것은 인사가 아니었습니다. 하이디는 그것을 알고 있었습니다.`,
            `문 닫히는 소리를 들은 것이 전부였습니다.`,
            `하이디는 그것이 마음에 걸렸습니다.`,
            `마이엔펠트에서 기차를 탔습니다.`,
            `하이디는 기차를 처음 탔습니다. 창밖으로 산이 뒤로 밀려 갔습니다. 산이 낮아지고, 낮아지다가, 마침내 보이지 않게 되었습니다.`,
            `하이디는 창에 얼굴을 붙이고 있었습니다.`,
            `산이 사라지자 아이는 자리에 앉았습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `데테가 데려다주면서 그렇게 일러 두었던 것입니다.`,
            `할머니는 그 아이를 안았습니다.`,
            `"울고 싶으면 울어라. 그리고 견디기 힘들면 마음속으로 말해도 된단다. 아무도 못 듣는 데다 대고 다 말해도 돼."`,
            `하이디는 그 말을 오래 붙들고 있었습니다.`,
            `그러나 할머니는 곧 그 집을 떠났습니다.`,
            `그 뒤로 그 집에 이상한 일이 생겼습니다. 밤마다 현관문이 열려 있는 것이었습니다.`,
            `아무도 그 까닭을 몰랐습니다.`,
            `아침에 하인이 내려와 보면 빗장이 풀려 있고 문이 반쯤 열려 있었습니다.`,
            `집 안이 시끄러워졌습니다. 도둑이 든다는 사람도 있고 유령이라는 사람도 있었습니다.`,
            `하인들이 밤에 계단을 다니지 않으려 했습니다.`,
            `제제만 씨가 집에 돌아왔습니다. 그리고 친구인 의사와 함께 밤을 새우기로 했습니다.`,
            `둘 다 총을 옆에 두었습니다.`,
            `두 사람은 촛불을 끄고 현관 옆방에서 기다렸습니다.`,
            `새벽 한 시가 지났을 때, 계단에서 아주 작은 소리가 났습니다. 두 사람은 문틈으로 내다보았습니다.`,
            `맨발 소리였습니다.`,
            `하얀 것이 계단을 내려오고 있었습니다.`,
            `제제만 씨가 등불을 들고 나섰습니다.`,
            `그리고 그 자리에서 멈췄습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `클라라가 하인에게 시켜 모아 둔 것이었습니다.`,
            `클라라가 그동안 하이디의 이야기를 다 기억하고 있었던 것입니다.`,
            `하이디는 클라라를 끌어안았습니다.`,
            `헤어지는 것이 슬프면서도 가는 것이 좋았습니다.`,
            `"클라라, 언젠가 우리 산에 와."<br>"갈게. 꼭 갈게."`,
            `그때는 두 아이 다 그 말이 이루어질 줄 몰랐습니다.`,
            `그런데 이루어집니다.`,
            ...
            `들이 언덕이 되고 언덕이 산이 되었습니다.`,
            `산이 보였기 때문입니다.`,
            `따라온 사람이 뒤에서 부르는데도 서지 않았습니다.`,
            ...
            `열두 개였습니다.`,
            `할머니는 그것을 하나씩 세어 보았습니다.`,
            `할머니가 그 빵을 손으로 만졌습니다. 그리고 울었습니다.`,
            `그런 빵을 만져 본 지 여러 해였습니다.`,
            `하이디는 그 옆에 앉아 있었습니다.`,
            `"그리고 할머니, 저 이제 글 읽어요."`,
            `할머니가 고개를 들었습니다.`,
            `하이디는 선반에서 찬송가 책을 꺼내 펴고 읽기 시작했습니다. 할머니는 두 손을 모으고 그것을 들었습니다.`,
            `그 노래를 다시 듣기까지 여러 해가 걸린 것이었습니다.`,
            `해가 기울 무렵 하이디는 산으로 올라갔습니다.`,
            `전나무 세 그루가 보였습니다. 그 아래 걸상에 할아버지가 앉아 있었습니다.`,
            `바람에 낮게 울고 있었습니다.`,
            `한 해 만에 듣는 소리였습니다.`,
            ...
            `그리고 손등으로 눈을 닦았습니다.`,
            `아이는 그것을 보지 못했습니다.`,
            `그날 저녁 세 사람이 오두막 앞에 앉았습니다. 할아버지가 빵을 자르고 치즈를 불에 녹여 얹었습니다.`,
            `한 해 전과 똑같았습니다.`,
            `하이디가 그것을 받아 들고 말했습니다.<br>"할아버지, 저는 프랑크푸르트에서 이걸 제일 생각했어요."<br>"그 집에는 더 좋은 게 많았을 텐데."<br>"많았어요. 그런데 이게 더 맛있어요."`,
            `할아버지가 고개를 돌렸습니다.`,
            `할아버지는 대답 대신 한 조각을 더 잘라 주었습니다.`,
            `그날 밤 하이디는 다락에 올라가 둥근 창을 열었습니다. 별이 가득했습니다.`,
            `찬 바람이 들어왔습니다.`,
            `별이 가득했습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `가을 내내 그 일을 했습니다.`,
            `혼자서 다 했습니다.`,
            `그해 겨울, 두 사람은 그 집에서 지냈습니다.`,
            `하이디는 처음으로 학교에 갔습니다. 글을 이미 읽을 줄 알아서 선생님이 놀랐습니다.`,
            `"이 아이는 어디서 배웠습니까?"<br>"프랑크푸르트에서요."`,
            `선생님은 그 말을 듣고 고개를 끄덕였습니다.`,
            `하이디는 학교에서 셈도 배우고 글씨 쓰는 법도 배웠습니다. 학교가 끝나면 곧장 페터의 집으로 갔습니다. 그리고 할머니에게 그날 배운 것을 다 이야기했습니다.`,
            `마을 사람들은 알름 할아버지가 마을에 내려온 것을 보고 처음에는 어색해했습니다. 그런데 겨울이 지나는 동안 조금씩 달라졌습니다.`,
            `말은 여전히 적었습니다.`,
            `할아버지가 눈길을 치우는 것을 사람들이 보았습니다. 남의 집 앞까지 치우는 것도요.`,
            `아무 말도 하지 않고 치우고 갔습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `한 해 전에 한 약속을 지키러 오는 것이었습니다.`,
            `의사 선생님이 먼저 와서 산을 보고 갔습니다. 그리고 클라라가 여기서 지내면 좋겠다고 했습니다.`,
            `공기가 좋고 볕이 잘 든다고 했습니다.`,
            `유월의 어느 날, 산길로 사람들이 올라왔습니다. 가마에 앉은 클라라와 그 할머니, 그리고 짐꾼들이었습니다.`,
            `하이디는 산길을 뛰어 내려가 마중을 나갔습니다.`,
            `숨이 차서 말도 못 했습니다.`,
            `클라라는 오두막 앞에 이르러 주위를 둘러보았습니다.`,
            `전나무 세 그루가 바람에 울고 있었습니다. 아래로 골짜기가 펼쳐졌고, 위로는 바위산이 솟아 있었습니다.`,
            `클라라는 그런 것을 그림으로만 보았습니다.`,
            `"하이디." 클라라가 말했습니다.<br>"네가 말한 그대로야."`,
            `그러고는 한참 아무 말도 하지 못했습니다.`,
            `할아버지는 클라라를 안아 바퀴 의자에서 걸상으로 옮겨 앉혔습니다.`,
            `그리고 염소젖을 한 잔 짜서 가져왔습니다. 클라라는 그 냄새를 맡고 얼굴을 찌푸렸습니다.`,
            `갓 짠 것이라 아직 따뜻했습니다.`,
            `"드셔 보십시오." 할아버지가 말했습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `어느 아침, 페터가 오두막 앞으로 올라왔습니다.`,
            `여느 때보다 일찍 올라온 것이었습니다.`,
            `염소를 아래에 두고 왔습니다.`,
            ...
            `다들 아주 낫거나 아주 못 낫거나 둘 중 하나로만 말했습니다.`
        ]
    },
    {
        num: 13,
        ...
        paras: [
            ...
            `"하이디, 나 걸었어."`,
            `세 아이가 다 소리를 질렀습니다.`,
            `그날부터 세 아이는 날마다 그 연습을 했습니다. 두 걸음이 세 걸음이 되고, 세 걸음이 열 걸음이 되었습니다.`,
            `아무에게도 말하지 않고 했습니다. 놀라게 해 주려던 것이었습니다.`,
            `그동안 페터는 아무에게도 그 이야기를 하지 않았습니다. 그리고 어느 날 하이디에게 털어놓았습니다.`,
            `"하이디, 그 의자······ 내가 그랬어."`,
            `하이디는 한참 아무 말도 하지 않았습니다.`,
            `그 말이 무슨 뜻인지 알아듣는 데 잠깐 걸렸습니다.`,
            ...
            `페터는 그 말이 제일 무서웠습니다.`,
            `페터는 며칠을 더 미루다가 결국 말했습니다.`,
            `할아버지는 페터를 한참 보았습니다.`,
            `페터는 눈을 감았습니다.`,
            `"그래. 말했으니 됐다."`,
            `그것이 전부였습니다.`,
            `야단도 치지 않았고 벌도 주지 않았습니다.`
        ]
    },
    {
        num: 14,
        ...
        paras: [
            `가을이 되기 전, 제제만 씨가 산에 올라왔습니다. 딸을 데리러 온 것이었습니다.`,
            `여름이 다 가고 있었습니다.`,
            `산에 벌써 찬 바람이 돌았습니다.`,
            ...
            `한 걸음씩 옮기고 있었습니다.`,
            `아주 천천히였습니다.`,
            `제제만 씨는 그 자리에 굳어 섰습니다. 그리고 두 손으로 얼굴을 가렸습니다.`,
            `여러 해 동안 못 보던 모습이었습니다.`,
            `아니, 한 번도 본 적이 없는 모습이었습니다.`,
            `클라라가 아버지 앞까지 와서 멈췄습니다.`,
            `"아버지, 저 걸어요."`,
            `목소리가 떨렸습니다.`,
            `그리고 웃고 있었습니다.`,
            `제제만 씨는 무릎을 꿇고 딸을 안았습니다.`,
            `한참 뒤에 그는 할아버지에게 걸어갔습니다.`,
            `"무엇으로 갚아야 할지 모르겠습니다."<br>"갚을 것 없습니다." 할아버지가 말했습니다.<br>"산이 한 일입니다. 그리고 저 아이들이 한 일이고요."<br>"그래도 무엇이든 말씀해 주십시오."`,
            `제제만 씨는 무엇이든 하겠다고 했습니다.`,
            `할아버지는 자기 몫을 말하지 않았습니다.`,
            `여름 내내 업고 다닌 것은 그였습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `산길은 가팔랐기 때문입니다.`,
            `"조금이라도 걸어서 내려갈래요."`,
            `할아버지가 옆에서 팔을 잡아 주었습니다.`,
            `그리고 마지막에는 업어서 내려갔습니다.`,
            `그래서 산길 첫머리까지는 걸어서 내려갔습니다.`,
            `그 뒤로 여러 해가 지났습니다.`,
            `산은 해마다 같았고 아이들은 자랐습니다.`,
            `전나무만 그대로였습니다.`,
            `클라라는 해마다 여름에 산으로 왔습니다. 그리고 해마다 조금씩 더 걸었습니다.`,
            `세 해째 되던 해에는 산길을 혼자 올라왔습니다.`,
            `가마도 짐꾼도 없이 왔습니다.`,
            `페터의 할머니는 겨울마다 새 숄을 받았습니다. 클라라의 할머니가 보낸 것이었습니다. 그리고 하얀 빵이 끊이지 않았습니다.`,
            `약속을 한 번도 어기지 않았습니다.`,
            `그 집 겨울이 그 뒤로는 춥지 않았습니다.`,
            `페터는 글을 읽게 되었습니다. 아주 잘 읽지는 못했지만, 할머니에게 찬송가를 읽어 드릴 수는 있게 되었습니다.`,
            `할머니는 그 노래를 들으며 물레를 돌렸습니다.`,
            `손자가 읽어 주는 것이었습니다.`,
            `알름 할아버지는 마을에 자주 내려갔습니다.`,
            `겨울에는 아예 마을에서 지냈습니다.`,
            `이제 사람들은 그를 보고 길을 비키지 않았습니다. 오히려 인사를 했습니다.`,
            `아이 하나가 사람 하나를 마을로 데려온 것이었습니다.`,
            `여러 해 걸린 일이었습니다.`,
            `하이디는 학교에 다녔고, 겨울에는 마을에서 여름에는 산에서 지냈습니다.`,
            `밤에 다락 창으로 별을 보다가 하이디는 가끔 이런 생각을 했습니다. 프랑크푸르트의 그 큰 집에서 밤마다 문 앞에 서 있던 때를요.`,
            `그 큰 집에서 지낸 것이 꿈 같았습니다.`,
            `그런데 꿈이 아니었습니다.`,
            `그때 아이는 자기가 무엇을 그리워하는지도 몰랐습니다. 다만 견딜 수가 없어서 자면서 걸어 나갔던 것입니다.`,
            `말로 할 줄을 몰랐던 것입니다.`,
            `문을 열고 어디로 가려고 했는지도 몰랐습니다.`,
            `이제는 압니다.`,
            `그리워한 것은 이 소리였습니다.`,
            `전나무가 바람에 우는 소리였습니다.`,
            `창밖에서 전나무 세 그루가 낮게 울고 있었습니다.`,
            `하이디는 그 소리를 들으며 잠들었습니다.`
        ]
    }
];
/* ── 쪽 나누기 ─────────────────────────────────────────
