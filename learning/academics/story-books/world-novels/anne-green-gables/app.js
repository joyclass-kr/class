...
const CHAPTERS = [
    ...
    },
    {
        ...
        paras: [
            `마차가 달리는 동안 아이는 쉬지 않고 말했습니다.<br>"제 이름은 앤 셜리예요. 그런데 부르실 때는 코딜리아라고 불러 주시면 안 될까요? 아, 안 되겠죠. 그럼 앤이라고 불러 주세요. 대신 꼭 끝에 이(e)가 붙은 앤이에요. 앤(Ann)은 밋밋한데 앤(Anne)은 훨씬 근사해 보이거든요."<br>"아저씨, 제가 너무 말을 많이 하나요? 그러면 그만하라고 하세요. 저는 그만할 수 있어요. 어려운 일이지만 마음먹으면 할 수 있어요."<br>"괜찮다." 매슈가 말했습니다.<br>"얼마든지 하려무나."`,
            ...
            `앤은 그런 식으로 가는 길에 있는 것마다 이름을 새로 붙였습니다. 해가 질 무렵 마차가 초록 지붕 집 앞에 닿았습니다. 앤은 마차에서 내려 그 집을 올려다보았습니다.`,
            `"여기가······ 제 집이에요?" 매슈는 대답하지 못했습니다.`
        ]
    },
    {
        num: 3,
        ...
        paras: [
            ...
            `"없었다." 매슈가 겨우 말했습니다.<br>"저 아이만 있더구나."`,
            ...
            `"울 일이에요!" 앤이 고개를 들었습니다. 얼굴이 눈물범벅이었습니다.<br>"아주머니도 고아였다가 어떤 집에 갔는데, 그 집이 남자아이를 원했다는 걸 알게 되면 우실 거예요. 이건 제 인생에서 가장 비극적인 일이에요."`,
            `마릴라는 그날 밤 앤을 다락방에 재웠습니다.`,
            `아이가 올라간 뒤 마릴라가 말했습니다.<br>"내일 스펜서 부인에게 데려다주고 사정을 이야기해야겠다."`,
            `"그래야겠지." 매슈가 말했습니다. 그러고는 잠깐 있다가 덧붙였습니다.<br>"그런데 마릴라, 저 아이는 참 재미있는 아이더구나."`,
    ...
    },
    {
        ...
        paras: [
            ...
            `마릴라는 그 얼굴을 보았습니다. 그리고 자기가 무슨 말을 하는지 알기도 전에 이렇게 말하고 있었습니다.`,
            `"블루엣 부인, 죄송합니다. 저희가 아직 결정한 것이 아니라서요. 오늘은 데리고 돌아가겠습니다."`,
            `돌아오는 마차에서 앤은 한참 말이 없었습니다. 그러다 물었습니다.`,
            `"저를 데리고 계실 거예요?"<br>"아직 모르겠다." 마릴라가 말했습니다.<br>"다만 저 부인에게 보낼 수는 없겠더구나."`,
    ...
    },
    {
        ...
        paras: [
            ...
            `그 부인은 창가에 앉아 바느질을 하면서 길로 지나가는 것을 하나도 놓치지 않았고, 무엇이든 생각한 대로 말했습니다. 며칠 뒤 린드 부인이 초록 지붕 집에 왔습니다.`,
            `"그래, 그 아이를 보러 왔어요." 부인이 말했습니다. 앤이 부엌으로 들어왔습니다.`,
            ...
            `마릴라는 앤의 방으로 올라갔습니다. 앤은 침대에 엎드려 있었습니다.`,
            ...
            `이튿날 앤은 사과를 하겠다고 했습니다. 린드 부인의 집에서 앤은 무릎을 꿇고 두 손을 모았습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `"마음의 친구요." 앤이 말했습니다.<br>"속에 있는 것을 다 이야기할 수 있는 친구요."`,
            ...
            `"다이애나, 나랑 마음의 친구가 되어 줄래?" 앤이 물었습니다.<br>"그러면 맹세를 해야 해."`,
            ...
            `그날부터 두 아이는 늘 함께였습니다. 숲에 자기들만의 놀이집을 지었고, 시냇가에 이름을 붙였고, 나무 사이로 편지를 주고받았습니다.`,
            `놀이집은 자작나무 사이의 빈터에 널빤지를 얹어 만든 것이었습니다. 접시로 쓸 조각과 이 빠진 잔을 모아 두었고, 그 자리를 아이들끼리만 아는 이름으로 불렀습니다.`,
            `앤은 태어나서 처음으로 친구라는 것을 가졌습니다. 그해 가을부터 앤은 에이번리 학교에 다니기 시작했습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `그날부터 앤은 길버트에게 한마디도 하지 않았습니다. 다만 공부에서는 그를 이기기로 마음먹었습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `앤은 집으로 뛰어와 마릴라에게 그 이야기를 했습니다. 마릴라가 찬장을 열어 보고 이마를 짚었습니다.`,
    ...
    },
    {
        ...
        paras: [
            `그해 겨울 어느 밤이었습니다. 매슈와 마릴라는 이웃 마을에 다니러 가고 앤 혼자 집에 있었습니다. 밤 열한 시에 누가 문을 두드렸습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `그리고 그해 여름, 가장 큰 사고가 났습니다. 여자아이들이 배리네 마당에서 놀다가 서로 겁쟁이라고 놀리기 시작했습니다.`,
            ...
            `그래도 발목뼈가 부러졌습니다. 앤은 일곱 주 동안 누워 있어야 했습니다.`,
            `그 일곱 주 동안 앤의 방에는 손님이 끊이지 않았습니다. 학교 아이들이 날마다 찾아왔고, 앨런 목사 부인도 열네 번을 다녀갔습니다. 조시 파이까지 왔습니다.`,
            `"이렇게 많은 사람이 나를 좋아하는 줄 몰랐어요." 앤이 말했습니다. 마릴라는 그 말을 듣고 밖으로 나갔습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `그때부터 두 해 동안 앤은 공부했습니다. 저녁마다 등불 아래에서 책을 읽었고, 겨울이면 손이 곱아 연필을 놓치기도 했습니다.`,
            ...
            `결과가 나오는 데는 세 주가 걸렸습니다. 그날 저녁 다이애나가 신문을 들고 언덕을 뛰어 올라왔습니다.`,
            `"앤! 앤! 네가 일 등이야!"`,
    ...
    },
    {
        ...
        paras: [
            `앤은 여왕 학원에서 한 해 만에 이 년 과정을 마쳤습니다. 졸업식이 있기 전, 매슈는 마을 가게에 갔습니다.`,
            ...
            `앤이 집으로 돌아온 것은 유월이었습니다. 그해 여름은 초록 지붕 집에서 가장 좋은 여름이었습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `앤은 그 자리에 멈춰 섰습니다. 길버트는 모자를 벗고 지나가려 했습니다.`,
            `"길버트." 앤이 불렀습니다. 길버트가 돌아섰습니다.<br>"학교 자리 말인데······ 고마워." 앤이 말했습니다.`,
            `길버트는 얼굴이 빨개졌습니다.<br>"별것 아니야. 나는 어디서 시작하든 상관없거든."`,
            `두 사람은 잠깐 아무 말도 하지 못했습니다.`,
            `"길버트." 앤이 다시 말했습니다.<br>"오 년 전에 네가 사과했을 때 내가 안 받아 줬잖아. 그 뒤로 계속······ 미안했어."`,
    ...
    },
    {
        ...
        paras: [
            ...
            `대학에 가는 데는 사 년이 아니라 그보다 더 걸릴 것이었습니다. 어느 날 저녁, 앤은 창가에 앉아 있었습니다.`,
