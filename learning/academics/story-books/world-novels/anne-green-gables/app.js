...
const CHAPTERS = [
    {
        ...
        paras: [
            ...
            `언덕 아래 시냇가에 있는 집이었습니다. 지붕이 초록빛이라 그렇게 불렀습니다.`,
            `둘레에 사과나무가 심겨 있어서 봄이면 온통 하얬습니다.`,
            `그 집에는 남매가 살았습니다. 예순 살 매슈 커스버트와, 그보다 다섯 살 아래인 마릴라 커스버트였습니다. 두 사람 다 결혼을 하지 않았습니다.`,
            `그 집에서 나고 자라 그 집에서 늙어 가는 중이었습니다.`,
            `부모가 물려준 농장이었습니다.`,
            `매슈는 몹시 수줍은 사람이었습니다. 낯선 사람만 보면 말을 못 했고, 특히 여자 앞에서는 더 그랬습니다. 마릴라는 반대로 말이 짧고 단단했습니다. 웃는 일이 드물었습니다.`,
            `가게에 갈 일이 생기면 며칠 미루었습니다.`,
            `둘은 한집에서 육십 년을 살면서 서로에게 긴 말을 해 본 적이 없었습니다.`,
            `두 사람은 나이가 들었고 농장 일은 힘에 부쳤습니다. 그래서 고아원에서 남자아이를 하나 데려오기로 했습니다. 열한 살쯤 되어 일손을 도울 수 있는 아이면 좋겠다고 했습니다.`,
            `린드 부인은 그것을 두고 위험한 일이라고 했습니다. 어떤 아이가 올지 모른다는 것이었습니다.`,
            `그 시절에는 그런 일이 흔했습니다. 고아원에서 아이를 데려다 일을 시키고 먹여 주는 것이었습니다.`,
            `잘되면 그 집 아이가 되고, 안 되면 그냥 일꾼이 되었습니다.`,
            `그날 오후, 매슈는 그 아이를 데리러 브라이트 리버 역으로 마차를 몰았습니다.`,
            `가는 내내 무슨 말을 해야 하나 하고 걱정했습니다.`,
            `아이에게 말을 걸어 본 적이 없었기 때문입니다.`,
            `역에 닿았을 때 기차는 이미 떠난 뒤였습니다. 승강장에는 아무도 없었습니다.`,
            `매슈가 늦은 것이었습니다.`,
            `매슈는 마음이 놓이면서도 이상했습니다.`,
            ...
            `그 가방이 아이가 가진 것 전부였습니다.`,
            `옷 두 벌과 낡은 빗 하나가 들어 있었습니다.`,
            `가장 먼저 눈에 들어온 것은 머리카락이었습니다. 두 갈래로 땋아 늘였는데 아주 새빨간 빛이었습니다.`,
            `그 머리 때문에 앤은 여러 해 동안 마음고생을 하게 됩니다.`,
            `아이 자신이 그것을 제일 싫어했습니다.`,
            `얼굴은 작고 마르고 주근깨가 많았습니다. 그런데 눈이 아주 컸습니다. 그 눈은 어떤 때는 초록빛으로, 어떤 때는 잿빛으로 보였습니다.`,
            `그리고 그 눈이 무언가를 볼 때는 아주 크게 열렸습니다.`,
            `매슈는 그 눈을 보고 무슨 말을 해야 할지 더 몰라졌습니다.`,
            ...
            `고아원에서 사람을 잘못 보낸 것이었습니다.`,
            `그런 말은 마릴라가 해야 할 것이었습니다.`,
            `"자, 타거라." 그는 겨우 그렇게 말했습니다.`,
            `아이가 가방을 들고 마차에 올라탔습니다.`,
            `그리고 그 순간부터 다시 말하기 시작했습니다.`
        ]
    },
    {
        num: 2,
    ...
    },
    {
        ...
        paras: [
            ...
            `아이는 어른들 얼굴을 읽는 데 익숙했습니다. 그런 집에서만 자랐기 때문입니다.`,
            `아이는 가방을 바닥에 내려놓았습니다.`,
            `가방 소리가 났습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `초록 지붕 집에서 언덕 하나 아래에 살았습니다.`,
            `그 집 창에서 큰길이 다 내려다보였습니다.`,
            `그 부인은 창가에 앉아 바느질을 하면서 길로 지나가는 것을 하나도 놓치지 않았고, 무엇이든 생각한 대로 말했습니다.`,
            `나쁜 사람은 아니었습니다. 다만 말을 고르지 않았습니다.`,
            `마을에 궂은일이 생기면 제일 먼저 달려가는 사람이기도 했습니다.`,
            `며칠 뒤 린드 부인이 초록 지붕 집에 왔습니다.`,
            `그동안 몸이 아파 못 오고 있던 참이었습니다.`,
            ...
            `부인은 그 말을 웃으면서 했습니다.`,
            `나쁜 마음으로 한 말이 아니었습니다. 그런데 듣는 쪽에서는 그것이 상관없었습니다.`,
            ...
            `매슈는 그렇게 말하고 얼른 내려갔습니다.`,
            `이튿날 앤은 사과를 하겠다고 했습니다. 린드 부인의 집에서 앤은 무릎을 꿇고 두 손을 모았습니다.`,
            `마릴라는 그 자세를 보고 무언가 잘못되어 간다고 느꼈습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `마릴라는 그런 말에 대답하는 법을 끝내 배우지 못했습니다.`,
            `그래서 그냥 산수를 하라고만 했습니다.`
        ]
    },
    {
        num: 7,
    ...
    },
    {
        ...
        paras: [
            ...
            `앤은 손님을 대접하는 것이 즐거웠습니다.`,
            `다이애나는 세 잔을 마셨습니다.`,
            `세 잔째를 마시고 나서 얼굴이 빨개졌습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `세 살짜리 동생이었습니다.`,
            `의사는 다른 마을에 왕진을 가 있었습니다.`,
            `크루프는 목이 부어 숨길이 막히는 병이었습니다. 어린아이에게는 아주 위험했습니다.`,
            `그해 겨울에 그 병으로 아이가 여럿 갔습니다.`,
            `빨리 손을 쓰지 않으면 몇 시간 안에 잘못되었습니다.`,
            `앤은 이미 옷을 걸치고 있었습니다.`,
            `다이애나가 말을 다 하기 전에 벌써 움직였습니다.`,
            `숄을 두르고 등불을 챙겼습니다.`,
            `"내가 갈게. 나는 크루프를 여러 번 봤어."`,
            `앤이 그렇게 말하자 다이애나가 울음을 그쳤습니다.`,
            `앤은 해먼드 아주머니 집에서 쌍둥이 여섯을 돌보며 자랐습니다. 그중 크루프에 걸린 아이가 셋이었습니다.`,
            `그때 앤은 아홉 살이었습니다.`,
            `그 집에서 밤을 새운 적이 여러 번이었습니다.`,
            `앤은 부엌에서 토근 시럽을 챙겨 병에 담고, 다이애나와 함께 눈길을 달렸습니다.`,
            `달이 밝아서 눈이 파랗게 보였습니다.`,
            `두 아이는 한 번도 쉬지 않고 뛰었습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `그 시절 여자가 스스로 벌어먹을 수 있는 길이 그리 많지 않았습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `마릴라가 그 설탕을 보고 무슨 일이냐고 물었습니다. 매슈는 대답하지 못했습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `마릴라는 그 말을 하면서 앤을 보지 않았습니다.`,
            `앤은 그날 밤 자기 방에서 오래 앉아 있었습니다.`,
            `창밖으로 매슈가 걷던 밭이 보였습니다.`,
            `이튿날 아침, 앤이 말했습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `그해 가을에 그 나무에 사과가 처음 열렸습니다.`,
            `앤은 그것을 따서 마릴라에게 가져다주었습니다.`,
