...
const CHAPTERS = [
    {
        ...
        paras: [
            ...
            `고양이 꼬리를 밟고, 거위를 쫓아 몰고, 새 둥지를 헐었습니다. 그 집 짐승들은 다 닐스를 무서워했습니다.`,
            `삼월 어느 일요일 아침이었습니다.`,
            `부모가 교회에 가면서 닐스에게 말했습니다.<br>"오늘은 성경을 열 쪽만 읽어라."<br>"네."`,
            `어머니가 책장을 펴서 표를 끼워 놓고 갔습니다. 여기서 여기까지라고 손가락으로 짚어 주었습니다.`,
            ...
            `손바닥만 한 사람이었습니다. 수염이 있고, 챙 넓은 모자를 쓰고, 무릎 아래를 여민 바지를 입고 있었습니다.`,
            `스웨덴 시골에서 톰테라고 부르는 것이었습니다. 집을 지켜 준다는 작은 도깨비입니다.`,
            `스웨덴 시골집에서는 톰테에게 겨울마다 죽을 한 그릇 내놓는 풍습이 있었습니다. 그렇게 하면 집안이 무사하다고 여겼습니다.`,
            `닐스는 잠자리채를 들었습니다. 그리고 그것을 덮어씌워 잡았습니다.`,
            `톰테가 말했습니다.<br>"놓아 다오. 놓아 주면 은동전 하나를 주마."`,
            `닐스는 그 말을 듣고 욕심이 났습니다.`,
            `은동전 하나면 마을 가게에서 살 것이 여럿 있었습니다.`,
            `톰테를 잡으면 소원을 들어준다는 이야기를 닐스도 들은 적이 있었습니다.`,
            ...
            `어디서 나왔는지도 몰랐습니다. 그물코 하나가 벌어져 있었던 모양입니다.`,
            `아주 작은 손이었는데 눈앞이 캄캄해졌습니다. 닐스는 그 자리에 쓰러졌습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `거울 앞까지 가는 데도 한참이 걸렸습니다. 마룻바닥의 틈이 도랑처럼 넓었습니다.`,
            `닐스는 소리를 질렀습니다. 소리도 아주 작게 나왔습니다.`,
            `그런데 그때 이상한 일이 하나 더 있었습니다. 밖에서 참새들이 하는 말이 들렸습니다.`,
            `"저것 봐! 저 못된 애가 저렇게 됐어!"`,
            `"쌤통이다!"`,
            `짐승의 말이 다 들렸습니다. 그동안 닐스가 짐승들에게 한 일을 짐승들은 하나도 잊지 않고 있었습니다. 그리고 그것을 그날 다 말했습니다.`,
            `닐스는 마당으로 나갔습니다. 고양이가 앞을 막았습니다.`,
            `닐스는 늘 하던 대로 발로 차려고 했습니다. 그런데 이제 그 고양이가 닐스보다 훨씬 컸습니다.`,
            `고양이가 앞발로 닐스를 눌렀습니다.`,
            `그리고 이렇게 말했습니다.<br>"이제 내가 원하면 언제든 되겠구나."`,
            `그러고는 놓아 주었습니다.`,
            `닐스는 그때 처음으로 무섭다는 것이 어떤 것인지 알았습니다.`,
            ...
            `거위가 날아가면 아버지에게 크게 야단맞을 것이었습니다. 그 집에서 제일 값이 나가는 거위였습니다.`,
            `말리려고 한 것이었습니다.`,
            `"안 돼! 내려와!"`,
    ...
    },
    {
        ...
        paras: [
            ...
            `기러기는 무리에서 제일 늙고 길을 잘 아는 것이 앞에 섭니다. 힘이 센 것이 아니라 길을 아는 것이 앞에 섭니다.`,
            `아카는 그 산에서 태어났고, 백 살이 넘었다고 했습니다. 그해에도 아카가 무리를 이끌고 북쪽으로 가는 길이었습니다.`,
            `목에 흰 줄이 있었고, 날개 끝이 닳아 있었습니다. 그런데 나는 것은 어느 젊은 기러기보다 나았습니다.`,
            `저녁이 되자 무리가 호수에 내려앉았습니다.`,
            `기러기는 밤에 물 위에서 잡니다. 뭍에서 자면 여우에게 물리기 때문입니다. 삼월에는 아직 호수에 얼음이 남아 있었습니다.`,
            `아카가 모르텐 앞에 왔습니다.<br>"너는 집거위구나."<br>"그렇습니다."`,
            `"집거위는 우리를 따라올 수 없다. 라플란드까지는 아주 멀다."<br>"저는 갈 수 있습니다."`,
            `"그리고 저 아이는 무엇이냐."`,
            `아카가 닐스를 보았습니다.`,
            `"사람 아니냐. 사람은 안 된다."`,
            ...
            `여우는 겨울을 나느라 몹시 말라 있었습니다. 봄에 올라오는 기러기 떼는 여우에게 오랜만의 먹이였습니다.`,
            `기러기들은 물 한가운데 얼음 위에서 잤습니다. 여우가 얼음 위로 살금살금 갔습니다.`,
            `닐스는 그때 얼음 가장자리에 앉아 있었습니다. 잠이 오지 않았기 때문입니다.`,
            `그래서 그것을 보았습니다. 닐스는 소리를 질렀습니다.`,
            `"아카! 여우예요!"`,
            `기러기들이 다 날아올랐습니다. 여우는 아무것도 못 잡았습니다. 그런데 마지막에 한 마리를 물었습니다.`,
            `닐스는 그것을 보고 달려갔습니다. 그리고 여우 꼬리를 붙잡았습니다. 여우가 놀라 입을 벌렸습니다.`,
            `닐스는 그 꼬리털을 두 팔로 껴안고 매달렸습니다. 여우가 몸을 흔들어 닐스를 얼음 위로 내동댕이쳤습니다.`,
            `기러기가 빠져나갔습니다.`,
            `여우는 그 뒤로 닐스를 미워했습니다. 그리고 그해 내내 그 무리를 쫓아다녔습니다.`,
            `이튿날 아침, 아카가 닐스에게 말했습니다.<br>"너를 데려가겠다."`,
            `"왜요?"<br>"어젯밤 일 때문이다."`,
    ...
    },
    {
        ...
        paras: [
            ...
            `벽 두께가 사람 키만 했습니다. 창은 활을 쏘려고 낸 좁은 틈이었습니다.`,
            `수컷 황새의 이름은 에르멘리히였습니다. 어느 날 에르멘리히가 아카를 찾아왔습니다.`,
            `황새는 다리가 붉고 아주 깁니다. 날아올 때 그 다리를 뒤로 곧게 뻗고 옵니다.`,
            `"큰일 났습니다. 쥐들이 몰려옵니다."`,
            `에르멘리히는 날개를 접지도 못하고 서 있었습니다. 아주 먼 데서 곧장 날아온 참이었습니다.`,
            `사람이 떠난 집에는 쥐가 듭니다. 그리고 쥐가 들면 그 집은 더 빨리 무너집니다.`,
            `그 성 지하에는 오래전부터 쥐가 살고 있었습니다. 검은 쥐라고 불렀습니다.`,
            `그런데 나중에 다른 쥐들이 왔습니다. 회색 쥐라고 불리는 것들이었습니다. 수가 훨씬 많았습니다.`,
            `그 회색 쥐들이 그 성을 통째로 빼앗으려고 몰려오고 있었습니다.`,
            ...
            `한번 뒤를 돌아보았습니다. 들판이 다 움직이는 것처럼 보였습니다.`,
            `그리고 닐스는 그 쥐들을 아주 먼 데까지 데려갔습니다.`,
            `이 대목은 독일에 전해 오는 '하멜른의 피리 부는 사나이' 이야기에서 온 것입니다. 이 책을 쓴 셀마 라겔뢰프는 그 이야기를 잘 알고 있었습니다.`,
            `그리고 일부러 가져다 썼습니다.`,
            `다만 하멜른의 피리 부는 사나이는 값을 못 받자 아이들까지 데려갔습니다. 닐스는 아무 값도 받지 않았습니다.`,
            `같은 피리로 한 사람은 앙갚음을 했고, 한 사람은 그러지 않았습니다.`,
            `황새 에르멘리히가 물었습니다.<br>"무엇을 드리면 되겠습니까."<br>닐스가 말했습니다.<br>"제가 언제 다시 사람이 되는지 아세요?"<br>"모릅니다."<br>"그럼 됐습니다."`,
            `황새는 한참 닐스를 내려다보았습니다. 그리고 아무 말도 하지 못했습니다.`,
            `닐스가 바란 것은 그것 하나뿐이었기 때문입니다.`
        ]
    },
    {
        num: 5,
        ...
        paras: [
            `해마다 봄이면 쿨라베리라는 산에서 큰 모임이 열렸습니다. 짐승들의 모임이었습니다.`,
            `날짜가 정해져 있지는 않았습니다. 그런데 그날이 되면 짐승들이 다 알았습니다.`,
            `까마귀가 먼저 알고 소문을 냈다고도 하고, 바람 냄새로 안다고도 했습니다.`,
            `쿨라베리는 스코네의 바닷가에 있는 낮은 산입니다. 사람이 잘 올라가지 않는 곳이었습니다.`,
            `바위가 많고 길이 험해서 밭으로도 못 쓰고 목장으로도 못 쓰는 산이었습니다. 그래서 짐승들에게 남겨진 것입니다.`,
            `그날 하루만은 서로 잡아먹지 않기로 되어 있었습니다. 사슴과 늑대가 같은 자리에 있어도 아무 일이 없었습니다. 그런 규칙이 아주 오래전부터 있었습니다.`,
            `여우가 토끼 옆에 앉아 있었고, 매가 참새 옆 가지에 앉아 있었습니다.`,
            ...
            `토끼들이 풀밭을 가로질러 뛰었습니다. 뒤로 뛰기도 하고 옆으로 튀기도 했습니다.`,
            `보고 있던 짐승들이 발을 굴렀습니다.`,
            `제일 빠른 토끼가 마지막에 한 번 더 돌았습니다. 그러고는 풀밭 가장자리로 들어갔습니다.`,
            `그다음에 뇌조들이 나와 노래를 불렀습니다. 뇌조는 봄이면 목을 부풀리고 낮게 우는 새입니다. 그 소리가 숲 안에서 아주 멀리까지 갑니다.`,
            `그다음에 사슴들이 뿔을 맞대고 겨루었습니다.`,
            `마지막에 학들이 나왔습니다. 학들이 춤을 추었습니다.`,
            `풀밭 한가운데에서 회색 새들이 목을 세우고, 날개를 반쯤 펴고, 뛰어올랐다가 내려앉았습니다. 아무도 소리를 내지 않았습니다.`,
            `발끝으로 돌고, 서로 마주 보고 절을 하고, 다시 뛰어올랐습니다. 그림자가 풀밭 위에서 함께 움직였습니다.`,
            `해가 지고 있어서 그림자가 아주 길었습니다.`,
            `모여 있던 짐승들이 다 조용해졌습니다. 까마귀도 울지 않았습니다.`,
            `학은 사람이 보는 데서는 잘 추지 않습니다. 그래서 그것을 본 사람이 드뭅니다.`,
            `닐스는 그것을 본 몇 안 되는 사람 가운데 하나였습니다. 그때는 사람이 아니었지만요.`,
            `닐스는 그것을 보다가 목이 메었습니다. 왜 그런지 몰랐습니다.`,
            ...
            `늙은 짐승들이 앞에 나와 앉았습니다. 스미레는 그 앞에 끌려 나왔습니다.`,
            `스미레는 아무 변명도 하지 않았습니다. 입가에 아직 깃털이 붙어 있었습니다.`,
            `벌은 이랬습니다. 스미레는 그날부터 그 지방에서 쫓겨났습니다. 그리고 어느 짐승도 그와 말을 섞지 않기로 했습니다.`,
            `죽이지는 않았습니다. 짐승들의 규칙에는 죽이는 벌이 없었습니다.`,
            `스미레는 혼자 산을 내려갔습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `이 책은 사실 스웨덴의 지리를 가르치려고 쓴 책입니다. 백이십 년쯤 전에, 스웨덴의 학교에서 쓸 책이 필요했습니다.`,
            `아이들에게 이 나라가 어떻게 생겼는지 가르치는 책이었습니다. 그 일을 셀마 라겔뢰프라는 작가에게 맡겼습니다.`,
            `라겔뢰프는 삼 년 동안 스웨덴 곳곳을 돌아다녔습니다. 산과 호수와 도시를 다 보았습니다.`,
            `그리고 그것을 그냥 늘어놓지 않고, 아이 하나가 거위 등에 앉아 지나가는 이야기로 만들었습니다.`,
            `그래서 닐스가 지나가는 곳은 다 실제로 있는 곳입니다. 산도 호수도 도시도 다 진짜입니다. 그 가운데 이런 곳이 있었습니다.`,
            `지금도 스웨덴에 가면 그 자리에 그대로 있습니다.`,
            `발트해는 스웨덴 동쪽 바다입니다. 그 안에 섬이 아주 많습니다. 그 가운데 오래전에 큰 항구였다가 버려진 곳이 있었습니다.`,
            `그 섬에 낡은 성터가 있었습니다. 사람이 살지 않는 곳이었습니다.`,
            `돌담이 무너져 있었고 그 사이에 풀이 자라 있었습니다. 갈매기만 그 위에 앉아 있었습니다.`,
            ...
            `상인이 물건을 보여 주었습니다.`,
            `"이걸 사시오. 값은 동전 하나면 되오."`,
            `닐스는 주머니를 뒤졌습니다. 아무것도 없었습니다. 상인이 다른 가게로 데려갔습니다.`,
            `주머니에는 실밥과 마른 풀잎밖에 없었습니다.`,
            `거기서도 값은 동전 하나였습니다. 그 도시 사람들이 다 몰려나와 닐스를 둘러쌌습니다. 다들 무언가를 팔려고 했습니다.`,
            `금잔, 비단, 가죽 신, 유리 목걸이. 사람들이 그것을 닐스 앞에 내밀었습니다.`,
            `어떤 사람은 무릎을 꿇고 매달렸습니다. 닐스는 그 까닭을 그때 몰랐습니다.`,
            `값은 다 동전 하나였습니다. 닐스는 그 동전이 없었습니다. 그러자 새벽닭이 울었습니다. 그리고 도시가 사라졌습니다.`,
            `불빛이 꺼지고, 사람이 사라지고, 배가 사라졌습니다. 소리가 한꺼번에 그쳤습니다.`,
            ...
            `닐스는 그 자리에 주저앉았습니다.`,
            `"제가 동전이 없어서······."<br>"그래."`,
            `그날 닐스는 밤새 울었습니다. 자기 때문이 아니라 그 도시 사람들 때문이었습니다. 닐스가 그런 마음을 낸 것은 그때가 처음이었습니다.`,
            `봄에 떠날 때였다면 그냥 잊었을 일이었습니다.`
        ]
    },
    {
        num: 7,
        ...
        paras: [
            ...
            `스웨덴 가운데쯤에 베리슬라겐이라는 지방이 있습니다. 그 지방 땅속에 쇠가 많이 묻혀 있어서, 오래전부터 그것을 캐고 녹여 왔습니다.`,
            `어느 날 닐스가 무리에서 떨어졌습니다. 바람이 세게 불어 모르텐의 등에서 미끄러진 것입니다.`,
            `기러기는 바람이 세면 대오를 흩뜨렸다가 다시 모읍니다. 그날은 다시 모였을 때 닐스가 없었습니다.`,
            `닐스는 숲에 떨어졌습니다. 그리고 밤이 되었습니다.`,
            ...
            `곰은 겨울잠에서 깨고 나면 몹시 배가 고픕니다. 그리고 새끼가 있으면 더 사나워집니다.`,
            `어미 곰이 깼습니다. 그리고 닐스를 앞발로 눌렀습니다.`,
            `"사람 냄새가 나는구나."<br>"저는 사람이 아니에요."<br>"사람 냄새가 난다."`,
            `그때 밖에서 소리가 났습니다. 사람 목소리와 쇠붙이 소리였습니다.`,
            `광산 사람들이 다이너마이트를 들고 그 굴을 찾아온 것이었습니다. 그 곰이 광산 근처에 나타나 골칫거리였기 때문입니다.`,
            `어미 곰이 굳었습니다.`,
            `사람들이 굴 앞에 화약을 놓았습니다. 그리고 심지에 불을 붙이려고 했습니다.`,
            ...
            `심지가 지지직 소리를 내며 타들어 가고 있었습니다. 닐스는 그 앞을 두 손으로 덮쳤습니다.`,
            `불꽃이 손을 태웠습니다. 닐스는 그것을 눌러 껐습니다.`,
            `닐스는 소리를 내지 않았습니다. 소리를 내면 사람들이 알아채기 때문입니다.`,
            `사람들은 아무것도 보지 못했습니다. 닐스가 너무 작았기 때문입니다.`,
            `사람들은 화약이 불량이라고 여기고 돌아갔습니다.`,
            `닐스가 굴로 돌아왔습니다.`,
            `어미 곰이 한참 닐스를 보았습니다.`,
            `그러고는 이렇게 말했습니다.<br>"가거라."<br>"저를 안 잡아먹으시겠어요?"<br>"오늘은 안 잡아먹는다. 다음에 만나면 모른다."`,
            `닐스는 그것으로 됐다고 생각했습니다.`,
            `그 손의 자국은 오래 남았습니다. 나중에 사람으로 돌아간 뒤에도 남아 있었습니다.`
        ]
    },
    {
        num: 8,
        ...
        paras: [
            ...
            `그런데 그 상이 말에서 내려 걷기 시작했습니다. 발소리가 온 도시에 울렸습니다.`,
            `닐스는 무서워서 달아났습니다. 청동상이 따라왔습니다.`,
            `발밑에서 돌바닥이 울렸습니다. 뒤에서 나는 소리가 점점 가까워졌습니다.`,
            `닐스는 항구 쪽으로 달렸습니다. 거기에 다른 상이 하나 있었습니다. 나무로 만든 뱃사람 상이었습니다. 아주 낡은 것이었습니다.`,
            `닐스가 그 뒤로 숨었습니다. 그러자 그 나무상도 움직였습니다. 그리고 청동상 앞을 막아섰습니다.`,
            `두 상이 마주 섰습니다.`,
            `닐스는 나무상 발치에 붙어 서서 위를 올려다보았습니다.`,
            `하나는 아주 크고 반짝였습니다. 하나는 작고 색이 다 벗겨져 있었습니다.`,
            `청동상이 말했습니다.<br>"비켜라."<br>나무상이 말했습니다.<br>"이 아이가 무엇을 잘못했습니까."<br>"나를 보고 달아났다."<br>"그건 무서워서 그런 것입니다."`,
            `그때 새벽닭이 울었습니다. 두 상은 그 자리에 멈췄습니다. 그리고 다시 상이 되었습니다.`,
            `청동상은 길 한가운데 서 있었고, 나무상은 그 앞을 막은 자세 그대로였습니다.`,
            `아침이 되자 사람들이 그것을 보고 놀랐습니다. 밤사이에 누가 옮겨 놓았다고들 했습니다.`,
            `닐스는 그 나무상 발치에 앉아 아침까지 있었습니다. 그리고 그 뒤로 그 이야기를 아무에게도 하지 않았습니다. 누가 믿겠습니까.`,
            `나무상은 색이 다 벗겨져 있었고 한쪽 팔이 갈라져 있었습니다.`,
            `이 대목을 두고 사람들은 여러 가지를 말합니다.`,
            `어떤 사람은 이것이 스웨덴의 역사를 말한 것이라고 합니다. 청동상은 전쟁을 하던 시절의 왕이고, 나무상은 배를 타고 일하던 보통 사람이라는 것입니다. 그리고 아이를 지킨 것은 나무상이었습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `밤 열두 시에도 하늘이 밝았습니다. 닐스는 처음에 그것 때문에 잠을 못 잤습니다.`,
            `봄에 떠나서 여름에 닿은 것이었습니다. 스코네에서 라플란드까지는 스웨덴을 세로로 다 지나가는 길입니다.`,
            ...
            `여름이 두 달쯤입니다. 그 안에 못 자라면 가을에 남쪽으로 갈 수가 없습니다.`,
            `모르텐과 던핀 사이에 새끼가 여섯 마리 났습니다. 닐스는 그 여름 동안 그 새끼들을 돌보았습니다.`,
            `닐스는 그 여섯 마리에게 이름을 다 붙여 주었습니다. 그리고 물가에 나갈 때마다 수를 세었습니다.`,
            `그해 여름에 닐스는 아주 달라졌습니다. 스스로도 그것을 알았습니다.`,
            `봄에 떠날 때 닐스는 남이 무엇을 잃든 상관하지 않는 아이였습니다. 여름이 끝날 무렵에는 새끼 한 마리가 안 보이면 밤에 잠을 못 잤습니다.`,
            `한번은 새끼 하나가 갈대밭으로 들어가 안 나온 적이 있었습니다. 닐스는 밤새 그 갈대밭을 헤매고 다녔습니다.`,
            `새벽에 찾아냈습니다. 그 새끼는 갈대 사이에서 자고 있었습니다.`,
            `어느 날 아카가 물었습니다.<br>"너는 사람으로 돌아가고 싶으냐."`,
            `닐스는 잠깐 대답하지 못했습니다.`,
            `"모르겠어요."<br>"왜 모르느냐."<br>"사람으로 돌아가면 이 말들이 안 들리잖아요."`,
            `아카는 그 말에 아무 대꾸도 하지 않았습니다. 늙은 기러기는 대답하지 않는 것으로 대답하는 일이 많았습니다.`,
            `그해 가을, 무리가 남쪽으로 내려가기 시작했습니다.`,
            `가는 길에 닐스는 여러 번 자기 마을 쪽을 보았습니다. 그리고 어머니와 아버지를 생각했습니다.`,
            `봄에 떠날 때는 그 생각을 하지 않았습니다. 그해 가을에는 자꾸 났습니다.`,
            ...
            `닐스는 그 창밑에 오래 앉아 있었습니다. 그리고 그날 돌아가기로 마음을 정했습니다.`,
            `그런데 어떻게 하면 돌아갈 수 있는지를 몰랐습니다.`
        ]
    },
    {
        num: 10,
        ...
        paras: [
            `그런데 어떻게 하면 사람이 되는지를 아무도 몰랐습니다. 톰테를 다시 만나면 될 것 같았는데, 그 뒤로 톰테를 본 사람이 없었습니다.`,
            `닐스는 여러 짐승에게 물었습니다. 그러다 어느 날 대답을 들었습니다.`,
            `올빼미가 이런 이야기를 하는 것을 들은 것입니다.`,
            `"내가 톰테에게 들었는데, 그 아이가 사람이 되는 방법이 있다더군."<br>"뭔데?"<br>"자기 대신 다른 누구를 그렇게 만들면 된다더군."`,
            `닐스는 나뭇가지 뒤에 붙어서 그 말을 다 들었습니다.`,
            `닐스는 그 말을 듣고 얼어붙었습니다. 자기 대신 누군가가 작아져야 한다는 것이었습니다.`,
            `누구를 그렇게 만들 것인가. 모르텐인가, 던핀인가, 아카인가. 닐스는 그 생각을 하다가 그만두었습니다.`,
            `생각을 이어 갈수록 얼굴이 하나씩 떠올랐기 때문입니다.`,
            `짐승이 되는 것이 어떤 것인지 닐스는 이제 알고 있었습니다. 그것을 다른 누구에게 하라고 할 수는 없었습니다.`,
            `그 뒤로 닐스는 여러 날 잠을 못 잤습니다.`,
            `이 이야기의 여러 판본에서 그다음이 조금씩 다릅니다. 가장 널리 전해지는 것은 이렇습니다.`,
            `가을 기러기는 봄보다 천천히 갑니다. 새끼들이 아직 어리기 때문입니다.`,
            `무리가 남쪽으로 내려와 닐스의 마을 가까이에 이르렀습니다. 그리고 그때 일이 났습니다.`,
            `닐스의 아버지가 밭에서 모르텐을 발견한 것입니다. 봄에 날아간 자기 집 거위였습니다.`,
            `아버지는 그 거위를 알아보았습니다. 발에 난 흠집이 그대로였기 때문입니다.`,
            `아버지는 그것을 붙잡았습니다. 그리고 부엌으로 가져갔습니다.`,
            `그날 저녁 손님이 오기로 되어 있었습니다. 모르텐과 던핀과 새끼 여섯 마리가 다 붙잡혔습니다. 닐스는 그것을 창밖에서 보았습니다. 그리고 방법이 없었습니다.`,
            `여덟 마리가 다 부엌 구석에 묶여 있었습니다. 새끼들이 어미 밑으로 파고들었습니다.`,
            `작은 몸으로는 아무것도 할 수 없었습니다. 닐스는 그때 이렇게 생각했습니다.`,
            `'내가 사람이면 저것을 막을 수 있는데.'`,
            `그리고 그 순간이었습니다.`,
            `닐스가 부엌으로 뛰어들어 갔습니다. 그리고 소리를 질렀습니다.`,
            `어머니가 칼을 들고 있었고 아버지가 거위를 누르고 있었습니다.`,
            `"안 돼요!"`,
            `그 소리가 아주 컸습니다. 작은 몸에서 날 수 있는 소리가 아니었습니다.`,
            `어머니가 돌아보았습니다. 부엌 한가운데에 열네 살짜리 아이가 서 있었습니다.`,
            `닐스였습니다. 그 순간 사람이 된 것이었습니다. 누구를 대신 작게 만들어서가 아니었습니다.`,
            `자기가 사람이면 무엇을 할 수 있는지를 처음으로 생각했기 때문입니다. 그전까지 닐스는 사람인 것으로 남을 괴롭히기만 했습니다.`,
    ...
    },
    {
        ...
        paras: [
            `어머니가 그 자리에 주저앉았습니다. 아버지는 손에 든 것을 떨어뜨렸습니다.`,
            `여덟 달 만이었습니다. 그동안 두 사람은 그 아이가 죽었다고 여기고도 있었고, 살았다고 여기고도 있었습니다.`,
            `"닐스냐."<br>"저예요."<br>"어디 있었느냐."`,
            `아버지가 한 걸음 다가왔다가 멈춰 섰습니다. 손을 대면 사라질 것 같았기 때문입니다.`,
            `닐스는 대답하려다가 말았습니다. 말해도 믿지 않을 것이었기 때문입니다.`,
            `거위 등을 타고 라플란드까지 갔다 왔다고 하면 누가 믿겠습니까.`,
            `그때 닐스가 제일 먼저 한 말은 이것이었습니다.`,
            `"저 거위들 놓아 주세요."<br>아버지가 물었습니다.<br>"왜?"<br>"제 친구예요."`,
            `아버지는 그 말이 무슨 뜻인지 몰랐습니다. 그런데 아들의 얼굴을 보고 더 묻지 않았습니다.`,
            `여덟 달 만에 돌아온 아들이 처음으로 한 부탁이었습니다. 그래서 놓아 주었습니다.`,
            `모르텐과 던핀과 새끼들이 마당으로 나갔습니다. 그리고 하늘로 올라갔습니다.`,
            `모르텐이 한 번 낮게 돌았습니다. 닐스는 마당에 서서 그것을 보았습니다.`,
            `그날 저녁, 마당에서 기러기 소리가 났습니다. 닐스가 나가 보았습니다. 무리가 낮게 날면서 지나가고 있었습니다.`,
            `아카가 맨 앞에 있었습니다. 닐스는 손을 들었습니다.`,
            `기러기 소리가 났습니다. 그런데 그것이 무슨 말인지 알 수 없었습니다.`,
            `봄에는 그 소리가 다 말이었습니다. 이제는 그냥 소리였습니다.`,
            `닐스는 소리쳐 부르려고 했습니다. 그런데 무슨 말로 불러야 하는지 알 수 없었습니다.`,
            ...
            `삼월이 되면 마당에 나가 서 있었습니다. 어머니가 그것을 보고 무엇을 보느냐고 물으면 아무것도 아니라고 했습니다.`,
            `이 책을 쓴 셀마 라겔뢰프는 여자로서는 처음으로 노벨 문학상을 받았습니다. 이 책이 나온 지 몇 해 뒤였습니다.`,
            `스웨덴 서쪽 시골에서 나고 자랐고, 어릴 때 다리가 아파 오래 앓았습니다. 그때 할머니가 들려준 옛날 이야기를 듣고 자랐습니다.`,
