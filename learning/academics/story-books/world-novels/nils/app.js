...
const CHAPTERS = [
    ...
    },
    {
        ...
        paras: [
            ...
            `아이들에게 이 나라가 어떻게 생겼는지 가르치는 책이었습니다. 그 일을 셀마 라겔뢰프라는 작가에게 맡겼습니다. 라겔뢰프는 삼 년 동안 스웨덴 곳곳을 돌아다녔습니다. 가는 데마다 적어 두었습니다. 산과 호수와 도시를 다 보았습니다. 기차를 타고도 다니고 걸어서도 다녔습니다. 사람들에게 묻고 그 자리에서 적었습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `자기가 사람이면 무엇을 할 수 있는지를 처음으로 생각했기 때문입니다. 그전까지 닐스는 사람인 것으로 남을 괴롭히기만 했습니다. 힘이 있는 것과 그 힘을 어디에 쓰는가는 다른 일입니다. 이 이야기는 그 하나를 말하려고 여덟 달을 돌아온 것입니다.`,
...
const AFTERWORD = {
    ...
    paras: [
        ...
        `그가 이름을 얻은 것은 서른셋에 낸 첫 소설로부터입니다. 그때까지 십 년 넘게 시골 학교에서 아이들을 가르쳤습니다. 밤에 글을 썼습니다.`,
        ...
        `그는 삼 년 동안 스웨덴 곳곳을 돌아다녔습니다. 고장마다 다니며 지형과 살림과 옛이야기를 모았습니다. 그러고 나서 이 이야기를 지었습니다.`,
        ...
        `오십 년 넘게 그랬습니다. 그러니 스웨덴 사람 여러 세대가 이 책으로 자기 나라를 배웠습니다.`,
        ...
        `라겔뢰프가 삼 년 동안 돌아다니며 모은 것이 바로 그 이야기들입니다. 그 고장 노인들에게 물어 적어 온 것입니다.`,
