...
const CHAPTERS = [
    {
        ...
        paras: [
            ...
            `열네 살이었습니다. 닐스는 마을에서 손꼽히게 못된 아이였습니다. 일을 시키면 도망쳤고, 책을 펴면 잤습니다. 그리고 짐승을 괴롭혔습니다.`,
            `고양이 꼬리를 밟고, 거위를 쫓아 몰고, 새 둥지를 헐었습니다. 그 집 짐승들은 다 닐스를 무서워했습니다. 삼월 어느 일요일 아침이었습니다.`,
            `그 집은 넉넉하지 않았습니다. 아버지와 어머니는 새벽부터 밭에 나갔습니다. 그래서 닐스에게 잔소리할 틈도 별로 없었습니다.`,
            ...
            `손바닥만 한 사람이었습니다. 수염이 있고, 챙 넓은 모자를 쓰고, 무릎 아래를 여민 바지를 입고 있었습니다. 스웨덴 시골에서 톰테라고 부르는 것이었습니다.`,
            `스웨덴 시골집에서는 톰테에게 겨울마다 죽을 한 그릇 내놓는 풍습이 있었습니다. 그렇게 하면 집안이 무사하다고 여겼습니다.`,
            `집을 지켜 준다는 작은 도깨비입니다. 닐스는 잠자리채를 들었습니다. 그리고 그것을 덮어씌워 잡았습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `닐스는 소리를 질렀습니다. 그런데 그때 이상한 일이 하나 더 있었습니다. 밖에서 참새들이 하는 말이 들렸습니다.`,
            `소리도 아주 작게 나왔습니다.`,
            `"저것 봐! 저 못된 애가 저렇게 됐어!"`,
            `"쌤통이다!"`,
            `짐승의 말이 다 들렸습니다. 닐스는 마당으로 나갔습니다. 고양이가 앞을 막았습니다.`,
            `그동안 닐스가 짐승들에게 한 일을 짐승들은 하나도 잊지 않고 있었습니다. 그리고 그것을 그날 다 말했습니다.`,
            `닐스는 늘 하던 대로 발로 차려고 했습니다. 그런데 이제 그 고양이가 닐스보다 훨씬 컸습니다. 고양이가 앞발로 닐스를 눌렀습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `저녁이 되자 무리가 호수에 내려앉았습니다. 아카가 모르텐 앞에 왔습니다.`,
            `기러기는 밤에 물 위에서 잡니다. 뭍에서 자면 여우에게 물리기 때문입니다. 삼월에는 아직 호수에 얼음이 남아 있었습니다.`,
            `"너는 집거위구나."<br>"그렇습니다."<br>"집거위는 우리를 따라올 수 없다. 라플란드까지는 아주 멀다."<br>"저는 갈 수 있습니다."<br>"그리고 저 아이는 무엇이냐."`,
            `아카가 닐스를 보았습니다.`,
            `"사람 아니냐. 사람은 안 된다."`,
            ...
            `그때 닐스가 그것을 보았습니다. 닐스는 소리를 질렀습니다.`,
            ...
            `기러기가 빠져나갔습니다. 여우는 그 뒤로 닐스를 미워했습니다. 그리고 그해 내내 그 무리를 쫓아다녔습니다.`,
            `이튿날 아침, 아카가 닐스에게 말했습니다.<br>"너를 데려가겠다."<br>"왜요?"<br>"어젯밤 일 때문이다."<br>그리고 이렇게 덧붙였습니다.<br>"그런데 하나 알아 두어라. 우리는 너를 태워 주는 것이 아니라 함께 가는 것이다."`,
    ...
    },
    {
        ...
        paras: [
            ...
            `"큰일 났습니다. 쥐들이 몰려옵니다."`,
            `그 성에는 오래전부터 쥐가 살고 있었습니다. 회색 쥐라고 불리는 것들이었습니다. 그런데 그 성의 지하에 다른 쥐들이 살고 있었습니다.`,
            `사람이 떠난 집에는 쥐가 듭니다. 그리고 쥐가 들면 그 집은 더 빨리 무너집니다.`,
            `검은 쥐라고 불렀습니다. 검은 쥐들은 오래전부터 그 성에 살던 쥐들이었고, 회색 쥐들은 나중에 온 쥐들이었습니다. 회색 쥐가 수가 훨씬 많았습니다. 그리고 그 성을 통째로 빼앗으려고 몰려오고 있었습니다.`,
            `"그 성에는 사람이 없습니까?"<br>"없습니다. 오래전에 비었습니다."<br>아카가 말했습니다.<br>"우리는 도울 수 없다. 우리에게는 이빨도 발톱도 없다."<br>그때 닐스가 말했습니다.<br>"저한테 방법이 있을지도 몰라요."`,
            `닐스는 그 성 지하에서 무언가를 찾았습니다. 피리였습니다. 아주 오래된 나무 피리였습니다.`,
            `그 지하는 캄캄했습니다. 닐스는 벽을 짚어 가며 걸었습니다.`,
            `닐스는 그것을 불었습니다. 그러자 쥐들이 그 소리를 따라오기 시작했습니다. 회색 쥐들이 다 나왔습니다.`,
            `제대로 부는 법도 몰랐습니다. 그런데 소리가 나자 사방에서 발톱 긁는 소리가 났습니다.`,
            `닐스는 피리를 불며 걸었습니다. 성 밖으로, 들판을 가로질러, 호수 쪽으로. 쥐들이 다 따라왔습니다. 그리고 닐스는 그 쥐들을 아주 먼 데까지 데려갔습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `그다음에 뇌조들이 나와 노래를 불렀습니다. 그다음에 사슴들이 뿔을 맞대고 겨루었습니다. 마지막에 학들이 나왔습니다.`,
            `뇌조는 봄이면 목을 부풀리고 낮게 우는 새입니다. 그 소리가 숲 안에서 아주 멀리까지 갑니다.`,
            `학들이 춤을 추었습니다. 풀밭 한가운데에서 회색 새들이 목을 세우고, 날개를 반쯤 펴고, 뛰어올랐다가 내려앉았습니다. 아무도 소리를 내지 않았습니다.`,
            `학은 사람이 보는 데서는 잘 추지 않습니다. 그래서 그것을 본 사람이 드뭅니다.`,
            `닐스는 그것을 보다가 목이 메었습니다. 왜 그런지 몰랐습니다. 그런데 그날 그 모임에서 사고가 하나 났습니다.`,
            `그때까지 닐스가 아름답다고 느껴 본 것은 아무것도 없었습니다.`,
            `여우 스미레가 규칙을 어긴 것입니다. 기러기를 하나 물어 갔습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `라겔뢰프는 삼 년 동안 스웨덴 곳곳을 돌아다녔습니다. 그리고 이 이야기를 썼습니다.`,
            `산과 호수와 도시를 다 보았습니다. 그리고 그것을 그냥 늘어놓지 않고, 아이 하나가 거위 등에 앉아 지나가는 이야기로 만들었습니다.`,
            `그래서 닐스가 지나가는 곳은 다 실제로 있는 곳입니다. 산도 호수도 도시도 다 진짜입니다. 그 가운데 이런 곳이 있었습니다.`,
            `발트해 어느 섬에 낡은 성터가 있었습니다. 사람이 살지 않는 곳이었습니다. 닐스는 어느 밤 그 섬에 내렸습니다. 그리고 이상한 것을 보았습니다.`,
            ...
            `닐스는 어느 가게로 들어갔습니다. 상인이 물건을 보여 주었습니다.`,
            `가게 안이 환했습니다. 사람들 목소리가 들렸습니다. 그런데 아무도 닐스를 이상하게 여기지 않았습니다.`,
            `"이걸 사시오. 값은 동전 하나면 되오."`,
            ...
            `닐스는 빈 성터에 혼자 서 있었습니다. 나중에 닐스가 아카에게 그 이야기를 했습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `어느 날 닐스가 무리에서 떨어졌습니다. 바람이 세게 불어 모르텐의 등에서 미끄러진 것입니다. 닐스는 숲에 떨어졌습니다. 그리고 밤이 되었습니다.`,
            ...
            `그때 밖에서 소리가 났습니다. 사람들이었습니다. 광산 사람들이 다이너마이트를 들고 그 굴을 찾아온 것이었습니다.`,
            `사람 목소리와 쇠붙이 소리였습니다.`,
            `그 곰이 광산 근처에 나타나 골칫거리였기 때문입니다. 어미 곰이 굳었습니다. 사람들이 굴 앞에 화약을 놓았습니다. 그리고 심지에 불을 붙이려고 했습니다.`,
            ...
            `불꽃이 손을 태웠습니다. 닐스는 그것을 눌러 껐습니다. 사람들은 아무것도 보지 못했습니다.`,
            `닐스는 소리를 내지 않았습니다. 소리를 내면 사람들이 알아채기 때문입니다.`,
            `너무 작았기 때문입니다. 사람들은 화약이 불량이라고 여기고 돌아갔습니다. 닐스가 굴로 돌아왔습니다.`,
            `어미 곰이 한참 닐스를 보았습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `공원 한쪽에 커다란 청동 기마상이 있었습니다. 옛날 왕의 상이었습니다. 그런데 그 상이 말에서 내려 걷기 시작했습니다.`,
            `말을 탄 왕이 손을 들고 있는 상이었습니다. 아주 컸습니다.`,
            `발소리가 온 도시에 울렸습니다. 닐스는 무서워서 달아났습니다. 청동상이 따라왔습니다.`,
            `닐스는 항구 쪽으로 달렸습니다. 거기에 다른 상이 하나 있었습니다. 나무로 만든 뱃사람 상이었습니다.`,
            `발밑에서 돌바닥이 울렸습니다. 뒤에서 나는 소리가 점점 가까워졌습니다.`,
            `아주 낡은 것이었습니다. 닐스가 그 뒤로 숨었습니다. 그러자 그 나무상도 움직였습니다. 그리고 청동상 앞을 막아섰습니다.`,
            `두 상이 마주 섰습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `모르텐과 던핀 사이에 새끼가 여섯 마리 났습니다. 닐스는 그 여름 동안 그 새끼들을 돌보았습니다. 그리고 그해 여름에 닐스는 아주 달라졌습니다.`,
            ...
            `아카는 그 말에 아무 대꾸도 하지 않았습니다. 그해 가을, 무리가 남쪽으로 내려가기 시작했습니다. 가는 길에 닐스는 여러 번 자기 마을 쪽을 보았습니다. 그리고 어머니와 아버지를 생각했습니다.`,
            `늙은 기러기는 대답하지 않는 것으로 대답하는 일이 많았습니다.`,
            `봄에 떠날 때는 그 생각을 하지 않았습니다. 그해 가을에는 자꾸 났습니다.`,
            `어느 날 닐스는 자기 집에 몰래 가 보았습니다. 창으로 들여다보았습니다. 어머니가 식탁에 앉아 있었습니다.`,
            `집이 그대로였습니다. 마당의 돌도, 문에 난 흠집도 그대로였습니다.`,
            `아버지가 옆에 있었습니다. 두 사람은 아무 말도 하지 않고 있었습니다. 닐스가 없어진 뒤로 두 사람이 어떻게 지냈는지 닐스는 그때 알았습니다.`,
            `두 사람은 닐스를 찾아 여기저기 다녔습니다. 그리고 못 찾았습니다. 그리고 그 집을 팔지 못하고 있었습니다.`,
            `닐스가 돌아올지도 모른다고 여겼기 때문입니다. 닐스는 그 창밑에 오래 앉아 있었습니다. 그리고 그날 돌아가기로 마음을 정했습니다.`,
    ...
    },
    {
        ...
        paras: [
            `그런데 어떻게 하면 사람이 되는지를 아무도 몰랐습니다. 닐스는 여러 사람에게 물었습니다. 그러다 어느 날 대답을 들었습니다.`,
            `톰테를 다시 만나면 될 것 같았는데, 그 뒤로 톰테를 본 사람이 없었습니다.`,
            ...
            `그 뒤로 닐스는 여러 날 잠을 못 잤습니다. 그리고 이 이야기의 여러 판본에서 그다음이 조금씩 다릅니다. 가장 널리 전해지는 것은 이렇습니다.`,
            `짐승이 되는 것이 어떤 것인지 닐스는 이제 알고 있었습니다. 그것을 다른 누구에게 하라고 할 수는 없었습니다.`,
            `무리가 남쪽으로 내려와 닐스의 마을 가까이에 이르렀습니다. 그리고 그때 일이 났습니다. 닐스의 아버지가 밭에서 모르텐을 발견한 것입니다.`,
            `가을 기러기는 봄보다 천천히 갑니다. 새끼들이 아직 어리기 때문입니다.`,
            `봄에 날아간 자기 집 거위였습니다. 아버지는 그것을 붙잡았습니다. 그리고 부엌으로 가져갔습니다.`,
            ...
            `작은 몸으로는 아무것도 할 수 없었습니다. 닐스는 그때 이렇게 생각했습니다. '내가 사람이면 저것을 막을 수 있는데.' 그리고 그 순간이었습니다.`,
            `닐스가 부엌으로 뛰어들어 갔습니다. 그리고 소리를 질렀습니다.`,
            `"안 돼요!"`,
            `그 소리가 아주 컸습니다. 어머니가 돌아보았습니다. 부엌 한가운데에 열네 살짜리 아이가 서 있었습니다.`,
            `작은 몸에서 날 수 있는 소리가 아니었습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `아버지는 그 말이 무슨 뜻인지 몰랐습니다. 그런데 여덟 달 만에 돌아온 아들이 처음으로 한 부탁이었습니다. 그래서 놓아 주었습니다.`,
            `그런데 아들의 얼굴을 보고 더 묻지 않았습니다.`,
            `모르텐과 던핀과 새끼들이 마당으로 나갔습니다. 그리고 하늘로 올라갔습니다.`,
            `그날 저녁, 마당에서 기러기 소리가 났습니다. 닐스가 나가 보았습니다. 무리가 낮게 날면서 지나가고 있었습니다.`,
            `아카가 맨 앞에 있었습니다. 닐스는 손을 들었습니다. 그런데 아무 소리도 들리지 않았습니다.`,
            `닐스는 소리쳐 부르려고 했습니다. 그런데 무슨 말로 불러야 하는지 알 수 없었습니다.`,
            `기러기 소리는 났습니다. 그런데 그것이 무슨 말인지 알 수 없었습니다. 닐스는 그 자리에 서서 그 소리를 들었습니다. 그리고 처음으로 자기가 무엇을 잃었는지 알았습니다.`,
