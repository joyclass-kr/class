...
const CHAPTERS = [
    {
        ...
        paras: [
            ...
            `그것이 세드릭이 들은 유일한 대답이었습니다. 세드릭이 모르는 것이 하나 있었습니다.`,
    ...
    },
    {
        ...
        paras: [
            `세드릭은 그 소식을 홉스 씨에게 알려야 했습니다. 그 일이 가장 어려웠습니다.`,
            ...
            `"몇 시에 떠나니."<br>"다음 주에요."`,
            `그날 홉스 씨는 가게 문을 일찍 닫았습니다. 며칠 뒤, 세드릭은 딕을 찾아갔습니다.`,
            ...
            `세드릭은 그 말을 잊지 않았습니다. 떠나기 전날, 세드릭은 어머니와 함께 딕에게 새 구두닦이 도구 한 벌을 사 주었습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `백작은 그 아이를 내려다보았습니다. 그 성에서 그의 몸이 아픈지 안 아픈지를 물어본 사람은 몇 해 만에 처음이었습니다. 저녁 식탁에서 백작은 아이를 지켜보았습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `백작의 얼굴이 굳었습니다.<br>"······가거라." 그날부터 세드릭은 날마다 코트 로지에 갔습니다.`,
            ...
            `백작은 아이에게 돈을 주기 시작했습니다.<br>"쓰고 싶은 대로 쓰거라." 세드릭은 그 돈으로 무엇을 할지 아주 진지하게 생각했습니다.`,
            ...
            `백작은 해비셤 씨를 불러 그 일을 처리하게 했습니다. 그리고 그 뒤로 아이가 무엇을 부탁할지 조금씩 궁금해지기 시작했습니다.`
        ]
    },
    {
        num: 7,
        ...
        paras: [
            `어느 날 세드릭은 조랑말을 타고 처음 가 보는 쪽으로 갔습니다. 언덕을 넘자 마을이 하나 나왔습니다. 그 마을은 지금까지 본 곳과 아주 달랐습니다.`,
    ...
    },
    {
        ...
        paras: [
            `며칠 뒤 백작이 관리인 뉴익 씨를 불렀습니다.<br>"언쇼 말이다." 백작이 말했습니다.<br>"다 헐고 새로 짓게."`,
            `뉴익 씨는 자기 귀를 의심했습니다.`,
            `"백작님, 그 돈이 얼마나 드는지 아십니까?"<br>"알고 있네."`,
            `"실례지만······ 어찌 된 일이십니까? 십 년 동안 제가 그 말씀을 몇 번이나 올렸는데요."<br>"그동안은 내가 듣지 않았지." 백작이 말했습니다.<br>"이번에는 다른 사람이 말했네."`,
            ...
            `그 뒤로도 세드릭은 부탁을 계속했습니다. 한번은 절름발이인 힉스라는 아이를 만나고 와서, 그 아이가 병원에 가야 한다고 했습니다. 한번은 마을 학교의 지붕이 낮아서 아이들이 답답해한다고 했습니다.`,
            `한번은 어느 집 할머니가 겨울에 땔감이 없다고 했습니다. 백작은 그때마다 투덜거렸습니다.`,
            `"너는 내 재산을 다 쓸 셈이냐."<br>"할아버지가 쓰고 싶은 대로 쓰라고 하셨잖아요."<br>"내 돈 말이지, 내 땅을 통째로 말한 게 아니다."`,
            `그러면서도 그는 다 들어주었습니다. 그해 가을, 마을 사람들이 백작을 보는 눈이 달라졌습니다.`,
    ...
    },
    {
        ...
        paras: [
            `어느 일요일 아침, 백작이 처음으로 교회에 나가겠다고 했습니다. 여러 해 만의 일이었습니다.`,
            ...
            `앉고 나서 세드릭이 아래쪽을 내려다보다가 갑자기 몸을 내밀었습니다. 저쪽 자리에 어머니가 앉아 있었습니다.`,
            `세드릭이 손을 흔들었습니다. 어머니가 손가락을 입에 대고 웃었습니다.`,
            `백작은 그쪽을 보았습니다. 그가 그 며느리를 본 것은 그때가 처음이었습니다.`,
            `젊고 조용한 여자였습니다. 검은 옷을 입고 있었고, 아이 쪽을 보는 눈이 아주 부드러웠습니다.`,
            `백작은 곧 눈을 돌렸습니다. 예배가 끝나고 나오는 길에 마을 사람들이 줄지어 인사를 했습니다.`,
            `한 노인이 백작 앞에 모자를 벗었습니다.<br>"백작님, 언쇼 일은 고맙습니다. 저희 손자가 이제 마른 데서 잡니다."`,
            `백작은 헛기침을 하고 지나갔습니다.`,
            `마차에서 세드릭이 말했습니다.<br>"할아버지, 사람들이 할아버지를 좋아해요."<br>"······그러냐."`,
            `"사랑이 그랬어요. 사람들이 백작님을 좋게 이야기하는 걸 요즘 자주 듣는대요." 백작은 창밖을 보았습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `"거짓말이다." 백작이 말했습니다.<br>"내 아들은 결혼한 적이 없다."`,
            `"미국에서 했습니다." 여자가 종이를 하나 내밀었습니다.<br>"여기 혼인 증서가 있습니다."`,
            `백작은 그 종이를 받아 들었습니다. 손이 떨렸습니다.`,
            `만약 그 말이 사실이라면, 맏아들의 아들이 상속자입니다.`,
            `셋째 아들의 아들인 세드릭이 아니라요.`,
            ...
            `그 말을 나중에 전해 들은 백작은 오래 아무 말도 하지 못했습니다. 백작에게 가장 견디기 힘든 것은 재산 문제가 아니었습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `딕은 그 무렵 새 도구로 일하며 형편이 나아져 있었습니다.<br>"딕, 이걸 봐라."`,
            ...
            `그때 홉스 씨와 딕이 나타났습니다. 그리고 며칠 뒤, 서부에서 벤이 도착했습니다.`,
    ...
    },
    {
        ...
        paras: [
            `그 여자는 성 근처의 여관에 묵고 있었습니다. 어느 날 오후, 여관 방문이 열렸습니다. 해비셤 씨와 백작의 사람들, 그리고 그 뒤에 낯선 남자 하나가 서 있었습니다.`,
            `여자가 그 남자를 보고 자리에서 일어섰습니다.<br>"미니." 남자가 말했습니다.`,
            `그 남자가 벤이었습니다. 딕의 형이었습니다.`,
            `방 안이 조용해졌습니다. 벤은 아이 쪽을 보았습니다.`,
            ...
            `여자는 아무 말도 하지 못했습니다. 그날 저녁 그 여자는 그 마을을 떠났습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `문이 열리고 에롤 부인이 나왔습니다. 두 사람은 처음으로 마주 보았습니다.`,
            `"들어오시겠습니까." 부인이 말했습니다.`,
            ...
            `부인이 그의 팔을 잡았습니다. 이번에는 백작이 그 손을 뿌리치지 않았습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `백작은 현관 계단에 서서 사람들을 맞았습니다. 그 곁에 세드릭이 서 있었고, 그 옆에 에롤 부인이 서 있었습니다.`,
            `사람들은 그 세 사람을 보고 서로 수군거렸습니다. 몇 달 전만 해도 상상할 수 없던 모습이었기 때문입니다.`,
            `그날 뉴욕에서 온 손님도 둘 있었습니다. 홉스 씨와 딕이었습니다.`,
            `홉스 씨는 새 옷을 입고 있었습니다. 그리고 아침부터 불편해서 어쩔 줄을 몰랐습니다.`,
            `세드릭이 그를 백작에게 데려갔습니다.<br>"할아버지, 이분이 홉스 아저씨예요." 백작이 손을 내밀었습니다.`,
            `홉스 씨는 그 손을 잡았습니다. 백작이라는 것들의 손을 잡는 날이 오리라고는 생각해 본 적이 없었습니다.`,
            `"자네가 백작을 아주 싫어한다고 들었네." 백작이 말했습니다. 홉스 씨는 얼굴이 새빨개졌습니다.<br>"그건······ 잘 몰랐을 때 이야기입니다."`,
            `백작이 웃었습니다.`,
            ...
            `"공부를 하고 싶어요." 딕이 말했습니다.<br>"이제 돈이 좀 생겼거든요."`
        ]
    },
    {
        num: 15,
