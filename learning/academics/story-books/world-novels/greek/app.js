...
const QUIZ = [
    { q: "프로메테우스가 사람에게 준 것은 무엇입니까?", choices: ["불", "말", "농사"], answer: 0 },
    { q: "프로메테우스가 뉘우치라는 말에 한 대답은 무엇입니까?", choices: ["뉘우치겠다", "뉘우칠 것이 없다, 저들이 얼어 죽는 것을 보았다", "생각해 보겠다"], answer: 1 },
    { q: "판도라라는 이름의 뜻은 무엇입니까?", choices: ["모든 선물", "첫 사람", "아름다운 이"], answer: 0 },
    { q: "항아리에서 마지막에 나온 것은 무엇입니까?", choices: ["희망", "병", "미움"], answer: 0 },
    { q: "페르세포네가 여섯 달만 땅 위에 있게 된 까닭은 무엇입니까?", choices: ["약속을 어겨서", "지하 세계에서 석류를 여섯 알 먹어서", "길을 잃어서"], answer: 1 },
    { q: "데메테르가 딸을 되찾은 방법은 무엇입니까?", choices: ["싸움", "부탁", "땅에 아무것도 자라지 않게 한 것"], answer: 2 },
    { q: "다이달로스가 이카로스에게 한 당부는 무엇입니까?", choices: ["높이 날아라", "낮게 날아라", "너무 낮게도 너무 높게도 날지 마라"], answer: 2 },
    { q: "미다스의 소원이 불러온 문제는 무엇입니까?", choices: ["금이 무거웠다", "먹을 수도 마실 수도 없게 되었다", "사람들이 미워했다"], answer: 1 },
    { q: "페르세우스가 메두사를 볼 때 쓴 방법은 무엇입니까?", choices: ["눈을 감았다", "청동 방패에 비친 모습을 보았다", "밤에 갔다"], answer: 1 },
    { q: "테세우스가 미궁에서 나올 수 있었던 까닭은 무엇입니까?", choices: ["힘이 세서", "아리아드네가 준 실을 풀면서 들어가서", "길을 외워서"], answer: 1 },
    { q: "테세우스가 아테네에서 저지른 실수는 무엇입니까?", choices: ["배를 잃었다", "흰 돛으로 바꿔 다는 것을 잊었다", "길을 잘못 들었다"], answer: 1 },
    { q: "오르페우스가 아내를 데려오지 못한 까닭은 무엇입니까?", choices: ["길을 잃어서", "마지막 한 걸음을 남기고 뒤를 돌아봐서", "노래를 못 불러서"], answer: 1 },
    { q: "헤라클레스가 히드라를 이길 때 알게 된 것은 무엇입니까?", choices: ["혼자 힘으로 안 되는 일이 있다는 것", "불이 세다는 것", "뱀이 약하다는 것"], answer: 0 },
    { q: "아라크네가 진 것은 무엇 때문입니까?", choices: ["솜씨", "힘", "게을러서"], answer: 1 },
    { q: "나르키소스가 끝내 하지 못한 것은 무엇입니까?", choices: ["물을 마시는 것", "자기 얼굴에서 눈을 떼는 것", "사냥"], answer: 1 },
    { q: "트로이가 지어낸 곳이 아니라는 것은 어떻게 밝혀졌습니까?", choices: ["기록이 나와서", "백오십 년쯤 전에 그 자리를 파서 찾아내서", "지도에 있어서"], answer: 1 }
];
