...
const CHAPTERS = [
    {
        ...
        paras: [
            ...
            `삼 년이 지났습니다. 그 삼 년 동안 목숨을 잃은 사람이 천 명이 넘었습니다. 나라 안에 딸을 가진 집이 남지 않았습니다. 다들 딸을 데리고 다른 나라로 달아났기 때문입니다. 밤에 짐을 싸서 성문을 빠져나갔습니다. 낮에 나가면 눈에 띄기 때문입니다. 그렇게 빠져나간 집이 하루에 몇 집씩이었습니다. 장이 서던 자리가 비고 가게가 문을 닫았습니다. 사람이 빠져나가면 나라가 그렇게 됩니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `오래 미움에 잠겨 있으면 마음이 그렇게 바뀐다는 이야기였습니다. 기다리던 것이 오지 않으면 사람은 마음을 접습니다. 접다 보면 나중에는 반대쪽으로 갑니다. 왕이 삼 년 동안 한 일이 바로 그것이었습니다. 셰에라자드는 그 말을 입 밖에 내지 않고 이야기로만 놓아 두었습니다.`
        ]
    },
    {
        num: 3,
