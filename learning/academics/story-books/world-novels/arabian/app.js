...
const CHAPTERS = [
    {
        ...
        paras: [
            `아주 오랜 옛날, 페르시아에 샤리아르라는 왕이 있었습니다. 젊고, 힘이 세고, 나라를 잘 다스리던 왕이었습니다. 백성이 그 왕을 따랐습니다. 그런데 어느 해에 왕은 크게 배신을 당했습니다. 그 일로 왕의 마음이 아주 상했습니다.`,
            `가장 가까운 사람에게 속은 것입니다. 믿었던 만큼 크게 무너졌습니다. 그 뒤로 왕이 달라졌습니다. 왕은 이렇게 생각했습니다.`,
            `'사람은 아무도 믿을 수 없다. 그러니 정을 붙이기 전에 끝내면 된다.' 그때부터 왕은 무서운 일을 시작했습니다. 날마다 새로 혼인을 하고, 이튿날 아침이면 그 사람의 목숨을 빼앗았습니다.`,
            `삼 년이 지났습니다. 그 삼 년 동안 목숨을 잃은 사람이 천 명이 넘었습니다. 나라 안에 딸을 가진 집이 남지 않았습니다. 다들 딸을 데리고 다른 나라로 달아났기 때문입니다. 밤에 짐을 싸서 성문을 빠져나갔습니다.`,
            `그 일을 맡아 하던 것은 재상이었습니다. 재상은 날마다 왕에게 사람을 데려가야 했습니다. 그 재상에게 딸이 둘 있었습니다. 큰딸은 셰에라자드, 작은딸은 두냐자드였습니다.`,
            `셰에라자드는 책을 아주 많이 읽은 사람이었습니다. 재상의 서고에 있는 책을 다 읽었습니다. 역사와 시와 옛이야기를 천 가지도 넘게 알고 있었습니다. 한 번 읽은 것은 잊지 않았습니다.`,
            ...
            `재상은 여러 날 말렸습니다. 울면서도 말리고 화를 내면서도 말렸습니다. 그런데 딸은 뜻을 굽히지 않았습니다. 밥을 먹으면서도 그 말만 했습니다. 결국 셰에라자드가 궁으로 갔습니다.`,
            ...
            `왕은 그러라고 했습니다. 어차피 아침이면 끝날 일이라고 생각했습니다.`,
            `셰에라자드는 이야기를 시작했습니다. 그리고 이야기가 가장 재미있어지는 대목에서 멈췄습니다.<br>"날이 밝았습니다. 나머지는 다음에 하겠습니다."`,
            `왕은 그 뒷이야기가 궁금했습니다. 이야기가 하필 제일 궁금한 데서 끊겼기 때문입니다. 그래서 하루를 미루었습니다.`,
            `이튿날 밤 셰에라자드는 그 이야기를 마쳤습니다. 왕은 끝까지 한마디도 하지 않고 들었습니다. 그리고 곧바로 다음 이야기를 시작했습니다. 그리고 또 재미있어지는 데서 멈췄습니다.`,
            `그렇게 하루가 이틀이 되고, 이틀이 열흘이 되고, 열흘이 한 해가 되었습니다. 그동안 궁 안에서는 아무도 그 이야기를 입에 올리지 않았습니다. 아래에 그 이야기 가운데 몇 편을 옮겨 적습니다.`
        ]
    },
    {
        num: 2,
        ...
        paras: [
            `가난한 어부가 하나 있었습니다. 그 어부에게는 규칙이 하나 있었습니다. 하루에 그물을 네 번만 던지는 것이었습니다. 네 번을 넘겨 욕심을 부리지 않겠다는 다짐이었습니다.`,
            `어느 날 첫 번째 그물에 죽은 나귀가 걸려 올라왔습니다. 두 번째에는 모래가 가득 든 항아리가 올라왔습니다. 세 번째에는 깨진 그릇과 유리 조각이 올라왔습니다. 그물만 여기저기 찢어졌습니다.`,
            ...
            `연기가 하늘로 올라가 뭉치더니, 어마어마하게 큰 마신이 되었습니다. 머리가 구름에 닿고 발이 땅에 닿았습니다. 눈이 화로만 했습니다. 어부는 다리에 힘이 빠졌습니다.`,
            `마신이 소리쳤습니다.<br>"준비해라. 나는 너를 죽이겠다."<br>"제가 당신을 꺼내 드렸는데요."<br>"그러니까 죽이겠다는 것이다."`,
            `그리고 마신이 이런 이야기를 했습니다. 그는 옛날에 어느 왕의 명을 어겨 그 항아리에 갇혔습니다. 납으로 봉하고 도장을 찍어 바다에 던진 것이었습니다. 첫 백 년 동안 그는 이렇게 생각했습니다.`,
            ...
            `'나를 꺼내 주는 자에게 소원을 세 가지 들어주겠다.' 아무도 오지 않았습니다. 그러다 사백 년이 지나자 그는 이렇게 생각했습니다. '이제 누가 나를 꺼내 주든, 나는 그자를 죽이겠다.'`,
            `어부는 그 이야기를 다 들었습니다. 그리고 벌벌 떨면서 이렇게 말했습니다.<br>"한 가지만 여쭙겠습니다. 정말 그렇게 큰 분이 이 작은 항아리에 들어가 계셨습니까?"<br>"그렇다."<br>"저는 못 믿겠습니다. 발 하나도 안 들어갈 것 같은데요."`,
            `마신이 화를 냈습니다.<br>"내가 보여 주지."`,
            `그리고 다시 연기가 되어 항아리 속으로 들어갔습니다. 연기가 소용돌이치며 빨려 들어갔습니다. 어부는 그 순간 뚜껑을 눌러 닫았습니다.`,
            `"이제 도로 바다에 던지겠습니다."<br>안에서 마신이 사정했습니다.<br>"내가 잘못했다. 꺼내 주면 너를 부자로 만들어 주겠다."<br>"사백 년 동안 마음이 세 번 바뀌신 분을 제가 어떻게 믿습니까."`,
            `그런데 어부는 결국 그를 꺼내 주었습니다. 마신이 그 은혜를 갚겠다고 맹세했기 때문입니다. 이번에는 정말이라고 여러 번 말했습니다. 그리고 그 마신은 정말로 약속을 지켰습니다.`,
            `어부는 그 뒤로 잘살았습니다.`,
            `셰에라자드는 이 이야기를 마치고 왕을 보았습니다. 왕은 아무 말도 하지 않았습니다. 그런데 이 이야기가 무슨 이야기인지는 알아들었습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `알라딘은 어둠 속에 갇혔습니다. 이틀 동안 알라딘은 그 안에서 울었습니다. 그러다 손을 비비다가 반지를 문질렀습니다. 그러자 반지에서 무언가가 나왔습니다.<br>"주인님, 무엇을 원하십니까."`,
            ...
            `그때 알라딘은 사냥을 나가 있었습니다. 공주가 그 소리를 듣고, 창고에 굴러다니는 낡은 램프를 내주었습니다. 그 램프가 무엇인지 몰랐기 때문입니다. 알라딘은 그것을 아내에게도 말하지 않았던 것입니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `어느 날 알리바바가 숲에서 나무를 하고 있는데 말발굽 소리가 났습니다. 알리바바는 나무 위로 올라가 숨었습니다. 말 탄 사람이 마흔 명이었습니다. 하나하나 칼을 차고 있었습니다. 다들 짐을 잔뜩 싣고 있었습니다.`,
            `그 무리의 우두머리가 바위 앞에 서서 말했습니다.<br>"열려라, 참깨."`,
            `그러자 바위가 갈라졌습니다. 사람들이 짐을 지고 안으로 들어갔습니다. 그리고 한참 뒤에 빈손으로 나왔습니다.`,
            `우두머리가 말했습니다.<br>"닫혀라, 참깨."`,
            `바위가 닫혔고, 무리가 떠났습니다. 알리바바는 나무에서 내려왔습니다. 그리고 그 바위 앞에 서서 말해 보았습니다.<br>"열려라, 참깨."`,
            `바위가 갈라졌습니다. 안에는 굴이 있었습니다. 그 굴에 금과 은과 비단이 산더미처럼 쌓여 있었습니다. 수십 년 동안 모아 놓은 것이었습니다.`,
            `알리바바는 금화를 자루에 담아 나귀에 실었습니다. 그런데 다 가져가지 않았습니다. 나귀 세 마리에 실을 만큼만 가져갔습니다.`,
            `집에 와서 아내가 그 금을 되로 재려고 했습니다. 그런데 되가 없어서 형수네 집에서 빌려 왔습니다.`,
            `형수는 그 되에 몰래 밀랍을 발라 두었습니다. 바닥에 얇게 발라 두었습니다. 동생네가 무엇을 재는지 궁금했기 때문입니다. 되를 돌려받아 보니 밀랍에 금화가 하나 붙어 있었습니다.`,
            `형 카심이 동생을 불렀습니다.<br>"그 금이 어디서 났느냐."`,
            `알리바바는 사실대로 다 말했습니다. 그리고 그 굴을 함께 쓰자고 했습니다. 그런데 카심은 이튿날 새벽에 혼자 나귀 열 마리를 끌고 그리로 갔습니다.<br>"열려라, 참깨."`,
            `바위가 열렸습니다. 카심은 안에 들어가 자루에 금을 채웠습니다. 그리고 나오려는데 주문이 생각나지 않았습니다.<br>"열려라, 보리."<br>"열려라, 콩."`,
            `금을 눈앞에 두고 있는 동안 참깨라는 말이 머리에서 지워진 것입니다.`,
            `그날 도적들이 돌아왔습니다. 카심은 그 굴에서 나오지 못했습니다.`,
            `그 뒤 도적들은 그 마을을 뒤져 알리바바를 찾아냈습니다. 그리고 여러 번 그를 없애려고 했습니다. 그때마다 그것을 알아채고 막아 낸 사람이 있었습니다. 집안일을 하던 사람이었습니다. 알리바바의 집에서 일하는 모르지아나라는 여자였습니다.`,
            `도적들이 기름 항아리 서른일곱 개를 실은 장사꾼 행세를 하고 그 집에 들었을 때, 모르지아나는 기름을 뜨러 갔다가 항아리 안에서 사람 숨소리를 들었습니다. 모르지아나는 소리를 지르지 않았습니다.`,
            `그 대신 조용히 방법을 썼습니다. 그리고 그날 밤 그 집에서는 아무 일도 일어나지 않았습니다.`,
    ...
    },
    {
        ...
        paras: [
            `바그다드에 신드바드라는 짐꾼이 살았습니다. 무거운 짐을 지고 다니며 먹고살았습니다. 등이 짐 모양대로 굽어 있었습니다. 어느 더운 날, 그는 어느 큰 집 대문 앞에서 짐을 내려놓고 쉬었습니다. 안에서 음악 소리와 웃음소리가 났습니다. 고기 냄새도 담을 넘어왔습니다.`,
            `짐꾼은 이렇게 중얼거렸습니다.<br>"어떤 이는 저 안에 있고 어떤 이는 이 밖에 있구나."`,
            `그 소리를 그 집 사람이 들었습니다. 그리고 주인이 그를 안으로 불렀습니다. 그 집 주인의 이름도 신드바드였습니다. 그래서 주인이 그를 불러들인 것이었습니다. 일곱 번 바다에 나갔다가 돌아온 뱃사람 신드바드였습니다.`,
            `주인이 말했습니다.<br>"자네 이름이 나와 같군. 그럼 내 이야기를 들어 보게."`,
            `그리고 그는 이런 이야기를 했습니다. 두 번째 항해 때의 일일세. 배가 어느 섬에 들렀네.`,
            `나는 뭍에 내려 나무 그늘에서 쉬다가 잠이 들었네. 깨어 보니 배가 없었네. 수평선까지 아무것도 없었네. 사람들이 나를 두고 떠난 것이네.`,
            `나는 섬을 돌아다녔네. 사람이 살던 자취는 하나도 없었네. 그러다 흰 둥근 것을 하나 보았네. 지붕만큼 컸네.`,
            ...
            `나는 줄을 풀고 뛰어내렸네. 그 골짜기 바닥에 무엇이 깔려 있었는지 아나. 다이아몬드였네. 그런데 그 골짜기에는 큰 뱀들이 살고 있었네. 몸통이 나무 둥치만 했네.`,
            `그리고 절벽이 너무 높아 올라갈 수도 없었네. 나는 그 다이아몬드 위에 앉아 이렇게 생각했네. 세상에서 가장 값진 것 위에 앉아서 굶어 죽는구나.`,
            `그때 위에서 무언가가 떨어졌네. 커다란 고깃덩이였네. 그리고 또 하나 떨어졌네.`,
            `나는 그것을 보고 알아챘네. 절벽 위의 사람들이 고기를 던져 넣고 있었네. 고기에 다이아몬드가 박히면, 독수리가 그것을 물고 올라가네. 그렇게 하지 않으면 그 골짜기에 내려갈 길이 없기 때문이네.`,
            ...
            `뱃사람 신드바드가 웃었습니다.<br>"자네 말이 맞네. 그런데 뭍에 있으면 또 바다가 생각나네."`
        ]
    },
    {
        num: 6,
        ...
        paras: [
            `다섯 번째 항해 때의 일일세. 이번에는 배가 폭풍에 부딪쳤네. 배가 부서져서 나 혼자 어느 섬에 닿았네. 널빤지 하나에 매달려 떠밀려 온 것이네. 그 섬에는 물이 있고 열매가 있었네. 바나나 비슷한 것이 열려 있었네. 그래서 굶지는 않았네. 다만 사람이 하나도 없었네.`,
            `며칠 뒤 시냇가에서 노인을 하나 보았네. 사람을 보고 어찌나 반가웠는지 모르네. 아주 늙은 사람이었네. 수염이 하얗고 다리가 가늘었네. 그 노인이 손짓으로 나를 불렀네. 목소리는 내지 않았네. 그리고 자기를 업어서 저 개울을 건네 달라고 했네. 손짓만으로 그렇게 말했네.`,
            `나는 딱하게 여겨 그 사람을 업었네. 뼈만 남은 것처럼 가벼웠네. 개울을 건너 내려놓으려고 했네. 물이 무릎까지밖에 오지 않는 개울이었네. 그런데 내려오지 않았네.`,
            `두 다리로 내 목을 감고 놓지 않았네. 그 다리에 힘이 어찌나 센지 목이 졸릴 지경이었네. 쇠고리를 채운 것 같았네.`,
            `그때부터 그 노인은 내 등에서 내려오지 않았네. 내가 자면 등에서 자고, 내가 걸으면 발로 옆구리를 차서 방향을 시켰네. 내 등이 그 사람의 집이 된 것이네. 열매를 따라고 하면 따야 했고, 물을 뜨라고 하면 떠야 했네. 조금이라도 굼뜨면 옆구리를 걷어찼네.`,
            `그렇게 여러 달이 지났네. 날을 세는 것도 그만두었네. 나는 등이 굽고 다리가 떨렸네. 거울이 있었다면 나도 나를 못 알아보았을 걸세. 그러다 어느 날 나는 방법을 하나 생각해 냈네. 힘으로는 안 되니 다른 길을 찾은 것이네.`,
            `그 섬에는 커다란 조롱박이 열려 있었네. 나는 그것을 따서 속을 파냈네. 어른 머리만 한 조롱박이었네. 그리고 그 안에 포도를 짜 넣고 며칠 놓아두었네. 그 섬에는 포도가 아주 많았네.`,
            `그것이 익어 술이 되었네. 며칠 지나니 냄새가 났네. 나는 그것을 마시고 기운이 난 척했네. 일부러 크게 웃었네. 노래를 부르고 춤을 추었네. 등에 사람을 업은 채로 그렇게 했네.`,
            `등에 업힌 노인이 그것을 보고 그 조롱박을 빼앗았네. 자기도 마시고 싶었던 것이네. 그리고 다 마셨네. 단숨에 들이켰네. 조금 뒤 그 다리에서 힘이 빠졌네. 목을 죄던 것이 스르르 풀렸네.`,
            `나는 그를 등에서 내려놓았네. 목이 그제야 펴졌네. 그리고 그 섬을 벗어났네. 뒤도 돌아보지 않고 바닷가로 갔네. 며칠 뒤 지나가는 배가 나를 건져 주었네. 바닷가에서 옷을 흔들어 신호를 보낸 것이네. 그 배 사람들이 내 이야기를 듣고 이렇게 말했네.<br>"그자를 바다의 노인이라고 부릅니다. 그 등에 업힌 사람 가운데 살아 돌아온 사람은 당신이 처음입니다."`,
    ...
    },
    {
        ...
        paras: [
            `페르시아의 어느 왕이 새해 잔치를 열었습니다. 그 자리에 세 사람이 신기한 것을 가지고 왔습니다.`,
            `첫 번째 사람은 금으로 만든 공작을 가져왔습니다. 한 시간마다 날개를 치고 소리를 내는 것이었습니다. 두 번째 사람은 놋쇠 나팔수를 가져왔습니다. 성문 위에 세워 두면 적이 오는 것을 보고 나팔을 부는 것이었습니다. 밤에도 소리를 낸다고 했습니다.`,
            `세 번째 사람은 검은 나무로 만든 말을 가져왔습니다. 보기에는 그냥 말 조각이었습니다. 그 사람이 말했습니다.<br>"이것은 하늘을 납니다."`,
            `사람들이 웃었습니다. 그 사람이 말에 올라 목 아래의 손잡이를 돌렸습니다. 그러자 말이 떠올랐습니다. 발굽이 땅에서 한 자쯤 뜨더니 쑥 올라갔습니다. 그리고 성 위로 한 바퀴 돌고 내려왔습니다.`,
            `왕이 크게 놀랐습니다.<br>"무엇을 원하는가."<br>"공주님을 아내로 주십시오."`,
            `왕은 대답을 미루었습니다. 딸을 그렇게 내줄 수는 없었기 때문입니다. 그런데 그 자리에 왕자 카마르가 있었습니다. 왕자는 그 말을 타 보고 싶어 견딜 수가 없었습니다.<br>"제가 한번 타 보겠습니다."`,
            `왕자는 말에 올라 손잡이를 돌렸습니다. 말이 떠올랐습니다. 그리고 계속 올라갔습니다. 왕자는 내리는 방법을 묻지 않았던 것입니다.`,
            `말은 구름을 뚫고 올라갔습니다. 왕자는 숨이 막혔습니다. 높이 올라갈수록 바람이 찼습니다. 그리고 손으로 말의 몸을 더듬었습니다.`,
            `어깨 쪽에 손잡이가 하나 더 있었습니다. 그것을 돌리자 말이 내려가기 시작했습니다.`,
            `왕자는 그날 밤 아주 먼 나라의 궁전 지붕에 내렸습니다.`,
            `그 나라는 벵골이라는 곳이었습니다. 왕자가 이름도 들어 본 적 없는 나라였습니다. 그리고 거기서 공주를 만났습니다. 두 사람은 서로 마음이 맞았습니다.`,
            ...
            `그 나라 왕이 공주를 궁에 데리고 있었는데, 공주가 아무 말도 하지 않고 아무것도 먹지 않아 걱정하고 있었습니다. 왕자는 의원 행세를 하고 그 궁에 들어갔습니다. 약상자를 하나 들고 들어갔습니다.`,
    ...
    },
    {
        ...
        paras: [
            `바그다드에 하룬 알라시드라는 칼리프가 있었습니다. 칼리프는 그 나라에서 가장 높은 사람입니다. 하룬은 밤이면 옷을 바꿔 입고 시내를 걸어 다녔습니다. 장사꾼 차림을 할 때가 많았습니다.`,
            `백성이 실제로 어떻게 사는지 보려는 것이었습니다.`,
            `어느 밤, 다리 위에서 젊은이를 하나 만났습니다. 이름은 아부 하산이었습니다. 아버지가 남긴 재산이 있어서 넉넉히 사는 사람이었습니다. 아부 하산은 낯선 나그네인 하룬을 집에 데려가 밥을 먹였습니다. 누구인지 묻지도 않았습니다.`,
            ...
            `하룬은 그 말을 듣고 웃었습니다. 그리고 그날 밤 아부 하산의 잔에 잠드는 약을 조금 탔습니다. 아부 하산은 그것을 눈치채지 못했습니다. 아부 하산은 곧 잠들었습니다.`,
            ...
            `아부 하산은 자기가 꿈을 꾸는 줄 알았습니다. 손등을 물어 보았습니다. 꿈이면 아프지 않을 줄 알았던 것입니다. 아팠습니다.`,
            `그날 아부 하산은 칼리프 노릇을 했습니다. 그리고 제일 먼저 한 일이 있습니다. 그 동네의 못된 사람 넷을 잡아들이라고 한 것입니다.`,
            `그 사람들이 끌려왔습니다. 아부 하산은 그 사람들의 죄를 하나하나 말했습니다. 누가 누구의 밭을 빼앗았는지, 누가 과부의 돈을 떼먹었는지, 누가 아이들을 때렸는지. 날짜까지 짚어 냈습니다.`,
            ...
            `옆에서 하룬이 그것을 다 지켜보고 있었습니다. 그날 밤 아부 하산은 다시 잠들었고, 깨어 보니 자기 집이었습니다. 아부 하산은 그것이 꿈인지 아닌지 몰라 여러 날을 앓았습니다.`,
            ...
            `그리고 하룬은 아부 하산을 곁에 두었습니다. 그 뒤로 아부 하산은 칼리프에게 바깥 이야기를 전하는 사람이 되었습니다. 궁 안에서는 들을 수 없는 이야기였습니다.`
        ]
    },
    {
        num: 9,
        ...
        paras: [
            `어느 왕이 사냥을 나갔다가 길을 잃었습니다. 사슴을 쫓다가 일행과 떨어진 것이었습니다. 그러다 큰 호수를 하나 발견했습니다. 물이 아주 맑았습니다. 그 호수에는 물고기가 네 가지 빛깔로 헤엄치고 있었습니다. 흰 것과 붉은 것과 파란 것과 노란 것이었습니다. 수가 고르게 섞여 있었습니다.`,
            `그리고 호수 건너편에 궁전이 하나 있었습니다. 왕은 그 궁전으로 갔습니다. 문이 열려 있었습니다.`,
            `안에 들어가 보니 사람이 하나도 없었습니다. 방마다 등이 켜져 있고, 상에 밥이 차려져 있었습니다. 그런데 사람이 없었습니다.`,
            `왕이 큰 소리로 불렀습니다. 소리가 빈 방들을 돌아 되울렸습니다. 아무 대답이 없었습니다. 그러다 안쪽 방에서 우는 소리가 났습니다. 아주 낮게 흐느끼는 소리였습니다.`,
            `왕이 그 방에 들어갔습니다. 젊은 남자가 하나 옥좌에 앉아 있었습니다. 잘생긴 사람이었는데 얼굴이 몹시 슬펐습니다. 그 사람이 말했습니다.<br>"어서 오십시오. 일어나 맞지 못하는 것을 용서하십시오."<br>"괜찮소."<br>"제가 일어날 수 없어서 그럽니다."`,
            `그리고 그 사람이 옷자락을 걷었습니다. 왕이 그쪽으로 몸을 숙였습니다. 허리 아래가 돌이었습니다. 발끝까지 새까만 돌이었습니다. 왕은 그 자리에 굳었습니다. 손도 발도 움직이지 않았습니다.`,
            `젊은이가 이야기를 시작했습니다. 그는 검은 섬이라는 나라의 왕이었습니다. 섬 넷을 다스리던 나라였습니다. 여러 해 전, 그 나라 안에서 큰 배신이 있었습니다.`,
            `그 일을 꾸민 사람은 마법을 쓸 줄 알았습니다. 아주 오래 마법을 익힌 사람이었습니다. 그 사람은 왕을 이렇게 만들어 놓고, 나라 전체에도 마법을 걸었습니다. 하룻밤 사이에 벌어진 일이었습니다. 그 나라의 도시가 통째로 호수가 되었습니다. 집도 길도 다 물속에 잠겼습니다. 그리고 그 도시 사람들이 물고기가 되었습니다. 네 가지 빛깔은 그 나라의 네 부족이었습니다.`,
            `"저는 날마다 여기 앉아서 그 호수를 봅니다."<br>왕은 그 이야기를 다 듣고 이렇게 물었습니다.<br>"그 마법을 푸는 방법이 있소?"<br>"있습니다. 그런데 그것을 하려면 목숨을 걸어야 합니다."`,
            `왕은 그것을 하기로 했습니다. 그 방법이 무엇이었는지는 이야기마다 조금씩 다릅니다. 들려주는 사람마다 달리 전했기 때문입니다. 다만 결과는 같습니다. 어느 이야기에서든 왕이 목숨을 걸었습니다.`,
            `왕이 그것을 해냈고, 마법이 풀렸습니다. 땅이 크게 울렸습니다. 호수가 사라지고 그 자리에 도시가 다시 나타났습니다. 집과 길과 우물이 그대로 있었습니다. 물고기들이 사람이 되었습니다. 물이 빠진 자리에서 사람들이 일어섰습니다.`,
            `장에서 물건을 팔던 사람은 물건을 팔던 자리에 서 있었고, 밥을 짓던 사람은 부뚜막 앞에 서 있었습니다. 여러 해가 지난 줄도 모르고 있었습니다.`,
            `그런데 젊은 왕은 자기 나라로 돌아가지 않았습니다. 그 도시가 있던 자리가 너무 외진 곳이라 사람이 살기 어려워졌기 때문입니다.`,
            `늙은 왕이 이렇게 말했습니다.<br>"내 나라로 갑시다. 내게는 아들이 없소."`,
            `그래서 두 나라 사람들이 함께 옮겨 가 살았습니다. 사람과 짐승과 수레가 줄지어 갔습니다. 그 길이 한 해가 걸렸다고 합니다. 길에서 아이가 태어나기도 했습니다.`
        ]
    },
    {
        num: 10,
        ...
        paras: [
            `아라비안나이트에는 이런 이야기가 수백 편 들어 있습니다. 다 읽으려면 여러 달이 걸립니다. 어른도 끝까지 읽은 사람이 드뭅니다. 그런데 이 책에는 이상한 점이 하나 있습니다. 한 가지 나라의 이야기가 아니라는 것입니다. 한 사람이 지은 책도 아닙니다.`,
            `인도에서 온 이야기가 있고, 페르시아에서 온 이야기가 있고, 이집트에서 온 이야기가 있고, 바그다드에서 지어진 이야기가 있습니다. 장사꾼들이 낙타를 타고 오가면서 이야기도 함께 옮긴 것입니다. 천 년이 넘는 동안 여러 나라에서 흘러온 이야기가 이 한 권에 쌓인 것입니다.`,
            `그래서 이 책 안에는 서로 어긋나는 이야기도 있습니다. 어떤 편에서는 마신이 무섭고, 어떤 편에서는 마신이 심부름을 합니다. 같은 이름이 편마다 다른 뜻으로 쓰이기도 합니다. 어떤 편은 아주 짧고, 어떤 편은 백 쪽이 넘습니다.`,
            `그리고 한 가지가 더 있습니다.`,
            `알라딘과 알리바바는 사실 원래 아랍어 원본에 없었습니다. 제일 유명한 두 편이 그렇습니다. 삼백 년쯤 전에 프랑스 사람 앙투안 갈랑이 이 책을 유럽에 소개하면서 함께 실은 이야기입니다. 갈랑이 옮긴 뒤로 이 책이 온 유럽에서 읽혔습니다.`,
            `그가 시리아에서 온 어떤 사람에게 들은 것이라고 적어 두었습니다. 그 사람의 이름은 한나 디아브였다고 전해집니다. 그래서 그 두 편은 아라비안나이트에서 제일 유명한데, 원본에는 없습니다. 이야기라는 것이 그렇게 흘러다닙니다. 어디서 시작했는지 아무도 모르게 됩니다.`,
            `이제 셰에라자드의 이야기로 돌아가겠습니다. 이 책의 처음이자 마지막 이야기입니다. 셰에라자드는 천 하룻밤 동안 이야기를 했습니다. 하루도 거르지 않았습니다. 햇수로 거의 세 해였습니다. 천 하룻밤을 한 밤도 거르지 않았습니다. 그 사이에 아이가 셋 태어났습니다.`,
            ...
            `이 이야기를 어떻게 읽어야 하는지는 사람마다 다릅니다. 한 가지는 분명합니다. 셰에라자드가 목숨을 건 방법은 싸움이 아니었습니다. 그리고 애원도 아니었습니다. 살려 달라고 빈 적이 한 번도 없었습니다.`,
            `그 사람은 이야기를 했습니다. 날마다 다른 사람의 인생을 하나씩 왕 앞에 가져다 놓은 것입니다. 천 밤 동안 천 사람이 왕 앞을 지나간 셈입니다. 어부 이야기, 짐꾼 이야기, 도둑 이야기, 왕자 이야기. 다 다른 사람들이었습니다.`,
            `그 이야기들을 천 밤 동안 듣는 동안, 왕은 사람이라는 것을 다시 보게 되었습니다. 자기도 모르는 사이에 그렇게 되었습니다. 사람을 미워하기는 쉽습니다. 얼굴 한 번 안 보고도 미워할 수 있습니다. 그런데 그 사람의 이야기를 끝까지 듣고 나서도 미워하기는 어렵습니다. 셰에라자드는 그것을 알고 있었습니다. 천 밤을 걸고 그것에 기댄 것입니다.`
        ]
    }
];
/* ── 쪽 나누기 ─────────────────────────────────────────
