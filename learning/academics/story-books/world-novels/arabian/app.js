...
const CHAPTERS = [
    {
        ...
        paras: [
            `아주 오랜 옛날, 페르시아에 샤리아르라는 왕이 있었습니다. 젊고, 힘이 세고, 나라를 잘 다스리던 왕이었습니다. 백성이 그 왕을 따랐습니다. 그런데 어느 해에 왕은 크게 배신을 당했습니다. 그 일로 왕의 마음이 아주 상했습니다. 상한 마음을 어디에도 털어놓지 않았습니다. 왕이라 털어놓을 사람이 없었습니다.`,
            `가장 가까운 사람에게 속은 것입니다. 믿었던 만큼 크게 무너졌습니다. 작게 믿었으면 작게 무너졌을 것입니다. 크게 믿은 것이 화가 되었습니다. 그 뒤로 왕이 달라졌습니다. 왕은 이렇게 생각했습니다.`,
            `'사람은 아무도 믿을 수 없다. 그러니 정을 붙이기 전에 끝내면 된다.' 그때부터 왕은 무서운 일을 시작했습니다. 날마다 새로 혼인을 하고, 이튿날 아침이면 그 사람의 목숨을 빼앗았습니다.`,
            `삼 년이 지났습니다. 그 삼 년 동안 목숨을 잃은 사람이 천 명이 넘었습니다. 나라 안에 딸을 가진 집이 남지 않았습니다. 다들 딸을 데리고 다른 나라로 달아났기 때문입니다. 밤에 짐을 싸서 성문을 빠져나갔습니다. 낮에 나가면 눈에 띄기 때문입니다. 그렇게 빠져나간 집이 하루에 몇 집씩이었습니다.`,
            `그 일을 맡아 하던 것은 재상이었습니다. 재상은 날마다 왕에게 사람을 데려가야 했습니다. 그 일을 삼 년 동안 했습니다. 밤마다 잠을 이루지 못하는 사람이 되었습니다. 그 재상에게 딸이 둘 있었습니다. 큰딸은 셰에라자드, 작은딸은 두냐자드였습니다.`,
            `셰에라자드는 책을 아주 많이 읽은 사람이었습니다. 재상의 서고에 있는 책을 다 읽었습니다. 역사와 시와 옛이야기를 천 가지도 넘게 알고 있었습니다. 한 번 읽은 것은 잊지 않았습니다. 어느 대목에서 끊어야 사람이 궁금해하는지도 알고 있었습니다. 그것은 책에 적혀 있지 않은 것이었습니다.`,
            ...
            `재상은 여러 날 말렸습니다. 울면서도 말리고 화를 내면서도 말렸습니다. 그런데 딸은 뜻을 굽히지 않았습니다. 밥을 먹으면서도 그 말만 했습니다. 딸이 무엇을 하려는지 재상은 그때 알지 못했습니다. 알았더라도 말렸을 것입니다. 결국 셰에라자드가 궁으로 갔습니다.`,
            ...
            `왕은 그러라고 했습니다. 어차피 아침이면 끝날 일이라고 생각했습니다. 이야기 하나쯤 듣는다고 달라질 것이 없었습니다. 그것이 왕의 셈이었습니다.`,
            ...
            `그렇게 하루가 이틀이 되고, 이틀이 열흘이 되고, 열흘이 한 해가 되었습니다. 그동안 궁 안에서는 아무도 그 이야기를 입에 올리지 않았습니다. 입에 올리면 왕이 정신을 차릴까 봐서였습니다. 다들 그 밤이 하루라도 더 이어지기를 바랐습니다. 아래에 그 이야기 가운데 몇 편을 옮겨 적습니다.`
        ]
    },
    {
        num: 2,
        ...
        paras: [
            `가난한 어부가 하나 있었습니다. 그 어부에게는 규칙이 하나 있었습니다. 하루에 그물을 네 번만 던지는 것이었습니다. 네 번을 넘겨 욕심을 부리지 않겠다는 다짐이었습니다. 많이 던진다고 많이 잡히는 것도 아니었습니다. 그 규칙을 여러 해 지켰습니다.`,
            `어느 날 첫 번째 그물에 죽은 나귀가 걸려 올라왔습니다. 두 번째에는 모래가 가득 든 항아리가 올라왔습니다. 세 번째에는 깨진 그릇과 유리 조각이 올라왔습니다. 그물만 여기저기 찢어졌습니다. 찢어진 데를 그 자리에서 기웠습니다. 손이 굳어 매듭이 잘 지어지지 않았습니다.`,
            `어부는 하늘을 보고 한숨을 쉬었습니다. 그리고 네 번째 그물을 던졌습니다. 그날의 마지막 그물이었습니다. 이것마저 비면 빈손으로 돌아가야 했습니다.`,
            `이번에는 놋쇠 항아리가 올라왔습니다. 입구가 납으로 봉해져 있었고, 그 위에 도장이 찍혀 있었습니다. 어부는 '이 안에 무언가 값나가는 것이 들었겠지' 하고 그 봉을 뜯었습니다. 그러자 안에서 연기가 쏟아져 나왔습니다.`,
            `연기가 하늘로 올라가 뭉치더니, 어마어마하게 큰 마신이 되었습니다. 머리가 구름에 닿고 발이 땅에 닿았습니다. 눈이 화로만 했습니다. 입을 열자 동굴 같았습니다. 목소리가 땅을 울렸습니다. 어부는 다리에 힘이 빠졌습니다.`,
            `마신이 소리쳤습니다.<br>"준비해라. 나는 너를 죽이겠다."<br>"제가 당신을 꺼내 드렸는데요."<br>"그러니까 죽이겠다는 것이다."`,
            `그리고 마신이 이런 이야기를 했습니다. 그는 옛날에 어느 왕의 명을 어겨 그 항아리에 갇혔습니다. 납으로 봉하고 도장을 찍어 바다에 던진 것이었습니다. 그 도장은 아무나 뜯을 수 없는 것이었습니다. 그래서 사백 년을 그 안에 있었습니다. 첫 백 년 동안 그는 이렇게 생각했습니다.`,
            ...
            `그리고 다시 연기가 되어 항아리 속으로 들어갔습니다. 연기가 소용돌이치며 빨려 들어갔습니다. 들어가는 데도 한참이 걸렸습니다. 그만큼 큰 것이 그 안에 들어간 것입니다. 어부는 그 순간 뚜껑을 눌러 닫았습니다.`,
            `"이제 도로 바다에 던지겠습니다."<br>안에서 마신이 사정했습니다.<br>"내가 잘못했다. 꺼내 주면 너를 부자로 만들어 주겠다."<br>"사백 년 동안 마음이 세 번 바뀌신 분을 제가 어떻게 믿습니까."`,
            `그런데 어부는 결국 그를 꺼내 주었습니다. 마신이 그 은혜를 갚겠다고 맹세했기 때문입니다. 이번에는 정말이라고 여러 번 말했습니다. 어부는 그 말을 다 믿지는 않았습니다. 그래도 항아리를 다시 열어 주었습니다. 그리고 그 마신은 정말로 약속을 지켰습니다.`,
            `어부는 그 뒤로 잘살았습니다.`,
            `셰에라자드는 이 이야기를 마치고 왕을 보았습니다. 왕은 아무 말도 하지 않았습니다. 그런데 이 이야기가 무슨 이야기인지는 알아들었습니다.`,
            `오래 미움에 잠겨 있으면 마음이 그렇게 바뀐다는 이야기였습니다. 기다리던 것이 오지 않으면 사람은 마음을 접습니다. 접다 보면 나중에는 반대쪽으로 갑니다.`
        ]
    },
    {
        num: 3,
        ...
        paras: [
            ...
            `어머니가 실을 자아 팔아 겨우 먹고살았습니다. 밤이 늦도록 물레를 돌렸습니다. 그 소리를 들으며 알라딘은 잠들었습니다.`,
            `어느 날 낯선 사람이 알라딘을 찾아왔습니다.<br>"내가 네 아버지의 동생이다."`,
            `알라딘도 어머니도 그런 사람이 있다는 말을 들어 본 적이 없었습니다. 그런데 그 사람은 돈을 잘 썼습니다. 그리고 알라딘에게 좋은 옷을 사 주고, 가게를 차려 주겠다고 했습니다. 처음 보는 사람이 그렇게까지 하는 것이 이상한 일이었습니다. 그런데 가난한 집에서는 그런 것을 따져 볼 겨를이 없었습니다.`,
            `며칠 뒤 그 사람이 알라딘을 데리고 도시 밖으로 나갔습니다. 한참을 걸어 산 밑에 이르렀습니다. 그 사람이 땅에 무언가를 뿌리고 주문을 외웠습니다. 그러자 땅이 갈라지고 돌문이 나왔습니다.`,
            `그 사람은 마법을 쓰는 사람이었습니다. 아주 멀리서 이 램프를 찾아 여기까지 온 것이었습니다. 그 문은 정해진 아이만 열 수 있었습니다. 그래서 알라딘이 필요했던 것입니다. 그 사람에게 알라딘은 조카가 아니라 문을 여는 열쇠였습니다. 그러니 문만 열리면 그다음은 필요가 없었습니다.`,
            `그 사람이 알라딘에게 일렀습니다.<br>"들어가라. 안에 뜰이 있고 나무가 있다. 아무것도 만지지 말고, 벽에 걸린 낡은 램프만 가지고 나와라."`,
            `그리고 반지를 하나 끼워 주었습니다.<br>"이건 지키는 반지다."`,
            `알라딘은 계단을 내려갔습니다. 안에는 정말로 뜰이 있었습니다. 나무에 열매가 달려 있었는데, 그 열매가 다 보석이었습니다. 빨간 것과 파란 것과 초록 것이 가지마다 달려 있었습니다. 알라딘은 그것이 유리인 줄 알았습니다.`,
            ...
            `알라딘은 어둠 속에 갇혔습니다. 이틀 동안 알라딘은 그 안에서 울었습니다. 소리를 질러도 위에서는 들리지 않았습니다. 물도 없고 빛도 없었습니다. 그러다 손을 비비다가 반지를 문질렀습니다. 그러자 반지에서 무언가가 나왔습니다.<br>"주인님, 무엇을 원하십니까."`,
            ...
            `그때 알라딘은 사냥을 나가 있었습니다. 공주가 그 소리를 듣고, 창고에 굴러다니는 낡은 램프를 내주었습니다. 그 램프가 무엇인지 몰랐기 때문입니다. 알라딘은 그것을 아내에게도 말하지 않았던 것입니다. 제일 가까운 사람에게 말해 두지 않은 것이 화가 되었습니다. 감춘 것이 지켜 준 것이 아니라 오히려 잃게 한 것입니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `어느 날 알리바바가 숲에서 나무를 하고 있는데 말발굽 소리가 났습니다. 알리바바는 나무 위로 올라가 숨었습니다. 말 탄 사람이 마흔 명이었습니다. 하나하나 칼을 차고 있었습니다. 다들 짐을 잔뜩 싣고 있었습니다. 자루가 무거워 말이 힘들어했습니다. 어디서 가져온 것인지는 물어보나 마나였습니다.`,
            ...
            `바위가 갈라졌습니다. 안에는 굴이 있었습니다. 그 굴에 금과 은과 비단이 산더미처럼 쌓여 있었습니다. 수십 년 동안 모아 놓은 것이었습니다. 비단은 접힌 자리가 삭아 있었습니다. 오래 쌓아 두기만 하고 쓰지 않은 것이었습니다.`,
            `알리바바는 금화를 자루에 담아 나귀에 실었습니다. 그런데 다 가져가지 않았습니다. 나귀 세 마리에 실을 만큼만 가져갔습니다. 더 실으면 나귀가 힘들고, 남이 보면 이상하게 여길 것이었습니다. 그것이 알리바바가 살아남은 까닭입니다.`,
            `집에 와서 아내가 그 금을 되로 재려고 했습니다. 그런데 되가 없어서 형수네 집에서 빌려 왔습니다.`,
            `형수는 그 되에 몰래 밀랍을 발라 두었습니다. 바닥에 얇게 발라 두었습니다. 동생네가 무엇을 재는지 궁금했기 때문입니다. 가난한 집에서 되를 빌려 가는 것이 이상했던 것입니다. 곡식은 그 집에 있을 리가 없었습니다. 되를 돌려받아 보니 밀랍에 금화가 하나 붙어 있었습니다.`,
            ...
            `금을 눈앞에 두고 있는 동안 참깨라는 말이 머리에서 지워진 것입니다. 자루를 채우는 데 마음을 다 쓴 탓이었습니다. 나가는 길을 생각한 사람은 동생뿐이었습니다.`,
            ...
            `도적들이 기름 항아리 서른일곱 개를 실은 장사꾼 행세를 하고 그 집에 들었을 때, 모르지아나는 기름을 뜨러 갔다가 항아리 안에서 사람 숨소리를 들었습니다. 모르지아나는 소리를 지르지 않았습니다. 소리를 질렀으면 그 자리에서 서른일곱이 쏟아져 나왔을 것입니다. 그것을 그 짧은 사이에 셈한 것입니다.`,
            `그 대신 조용히 방법을 썼습니다. 그리고 그날 밤 그 집에서는 아무 일도 일어나지 않았습니다.`,
            `이 이야기에서 사람을 살린 것은 알리바바가 아니라 모르지아나였습니다. 알리바바는 나중에 그 사실을 알고, 모르지아나를 자기 아들과 혼인시키고 집안의 가족으로 삼았습니다. 그 시절 이야기에서 부리던 사람이 집안의 가족이 되는 일은 흔하지 않았습니다. 이 이야기가 오래 남은 까닭 가운데 하나가 그것입니다.`
        ]
    },
    {
        num: 5,
        ...
        paras: [
            `바그다드에 신드바드라는 짐꾼이 살았습니다. 무거운 짐을 지고 다니며 먹고살았습니다. 등이 짐 모양대로 굽어 있었습니다. 어느 더운 날, 그는 어느 큰 집 대문 앞에서 짐을 내려놓고 쉬었습니다. 안에서 음악 소리와 웃음소리가 났습니다. 고기 냄새도 담을 넘어왔습니다. 짐꾼은 아침부터 아무것도 먹지 못한 참이었습니다. 담벼락에 등을 대고 앉아 그 냄새를 맡았습니다.`,
            `짐꾼은 이렇게 중얼거렸습니다.<br>"어떤 이는 저 안에 있고 어떤 이는 이 밖에 있구나."`,
            `그 소리를 그 집 사람이 들었습니다. 그리고 주인이 그를 안으로 불렀습니다. 그 집 주인의 이름도 신드바드였습니다. 그래서 주인이 그를 불러들인 것이었습니다. 일곱 번 바다에 나갔다가 돌아온 뱃사람 신드바드였습니다. 일곱 번 다 큰일을 겪고 돌아왔습니다. 그때마다 다시는 안 나가겠다고 했습니다.`,
            ...
            `나는 섬을 돌아다녔네. 사람이 살던 자취는 하나도 없었네. 그러다 흰 둥근 것을 하나 보았네. 지붕만큼 컸네. 매끈하고 흠이 없었네. 두드려 보니 속이 빈 소리가 났네.`,
            `나는 그것이 무엇인지 한참 몰랐네. 그런데 해가 갑자기 어두워졌네. 한낮인데 그늘이 졌네. 하늘을 보니 새가 한 마리 내려오고 있었네.`,
            `구름을 가릴 만큼 큰 새였네. 로크라는 새라고 하네. 그 흰 것은 그 새의 알이었네. 그러니 그 새가 얼마나 큰지 알 만하지 않은가. 다리 하나가 나무 둥치만 했네.`,
            ...
            `나는 줄을 풀고 뛰어내렸네. 그 골짜기 바닥에 무엇이 깔려 있었는지 아나. 다이아몬드였네. 그런데 그 골짜기에는 큰 뱀들이 살고 있었네. 몸통이 나무 둥치만 했네. 낮에는 굴 속에 있다가 해가 지면 나왔네. 그래서 나는 해가 있는 동안에만 움직였네.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `나는 딱하게 여겨 그 사람을 업었네. 뼈만 남은 것처럼 가벼웠네. 개울을 건너 내려놓으려고 했네. 물이 무릎까지밖에 오지 않는 개울이었네. 업어 줄 것도 없는 개울이었네. 그것을 그때는 생각하지 못했네. 그런데 내려오지 않았네.`,
            `두 다리로 내 목을 감고 놓지 않았네. 그 다리에 힘이 어찌나 센지 목이 졸릴 지경이었네. 쇠고리를 채운 것 같았네. 떼어 내려고 손을 넣어 보았지만 손가락도 들어가지 않았네. 그 가벼운 몸 어디에 그런 힘이 있었는지 모르네.`,
            `그때부터 그 노인은 내 등에서 내려오지 않았네. 내가 자면 등에서 자고, 내가 걸으면 발로 옆구리를 차서 방향을 시켰네. 내 등이 그 사람의 집이 된 것이네. 열매를 따라고 하면 따야 했고, 물을 뜨라고 하면 떠야 했네. 조금이라도 굼뜨면 옆구리를 걷어찼네. 밤에도 내려오지 않았네. 나는 앉아서 자는 법을 배웠네.`,
            `그렇게 여러 달이 지났네. 날을 세는 것도 그만두었네. 나는 등이 굽고 다리가 떨렸네. 거울이 있었다면 나도 나를 못 알아보았을 걸세. 목소리도 나오지 않게 되었네. 말을 할 일이 없었기 때문이네. 그러다 어느 날 나는 방법을 하나 생각해 냈네. 힘으로는 안 되니 다른 길을 찾은 것이네.`,
            ...
            `그것이 익어 술이 되었네. 며칠 지나니 냄새가 났네. 나는 그것을 마시고 기운이 난 척했네. 일부러 크게 웃었네. 노래를 부르고 춤을 추었네. 등에 사람을 업은 채로 그렇게 했네. 업힌 사람이 흔들리도록 일부러 크게 움직였네. 그래야 무엇을 마셨는지 궁금해질 것이었네.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `세 번째 사람은 검은 나무로 만든 말을 가져왔습니다. 보기에는 그냥 말 조각이었습니다. 칠도 하지 않은 검은 나무였습니다. 사람들이 보고 시시하게 여겼습니다. 그 사람이 말했습니다.<br>"이것은 하늘을 납니다."`,
            ...
            `왕자는 말에 올라 손잡이를 돌렸습니다. 말이 떠올랐습니다. 그리고 계속 올라갔습니다. 왕자는 내리는 방법을 묻지 않았던 것입니다. 올라가는 손잡이만 보고 올라탄 것입니다. 신기한 것을 보면 사람은 대개 그렇게 합니다.`,
            `말은 구름을 뚫고 올라갔습니다. 왕자는 숨이 막혔습니다. 높이 올라갈수록 바람이 찼습니다. 아래를 보니 성이 손톱만 했습니다. 소리쳐도 들릴 데가 없었습니다. 그리고 손으로 말의 몸을 더듬었습니다.`,
            `어깨 쪽에 손잡이가 하나 더 있었습니다. 그것을 돌리자 말이 내려가기 시작했습니다.`,
            `왕자는 그날 밤 아주 먼 나라의 궁전 지붕에 내렸습니다.`,
            `그 나라는 벵골이라는 곳이었습니다. 왕자가 이름도 들어 본 적 없는 나라였습니다. 말도 통하지 않았습니다. 그런데도 이야기가 되었습니다. 그리고 거기서 공주를 만났습니다. 두 사람은 서로 마음이 맞았습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `하룬은 그 말을 듣고 웃었습니다. 그리고 그날 밤 아부 하산의 잔에 잠드는 약을 조금 탔습니다. 아부 하산은 그것을 눈치채지 못했습니다. 잔을 비우고 나서 곧 말이 느려졌습니다. 그러고는 그 자리에서 엎드려 잠들었습니다. 아부 하산은 곧 잠들었습니다.`,
            ...
            `아주 자세히 알고 있었습니다. 그 동네에서 오래 살았기 때문입니다. 높은 자리에 앉은 사람은 그런 것을 모릅니다. 아래에서 살아 본 사람만 압니다. 그리고 벌을 내렸습니다. 그다음에는 어머니와 이웃들에게 돈을 보내라고 했습니다.`,
            ...
            `그리고 하룬은 아부 하산을 곁에 두었습니다. 그 뒤로 아부 하산은 칼리프에게 바깥 이야기를 전하는 사람이 되었습니다. 궁 안에서는 들을 수 없는 이야기였습니다. 높은 사람에게 올라가는 말은 올라가는 동안 다듬어집니다. 다듬어지지 않은 말을 전할 사람이 필요했던 것입니다.`
        ]
    },
    {
        num: 9,
        ...
        paras: [
            `어느 왕이 사냥을 나갔다가 길을 잃었습니다. 사슴을 쫓다가 일행과 떨어진 것이었습니다. 그러다 큰 호수를 하나 발견했습니다. 물이 아주 맑았습니다. 그 호수에는 물고기가 네 가지 빛깔로 헤엄치고 있었습니다. 흰 것과 붉은 것과 파란 것과 노란 것이었습니다. 수가 고르게 섞여 있었습니다. 헤엄치는 모양도 빛깔마다 달랐습니다. 왕은 그것을 한참 들여다보았습니다.`,
            `그리고 호수 건너편에 궁전이 하나 있었습니다. 왕은 그 궁전으로 갔습니다. 문이 열려 있었습니다.`,
            `안에 들어가 보니 사람이 하나도 없었습니다. 방마다 등이 켜져 있고, 상에 밥이 차려져 있었습니다. 그런데 사람이 없었습니다. 밥에서 김이 오르고 있었습니다. 방금까지 사람이 있었던 것 같았습니다.`,
            `왕이 큰 소리로 불렀습니다. 소리가 빈 방들을 돌아 되울렸습니다. 아무 대답이 없었습니다. 그러다 안쪽 방에서 우는 소리가 났습니다. 아주 낮게 흐느끼는 소리였습니다. 참다가 새어 나오는 소리였습니다. 왕은 그 소리를 따라갔습니다.`,
            ...
            `그리고 그 사람이 옷자락을 걷었습니다. 왕이 그쪽으로 몸을 숙였습니다. 허리 아래가 돌이었습니다. 발끝까지 새까만 돌이었습니다. 왕은 그 자리에 굳었습니다. 손도 발도 움직이지 않았습니다. 돌은 차가웠습니다. 만져 보니 정말 돌이었습니다.`,
            `젊은이가 이야기를 시작했습니다. 그는 검은 섬이라는 나라의 왕이었습니다. 섬 넷을 다스리던 나라였습니다. 여러 해 전, 그 나라 안에서 큰 배신이 있었습니다.`,
            `그 일을 꾸민 사람은 마법을 쓸 줄 알았습니다. 아주 오래 마법을 익힌 사람이었습니다. 그 사람은 왕을 이렇게 만들어 놓고, 나라 전체에도 마법을 걸었습니다. 하룻밤 사이에 벌어진 일이었습니다. 저녁에 자리에 든 사람들이 아침에 물속에 있었던 것입니다. 무슨 일이 일어났는지 아무도 알지 못했습니다. 그 나라의 도시가 통째로 호수가 되었습니다. 집도 길도 다 물속에 잠겼습니다. 그리고 그 도시 사람들이 물고기가 되었습니다. 네 가지 빛깔은 그 나라의 네 부족이었습니다.`,
            `"저는 날마다 여기 앉아서 그 호수를 봅니다."<br>왕은 그 이야기를 다 듣고 이렇게 물었습니다.<br>"그 마법을 푸는 방법이 있소?"<br>"있습니다. 그런데 그것을 하려면 목숨을 걸어야 합니다."`,
            `왕은 그것을 하기로 했습니다. 그 방법이 무엇이었는지는 이야기마다 조금씩 다릅니다. 들려주는 사람마다 달리 전했기 때문입니다. 다만 결과는 같습니다. 어느 이야기에서든 왕이 목숨을 걸었습니다. 남의 나라 일에 목숨을 건 것입니다. 그 대목만은 어느 판본에서도 빠지지 않습니다.`,
            `왕이 그것을 해냈고, 마법이 풀렸습니다. 땅이 크게 울렸습니다. 호수가 사라지고 그 자리에 도시가 다시 나타났습니다. 집과 길과 우물이 그대로 있었습니다. 물고기들이 사람이 되었습니다. 물이 빠진 자리에서 사람들이 일어섰습니다.`,
            `장에서 물건을 팔던 사람은 물건을 팔던 자리에 서 있었고, 밥을 짓던 사람은 부뚜막 앞에 서 있었습니다. 여러 해가 지난 줄도 모르고 있었습니다. 자기가 물고기였던 것도 몰랐습니다. 다만 아이들이 그 사이에 자라 있었습니다.`,
            `그런데 젊은 왕은 자기 나라로 돌아가지 않았습니다. 그 도시가 있던 자리가 너무 외진 곳이라 사람이 살기 어려워졌기 때문입니다.`,
            `늙은 왕이 이렇게 말했습니다.<br>"내 나라로 갑시다. 내게는 아들이 없소."`,
            `그래서 두 나라 사람들이 함께 옮겨 가 살았습니다. 사람과 짐승과 수레가 줄지어 갔습니다. 그 길이 한 해가 걸렸다고 합니다. 길에서 아이가 태어나기도 했습니다. 그 아이는 두 나라 어디에도 속하지 않은 데서 태어난 셈입니다. 그런 아이가 그 해에 여럿이었다고 합니다.`
        ]
    },
    {
        num: 10,
        ...
        paras: [
            ...
            `그래서 이 책 안에는 서로 어긋나는 이야기도 있습니다. 어떤 편에서는 마신이 무섭고, 어떤 편에서는 마신이 심부름을 합니다. 같은 이름이 편마다 다른 뜻으로 쓰이기도 합니다. 어떤 편은 아주 짧고, 어떤 편은 백 쪽이 넘습니다. 한 사람이 지었다면 이렇게 되지 않았을 것입니다. 그 어긋남이 오히려 이 책이 어떻게 만들어졌는지를 알려 줍니다.`,
            `그리고 한 가지가 더 있습니다.`,
