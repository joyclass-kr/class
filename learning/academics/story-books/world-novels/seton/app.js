...
const CHAPTERS = [
    {
        ...
        paras: [
            ...
            `발자국이 아주 커서 그것만 보고도 로보인 줄 알았습니다. 로보에게는 여러 가지가 알려져 있었습니다. 앞발 자국이 어른 손바닥만 했습니다. 첫째, 로보는 독을 절대 먹지 않았습니다.`,
            `사람들이 고기에 독을 넣어 놓으면, 로보는 그것을 파내어 한데 모아 놓고 그 위에 표시를 하고 갔습니다. 그렇게 하고 간 자리를 시튼은 여러 번 보았습니다. 둘째, 로보는 덫을 알아보았습니다. 사람들이 덫을 놓으면 그 자리를 피해 갔습니다.`,
            ...
            `천 달러였습니다. 그 시절 큰돈이었습니다. 사냥꾼들이 몰려왔습니다. 말 한 필이 스무 달러 하던 때였습니다.`,
            `아무도 잡지 못했습니다. 천팔백구십사 년, 이 글을 쓰는 시튼이 그 지방에 갔습니다. 시튼은 그때 서른 몇 살이었고, 덫을 놓는 데 자신이 있었습니다. 시튼은 넉 달 동안 온갖 방법을 다 썼습니다.`,
            `그동안 로보는 소를 계속 잡았습니다. 시튼이 온 뒤로 오히려 더 잡았습니다. 독을 여섯 가지로 바꿔 가며 놓았습니다. 로보는 다 파냈습니다.`,
            `덫을 백서른 개 놓았습니다. 로보는 다 피했습니다.`,
            `한번은 좁은 길목에 덫을 넉 줄로 늘어놓았습니다. 이튿날 가 보니 로보가 그 길로 들어와서, 덫이 없는 자리만 골라 밟고 지나갔습니다. 그리고 그 끝에서 덫을 하나 파내어 뒤집어 놓고 갔습니다. 시튼은 그날 하루 종일 아무 말도 하지 않았다고 적었습니다.`,
            `시튼은 그해 여름에 이런 것을 알아냈습니다. 로보의 무리에 흰 늑대가 하나 있었습니다. 발자국이 작고 걸음이 가벼웠습니다.`,
            `사람들은 그것을 블랑카라고 불렀습니다. 그리고 로보가 그 늑대와 늘 함께 다닌다는 것을 알았습니다. 블랑카는 로보만큼 조심스럽지 않았습니다. 시튼은 그것을 이용하기로 했습니다.`,
            ...
            `네 발이 다 걸려 있었습니다. 로보는 시튼을 보고 일어섰습니다. 그리고 짖지 않았습니다. 기운이 다 빠졌는데도 서 있었습니다.`,
            `시튼은 그 자리에서 로보를 쏘지 못했습니다. 대신 목에 줄을 걸어 목장으로 데려갔습니다. 그리고 마당에 매어 두고 고기와 물을 주었습니다.`,
            `로보는 그것을 먹지 않았습니다. 그리고 들판 쪽만 보고 있었습니다. 사람들이 사흘을 두고 보았지만 물 한 모금 마시지 않았습니다.`,
            `이튿날 아침, 로보는 그 자리에서 세상을 떠나 있었습니다. 상처는 없었습니다. 사람들은 그 몸을 블랑카 옆에 놓아 주었습니다.`,
            `줄이 끊긴 것도 아니었습니다. 목걸이가 그대로 매여 있었습니다. 시튼은 그 뒤로 다시는 늑대를 잡지 않았습니다. 그리고 평생 야생 동물을 지키는 일을 했습니다.`
        ]
    },
    {
        num: 2,
        ...
        paras: [
            ...
            `첫째, 까마귀는 말을 씁니다. 소리가 스무 가지가 넘었습니다. 짧게 두 번은 안전, 길게 세 번은 사람, 아주 날카롭게 하나는 총이었습니다. 시튼은 그 소리를 하나하나 공책에 적어 두었습니다.`,
            `시튼이 총을 들고 나가면 그 소리가 났고, 총 없이 나가면 나지 않았습니다. 둘째, 무리에 규율이 있었습니다. 아침에 골짜기를 나설 때 순서가 있었습니다. 그리고 먹이를 찾으러 갈 때 늘 보초를 세웠습니다.`,
            `보초를 서는 까마귀는 먹지 않고 높은 데 앉아 있었습니다. 그러다 교대를 했습니다. 보초가 소리를 내면 이백 마리가 한꺼번에 날아올랐습니다. 셋째, 은점박이는 훈련을 시켰습니다.`,
            `여름이면 그해에 태어난 어린 까마귀들을 데리고 다니면서 하나씩 가르쳤습니다. 시튼은 그것을 여러 번 보았습니다. 가르치는 일이 여름 내내 이어졌습니다.`,
            ...
            `은점박이는 아주 늙었습니다. 날개 깃이 닳아 있었고, 부리에 흠이 많았습니다. 시튼은 그 나이를 스무 살이 넘었을 것으로 보았습니다. 그렇게 오래 사는 까마귀는 드뭅니다.`,
            `어느 해 봄, 은점박이가 무리와 함께 오지 않았습니다. 시튼은 여러 날 그 골짜기를 뒤졌습니다. 그리고 언덕 아래에서 그 몸을 찾아냈습니다.`,
            `부엉이에게 당한 것이었습니다. 늙어서 밤에 눈이 어두워진 것이 아닐까 하고 시튼은 적었습니다. 부엉이는 까마귀의 오랜 적입니다. 밤에는 부엉이 쪽이 훨씬 잘 봅니다.`,
            `그 뒤로 그 무리에는 다른 우두머리가 생겼습니다. 그런데 그 뒤로 여러 해 동안, 그 무리는 예전만큼 하지 못했습니다. 시튼은 그 대목에 이렇게 적었습니다.<br>"우리는 짐승이 그저 본능으로 산다고 배웠다. 그런데 저 무리가 잘하던 것들은 은점박이가 죽자 함께 사라졌다."<br>"그것이 본능이라면 사라질 리가 없다. 저것은 가르쳐서 이어지던 것이었다."`
        ]
    },
    {
        num: 3,
        ...
        paras: [
            ...
            `둘째, 굴 근처에서는 절대 곧장 굴로 들어가지 않습니다. 한 바퀴 돌아서, 뛰어서 건너뛰어 들어갑니다. 발자국이 굴 앞에서 끊기게 하는 것입니다. 쫓아오던 짐승은 그 자리에서 냄새를 잃습니다.`,
            `셋째, 개에게 쫓기면 물로 갑니다. 물에 들어가면 냄새가 끊깁니다. 넷째, 가시덤불로 들어갑니다. 랙이 사는 늪 가운데에도 아주 두꺼운 찔레 덤불이 하나 있었습니다.`,
            `토끼는 낮게 지나갈 수 있지만 큰 짐승은 못 들어옵니다. 랙은 이것을 하나씩 배웠습니다. 그리고 여러 번 죽을 뻔했습니다.`,
            `한번은 뱀에게 붙잡혔습니다. 그때 몰리가 달려와 뱀을 물어뜯어 구했습니다. 몰리는 그때 앞발로 뱀의 머리를 밟고 물어뜯었습니다.`,
            ...
            `랙을 쫓던 총이 아니었습니다. 몰리가 랙 앞으로 나갔던 것입니다. 시튼은 이 이야기 끝에 이렇게 적었습니다.<br>"토끼가 오래 사는 것은 빠르기 때문이 아니다. 아는 것이 많기 때문이다."<br>"그리고 그 아는 것은 다 어미에게서 온 것이다."`
        ]
    },
    {
        num: 4,
        ...
        paras: [
            `이 이야기는 시튼이 소년 때 겪은 일입니다. 열몇 살 무렵의 일이라고 했습니다. 그 무렵 마을에서 닭이 자꾸 없어졌습니다. 사람들은 여우 짓이라고 했습니다.`,
            `한 집에서 하루에 세 마리가 없어진 적도 있었습니다. 시튼과 몇 사람이 그 여우 굴을 찾아냈습니다. 언덕 비탈의 모래 굴이었습니다. 그 앞에 새끼 네 마리가 놀고 있었습니다.`,
            ...
            `살아 있는 쥐를 물어다 놓아주고 잡게 하는 식이었습니다. 한번은 어미가 새끼 하나를 발로 밀어 냈습니다. 그 새끼가 굴 밖으로 너무 멀리 나갔기 때문입니다. 새끼가 놓치면 어미가 다시 잡아다 놓아주었습니다.`,
            `여우는 새끼를 그렇게 가르쳤습니다. 그런데 마을 사람들이 그 굴을 파기로 했습니다. 사람들이 삽을 들고 갔습니다. 굴을 파는 데 어른 여럿이 반나절을 매달렸습니다.`,
            ...
            `개가 있고 사람이 있는 마당이었습니다. 그런데도 왔습니다. 시튼은 밤에 창가에 앉아 그것을 보았습니다. 여우가 사람 사는 마당에 밤마다 들어오는 것은 있을 수 없는 일이었습니다.`,
            `어미는 사슬을 물어뜯으려고 했습니다. 이빨이 부러질 때까지 물었습니다. 그래도 끊어지지 않았습니다. 쇠사슬이었습니다.`,
            `그렇게 여러 밤이 지났습니다. 그리고 어느 날 아침, 새끼가 죽어 있었습니다. 상처는 없었습니다. 새끼는 그동안 사슬에 목이 쓸려 털이 벗겨져 있었습니다.`,
            `그 옆에 먹이가 놓여 있었습니다. 독이 있는 미끼였습니다. 사람들이 여우를 잡으려고 마을 여기저기에 놓아둔 것이었습니다.`,
            `그 미끼는 여우에게 잘 알려진 것이었습니다. 어미가 그것을 몰랐을 리 없습니다.`,
            `어미가 그것을 물어다 준 것입니다. 시튼은 그것이 실수인지 아닌지를 오래 생각했습니다. 그리고 이 이야기 끝에 이렇게만 적었습니다.<br>"나는 그 뒤로 그 여우를 다시 보지 못했다."<br>"그리고 나는 그 마당의 기둥을 지날 때마다 걸음이 빨라진다."`
        ]
    },
    {
        num: 5,
        ...
        paras: [
            `이것은 시튼이 캐나다에서 농장 일을 할 때의 이야기입니다. 이웃집에서 강아지를 하나 얻었습니다. 검은 개였고, 이름을 빙고라고 지었습니다. 그 무렵 시튼은 스물 몇 살이었고, 그림을 그려 팔면서 농장 일을 도왔습니다.`,
            `빙고는 자라면서 이상한 개가 되었습니다. 집에 붙어 있지 않았습니다. 낮에는 어디로 갔는지 알 수 없었고, 저녁이면 돌아왔습니다. 그리고 사람 곁에 오래 있지 않았습니다.`,
            `개는 사람 곁에 있으려고 하는 짐승인데 빙고는 그러지 않았습니다. 쓰다듬으면 잠깐 있다가 슬쩍 빠져나갔습니다. 그래도 빙고는 시튼을 알아보았습니다. 아주 멀리서도 알아보았습니다.`,
            `이름을 부르면 귀만 움직이고 오지는 않았습니다. 빙고에게는 한 가지 재주가 있었습니다. 소를 모는 것이었습니다. 누가 가르친 적이 없는데 아주 잘했습니다.`,
            `어느 소가 어느 우리 것인지도 알았습니다. 저녁에 소가 안 들어오면 빙고 혼자 나가서 몰고 왔습니다. 시튼은 나중에 그 농장을 떠났습니다. 빙고는 다른 사람에게 맡겨졌습니다.`,
            `그 농장에서 빙고를 대신할 것은 없었습니다.`,
            `여러 해가 지났습니다. 어느 겨울, 시튼이 그 지방에 다시 갔습니다. 늑대를 잡으려고 덫을 여러 개 놓아둔 참이었습니다. 그런데 밤에 덫을 살피러 가다가 시튼 자신이 덫에 걸렸습니다.`,
            `손이 걸렸습니다. 그리고 다른 손으로 그것을 벌리려다가 그 손마저 다른 덫에 걸렸습니다. 두 손이 다 묶인 것이었습니다. 늑대 덫은 사람 힘으로는 잘 벌어지지 않습니다.`,
            `영하 이십 도가 넘는 밤이었습니다. 그리고 아무도 그가 어디 있는지 몰랐습니다. 시튼은 그 자리에서 여러 시간을 보냈습니다. 그런 밤에 손이 얼면 손을 잘라 내야 합니다.`,
            ...
            `여러 해 만에 만난 것인데도 알아보았습니다. 늑대가 다가오면 짖어서 쫓았습니다. 아침에 사람들이 시튼을 찾아냈습니다. 빙고가 그 자리에서 계속 짖고 있었기 때문입니다.`,
            `아침까지 그 자리를 뜨지 않았습니다. 시튼은 손을 잃지 않았습니다. 그 뒤로 빙고는 또 사라졌습니다. 그리고 몇 해 뒤에 세상을 떠났습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `그날 어미와 형제 셋이 죽었습니다. 왑만 덤불 속에 숨어 살아남았습니다. 왑은 그때 젖도 못 뗀 새끼였습니다. 그런 새끼가 혼자 살아남는 일은 거의 없습니다.`,
            `왑은 혼자 자랐습니다. 가르쳐 주는 것이 없어서 다 스스로 알아내야 했습니다. 무엇을 먹어도 되는지, 벌집을 어떻게 여는지, 겨울을 어떻게 나는지. 그리고 여러 번 크게 다쳤습니다.`,
            `어미가 있는 새끼는 두 해 동안 그것을 배웁니다. 호저의 가시가 앞발에 박혀 여러 달을 절었습니다. 그런데 왑은 살아남았습니다. 그리고 아주 크게 자랐습니다.`,
            `호저의 가시는 끝이 낚싯바늘처럼 되어 있어서 한번 박히면 빠지지 않습니다. 왼쪽 앞발에 흰 발자국 자국이 남아서 사람들이 알아보았습니다. 왑은 그 골짜기에서 제일 센 짐승이 되었습니다. 다른 곰도, 늑대도, 퓨마도 그를 피했습니다.`,
            `왑에게는 자기 땅이 있었습니다. 그 둘레의 나무에 발톱 자국을 내어 표시했습니다. 곰은 나무에 서서 될 수 있는 한 높이 발톱 자국을 냅니다. 그 땅은 골짜기 하나만 한 넓이였습니다.`,
            ...
            `왑은 그 골짜기가 무엇인지 알고 있었습니다. 그 앞에서 평생 발길을 돌렸기 때문입니다. 그날은 돌리지 않았습니다. 시튼은 이 대목에 이렇게 적었습니다.<br>"내가 저 곰의 마음을 안다고 말할 수는 없다. 그런데 나는 그날 그 골짜기 입구에 남은 발자국을 보았고, 그 발자국은 한 번도 뒤로 돌아오지 않았다."`
        ]
    },
    {
        num: 7,
        ...
        paras: [
            `캐나다 돈 강 골짜기에 뇌조가 살았습니다. 뇌조는 꿩과 비슷한 새입니다. 목에 붉은 깃이 도드라진 수컷이 있어서, 시튼은 그것을 붉은 목이라고 불렀습니다. 땅에서 지내는 새라 나무 위보다 낙엽 위에 있는 때가 많습니다.`,
            `봄이면 수컷 뇌조는 통나무 위에 올라가 날개를 칩니다. 아주 빨리 쳐서 북소리 같은 소리를 냅니다. 그 소리로 암컷을 부르는 것입니다.`,
            `그 소리는 아주 멀리까지 갑니다. 사람 귀에는 북을 두드리는 소리로 들립니다.`,
            `붉은 목은 그 골짜기에서 제일 좋은 통나무를 차지하고 있었습니다. 그해 봄 붉은 목은 짝을 만났습니다. 암컷은 낙엽 속에 둥지를 짓고 알을 열두 개 낳았습니다. 그 통나무를 두고 다른 수컷과 여러 번 싸웠습니다.`,
            `새끼가 나온 날 시튼이 그것을 보았습니다. 막 알에서 나온 새끼가 벌써 걸었습니다. 그리고 어미가 소리를 내자 그 자리에서 다 얼어붙었습니다. 알에서 나온 지 몇 시간 만이었습니다.`,
            `낙엽 위에 있으니 하나도 보이지 않았습니다. 어미가 다시 소리를 내자 다시 움직였습니다. 한번은 여우가 다가왔습니다. 그 소리는 사람 귀에 거의 들리지 않을 만큼 낮았습니다.`,
            ...
            `족제비가 둘을 잡았습니다. 사람이 놓은 덫에 셋이 걸렸습니다. 사람이 놓은 덫은 뇌조를 잡으려던 것이 아니었습니다. 그래도 걸렸습니다.`,
            `가을이 되자 넷이 남았습니다. 겨울에 눈이 왔습니다. 뇌조는 눈 속에서 잡니다. 열둘 가운데 넷이면 그해에는 많이 남은 편이었습니다.`,
            `눈에 구멍을 파고 들어가면 그 안이 따뜻합니다. 그런데 그해 겨울에는 비가 왔다가 얼었습니다. 눈 위에 얼음이 두껍게 덮인 것입니다. 눈 속이 바깥보다 이십 도쯤 따뜻합니다.`,
    ...
    },
    {
        ...
        paras: [
            `어니스트 톰프슨 시튼은 천팔백육십 년 영국에서 태어났습니다. 여섯 살 때 가족이 캐나다로 옮겨 갔습니다. 아버지는 아주 엄한 사람이었습니다. 열넷이나 되는 아이를 그 사람은 회초리로 다스렸습니다.`,
            `아이가 열넷인 집의 여덟째였습니다.`,
            `시튼이 스물한 살이 되던 날, 아버지가 청구서를 하나 내밀었다고 합니다. 태어나서 스물한 살까지 먹이고 입힌 값이었습니다. 시튼은 그 돈을 다 갚았습니다. 그리고 다시는 아버지를 만나지 않았습니다.`,
            `그 돈은 오백삼십칠 달러였습니다. 시튼은 어릴 때 숲에서 지냈습니다. 짐승을 보고 그림을 그리고, 본 것을 공책에 적었습니다. 아버지가 그림 그리는 것을 못마땅해했기 때문에 숨어서 그렸습니다.`,
            ...
            `잡은 짐승의 값을 받아 살았으니, 그 무렵의 시튼은 이 책에 나오는 사냥꾼들과 다르지 않았습니다. 로보를 잡는 데 넉 달이 걸렸고, 그 넉 달 동안 시튼은 그 짐승을 아주 잘 알게 되었습니다. 그리고 알고 나니 잡을 수가 없어졌습니다.`,
            `시튼은 그 뒤로 야생 동물을 지키는 일에 평생을 썼습니다. 그리고 아이들에게 숲을 가르치는 단체를 만들었습니다. 그 단체가 나중에 보이스카우트가 되는 데 큰 몫을 했습니다. 그 단체의 이름은 우드크래프트 인디언스였습니다.`,
            `아이들을 숲으로 데려가 불 피우는 법과 발자국 읽는 법을 가르쳤습니다. 시튼은 그 단체에 등수를 두지 않았습니다. 자기가 그렇게 자랐기 때문입니다.`,
            `시튼의 이야기에는 한 가지 규칙이 있습니다. 주인공이 대개 마지막에 죽습니다. 사람들이 그것을 두고 시튼을 여러 번 나무랐습니다. 로보도, 은점박이도, 왑도, 붉은 목도 그렇습니다.`,
            `살아서 끝나는 것은 솜꼬리토끼 랙 하나뿐입니다. 아이들이 읽는 책인데 왜 그렇게 쓰느냐는 것이었습니다. 그때마다 시튼은 물러서지 않았습니다.`,
