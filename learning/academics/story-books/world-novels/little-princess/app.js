...
const CHAPTERS = [
    {
        ...
        paras: [
            ...
            `안개가 어찌나 짙은지 가로등이 노란 얼룩처럼 보였습니다. 말발굽 소리만 또각또각 났습니다.`,
            `세라는 그 소리를 세고 있었습니다. 세다가 자꾸 놓쳤습니다.`,
            `세라는 그날 아침부터 아무 말도 하지 않고 있었습니다.`,
            `마차 안에는 아버지와 딸이 앉아 있었습니다. 딸은 일곱 살이었는데, 나이보다 어른스러운 얼굴로 창밖을 보고 있었습니다. 초록빛이 도는 잿빛 눈에 속눈썹이 길었고, 머리카락은 검었습니다.`,
            `웃지 않는 얼굴이었습니다. 그렇다고 슬픈 얼굴도 아니었습니다.`,
            `무언가를 골똘히 생각하는 얼굴이었습니다.`,
            ...
            `크루 대위는 젊고 잘생긴 군인이었습니다. 그리고 딸을 아주 좋아했습니다.`,
            `두 사람은 서로에게 하나뿐인 식구였습니다.`,
            `인도의 그 집에서 두 사람은 늘 같이 밥을 먹었습니다.`,
            `세라는 어른들 사이에서 자랐습니다. 또래와 놀아 본 적이 거의 없었고, 대신 아버지의 책장을 뒤지며 놀았습니다. 그래서 말하는 것이 나이보다 어른스러웠습니다.`,
            `글자를 언제 익혔는지 아버지도 몰랐습니다. 어느 날 보니 읽고 있었습니다.`,
            `일곱 살에 어른들이 읽는 책을 읽었습니다.`,
            `아버지가 읽던 책을 그대로 가져다 읽었습니다.`,
            `인도는 아이가 자라기에 더운 곳이었습니다. 그래서 영국의 학교에 보내는 것이 그곳 사람들의 관례였습니다.`,
            `부모와 몇 해씩 떨어져 지내는 아이가 많았습니다. 세라도 그 가운데 하나가 되는 참이었습니다.`,
            `다들 그렇게 한다고 하니 크루 대위도 그렇게 하는 것이었습니다.`,
            `그런데 그 배를 태워 보내고 나면 몇 해를 못 봅니다.`,
            `"아빠." 세라가 말했습니다.<br>"저기가 그 학교인가요?"<br>"그렇단다."`,
            `세라는 그 말을 아주 담담하게 물었습니다.`,
            `아버지가 대답을 못 하고 있다가 겨우 그렇다고 했습니다.`,
            `마차가 멈춘 곳은 크고 어두운 벽돌집이었습니다. 문에 놋쇠 문패가 붙어 있었습니다. 민친 여학교라고 적혀 있었습니다.`,
            `창이 많은데도 안이 어두워 보였습니다. 세라는 그 집을 올려다보고 아무 말도 하지 않았습니다.`,
            `창마다 커튼이 반듯하게 걸려 있었습니다.`,
            `반듯한 것이 오히려 차가워 보였습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `아버지는 그날 아무것도 아끼지 않았습니다. 다음 날이면 인도로 떠나야 했기 때문입니다.`,
            ...
            `아버지는 그 말을 듣고 잠깐 아무 말도 하지 못했습니다.`,
            ...
            `그날 밤 세라는 울지 않았습니다. 우는 것은 나중에 배웠습니다.`
        ]
    },
    {
        num: 3,
        ...
        paras: [
            ...
            `종이 울려도 자리에서 일어나지 않는 아이가 있었습니다.`,
            `선생이 두 번 불러야 일어났습니다.`,
            `세라는 이야기를 지어내는 것이 아니라 자기가 정말로 그 자리에 있는 것처럼 이야기했습니다. 인어가 헤엄치는 바닷속, 얼음으로 된 궁전, 사막을 건너는 낙타 행렬. 아이들은 그 이야기를 들으며 정말로 그것을 보았습니다.`,
            `세라는 그런 것을 책에서 읽고 머릿속에 넣어 두고 있었습니다.`,
            `세라는 이야기를 하다가 목소리를 낮추기도 하고 갑자기 멈추기도 했습니다. 그러면 아이들이 숨을 죽였습니다.`,
            `라비니아도 뒤에서 듣고 있었습니다. 안 듣는 척하면서요.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `지나가도 아무도 인사하지 않았습니다.`,
            `부엌데기는 그 집에서 사람 수에 들지 않았습니다.`,
            `석탄을 나르고, 물을 긷고, 계단을 닦았습니다. 그 집에서 제일 일찍 일어나 제일 늦게 잤습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `모자를 손에 들고 서 있었습니다. 앉으라고 해도 앉지 않았습니다.`,
            `"크루 대위가 두 달 전에 세상을 떠났습니다." 그가 말했습니다.`,
            `민친 선생은 의자를 붙잡았습니다.`,
            `교실 쪽에서 아이들이 웃는 소리가 들려왔습니다.`,
            `그 방에서는 아직 잔치가 이어지고 있었습니다.`,
            ...
            `변호사는 그 말을 하고 서둘러 나갔습니다.`,
            `변호사가 나간 뒤 민친 선생은 한참을 서 있었습니다.`,
            `그 사람이 그때 생각한 것은 세라가 아니었습니다. 받지 못하게 된 돈이었습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `계단을 오를 때 삐걱거리는 자리를 다 외워 두었습니다.`,
            `그 자리를 밟지 않고 올라오는 데 여러 밤이 걸렸습니다.`,
            `어느 날 어먼가드가 커다란 상자를 안고 올라왔습니다.<br>"아버지가 책을 보내셨어. 나는 하나도 못 읽겠어."`,
            `어먼가드는 그 책을 들고 울 뻔했습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `빗물이 목덜미로 들어갔습니다.`,
            `옷이 다 젖어서 걸을 때마다 무거웠습니다.`,
            `머릿속에는 온통 먹을 것 생각뿐이었습니다. 그런 자기가 부끄러웠지만 어쩔 수 없었습니다.`,
            `빵집 냄새가 나면 그쪽으로 고개가 돌아갔습니다.`,
            `그런 날은 공주 생각이 잘 되지 않았습니다.`,
            ...
            `세라는 그것을 진창에서 꺼내 앞치마에 닦았습니다.`,
            `사 펜스면 빵 네 개를 살 수 있었습니다.`,
            `세라는 그것을 주워 들고 주위를 둘러보았습니다. 잃어버린 사람을 찾을 수 없었습니다.`,
            `빗속에 사람이 몇 지나갔지만 아무도 무엇을 찾는 얼굴이 아니었습니다.`,
            `세라는 그것을 손에 쥐고 잠깐 서 있었습니다.`,
            `바로 앞에 빵집이 있었습니다. 진열창에서 김이 오르는 빵이 막 나오고 있었습니다.`,
            `둥글고 뜨거운 빵이었습니다. 유리에 김이 서려 있었습니다.`,
            `세라는 그 앞에서 걸음이 느려졌습니다.`,
            ...
            `세라보다 훨씬 딱한 아이였습니다.`,
            `움직이지 않고 그것만 보고 있었습니다.`,
            `빵집 문이 열릴 때마다 김이 나왔습니다.`,
            `세라가 물었습니다.<br>"너 배고프니?"`,
            `아이가 고개를 들었습니다.<br>"배고파. 엄청."`,
            `목소리가 아주 작았습니다.`,
            `그 아이는 여러 날 굶은 것 같았습니다.`,
            ...
            `세라는 그날도 저녁을 먹지 못했습니다.`,
            `그런데 그 말을 하고 나니 배가 덜 고팠습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `이 아이는 원래 이런 방에 살던 아이가 아니라는 것도 알아보았습니다.`,
    ...
    },
    {
        ...
        paras: [
            `며칠 뒤, 유난히 추운 밤이었습니다.`,
            `그해 겨울에서 가장 추운 밤이었습니다. 눈이 하루 종일 내렸습니다.`,
            `그날 세라는 눈길을 여러 번 왕복했고, 저녁도 먹지 못했습니다. 다락방에 올라왔을 때는 손발의 감각이 없었습니다.`,
            `요리사가 심부름이 늦었다고 밥을 주지 않았습니다.`,
            `손가락이 굽어지지 않았습니다.`,
            `신발은 이미 오래전에 못 신게 되어 있었습니다.`,
            `바닥이 벌어져서 눈이 그대로 들어왔습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `그리고 이렇게 물었습니다.<br>"제 아버지를 아셨어요?"`,
            `"가장 가까운 친구였단다." 캐리스퍼드 씨가 겨우 말했습니다.`,
            `그리고 이렇게 덧붙였습니다.<br>"내가 네 아버지를 저버렸단다."`,
            `세라는 그 말을 듣고 문 쪽을 돌아보았습니다. 벽 하나 너머가 그 학교였습니다.`,
            `세라는 그 말에 대답하지 않았습니다. 무슨 말을 해야 할지 몰랐기 때문입니다.`
        ]
    },
    {
        num: 13,
        ...
        paras: [
            ...
            `지붕이 미끄러운 밤에도 그렇게 했습니다.`,
            `한 번은 발이 미끄러져 떨어질 뻔했습니다.`,
            `"몇 번이나요?"<br>"여러 번입니다. 아가씨께서 잠든 것을 늘 확인하고 들어갔습니다."`,
            `숨소리를 듣고 알았다고 했습니다.`,
            `세라는 웃다가 울었습니다.`,
            `그 밤들이 다 이 집에서 건너온 것이었습니다.`,
            ...
            `"그 아이가 아니었으면 저는 못 견뎠을 거예요."`,
            `그 시각 민친 여학교에서는 난리가 났습니다. 세라가 아침부터 보이지 않았기 때문입니다.`,
            `부엌일이 밀리고 아이들 수업이 멈췄습니다.`,
            ...
            `세라는 그날 아무 말도 하지 않았습니다. 그것으로 충분했습니다.`,
            `그날 저녁 베키가 짐을 들고 옆집으로 왔습니다. 짐이라고 해야 보자기 하나였습니다.`,
            `그 안에 앞치마 두 장과 빗 하나가 있었습니다.`,
            `베키가 가진 것 전부였습니다.`,
            `세라가 그 보자기를 받아 들었습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `아주머니는 그날 이후로 빵을 셀 때마다 그 생각을 했습니다.`,
            ...
            `앤은 그날 고맙다는 말밖에 하지 못했습니다.`,
            `그런데 그 말이면 되었습니다.`,
            `세라는 그것으로 충분하다고 여겼습니다.`,
            `앤은 대답하지 못하고 앞치마만 만지작거렸습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `다락방에서 읽고 싶었던 책이 다 있었습니다.`,
            `세라는 그 앞에 서서 한참 있었습니다.`,
            `세라는 아침마다 그것을 한 번씩 확인했습니다.`,
            `없어지지 않았다는 것을 확인하고 나서야 일어났습니다.`,
            `그 버릇은 여러 해 갔습니다.`,
            `그러나 세라는 예전의 세라와 조금 달라져 있었습니다.`,
            `다락방에서 지낸 두 해가 그냥 지나가지 않았던 것입니다.`,
            `세라는 이제 거리에서 아이들을 유심히 보게 되었습니다.`,
            `맨발인 아이가 지나가면 걸음을 멈췄습니다.`,
            `어먼가드와 로티는 자주 놀러 왔습니다. 로티는 여전히 세라를 엄마라고 불렀습니다.`,
            `민친 선생은 그것을 막지 못했습니다. 두 아이 부모가 허락했기 때문입니다.`,
            `그것만은 끝까지 고쳐지지 않았습니다.`,
            `베키는 세라의 곁에서 지냈습니다. 이제 새벽에 일어나지 않아도 되었지만, 습관이 되어 한동안은 다섯 시면 눈이 떠졌습니다.`,
            `그러면 다시 눕지 못하고 앉아 있었습니다.`,
            `몸이 그 시간을 기억하고 있었던 것입니다.`,
            `세라가 그러지 않아도 된다고 여러 번 말했습니다.`,
            ...
            `부잣집 아이가 하루아침에 부엌데기가 되었다는 이야기였습니다. 그런 학교에 아이를 맡기려는 부모는 없었습니다.`,
            `민친 선생은 그 뒤로도 그 학교를 붙들고 있었습니다.`,
            `세라는 그 사람을 두고 아무 말도 하지 않았습니다.`,
            `어느 날 어먼가드가 물었습니다.<br>"세라, 그때 다락방에서 정말로 네가 공주라고 생각했어?"`,
            `"응."<br>"진짜로?"`,
            `"진짜로." 세라가 말했습니다.<br>"그렇게 생각하지 않으면 견딜 수가 없었거든."`,
            `"그렇게 생각하면 요리사가 소리를 질러도 견딜 수 있었어."`,
            `어먼가드는 그 말에 아무 말도 하지 못했습니다.`,
            `어먼가드는 그 두 해 동안 밤마다 계단을 올랐던 아이였습니다.`,
            `그것도 쉬운 일이 아니었습니다.`,
            `"그럼 지금도 공주야?"`,
            `세라는 창밖을 보았습니다. 광장 건너편에 민친 여학교의 지붕이 보였습니다. 그 꼭대기에 작은 창이 하나 있었습니다.`,
            `볕이 들지 않는 창이었습니다.`,
            `그 방에는 이제 아무도 살지 않았습니다.`,
            `베키가 나온 뒤로 그 옆방도 비었습니다.`,
            ...
            `"아무도 안 보고 있을 때도 그렇게 하는 거야."`,
            `"그때가 제일 어려워."`,
            `세라는 그 두 해 동안 그것을 배웠습니다.`,
            `"그거 어려워."<br>"어려워." 세라가 말했습니다.<br>"그래서 하는 거야."`,
            `어먼가드가 웃었습니다.`,
            `로티가 무슨 이야기냐고 끼어들었습니다.`,
            `세라는 로티에게 다시 이야기를 시작했습니다.`,
            `그날 저녁, 세라는 다시 그 작은 창을 올려다보았습니다.`,
            `해가 지고 있었습니다.`,
            `그 창에 노을이 잠깐 비쳤다가 사라졌습니다.`,
            `세라는 창을 닫고 돌아섰습니다.`,
