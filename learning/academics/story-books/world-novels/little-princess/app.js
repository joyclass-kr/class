...
const CHAPTERS = [
    {
        ...
        paras: [
            ...
            `"이 아이는 책을 아주 좋아합니다." 크루 대위가 말했습니다.<br>"밥 먹듯이 읽지요. 필요한 책은 마음껏 사 주십시오."`,
    ...
    },
    {
        ...
        paras: [
            ...
            `"아무 인형이나 안 돼요." 세라가 진지하게 말했습니다.<br>"저를 기다려 줄 인형이어야 해요. 아빠가 인도로 가시면 저는 혼자 남잖아요. 그때 이야기할 사람이 있어야 해요."`,
            ...
            `"안 해요." 세라가 말했습니다.<br>"하지만 저는 인형이 들을 수 있다고 생각해요. 사람이 없을 때 인형은 걸어 다니고 이야기도 한대요. 그러다 사람이 오면 얼른 제자리로 돌아가 아무것도 모르는 척하는 거예요."`,
            ...
            `그러고는 방으로 올라가 문을 닫았습니다. 에밀리는 의자에 앉아 세라를 보고 있었습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `로티가 울음을 멈추고 눈을 떴습니다.`,
            `"우리 엄마는 하늘에 계셔." 세라가 말했습니다.<br>"거기가 어떤 곳인지 아니? 온통 꽃밭이야. 길에 백합이 깔려 있어서 바람이 불면 향기가 나. 그리고 사람들이 그 위를 걸어 다녀."`,
    ...
    },
    {
        ...
        paras: [
            ...
            `"크루 대위가 두 달 전에 세상을 떠났습니다." 그가 말했습니다. 민친 선생은 의자를 붙잡았습니다.`,
    ...
    },
    {
        ...
        paras: [
            `"네 아버지가 돌아가셨다." 민친 선생이 말했습니다. 세라는 그 말을 듣고 아무 말도 하지 못했습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `"그러니까 더 그래야 해." 세라가 말했습니다.<br>"좋은 옷을 입고 있을 때는 아무나 공주 같아 보여. 그건 어렵지 않아. 아무도 몰라줄 때 그렇게 하는 게 진짜야."`,
            `"어떻게 하는 건데요?"<br>"요리사가 소리를 지르면 나는 속으로 생각해. 너는 내가 누구인지 모르는구나. 그러면 화가 나지 않아. 마음속으로는 아무도 나를 어쩌지 못하니까."`,
    ...
    },
    {
        ...
        paras: [
            ...
            `"이건 그냥 상상이야." 세라가 말했습니다.<br>"하지만 상상은 아주 잘하면 진짜랑 비슷해져."`,
            ...
            `"내일은 아무것도 못 먹을 줄 알아라." 민친 선생이 문을 닫고 나갔습니다. 방이 캄캄해졌습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `그가 그 사실을 알고 돌아왔을 때, 친구는 이미 세상을 떠난 뒤였습니다. 그 친구의 이름이 크루 대위였습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `그렇게 상상하다가 잠이 들었습니다. 눈을 떴을 때 방이 밝았습니다. 세라는 아직 꿈을 꾸고 있다고 생각했습니다.`,
            ...
            `"아가씨······ 이게 뭐예요?"<br>"나도 몰라." 세라가 말했습니다.<br>"아침이 되면 사라질지도 몰라. 그러니까 지금 먹자."`,
    ...
    },
    {
        ...
        paras: [
            ...
            `"주인님께서 뵙고 싶어 하십니다." 램 다스가 말했습니다. 세라는 처음으로 그 집 안으로 들어갔습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `"그럼 그 방에 불을 지피고 밥을 놓아둔 것도······."<br>"저희였습니다." 램 다스가 말했습니다.<br>"주인님께서 시키셨습니다. 저는 지붕으로 넘어가 창으로 들어갔습니다."`,
            ...
            `"제 학교 아이가 여기 있다고 들었습니다." 민친 선생이 말했습니다.<br>"세라, 당장 나오너라."`,
            `"세라 크루 양은 이제 그 학교로 돌아가지 않습니다." 카마이클 씨가 말했습니다.<br>"이분이 세라 양의 후견인이십니다."`,
    ...
    },
    {
        ...
        paras: [
            `며칠 뒤 세라는 캐리스퍼드 씨에게 가 보고 싶은 곳이 있다고 했습니다. 마차가 멈춘 곳은 어느 빵집 앞이었습니다.`,
            `빵집 아주머니는 잘 차려입은 아이를 보고 처음에는 알아보지 못했습니다. 그러다 얼굴을 보고 앞치마에 손을 닦았습니다.`,
            `"너, 그때 그 아이구나."<br>"네." 세라가 말했습니다.<br>"그날 빵을 여섯 개 주셨지요."`,
            `"네 개 값밖에 안 받았는데도 그걸 다 남을 줬잖니." 아주머니가 말했습니다.<br>"나는 그날 일을 아직도 생각한단다."`,
            `그때 가게 안쪽에서 여자아이 하나가 나왔습니다. 얼굴이 깨끗해지고 옷을 갖춰 입었지만, 세라는 그 아이를 알아보았습니다. 그날 계단 밑에 웅크려 있던 아이였습니다.`,
            `"앤이라고 한단다." 아주머니가 말했습니다.<br>"그날부터 여기서 지내고 있어."`,
            ...
            `"힘들었어요." 세라가 말했습니다.<br>"그런데 그때 굶어 보지 않았으면 그 아이가 얼마나 배고픈지 몰랐을 거예요."`,
    ...
    },
    {
        ...
        paras: [
            ...
            `"응."<br>"진짜로?"`,
            `"진짜로." 세라가 말했습니다.<br>"그렇게 생각하지 않으면 견딜 수가 없었거든."`,
            `"그럼 지금도 공주야?"`,
            `세라는 창밖을 보았습니다. 광장 건너편에 민친 여학교의 지붕이 보였습니다. 그 꼭대기에 작은 창이 하나 있었습니다.`,
            `그 창 안쪽이 어떤 방인지 세라는 알고 있었습니다. 지금은 아무도 살지 않는 방이었습니다.`,
            `"공주라는 건 옷 이야기가 아니야." 세라가 말했습니다.<br>"아무것도 없을 때 어떻게 하느냐 하는 이야기야. 화가 나도 함부로 말하지 않고, 배가 고파도 나보다 더 고픈 사람을 보면 나눠 주고."`,
