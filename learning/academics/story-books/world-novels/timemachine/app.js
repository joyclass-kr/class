...
const CHAPTERS = [
    ...
    },
    {
        ...
        paras: [
            ...
            `벽에는 도면이 여러 겹으로 붙어 있었습니다. 지운 자국이 많았고, 그 위에 다시 그린 자국이 또 있었습니다. 몇 해를 매달린 일이라는 것을 그것만 보아도 알 수 있었습니다. 절반쯤 만들어져 있었습니다.`,
            ...
            `기자는 그것으로 기사를 쓰겠다고 했다가 그만두었습니다. 아무도 믿지 않을 것 같았기 때문입니다. 시장은 그 이야기를 아예 입에 올리지 않았습니다. 자기가 속았다고 여기는 눈치였습니다.`,
            ...
            `문틀을 한 손으로 짚고 서 있었습니다. 그 손이 놓이면 쓰러질 것 같았습니다. 웃옷이 흙투성이였고, 소매가 찢어져 있었습니다. 얼굴이 창백했고, 턱에 마른 피가 붙어 있었습니다.`,
            `손등이 온통 까져 있었습니다. 손톱 밑에는 흙이 껴 있었습니다.`,
            `머리가 세어 있었습니다. 이레 전에는 그렇지 않았습니다. 사람이 이레 만에 머리가 세지는 않습니다.`,
            `그리고 발에 신발이 없었습니다. 양말만 신고 있었는데 그것도 다 찢어져 있었습니다. 절뚝거리며 걸어 들어와 식탁 끝에 앉았습니다.`,
            ...
            `그리고 이야기를 시작했습니다. 아래는 그 사람이 그날 밤 한 이야기를 그대로 옮긴 것입니다. 저는 그날 밤 집에 돌아가 기억나는 대로 적어 두었습니다. 그래서 여기 적힌 것은 그 사람의 말투 그대로입니다.`,
    ...
    },
    {
        ...
        paras: [
            `오늘 아침 열 시에 기계가 완성되었습니다. 마지막에 끼운 것은 수정 막대 두 개였습니다. 그것을 끼우자 기계가 조금 흔들렸습니다. 저는 한참 그것을 보고 있었습니다.`,
            `그러고는 안장에 앉아 지렛대를 잡았습니다. 손이 떨렸습니다. 그리고 눌렀습니다.`,
            `처음에는 떨어지는 느낌이었습니다. 배를 타고 파도를 넘을 때처럼 속이 뒤집혔습니다. 귀가 멍했습니다. 저는 지렛대를 놓칠 뻔했습니다.`,
            `그리고 작업실을 보니 이상했습니다. 벽에 걸린 시계의 바늘이 아주 빨리 돌고 있었습니다. 조금 뒤에는 바늘이 보이지 않을 만큼 빨라졌습니다. 창밖에서 해가 하늘을 가로질러 지나갔습니다.`,
            ...
            `우박이 쏟아지고 있었습니다. 기계는 옆으로 넘어져 있었고, 저는 등이 젖은 채 엎드려 있었습니다. 우박이 목덜미를 때렸습니다. 저는 그 자리에 엎드린 채 계기판을 보았습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `물방울이 맺힌 꽃들이 한꺼번에 빛났습니다. 저는 잠깐 그것을 보고 서 있었습니다. 제가 아는 어떤 꽃과도 달랐습니다. 잎이 크고 색이 짙었습니다.`,
            ...
            `아주 오래된 것이 분명했습니다. 돌이 삭아 있었고 이끼가 끼어 있었습니다. 날개 한쪽이 떨어져 나가 있었고, 받침돌에는 금이 가 있었습니다. 비바람을 몇천 년쯤 맞은 돌의 모습이었습니다.`,
            `그런데 이상한 것이 하나 있었습니다. 이끼가 끼어 있는데도 얼굴만은 또렷했습니다. 누가 손을 대고 있다는 뜻이었습니다.`,
            `그 얼굴이 저를 내려다보고 있었습니다. 저는 조금 무서워졌습니다. 입꼬리가 조금 올라가 있었습니다. 웃는 것 같기도 하고 아닌 것 같기도 했습니다.`,
            ...
            `제 가슴께에 겨우 닿았습니다. 그런데 아이가 아니었습니다. 얼굴을 보니 다 자란 사람이었습니다. 그저 그만큼밖에 자라지 않는 사람들이었습니다.`,
            ...
            `제 옷을 잡아당겨 보고, 신발을 신기하게 들여다보았습니다. 그러고는 자기들끼리 웃었습니다. 일을 해 본 적이 없는 손이었습니다. 굳은살이 하나도 없었습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `그런데 기계가 없었습니다. 저는 그 자리에 얼어붙었습니다. 풀밭을 뛰어다니며 찾았습니다. 소리를 질렀습니다.`,
            `어두워서 잘 보이지 않았습니다. 저는 손으로 풀을 헤치며 기어 다녔습니다. 손끝에 돌만 걸렸습니다.`,
            `풀이 눌린 자리는 있었습니다. 그러니까 제가 자리를 잘못 찾은 것이 아니었습니다. 엘로이 몇이 나와서 저를 보았습니다. 저는 그 사람들을 붙잡고 흔들었습니다.`,
            `"내 기계 어디 있어! 누가 가져갔어!"`,
            `그 사람들은 무서워서 울었습니다. 저는 그때 제가 무슨 짓을 하고 있는지 알았습니다. 아이를 붙잡고 흔들고 있었던 것입니다.`,
            `저는 손을 놓고 물러섰습니다. 그리고 그날 밤 풀밭에 앉아 있었습니다. 기계가 없으면 저는 영영 여기서 살아야 했습니다. 과일을 먹고, 노래를 듣고, 밤이면 남들 틈에 끼어 자면서요.`,
            ...
            `문에는 손잡이도 열쇠 구멍도 없었습니다. 안에서만 여는 문이었습니다. 저는 그 문을 두드렸습니다. 안에서 무언가 움직이는 소리가 났습니다.`,
            ...
            `그 사람들은 그 조각상 쪽을 보려고도 하지 않았습니다. 제가 손으로 가리키기만 해도 자리를 떴습니다. 무서워하는 것과는 조금 달랐습니다. 보지 않기로 정해 놓은 것 같았습니다.`,
    ...
    },
    {
        ...
        paras: [
            `그다음 날 강가에서 일이 하나 있었습니다. 그 강은 넓고 물살이 느렸습니다. 그런데 한가운데에 물이 빠르게 도는 데가 있었습니다. 엘로이 여럿이 물에서 놀고 있었는데, 그 가운데 하나가 물살에 휩쓸렸습니다.`,
            `저는 그것을 보고 물에 뛰어들어 건져 냈습니다. 아주 가벼웠습니다. 제 팔 하나로 들 수 있었습니다. 물가로 나와 눕히자 물을 조금 뱉었습니다.`,
            ...
            `위나는 그날부터 저를 따라다녔습니다. 제가 어디를 가든 따라왔습니다. 그리고 제 주머니에 꽃을 넣어 주었습니다. 제가 폐허를 살피러 가면 옆에 앉아 기다렸고, 제가 걸으면 뛰어서 따라왔습니다.`,
            ...
            `다른 사람들은 아무하고나 놀고 아무하고나 헤어졌습니다. 누가 없어져도 찾지 않았습니다. 그런데 위나는 제가 안 보이면 저를 찾으러 다녔습니다. 위나 덕분에 저는 한 가지를 알게 되었습니다.`,
            `엘로이는 어둠을 몹시 무서워했습니다. 해가 지면 다들 큰 건물 안으로 들어갔고, 밖에 남으려고 하지 않았습니다. 그리고 밤에는 절대 혼자 있지 않았습니다.`,
            `해가 기울기 시작하면 웃음소리가 잦아들었습니다. 그리고 다들 같은 쪽으로 걸었습니다. 누가 부르는 것도 아닌데 다 같이 움직였습니다. 몇만 년 동안 그렇게 해 온 것 같았습니다.`,
            ...
            `저는 밤마다 큰 건물 안에서 잤습니다. 그리고 몇 번인가 문 쪽에서 발소리를 들었습니다. 맨발이 돌바닥을 밟는 소리였습니다. 그 소리가 들리면 자던 사람들이 서로 더 바짝 붙었습니다.`,
    ...
    },
    {
        ...
        paras: [
            `저는 무기가 필요했습니다. 쇠막대 하나면 되었습니다. 그런데 그 땅에는 쇠붙이가 하나도 없었습니다. 팔십만 년 동안 다 삭은 것입니다.`,
            `그래서 저는 며칠을 걸어 큰 폐허로 갔습니다. 초록빛 도자기로 지은 아주 큰 건물이었습니다. 안에 들어가 보니 그것은 옛날 박물관이었습니다. 그것도 아주 오래된 박물관이었습니다.`,
            `깨진 유리 진열장이 줄지어 서 있었고, 그 안에 삭아 버린 것들이 놓여 있었습니다. 기계, 뼈, 돌, 책. 책은 손을 대자 가루가 되었습니다. 여기 놓인 것들이 만들어진 때와 제 시대 사이가, 제 시대와 지금 사이만큼 멀지도 모릅니다.`,
            `저는 그 안에서 두 가지를 찾아냈습니다. 쇠막대 하나와, 성냥 한 통이었습니다. 찾는 데 반나절이 걸렸습니다.`,
            `위나가 옆에서 제 흉내를 내며 진열장을 들여다보았습니다. 성냥은 유리병 안에 들어 있어서 아직 그어졌습니다. 그 박물관을 돌아보면서 저는 이상한 기분이 들었습니다. 여기 있는 것들은 사람이 알아낸 것을 모아 둔 자리였습니다.`,
            `누군가 그것을 모으고, 이름을 붙이고, 순서대로 놓았습니다. 그런데 이제 그것을 읽을 수 있는 사람이 하나도 없었습니다.`,
            ...
            `날이 밝을 때까지 찾았습니다. 찾지 못했습니다. 저는 그 뒤로 위나를 다시 보지 못했습니다. 주머니에 그 사람이 넣어 준 꽃 두 송이가 남아 있었습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `목을 잡고 있던 손이 스르르 벗겨졌습니다. 그것들은 저와 함께 오지 못했습니다. 저는 안장에 엎드린 채 한참 동안 숨만 쉬었습니다.`,
            ...
            `해가 하늘에 붙박여 있었습니다. 지지도 뜨지도 않았습니다. 그리고 그 해가 붉고 아주 컸습니다. 바람이 몹시 찼습니다.`,
            ...
            `더듬이를 천천히 흔들며 저를 향해 왔습니다. 저는 지렛대를 밀어 조금 앞으로 갔습니다. 그러자 그것이 사라지고, 다른 것이 같은 자리에 있었습니다. 그 물가에는 그런 것들만 살고 있었습니다.`,
