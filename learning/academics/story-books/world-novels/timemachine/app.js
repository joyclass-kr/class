...
const CHAPTERS = [
    {
        ...
        paras: [
            `천팔백구십몇 년 어느 목요일 저녁이었습니다.`,
            `런던 리치먼드에 사는 어느 사람의 집에 손님 예닐곱이 모여 있었습니다.`,
            `그 집 주인은 발명을 하는 사람이었습니다.`,
            `이름은 여기 적지 않겠습니다. 그 사람이 알려지기를 바라지 않았기 때문입니다.`,
            `이 글에서는 그냥 시간 여행자라고 부르겠습니다.`,
            `손님들은 의사, 심리학자, 신문 기자, 시장, 그리고 저였습니다.`,
            `저녁을 먹고 난롯가에 앉아 있는데 주인이 말을 꺼냈습니다.`,
            `"여러분, 학교에서 배운 것 가운데 틀린 것이 하나 있습니다."`,
            `"무엇 말입니까."`,
            `"우리가 사는 세상에 방향이 몇 개 있습니까?"`,
            `"셋이지요. 앞뒤, 좌우, 위아래."`,
            `"넷입니다."`,
            `사람들이 웃었습니다.`,
            `"네 번째가 뭡니까?"`,
            `"시간입니다."`,
            `그리고 주인은 이렇게 설명했습니다.`,
            `사람이 태어나서 죽을 때까지, 그 사람은 계속 시간 위를 지나갑니다.`,
            `그러니까 시간도 우리가 지나가는 길입니다.`,
            `다만 우리는 그 길을 한 방향으로만, 그리고 늘 같은 빠르기로만 갑니다.`,
            `"앞뒤로는 마음대로 갔다 오지 않습니까. 위아래도 애를 쓰면 갑니다. 그런데 시간만은 왜 한쪽으로만 갑니까?"`,
            `"그야 그런 것이니까요."`,
            `"저는 그렇게 생각하지 않습니다."`,
            `그러고는 주인이 옆방에서 무언가를 가져왔습니다.`,
            `아주 작은 것이었습니다.`,
            `놋쇠와 상아와 수정으로 만든 것인데, 자전거만큼도 안 되게 작았습니다.`,
            `그 위에 작은 안장이 있고, 앞에 지렛대가 두 개 달려 있었습니다.`,
            `"이것이 제가 만든 기계의 모형입니다."`,
            `주인은 그것을 탁자 한가운데 놓았습니다.`,
            `그리고 심리학자에게 말했습니다.`,
            `"이 지렛대를 눌러 보시겠습니까."`,
            `심리학자가 손가락을 뻗어 눌렀습니다.`,
            `그러자 그 작은 기계가 흔들리더니, 흐릿해지더니, 사라졌습니다.`,
            `탁자 위에 아무것도 남지 않았습니다.`,
            `방 안이 조용해졌습니다.`,
            `누가 탁자 밑을 들여다보았습니다.`,
            `아무것도 없었습니다.`,
            `"속임수요."`,
            `"그렇게 생각하셔도 됩니다." 주인이 말했습니다. "저는 설득할 생각이 없습니다."`
        ]
    },
    {
        num: 2,
        ...
        paras: [
            `그날 밤 주인은 손님들을 작업실로 데려갔습니다.`,
            `거기에 큰 기계가 하나 있었습니다.`,
            `아까 그 모형을 사람이 탈 수 있게 크게 만든 것이었습니다.`,
            `절반쯤 만들어져 있었습니다.`,
            ...
            `사람들은 웃으면서 저녁을 먹기 시작했습니다.`,
            `"또 무슨 장난을 치려는 모양이지."`,
            `그때 문이 열렸습니다.`,
            `사람들이 고개를 들다가 다 굳었습니다.`,
            `주인이 서 있었습니다.`,
            `그런데 몰골이 말이 아니었습니다.`,
            `웃옷이 흙투성이였고, 소매가 찢어져 있었습니다.`,
            `얼굴이 창백했고, 턱에 마른 피가 붙어 있었습니다.`,
            `머리가 세어 있었습니다. 이레 전에는 그렇지 않았습니다.`,
            `그리고 발에 신발이 없었습니다. 양말만 신고 있었는데 그것도 다 찢어져 있었습니다.`,
            `절뚝거리며 걸어 들어와 식탁 끝에 앉았습니다.`,
            `아무 말 없이 술을 한 잔 따라 마셨습니다.`,
            `그리고 고기를 집어 먹었습니다.`,
            `허겁지겁 먹었습니다.`,
            `사람들이 물으려고 하자 손을 들어 막았습니다.`,
            `"조금만 기다려 주십시오. 먹고 나서 다 말씀드리겠습니다."`,
            `그렇게 십 분이 지났습니다.`,
            `그리고 주인은 옷을 갈아입고 와서 난롯가에 앉았습니다.`,
            `"오늘 저는 여드레를 살았습니다."`,
            `"무슨 말씀입니까."`,
            `"여러분이 이레를 사시는 동안, 저는 팔십만 년을 다녀왔습니다."`,
            `그리고 이야기를 시작했습니다.`,
            `아래는 그 사람이 그날 밤 한 이야기를 그대로 옮긴 것입니다.`
        ]
    },
    {
        num: 3,
        ...
        paras: [
            `오늘 아침 열 시에 기계가 완성되었습니다.`,
            `저는 안장에 앉아 지렛대를 잡았습니다.`,
            `손이 떨렸습니다.`,
            `그러고는 눌렀습니다.`,
            `처음에는 떨어지는 느낌이었습니다.`,
            `배를 타고 파도를 넘을 때처럼 속이 뒤집혔습니다.`,
            `그리고 작업실을 보니 이상했습니다.`,
            `벽에 걸린 시계의 바늘이 아주 빨리 돌고 있었습니다.`,
            `조금 뒤에는 바늘이 보이지 않을 만큼 빨라졌습니다.`,
            `창밖에서 해가 하늘을 가로질러 지나갔습니다.`,
            `그리고 밤이 왔습니다. 그리고 다시 낮이 왔습니다.`,
            `그것이 점점 빨라져서 나중에는 깜빡거리는 것처럼 되었습니다.`,
            `그러다 아예 하나로 이어졌습니다.`,
            `하늘이 짙푸른 빛이 되고, 해는 하늘을 도는 불의 띠가 되었습니다.`,
            `작업실 벽이 흐릿해지더니 사라졌습니다.`,
            `제가 앉아 있는 자리에 다른 건물이 서고, 그것이 무너지고, 또 다른 것이 섰습니다.`,
            `너무 빨라서 형태를 알아볼 수가 없었습니다.`,
            `사람은 하나도 보이지 않았습니다.`,
            `한 사람이 지나가는 데 걸리는 시간이 제게는 눈 깜빡할 새보다 짧았기 때문입니다.`,
            `저는 처음에 조금 즐거웠습니다.`,
            `그러다 무서워졌습니다.`,
            `한 가지 생각이 들었기 때문입니다.`,
            `제가 멈추는 그 순간에, 그 자리에 무언가가 있으면 어떻게 될까요.`,
            `벽이나 바위나, 아니면 흙더미가요.`,
            `그러면 제 몸과 그것이 같은 자리를 차지하게 됩니다.`,
            `그러면 어떻게 되는지 저도 모릅니다.`,
            `그 생각을 하자 견딜 수가 없어졌습니다.`,
            `저는 지렛대를 잡아당겼습니다.`,
            `너무 갑자기 잡아당겼습니다.`,
            `기계가 옆으로 넘어갔고, 저는 풀밭으로 굴러떨어졌습니다.`,
            `우박이 쏟아지고 있었습니다.`,
            `저는 그 자리에 엎드린 채 계기판을 보았습니다.`,
            `팔십만 이천칠백일 년.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `제가 아는 어떤 꽃과도 달랐습니다.`,
            `공기가 따뜻했고 냄새가 좋았습니다.`,
            `그리고 제 앞에 큰 조각상이 하나 서 있었습니다.`,
            `하얀 돌로 만든 것이었는데, 사람 얼굴에 짐승 몸을 하고 날개가 있었습니다.`,
            `스핑크스라고 부르는 모양의 상이었습니다.`,
            `높이가 이층집만 했습니다.`,
            `아주 오래된 것이 분명했습니다. 돌이 삭아 있었고 이끼가 끼어 있었습니다.`,
            `그 얼굴이 저를 내려다보고 있었습니다.`,
            `저는 조금 무서워졌습니다.`,
            `그때 소리가 났습니다.`,
            `돌아보니 사람들이 오고 있었습니다.`,
            `저는 놀랐습니다.`,
            ...
            `아니면 아주 크고 힘이 셀 것이라고도 생각했습니다.`,
            `그런데 눈앞에 온 것은 아이들 같았습니다.`,
            `키가 넉 자쯤 되었습니다.`,
            `머리가 곱슬거리고, 얼굴이 갸름하고, 눈이 컸습니다.`,
            `아주 예쁘게 생겼습니다.`,
            `보라색과 분홍색 천으로 만든 옷을 입고 있었고, 발이 맨발이었습니다.`,
            `그리고 남자와 여자가 잘 구별되지 않았습니다.`,
            `그 사람들은 저를 보고도 무서워하지 않았습니다.`,
            `웃으면서 다가와 저를 만졌습니다.`,
            `손이 아주 작고 부드러웠습니다.`,
            `한 사람이 제 목에 꽃목걸이를 걸어 주었습니다.`,
            `저는 그 사람들에게 물었습니다.`,
            `"여기가 어디입니까? 지금이 언제입니까?"`,
            `그 사람들은 서로 얼굴을 보고 웃었습니다.`,
            `그리고 새가 우는 것 같은 소리로 무어라 말했습니다.`,
            `저는 알아듣지 못했습니다.`
        ]
    },
    {
        ...
        paras: [
            `그 사람들은 자기들을 엘로이라고 불렀습니다.`,
            `저는 그날 그 사람들을 따라 큰 건물로 갔습니다.`,
            `아주 오래된 건물이었습니다. 돌기둥이 서 있고 지붕이 반쯤 무너져 있었습니다.`,
            `그 안에 낮은 상들이 놓여 있고, 사람들이 거기서 밥을 먹었습니다.`,
            `먹는 것은 과일뿐이었습니다.`,
            `고기도 없고 빵도 없었습니다.`,
            `그런데 그 과일이 제가 아는 어떤 과일과도 달랐습니다.`,
            `누가 오랜 세월에 걸쳐 골라 기른 것이 분명했습니다.`,
            `씨가 없고, 껍질이 얇고, 아주 달았습니다.`,
            `그렇다면 누군가 그것을 기르고 있다는 뜻이었습니다.`,
            `그런데 밭이 없었습니다.`,
            `저는 그때 그것을 이상하게 여겼어야 했습니다.`,
            `저는 여러 날 동안 그 사람들을 지켜보았습니다.`,
            `그리고 이런 것들을 알게 되었습니다.`,
            `그 사람들은 일을 하지 않았습니다.`,
            `밭도 없고 공장도 없었습니다.`,
            `하루 종일 놀고, 노래하고, 물에서 헤엄치고, 꽃을 땄습니다.`,
            `그리고 밤이 되면 무리 지어 그 큰 건물 안에 들어가 잤습니다.`,
            `혼자 자는 사람은 하나도 없었습니다.`,
            `그 사람들은 몹시 약했습니다.`,
            `조금만 걸어도 지쳤습니다.`,
            `그리고 어른이 되어도 아이 같았습니다.`,
            `무엇에도 오래 마음을 두지 않았습니다.`,
            `제가 무언가를 물으면 잠깐 웃다가 다른 데로 가 버렸습니다.`,
            `저는 그 사람들에게 말을 가르쳐 보려고 했습니다.`,
            `손가락으로 물건을 가리키고 이름을 말하는 식이었습니다.`,
            `그 사람들은 재미있어하며 따라 했습니다.`,
            `그런데 십 분쯤 지나면 다 잊어버렸습니다.`,
            `무엇을 오래 붙들고 있는 힘이 없었던 것입니다.`,
            `저는 여러 날에 걸쳐 겨우 낱말 몇 개를 배웠습니다.`,
            `저는 처음에 이렇게 생각했습니다.`,
            `'사람이 완성된 모습이구나.'`,
            `병도 없고, 싸움도 없고, 먹을 것 걱정도 없습니다.`,
            `그러니 힘이 셀 필요도 없고, 머리를 쓸 필요도 없습니다.`,
            `사람을 강하게 만드는 것은 어려움입니다.`,
            `어려움이 하나도 없어지면 사람은 이렇게 되는 것이구나 하고 생각했습니다.`,
            `저는 그날 저녁 언덕에 앉아 그 생각을 정리했습니다.`,
            `제 생각은 그럴듯했습니다.`,
            `그런데 완전히 틀린 생각이었습니다.`,
            `저는 그것을 사흘 뒤에 알게 됩니다.`
        ]
    },
    {
        ...
        paras: [
            ...
            `소리를 질렀습니다.`,
            `엘로이 몇이 나와서 저를 보았습니다.`,
            `저는 그 사람들을 붙잡고 흔들었습니다.`,
            `"내 기계 어디 있어! 누가 가져갔어!"`,
            `그 사람들은 무서워서 울었습니다.`,
            `저는 그때 제가 무슨 짓을 하고 있는지 알았습니다.`,
            `아이를 붙잡고 흔들고 있었던 것입니다.`,
            `저는 손을 놓고 물러섰습니다.`,
            `그리고 그날 밤 풀밭에 앉아 있었습니다.`,
            `기계가 없으면 저는 영영 여기서 살아야 했습니다.`,
            `팔십만 년 뒤에, 말도 안 통하는 곳에서요.`,
            `저는 그날 밤 여러 가지를 생각했습니다.`,
            `여기서 늙어 죽는다면 아무도 제가 어디로 갔는지 모를 것입니다.`,
            `친구들은 제가 장난을 치다가 사라졌다고 여길 것입니다.`,
            `그리고 몇 해가 지나면 저를 잊을 것입니다.`,
            `그 생각을 하자 견디기가 어려웠습니다.`,
            `아침이 되어 저는 침착해졌습니다.`,
            `그리고 땅에 남은 자국을 살폈습니다.`,
            `기계는 끌린 자국을 남기고 있었습니다.`,
            `그 자국이 스핑크스 조각상 쪽으로 이어져 있었습니다.`,
            `그 조각상의 받침 부분에 청동 문이 두 짝 있었습니다.`,
            `그 문 안으로 자국이 들어가 있었습니다.`,
            `저는 그 문을 두드렸습니다.`,
            `안에서 무언가 움직이는 소리가 났습니다.`,
            `그리고 웃음소리 같은 것이 들렸습니다.`,
            `저는 그 문을 돌로 쳤습니다.`,
            `열리지 않았습니다.`,
            `그런데 문 안에 무언가 있었습니다.`,
            `엘로이가 그것을 열 수 있을 리가 없었습니다.`,
            `그 사람들은 그렇게 무거운 것을 밀 힘이 없었기 때문입니다.`,
            `그렇다면 이 세상에는 엘로이 말고 다른 것이 있었습니다.`,
            `저는 그날부터 그 문 앞을 여러 번 오갔습니다.`,
            `그리고 엘로이에게 그 문에 대해 물었습니다.`,
            `말이 통하는 만큼 물었습니다.`,
            `그 사람들은 그 조각상 쪽을 보려고도 하지 않았습니다.`,
            `제가 손으로 가리키기만 해도 자리를 떴습니다.`,
            `무서워하는 것과는 조금 달랐습니다.`,
    ...
    },
    {
        ...
        paras: [
            `그다음 날 강가에서 일이 하나 있었습니다.`,
            `엘로이 여럿이 물에서 놀고 있었는데, 그 가운데 하나가 물살에 휩쓸렸습니다.`,
            `저는 그것을 보고 물에 뛰어들어 건져 냈습니다.`,
            `아주 가벼웠습니다.`,
            `그런데 이상한 일이 있었습니다.`,
            `물가에 있던 다른 엘로이들이 아무도 나서지 않았던 것입니다.`,
            `누가 물에 빠져 떠내려가는데 다들 그냥 보고 있었습니다.`,
            `무섭거나 슬퍼 보이지도 않았습니다.`,
            `그것이 저에게는 제일 이상했습니다.`,
            `제가 살던 곳에서는 누가 물에 빠지면 다들 뛰어듭니다.`,
            `뛰어들지 못하는 사람도 소리는 지릅니다.`,
            `그런데 그 사람들은 소리도 지르지 않았습니다.`,
            `잠깐 그쪽을 보다가 다시 놀던 것을 계속했습니다.`,
            `제가 건져 낸 사람은 여자였습니다.`,
            `저는 그 사람을 위나라고 불렀습니다.`,
            `그 사람이 낸 소리를 제가 그렇게 알아들었기 때문입니다.`,
            `위나는 그날부터 저를 따라다녔습니다.`,
            `제가 어디를 가든 따라왔습니다.`,
            `제 주머니에 꽃을 넣어 주었습니다.`,
            `그것이 그 사람이 아는 유일한 고마움의 표시였습니다.`,
            `위나는 다른 엘로이와 조금 달랐습니다.`,
            `한 사람에게 오래 마음을 두었기 때문입니다.`,
            `그것은 그 사람들 사이에서 드문 일이었습니다.`,
            `위나 덕분에 저는 한 가지를 알게 되었습니다.`,
            `엘로이는 어둠을 몹시 무서워했습니다.`,
            `해가 지면 다들 큰 건물 안으로 들어갔고, 밖에 남으려고 하지 않았습니다.`,
            `그리고 밤에는 절대 혼자 있지 않았습니다.`,
            `한번은 제가 밤에 밖에 나가려고 하자 위나가 울면서 매달렸습니다.`,
            `저는 물었습니다.`,
            `"밤에 뭐가 있어?"`,
            `위나는 대답하지 못했습니다.`,
            `말을 몰라서가 아니었습니다.`,
            `그 사람들에게는 그것을 가리키는 말이 없었습니다.`,
            `저는 그때 몇 가지를 짐작했습니다.`,
            `그 사람들이 무서워하는 것은 어둠 자체가 아니었습니다.`,
            `어둠 속에 무언가가 있었습니다.`,
            `그리고 그것은 사람이 지어낸 이야기 속의 무엇이 아니었습니다.`,
            `정말로 있는 것이었습니다.`,
            `그러지 않고서는 어른들까지 그렇게 무서워할 까닭이 없었습니다.`
        ]
    },
    {
        num: 8,
        ...
        paras: [
            `저는 그 땅을 돌아다니면서 이상한 것을 여럿 보았습니다.`,
            `여기저기에 둥근 우물 같은 것이 있었습니다.`,
            `가장자리가 청동으로 되어 있었고, 안이 깊었습니다.`,
            `귀를 대면 소리가 났습니다.`,
            `아주 깊은 데서 무언가 돌아가는 소리였습니다. 기계 소리였습니다.`,
            `그리고 그 우물에서는 바람이 나왔습니다.`,
            `공기가 위로 올라오고 있었던 것입니다.`,
            `그러니까 저 아래에 무언가 있고, 거기에 공기를 넣어 주고 있었습니다.`,
            `엘로이에게 그것이 무엇이냐고 물었습니다.`,
            `대답하지 못했습니다.`,
            `그 사람들은 그 우물을 아예 보지 않으려고 했습니다.`,
            `제가 세어 본 것만 그런 우물이 여남은 개였습니다.`,
            `그리고 그것들이 아무렇게나 놓여 있지 않았습니다.`,
            `일정한 간격으로, 이 땅 전체에 골고루 흩어져 있었습니다.`,
            `누가 설계해서 만든 것이었습니다.`,
            `그런데 엘로이는 그런 것을 만들 수 있는 사람들이 아니었습니다.`,
            `그러던 어느 날 새벽이었습니다.`,
            `저는 일찍 깨서 폐허 사이를 걷고 있었습니다.`,
            `그때 어둠 속에서 무언가가 움직였습니다.`,
            `저는 그것을 짐승이라고 생각했습니다.`,
            `흰빛이 도는 것이었는데, 네 발로 기다가 두 발로 서기도 했습니다.`,
            `그것이 저를 보고 달아났습니다.`,
            `저는 따라갔습니다.`,
            `그것이 우물 안으로 사라졌습니다.`,
            `그런데 사라지기 전에 잠깐 돌아보았습니다.`,
            `저는 그 얼굴을 보았습니다.`,
            `사람이었습니다.`,
            `살갗이 희고, 머리에 색이 없고, 눈이 아주 컸습니다.`,
            `밤에 사는 짐승의 눈이었습니다.`,
            `저는 그날 하루 종일 그 생각을 했습니다.`,
            `그리고 알아냈습니다.`,
            `이 세상에는 사람이 두 종류 살고 있었습니다.`,
            `땅 위에 사는 엘로이와, 땅 아래에 사는 무엇이었습니다.`,
            `엘로이들은 그것을 몰록이라고 불렀습니다.`,
            `그 이름을 말할 때 엘로이들의 얼굴이 달라졌습니다.`,
            `웃음이 사라졌습니다.`,
            `위나는 그 말을 듣자 제 손을 잡고 다른 데로 끌었습니다.`,
    ...
    },
    {
        ...
        paras: [
            `저는 내려가 보기로 했습니다.`,
            `기계가 그 문 안에 있고, 그 문을 여는 것이 저것들이라면, 저것들을 알아야 했기 때문입니다.`,
            `위나가 울면서 말렸습니다.`,
            ...
            `내려가면서 저는 제가 얼마나 어리석은 짓을 하고 있는지 생각했습니다.`,
            `성냥 한 통과 쇠막대 하나로 저 아래에 무엇이 있는지도 모르고 내려가는 것이었습니다.`,
            `그런데 올라갈 수도 없었습니다.`,
            `여기서 돌아서면 저는 팔십만 년 뒤에 남는 것이었습니다.`,
            `아래에 이르자 좁은 옆굴이 있었습니다.`,
            `저는 그리로 기어들어 갔습니다.`,
            `안은 캄캄했고, 기계 소리가 컸습니다.`,
            `그리고 냄새가 났습니다.`,
            `저는 성냥을 켰습니다.`,
            ...
            `기계가 여러 대 돌아가고 있었습니다.`,
            `무슨 기계인지는 알 수 없었습니다.`,
            `그리고 그 사이에 몰록들이 서 있었습니다.`,
            `수십 마리였습니다.`,
            `성냥불을 보고 다들 손으로 눈을 가렸습니다.`,
            `빛을 견디지 못하는 것이었습니다.`,
            `그 가운데 한쪽에 상이 하나 있었습니다.`,
            `그 위에 고기가 놓여 있었습니다.`,
            `저는 그것을 보고 성냥을 떨어뜨렸습니다.`,
            `그 고기가 무슨 고기인지 알았기 때문입니다.`,
            `그리고 그때 몰록들이 저를 붙잡았습니다.`,
            `손이 여럿 뻗어와 제 목과 팔을 잡았습니다.`,
            `저는 성냥을 다시 켜서 휘둘렀습니다.`,
            `그것들이 놓았습니다.`,
            `저는 사다리까지 뛰어가 기어올랐습니다.`,
            `발목을 붙잡히면서 올라갔습니다.`,
            `밖으로 나와 풀밭에 쓰러졌을 때, 해가 지고 있었습니다.`,
            `위나가 폐허 계단에 앉아 저를 기다리고 있었습니다.`,
            `제가 나오는 것을 보고 뛰어왔습니다.`,
            `그리고 제 얼굴을 보더니 울기 시작했습니다.`,
            `제 얼굴이 어떻게 되어 있었는지는 저도 모릅니다.`,
    ...
    },
    {
        ...
        paras: [
            `그날 밤 저는 다 알아냈습니다.`,
            `제가 처음에 한 생각은 틀렸습니다.`,
            `이 세상은 사람이 완성된 세상이 아니었습니다.`,
            `이 세상은 사람이 둘로 갈라진 세상이었습니다.`,
            `제가 살던 시대에도 이미 그 갈라짐이 시작되고 있었습니다.`,
            `한쪽에는 일하지 않고 사는 사람들이 있었습니다.`,
            `다른 쪽에는 땅 아래에서 일하는 사람들이 있었습니다.`,
            `제 시대의 런던에도 지하철이 있었고, 지하 공장이 있었고, 하수도에서 일하는 사람들이 있었습니다.`,
            `그 사람들은 햇빛을 거의 보지 못하고 살았습니다.`,
            `그것이 몇십만 년 이어지면 어떻게 될까요.`,
            `땅 위에서 놀기만 한 쪽은 점점 약해지고 작아졌습니다.`,
            `힘이 필요 없었고, 머리를 쓸 일이 없었기 때문입니다.`,
            `그것이 엘로이가 되었습니다.`,
            `땅 아래에서 일한 쪽은 어둠에 맞게 바뀌었습니다.`,
            `눈이 커지고 살갗이 희어졌습니다.`,
            `그것이 몰록이 되었습니다.`,
            `그런데 여기서 한 가지가 뒤집혔습니다.`,
            `처음에는 위쪽이 주인이고 아래쪽이 일꾼이었을 것입니다.`,
            `그런데 오랜 세월이 지나자, 아래쪽에는 기계와 힘과 어둠 속에서 보는 눈이 남았고 위쪽에는 아무것도 남지 않았습니다.`,
            `그래서 지금은 아래쪽이 위쪽을 먹입니다.`,
            `저는 이것을 알아내고 나서 제가 처음에 한 생각이 얼마나 얕았는지 알았습니다.`,
            `저는 이 세상을 사흘 보고 다 안다고 여겼습니다.`,
            `예쁜 것만 보고 그것이 전부라고 여긴 것입니다.`,
            `저는 학자입니다.`,
            `그런 사람이 사흘 보고 결론을 냈습니다.`,
            `옷을 만들어 주고, 과일이 자라게 해 주고, 다 돌봐 줍니다.`,
            `그리고 밤이 되면 몇을 데려갑니다.`,
            `엘로이가 밤을 무서워하는 것이 그 때문이었습니다.`,
            `엘로이가 물에 빠진 동료를 구하지 않은 것도 그 때문이었습니다.`,
            `그 사람들은 누가 없어지는 일에 익숙해져 있었습니다.`,
            `그러지 않고서는 살 수 없었기 때문입니다.`,
            `저는 그것을 알아내고 오래 앉아 있었습니다.`,
            `그리고 제 시대가 생각났습니다.`,
            `저는 그날 밤 처음으로 집에 가고 싶었습니다.`
        ]
    },
    {
        num: 11,
        ...
        paras: [
            `저는 무기가 필요했습니다.`,
            `그래서 며칠 걸어 큰 폐허로 갔습니다.`,
            `초록빛 도자기로 지은 아주 큰 건물이었습니다.`,
            `안에 들어가 보니 그것은 옛날 박물관이었습니다.`,
            `깨진 유리 진열장이 줄지어 서 있었고, 그 안에 삭아 버린 것들이 놓여 있었습니다.`,
            `기계, 뼈, 돌, 책.`,
            `책은 손을 대자 가루가 되었습니다.`,
            `저는 그 안에서 두 가지를 찾아냈습니다.`,
            `쇠막대 하나와, 성냥 한 통이었습니다.`,
            `성냥은 유리병 안에 들어 있어서 아직 그어졌습니다.`,
            `그 박물관을 돌아보면서 저는 이상한 기분이 들었습니다.`,
            `여기 있는 것들은 사람이 알아낸 것을 모아 둔 자리였습니다.`,
            `누군가 그것을 모으고, 이름을 붙이고, 순서대로 놓았습니다.`,
            `그런데 이제 그것을 읽을 수 있는 사람이 하나도 없었습니다.`,
            `저는 진열장 하나를 오래 보았습니다.`,
            `안에 든 것이 무엇인지 알 수 없었습니다.`,
            `저에게도 이미 너무 먼 것이었습니다.`,
            `저는 위나와 함께 돌아오는 길에 숲에서 밤을 맞았습니다.`,
            `숲에서 밤을 보내는 것은 위험했습니다.`,
            `저는 불을 피웠습니다.`,
            `몰록들이 불을 무서워하기 때문이었습니다.`,
            `그런데 잠이 들었습니다.`,
            `깨어 보니 불이 꺼져 있었고, 사방에서 손이 뻗어 오고 있었습니다.`,
            `저는 쇠막대를 휘두르며 싸웠습니다.`,
            `그리고 위나의 손을 잡고 뛰었습니다.`,
            `달아나면서 저는 마른 나뭇가지에 불을 붙여 던졌습니다.`,
            `숲에 불이 붙었습니다.`,
            `불은 아주 빨리 번졌습니다.`,
            `몰록들이 불빛에 눈이 멀어 이리저리 부딪히며 헤맸습니다.`,
            `그 광경은 보기 좋지 않았습니다.`,
            `저는 그때 그것들이 미웠습니다.`,
            `그런데 지금 그 밤을 생각하면 다른 마음이 듭니다.`,
            `그것들은 팔십만 년 동안 어둠 속에 갇혀 살았습니다.`,
            `누가 그렇게 만들었습니까.`,
            `그날 밤 저는 위나의 손을 놓쳤습니다.`,
            `불과 연기 속에서 놓친 것입니다.`,
            `날이 밝을 때까지 찾았습니다.`,
            `찾지 못했습니다.`,
            `저는 그 뒤로 위나를 다시 보지 못했습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `저는 알면서 들어갔습니다.`,
            `문이 뒤에서 닫혔습니다.`,
            `사방이 캄캄해졌고, 손들이 다가왔습니다.`,
            `저는 안장에 올라 지렛대를 더듬어 찾았습니다.`,
            `손이 목에 닿는 순간 지렛대가 잡혔습니다.`,
            `저는 그것을 밀었습니다.`,
            `어둠이 사라지고 다시 낮과 밤이 깜빡이기 시작했습니다.`,
            `저는 그때 제정신이 아니었습니다.`,
            `그래서 멈추지 않고 계속 갔습니다.`,
            `계기판의 숫자가 백만을 넘고, 천만을 넘었습니다.`,
            `그리고 어느 순간 낮과 밤의 깜빡임이 느려졌습니다.`,
            `지구가 도는 것이 느려진 것입니다.`,
            `아주 먼 미래에 저는 멈췄습니다.`,
            `바닷가였습니다.`,
            ...
            `바다는 기름처럼 잔잔했습니다.`,
            `그 물가에 무언가 움직이는 것이 있었습니다.`,
            `게처럼 생긴 것인데 탁자만큼 컸습니다.`,
            `저는 지렛대를 밀어 더 갔습니다.`,
            `삼천만 년쯤 갔을 때, 저는 마지막으로 멈췄습니다.`,
            `그 자리에는 아무것도 없었습니다.`,
            `해가 검게 이지러져 있었고, 바다가 얼어 있었습니다.`,
            `공기가 얇아서 숨쉬기가 어려웠습니다.`,
            `저는 물가에서 검은 것이 하나 꿈틀거리는 것을 보았습니다.`,
            `그것이 제가 본 마지막 생물이었습니다.`,
            `저는 정신을 잃을 것 같아 지렛대를 반대로 밀었습니다.`,
            `그리고 오늘 저녁 이 작업실로 돌아왔습니다.`,
            `여러분이 저녁을 드시고 계실 때였습니다.`,
            `여기까지가 그 사람이 그날 밤에 한 이야기입니다.`,
            `이야기가 끝나자 아무도 말을 하지 않았습니다.`,
            `그러다 의사가 물었습니다.`,
            `"증거가 있습니까?"`,
            `주인은 주머니에서 꽃 두 송이를 꺼내 상 위에 놓았습니다.`,
            `말라 있었지만 아직 형태가 남아 있었습니다.`,
            `의사가 그것을 집어 들여다보다가 얼굴이 굳었습니다.`,
            `"이런 꽃은 본 적이 없습니다."`,
            `그날 밤 손님들은 한마디씩 하고 돌아갔습니다.`,
            `믿는다고 한 사람은 하나도 없었습니다.`,
            `저만 남아서 조금 더 있었습니다.`,
            `주인이 저에게 이렇게 말했습니다.`,
            `"내일 다시 오시겠습니까. 이번에는 증거를 가져오겠습니다. 사진기를 가지고 가겠습니다."`,
            `이튿날 저는 다시 갔습니다.`,
            `작업실 문이 열려 있었고, 안이 비어 있었습니다.`,
            `유리 깨지는 소리 같은 것이 들렸고, 바람이 지나가는 것 같았습니다.`,
            `저는 그 자리에 서서 기다렸습니다.`,
            `한 시간을 기다렸습니다.`,
            `그리고 그날부터 삼 년을 기다렸습니다.`,
            `그 사람은 돌아오지 않았습니다.`,
            `저는 가끔 이런 생각을 합니다.`,
            `그 사람이 지금 어느 시대에 가 있을까요.`,
            `사람이 아직 짐승과 다르지 않던 아주 먼 옛날일 수도 있고, 우리가 알지 못할 어느 앞날일 수도 있습니다.`,
            `그 사람은 사람에게 앞날이 없다고 여기고 떠났습니다.`,
            `저는 그렇게 생각하지 않습니다.`,
            `그 사람이 본 것은 사람이 이렇게 될 수도 있다는 것이지, 반드시 그렇게 된다는 것은 아니었습니다.`,
            `저는 그 마른 꽃 두 송이를 아직 가지고 있습니다.`,
            `사람이 다 사라진 뒤에도 꽃은 피었다는 뜻이니까요.`
        ]
    }
];
/* ── 쪽 나누기 ─────────────────────────────────────────
