...
const CHAPTERS = [
    {
        ...
        paras: [
            ...
            `그 집에서는 목요일마다 저녁 자리가 열렸습니다. 아무나 오는 자리는 아니었고, 늘 오던 사람들만 왔습니다.`,
            `난롯불이 좋았고, 의자가 깊었고, 이야기가 길었습니다. 그래서 다들 그 자리를 좋아했습니다.`,
            ...
            `의사가 고개를 저었습니다.<br>"말장난입니다. 방향과 세월은 다른 것이지요."`,
            `"다르다고 누가 정했습니까." 주인이 되물었습니다.<br>"우리가 그쪽으로 갈 줄 몰라서 다르다고 여기는 것뿐입니다."`,
            `다만 우리는 그 길을 한 방향으로만, 그리고 늘 같은 빠르기로만 갑니다.`,
            `주인이 손가락으로 탁자 위에 선을 그었습니다.<br>"여기가 제가 태어난 날이고, 여기가 오늘입니다. 저는 이 선 위를 걸어온 것입니다."`,
            `기자가 물었습니다.<br>"그러면 우리는 지금도 걷고 있는 겁니까?"<br>"앉아 계셔도 걷고 있습니다. 멈출 수가 없으니까요."`,
            ...
            `손바닥에 올려놓을 수 있을 정도였습니다. 놋쇠가 잘 닦여 있어서 촛불이 거기 비쳤습니다.`,
            `수정 막대 두 개가 어딘가 이상했습니다. 빛이 그 안으로 들어가서 나오지 않는 것 같았습니다.`,
            ...
            `바람 한 줄기가 지나간 것 같았습니다. 촛불이 한 번 흔들렸습니다.`,
            `심리학자는 손가락을 뻗은 자세 그대로 굳어 있었습니다. 그 손가락이 조금씩 떨렸습니다.`,
            `방 안이 조용해졌습니다. 누가 탁자 밑을 들여다보았습니다. 아무것도 없었습니다.`,
            `시장이 탁자 위를 손바닥으로 쓸어 보았습니다. 매끈했습니다.`,
            `기자는 주인의 소매를 보았습니다. 무언가 숨겼는지 보려는 것이었습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `마당을 건너는 동안 아무도 말을 하지 않았습니다. 탁자 위에서 기계가 사라지던 것을 다들 아직 보고 있었기 때문입니다.`,
            `밤공기가 찼습니다. 심리학자는 아직도 자기 손가락을 들여다보고 있었습니다.`,
            `작업실은 마당 건너 별채에 있었습니다. 안이 어수선했습니다. 쇠붙이와 유리 조각과 도면이 바닥에 널려 있었습니다.`,
            `손님들은 촛불을 들고 조심조심 걸었습니다. 바닥에 떨어진 나사를 밟고 미끄러질 뻔한 사람도 있었습니다.`,
            `기름 냄새와 쇳가루 냄새가 났습니다. 오래 일한 사람의 방 냄새였습니다.`,
            `벽에는 도면이 여러 겹으로 붙어 있었습니다. 지운 자국이 많았고, 그 위에 다시 그린 자국이 또 있었습니다.`,
            `몇 해를 매달린 일이라는 것을 그것만 보아도 알 수 있었습니다.`,
            `절반쯤 만들어져 있었습니다.`,
            ...
            `의사는 얼른 손을 뗐습니다.<br>"위험합니까?"<br>"저도 모릅니다. 그래서 만지지 말라는 것입니다."`,
            `"다음 주 목요일에 다시 오십시오. 그때 보여 드리겠습니다."`,
            `"무엇을 보여 주신다는 말씀입니까." 의사가 물었습니다.<br>"그때 아시게 됩니다."`,
            `주인은 촛불을 들고 앞장서서 작업실을 나왔습니다. 문을 잠그는 소리가 마당에 울렸습니다.`,
            `그 이레 동안 손님들은 저마다 그 일을 곱씹었습니다. 의사는 손 빠른 속임수라고 했고, 심리학자는 자기가 헛것을 본 것이라고 했습니다.`,
            `기자는 그것으로 기사를 쓰겠다고 했다가 그만두었습니다. 아무도 믿지 않을 것 같았기 때문입니다.`,
            `시장은 그 이야기를 아예 입에 올리지 않았습니다. 자기가 속았다고 여기는 눈치였습니다.`,
            `저만 밤마다 그 생각을 했습니다. 손가락을 눌렀을 때 촛불이 흔들리던 것이 자꾸 떠올랐습니다.`,
            `이레 뒤, 손님들이 다시 모였습니다. 그런데 주인이 없었습니다.`,
            `식탁에는 이런 쪽지가 놓여 있었습니다.`,
            `"늦을지도 모릅니다. 먼저 드시고 계십시오."`,
            `사람들은 웃으면서 저녁을 먹기 시작했습니다.<br>"또 무슨 장난을 치려는 모양이지."`,
            `"이번에는 무엇으로 놀래 주려는지 봅시다." 기자가 말했습니다.`,
            `"지난번 것보다 나아야 할 텐데요." 의사가 받았습니다.`,
            `다들 웃었습니다. 그런데 웃음소리가 평소보다 컸습니다.`,
            `그때 문이 열렸습니다. 사람들이 고개를 들다가 다 굳었습니다. 주인이 서 있었습니다. 그런데 몰골이 말이 아니었습니다.`,
            `문틀을 한 손으로 짚고 서 있었습니다. 그 손이 놓이면 쓰러질 것 같았습니다.`,
            ...
            `아무 말 없이 술을 한 잔 따라 마셨습니다. 그리고 고기를 집어 먹었습니다.`,
            `허겁지겁 먹었습니다. 며칠 굶은 사람이 먹는 모양이었습니다.`,
            `고기를 손으로 집어 먹었습니다. 그 사람은 평소에 상 앞에서 아주 반듯한 사람이었습니다.`,
            `의사가 술잔을 채워 주었습니다. 그것도 한 번에 비웠습니다.`,
            `그런데 이레 전에 이 집에서 저녁을 먹은 사람이었습니다.`,
            `사람들이 물으려고 하자 손을 들어 막았습니다.`,
            `"조금만 기다려 주십시오. 먹고 나서 다 말씀드리겠습니다."`,
            `목이 쉬어 있었습니다. 오래 소리를 지른 사람의 목소리였습니다.`,
            `아무도 더 묻지 않았습니다. 다들 먹는 것을 멈추고 그 사람만 보았습니다.`,
            `그렇게 십 분이 지났습니다. 그리고 주인은 옷을 갈아입고 와서 난롯가에 앉았습니다.`,
            `머리를 빗고 얼굴을 씻고 왔는데도 달라 보이지 않았습니다. 센 머리가 그대로였기 때문입니다.`,
            `주인은 난로 쪽으로 손을 뻗었습니다. 손이 몹시 떨렸습니다.`,
            `"오늘 저는 여드레를 살았습니다."<br>"무슨 말씀입니까."<br>"여러분이 이레를 사시는 동안, 저는 팔십만 년을 다녀왔습니다."`,
            `아무도 웃지 않았습니다. 이레 전이었다면 다들 웃었을 것입니다.`,
            `그런데 그 사람의 센 머리를 보고 나서는 웃을 수가 없었습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `마지막에 끼운 것은 수정 막대 두 개였습니다. 그것을 끼우자 기계가 조금 흔들렸습니다.`,
            `저는 한참 그것을 보고 있었습니다.`,
            `그러고는 안장에 앉아 지렛대를 잡았습니다. 손이 떨렸습니다.`,
            `그리고 눌렀습니다.`,
            `처음에는 떨어지는 느낌이었습니다. 배를 타고 파도를 넘을 때처럼 속이 뒤집혔습니다.`,
            `귀가 멍했습니다. 저는 지렛대를 놓칠 뻔했습니다.`,
            `그리고 작업실을 보니 이상했습니다.`,
            ...
            `달도 띠가 되었습니다. 다만 그것은 흐릿한 은빛이었습니다.`,
            `별은 하나도 보이지 않았습니다. 별빛도 다 이어져 버렸기 때문입니다.`,
            ...
            `귀에서 쉭 하는 소리가 났습니다. 그리고 갑자기 소리라는 것이 돌아왔습니다.`,
            `바람 소리, 빗소리, 우박이 땅을 때리는 소리가 한꺼번에 쏟아졌습니다.`,
            `우박이 쏟아지고 있었습니다. 기계는 옆으로 넘어져 있었고, 저는 등이 젖은 채 엎드려 있었습니다.`,
            `우박이 목덜미를 때렸습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `풀밭이었습니다. 꽃이 아주 많았습니다.`,
            `저는 우박이 그칠 때까지 기다렸다가 일어났습니다. 그러자 해가 났습니다.`,
            `물방울이 맺힌 꽃들이 한꺼번에 빛났습니다. 저는 잠깐 그것을 보고 서 있었습니다.`,
            `제가 아는 어떤 꽃과도 달랐습니다. 잎이 크고 색이 짙었습니다.`,
            `그리고 사람이 심어 놓은 것처럼 줄지어 나 있었습니다. 저는 그때 그것을 대수롭지 않게 넘겼습니다.`,
            `공기가 따뜻했고 냄새가 좋았습니다.`,
            ...
            `날개 한쪽이 떨어져 나가 있었고, 받침돌에는 금이 가 있었습니다.`,
            `비바람을 몇천 년쯤 맞은 돌의 모습이었습니다.`,
            `그런데 이상한 것이 하나 있었습니다. 이끼가 끼어 있는데도 얼굴만은 또렷했습니다. 누가 손을 대고 있다는 뜻이었습니다.`,
            `그 얼굴이 저를 내려다보고 있었습니다. 저는 조금 무서워졌습니다.`,
            `입꼬리가 조금 올라가 있었습니다. 웃는 것 같기도 하고 아닌 것 같기도 했습니다.`,
            `저는 그 얼굴을 오래 보다가 눈을 돌렸습니다.`,
            `그때 소리가 났습니다. 돌아보니 사람들이 오고 있었습니다. 저는 놀랐습니다.`,
            `저는 얼른 기계 옆에 붙어 섰습니다. 그리고 지렛대에 손을 얹었습니다. 무슨 일이 생기면 곧바로 달아날 생각이었습니다.`,
            `손바닥에 땀이 났습니다.`,
            `팔십만 년 뒤의 사람이 어떤 모습일지 저는 여러 가지로 상상해 보았습니다. 기계를 타고 오는 동안 저는 그 생각만 했습니다.`,
            ...
            `제 가슴께에 겨우 닿았습니다. 그런데 아이가 아니었습니다.`,
            `얼굴을 보니 다 자란 사람이었습니다. 그저 그만큼밖에 자라지 않는 사람들이었습니다.`,
            ...
            `제 옷을 잡아당겨 보고, 신발을 신기하게 들여다보았습니다. 그러고는 자기들끼리 웃었습니다.`,
            `일을 해 본 적이 없는 손이었습니다. 굳은살이 하나도 없었습니다.`,
            `한 사람이 제 목에 꽃목걸이를 걸어 주었습니다.`,
            `저는 그것을 받고 어떻게 해야 할지 몰랐습니다. 그래서 고개를 숙여 인사했습니다.`,
            ...
            `저는 손짓으로 하늘을 가리키고, 땅을 가리키고, 기계를 가리켰습니다. 그 사람들은 제 손을 따라 고개를 돌렸습니다.`,
            `그리고 곧 싫증을 냈습니다. 한 사람은 벌써 꽃밭으로 돌아가 있었습니다.`,
            `그 사람들의 말은 아주 짧았습니다. 두세 마디를 하고 나면 더 할 말이 없는 것 같았습니다. 저는 그것도 그때는 대수롭지 않게 넘겼습니다.`,
            `저는 그날 저녁까지 그 사람들과 함께 있었습니다. 그리고 이런 생각을 했습니다.`,
            `사람이 팔십만 년 뒤에 이렇게 되었다면, 그동안 무슨 일이 있었던 것일까요. 그때는 좋은 쪽으로만 짐작했습니다.`
        ]
    },
    {
        num: 5,
        ...
        paras: [
            `그 사람들은 자기들을 엘로이라고 불렀습니다. 그것이 제가 알아들은 첫 낱말이었습니다.`,
            ...
            `어떤 것은 붉고 길쭉했고, 어떤 것은 손바닥만큼 컸습니다. 저에게도 하나 건네주었습니다.`,
            `저는 그것을 한 입 베어 물었습니다. 물이 많고 아주 달았습니다.`,
            ...
            `그런데 그 사람들이 입은 옷은 낡지 않았습니다. 건물 바닥에는 먼지가 없었습니다.`,
            `누군가 옷을 짓고 바닥을 쓸고 있다는 뜻이었습니다. 그 누군가를 저는 아직 보지 못했습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `과일을 먹고, 노래를 듣고, 밤이면 남들 틈에 끼어 자면서요.`,
            `그리고 언젠가 밤에 무엇인가에게 끌려가겠지요. 그때는 그것이 무엇인지 아직 몰랐습니다.`,
            ...
            `저는 무릎을 꿇고 그 자국을 손으로 짚어 보았습니다. 풀이 한쪽으로 눌려 있었습니다.`,
            `끌고 간 것이지 들고 간 것이 아니었습니다. 무거워서 들지 못했다는 뜻이었습니다.`,
            `문에는 손잡이도 열쇠 구멍도 없었습니다. 안에서만 여는 문이었습니다.`,
            `저는 그 문을 두드렸습니다. 안에서 무언가 움직이는 소리가 났습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `저는 그것을 보고 물에 뛰어들어 건져 냈습니다. 아주 가벼웠습니다.`,
            `제 팔 하나로 들 수 있었습니다. 물가로 나와 눕히자 물을 조금 뱉었습니다.`,
            ...
            `위나는 그날부터 저를 따라다녔습니다. 제가 어디를 가든 따라왔습니다. 그리고 제 주머니에 꽃을 넣어 주었습니다.`,
            `제가 폐허를 살피러 가면 옆에 앉아 기다렸고, 제가 걸으면 뛰어서 따라왔습니다.`,
            `저는 처음에는 귀찮았습니다. 그런데 며칠 지나자 그 사람이 없으면 허전했습니다.`,
            `그것이 그 사람이 아는 유일한 고마움의 표시였습니다.`,
            `위나는 다른 엘로이와 조금 달랐습니다. 한 사람에게 오래 마음을 두었기 때문입니다. 그것은 그 사람들 사이에서 드문 일이었습니다.`,
            `다른 사람들은 아무하고나 놀고 아무하고나 헤어졌습니다. 누가 없어져도 찾지 않았습니다.`,
            `그런데 위나는 제가 안 보이면 저를 찾으러 다녔습니다.`,
            `위나 덕분에 저는 한 가지를 알게 되었습니다.`,
            `엘로이는 어둠을 몹시 무서워했습니다. 해가 지면 다들 큰 건물 안으로 들어갔고, 밖에 남으려고 하지 않았습니다. 그리고 밤에는 절대 혼자 있지 않았습니다.`,
            `해가 기울기 시작하면 웃음소리가 잦아들었습니다. 그리고 다들 같은 쪽으로 걸었습니다.`,
            `누가 부르는 것도 아닌데 다 같이 움직였습니다. 몇만 년 동안 그렇게 해 온 것 같았습니다.`,
            `해가 지기 한참 전부터 다들 안으로 들어갔습니다. 그리고 문 가까이에는 아무도 자지 않았습니다.`,
            `한번은 제가 밤에 밖에 나가려고 하자 위나가 울면서 매달렸습니다.`,
            `제 팔을 두 손으로 잡고 놓지 않았습니다. 그렇게 힘을 쓰는 것은 처음 보았습니다.`,
            `저는 그 사람을 안아서 안으로 데리고 들어갔습니다. 그러자 곧 울음을 그쳤습니다.`,
            `저는 물었습니다.<br>"밤에 뭐가 있어?"`,
            `위나는 제 입을 손으로 막았습니다. 그러고는 고개를 저었습니다.`,
            `묻지 말라는 뜻이었습니다.`,
            ...
            `저는 밤마다 큰 건물 안에서 잤습니다. 그리고 몇 번인가 문 쪽에서 발소리를 들었습니다.`,
            `맨발이 돌바닥을 밟는 소리였습니다. 그 소리가 들리면 자던 사람들이 서로 더 바짝 붙었습니다.`,
            `정말로 있는 것이었습니다. 그러지 않고서는 어른들까지 그렇게 무서워할 까닭이 없었습니다.`,
            `저는 밤에 문 가까이에서 자 보기로 했습니다. 그러자 위나가 제 옷을 끌어 안쪽으로 데려갔습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `그리고 여기저기에 둥근 우물 같은 것이 있었습니다. 가장자리가 청동으로 되어 있었고, 안이 깊었습니다.`,
            `귀를 대면 소리가 났습니다. 쿵쿵거리는 소리가 규칙적으로 들렸습니다.`,
            `아주 큰 것이 천천히 도는 소리였습니다. 아주 깊은 데서 무언가 돌아가는 소리였습니다.`,
            `기계 소리였습니다.`,
            `그리고 그 우물에서는 바람이 나왔습니다. 공기가 위로 올라오고 있었던 것입니다. 그러니까 저 아래에 무언가 있고, 거기에 공기를 넣어 주고 있었습니다.`,
            `저는 마른 풀을 한 줌 뜯어 우물 위에 놓아 보았습니다. 풀이 위로 떠올랐습니다.`,
            `바람이 아주 셌습니다. 아래에서 무언가가 쉬지 않고 숨을 쉬고 있었습니다.`,
            `엘로이에게 그것이 무엇이냐고 물었습니다. 대답하지 못했습니다. 그 사람들은 그 우물을 아예 보지 않으려고 했습니다.`,
            `제가 우물 가장자리에 앉으면 다들 멀찍이 떨어졌습니다. 그러고는 저를 부르지도 않고 가 버렸습니다.`,
            `제가 세어 본 것만 그런 우물이 여남은 개였습니다. 그리고 그것들이 아무렇게나 놓여 있지 않았습니다.`,
            `일정한 간격으로, 이 땅 전체에 골고루 흩어져 있었습니다. 누가 설계해서 만든 것이었습니다.`,
            ...
            `저는 쫓아가다가 발을 헛디뎌 넘어졌습니다. 일어났을 때는 이미 우물 가장자리였습니다.`,
            `그것이 가장자리에 손을 걸치고 저를 올려다보았습니다.`,
            ...
            `저는 그 이름을 여러 번 되뇌었습니다. 몰록. 위나가 알려 준 말이었습니다.`,
            `정확히는 알려 준 것이 아니라, 제가 우물을 가리키자 그 사람이 겨우 뱉은 소리였습니다.`,
    ...
    },
    {
        ...
        paras: [
            `저는 내려가 보기로 했습니다. 기계가 그 문 안에 있고, 그 문을 여는 것이 저것들이라면, 저것들을 알아야 했기 때문입니다.`,
            ...
            `저는 그것을 잡고 내려갔습니다. 이백 자쯤 내려갔습니다. 팔이 떨렸습니다.`,
            `쇠막대 하나가 부러져서 하마터면 떨어질 뻔했습니다.`,
            ...
            `고기 썩는 냄새 비슷한 것이었습니다. 저는 숨을 얕게 쉬었습니다.`,
            `성냥을 그을 때 손이 떨려서 두 개를 부러뜨렸습니다.`,
            `아주 큰 방이었습니다. 천장이 보이지 않을 만큼 높았습니다.`,
            `기계가 여러 대 돌아가고 있었습니다. 무슨 기계인지는 알 수 없었습니다. 그리고 벽을 따라 관이 여러 가닥 지나가고 있었습니다.`,
            `그 사이에 몰록들이 서 있었습니다. 수십 마리였습니다.`,
            `성냥불을 보고 다들 손으로 눈을 가렸습니다. 빛을 견디지 못하는 것이었습니다.`,
            ...
            `성냥 통이 얼마 남지 않은 것을 저는 알고 있었습니다. 그래서 한 개비씩 아껴 그었습니다.`,
            `불이 꺼질 때마다 손들이 다시 다가왔습니다.`,
            ...
            `손등이 다 까져 있었고, 옷이 찢어져 있었습니다. 그것을 보고 운 것인지도 모릅니다.`,
            ...
            `저는 그날 밤 잠을 이루지 못했습니다. 상 위에 놓여 있던 그 고기가 자꾸 떠올랐습니다.`
        ]
    },
    {
        num: 10,
        ...
        paras: [
            ...
            `제가 처음에 한 생각은 틀렸습니다. 이 세상은 사람이 완성된 세상이 아니었습니다.`,
            ...
            `저는 그런 곳에 한 번 내려가 본 적이 있습니다. 등불을 들고 좁은 굴을 걸었습니다.`,
            `거기서 일하는 사람들의 얼굴이 희었습니다. 저는 그때 그것을 그냥 지나쳤습니다.`,
            `땅 아래에서 일하는 사람과 땅 위에서 그 덕을 보는 사람이 이미 나뉘어 있었습니다. 다만 그때는 같은 사람으로 보였습니다.`,
            `같은 말을 쓰고, 같은 옷을 입고, 길에서 마주치면 서로 비켜 주었으니까요.`,
            `그런데 사는 곳이 달랐고, 하는 일이 달랐고, 자식이 갈 학교가 달랐습니다.`,
            `그것이 몇십만 년 이어지면 어떻게 될까요. 한 세대가 삼십 년이라면 몇십만 년은 만 세대가 넘습니다. 사람이 그만큼 갈라져 살면 서로 다른 것이 됩니다.`,
            `같은 굴에 오래 사는 물고기는 눈이 없어집니다. 어두운 데서는 눈이 쓸모없기 때문입니다.`,
            `사람이라고 다를 까닭이 없습니다.`,
            `땅 위에서 놀기만 한 쪽은 점점 약해지고 작아졌습니다. 힘이 필요 없었고, 머리를 쓸 일이 없었기 때문입니다.`,
            `위험이 없으면 용기가 필요 없습니다. 할 일이 없으면 재주도 필요 없습니다.`,
            `필요 없는 것은 몇 대만 지나도 사라집니다. 팔십만 년이면 흔적도 남지 않습니다.`,
            `그것이 엘로이가 되었습니다. 땅 아래에서 일한 쪽은 어둠에 맞게 바뀌었습니다. 눈이 커지고 살갗이 희어졌습니다.`,
            `어두운 데서 보려면 눈이 커야 합니다. 햇빛을 안 받으면 살갗에 색이 남지 않습니다.`,
            `몸은 오히려 튼튼해졌습니다. 계속 일을 했기 때문입니다.`,
            ...
            `제가 그동안 이상하게 여긴 것들이 그것으로 다 풀렸습니다. 밭이 없는데 과일이 있던 것도, 옷이 낡지 않던 것도요.`,
            `사람이 기르는 짐승도 그렇습니다. 먹여 주고, 돌봐 주고, 우리를 지어 줍니다.`,
            `그리고 밤이 되면 몇을 데려갑니다. 엘로이가 밤을 무서워하는 것이 그 때문이었습니다.`,
            `저는 그 생각을 하고 한참 동안 움직이지 못했습니다.`,
            `제가 낮에 본 그 웃는 얼굴들이 다 그렇게 사라지는 것이었습니다. 그리고 남은 사람들은 다음 날 아침에도 웃었습니다.`,
            `저는 이것을 알아내고 나서 제가 처음에 한 생각이 얼마나 얕았는지 알았습니다. 저는 이 세상을 사흘 보고 다 안다고 여겼습니다. 예쁜 것만 보고 그것이 전부라고 여긴 것입니다.`,
            `처음 사흘 동안 저는 이런 생각을 했습니다. 사람이 마침내 싸움을 그치고, 병을 없애고, 다 같이 놀며 사는 세상을 만들었구나 하고요.`,
            `저는 그것을 노트에 적어 두기까지 했습니다.`,
            `저는 학자입니다. 그런 사람이 사흘 보고 결론을 냈습니다.`,
            `그 노트를 저는 나중에 찢어 버렸습니다.`,
            `엘로이가 물에 빠진 동료를 구하지 않은 것도 그 때문이었습니다. 그 사람들은 누가 없어지는 일에 익숙해져 있었습니다. 그러지 않고서는 살 수 없었기 때문입니다.`,
            `슬퍼하기 시작하면 밤마다 슬퍼해야 합니다. 그래서 슬퍼하는 법을 잊은 것입니다.`,
            `저는 위나가 저를 보고 울던 것을 떠올렸습니다. 그 사람만 그것을 잊지 않고 있었습니다.`,
            `저는 그것을 알아내고 오래 앉아 있었습니다. 그리고 제 시대가 생각났습니다. 저는 그날 밤 처음으로 집에 가고 싶었습니다.`,
            `석탄 연기 냄새가 나는 런던의 거리와, 시끄러운 마차 소리와, 신문을 파는 아이의 목소리가요.`,
            `그 아이는 아마 학교에 못 다녔을 것입니다. 저는 그때까지 그 아이를 한 번도 생각해 본 적이 없었습니다.`,
    ...
    },
    {
        ...
        paras: [
            `저는 무기가 필요했습니다. 쇠막대 하나면 되었습니다.`,
            `그런데 그 땅에는 쇠붙이가 하나도 없었습니다. 팔십만 년 동안 다 삭은 것입니다.`,
            `그래서 저는 며칠을 걸어 큰 폐허로 갔습니다. 초록빛 도자기로 지은 아주 큰 건물이었습니다.`,
            `안에 들어가 보니 그것은 옛날 박물관이었습니다. 그것도 아주 오래된 박물관이었습니다.`,
            `깨진 유리 진열장이 줄지어 서 있었고, 그 안에 삭아 버린 것들이 놓여 있었습니다. 기계, 뼈, 돌, 책.`,
            `책은 손을 대자 가루가 되었습니다.`,
            `여기 놓인 것들이 만들어진 때와 제 시대 사이가, 제 시대와 지금 사이만큼 멀지도 모릅니다.`,
            `저는 그 안에서 두 가지를 찾아냈습니다. 쇠막대 하나와, 성냥 한 통이었습니다. 찾는 데 반나절이 걸렸습니다.`,
            `위나가 옆에서 제 흉내를 내며 진열장을 들여다보았습니다. 성냥은 유리병 안에 들어 있어서 아직 그어졌습니다.`,
            `그 박물관을 돌아보면서 저는 이상한 기분이 들었습니다. 여기 있는 것들은 사람이 알아낸 것을 모아 둔 자리였습니다.`,
            `누군가 그것을 모으고, 이름을 붙이고, 순서대로 놓았습니다. 그런데 이제 그것을 읽을 수 있는 사람이 하나도 없었습니다.`,
            `저는 진열장 하나를 오래 보았습니다. 안에 든 것이 무엇인지 알 수 없었습니다. 저에게도 이미 너무 먼 것이었습니다.`,
            ...
            `어두워서 어디로 뛰는지도 몰랐습니다. 나뭇가지가 얼굴을 때렸습니다.`,
            `위나는 제 손을 꼭 잡고 있었습니다. 소리는 내지 않았습니다.`,
            ...
            `그것들은 서로 부딪히고 넘어지면서도 소리를 내지 않았습니다. 그것이 더 견디기 어려웠습니다.`,
            `그것들은 팔십만 년 동안 어둠 속에 갇혀 살았습니다. 누가 그렇게 만들었습니까.`,
            `그날 밤 저는 위나의 손을 놓쳤습니다. 불과 연기 속에서 놓친 것입니다.`,
            `연기가 목을 막아 저는 기침을 하며 주저앉았습니다. 다시 일어났을 때 손이 비어 있었습니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `활짝 열려 있었습니다. 며칠 동안 돌로 쳐도 꿈쩍하지 않던 문이었습니다.`,
            ...
            `목을 잡고 있던 손이 스르르 벗겨졌습니다. 그것들은 저와 함께 오지 못했습니다.`,
            `저는 안장에 엎드린 채 한참 동안 숨만 쉬었습니다.`,
            ...
            `새 소리도 벌레 소리도 없었습니다. 파도 소리도 나지 않았습니다.`,
            `제가 아는 어떤 곳보다 조용했습니다.`,
            `바다는 기름처럼 잔잔했습니다. 그 물가에 무언가 움직이는 것이 있었습니다. 게처럼 생긴 것인데 탁자만큼 컸습니다.`,
            `더듬이를 천천히 흔들며 저를 향해 왔습니다. 저는 지렛대를 밀어 조금 앞으로 갔습니다.`,
            `그러자 그것이 사라지고, 다른 것이 같은 자리에 있었습니다. 그 물가에는 그런 것들만 살고 있었습니다.`,
