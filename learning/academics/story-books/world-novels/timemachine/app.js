...
const CHAPTERS = [
    ...
    },
    {
        ...
        paras: [
            ...
            `그것이 몇십만 년 이어지면 어떻게 될까요. 땅 위에서 놀기만 한 쪽은 점점 약해지고 작아졌습니다. 힘이 필요 없었고, 머리를 쓸 일이 없었기 때문입니다.`,
            ...
            `그래서 지금은 아래쪽이 위쪽을 먹입니다. 저는 이것을 알아내고 나서 제가 처음에 한 생각이 얼마나 얕았는지 알았습니다. 저는 이 세상을 사흘 보고 다 안다고 여겼습니다.`,
            `예쁜 것만 보고 그것이 전부라고 여긴 것입니다. 저는 학자입니다. 그런 사람이 사흘 보고 결론을 냈습니다.`,
            `옷을 만들어 주고, 과일이 자라게 해 주고, 다 돌봐 줍니다. 그리고 밤이 되면 몇을 데려갑니다. 엘로이가 밤을 무서워하는 것이 그 때문이었습니다.`,
