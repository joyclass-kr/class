...
const CHAPTERS = [
    {
        ...
        paras: [
            ...
            `반대로 시시한 진주는 아무리 싸도 쳐다보지 않았지요.`,
            `"언젠가는 만날 거야. 딱 하나뿐인 그 진주를."`,
            `사람들은 그런 상인을 이상하게 여겼답니다.`,
            `"저 사람은 왜 사지도 않을 걸 저렇게 오래 보는 거지?"`,
            `"돈이 있으면 그냥 여러 개 사면 될 텐데."`,
            `상인은 그런 말에 그저 웃기만 했어요.`,
            `그러던 어느 날이었어요.`,
            `낯선 항구 마을의 허름한 좌판 앞을 지나던 상인이 우뚝 멈춰 섰지요.`,
            `숨이 멎을 뻔했답니다.`,
            `지금껏 본 적 없는 진주 한 알이 거기 놓여 있었거든요.`,
            `달빛을 그대로 굳혀 놓은 것 같았어요. 들여다보면 안쪽에서 은은한 빛이 도는 것이었지요.`,
            `'이거다. 평생 찾던 게 바로 이거야.'`,
            `상인의 손끝이 파르르 떨렸어요.`,
            `"이 진주, 얼마입니까?"`,
            `좌판 주인이 부른 값은 어마어마했답니다.`,
            `상인이 가진 전 재산을 다 합쳐도 모자랄 만큼이었지요.`,
            `보통 사람이라면 여기서 돌아섰을 거예요.`,
            `그런데 상인은 며칠씩 고민하지 않았어요.`,
            `"잠깐만 기다려 주십시오. 곧 돌아오겠습니다."`,
            `상인은 그길로 집을 팔았어요.`,
            `배도 팔았지요. 지금까지 모아 온 다른 보석들도 전부 내놓았답니다.`,
            `사람들이 혀를 찼어요.`,
            `"전 재산을 진주 한 알에 걸다니, 제정신이야?"`,
            `"저러다 길에 나앉지."`,
            `하지만 상인은 아무 말도 하지 않았어요.`,
            `그저 묵묵히 돈을 챙겨 그 좌판으로 돌아갔지요.`,
            `마침내 진주가 상인의 손바닥 위에 놓였어요.`,
            `상인은 그것을 오래오래 들여다보았답니다.`,
            `집도 없고 배도 없었어요. 남은 건 그 진주 하나뿐이었지요.`,
            `그런데 상인의 얼굴은 세상을 다 가진 사람 같았답니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `그런데 나그네는 갈 길이 급했어요.`,
            `아니나 다를까, 바위 뒤에서 강도들이 우르르 튀어나왔지요.`,
            `강도들은 나그네를 흠씬 두들겨 팼어요.`,
            `가진 것을 몽땅 빼앗고는 길가에 버려두고 사라졌답니다.`,
            ...
            `그 사람도 나그네를 보았지요. 가까이 다가가 들여다보기까지 했답니다.`,
            `하지만 이내 고개를 돌리고 갈 길을 갔어요.`,
            ...
            `그런데 그는 쓰러진 나그네를 보자마자 나귀에서 훌쩍 뛰어내렸어요.`,
            `"이런, 이 사람 좀 보게!"`,
            `그는 망설임 없이 다가가 무릎을 꿇었답니다.`,
            `가진 기름과 포도주를 꺼내 상처를 씻고, 제 옷자락을 찢어 정성껏 싸매 주었지요.`,
            `그러고는 나그네를 제 나귀에 태웠어요.`,
            `자기는 걸어서 고삐를 잡고 가까운 여관까지 데려갔답니다.`,
            `여관에 닿자 그는 주인에게 돈을 넉넉히 쥐여 주었어요.`,
            `"이 사람을 잘 돌봐 주세요."`,
            `"부족하면 제가 돌아올 때 더 드리겠습니다."`,
            `그러고는 이름도 남기지 않고 떠났지요.`,
            `정작 도와줄 거라 여겨졌던 사람들은 그냥 지나쳤어요.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `그런데 한 사람이 다급하게 친구네 집 대문을 두드렸답니다.`,
            `쿵쿵쿵!`,
            `"여보게, 자고 있나? 나 좀 도와줘!"`,
            `사연은 이랬어요.`,
            `먼 길을 오던 손님이 갑자기 찾아왔는데, 집에 대접할 빵이 하나도 없었던 거예요.`,
            `손님을 굶길 수는 없었지요. 그렇다고 이 밤에 빵집이 열려 있을 리도 없고요.`,
            `어쩔 줄 몰라 하다가 한밤중에 친구네 집까지 달려온 참이었답니다.`,
            `한참 만에 안에서 부스럭 소리가 났어요.`,
            `"지금 몇 신 줄 알아?"`,
            `친구는 침대에서 일어나지도 않은 채 짜증 섞인 목소리로 소리쳤지요.`,
            ...
            `쿵쿵쿵.`,
            `그는 계속, 계속 문을 두드렸어요.`,
            `개가 짖기 시작했어요. 옆집 창문에 불이 켜졌지요.`,
            `이웃이 다 깰 정도로 끈질기게 졸랐답니다.`,
            `결국 안에서 이불 걷어차는 소리가 났어요.`,
            `"아이고, 알겠다, 알겠어!"`,
            `쿵쾅쿵쾅. 발소리가 문 쪽으로 다가왔지요.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `여인은 가끔 그 은전을 꺼내 하나하나 세어 보곤 했답니다.`,
            ...
            `가슴이 철렁 내려앉았어요.`,
            `여인은 곧장 등불을 켰어요.`,
            `그러고는 빗자루를 들고 방을 쓸기 시작했지요.`,
            `침대 밑도 들여다봤어요. 항아리 뒤편도 뒤졌어요.`,
            `마루 틈에는 손가락을 넣어 훑어 보았답니다.`,
            `문지방 아래도, 화덕 옆 재까지도 헤쳐 보았지요.`,
            `이웃이 지나가다 창문 너머로 물었어요.`,
            `"뭘 그렇게 찾아요? 겨우 은전 한 닢 아니에요?"`,
            `여인은 고개도 들지 않고 대답했답니다.`,
            `"저에겐 그 한 닢이 열 닢만큼 중요해요."`,
            `등불이 방 구석구석을 훑고 지나갔어요.`,
            `빗자루가 마루를 몇 번이나 오갔지요.`,
            `무릎이 아파 왔지만 여인은 멈추지 않았답니다.`,
            `그러기를 한참, 방 한구석 어두운 틈에서 무언가가 반짝했어요.`,
            `여인이 숨을 멈추고 손을 뻗었지요.`,
            `"찾았다!"`,
            `여인은 은전을 손에 꼭 쥐고 뛸 듯이 기뻐했어요.`,
            `그러고는 문밖으로 달려 나가 이웃들을 불러 모았답니다.`,
            `"제가 잃어버렸던 은전을 찾았어요!"`,
            `"우리 같이 기뻐해요!"`,
            `이웃들은 어리둥절했어요.`,
            `은전 한 닢에 이렇게까지 기뻐하는 사람은 처음 보았거든요.`,
            `그런데 여인의 환한 얼굴을 보자 저마다 빙그레 웃음이 났답니다.`,
            `여인에게 중요했던 건 은전의 값어치만이 아니었어요.`,
            `제 것을 하나도 잃어버리지 않겠다는 마음, 그게 진짜였지요.`
        ],
    ...
    },
    {
        ...
        paras: [
            ...
            `한 사람은 마음이 급했어요.`,
            `그는 강가의 널찍한 모래밭을 골랐답니다.`,
            `모래는 파기도 쉽고 바닥도 평평해서 일이 훨씬 빨리 끝났거든요.`,
            `기둥을 세우고 벽을 올리는 데 며칠이 걸리지 않았어요.`,
            `"역시 요령이 최고지."`,
            `그는 흡족한 얼굴로 새집에 이사했답니다.`,
            `다른 한 사람은 달랐어요.`,
            `그는 땅을 파고 또 팠지요.`,
            `단단한 바위, 그러니까 반석을 찾아낼 때까지 멈추지 않았답니다.`,
            `팔이 저리고 등이 쑤셨어요.`,
            ...
            `"저기 저 사람은 벌써 다 지었던데."`,
            `"시간 낭비 아니야?"`,
            `그래도 그는 묵묵히 삽질을 계속했어요.`,
            `이윽고 삽 끝에 단단한 것이 딱 걸렸지요.`,
            `그제야 그는 그 위에 기둥을 세우기 시작했답니다.`,
            `몇 달이 흘렀어요.`,
            `그러던 어느 날, 거센 폭풍우가 마을을 덮쳤답니다.`,
            `비바람이 밤새 몰아쳤어요. 강물이 불어 넘쳐흘렀지요.`,
            `모래 위에 지은 집은 물이 발밑을 파고들자 기우뚱했어요.`,
            `한 번 더 기우뚱하더니—`,
            `와르르!`,
            `결국 무너져 내리고 말았답니다.`,
            `집주인은 넋을 잃고 그 자리에 주저앉았어요.`,
            `하지만 반석 위에 지은 집은 달랐지요.`,
            `그 무서운 폭풍 속에서도 흔들림 없이 우뚝 서 있었답니다.`,
            `그 집 주인은 창밖으로 몰아치는 비바람을 오래 바라보았어요.`,
            `그러고는 조용히 말했지요.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `일할 사람을 구하러 간 거예요.`,
            `"하루 품삯으로 은화 한 닢을 주겠소."`,
            `일꾼들은 흔쾌히 따라나섰지요. 그만하면 넉넉한 품삯이었거든요.`,
            `해가 높이 떠올랐어요.`,
            `그런데 주인이 낮 열두 시에 다시 시장에 나가는 것이었어요.`,
            `거기엔 아직 일자리를 못 구한 사람들이 우두커니 서 있었지요.`,
            `"자네들도 포도원에 가서 일해 주게."`,
            `오후 세 시에도 주인은 또 나갔어요.`,
            `심지어 해 지기 한 시간 전에도 나가 놀고 있는 사람들을 불러 모았답니다.`,
            `"어찌 하루 종일 여기 서 있는가?"`,
            `"아무도 우리를 써 주지 않아서요."`,
            `"그럼 자네들도 가서 일하게."`,
            `이윽고 저녁이 되어 일이 끝났어요.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `"아버지, 제 몫의 재산을 지금 주세요."`,
            `방 안이 조용해졌어요.`,
            `아버지는 한참 아들을 바라보았답니다. 그러고는 아무 말 없이 재산을 나눠 주었지요.`,
            `둘째 아들은 얼마 지나지 않아 짐을 싸서 먼 나라로 훌쩍 떠나 버렸어요.`,
            `뒤도 돌아보지 않았답니다.`,
            `낯선 도시에서 그는 흥청망청 돈을 써 댔어요.`,
            `좋은 옷을 사 입었어요. 날마다 잔치를 벌였지요.`,
            `"이야, 자네 정말 통이 크군!"`,
            `친구도 금세 많아졌답니다.`,
            `그런데 돈은 생각보다 훨씬 빨리 바닥났어요.`,
            `설상가상으로 그 나라에 큰 흉년까지 들었지요.`,
            `잔치 친구들은 하나둘 사라졌어요. 이름을 불러도 못 들은 척했답니다.`,
            `결국 그는 남의 집 돼지를 치는 신세가 되고 말았어요.`,
            `돼지 먹이라도 나눠 먹고 싶을 만큼 배를 곯았지요.`,
            `어느 날 빈 여물통을 들여다보던 둘째 아들이 문득 정신이 들었어요.`,
            ...
            `그런데 아직 마을이 저 멀리 보일 무렵이었어요.`,
            `누군가 옷자락을 붙잡고 버선발로 달려 나오는 게 아니겠어요?`,
            `아버지였답니다.`,
            `날마다 그 길을 내다보고 있었던 거예요.`,
            `"아버지, 저는……"`,
            `말이 끝나기도 전에 아버지는 아들을 와락 끌어안았어요.`,
            `그러고는 종들을 향해 소리쳤지요.`,
            `"어서 잔치를 열어라!"`,
            `그 모습을 이해할 수 없다는 얼굴로 바라보던 큰아들에게, 아버지는 이렇게 말했답니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `그는 품에서 다른 씨앗을 꺼냈어요.`,
            `밀과 아주 비슷하게 생긴 잡초, 가라지 씨앗이었답니다.`,
            `이웃은 그것을 밭 여기저기에 뿌리고 소리 없이 사라졌어요.`,
            `며칠 뒤 싹이 자라기 시작했어요.`,
            `그런데 일꾼들이 화들짝 놀라 농부에게 달려왔지요.`,
            `"주인님, 큰일 났습니다!"`,
            `"밭에 이상한 잡초가 밀이랑 섞여서 자라고 있어요!"`,
            `"지금 당장 뽑아 버릴까요?"`,
            `농부는 밭에 나가 한참을 들여다보았어요.`,
            `쪼그려 앉아 싹을 하나하나 만져 보기도 했지요.`,
            `밀과 가라지는 어찌나 닮았는지 구별이 잘 되지 않았답니다.`,
            `일꾼들이 삽을 들고 명령을 기다렸어요.`,
            `그런데 농부가 천천히 고개를 저었답니다.`,
            `"아니다. 그냥 두어라."`,
            ...
            `밀은 알이 무거워 고개를 푹 숙였어요.`,
            `반면 가라지는 알맹이가 없어 빳빳하게 서 있었답니다.`,
            `이제는 멀리서 봐도 한눈에 구별이 되었어요.`,
            `농부가 일꾼들을 불러 말했지요.`,
            `"자, 이제 거두어라."`,
    ...
    },
    {
        ...
        paras: [
            ...
            `첫째 종은 그날로 시장으로 달려갔어요.`,
            `그 돈을 밑천 삼아 곡식을 사고팔기 시작했지요.`,
            `둘째 종도 마찬가지였답니다.`,
            `이 마을 저 마을을 부지런히 뛰어다니며 물건을 사고팔았어요.`,
            `그런데 셋째 종은 달랐지요.`,
            ...
            `"이러면 잃어버릴 일은 없겠지."`,
            `오랜 시간이 흘러 주인이 돌아왔어요.`,
            `주인은 종들을 불러 셈을 하기로 했지요.`,
            `첫째 종이 앞으로 나왔어요.`,
            `"주인님, 다섯 달란트를 열 달란트로 만들었습니다."`,
            `둘째 종도 나왔답니다.`,
            `"저는 두 달란트를 네 달란트로 만들었습니다."`,
            `주인은 크게 기뻐하며 두 사람의 어깨를 두드렸어요.`,
            `"잘했다! 아주 잘했어."`,
            `이윽고 셋째 종의 차례가 되었어요.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `그는 마음에 들지 않는 사람은 아예 만나 주지도 않았답니다.`,
            `그런데 그 마을에는 억울한 일을 당한 과부가 한 명 있었어요.`,
            `남편을 잃고 가진 것마저 빼앗긴 처지였지요.`,
            `과부는 재판관을 찾아가 애원했답니다.`,
            `"제발 제 억울함을 풀어 주세요!"`,
            `재판관은 서류에서 눈도 떼지 않았어요.`,
            `"바쁘니 나중에 오시오."`,
            `그러고는 손짓 한 번으로 과부를 돌려보냈지요.`,
            `문밖으로 밀려난 과부는 한참을 서 있었어요.`,
            `하지만 포기하지 않았답니다.`,
            `다음 날 아침, 과부는 다시 그 문 앞에 서 있었어요.`,
            `"제발 제 사정을 좀 들어주세요."`,
            `그다음 날도 찾아갔지요.`,
            `또 그다음 날도요.`,
            `재판관은 매번 짜증을 냈어요.`,
            ...
            `"내가 몇 번을 말해야 알아듣겠소!"`,
            `그래도 과부는 아랑곳하지 않았답니다.`,
            `아침이면 어김없이 그 문 앞에 서 있었어요.`,
            `하루가 이틀이 되고, 이틀이 열흘이 되었지요.`,
            `재판관은 밥을 먹다가도 그 얼굴이 떠올랐어요.`,
            `잠을 자려고 누워도 문 두드리는 소리가 들리는 것 같았답니다.`,
            `마침내 재판관이 두 손을 들고 말았어요.`,
            `"내가 아무도 두렵지 않지만……"`,
            `그는 이마를 짚으며 한숨을 쉬었지요.`,
            `"이 여자가 하도 귀찮게 굴어서 도저히 못 버티겠구나."`,
            `"차라리 이 사람의 억울함을 풀어 줘서 더는 안 찾아오게 해야겠다."`,
            `재판관은 결국 과부의 손을 들어 주었답니다.`,
            `마을 사람들은 그 소식을 듣고 눈을 동그랗게 떴어요.`,
            `"그 재판관이 움직였다고?"`,
    ...
    },
    {
        ...
        paras: [
            ...
            `그런데 이 청지기가 재산을 함부로 쓴다는 소문이 부자의 귀에 들어갔답니다.`,
            `부자가 청지기를 불렀어요.`,
            `"자네 소문이 사실인가?"`,
            `청지기는 아무 대답도 하지 못했어요.`,
            `변명할 말이 없었거든요.`,
            ...
            `한참을 궁리하던 청지기의 눈이 반짝했어요.`,
            `묘안이 떠오른 거예요.`,
            `그는 주인에게 빚진 사람들을 하나씩 몰래 불렀답니다.`,
            `"자네가 얼마를 빚졌지?"`,
            `"기름 백 말입니다."`,
            `"그럼 장부에 쉰 말이라고 적게."`,
            `빚진 사람은 어리둥절했어요.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `임금이 눈살을 찌푸렸지요.`,
            `"가족까지 다 팔아서라도 갚아라."`,
            `신하는 그 자리에 털썩 무릎을 꿇었어요.`,
            `"제발 시간을 좀 주십시오."`,
            `"반드시 다 갚겠습니다."`,
            `그는 이마를 바닥에 대고 빌고 또 빌었답니다.`,
            `그 모습이 어찌나 안쓰럽던지요.`,
            `임금은 한참 신하를 내려다보았어요.`,
            `궁궐 안이 아주 조용해졌지요.`,
            `이윽고 임금이 손을 내저었답니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `"수확철이 되면 내 몫만 보내 주게."`,
            `"염려 마십시오, 주인님."`,
            `가을이 되어 포도가 탐스럽게 익었어요.`,
            `지주는 몫을 받으러 종을 보냈지요.`,
            `그런데 소작농들은 그 종을 흠씬 두들겨 팼답니다.`,
            `"주인이 뭘 했다고 몫을 달래?"`,
            `"땀 흘린 건 우리야!"`,
            `종은 빈손으로 돌아갈 수밖에 없었어요.`,
            `지주는 다시 다른 종을 보냈어요.`,
            `이번엔 더 심하게 당하고 쫓겨났지요.`,
            ...
            `"주인은 멀리 있잖아. 누가 알겠어?"`,
            `결국 지주는 마지막으로 자기 아들을 보내기로 했어요.`,
            `"내 아들이라면 그래도 존중해 주겠지."`,
            `아들이 포도원 문을 들어섰어요.`,
            `소작농들이 그 모습을 보고 서로 수군거렸지요.`,
            `"저 아들만 없애면 이 포도원은 완전히 우리 것이 될 거야!"`,
            `"주인이 늙으면 물려줄 사람도 없을 테고."`,
            `그들은 아들마저 붙잡아 포도원 밖으로 끌고 나가 해치고 말았답니다.`,
            `소식을 들은 지주는 크게 분노했어요.`,
            `그는 곧장 사람들을 데리고 포도원으로 갔지요.`,
            `그러고는 그 소작농들을 모두 내쫓았답니다.`,
            `한 사람도 남기지 않았어요.`,
            `지주는 정직하게 몫을 나눌 새로운 사람들에게 포도원을 맡겼지요.`,
            `욕심에 눈이 멀어 은혜를 저버린 이들에게는, 결국 그 욕심조차 허락되지 않았던 거예요.`
        ],
    ...
    },
    {
        ...
        paras: [
            ...
            `"어떡해!"`,
            `"기름 좀 나눠 줘!"`,
            `하지만 지혜로운 다섯은 고개를 저었어요.`,
            `"나눠 주면 우리도 모자라."`,
            `"가서 사 오는 게 낫겠어."`,
            `어리석은 다섯은 기름을 사러 캄캄한 거리로 급히 달려 나갔답니다.`,
            `그사이 신랑이 도착했어요.`,
            `준비돼 있던 다섯은 환한 등불을 들고 신랑을 맞았지요.`,
            `그러고는 함께 잔치 자리로 들어갔답니다.`,
            `그리고 문이 닫혔어요.`,
            `한참 뒤 기름을 구해 돌아온 다섯이 문을 두드렸어요.`,
            `쿵쿵쿵. 쿵쿵쿵.`,
            `하지만 문은 끝내 열리지 않았답니다.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `임금은 크게 화가 났지요.`,
            `"초대받고도 저리 무례하다니!"`,
            `상은 다 차려져 있는데 자리는 텅 비어 있었어요.`,
            `한참 씩씩거리던 임금이 손을 저었답니다.`,
            `"이제 아무나 데려오너라."`,
            `종들은 길거리로 나갔어요.`,
            `마주치는 사람은 누구든 붙잡았지요.`,
            `좋은 사람이든 나쁜 사람이든 가리지 않았답니다.`,
            `"임금님이 부르십니다! 어서 가시지요!"`,
            `덕분에 잔칫상은 금세 손님들로 가득 찼어요.`,
            `웃음소리가 궁궐 담을 넘었지요.`,
            `임금이 흐뭇하게 손님들을 둘러보던 참이었어요.`,
            `그런데 한 사람이 눈에 걸렸답니다.`,
            `예복도 갖춰 입지 않은 채 앉아 있었던 거예요.`,
            `임금이 그 앞으로 다가갔어요.`,
            `"자네는 어찌 예복도 없이 여기 들어왔는가?"`,
            `그 사람은 아무 대답도 하지 못했어요.`,
            `잔치에 초대받았다는 사실만 믿고, 정작 그 자리에 걸맞은 준비는 하지 않았던 거지요.`,
            `결국 그 사람은 잔치에서 쫓겨나고 말았답니다.`,
            `초대는 누구에게나 열려 있었어요.`,
    ...
    },
    {
        ...
        paras: [
            ...
            `밥을 먹으면서도 설계도를 들여다봤어요.`,
            `잠자리에 누워서도 곳간 생각뿐이었지요.`,
            `"기둥은 저기가 낫겠어. 문은 더 넓게."`,
            `이웃이 찾아와도 건성으로 대답했답니다.`,
            `"내년에는 더 많이 거두겠지. 그럼 하나 더 지어야 하나?"`,
            `그런데 바로 그날 밤이었어요.`,
            `부자는 갑자기 세상을 떠나고 말았답니다.`,
            `그 많던 곡식도, 새로 지은 곳간도, 부자가 그렇게 자랑스러워하던 모든 것이 하루아침에 그의 것이 아니게 되어 버렸어요.`,
            `부자는 평생을 곳간 채울 궁리만 했어요.`,
            `정작 그 재산을 나누거나 뜻있게 쓸 시간은 한 번도 만들지 않았지요.`,
            `굶는 이웃이 있어도 눈길을 준 적이 없었답니다.`,
            `사람들은 그 소식을 듣고 새로 지은 곳간을 올려다보았어요.`,
            `아직 페인트 냄새도 가시지 않은 곳간이었지요.`,
            `그러고는 씁쓸하게 되뇌었답니다.`,
