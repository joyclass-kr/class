        ...
        "beats": [
            {
                ...
                "emoji": "🦁",
                "left": [
                    "숲속 나라의 임금님은 사자 노블이었습니다. 갈기가 금빛으로 빛나는 사자였지요.",
                    "해마다 봄이 되면 큰 재판이 열렸습니다. 억울한 일이 있으면 누구나 말할 수 있었지요.",
                    "올해도 넓은 풀밭에 짐승들이 모였습니다. 작은 쥐부터 커다란 곰까지 빙 둘러앉았지요."
                ],
                "right": [
            ...
            },
            {
                ...
                "left": [
                    ...
                    "\"임금님, 제 말씀부터 들어 주십시오.\"",
                    "\"저 여우가 제 집 닭을 다 물어 갔습니다!\"",
                    "늑대는 앞발로 땅을 쿵쿵 굴렀습니다.",
                    "\"그것뿐이 아닙니다.\""
                ],
                "right": [
                    "\"제 새끼들 앞에서 저를 놀리기까지 했지요.\"",
                    "짐승들이 웅성거렸습니다. 임금님은 턱을 쓰다듬었지요.",
                    "\"흠, 또 그 여우로군.\"",
                    "\"올해도 나오지 않은 모양이구나.\""
                ]
            }
        ...
        "beats": [
            ...
            },
            {
                ...
                "left": [
                    ...
                    "임금님이 앞발을 크게 들었지요.",
                    "\"조용, 조용!\"",
                    "재판정이 겨우 잠잠해졌습니다. 임금님은 이맛살을 찌푸렸지요."
                ],
                "right": [
                    "\"본인 말도 들어 봐야 하지 않겠느냐.\"",
                    "\"그 여우를 당장 데려오너라.\"",
        ...
        "beats": [
            ...
            },
            {
                ...
                "left": [
                    "\"저 나무에 꿀이 가득한데요.\"",
                    "\"드시고 가시지요.\"",
                    "곰은 재판이고 뭐고 다 잊어버렸습니다. 침이 꿀떡 넘어갔지요. 커다란 나무에 틈이 갈라져 있었습니다.",
                    "곰은 그 틈에 머리부터 들이밀었지요."
                ],
                "right": [
                    "그런데 여우가 슬쩍 쐐기를 뽑았습니다. 틈이 딱 닫혔지요.",
                    "\"어이쿠! 이 여우 놈아!\"",
        ...
        "beats": [
            ...
            },
            {
                ...
                "left": [
                    ...
                    "그런데 문턱에 밧줄이 걸려 있었습니다. 올가미가 목에 척 걸렸지요.",
                    "\"야옹! 사람 살려!\""
                ],
                "right": [
                    "고양이는 대롱대롱 매달렸습니다. 농부가 몽둥이를 들고 달려 나왔지요. 여우는 그 소리를 뒤로하고 돌아섰습니다.",
                    "\"저런, 안됐군요.\"",
                    "그러고는 낮잠을 자러 갔지요. 헛간에서는 한참 소동이 났습니다."
                ]
            }
        ]
    },
        ...
        "beats": [
            {
                ...
                "right": [
                    ...
                    "오소리는 손을 저었습니다.",
                    "\"나한테는 안 통해.\"",
                    "\"르나르, 이번엔 정말 가야 해.\" 오소리가 진지하게 말했습니다."
                ]
            },
            {
                "art": "05-badger-2.png",
                ...
                "right": [
                    "\"가서 한번 이야기해 보지 뭐.\"",
                    "오소리는 마음이 놓였습니다.",
                    "그런데 여우의 눈이 반짝 빛났지요. 무슨 꿍꿍이가 있는 눈이었습니다. 오소리는 그것을 알아채지 못했지요.",
                    "두 짐승은 나란히 길을 나섰습니다."
                ]
            }
        ]
        ...
        "beats": [
            {
                ...
                "emoji": "⚖️",
                "left": [
                    "이튿날 여우가 재판정에 나타났습니다. 짐승들이 술렁였지요. 늑대가 이를 드러냈습니다.",
                    "곰도 고양이도 노려보았지요.",
                    "그런데 여우는 조금도 떨지 않았습니다. 오히려 아주 슬픈 얼굴을 했지요. 앞발을 가슴에 얹고 말했습니다."
                ],
                "right": [
                    "\"임금님, 저는 억울합니다.\"",
                    "\"저를 두고 온갖 말이 도는 모양인데요.\"",
                    "\"사실은 그렇지 않습니다.\"",
                    "임금님이 눈썹을 치켜올렸지요.",
                    "\"그럼 어찌 된 일이냐?\""
                ]
            },
            {
                ...
                "right": [
                    "\"거짓말이 술술 나오는구나!\"",
                    "여우는 눈 하나 깜짝하지 않았지요.",
                    "\"그자들이 숨겨 둔 보물도 제가 압니다.\"",
                    "보물이라는 말에 임금님의 귀가 쫑긋 섰지요.",
                    "\"보물이라고? 어디에 있느냐.\" 늑대의 말은 벌써 잊은 듯했지요."
                ]
            }
        ]
    },
        ...
        "beats": [
            {
                ...
                "left": [
                    ...
                    "\"동쪽 늪을 지나면 마른 우물이 있습니다.\"",
                    "\"그 밑에 금이 궤짝으로 묻혀 있지요.\"",
                    "\"제 아버지가 목숨 걸고 알아낸 것입니다.\"",
                    "임금님의 눈이 번쩍였습니다."
                ],
                "right": [
                    "\"당장 그리로 가 보아라!\"",
        ...
        "beats": [
            {
                ...
                "left": [
                    ...
                    "그런데 금은커녕 돌멩이 하나 없었지요. 마른 우물조차 찾지 못했습니다. 그제야 속은 것을 알았지요.",
                    "늑대가 씩씩거리며 돌아왔습니다. 온몸이 진흙투성이였지요."
                ],
                "right": [
                    "\"그 여우를 다시 잡아 옵시다!\"",
                    "\"이번에는 제가 벌을 내리겠습니다!\"",
            ...
            },
            {
                ...
                "emoji": "🍂",
                "left": [
                    "곰은 제 코를 만졌습니다. 고양이는 꼬리를 감췄지요.",
                    "오소리는 딴 데를 보았습니다. 지난번 일이 아직 생생했거든요.",
                    "재판정에 숨소리 하나 없었지요. 임금님은 헛기침을 했습니다."
                ],
                "right": [
                    "\"오늘은 이만 하자꾸나.\"",
                    "그러고는 재판을 끝냈지요. 짐승들은 하나둘 집으로 돌아갔습니다.",
                    "숲에는 낙엽만 사르르 떨어졌지요.",
...
const QUIZ = [
    ...
    {
        "q": "짐승들이 여우를 다시 잡으러 가지 않은 까닭은 무엇인가요?",
        "choices": [
            "또 당할까 봐 겁이 나서",
            "임금님이 막아서",
            "용서해서"
