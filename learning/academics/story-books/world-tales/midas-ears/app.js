        ...
        "beats": [
            {
                ...
                "emoji": "🙋",
                "left": [
                    "이제 심판이 결정을 내릴 차례였습니다.",
                    "심판은 그 산의 산신이었지요.",
                    "산신은 잠시 생각하더니 손을 들었습니다.",
                    "아폴론의 손이었지요.",
                    "\"하프가 더 훌륭하였소.\"",
                    "구경꾼들도 모두 고개를 끄덕였습니다."
                ],
        ...
        "beats": [
            {
                ...
                "left": [
                    "이튿날 아침이었습니다.",
                    "임금님은 늘 하던 대로 거울 앞에 앉았지요.",
                    "그런데 무언가 이상했습니다.",
                    "머리 위로 길쭉한 것이 솟아 있었지요.",
                    "임금님은 손을 뻗어 만져 보았습니다.",
                    "털이 보송보송했지요."
                ],
                "right": [
        ...
        "beats": [
            ...
            },
            {
                ...
                "left": [
                    ...
                    "\"예, 예! 절대로 말하지 않겠습니다!\"",
                    "이발사는 연방 고개를 조아렸지요.",
                    "손이 떨려 가위질도 제대로 못 했습니다.",
                    "겨우 머리를 깎고 밖으로 나왔지요."
                ],
                "right": [
                    "등에 식은땀이 흘렀습니다.",
                    "집으로 가는 길이 어찌나 먼지 몰랐지요.",
                    "그런데 그날 밤부터 이상했습니다.",
                    "입이 자꾸 근질근질했거든요.",
                    "그 말이 목구멍까지 올라왔지요.",
                    "이발사는 이불을 뒤집어썼습니다."
        ...
        "beats": [
            {
                ...
                "emoji": "🤐",
                "left": [
                    "이발사는 밥을 먹다가도 그 생각이 났습니다.",
                    "숟가락을 들면 귀가 떠올랐지요.",
                    "잠을 자려고 누우면 더 또렷해졌습니다.",
                    "\"말하고 싶다.\"",
                    "\"딱 한 번만 말하고 싶다.\"",
                    "이발사는 이불을 뒤집어썼지요."
                ],
