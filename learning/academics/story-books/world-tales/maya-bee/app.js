        ...
        "beats": [
            {
                ...
                "emoji": "🍯",
                "left": [
                    "커다란 나무 속에 벌집이 하나 있었습니다. 수천 마리 꿀벌이 사는 집이었지요.",
                    "방마다 육각형 칸이 촘촘히 붙어 있었습니다.",
                    "어느 날 그곳에서 어린 벌이 깨어났지요. 이름은 마야였습니다.",
                    "눈이 크고 호기심이 많은 벌이었지요. 선생님 벌 카산드라가 마야를 맡았습니다."
                ],
                "right": [
            ...
            },
            {
                ...
                "right": [
                    "하지만 속으로는 그렇지 않았지요.",
                    "오히려 더 궁금해졌거든요.",
                    "그날 밤 마야는 잠이 오지 않았습니다.",
                    "문틈으로 바람 냄새가 들어왔지요.",
                    "풀 냄새와 꽃 냄새가 섞여 있었습니다.",
                    "마야는 밤새 그 냄새를 맡았지요."
                ]
            }
        ]
        ...
        "beats": [
            {
                ...
                "left": [
                    "이튿날 아주 이른 아침이었습니다.",
                    "아직 아무도 일어나지 않았지요.",
                    "마야는 살그머니 벌집 문으로 갔습니다.",
                    "잠시 망설이다 밖으로 나갔지요.",
                    "그러고는 그대로 얼어붙었습니다.",
                    "눈앞에 들판이 끝없이 펼쳐져 있었거든요."
                ],
                "right": [
                    "꽃들이 마야의 몇 배나 컸습니다.",
                    "양귀비도 있고 수레국화도 있었지요.",
        ...
        "beats": [
            {
                ...
                "right": [
                    ...
                    "페피는 말하는 중에도 세 번이나 뛰었지요.",
                    "한 번 뛸 때마다 풀잎이 크게 흔들렸습니다."
                ]
            },
            {
                ...
                "right": [
                    ...
                    "\"돌아가는 길도 모르는데?\"",
                    "\"응, 그래도 괜찮아.\"",
                    "페피는 어이없다는 듯 고개를 저었지요. 그러고는 훌쩍 뛰어 사라졌습니다.",
                    "마야는 그 뒷모습을 오래 보았지요."
                ]
            }
        ]
        ...
        "beats": [
            {
                ...
                "left": [
                    "며칠이 지났습니다.",
                    "마야는 낡은 나무 곁을 지나고 있었지요.",
                    "나무에 커다란 구멍이 뚫려 있었습니다.",
                    "그 안에서 낮은 소리가 들렸지요.",
                    "마야는 나무껍질에 몸을 붙였습니다.",
                    "안을 들여다보니 말벌들이 모여 있었지요."
                ],
                "right": [
                    "몸집이 꿀벌의 몇 배나 되었습니다.",
                    "무언가를 의논하는 중이었지요.",
            ...
            },
            {
                ...
                "left": [
                    ...
                    "그러고는 있는 힘껏 날았지요.",
                    "날개가 부러질 것 같았습니다.",
                    "그런데 어느 쪽으로 가야 할지 몰랐지요.",
                    "마야는 높이 올라가 둘레를 살폈습니다."
                ],
                "right": [
                    "저 멀리 낯익은 나무가 보였지요.",
                    "해가 뉘엿뉘엿 지고 있었습니다.",
