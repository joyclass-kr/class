        ...
        "beats": [
            {
                ...
                "left": [
                    "어느 아이가 생일 선물을 받았습니다.",
                    "기다란 상자 하나였지요.",
                    "뚜껑을 열자 장난감 병정이 가득했습니다.",
                    "모두 스물다섯이었지요.",
                    "주석을 녹여 만든 병정들이었습니다.",
                    "옛날 숟가락 하나로 만든 형제들이었지요."
                ],
                "right": [
                    "푸른 웃옷에 붉은 바지를 입고 있었습니다.",
                    "어깨에는 총을 척 메고 있었지요.",
                    "아이는 병정들을 탁자에 죽 세웠습니다.",
                    "그런데 마지막 하나가 좀 달랐지요.",
                    "다리가 한쪽뿐이었던 것입니다.",
                    "\"어? 이 병정은 왜 이래?\""
                ]
        ...
        "beats": [
            {
                ...
                "emoji": "💃",
                "left": [
                    "탁자 저편에 종이로 만든 성이 있었습니다.",
                    "창문마다 얇은 종이가 발려 있었지요.",
                    "성 앞에는 작은 호수도 만들어 두었습니다.",
                    "거울 조각으로 만든 호수였지요.",
                    "그 앞에 종이 무희가 서 있었습니다.",
                    "하얀 치마가 나풀나풀했지요."
                ],
                "right": [
                    "어깨에는 파란 띠를 둘렀습니다.",
                    "허리에는 반짝이가 하나 달려 있었지요.",
                    "무희는 한 발로 사뿐히 서 있었습니다.",
                    "병정은 그 모습에서 눈을 뗄 수 없었지요.",
                    "가슴이 이상하게 두근거렸습니다.",
                    "이런 마음은 처음이었지요."
                ]
            },
            {
                ...
                "left": [
                    ...
                    "\"저 아이도 다리가 하나구나.\"",
                    "\"나와 똑같네.\"",
                    "사실은 그렇지 않았지요. 무희는 다른 쪽 다리를 높이 들고 있을 뿐이었습니다.",
                    "병정은 그것을 알지 못했지요."
                ],
                "right": [
        ...
        "beats": [
            ...
            },
            {
                ...
                "left": [
                    ...
                    "창문이 활짝 열려 있었습니다.",
                    "병정은 바깥 거리를 내려다보았지요.",
                    "그런데 갑자기 바람이 세게 불었습니다.",
                    "병정은 그대로 창밖으로 굴러떨어졌지요."
                ],
                "right": [
                    "삼 층 아래로 떨어졌습니다.",
                    "길바닥에 총이 먼저 꽂혔지요.",
                    "병정은 총을 짚은 채 거꾸로 박혔습니다.",
        ...
        "beats": [
            ...
            },
            {
                ...
                "right": [
                    ...
                    "\"나는 병정이니까.\"",
                    "아이들의 목소리가 점점 멀어졌지요.",
                    "이윽고 아무 소리도 들리지 않았습니다.",
                    "앞쪽에 컴컴한 구멍이 보였지요.",
                    "물이 그리로 빨려 들어가고 있었습니다."
                ]
            }
        ]
    },
        ...
        "beats": [
            {
                ...
                "right": [
                    ...
                    "\"통행세 없이는 못 지나간다!\"",
                    "병정은 대답 대신 총을 꽉 쥐었지요.",
                    "배는 쥐를 지나쳐 쏜살같이 떠내려갔습니다.",
                    "쥐가 물속으로 뛰어들어 뒤를 쫓았지요."
                ]
            },
            {
                "art": "05-tunnel-2.png",
        ...
        "beats": [
            {
                ...
                "emoji": "🐟",
                "left": [
                    "종이배는 물을 먹고 스르르 가라앉았습니다.",
                    "병정도 함께 물속으로 잠겼지요.",
                    "푸른 물이 사방을 감쌌습니다.",
                    "병정은 아래로 아래로 내려갔지요.",
                    "그때 앞이 갑자기 캄캄해졌습니다.",
                    "커다란 물고기가 입을 쩍 벌린 것이었지요."
                ],
                "right": [
                    "병정은 그대로 뱃속으로 들어갔습니다.",
                    "안은 굴속보다도 캄캄했지요.",
        ...
        "beats": [
            {
                ...
                "right": [
                    "병정이 살던 바로 그 집이었습니다.",
                    "창밖으로 떨어졌던 그 창문도 그대로였지요.",
                    "아이가 달려와 병정을 받아 들었습니다.",
                    "\"내 병정이잖아! 어디 갔었어?\"",
                    "아이는 병정을 탁자 위에 올려놓았지요.",
                    "형제 병정들 옆자리였습니다."
                ]
            },
            {
                ...
                "left": [
                    ...
                    "종이 성도 그 자리에 있었습니다.",
                    "그 앞에 종이 무희가 서 있었지요.",
                    "여전히 한 발로 사뿐히 서 있었습니다.",
                    "병정은 가슴이 뜨거워졌지요."
                ],
                "right": [
                    "먼 길을 돌아 다시 만난 것이었습니다.",
                    "하지만 아무 말도 하지 못했지요.",
                    "병정은 그저 무희를 바라보았습니다.",
                    "무희도 병정 쪽을 보는 것 같았지요.",
                    "치맛자락이 조금 흔들렸습니다.",
