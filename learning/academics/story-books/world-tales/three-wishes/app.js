    ...
    },
    {
        ...
        "beats": [
            ...
            },
            {
                ...
                "left": [
                    "아내가 두 눈을 아래로 내리떴습니다.",
                    "코끝에 소시지가 대롱대롱 달려 있었지요.",
                    "\"아이고! 이게 무슨 꼴이에요!\"",
                    "아내는 두 손으로 소시지를 잡아당겼습니다.",
                    "하지만 꿈쩍도 하지 않았지요.",
                    "나무꾼도 얼른 달려들었습니다."
                ],
                "right": [
                    "두 사람이 함께 끙끙거렸지요.",
                    "아내는 뒤로, 나무꾼은 앞으로 당겼습니다.",
                    "의자가 넘어지고 그릇이 굴렀지요.",
                    "그래도 소시지는 그대로였습니다.",
                    "오히려 코만 벌겋게 부었지요.",
                    "아내는 그만 울음을 터뜨렸습니다."
        ...
        "beats": [
            {
                ...
                "right": [
                    "나무꾼은 아내의 얼굴을 물끄러미 보았지요.",
                    "코끝에 소시지가 달린 얼굴이었습니다.",
                    "평생 저러고 살 것을 생각하니 마음이 아팠지요.",
                    "큰 집이 다 무슨 소용인가 싶었습니다.",
                    "\"그건 안 되지.\""
                ]
            },
            {
    ...
    },
    {
        ...
        "beats": [
            ...
            },
            {
                ...
                "emoji": "🥣",
                "left": [
                    "집도 그대로였고 살림도 그대로였습니다.",
                    "밥상에는 묽은 죽 두 그릇뿐이었지요.",
                    "두 사람은 상 앞에 앉았습니다.",
                    "그런데 이상한 일이었지요.",
                    "밥상이 어쩐지 푸짐하게 느껴졌습니다.",
                    "접시에는 소시지가 그대로 있었으니까요."
                ],
                "right": [
                    "아내가 그것을 반으로 잘랐습니다.",
                    "\"자, 반씩 먹어요.\"",
                    "두 사람은 소시지를 나누어 먹었지요.",
                    "먹다가 서로를 보고 웃음이 터졌습니다.",
