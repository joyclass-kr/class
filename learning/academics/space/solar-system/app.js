    ...
    function boot() {
        ...
        function loadNewQuizQuestion() {
            ...
            var quizPool = [
                ...
                { cat: "태양의 에너지원", q: "태양이 오랫동안 빛과 열을 내는 주된 에너지원은?", ans: "중심부의 수소 핵융합", opts: ["중심부의 수소 핵융합", "표면의 석탄 연소", "행성 충돌", "태양의 공전 운동"], exp: "태양 중심부에서는 수소 원자핵이 헬륨 원자핵으로 융합하며 질량 일부가 막대한 에너지로 전환됩니다." },
                { cat: "행성의 공전 방향", q: "태양의 북극 쪽에서 내려다볼 때 대부분의 행성이 태양 주위를 공전하는 방향은?", ans: "시계 반대 방향", opts: ["시계 반대 방향", "시계 방향", "행성마다 무작위", "공전하지 않음"], exp: "대부분의 행성은 태양 자전과 같은 방향인 시계 반대 방향으로 공전합니다." },
                { cat: "행성의 공전 궤도", q: "행성의 공전 궤도와 태양의 위치를 바르게 설명한 것은?", ans: "타원 궤도이며 태양은 한 초점에 있다.", opts: ["타원 궤도이며 태양은 한 초점에 있다.", "완전한 원이며 태양은 항상 중심에 있다.", "직선 궤도이며 태양은 끝에 있다.", "나선 궤도이며 태양은 바깥에 있다."], exp: "행성은 태양을 한 초점으로 하는 타원 궤도를 따라 공전합니다. 실제 행성 궤도는 원에 가까운 경우가 많지만 완전한 원은 아닙니다." },
                { cat: "공전 속도", q: "한 행성이 타원 궤도에서 태양에 가까워질 때 공전 속도는 어떻게 변하는가?", ans: "빨라진다.", opts: ["빨라진다.", "느려진다.", "항상 멈춘다.", "거리와 관계없이 완전히 같다."], exp: "행성은 태양에 가까운 구간에서 더 빠르게, 먼 구간에서 더 느리게 움직입니다." },
                { cat: "공전 주기", q: "같은 시간 동안 지구보다 해왕성이 공전 궤도를 따라 움직인 각도가 훨씬 작은 까닭은?", ans: "해왕성의 공전 주기가 훨씬 길기 때문에", opts: ["해왕성의 공전 주기가 훨씬 길기 때문에", "해왕성이 자전하지 않기 때문에", "지구가 태양계 중심이기 때문에", "해왕성에는 위성이 있기 때문에"], exp: "태양에서 먼 해왕성은 공전 궤도가 크고 공전 주기가 매우 길어 같은 시간 동안 진행하는 공전 각도가 작습니다." },
                { cat: "지구형·목성형 분포", q: "지구형 행성과 목성형 행성의 태양계 내 분포로 옳은 것은?", ans: "지구형은 안쪽, 목성형은 바깥쪽에 주로 있다.", opts: ["지구형은 안쪽, 목성형은 바깥쪽에 주로 있다.", "목성형은 안쪽, 지구형은 바깥쪽에 주로 있다.", "두 종류가 완전히 번갈아 배치된다.", "분포에는 아무 경향이 없다."], exp: "수성부터 화성까지의 지구형 행성은 태양계 안쪽에, 목성부터 해왕성까지의 목성형 행성은 바깥쪽에 있습니다." },
                ...
                { cat: "금성", q: "금성의 표면 온도가 수성보다도 높은 주된 이유는?", ans: "두꺼운 이산화탄소 대기의 강한 온실 효과", opts: ["두꺼운 이산화탄소 대기의 강한 온실 효과", "태양에서 가장 가까워서", "표면에 불이 타고 있어서", "위성이 열을 공급해서"], exp: "금성은 두꺼운 이산화탄소 대기가 강한 온실 효과를 일으켜 표면 온도가 매우 높습니다." },
                { cat: "지구", q: "현재 지구가 생명체가 존재하는 것으로 확인된 유일한 행성인 조건과 가장 관련 깊은 것은?", ans: "액체 상태의 물과 적절한 대기·온도", opts: ["액체 상태의 물과 적절한 대기·온도", "가장 큰 행성이라는 점", "태양에서 가장 가깝다는 점", "고리가 가장 뚜렷하다는 점"], exp: "지구는 액체 상태의 물이 안정적으로 존재하고 생명 활동에 적합한 온도와 대기를 갖추고 있습니다." },
                { cat: "화성", q: "화성에서도 계절 변화가 나타나는 주된 까닭은?", ans: "자전축이 기울어진 채 태양을 공전하기 때문에", opts: ["자전축이 기울어진 채 태양을 공전하기 때문에", "태양 주위를 공전하지 않기 때문에", "위성이 두 개이기 때문에", "표면의 산화 철 때문에"], exp: "화성도 자전축이 기울어진 채 태양을 공전하므로 계절 변화가 나타납니다." },
                { cat: "내행성 관측", q: "수성과 금성이 태양에서 매우 멀리 떨어진 한밤중 하늘에 보이지 않는 까닭은?", ans: "지구보다 안쪽 궤도를 돌아 태양에서 보이는 각거리가 제한되기 때문에", opts: ["지구보다 안쪽 궤도를 돌아 태양에서 보이는 각거리가 제한되기 때문에", "스스로 빛을 내지 못해서", "밤에는 공전을 멈추기 때문에", "지구 그림자 속에 항상 들어가기 때문에"], exp: "내행성은 지구 궤도 안쪽에서 태양을 공전하므로 하늘에서 태양과 일정 각도 이상 멀어질 수 없습니다." },
                { cat: "외행성 관측", q: "외행성이 충에 있을 때의 관측 특징으로 옳은 것은?", ans: "해 질 무렵 떠서 자정 무렵 남중하고 해 뜰 무렵 진다.", opts: ["해 질 무렵 떠서 자정 무렵 남중하고 해 뜰 무렵 진다.", "태양과 함께 떠서 함께 진다.", "정오에만 남중한다.", "항상 북쪽 하늘에만 보인다."], exp: "충에서는 외행성이 태양 반대 방향에 있어 해 질 무렵 떠서 밤새 보이며 자정 무렵 남중합니다." },
                { cat: "행성의 역행", q: "외행성이 별 사이에서 잠시 평소와 반대 방향으로 움직이는 것처럼 보이는 주된 까닭은?", ans: "공전 속도가 더 빠른 지구가 외행성을 앞질러 가기 때문에", opts: ["공전 속도가 더 빠른 지구가 외행성을 앞질러 가기 때문에", "외행성이 실제로 공전 방향을 바꾸기 때문에", "지구의 자전이 멈추기 때문에", "태양이 외행성을 뒤로 밀기 때문에"], exp: "외행성의 역행은 지구와 외행성의 상대적인 공전 운동 때문에 나타나는 겉보기 현상입니다." },
                { cat: "왜소행성", q: "행성과 왜소행성을 구분하는 핵심 조건은?", ans: "공전 궤도 주변을 지배적으로 정리했는가", opts: ["공전 궤도 주변을 지배적으로 정리했는가", "위성이 반드시 있는가", "고리가 있는가", "표면에 대기가 있는가"], exp: "둘 다 태양을 공전하고 자체 중력으로 거의 둥글 수 있지만, 행성은 궤도 주변을 지배적으로 정리했다는 조건을 만족해야 합니다." },
                { cat: "소행성과 혜성", q: "소행성과 혜성의 일반적인 구성 차이를 바르게 설명한 것은?", ans: "소행성은 주로 암석·금속, 혜성은 얼음·먼지 성분이 많다.", opts: ["소행성은 주로 암석·금속, 혜성은 얼음·먼지 성분이 많다.", "소행성은 모두 기체, 혜성은 모두 액체이다.", "둘은 구성과 활동이 완전히 같다.", "혜성은 별이고 소행성은 행성이다."], exp: "소행성은 대체로 암석과 금속 성분이 많고, 혜성은 얼음과 먼지가 많아 태양에 가까워지면 코마와 꼬리가 발달합니다." },
                { cat: "혜성 꼬리", q: "혜성의 이온 꼬리와 먼지 꼬리를 비교한 설명으로 옳은 것은?", ans: "이온 꼬리는 더 곧고, 먼지 꼬리는 더 휘어질 수 있다.", opts: ["이온 꼬리는 더 곧고, 먼지 꼬리는 더 휘어질 수 있다.", "먼지 꼬리만 태양 반대 방향이다.", "두 꼬리는 항상 혜성 진행 방향 뒤쪽이다.", "이온 꼬리는 암석 덩어리 하나로 이루어진다."], exp: "이온 꼬리는 태양풍을 따라 비교적 곧게 뻗고, 먼지 꼬리는 방출된 입자의 궤도 운동 때문에 넓고 휘어진 모양이 될 수 있습니다." },
                { cat: "혜성 꼬리", q: "혜성이 태양을 돌아 진행 방향이 바뀌어도 꼬리가 태양 반대쪽을 향하는 까닭은?", ans: "태양풍과 태양 복사압이 물질을 밀어내기 때문에", opts: ["태양풍과 태양 복사압이 물질을 밀어내기 때문에", "꼬리가 항상 혜성의 과거 궤도에 남기 때문에", "혜성의 중력이 태양보다 강하기 때문에", "지구의 대기가 꼬리를 밀기 때문에"], exp: "혜성 꼬리의 방향은 단순히 이동 방향의 뒤가 아니라 태양풍과 복사압에 의해 정해져 항상 태양의 반대쪽을 향합니다." },
                { cat: "유성체·유성·운석", q: "우주 공간의 작은 암석 조각, 대기에서 빛나는 현상, 지표에 도달한 잔해의 순서는?", ans: "유성체→유성→운석", opts: ["유성체→유성→운석", "유성→유성체→운석", "운석→혜성→유성", "소행성→위성→행성"], exp: "우주 공간에서는 유성체, 대기권에서 빛나는 현상은 유성, 타다 남아 지표에 도달한 물질은 운석입니다." },
                { cat: "태양계 형성", q: "소행성·혜성 같은 태양계 소천체를 연구하는 중요한 까닭은?", ans: "태양계 형성 초기의 물질과 환경 정보를 간직하기 때문에", opts: ["태양계 형성 초기의 물질과 환경 정보를 간직하기 때문에", "모두 곧 지구와 충돌하기 때문에", "스스로 핵융합을 하기 때문에", "은하 중심을 공전하지 않기 때문에"], exp: "작은 천체들은 행성 형성 과정에서 남은 비교적 원시적인 물질을 간직해 태양계의 기원을 연구하는 단서가 됩니다." },
