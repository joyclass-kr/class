...
window.SOLAR_SYSTEM_DATA = {
    ...
    mercury: {
        ...
        desc: '태양에서 가장 가깝고 가장 작은 지구형 행성입니다. 대기가 없어 낮과 밤의 온도 차이가 600°C 이상입니다.',
        satExamKeyPoints: [
            ...
            '❄️ 대기의 보온 효과(온실효과)가 없어 태양계 행성 중 낮과 밤의 일교차가 가장 큼'
        ],
    ...
    earth: {
        ...
        satExamKeyPoints: [
            ...
            '🌍 평균 밀도가 5.51g/cm³로 태양계 전체 천체 중 밀도가 가장 높음'
        ],
    ...
    mars: {
        ...
        satExamKeyPoints: [
            ...
            '🌋 태양계 최대 화산인 올림푸스 화산(높이 25km)과 거대한 말리네리스 계곡 존재'
        ],
    ...
    jupiter: {
        ...
        satExamKeyPoints: [
            ...
            '🪐 갈릴레이 4대 위성(이오, 유로파, 가니메데, 칼리스토) 및 희미한 암석 고리 보유'
        ],
