    ...
    window.POETRY_WRAP_QUESTIONS = [
        ...
        },
        {
            ...
            "choices": [
                ...
                "「규원가」는 남자 신하가 여인의 말투를 빌린 노래고, 「사미인곡」은 여인이 여인으로서 쓴 노래예요",
                "「규원가」는 임금을 향한 마음을 담은 노래고, 「사미인곡」은 떠난 남편을 원망하는 노래예요"
            ],
        ...
        },
        {
            ...
            "choices": [
                "김광균은 그림 같은 장면으로 마음을 대신하고, 유치환은 의지를 곧장 말해요",
                "김광균은 의지를 곧장 말하고, 유치환은 그림 같은 장면으로 마음을 대신해요",
                "김광균은 시골 들판을 그리고, 유치환은 도시의 밤거리를 그려요"
            ],
            "answer": "김광균은 그림 같은 장면으로 마음을 대신하고, 유치환은 의지를 곧장 말해요",
