  ...
  function renderAnswerPanel() {
    return (
      <div className="trig-derivative-answer-panel-backdrop" onClick={() => setAnswerPanelOpen(false)}>
          <aside className="trig-derivative-answer-panel worksheet-choice-modal" aria-label="분수식의 계산 답안 입력" onClick={(event) => event.stopPropagation()}>
          <header>
            ...
            {problems.map((problem, index) => {
              ...
              return (
                  ...
                  <div className="trig-derivative-answer-item-heading">
                    ...
                    <div className="trig-derivative-answer-question"><MathFormula latex={expressionLatex(problem.operations)} display /></div>
  ...
  function renderSheet(answerSheet: boolean) {
    return (
      <div className={`a4-sheet counting-sheet polynomial-sheet rational-sheet polynomial-sheet-${problems.length}`} style={{ transform: `scale(${sheetScale})` }}>
        ...
        <div className="polynomial-instruction"><b>인수분해하고 빈 공간에 약분 과정을 쓰세요.</b><span>답안 입력에서 4지선다 채점</span></div>
