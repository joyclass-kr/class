        ...
        beats: [
            {
                ...
                right: [
                    ...
                    "\"밭에서 요술 항아리를 캤다지 뭔가.\"",
                    "소문은 금세 온 마을에 쫙 퍼졌답니다.",
                    "손바닥으로 하늘을 가릴 수는 없는 일이었지요."
                ]
            },
            {
                art: "05-seize.webp",
            ...
            },
            {
                ...
                emoji: "💰",
                left: [
                    "부자는 방문을 걸어 잠그고 항아리 앞에 딱 앉았습니다.",
                    "식구한테도 아무도 못 보게 하려는 것이었어요.",
                    "이번에는 엽전 따위를 넣지 않았어요.",
                    "금붙이 하나를 넣고 꺼내 보니 두 개.",
                    "부자는 두 손을 부들부들 떨었지요."
                ],
                right: [
                    "또 꺼내니 세 개.",
        ...
        beats: [
            {
                ...
                emoji: "👴",
                left: [
                    "그때 늙은 아버지가 문틈으로 안을 기웃거렸어요.",
                    "아들 방에서 밤새 이상한 소리가 났거든요.",
                    "\"얘야, 대체 무얼 하느냐?\"",
                    "\"아버지는 저리 가 계세요!\"",
...
const QUIZ = [
    { q: "농부가 항아리에 처음 빠뜨린 것은 무엇인가요?", choices: ["엽전", "호미", "금붙이"], answer: 1 },
