const CHAPTERS = [
    {
        ...
        beats: [
            ...
            },
            {
                ...
                right: [
                    "느티나무 껍질을 벗겨다 어머니 밥을 지었고, 얻은 밥이 있으면 어머니 몫부터 덜어 두었습니다.",
                    "어머니 손에 밥그릇을 쥐여 드렸어요.",
                    "\"저 사람, 바보는 바보인데 참 착하지.\"",
                    "\"저 정도로 착한 사람이 어디 있나.\""
                ]
            },
            {
                ...
                right: [
                    "하루에도 몇 번씩 앙— 하고 울었습니다. 궁녀들이 달래도 소용이 없었어요. 임금은 귀를 막고 도망 다녔지요.",
                    "온 궁궐이 그 울음소리에 시달렸지요.",
                    "누구도 공주를 달래지 못했답니다."
                ]
            },
            {
                ...
                left: [
                    ...
                    "임금이 두 손으로 귀를 막으며 소리쳤어요.",
                    "농담 삼아 던진 말이었지요.",
                    "그러면 공주는 울음을 뚝 그쳤지요."
                ],
                right: [
                    "그 말이 어찌나 자주 나왔는지 몰라요. 울 때마다, 떼쓸 때마다.",
                    "공주가 아주 어릴 적부터 들은 말이었지요.",
                    "공주는 그 이름을 똑똑히 기억해 두었답니다. 언젠가 그 사람을 보고 싶었거든요."
                ]
            },
            {
                art: "05-sixteen.webp",
        ...
        beats: [
            ...
            },
            {
                ...
                left: [
                    ...
                    "궁 밖에 나온 것은 그날이 처음이었어요.",
                    "길이 어찌나 먼지 발이 다 부르텄지요."
                ],
                right: [
                    "사람들에게 물어물어 산 밑 오두막을 찾아갔지요. 다 쓰러져 가는 집이었습니다. 지붕에 풀이 자라 있었어요.",
                    "공주는 한참을 문 앞에 서 있었어요.",
                    "망설인 것이 아니라 마음을 다잡은 것이었지요."
                ]
            },
            {
                art: "08-refuse.webp",
            ...
            },
            {
                ...
                right: [
                    ...
                    "공주가 말의 목을 쓰다듬으며 말했어요.",
                    "몇 달이 지나자 말은 몰라보게 달라졌어요. 털에서 윤이 흐르고 눈에 힘이 돌았답니다.",
                    "온달의 눈이 휘둥그레졌답니다."
                ]
            }
        ]
        ...
        beats: [
            ...
            },
            {
                ...
                left: [
                    ...
                    "해마다 열리는 큰 잔치였어요.",
                    "임금과 온 나라 무사들이 말을 달렸지요.",
                    "말발굽 소리가 언덕을 울렸지요."
                ],
                right: [
                    "그 틈에 낯선 젊은이 하나가 끼어 있었습니다. 누구도 눈여겨보지 않았어요.",
                    "옷도 말도 초라해 보였거든요.",
            ...
            },
            {
                ...
                right: [
                    "\"과연 내 사위로다!\"",
                    "임금이 온달의 어깨를 잡았어요.",
                    "온달은 그날로 벼슬을 받았지요. 언덕 아래에서 공주가 그 모습을 보고 있었답니다.",
                    "공주의 눈에 눈물이 맺혔지요."
                ]
            },
            {
                ...
                left: [
                    ...
                    "말은 화살처럼 달렸어요.",
                    "온달이 가는 곳마다 이겼지요.",
                    "사람들은 더 이상 바보 온달이라 부르지 않았습니다."
                ],
                right: [
                    "온달 장군이라 불렀어요. 그래도 온달은 예전처럼 씩 웃기만 했답니다.",
                    "아이들도 이제는 온달을 우러러보았어요.",
                    "\"저는 그대로인데요.\""
                ]
            },
            {
    ...
    return `
        <div class="page page-cover">
            ...
            <div class="story-page-right">
                <h1>바보 온달과 평강 공주</h1>
                <p>온달과 평강 공주 이야기는 삼국사기 열전에 실려 전해져요. 고구려 평원왕 때 실제로 있었던 사람들의 이야기랍니다.</p>
                <p>삼국사기 열전은 임금이 아닌 사람들의 일생을 모아 놓은 부분이에요. 온달은 그 안에서도 가장 많이 읽히는 인물이지요.</p>
                <p>고구려에는 삼월 삼짇날에 낙랑 언덕에서 사냥 대회를 여는 풍습이 있었어요. 임금과 신하들이 함께 말을 달려 잡은 짐승으로 하늘에 제사를 지냈답니다.</p>
                <p>충청북도 단양에는 온달산성이라 불리는 옛 성이 남아 있어요. 온달이 신라와 싸우던 자리로 전해지는 곳이랍니다.</p>
                ${coverToc()}
            </div>
        </div>`;
}
...
const QUIZ = [
    ...
    { q: "임금이 우는 공주에게 한 말은 무엇인가요?", choices: ["궁 밖으로 내보내겠다", "말을 타게 하겠다", "온달에게 시집보내겠다"], answer: 2 },
    { q: "공주가 궁을 나올 때 가져온 것은 무엇인가요?", choices: ["금팔찌 몇 개", "비단옷 한 벌", "책 한 상자"], answer: 0 },
    { q: "공주가 온달에게 사 오게 한 말은 어떤 말인가요?", choices: ["장에서 가장 값비싼 말", "새끼를 밴 튼튼한 암말", "나라에서 내다 판 여윈 말"], answer: 2 },
