    ...
    },
    {
        ...
        beats: [
            ...
            },
            {
                ...
                emoji: "🔥",
                left: [
                    "하인이 그제야 지난밤에 들은 이야기를 다 털어놓았어요.",
                    "우물 이야기부터 딸기밭 이야기까지요.",
                    "도련님은 한참을 말이 없었습니다. 그제야 모든 것을 알았거든요.",
...
const QUIZ = [
    { q: "도련님은 들은 이야기를 몇 사람에게 들려주었나요?", choices: ["만나는 사람마다", "한 사람도 없었다", "사랑방 어른들에게"], answer: 1 },
    ...
    { q: "하인은 첫 번째로 무엇을 막았나요?", choices: ["딸기를 따 오는 것", "우물물을 마시는 것", "신방에 들어가는 것"], answer: 1 },
