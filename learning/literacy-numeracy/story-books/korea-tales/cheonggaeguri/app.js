...
const QUIZ = [
    ...
    { q: "비가 오면 청개구리는 왜 우나요?", choices: ["비를 싫어해서", "무덤이 걱정돼서", "배가 고파서"], answer: 1 },
    {
        ...
        wide: true,
        choices: [
            "엄마가 개울가에 묻어 달라고 한 것을 보면, 아들을 못 믿은 것이 아니라 너무 잘 안 것이구나.",
            "아들이 처음으로 엄마 말대로 한 날이 하필 엄마가 떠난 뒤였던 것을 보면, 뒤늦게 아는 일도 있구나.",
            "돌을 하나하나 옮겨 무덤을 쌓은 것을 보면, 뉘우침은 말이 아니라 손으로 하는 것이구나.",
            "동네 개구리들이 아들의 우는 소리를 따라 하며 놀아 준 것을 보면, 그래도 동무는 있었구나."
        ],
        answer: 3
    }
];
