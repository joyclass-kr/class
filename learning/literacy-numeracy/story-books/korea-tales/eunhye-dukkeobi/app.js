...
const COVER = {
    ...
    intro: [
        ...
        "이야기에 나오는 지네는 실제 벌레보다 훨씬 크고 무서운 존재로 그려져요. 옛이야기에서 지네는 오래 묵어 이상한 힘을 얻은 짐승으로 자주 나오는데, 두꺼비와 지네가 서로 맞서는 짜임은 우리나라 여러 고장에서 똑같이 전한답니다."
    ]
};
...
const WORDS_KO = {
    "cover": [
        ...
        { w: "묵다", k: "오랜 세월이 지나다.", s: "지네는 오래 묵어 이상한 힘을 얻은 짐승으로 자주 나오는데" },
        { w: "맞서다", k: "마주 서서 겨루다.", s: "두꺼비와 지네가 서로 맞서는 짜임은" }
    ],
    "01-girl.webp": [
