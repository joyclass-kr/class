        ...
        beats: [
            ...
            },
            {
                ...
                left: [
                    ...
                    "노인이 아들의 팔을 붙잡았어요.",
                    "\"어머니가 저기 계신데요.\"",
                    "아들은 짚신 몇 켤레를 허리에 매달고 길을 나섰습니다.",
                    "아들은 조금도 흔들리지 않았지요."
                ],
                right: [
                    "해가 지는 쪽으로, 깃털이 날아온 쪽으로요.",
                    "그 짚신이 다 닳도록 걸을 참이었지요.",
        ...
        beats: [
            {
                ...
                left: [
                    ...
                    "바위가 미끄럽고 손끝이 찢어졌어요. 아들은 이를 악물고 올라갔지요.",
...
const QUIZ = [
    ...
    { q: "아들이 뒷산에서 주워 든 것은 무엇인가요?", choices: ["부러진 나뭇가지", "시커먼 깃털 하나", "짚신 한 켤레"], answer: 1 },
    { q: "아들은 할머니를 어떻게 도왔나요?", choices: ["빨래를 밟아 주었다", "밭 하나를 다 매 주었다", "짚신을 삼아 주었다"], answer: 0 },
