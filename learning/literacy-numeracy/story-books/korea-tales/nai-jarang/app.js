    ...
    return `
        <div class="page page-cover">
            ...
            <div class="story-page-right">
                ...
                <p>두꺼비는 우리 옛이야기에 자주 나오는 짐승이에요. 크지도 빠르지도 않고 생김새도 볼품없지만, 옛사람들은 두꺼비를 미련하게 그리지 않았어요. 오히려 진득하니 앉아 무언가를 알고 있는 쪽으로 그렸지요.</p>
                ${coverToc()}
            </div>
        </div>`;
}
...
const QUIZ = [
    ...
    { q: "두꺼비가 심은 세 번째 나무는 무엇이 되었나요?", choices: ["별 박는 망치 자루", "하늘의 큰 기둥", "해를 매단 장대"], answer: 0 },
    {
        ...
        choices: [
            ...
            "두꺼비가 다투지 않고 울음부터 터뜨린 것을 보면, 소리 지르는 쪽만 이기는 것은 아니구나.",
            "정말 그 나무를 심었는지 아무도 모른다고 한 것을 보면, 이야기가 두꺼비 편만 들지는 않는구나.",
            "두꺼비가 나무 세 그루를 심은 것을 보면, 셋 중에 제일 오래 산 것이 틀림없구나."
        ],
        answer: 3
    }
];
