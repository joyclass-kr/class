    ...
    return `
        <div class="page page-cover">
            ...
            <div class="story-page-right">
                ...
                <p>마을 어귀의 큰 느티나무는 옛날 우리 마을마다 있던 것이에요. 정자나무라고 불렀지요. 여름이면 그 아래에 돗자리를 깔고 사람들이 모여 쉬고, 이야기하고, 낮잠을 잤어요. 나무 한 그루가 마을의 사랑방 노릇을 한 셈이랍니다.</p>
...
const QUIZ = [
    ...
    { q: "나그네는 마지막에 뭐라고 했나요?", choices: ["돈을 곱절로 돌려받겠다고", "온 마을의 것이라고", "이제 제 것이니 팔겠다고"], answer: 1 },
    {
        ...
        choices: [
            ...
            "나그네가 돈을 도로 놓고 떠난 것을 보면, 처음부터 돈을 벌 생각이 아니었구나.",
            "이듬해 여름에 부자도 돗자리 한쪽에 앉아 있었다는 것을 보면, 사람은 이렇게도 달라지는구나.",
            "부자가 곱절로 물러 달라고 하자 나그네가 그러자고 한 것을 보면, 셈은 셈대로 밝은 사람이구나."
        ],
        answer: 3
    }
];
