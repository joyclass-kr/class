...
THE SNAKE IS ONE UNBROKEN BODY: a single continuous line from head to tail. The
coils around the man must join up with the rest of the body — no detached
segment, no gap. ONE NECK, not two strands, and ONE clearly drawn head.
On the left, the paper door glows faint blue with moonlight. Keep the snake decorative and rounded, not
