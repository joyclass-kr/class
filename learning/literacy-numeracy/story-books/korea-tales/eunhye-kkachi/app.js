        ...
        beats: [
            {
                ...
                right: [
                    "산 위 빈 절에서는 구렁이가 종 아래에 똬리를 틀고 있었어요.",
...
const QUIZ = [
    { q: "선비가 과거에 붙어야 한다고 한 까닭은 무엇인가요?", choices: ["아버지에게 활을 물려받으려고", "어머니께 면목이 서려고", "산길에서 밤을 새우지 않으려고"], answer: 1 },
    ...
    { q: "선비는 그 뒤에 어떻게 했나요?", choices: ["곧장 한양으로 떠났다", "다친 새들을 돌봤다", "절에 이레를 머물렀다"], answer: 1 }
];
