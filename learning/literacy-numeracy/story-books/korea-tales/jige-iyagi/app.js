    ...
    },
    {
        ...
        beats: [
            ...
            },
            {
                ...
                emoji: "🏡",
                left: [
                    "그날부터 아들은 아버지를 정성껏 모셨어요. 아침저녁으로 미음을 끓이고 자리를 갈아 드렸지요.",
...
const QUIZ = [
    ...
    { q: "아버지가 가자고 하자 아이는 어떻게 했나요?", choices: ["손을 빼고 되돌아 뛰어갔다", "말없이 손을 잡았다", "대문 기둥을 붙들었다"], answer: 0 },
