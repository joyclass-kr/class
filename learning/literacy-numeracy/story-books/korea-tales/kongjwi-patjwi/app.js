...
const CHAPTERS = [
    {
        ...
        paras: [
            ...
            "\"이걸로 어떻게 저 밭을 다 매나.\" 그런데 밭은 반의반도 매지 못했습니다.",
    ...
    },
    {
        ...
        paras: [
            ...
            "독이 가득 찬 것을 본 배 씨의 얼굴이 굳었습니다. 그러나 곧 아무렇지 않은 척 말했습니다.<br>\"참, 한 가지를 깜빡했구나. 곳간에 벼 석 섬이 있다. 그것을 다 찧어 놓고 오너라.\" 말끝이 유난히 부드러웠습니다. 배 씨는 콩쥐의 얼굴을 보지 않고 말했습니다.",
            ...
            "콩쥐는 절구를 끌어다 놓고 벼를 한 바가지 부었습니다. 절굿공이가 어찌나 무거운지 두 손으로 겨우 들었습니다. 절구가 콩쥐 키만 했습니다.",
...
const EN = {
    ...
    quiz: [
        ...
        { q: "What did the stepmother do after Kongjwi went to the governor's house?", choices: ["She moved away to a far town", "She went and apologised to Kongjwi", "She tried to put Patjwi in her place"], answer: 2 },
