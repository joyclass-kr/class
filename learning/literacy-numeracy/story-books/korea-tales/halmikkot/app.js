...
const COVER = {
    ...
    intro: [
        ...
        "할미꽃은 이른 봄 무덤가나 볕 잘 드는 언덕에 피는 우리나라 들꽃이에요. 줄기가 활처럼 굽어 꽃이 늘 땅을 내려다보고, 온몸에 흰 솜털이 촘촘히 나 있지요. 굽은 허리와 흰머리가 할머니를 닮았다고 해서 붙은 이름이랍니다.",
...
const WORDS_KO = {
    "cover": [
        ...
        { w: "볕", k: "해에서 오는 따뜻한 빛.", s: "이른 봄 무덤가나 볕 잘 드는 언덕에 피는 우리나라 들꽃이에요." },
