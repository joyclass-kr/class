...
const QUIZ = [
    ...
    { q: "두 형제는 어디에서 마주쳤나요?", choices: ["마을 장터에서", "밤길 논둑에서", "서로의 집에서"], answer: 1 },
    {
        ...
        choices: [
            ...
            "서로 모르게 하려고 한밤중에 오간 것을 보면, 주는 일에도 조심할 것이 있구나.",
            "그 뒤로는 볏단을 세어 보지 않았다는 것을 보면, 알고 나서는 셈할 것이 없어졌구나.",
            "두 형제가 물려받은 논을 나눌 때부터 서로 더 주려고 다툰 것을 보면, 그 마음이 처음부터였구나."
        ],
        answer: 3
    }
];
    ...
    spreads: [
        {
            ...
            left: [
                ...
                "이야기가 실제로 있었던 일인지는 알 수 없습니다. 다만 나라에서 비석까지 세워 알렸다는 것은, 그 시절 사람들이 이런 형제를 몹시 귀하게 여겼다는 뜻이기도 합니다.",
