    ...
    return `
        <div class="page page-cover">
            ...
            <div class="story-page-right">
                ...
                <p>꿈에 담긴 뜻을 풀어 보는 것을 꿈풀이라고 해요. 옛날에는 꿈에 뜻이 있다고 여겨 꿈풀이을 아주 중요하게 여겼지요. 같은 꿈을 두고 좋게도 나쁘게도 풀 수 있다는 것이 이 이야기의 웃음이 시작되는 자리랍니다.</p>
                ${coverToc()}
            </div>
        </div>`;
}
...
const QUIZ = [
    ...
    { q: "꼴뚜기는 왜 눈이 아래로 내려갔나요?", choices: ["멸치에게 맞아서", "놀라 달아나다가", "물살에 휩쓸려서"], answer: 1 },
    {
        ...
        choices: [
            ...
            "넙치가 본 대로만 말한 것을 보면, 바른말을 하고도 매를 맞는 자리가 있구나.",
            "바닷속 생김새를 하루 만에 다 정해 놓은 것을 보면, 옛사람들은 웃으면서 까닭을 붙였구나.",
            "망둥이가 서해까지 다녀온 것을 보면, 멸치를 그만큼 따르고 아꼈구나."
        ],
        answer: 3
    }
];
