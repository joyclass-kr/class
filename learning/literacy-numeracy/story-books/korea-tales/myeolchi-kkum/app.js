        ...
        beats: [
            {
                ...
                right: [
                    "그날 밤 멸치는 이상한 꿈을 꾸었어요.",
                    "잠자리에 든 지 얼마 되지 않았을 때였지요.",
            ...
            },
            {
                ...
                left: [
                    ...
                    "\"서해에 해몽 잘하는 넙치가 산다지?\"",
                    "\"해몽이라면 그 넙치를 따를 자가 없다더라.\"",
                    "\"당장 가서 모셔 오너라.\""
                ],
                right: [
                    "멸치가 두 눈을 부라렸어요.",
                    "\"예? 서해까지요?\"",
                    "망둥이는 그만 울상이 되고 말았습니다.",
                    "동해에서 서해까지는 가도 가도 끝이 없는 물길이었거든요.",
    ...
    },
    {
        ...
        beats: [
            ...
            },
            {
                ...
                emoji: "🗣️",
                left: [
                    "드디어 멸치가 꿈 이야기를 늘어놓았어요.",
                    "멸치의 목소리에 힘이 잔뜩 들어갔지요.",
                    "\"몸이 두둥실 하늘로 떠올랐지요.\"",
            ...
            },
            {
                ...
                right: [
                    "넙치는 그저 본 대로 말했을 뿐이었어요.",
                    "잔칫상 앞이 갑자기 얼음처럼 굳어 버렸지요.",
                    "\"뭐, 뭐라고?!\"",
                    "멸치가 자리에서 벌떡 일어섰습니다.",
                    "멸치의 얼굴이 시퍼렇게 질렸답니다.",
                    "누구도 입을 떼지 못했어요."
        ...
        beats: [
            {
                ...
                left: [
                    ...
                    "넙치가 눈을 껌뻑이는 모습이 하도 우스웠거든요.",
                    "\"으하하하! 눈이 저게 뭐야!\"",
                    "메기는 입을 있는 대로 벌리고 웃었지요.",
                    "배를 잡고 뒹굴며 웃었답니다."
                ],
                right: [
                    "그런데 너무 크게 웃은 것이 탈이었지요.",
                    "입이 양쪽으로 쭉 찢어지고 말았지요.",
            ...
            },
            {
                ...
                left: [
                    ...
                    "웃었다가는 저도 메기 꼴이 날 것 같았거든요.",
                    "\"읍! 우우읍!\"",
                    "볼이 빨갛게 부풀고 눈에 눈물까지 맺혔지요.",
                    "그러면서도 입은 끝내 열지 않았답니다."
                ],
                right: [
                    "그런데 얼마나 힘껏 오므렸는지 입이 도로 펴지지 않았습니다.",
                    "병어가 물빛에 제 얼굴을 비춰 보았어요.",
                    "\"어머, 내 입이 왜 이리 작아졌지?\"",
            ...
            },
            {
                ...
                right: [
                    ...
                    "\"어어, 내 눈이 왜 여기까지 내려왔지?\"",
                    "꼴뚜기가 두 눈을 밀어 올려 보았어요.",
                    "그러나 두 눈은 꿈쩍도 하지 않았지요.",
