...
const EN = {
    ...
    words: {
        "cover": [
            ...
            { w: "districts", k: "고을", s: "in some districts the persimmon is a fresh persimmon" },
            { w: "toffee", k: "엿", s: "a piece of toffee instead" },
            { w: "wear two faces", k: "두 얼굴을 가지다", s: "Tigers wear two faces in old stories." },
            { w: "fearsome", k: "무서운", s: "the fearsome spirit that guards the mountain" },
            { w: "spirit", k: "산신, 신령", s: "the fearsome spirit that guards the mountain" },
            { w: "guards (guard)", k: "지킨다", s: "the spirit that guards the mountain" },
            { w: "slow-witted", k: "어수룩한", s: "it is a slow-witted creature that gets fooled" },
            { w: "gets fooled", k: "속는다", s: "a slow-witted creature that gets fooled" },
            { w: "the Joseon period", k: "조선 시대", s: "In the Joseon period tigers really did come down into villages" },
            { w: "hunters", k: "사냥꾼", s: "a special army of tiger hunters" },
            { w: "making fun of ~", k: "~을 놀리는 것", s: "Making fun of the most frightening animal alive" },
            { w: "peeled (peel)", k: "껍질을 벗겼다", s: "a persimmon that has been peeled and dried" },
            { w: "fridges", k: "냉장고", s: "In a time with no sweets and no fridges" },
            { w: "precious", k: "귀한", s: "it was a precious sweet thing" }
        ],
        "01-hungry.webp": [
