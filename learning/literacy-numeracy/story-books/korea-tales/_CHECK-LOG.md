...
| 자리 | 문제 | 상태 |
|---|---|---|
| `banjjogi` 전권 14장 | 주인공이 반쪽이 아님 + 표지가 해부도 | 주문서에 올림 |
| `bak-hyeokgeose/03-horse` | 글·그림말 다 「앞무릎을 꿇고」인데 앞발을 들고 섰음 | 주문서에 올림 |
| `hokburi-yeonggam/09-greedy` | 욕심쟁이 얼굴이 딱딱함 | 주문서에 올림 |
| `hokburi-yeonggam/10-sing` | 다시 온 것이 더 나빠 되돌림 | 주문서에 올림 |
| `eunhye-dukkeobi` 지네 4장 | 마디·이빨·눈동자를 다 그려 징그러움 | 주문서에 올림 |
