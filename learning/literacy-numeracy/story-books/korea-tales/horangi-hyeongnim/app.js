...
const COVER = {
    ...
    intro: [
        ...
        "청나라 사람 포송령이 쓴 요재지이에도 이와 비슷한 호랑이 이야기가 실려 있어요. 방정환의 원래 이야기는 호랑이가 끝내 알지 못한 채 끝나는데, 이 책은 뒷부분을 달리 지었답니다."
    ]
};
...
const WORDS_KO = {
    ...
    "01-woodcutter.webp": [
        ...
        { w: "골짜기", k: "산과 산 사이 깊고 좁은 곳.", s: "그러다 어느새 골짜기 안쪽까지 들어와 버렸지요." },
    ...
    "07-gift.webp": [
        ...
        { w: "소복이", k: "수북하게 담긴 모양.", s: "산나물과 약초가 소복이 놓였지요." },
