        ...
        beats: [
            {
                ...
                right: [
                    "\"오늘은 한 짐만 더 하고 내려가자.\"",
                    "나무꾼은 가지를 치며 자꾸자꾸 안으로 들어갔어요. 그러다 어느새 골짜기 안쪽까지 들어와 버렸지요.",
                    "산이 유난히 조용했습니다.",
                    "새소리도 물소리도 들리지 않았답니다."
                ]
            },
    ...
    },
    {
        ...
        beats: [
            ...
            },
            {
                ...
                right: [
                    "그다음 날에는 노루가 놓여 있었어요. 그다음 날에는 산나물과 약초가 소복이 놓였지요.",
                    "밤마다 무언가가 마당에 놓였답니다.",
...
const QUIZ = [
    ...
    { q: "호랑이의 대답은 무엇이었나요?", choices: ["어머니께 말하지 말라고", "제 꼴이 부끄럽다고", "진작 알고 있었다고"], answer: 2 },
    {
        ...
        choices: [
            ...
            "어머니가 밤마다 밥 한 그릇을 내놓은 것을 보면, 알면서 모른 척해 준 것이었구나.",
            "호랑이가 진작 알고 있었다고 한 것을 보면, 속은 것이 아니라 그 이름이 좋았던 것이구나.",
            "호랑이가 지게를 져다 주고 어머니께 절까지 하고 간 것을 보면, 아들 노릇을 해 보고 싶었구나."
        ],
        answer: 3
    }
];
