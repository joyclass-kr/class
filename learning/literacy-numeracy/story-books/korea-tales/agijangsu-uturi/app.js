    ...
    return `
        <div class="page page-cover">
            ...
            <div class="story-page-right">
                <h1>아기장수 우투리</h1>
                <p>아기장수 우투리는 지은이가 없는 옛이야기예요. 우리나라 곳곳에 조금씩 다른 모습으로 전해 오고, 용마못이나 용마바위라는 이름이 남은 자리마다 이 이야기가 따라옵니다.</p>
                <p>겨드랑이에 날개를 달고 태어난 아이가 큰 장수가 되려다 그러지 못하는 이야기예요. 옛이야기 가운데 드물게 끝이 슬픈 이야기지요.</p>
                <p>콩 한 알이 모자라 일이 어그러집니다. 그 한 알을 누가 먹었는지, 왜 한 해를 못 기다렸는지를 따라가 보세요.</p>
                ${coverToc()}
            </div>
        </div>`;
}
