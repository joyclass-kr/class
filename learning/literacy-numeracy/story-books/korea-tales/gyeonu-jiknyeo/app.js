...
const COVER = {
    ...
    intro: [
        ...
        "은하수를 사이에 두고 마주 보는 두 개의 밝은 별이 실제로 있어요. 여름밤 하늘에서 볼 수 있는 견우성과 직녀성이지요. 두 별이 은하수 양쪽에 떨어져 있는 모습에서 이 이야기가 시작되었답니다.",
        "음력 칠월 칠일을 칠석이라고 해요. 옛사람들은 이날 두 사람이 만난다고 여겨 별을 보며 소원을 빌었지요. 칠석 무렵에 비가 자주 오는 것도, 그 무렵 까치 머리가 성긴 것도 이 이야기로 설명했답니다."
    ]
};
...
const WORDS_KO = {
    "cover": [
        ...
        { w: "소원", k: "이루어지기를 바라는 일.", s: "이날 두 사람이 만난다고 여겨 별을 보며 소원을 빌었지요." },
        { w: "성기다", k: "사이가 뜨고 듬성듬성하다.", s: "그 무렵 까치 머리가 성긴 것도 이 이야기로 설명했답니다." }
    ],
    "01-gyeonu.webp": [
