    ...
    return `
        <div class="page page-cover">
            ...
            <div class="story-page-right">
                ...
                <p>음력 칠월 칠일을 칠석이라고 해요. 옛사람들은 이날 두 사람이 만난다고 여겨 별을 보며 소원을 빌었지요. 칠석 무렵에 비가 자주 오는 것도, 그 무렵 까치 머리가 성긴 것도 이 이야기로 설명했답니다.</p>
                ${coverToc()}
            </div>
        </div>`;
}
...
const QUIZ = [
    ...
    { q: "칠석 무렵에 비가 오는 까닭은 무엇이라고 했나요?", choices: ["구름이 몰려와서라고", "두 사람의 눈물이라고", "용이 노해서라고"], answer: 1 },
    {
        ...
        choices: [
            ...
            "일 년에 하루라도 만나게 한 것을 보면, 벌을 주면서도 아주 끊지는 못했구나.",
            "까치와 까마귀가 해마다 저희끼리 모여 올라간다는 것을 보면, 시키지 않아도 하는 일이 따로 있구나.",
            "옥황상제가 둘을 갈라놓은 것을 보면, 처음부터 이 혼인을 마뜩잖게 여겼구나."
        ],
        answer: 3
    }
];
