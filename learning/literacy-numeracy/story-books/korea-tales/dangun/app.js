        ...
        beats: [
            {
                ...
                left: [
                    ...
                    "그에게는 환웅이라는 아들이 있었지요.",
                    "환웅은 하늘 일보다 땅 일에 마음이 가 있었어요."
                ],
                right: [
                    "환웅은 날마다 구름 사이로 아래를 내려다보았어요.",
                    "사람들이 밭을 갈고 아이를 업고 다니는 모습이 보였거든요.",
            ...
            },
            {
                ...
                right: [
                    "환웅은 무리 삼천을 이끌고 산꼭대기로 내려왔지요.",
                    "구름이 갈라지며 길이 열렸어요.",
                    "바람과 비와 구름을 맡은 셋도 함께였어요.",
            ...
            },
            {
                ...
                left: [
                    ...
                    "씨를 뿌리는 때와 거두는 때를 일러 주었지요.",
                    "아픈 사람에게는 약초를 달여 먹였어요."
                ],
                right: [
                    "\"널리 사람을 이롭게 하라.\"",
                    "그것이 환웅이 늘 하던 말이었지요.",
                    "신시에는 굶는 사람도 다투는 사람도 없었어요.",
                    "웃음소리가 끊이지 않았답니다."
                ]
            },
            {
                ...
                right: [
                    ...
                    "환웅은 한참 동안 둘을 내려다보았어요. 둘의 눈이 아주 간절했답니다."
                ]
            }
        ]
    },
        ...
        beats: [
            ...
            },
            {
                ...
                right: [
                    "\"못 하겠다! 나는 이렇게는 못 산다!\"",
                    "\"고기 한 점만 먹으면 살 것 같은데!\"",
                    "호랑이는 동굴 밖으로 뛰쳐나갔어요. 곰은 그 뒷모습을 물끄러미 바라보았지요.",
                    "말릴 새도 없이 순식간이었지요."
                ]
            },
            {
                ...
                left: [
                    ...
                    "아무도 없는 동굴이 훨씬 더 조용해졌어요.",
                    "쓴맛에도 이제는 눈물이 나지 않았어요."
                ],
                right: [
                    "'조금만 더. 조금만 더.'",
                    "곰은 그 말만 되풀이했어요.",
            ...
            },
            {
                ...
                emoji: "✨",
                left: [
                    "스무하루가 되던 날 아침이었어요. 백 일을 채우려면 아직 멀었지만, 환웅이 그 마음을 벌써 다 본 것이지요.",
                    "곰이 여느 때처럼 쑥을 씹고 있을 때였어요.",
                    "동굴 안이 눈이 부시도록 환해졌습니다.",
                    "곰은 눈을 뜰 수가 없었지요."
                ],
                right: [
                    "몸이 가벼워지고 앞발이 길어졌어요. 곰의 몸에서 검은 털이 눈처럼 흩날렸지요.",
        ...
        beats: [
            {
                ...
                right: [
                    "\"아이를 하나만 갖게 해 주십시오.\"",
                    "웅녀는 아침에도 저녁에도 그 자리에 있었어요.",
                    "그 소리가 어찌나 간절했던지 나뭇잎이 다 떨어지도록 이어졌지요.",
            ...
            },
            {
                ...
                emoji: "🌄",
                left: [
                    "자라난 단군은 새 터를 찾아 길을 나섰습니다. 신시만으로는 사람이 다 살 수 없을 만큼 늘어났거든요.",
                ...
                right: [
                    "\"이곳을 아사달이라 하겠다.\"",
                    "단군이 두 팔을 벌리며 말했지요.",
                    "아사달은 아침 땅이라는 뜻이었어요. 아침 해가 제일 먼저 닿는 땅이었지요.",
                    "사람들이 그 말을 따라 옮겨 왔답니다."
                ]
            },
            {
                art: "14-joseon.webp",
                ...
                right: [
                    "아침 해처럼 새로 여는 나라라는 뜻이었지요.",
                    "곰이 깊은 어둠 속에서 견뎌 얻은 것이 결국 아침이었던 셈이에요. 그것이 우리 땅에 선 첫 번째 나라였답니다."
                ]
            }
        ],
    ...
    return `
        <div class="page page-cover">
            ...
            <div class="story-page-right">
                <h1>단군</h1>
                <p>단군 이야기는 고려 때 승려 일연이 쓴 삼국유사에 실려 전해져요. 비슷한 시기에 이승휴가 쓴 제왕운기에도 함께 실려 있답니다.</p>
                <p>이야기 속에서 곰과 호랑이가 사람이 되기를 바라는 대목은 오래된 북방 이야기들과 닮았어요. 곰을 조상으로 모시는 이야기는 시베리아와 만주 여러 곳에 남아 있지요.</p>
                <p>환웅이 데리고 내려온 풍백, 우사, 운사는 바람과 비와 구름을 맡은 이들이에요. 농사에 가장 중요한 세 가지를 이름으로 삼은 것이랍니다.</p>
                ${coverToc()}
            </div>
        </div>`;
}
...
const QUIZ = [
    ...
    { q: "환웅이 내려와 연 곳의 이름은 무엇인가요?", choices: ["아사달", "평양", "신시"], answer: 2 },
    { q: "곰과 호랑이가 받은 것은 무엇인가요?", choices: ["쑥과 마늘", "쌀과 보리", "약과 물"], answer: 0 },
