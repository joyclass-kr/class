const CHAPTERS = [
    {
        ...
        beats: [
            ...
            },
            {
                ...
                left: [
                    "나무꾼은 물가에 주저앉았어요.",
                    "연못은 바닥이 안 보일 만큼 깊었습니다. 들어가 볼 엄두도 나지 않았지요.",
                    "물속을 한참이나 들여다보았어요.",
