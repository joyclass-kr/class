const CHAPTERS = [
    {
        ...
        beats: [
            ...
            },
            {
                ...
                right: [
                    "할머니가 이웃집에 혼담을 넣었어요. 이웃집에서는 첫째도 둘째도 펄쩍 뛰었지요.",
                    "\"뱀한테 시집을 가라고?\"",
                    "그런데 셋째가 조용히 말했습니다.",
                    "\"제가 가겠습니다.\"",
                    "언니들이 셋째를 붙들고 말렸답니다."
        ...
        beats: [
            ...
            },
            {
                ...
                left: [
                    ...
                    "아무도 그 비밀을 몰랐답니다. 둘은 그렇게 여러 해를 살았어요.",
    ...
    return `
        <div class="page page-cover">
            ...
            <div class="story-page-right">
                ...
                <p>짐승 모습으로 태어난 신랑이 허물을 벗고 사람이 되고, 금기를 어겨 사라지고, 아내가 먼 길을 걸어 되찾는 짜임은 세계 곳곳에 있어요. 유럽의 미녀와 야수, 큐피드와 프시케 이야기가 같은 갈래랍니다.</p>
...
const QUIZ = [
    ...
    { q: "신선비는 허물을 어떻게 간수해 달라고 했나요?", choices: ["불에 닿지 않게", "물에 젖지 않게", "흙에 묻히지 않게"], answer: 0 },
    ...
    { q: "아내는 어떻게 신선비를 찾아냈나요?", choices: ["빨래를 밟아 주고 물어서", "까치에게 물어서", "담 밖에서 노래를 불러서"], answer: 2 },
    {
        ...
        wide: true,
        choices: [
            "셋째만 구렁덩덩 신선비라고 불러 준 것을 보면, 같은 것을 보고도 무어라 부르느냐가 다르구나.",
            "언니들이 허물을 태운 것을 보면, 흉하다고 하던 쪽이 끝내 없애려 드는구나.",
            "아내가 까치와 멧돼지를 도우며 길을 물어 간 것을 보면, 먼 길은 혼자 가는 것이 아니구나.",
            "엄마 말을 늘 거꾸로 하던 아들이 마지막에 그대로 따른 것을 보면, 뉘우침은 늘 한발 늦는구나."
        ],
        answer: 3
    }
];
