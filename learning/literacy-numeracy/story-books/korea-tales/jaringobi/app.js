    ...
    },
    {
        ...
        beats: [
            ...
            },
            {
                ...
                emoji: "🤝",
                left: [
                    "그 소문이 경상도까지 퍼졌습니다. 파리를 한양까지 쫓아갔다는 이야기였지요.",
                    "그곳에도 지지 않는 구두쇠가 하나 있었거든요.",
                    "\"충주에 나보다 더한 자가 있다고?\"",
                    "구두쇠는 그 말을 듣고 발끈했어요."
                ],
                right: [
        ...
        beats: [
            {
                ...
                right: [
                    "벼는 다 말라 죽었어요.",
                    "가을이 되어도 거둘 것이 없었지요. 마을 사람들은 나무껍질을 벗겨 죽을 쑤었어요.",
                    "아이들 울음소리가 밤새 끊이지 않았답니다. 온 마을이 굶주렸지요."
                ]
            },
            {
                art: "11-mutter.webp",
