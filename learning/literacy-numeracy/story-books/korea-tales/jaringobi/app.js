        ...
        beats: [
            {
                ...
                emoji: "🏠",
                left: [
                    "옛날 충주 땅에 소문난 부자가 살았어요. 논이 몇십 마지기에 곳간이 세 채나 되었지요.",
        ...
        beats: [
            {
                ...
                right: [
                    ...
                    "\"내 된장 내놓고 가거라!\"",
                    "장독대를 지나 담을 넘고 고샅길까지 쫓아갔지요. 파리는 아랑곳없이 훨훨 날아갔어요.",
                    "그래도 자린고비는 멈추지 않았답니다."
                ]
            },
            {
...
const QUIZ = [
    ...
    { q: "마을 사람들은 그제야 무엇을 알았나요?", choices: ["그가 부자가 아니라는 것", "왜 그토록 아꼈는지", "굴비가 가짜였다는 것"], answer: 1 },
    {
        ...
        choices: [
            ...
            "흉년에 곳간 문을 손수 밀어젖힌 것을 보면, 삼십 년을 아낀 데에는 까닭이 있었구나.",
            "경상도 구두쇠가 굴비를 한 번도 안 쳐다본 것을 보면, 위에는 위가 있는 법이구나.",
            "파리를 한양까지 쫓아가 기어이 된장을 되찾아 온 것을 보면, 한번 마음먹으면 끝을 보는 사람이구나."
        ],
        answer: 3
    }
];
