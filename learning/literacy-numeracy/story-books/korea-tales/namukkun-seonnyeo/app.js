...
const COVER = {
    ...
    intro: [
        ...
        "마을마다 끝이 달라요. 나무꾼이 하늘로 올라가 함께 사는 판본도 있고, 끝내 땅에 남는 판본도 있지요. 수탉이 새벽마다 하늘을 보고 우는 까닭을 여기에 붙여 놓은 판본도 있답니다.",
        "이 책은 널리 알려진 줄거리 가운데 앞부분을 고쳐 썼어요. 옛 이야기에서는 나무꾼이 날개옷을 감추지만, 이 책에서는 주운 옷을 곧바로 돌려줍니다."
    ]
};
