        ...
        beats: [
            {
                ...
                right: [
                    "\"내 옷이 없어졌어…\"",
                    "선녀는 무릎에 얼굴을 묻고 울었지요.",
                    "나무꾼이 조심조심 다가갔어요. 선녀는 그가 온 줄도 몰랐답니다.",
                    "나무꾼은 뭐라 말을 붙일지 몰랐지요."
                ]
            },
            {
            ...
            },
            {
                ...
                right: [
                    "선녀는 밥 짓는 법도 빨래하는 법도 몰랐지요. 그래도 무엇이든 배우려 했어요.",
                    "대신 산나물 이름은 하나도 빠짐없이 알았고, 약초 이름도 줄줄 꿰었지요.",
                    "세 사람은 밤마다 이야기꽃을 피웠답니다."
                ]
            },
            {
                art: "10-stay.webp",
    ...
    },
    {
        ...
        beats: [
            ...
            },
            {
                ...
                emoji: "🐓",
                left: [
                    "어머니는 아들을 보자 팥죽부터 쑤어 왔어요. 몇 해 만에 보는 아들이었으니까요.",
                    "김이 펄펄 나는 팥죽이었지요.",
                    "말 위에서 받아 든 순간 그릇이 기울었어요.",
                ...
                right: [
                    ...
                    "주저앉아 하늘을 보고 울부짖었지요.",
                    "어머니가 그 곁에서 함께 울었지요.",
                    "그러자 두레박이 또 내려왔어요. 아내와 아이들이 타고 있었지요.",
                    "넷은 어머니 곁에서 오래오래 살았답니다."
                ]
            }
        ],
    ...
    return `
        <div class="page page-cover">
            ...
            <div class="story-page-right">
                ...
                <p>마을마다 끝이 달라요. 나무꾼이 하늘로 올라가 함께 사는 판본도 있고, 끝내 땅에 남는 판본도 있지요. 수탉이 새벽마다 하늘을 보고 우는 까닭을 여기에 붙여 놓은 판본도 있답니다.</p>
    ...
    spreads: [
        {
            ...
            left: [
                ...
                "다른 판본에서 나무꾼이 처음 하는 일은 날개옷을 감추는 것입니다. 도와준 것이 아니라 붙잡아 둔 것이지요."
            ],
            right: [
