...
const COVER = {
    ...
    intro: [
        ...
        "이 이야기는 유래담이에요. 바닷물이 왜 짠지를 이야기로 설명하지요. 놀라운 것은 거의 같은 이야기가 아주 먼 나라에도 있다는 점이에요. 북유럽에는 그로티라는 맷돌 이야기가 있고, 일본에도 바닷속에서 소금을 갈아 내는 맷돌 이야기가 전해요. 서로 만난 적 없는 사람들이 같은 궁금증을 같은 방식으로 풀어낸 셈이지요.",
