const CHAPTERS = [
    {
        ...
        beats: [
            ...
            },
            {
                ...
                emoji: "💃",
                left: [
                    "아홉 간과 이백 명 남짓한 사람들이 노래를 불렀어요. 처음에는 목소리가 제각각이었지요.",
                    "발을 구르고 손뼉을 쳤습니다.",
    ...
    },
    {
        ...
        beats: [
            ...
            },
            {
                ...
                emoji: "👶",
                left: [
                    "열이틀이 지난 이른 아침이었어요. 새벽부터 사람들이 집 앞에 모여 있었지요.",
    ...
    },
    {
        ...
        beats: [
            ...
            },
            {
                ...
                right: [
                    "배에서 내린 이는 낯선 옷을 입은 젊은 여인이었지요. 머리에 낯선 장신구를 하고 있었어요.",
...
const QUIZ = [
    ...
    { q: "허황옥이 배에 싣고 온 것은 무엇인가요?", choices: ["쇠와 쟁기", "금빛 상자", "씨앗과 책"], answer: 2 },
    {
        ...
        choices: [
            ...
            "쇠가 많이 나서 배가 드나들었다는 것을 보면, 이야기 속에도 그 고장이 무엇으로 살았는지 담겨 있구나.",
            "바다 건너에서 온 여인을 왕비로 맞은 것을 보면, 낯선 것을 겁내지 않는 나라였구나.",
            "아홉 간이 저마다 제 딸을 왕비로 들이려 애쓴 끝에 뜻을 이룬 것을 보면, 사람 욕심은 어디나 같구나."
        ],
        answer: 3
    }
];
