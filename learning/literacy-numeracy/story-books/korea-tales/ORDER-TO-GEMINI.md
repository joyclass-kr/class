...
`learning/literacy-numeracy/story-books/korea-tales/` · 2026-08-28 10:40 기준

62권 가운데 **58권 완성**, 그림 919장이 들어왔습니다. 고맙습니다.
남은 것은 아래 두 묶음입니다. **① 다시 그릴 것 → ② 빠진 것 5장**

---

## ① 악당을 다시 그려 주세요 — 재미있고 귀엽게
...
**반드시 각 책의 `IMAGE-PROMPTS.md`를 새로 받아 쓰셔야 합니다.**
예전 프롬프트로 그리면 또 같은 그림이 나옵니다.
...
### 같이 봐 주실 것 — 악당이 나오는 그림 54장

프롬프트에 악당이 등장한다고 적힌 그림만 뽑았습니다.
**얼굴이 흉하게 나온 것만** 다시 그려 주세요. 웃기고 귀엽게 나온 것은 그대로 두셔도 됩니다.
...
62권 924장이 다 들어왔습니다. **빠진 그림은 없습니다.** 고맙습니다.
어제 보내 주신 열두 장은 전부 정확했습니다. 이름도 하나도 안 어긋났고,
악당 얼굴도 규칙대로였습니다. 특히 자린고비 `04-fan`은 부채 든 팔이
굳은 채 머리만 흔들리는 잔상까지 그림말 그대로였습니다.

지금 924장을 하나씩 열어 본문과 견주는 중입니다. 나오는 대로 여기 적습니다.
...
새로 보내 주신 것에서 **도깨비들이 귀를 막고 음표가 삐뚤빼뚤 날아가는 것은
아주 좋습니다.** 노래가 얼마나 못 견딜 만한지가 한눈에 보입니다. 그건 꼭 살려 주세요.

다만 **영감 얼굴이 반대로 갔습니다.** 얼굴이 시뻘겋게 일그러지고 눈이 꽉
감기고 입이 쩍 벌어져 이와 혀까지 다 드러났습니다. 이건 규칙에서 하지 말라고
한 바로 그 얼굴입니다. 그래서 아침에 받은 것을 그대로 두었습니다.

    귀 막는 도깨비 · 날아가는 음표 · 몸 전체로 부르는 자세  → 살려 주세요
    시뻘겋게 일그러진 얼굴 · 쩍 벌어져 이가 드러난 입        → 빼 주세요

입은 벌리되 동그랗게, 눈은 감되 웃는 눈으로, 얼굴빛은 발그레한 정도로
해 주시면 딱 좋겠습니다. **못 부르는 게 우스워야지 얼굴이 흉하면 안 됩니다.**

한편 같이 보내 주신 `11-angry` 는 아주 좋아서 그대로 받았습니다.
눈이 뱅뱅 돌고 혹이 막 붙은 참, 아기 도깨비가 혀를 내미는 것까지
웃기면서 하나도 흉하지 않습니다. **그 얼굴이 기준입니다.**

---

## 저장할 때 부탁 세 가지

**하나. 파일 이름을 `IMAGE-PROMPTS.md`에 적힌 그대로.**
지난번에 이런 것들이 어긋나 손으로 맞췄습니다.

    01-market -> 01-stranger    07-peace  -> 07-revealed
    06-reward -> 08-reward      08-end    -> end
    03-climb  -> 03-beanstalk   07-wedding-> 07-awake

**앞의 번호를 바꾸지 말아 주세요.** 번호가 어긋나면 그림이 엉뚱한 쪽에 붙습니다.

**둘. 같은 그림을 두 자리에 저장하지 말아 주세요.** 지금까지 세 건 있었습니다.
바이트까지 똑같아서 한쪽은 통째로 잘못된 자리였습니다.

**셋. 규격** (webp 변환은 저희가 합니다)
...
## 반쪽이 · 은혜 갚은 두꺼비 — 다 받았다. 고칠 것 없음

반쪽이 열다섯 장을 다시 세어 보았다. 눈 하나 뜨고 하나 감음, 팔 하나,
다리 하나, 소매와 바짓가랑이 매듭 — 열다섯 장 모두 맞다.

13-wedding의 어머니가 젊어졌다. 이제 02-half의 어머니와 같은 사람으로
보인다. 형 둘도 그대로 둘이다.

09~12의 김 부자도 좋다. 낯빛이 발그레해졌고 놀란 표정은 그대로다.
파랗게 질린 표정 자체가 잘못이 아니라는 것은 앞서 정리한 대로다.

은혜 갚은 두꺼비의 지네도 좋다. 굵은 선에 동그란 눈, 통통한 마디.
징그러운 잔털이나 촘촘한 다리 없이도 무섭고 우습다. **앞으로 괴물은
이 지네를 본으로 삼는다.**

두꺼비 그림에 맞추어 글을 고쳤다. 지네가 들보를 감고 있지 않고
허공에 떠 있으므로 「들보를 칭칭 감고 있는 것은」을 「천장 아래 허공에
떠 있었어요」로, 「수없이 많은 다리가 스멀스멀」을 「마디마다 구불구불」로
바꾸었다. 물러가는 것도 「들보에서 내려와」가 아니라 「검은 연기가 되어
흩어졌습니다」로 했다.
...
# 전수조사에서 나온 것 (1) — 열다섯 권까지

925장을 하나씩 열어 본문과 견주는 중이다. 지금까지 열다섯 권을 보았다.
**고쳐 주었으면 하는 것만** 아래에 적는다. 나머지는 다 좋다.

## 같은 그림이 두 펼침에 그대로 쓰였다

한 장면을 두 번 쓰면 아이가 쪽을 넘긴 줄을 모른다. **갈라 주기 바란다.**

| 자리 | 지금 | 어떻게 |
|---|---|---|
| `banggwi-myeoneuri` 05-boom · 06-fly | 회오리 그림이 거의 같다 | **05**는 「뿌우웅」 터지는 순간까지 — 시아버지가 기둥을 안고 도는 것만. **06**은 시어머니가 문짝째 날아가고 남편이 지붕에 올라앉고 닭이 깃털만 남는 장면 |
| `cheonggaeguri` 05-sick · 06-plan | 굴속 그림이 거의 같다 | **05**는 아들이 물을 떠다 입에 대 주는 장면. **06**은 엄마 혼자 천장을 보며 궁리하는 장면(아들은 밖에) |
| `eunhye-kkachi` 05-coil · 06-revenge | 방 안 그림이 거의 같다 | 아래 참조 |

## 글과 어긋난 것

| 자리 | 무엇이 어긋났나 |
|---|---|
| `deuljwi-sontop` 03-rat | **들쥐가 두 마리다.** 글은 「들쥐 한 마리가 나왔습니다」. 한 마리만 그려야 한다. 그 한 마리가 손톱을 먹고 사람이 되는 이야기다 |
| `dokkaebi-bangmangi` 05-feast | **아우가 다락이 아니라 도깨비들 바로 옆 바닥에 있다.** 앞 쪽에서 사다리를 타고 다락에 올라갔고, 글도 「다락 위 아우는 눈이 휘둥그레졌답니다」이다. 다락 난간 너머로 내려다보는 모습이어야 한다 |
| `dokkaebi-gamtu` 16-burn | 글은 **도깨비 하나가 혼자 앉아 있는** 장면인데 여럿이 잔치를 벌이고 있다. 게다가 아궁이(그날 밤)와 개울가(이튿날 밤)가 한 그림에 섞였다. **개울가에 도깨비 하나와 돌쇠 둘만** 나란히 앉은 그림으로 |
| `eunhye-kkachi` 05-coil | 글은 「구렁이가 선비의 몸을 칭칭 감고 있었습니다 … 팔 하나 까딱할 수 없었답니다」인데 선비가 자유롭게 앉아 있다. **몸을 감은 모습**으로 |
| `bak-hyeokgeose` 03-horse | **붉은 알이 벌써 우물 위에 있다.** 알은 말이 하늘로 사라진 뒤에 나타난다. 이 그림에는 알이 없어야 한다 |
| `bak-hyeokgeose` 02-light | 촌장이 **다섯**만 보인다. 글은 여섯 |
| `bak-hyeokgeose` 11-thirteen | 촌장이 **넷**만 보인다. 글은 여섯 |

## 같은 사람이 다른 사람으로 보인다

**한 사람이 나오는 그림을 다 늘어놓고 견주어 주기 바란다.**

| 자리 | 무엇이 |
|---|---|
| `dangun` 05-two · 06-give | 환웅만 **수염 난 상투 어른**으로 그려졌다. 01·02·03·04·12에서는 수염 없는 긴 머리 젊은이다. 젊은 쪽이 맞다 |
| `geumdokki-eundokki` 09-copy · 10-greedy | 욕심쟁이가 **딴사람**이다. 09는 콧수염 난 파란 도포의 어른, 10은 색동저고리를 입은 동글동글한 아이 같은 사람. 09 쪽으로 맞춰 주기 바란다. 색동은 아이 옷이다 |

## 낮은 순위 (급하지 않음)

| 자리 | 무엇이 |
|---|---|
| `bak-hyeokgeose` 05-boy | 말이 아직 하늘에 있다. 앞 쪽에서 사라졌다 |
| `bak-hyeokgeose` 06-bath | 글은 촌장들이 함께 씻기는데 한 사람뿐 |
| `bame-chajaon-dokkaebi` 02-challenge | 글은 「키가 두 배」인데 그만큼 크지 않다. 표지는 두 배로 아주 잘 그렸다 |
| `bame-chajaon-dokkaebi` 05-remember | 전래동화에 **전구**가 떠 있다. 등잔불이나 반짝임으로 |


---

# 전수조사에서 나온 것 (2) — 스물일곱 권까지

## 같은 사람이 딴사람으로 그려졌다

| 자리 | 무엇이 |
|---|---|
| `heungbujeon` story-01-b · story-01-c | **놀부 아내(형수)가 딴사람이다.** 01-b는 마르고 각진 얼굴에 눈살을 잔뜩 찌푸린 붉그죽죽한 낯, 01-c는 동글동글하고 볼이 발그레한 얼굴. **01-c 쪽이 맞다.** 01-b는 「악당을 흉하게 그리지 말라」에도 걸린다. 01-c의 얼굴로 다시 그려 주기 바란다 |
| `geuneul-san-saram` 10-beg · 11-return | 부자가 03~07에서는 **둥글둥글하고 살진 얼굴**인데, 10·11에서는 **머리가 벗어지고 홀쭉한 긴 얼굴**이다. 갓을 벗은 것만으로는 얼굴형이 바뀌지 않는다 |

## 글과 어긋난 것

| 자리 | 무엇이 |
|---|---|
| `halmikkot` 10-flower | 할머니가 **아직 살아 계신데 할미꽃이 이미 피어 있다.** 할미꽃은 할머니가 돌아가신 이듬해 봄에 핀다. 이 그림에는 할미꽃이 없어야 한다 |
| `hokburi-yeonggam` 12-two | 욕심쟁이가 **두 손으로 얼굴을 가려 혹 둘이 보이지 않는다.** 「혹 떼러 갔다 혹 붙여 온다」가 이 이야기의 웃음거리다. 양쪽 턱에 혹이 하나씩 덜렁덜렁 달린 것이 대번에 보여야 한다 |
| `horangi-sogin-tokki` 01-caught | 글은 「커다란 앞발로 토끼를 콱 눌렀어요」인데 호랑이가 그냥 걸어오고 토끼는 태연히 앉아 있다 |

## 낮은 순위

| 자리 | 무엇이 |
|---|---|
| `horangi-hyeongnim` 11-confess · 12-know | 글은 「털이 허옇게 세어 있었지요」인데 호랑이가 여전히 젊다 |
| `honggildongjeon` story-01-c | 「똑같은 얼굴이 여덟」인데 그림자로만 보여 여덟인지 알 수 없다 |
| `haewa-dari-doen-onui` 03-pass | 호랑이가 둘로 보인다. 같은 호랑이가 고개마다 나타나는 이야기다 |
| `gyeonu-jiknyeo` 06-parted · 08-river | 두 그림이 많이 닮았다. 06은 갈라지는 순간, 08은 일 년 뒤 다시 만나려는 순간 |


---

# 전수조사에서 나온 것 (3) — 예순두 권 925장을 다 봤습니다

## 꼭 고쳐 주었으면 하는 것

| 자리 | 무엇이 |
|---|---|
| `singihan-jeolgu` 07-more | **말풍선에 영어로 「SCREAM!」이 적혀 있다.** 우리 옛이야기 그림책이다. 글자를 아예 빼거나 「으아악!」처럼 우리말로 |
| `pureun-gusul` 10-threat | **고양이가 벌써 푸른 구슬을 들고 있다.** 이때 구슬은 아직 자물쇠 채운 궤짝 속에 있다. 쥐들이 궤를 갉아 낸 다음 쪽(11-gnaw)에서야 나온다. 이 그림에서는 구슬을 빼야 한다 |
| `tokkijeon` story-05-b · story-05-c | 두 그림이 거의 같다. **05-b**는 군사들이 창을 겨누고 토끼가 새파랗게 질리는 순간, **05-c**는 토끼가 배를 쑥 내밀고 「어디 갈라 보십시오」 하며 웃는 순간으로 갈라 주기 바란다 |

## 낮은 순위

| 자리 | 무엇이 |
|---|---|
| `uijoheun-hyeongje` 07-morning · 08-again | 두 아침 그림이 거의 같다. 이야기가 「이튿날도 똑같았다」이니 뜻은 맞지만, 아이가 쪽을 넘긴 줄을 모른다. 07은 형과 아우가 **따로** 제 논 앞에서 갸웃하는 모습으로 갈라 주면 좋겠다 (글도 따로다) |
| `patjuk-halmeom` 05-cry | 밤과 자라가 **벌써 부엌에 나와** 함께 울고 있다. 글에서는 다음 쪽부터 하나씩 찾아온다 |
| `samnyeon-gogae` 04-stumble | 글은 「엽전이 사방으로 흩어졌어요」인데 엽전이 없다 |
| `pureun-gusul` 10-threat | 고양이 얼굴이 송곳니에 눈을 가늘게 뜬 악당 얼굴이다. 이 고양이는 주인공이다 |

## 아무 탈 없던 책 (마흔여섯 권)

강도 잡은 개 · 곶감과 호랑이 · 구렁덩덩 신선비 · 견우와 직녀 ·
금도끼 은도끼(09·10만) · 꾀 많은 소년 · 꽁지 닷발 주둥이 닷발 ·
김수로 · 나이 자랑 · 나무꾼과 선녀 · 망두석 재판 · 멸치의 꿈 ·
무영탑 · 삼년 고개 · 삼형제의 재주 · 석탈해 · 심청전 · 옹고집전 ·
온달과 평강 · 요술 항아리 · 우렁이 색시 · 연이와 버들 도령 ·
이야기 주머니 · 임금님 귀는 당나귀 귀 · 자린고비 · 좁쌀 한 톨 ·
주인 구한 누렁이 · 주몽 · 쥐 사위 · 지게 이야기 · 진주와 거위 ·
춘향전 · 콩쥐팥쥐 · 토끼 재판 · 홍길동전 · 황소가 된 농부 ·
빨간 부채 파란 부채 · 밤에 찾아온 도깨비 · 반쪽이 · 은혜 갚은 두꺼비 외

**그림이 아주 좋습니다.** 특히 다음은 글보다 그림이 앞섭니다.
  무영탑 14-tower  못에 두 사람의 얼굴이 나란히 비친다
  옹고집전 01-c    한 집 안에서 아들 방은 따뜻하고 어머니 방은 얼음장이다
...
# 받은 것 확인 (2026-08-30) — 열은 해결, 열셋 남았습니다
...
# 05:30 확인 — **미해결 없음. 스물셋 다 해결됐습니다** ✔

마지막 열셋도 다 고쳐져 왔습니다. 하나씩 눈으로 확인했습니다.

| 자리 | 확인한 것 |
|---|---|
| `bak-hyeokgeose` 03-horse | **앞무릎을 꿇고 고개를 들어 울고 있습니다.** 붉은 알도 사라졌습니다 |
| `bak-hyeokgeose` 02-light | 촌장이 **여섯**입니다 (세어 봤습니다) |
| `bak-hyeokgeose` 11-thirteen | 촌장이 왼쪽 셋 오른쪽 셋 **여섯**, 뒤에 마을 사람이 가득합니다 |
| `heungbujeon` story-01-b | 놀부 아내가 **01-c와 같은 둥글고 발그레한 얼굴**이 되었습니다 |
| `geuneul-san-saram` 10-beg · 11-return | 부자가 **05와 같은 사람**입니다. 대머리에 홀쭉하던 얼굴이 사라졌습니다 |
| `hokburi-yeonggam` 12-two | **혹 둘이 양쪽 볼에 하나씩** 대롱대롱 달렸습니다. 손도 얼굴을 안 가립니다 |
| `geumdokki-eundokki` 10-greedy | 욕심쟁이가 **09와 같은 파란 도포의 어른**입니다. 색동저고리가 사라졌습니다 |
| `dokkaebi-gamtu` 16-burn | **개울가에 돌쇠와 도깨비 하나만** 나란히 앉아 있습니다 |
| `halmikkot` 10-flower | 할미꽃이 사라졌습니다. 진달래만 피어 있습니다 |
| `horangi-sogin-tokki` 01-caught | 호랑이가 **앞발로 토끼를 콱 누르고** 있습니다 |
| `eunhye-kkachi` 05-coil · 06-revenge | 05는 **구렁이가 몸을 칭칭 감고** 있고, 06은 여인이 나타나 손가락질합니다. 두 장면이 갈라졌습니다 |
| `banggwi-myeoneuri` 05-boom · 06-fly | 05는 집이 온전한 채 회오리가 뿜어져 나오고, 06은 지붕이 날아갑니다. 갈라졌습니다 |
| `cheonggaeguri` 05-sick · 06-plan | 06에 **생각 풍선(산과 개울)**이 들어가 갈라졌습니다. 엄마가 무슨 궁리를 하는지 그림만 봐도 압니다 |

## 마무리

    62권 925장 · 진짜 webp 925 · 가짜 0 · png 0
    없는 그림 0 · 안 쓰는 그림 0 · 겹친 그림 0
    62권 · 칸 1768 · 문항 434 · 본문 227,010자 — 이상 없음
    소설 그림 닻 135개 다 살아 있음

**꼭 고칠 것 스물셋은 다 끝났습니다.** 다만 아래 「낮은 순위」가 아직
남아 있습니다. 제가 「다 끝났다」고 적었던 것은 잘못이었습니다.
