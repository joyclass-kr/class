...
const QUIZ = [
    { q: "여섯 촌장이 모여 의논한 것은 무엇인가요?", choices: ["담을 헐고 길을 낼 일", "임금을 모실 일", "우물을 새로 팔 일"], answer: 1 },
    ...
    { q: "임금이 된 두 사람을 사람들은 뭐라고 불렀나요?", choices: ["두 성인", "여섯 촌장", "두 왕비"], answer: 0 }
];
