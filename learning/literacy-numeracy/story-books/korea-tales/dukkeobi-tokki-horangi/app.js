        ...
        beats: [
            {
                ...
                emoji: "🍡",
                left: [
                    "어느 가을날, 호랑이와 토끼와 두꺼비가 한자리에 모였습니다.",
                    "김이 모락모락 나는 떡시루가 놓여 있었지요. 갓 쪄 낸 하얀 떡이 수북이 담겨 있었습니다.",
                    "마을 잔치에서 얻어 온 떡이었어요.",
                    "구수한 김이 언덕 아래까지 퍼져 나갔어요.",
                    "셋이 시루를 빙 둘러싸고 언덕에 올라앉았지요."
                ],
                right: [
                    "\"야, 맛있겠다!\"",
                    "토끼가 코를 벌름거렸어요.",
            ...
            },
            {
                ...
                right: [
                    ...
                    "토끼도 지지 않고 귀를 쫑긋 세웠어요.",
                    "둘은 코가 닿을 만큼 얼굴을 들이밀었습니다.",
            ...
            },
            {
                ...
                emoji: "🐸",
                left: [
                    "호랑이와 토끼가 한참을 옥신각신했어요.",
                    "해가 벌써 기울고 있었어요.",
                    "그동안 두꺼비는 한마디도 하지 않았지요. 시루 옆에 앉아 눈만 껌뻑거렸습니다.",
                    "\"두꺼비, 너는 왜 가만있어?\"",
                    "토끼가 두꺼비를 툭 건드렸지요."
                ],
                right: [
                    ...
                    "두꺼비는 느릿느릿 대답했어요.",
                    "얼굴에는 아무 기색도 없었어요.",
                    "호랑이와 토끼는 코웃음을 치고는 다시 다투기 시작했지요.",
                    "두꺼비는 그저 언덕 아래만 내려다보았지요."
                ]
            }
        ]
    },
        ...
        beats: [
            {
                ...
                right: [
                    ...
                    "\"먼저 잡는 이가 다 먹기로 하고요.\"",
                    "두꺼비는 언덕 아래를 턱으로 가리켰습니다.",
                    "언덕은 길고 비탈이 제법 가팔랐답니다."
                ]
            },
            {
                art: "05-agree.webp",
                ...
                right: [
                    "둘은 벌써 출발선에 서서 몸을 풀었습니다.",
                    "호랑이는 발톱으로 땅을 긁고, 토끼는 뒷다리를 폈다 굽혔다 했지요.",
                    "둘 다 두꺼비는 안중에도 없었어요.",
            ...
            },
            {
                ...
                left: [
                    "\"하나, 둘, 셋!\"",
                    "두꺼비가 시루를 슬쩍 밀었어요.",
                    "떡시루가 언덕 아래로 데굴데굴 굴러갔습니다.",
                    "\"내 거다!\"",
                    "\"제가 먼저예요!\""
                ],
                right: [
                    "호랑이와 토끼는 쏜살같이 시루를 쫓아 내려갔어요.",
                    "둘은 뒤도 돌아보지 않았어요.",
                    "흙먼지가 뿌옇게 일었지요.",
                    "두꺼비는 그 뒷모습을 한참 바라보다가 엉금엉금 걷기 시작했습니다.",
                    "서두를 까닭이 하나도 없었으니까요."
                ]
            }
        ]
        ...
        beats: [
            {
                ...
                left: [
                    "두꺼비는 느릿느릿 언덕을 내려갔어요.",
                    "한 걸음, 또 한 걸음. 서두르는 기색이라고는 조금도 없었지요.",
                    "대신 눈은 부지런히 땅바닥을 살폈습니다.",
                    "숨도 차지 않았지요."
                ],
                right: [
                    "그런데 시루가 구를 때마다 떡이 한 조각씩 툭, 툭 떨어졌어요.",
                    "언덕 여기저기에 하얀 떡이 흩어졌습니다.",
                    "떡은 풀 위에 얌전히 놓여 있었어요.",
                    "두꺼비는 그것을 하나도 놓치지 않았지요."
                ]
            },
            {
                art: "08-eat.webp",
                ...
                right: [
                    "떡은 주워도 주워도 계속 나왔어요. 몇 걸음마다 한 조각씩 놓여 있었으니까요.",
                    "두꺼비의 배가 점점 볼록해졌습니다.",
            ...
            },
            {
                ...
                emoji: "😳",
                left: [
                    "언덕 아래에서 시루가 나무에 부딪혀 멈췄어요.",
                    "호랑이와 토끼가 동시에 시루를 붙잡았지요.",
                    "\"내가 먼저!\" \"아니에요, 제가 먼저!\"",
                    "둘은 숨을 헐떡이며 서로를 노려보았습니다."
                ],
                right: [
                    "그런데 시루 안을 들여다본 순간, 둘 다 입을 다물었어요.",
                    "호랑이가 시루를 뒤집어 보았어요.",
                    "텅.",
                    "떡이 한 조각도 남아 있지 않았거든요. 굴러오는 동안 죄다 흘린 것이지요.",
                    "둘은 서로 얼굴만 쳐다보았지요."
                ]
            },
            {
                ...
                emoji: "🐸",
                left: [
                    "둘은 부랴부랴 언덕을 다시 올라갔습니다.",
                    "떡이 어디로 갔는지 알아야 했거든요.",
                    "두꺼비가 볼록한 배를 두드리며 앉아 있었지요.",
                    "\"아이고 배불러. 잘 먹었습니다.\""
                ],
                right: [
                    "\"너, 너 언제 다…!\"",
...
const QUIZ = [
    ...
    { q: "두꺼비는 언덕을 내려가며 무엇을 했나요?", choices: ["흙먼지를 일으키며 달렸다", "땅바닥만 내려다보았다", "시루를 뒤집어 보았다"], answer: 1 }
];
