        ...
        "beats": [
            ...
            },
            {
                ...
                "right": [
                    ...
                    "\"저길 어떻게 올라가시라고?\"",
                    "하인 하나가 소곤거렸지요. 왕비는 못 들은 척 고개를 돌렸습니다.",
                    "\"자, 이제 됐다.\"",
        ...
        "beats": [
            {
                ...
                "left": [
                    ...
                    "이불 꼭대기는 창턱보다도 높았지요.",
                    "\"편히 주무세요.\"",
                    "왕비가 문을 닫았습니다. 그러고는 문에 귀를 댔지요."
                ],
                "right": [
                    "아가씨는 이불 속에 몸을 뉘었습니다. 온몸이 노곤했지요.",
                    "그런데 등 밑에 뭔가 딱딱한 것이 배겼습니다.",
                    "이리 뒤척 저리 뒤척 몸을 돌렸지요. 그때마다 이불 마흔 장이 통째로 출렁였습니다.",
                    "\"이게 대체 뭐지?\"",
                    "어느 쪽으로 누워도 그 자리가 배겼습니다."
                ]
            },
            {
                ...
                "emoji": "🌙",
                "left": [
                    "아가씨는 일어나 앉아 이불을 하나하나 들춰 보았지요.",
                    "하지만 아무것도 없었습니다. 요 스무 장을 다 걷어 낼 수는 없었지요.",
                    "문밖에서는 왕비가 귀를 바짝 대고 있었습니다.",
                    "\"뒤척이는구나. 뒤척이는구나!\"",
...
const QUIZ = [
    ...
    },
    {
        ...
        "wide": true,
        "choices": [
                "왕비가 요를 스무 장 가져오라 했을 때 하인들이 서로 얼굴을 쳐다본 것을 보면, 잘못 들은 줄 알았던 거야.",
                "아가씨가 잠시 망설이다 한숨도 못 잤다고 말한 것을 보면, 거짓말을 하기가 싫었던 거지.",
                "마지막에 이것은 정말로 있었던 이야기라고 한 것을 보면, 안데르센이 시치미를 뚝 뗀 거구나.",
                "왕비가 이튿날 아가씨에게 완두콩 이야기를 먼저 털어놓고 사과한 것을 보면, 시험한 것이 마음에 걸린 거야."
            ],
        "answer": 3
    }
];
