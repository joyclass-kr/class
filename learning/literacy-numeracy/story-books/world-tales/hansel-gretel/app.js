        ...
        "beats": [
            {
                ...
                "right": [
                    "할머니가 자고 있던 헨젤을 거칠게 끌어냈습니다. 그러고는 마당의 우리에 가두었지요.",
                    "\"살이 오르면 놓아주마.\"",
                    "그레텔에게는 일을 시켰습니다.",
                    "\"물을 긷고 밥을 지어라.\"",
                    "\"네 오빠를 먹여야 하니까.\""
...
const QUIZ = [
    ...
    },
    {
        ...
        "wide": true,
        "choices": [
                "헨젤이 지붕 위 고양이를 보고 있었다고 둘러댄 것을 보면, 조약돌 떨어뜨리는 것을 들키지 않으려 한 거야.",
                "그레텔이 제 빵을 반으로 떼어 오빠 손에 쥐여 준 것을 보면, 오빠가 무엇을 하려는지 알아챈 거지.",
                "그레텔이 어떻게 들어가는지 모르겠다고 한 것을 보면, 시치미를 떼고 때를 기다린 거구나.",
                "두 아이가 과자 집을 나서며 남은 과자를 조금 챙긴 것을 보면, 돌아가는 길이 멀 줄 알았던 거야."
            ],
        "answer": 3
    }
];
