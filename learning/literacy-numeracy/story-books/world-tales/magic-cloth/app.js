        ...
        "beats": [
            {
                ...
                "left": [
                    ...
                    "\"두 번 다 그 주막이란 말이지.\"",
                    "무언가 짚이는 것이 있었지요. 막내는 나무를 깎으며 생각을 굴렸습니다. 대팻밥이 발밑에 소복이 쌓였지요."
                ],
                "right": [
        ...
        "beats": [
            {
                ...
                "right": [
                    "\"이것도 찾아왔지요.\"",
                    "두 형은 헛기침만 했습니다. 막내는 마당 한가운데 식탁보를 펼쳤지요. 아버지가 지팡이를 짚고 나왔습니다.",
                    "온 식구가 빙 둘러섰지요.",
                    "\"펼치고 차려라!\"",
                    "음식이 상다리가 휘도록 차려졌습니다."
                ]
...
const QUIZ = [
    ...
    },
    {
        ...
        "wide": true,
        "choices": [
                "막내가 형들이 묵었던 그 주막을 일부러 골라 간 것을 보면, 두 번 다 그 집이라는 것을 짚어 낸 거야.",
                "막내가 자루에 세상에서 제일 귀한 것이 들었다고 큰소리친 것을 보면, 주인이 손을 대게 만들려던 거지.",
                "주인이 나중에는 몽둥이 소리만 들어도 얼굴이 하얘진 것을 보면, 그 밤 일이 몸에 남은 거구나.",
                "막내가 주막 주인에게 식탁보를 한 번 펼쳐 대접해 준 것을 보면, 앙갚음으로 끝내지 않은 거야."
            ],
        "answer": 3
    }
];
