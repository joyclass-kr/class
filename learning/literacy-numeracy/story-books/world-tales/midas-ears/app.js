        ...
        "beats": [
            ...
            },
            {
                ...
                "left": [
                    ...
                    "\"말하면 큰일 날 줄 알아라.\"",
                    "\"예, 예! 절대로 말하지 않겠습니다!\"",
                    "이발사는 몇 번이나 고개를 숙였지요. 손이 떨려 가위질도 제대로 못 했습니다. 겨우 머리를 깎고 밖으로 나왔지요."
                ],
                "right": [
...
const QUIZ = [
    ...
    },
    {
        ...
        "wide": true,
        "choices": [
                "이발사가 얼굴은 반쪽이 되고 배만 불룩해진 것을 보면, 못 한 말이 그 안에 쌓이는 것 같았던 거야.",
                "땅에다 소리치고 나자 불룩하던 배가 스르르 꺼진 것을 보면, 말하고 나서야 몸이 풀린 거지.",
                "임금님이 모자를 벗고 마당으로 나간 것을 보면, 온 나라가 다 아는 마당에 숨길 것이 없어진 거구나.",
                "아폴론이 당나귀 귀가 어울리겠다고 한 것을 보면, 임금님이 알아듣도록 미리 일러 준 거야."
            ],
        "answer": 3
    }
];
