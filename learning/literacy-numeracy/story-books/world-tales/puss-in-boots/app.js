...
const QUIZ = [
    ...
    },
    {
        ...
        "wide": true,
        "choices": [
                "고양이가 자루에 당근을 넣고 풀숲에 납작 엎드린 것을 보면, 토끼가 제 발로 들어오게 한 거야.",
                "고양이가 주인의 옷을 풀숲 깊이 밀어 넣은 것을 보면, 도둑이 가져갔다고 할 셈이었지.",
                "일꾼들이 카라바가 누구냐고 물은 것을 보면, 그 이름을 그때 처음 들은 거구나.",
                "막내가 잔치에서 공주에게 제가 방앗간에서 자랐다고 말한 것을 보면, 고양이가 그렇게 말하라고 미리 일러 준 거야."
            ],
        "answer": 3
    }
];
