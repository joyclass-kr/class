/* 사실을 묻는 문항에서, 틀린 보기가 본문에 그대로 있는지 본다.
   ...
   ■ 93군데를 다 열어 봤다 — 이 잣대가 재는 병은 하나도 없었다
   93군데를 한 자리씩 읽고, 아리송한 열한 군데는 본문을 펼쳐 대 봤다.
   전부 「때가 다른 일을 가져다 쓴 좋은 오답」이었다.
     알라딘 「램프의 지니」   반지의 지니가 꺼내 준 자리를 묻는데, 램프는 뒤의 일
     미다스 「이발사를 불렀다」 소문을 듣기 훨씬 전의 일
     호두까기 「호두까기 인형」 대부님이 가져온 것은 태엽 성, 인형은 나무 아래 있었다
     구두장이 「눈이 침침해서」 살림이 기운 까닭은 「값을 헐하게 받았거든요」
   그러니 이 잣대는 붙였다 뗐다 하는 저울이 아니라 읽을 거리 목록이다.
   93이 예사 값이고, 수가 늘면 는 자리만 열어 보면 된다.

   ■ 문턱을 조여 보려다 그만두었다
   「토막만 겹친 것」을 버리려고 겹친 길이가 오답의 몇 할인지로 걸러 봤다.
   그런데 우리말은 끝이 잘려서, 「노란 열매를 먹어서」가 본문에 통째로 있어도
   겹친 토막은 「노란 열매를 먹」까지라 여덟 할이 안 된다. 문턱을 어디에 두든
   통째로 베낀 것과 토막만 겹친 것이 같이 버려졌다. 그래서 두었다.

   ■ 이 잣대가 못 보는 자리 — 실제로 하나 나왔다
   황금 사슴 4번 보기가 「새끼를 밸 몸이라」였다. 배다는 아기가 생긴다는 뜻이니
   이미 밴 사슴에게는 안 맞는 말이다. 본문은 「곧 새끼를 낳을 몸이었거든요」라
   적혀 있었다. 본문에 맞춰 고쳤다.
   이런 것은 오답이 본문에 있는지도 아니고 답이 본문에 없는지도 아니어서
   지금 있는 어느 잣대에도 안 걸린다. 눈으로 읽다 옆에서 걸린 것이다. */
