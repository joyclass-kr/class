...
const QUIZ = [
    ...
    },
    {
        ...
        "wide": true,
        "choices": [
                "시장이 이만 닢인들 주겠다더니 쥐가 사라지자 오십 닢을 민 것을 보면, 곤란이 끝나자 셈이 달라진 거야.",
                "사나이가 값을 두 번 청하지 않는다고 한 것을 보면, 그 자리에서 이미 다른 것을 받기로 마음먹은 거지.",
                "목발 짚은 아이 앞에서 무릎을 굽히고 피리를 내린 것을 보면, 제가 무엇을 하려던 것인지 그제야 돌아본 거구나.",
                "사나이가 아이들을 돌려보낸 뒤 목발 짚은 아이를 업고 마을까지 데려다준 것을 보면, 끝까지 마음을 쓴 거야."
            ],
        "answer": 3
    }
];
