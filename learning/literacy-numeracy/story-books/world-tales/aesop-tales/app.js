...
const QUIZ = [
    ...
    { q: "까마귀가 붙인 깃털은 어떻게 됐나요?", choices: ["새들이 도로 뽑아 갔다", "바람에 날아갔다", "그대로 붙어 있었다"], answer: 0 },
    {
        ...
        "wide": true,
        "choices": [
                "사자가 놓아준 쥐가 나중에 그물을 갉아 준 것을 보면, 작은 것이 큰 것을 돕기도 하는 거야.",
                "북풍이 세게 불수록 나그네가 옷깃을 더 여민 것을 보면, 밀어붙일수록 오히려 닫히는 거구나.",
                "개가 물속 그림자에 짖다가 물고 있던 고기를 놓친 것을 보면, 더 바라다가 가진 것을 잃은 거지.",
                "베짱이가 개미의 문을 두드린 것을 보면, 여름내 들려준 노래의 값을 받으러 간 거야."
            ],
        "answer": 3
    }
];
