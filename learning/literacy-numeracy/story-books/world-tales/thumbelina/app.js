...
const QUIZ = [
    ...
    },
    {
        ...
        "wide": true,
        "choices": [
                "물고기들이 잎 줄기를 갉아 끊어 준 것을 보면, 울음소리를 물속에서 다 듣고 있었던 거야.",
                "엄지 공주가 한밤에 건초를 안고 굴로 간 것을 보면, 아무도 시키지 않았는데 제 발로 간 거지.",
                "마지막에 날개를 달고 처음으로 스스로 날아오른 것을 보면, 그때까지는 늘 남이 옮겨 주었구나.",
                "엄지 공주가 떠나며 들쥐 아주머니께 겨울을 나게 해 줘 고맙다고 인사한 것을 보면, 신세 진 일을 잊지 않은 거야."
            ],
        "answer": 3
    }
];
