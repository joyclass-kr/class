    ...
    },
    {
        ...
        "beats": [
            ...
            },
            {
                ...
                "emoji": "👀",
                "left": [
                    "둘은 작업대로 폴짝 올라가 연장을 잡았습니다. 어찌나 빠른지 눈으로 따라가기가 어려웠지요.",
                    "\"자, 이번에는 못을 박아야지.\"",
                    "톡톡, 톡톡.",
                    "\"나는 번쩍번쩍 광을 내야지.\"",
                    "쓱쓱, 싹싹."
                ...
                "right": [
                    "가죽 조각이 손안에서 저절로 신발이 되어 갔지요. 흥얼흥얼 노래까지 불렀습니다.",
...
const QUIZ = [
    ...
    },
    {
        ...
        "choices": [
                ...
                "가죽이 한 장 남았을 때도 재고 오려 작업대에 올려 둔 것을 보면, 마지막까지 제 일을 놓지 않은 거지.",
                "부부가 가죽 대신 옷과 구두를 올려놓은 것을 보면, 한겨울에 맨발인 것을 보고 그냥 있을 수 없었구나.",
