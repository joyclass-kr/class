...
> - `story-07-wedding` — 궁궐 깃발이 **태극기**입니다. 프랑스 이야기이니 그냥 왕실 깃발이나 무늬 없는 깃발로 바꿔 주세요.
> - `story-03-magic` · `story-03-magic-2` — 배경 담장이 **한옥 기와 담장**입니다. 유럽식 돌담이나 나무 울타리로.
> - `story-04-ball-2` · `story-05-search` — 시계탑이 **런던 빅벤**입니다. 그냥 궁궐 시계탑이나 마을 종탑으로.
