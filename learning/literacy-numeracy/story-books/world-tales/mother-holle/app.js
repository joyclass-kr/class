        ...
        "beats": [
            ...
            },
            {
                ...
                "left": [
                    ...
                    "한참을 자으니 손끝이 아파 왔지요. 보니 실을 감는 물레가락에 피가 묻어 있었습니다. 빨간 점이 실에까지 배어 있었지요.",
...
const QUIZ = [
    ...
    },
    {
        ...
        "wide": true,
        "choices": [
                "언니가 무서웠을 텐데도 우물로 뛰어든 것을 보면, 찾아오지 않으면 들어올 생각도 말라는 말을 들은 거야.",
                "언니가 손이 발갛게 익도록 빵을 다 꺼낸 것을 보면, 제 갈 길이 급한 중에도 부탁을 지나치지 못한 거지.",
                "동생이 가시로 손끝을 찔러 피를 낸 것을 보면, 실 잣기는 귀찮고 금은 받고 싶었던 거구나.",
                "동생이 송진을 뒤집어쓰고 돌아온 뒤 언니에게 사과한 것을 보면, 그제야 제 잘못을 안 거야."
            ],
        "answer": 3
    }
];
