...
const QUIZ = [
    ...
    },
    {
        ...
        "wide": true,
        "choices": [
                "왕자가 살아 있을 때 담 안에서만 지낸 것을 보면, 슬픈 것을 본 적이 없어 행복했던 거야.",
                "제비가 한참 뒤에 어느 골목이냐고 슬그머니 물은 것을 보면, 떠나려던 마음을 스스로 돌린 거지.",
                "납으로 된 심장만은 아무리 넣어도 녹지 않은 것을 보면, 용광로도 어쩌지 못한 것이 있었구나.",
                "제비가 남쪽 동무들에게 늦는다고 미리 기별을 보낸 것을 보면, 약속을 저버린 것은 아니었던 거야."
            ],
        "answer": 3
    }
];
