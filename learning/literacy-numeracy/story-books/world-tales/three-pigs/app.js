...
const QUIZ = [
    ...
    },
    {
        ...
        "wide": true,
        "choices": [
                "막내가 언덕에서 바람이 어느 쪽에서 오는지 살핀 것을 보면, 짓기 전에 자리부터 본 거야.",
                "막내가 불을 피워 연기가 잘 빠지는지 보아 둔 것을 보면, 눈에 안 보이는 데까지 챙긴 거지.",
                "두 형이 덧문과 빗장을 왜 다느냐고 물은 것을 보면, 그것이 무엇을 막는 것인지 아직 몰랐구나.",
                "막내가 두 형에게 벽돌 쌓는 법을 하나하나 가르쳐 준 것을 보면, 형들이 이듬해 제 집을 지을 수 있었던 거야."
            ],
        "answer": 3
    }
];
