...
const CHAPTERS = [
    ...
    },
    {
        ...
        paras: [
            ...
            `그 무렵 미국은 서쪽으로 계속 넓어지고 있었습니다. 동쪽 바닷가에서 시작해 해마다 서쪽으로 나아갔습니다. 백 해 만에 반대쪽 바다까지 닿았습니다. 그리고 그 땅에는 이미 사람이 살고 있었습니다. 빈 땅이 아니었습니다. 마을이 있고 밭이 있고 무덤이 있었습니다. 그러니 그 땅을 가지려면 무언가 설명이 필요했습니다. 빼앗는 데에도 이유가 필요합니다. 그냥 가져가면 자기도 마음이 편치 않습니다. 그래서 이유를 만듭니다.`,
