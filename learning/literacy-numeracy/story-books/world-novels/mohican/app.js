...
const AFTERWORD = {
    ...
    paras: [
        ...
        `쿠퍼는 이 이야기를 다섯 권으로 이어 썼습니다. 매사냥꾼이 젊을 때부터 늙어 죽을 때까지를 그린 것입니다. 이 책은 그 가운데 한 권인데, 다섯 권 중 제일 널리 읽힙니다.`,
        `쓴 순서와 이야기 순서가 다릅니다. 쿠퍼는 늙은 매사냥꾼을 먼저 쓰고 젊은 시절을 나중에 썼습니다.`,
        ...
        `모히칸이라는 이름은 사실 두 부족의 이름이 섞인 것입니다. 허드슨강 쪽의 마히칸과 코네티컷 쪽의 모히건이 있었는데, 쿠퍼가 둘을 하나로 만들어 썼습니다.`,
