...
$$('[data-language]').forEach(b=>b.addEventListener('click',async()=>{selectLanguage(b.dataset.language);if(state.mode==='words')await wordBankReady;setup()}));
