...
const state={lang:'ko',level:0,mode:'words',index:0,start:0,typed:0,correct:0,streak:0,speeds:[],sound:true,locked:false};
...
$$('[data-language]').forEach(b=>b.addEventListener('click',()=>{selectLanguage(b.dataset.language);setup()}));
