(function (root, factory) {
    ...
    const entries = [
        ...
        ,
        { id:"samilcheonha", word:"삼일천하", hanja:"三日天下", hanjaExpl: "三 (석 삼) · 日 (날 일) · 天 (하늘 천) · 下 (아래 하)", theme:"재능·기세", meaning:"아주 짧은 기간 동안 권세를 잡았다가 곧 잃음.", story:"사흘 동안 천하를 다스린다는 뜻으로 권세나 형편이 오래가지 못하는 상황을 비유합니다.", lesson:"눈앞의 성공에 자만하지 말고 오래 지속할 바탕을 마련해야 합니다.", source:"일반 한자 성어", sourceNote:"석 삼, 날 일, 하늘 천, 아래 하를 써서 매우 짧게 누린 권세를 나타냅니다.", reference:"https://stdict.korean.go.kr/search/searchResult.do?pageNo=1&searchKeyword=%EC%82%BC%EC%9D%BC%EC%B2%9C%ED%95%98", verification:"사전 확인" },
        { id:"dongsimhyeomnyeok", word:"동심협력", hanja:"同心協力", hanjaExpl: "同 (같을 동) · 心 (마음 심) · 協 (협력할 협) · 力 (힘 력)", theme:"관계·교유", meaning:"같은 마음으로 서로 힘을 합쳐 협력함.", story:"여러 사람이 한마음이 되어 각자의 힘을 보태면 혼자 하기 어려운 일도 이룰 수 있다는 뜻입니다.", lesson:"공동 목표를 분명히 하고 서로의 역할을 존중하며 힘을 모아야 합니다.", source:"일반 한자 성어", sourceNote:"한가지 동, 마음 심, 도울 협, 힘 력을 써서 마음과 힘을 함께 모음을 나타냅니다.", reference:"https://stdict.korean.go.kr/search/searchResult.do?pageNo=1&searchKeyword=%EB%8F%99%EC%8B%AC%ED%98%91%EB%A0%A5", verification:"사전 확인" },
        { id:"sanjeonsujeon", word:"산전수전", hanja:"山戰水戰", hanjaExpl: "山 (산 산) · 戰 (싸움 전) · 水 (물 수) · 戰 (싸움 전)", theme:"노력·인내", meaning:"세상의 온갖 고생과 어려움을 다 겪음.", story:"산에서도 싸우고 물에서도 싸웠다는 말처럼 여러 어려움과 경험을 두루 겪은 사람을 가리킵니다.", lesson:"힘든 경험도 잘 돌아보면 다음 문제를 해결하는 지혜가 됩니다.", source:"일반 한자 성어", sourceNote:"메 산, 싸울 전, 물 수, 싸울 전을 써서 온갖 어려움을 겪었음을 나타냅니다.", reference:"https://stdict.korean.go.kr/search/searchResult.do?pageNo=1&searchKeyword=%EC%82%B0%EC%A0%84%EC%88%98%EC%A0%84", verification:"사전 확인" },
        { id:"cheonbangjichuk", word:"천방지축", hanja:"天方地軸", hanjaExpl: "天 (하늘 천) · 方 (모서리/방향 방) · 地 (땅 지) · 軸 (굴대/축 축)", theme:"지혜·처세", meaning:"방향 없이 함부로 덤벙거리거나 몹시 부산하게 행동함.", story:"하늘의 방향과 땅의 축조차 가리지 못하듯 갈피를 잡지 못하고 움직이는 모습을 나타냅니다.", lesson:"서두를수록 먼저 주변을 살피고 일의 순서를 정해야 합니다.", source:"일반 한자 성어", sourceNote:"하늘 천, 모 방, 땅 지, 굴대 축을 써서 방향 없이 부산한 모습을 나타냅니다.", reference:"https://stdict.korean.go.kr/search/searchResult.do?pageNo=1&searchKeyword=%EC%B2%9C%EB%B0%A9%EC%A7%80%EC%B6%95", verification:"사전 확인" },
        ...
        { id:"munjeonseongsi", word:"문전성시", hanja:"門前成市", hanjaExpl: "門 (문 문) · 前 (앞 전) · 成 (이룰 성) · 市 (시장 시)", theme:"관계·교유", meaning:"문 앞이 시장을 이룬 듯 찾아오는 사람이 매우 많아 붐빔.", story:"권세가 있거나 이름난 사람의 집 문 앞에 사람들이 몰려 시장처럼 붐비는 모습을 나타냅니다.", lesson:"사람이 많이 모이는 까닭과 관계의 바탕을 살펴야 합니다.", source:"일반 한자 성어", sourceNote:"문 문, 앞 전, 이룰 성, 시장 시를 써서 문 앞이 시장처럼 붐빔을 나타냅니다.", reference:"https://stdict.korean.go.kr/search/searchResult.do?pageNo=1&searchKeyword=%EB%AC%B8%EC%A0%84%EC%84%B1%EC%8B%9C", verification:"사전 확인" },
        { id:"taksanggongnon", word:"탁상공론", hanja:"卓上空論", hanjaExpl: "卓 (탁자 탁) · 上 (위 상) · 空 (헛될 공) · 論 (논할 론)", theme:"지혜·처세", meaning:"현실성이 없는 이론이나 실제에 도움이 되지 않는 논의.", story:"책상 위에서 말로만 계획을 세우고 실제 현장의 사정은 살피지 않는 모습을 가리킵니다.", lesson:"좋은 생각도 현실에서 직접 시험하고 고쳐 나가야 쓸모가 있습니다.", source:"일반 한자 성어", sourceNote:"높을 탁, 위 상, 빌 공, 논할 론을 써서 책상 위의 헛된 논의를 나타냅니다.", reference:"https://stdict.korean.go.kr/search/searchResult.do?pageNo=1&searchKeyword=%ED%83%81%EC%83%81%EA%B3%B5%EB%A1%A0", verification:"사전 확인" },
        ...
        { id:"myeonggyeongjisu", word:"명경지수", hanja:"明鏡止水", hanjaExpl: "明 (밝을 명) · 鏡 (거울 경) · 止 (고요할/멈출 지) · 水 (물 수)", theme:"지혜·처세", meaning:"맑은 거울과 고요한 물처럼 깨끗하고 평온한 마음.", story:"고요히 멈춘 물에 자신을 비추어 본다는 《장자》의 비유와 맑은 거울의 이미지가 합쳐진 표현입니다.", lesson:"마음을 차분히 가라앉히면 상황과 자신을 더 또렷하게 볼 수 있습니다.", source:"《장자》 〈덕충부〉의 비유와 관련", sourceNote:"밝을 명, 거울 경, 그칠 지, 물 수를 써서 맑고 고요한 마음을 나타냅니다.", reference:"https://stdict.korean.go.kr/search/searchResult.do?pageNo=1&searchKeyword=%EB%AA%85%EA%B2%BD%EC%A7%80%EC%88%98", verification:"고전·사전 확인" },
        { id:"ingwaeungbo", word:"인과응보", hanja:"因果應報", hanjaExpl: "因 (원인 인) · 果 (결과 과) · 應 (응할 응) · 報 (갚을 보)", theme:"지혜·처세", meaning:"행한 일의 원인에 따라 알맞은 결과가 돌아옴.", story:"불교의 인과와 업보 사상에서 비롯되어 행동은 그에 맞는 결과를 낳는다는 뜻입니다.", lesson:"모든 선택에는 결과가 따르므로 이후의 영향까지 생각해야 합니다.", source:"불교 경전의 인과·업보 사상", sourceNote:"인할 인, 열매 과, 응할 응, 갚을 보를 써서 원인에 맞는 결과가 돌아옴을 나타냅니다.", reference:"https://stdict.korean.go.kr/search/searchResult.do?pageNo=1&searchKeyword=%EC%9D%B8%EA%B3%BC%EC%9D%91%EB%B3%B4", verification:"사전 확인" },
        { id:"dongseonambuk", word:"동서남북", hanja:"東西南北", hanjaExpl: "東 (동쪽 동) · 西 (서쪽 서) · 南 (남쪽 남) · 北 (북쪽 북)", theme:"지혜·처세", meaning:"동쪽·서쪽·남쪽·북쪽을 아울러 이르는 말로 모든 방향이나 여러 곳을 뜻함.", story:"네 방향을 함께 일컬으며 사방과 온 세상을 나타내는 표현입니다.", lesson:"한 방향만 보지 않고 여러 관점과 가능성을 두루 살펴야 합니다.", source:"일반 한자 성어", sourceNote:"동녘 동, 서녘 서, 남녘 남, 북녘 북을 써서 사방을 나타냅니다.", reference:"https://stdict.korean.go.kr/search/searchResult.do?pageNo=1&searchKeyword=%EB%8F%99%EC%84%9C%EB%82%A8%EB%B6%81", verification:"사전 확인" },
        { id:"dongmunseodap", word:"동문서답", hanja:"東問西答", hanjaExpl: "東 (동쪽 동) · 問 (물어볼 문) · 西 (서쪽 서) · 答 (대답할 답)", theme:"관계·교유", meaning:"묻는 말과 전혀 상관없는 엉뚱한 대답을 함.", story:"동쪽을 물었는데 서쪽을 대답한다는 뜻으로 질문과 답의 요점이 어긋난 상황을 나타냅니다.", lesson:"상대의 말을 정확히 듣고 질문의 핵심에 맞게 대답해야 합니다.", source:"일반 한자 성어", sourceNote:"동녘 동, 물을 문, 서녘 서, 대답 답을 써서 질문과 답이 어긋남을 나타냅니다.", reference:"https://stdict.korean.go.kr/search/searchResult.do?pageNo=1&searchKeyword=%EB%8F%99%EB%AC%B8%EC%84%9C%EB%8B%B5", verification:"사전 확인" },
        { id:"iyeolchyeol", word:"이열치열", hanja:"以熱治熱", hanjaExpl: "以 (써/가지고 이) · 熱 (더울/열 열) · 治 (다스릴 치) · 熱 (더울/열 열)", theme:"지혜·처세", meaning:"열은 열로써 다스린다는 뜻으로 같은 성질의 방법으로 어려움을 이겨 냄.", story:"더운 날 뜨거운 음식을 먹어 땀을 내고 더위를 이기듯 같은 성질의 방법으로 문제를 다스리는 모습입니다.", lesson:"상황에 따라 같은 원리로 정면 대응하는 방법이 효과적일 수 있습니다.", source:"일반 한자 성어", sourceNote:"써 이, 더울 열, 다스릴 치, 더울 열을 써서 열로 열을 다스림을 나타냅니다.", reference:"https://stdict.korean.go.kr/search/searchResult.do?pageNo=1&searchKeyword=%EC%9D%B4%EC%97%B4%EC%B9%98%EC%97%B4", verification:"사전 확인" },
