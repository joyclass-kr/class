(function () {
  ...
  // 반직선 읽는 순서 함정(반직선 ㄱㄴ, 반직선 ㄷㄴ ➔ X)을 반영한 수학 OX 데이터 세트
  const mathOxData = [
    // ==========================================
    // 🟡 [초등 3학년] (10문항)
    // ==========================================
    ...
    },
    {
      ...
      answer: "X",
      pitfall: "반직선은 '시작하는 꼭짓점'부터 읽어야 함을 간과하고 점 ㄱ이나 ㄷ에서 시작한다고 착각하기 쉽습니다.",
      reason: "반직선의 이름은 반드시 **시작하는 점부터** 읽어야 합니다! 꼭짓점 $\\text{ㄴ}$에서 출발하므로 올바른 변의 이름은 **반직선 $\\text{ㄴㄱ}$과 반직선 $\\text{ㄴㄷ}$**입니다!"
    },
    {
      id: 7,
      subject: "초3",
    ...
    // ==========================================
    {
      ...
      subject: "기하",
      topic: "SAT 전설의 낚시",
      prompt: "[SAT 출제 오류 문제] 반지름 1 인 원이 반지름 3 인 큰 원의 테두리를 따라 바깥쪽으로 한 바퀴 미끄럼 없이 돌아 제자리로 올 때 자전 횟수는 3 회이다.",
      answer: "X",
      pitfall: "둘레가 3배이므로 $3 \\div 1 = 3$회 회전할 것이라는 직관적 낚시입니다.",
      reason: "작은 원 중심이 이동한 궤적 반지름이 $3+1=4$가 되므로, 큰 원 둘레(3회) + 원 자체 자전(1회)이 더해져 **정확히 4 회** 회전합니다! (SAT 출제진도 낚였던 전설의 문제)"
    },
    {
      id: 126,
      subject: "기하",
