(function () {
  ...
  // 선생님의 깊이 있는 출제 매커니즘이 반영된 135개 수학 개념 OX 데이터 세트
  const mathOxData = [
    // ==========================================
    // 🟡 [초등 3학년] (10문항) - 개념의 본질 저격
    // ==========================================
    {
      id: 1,
      subject: "초3",
    ...
    },
    {
      ...
      subject: "초3",
      topic: "도형",
      prompt: "네 변의 길이가 모두 같은 사각형은 모두 정사각형이다.",
      answer: "X",
      pitfall: "네 변의 길이가 같으면 정사각형일 것이라는 직관적 오개념입니다.",
      reason: "네 변의 길이가 같고 네 각도 모두 직각이어야 정사각형입니다. 각이 직각이 아니면 **마름모**입니다."
    },
    {
      id: 10,
      subject: "초3",
    ...
    },
    {
      ...
      subject: "초5",
      topic: "도형의 관계",
      prompt: "네 변의 길이가 모두 같고 네 각이 모두 직각인 사각형은 마름모이면서 동시에 직사각형이다.",
      answer: "O",
    ...
    },
    {
      ...
      subject: "중1",
      topic: "소인수분해",
      prompt: "모든 자연수는 소인수분해를 하면 곱하는 순서를 제외하고 결과가 단 하나로 유일하다.",
      answer: "O",
    ...
    },
    {
      ...
      subject: "중2",
      topic: "연립방정식",
      prompt: "미지수가 2개인 연립일차방정식은 해를 오직 하나만 갖는다.",
      answer: "X",
    ...
    },
    {
      ...
      subject: "중3",
      topic: "원의 성질",
      prompt: "원에 내접하는 사각형에서 마주 보는 두 대각의 크기의 합은 항상 $180^\\circ$이다.",
      answer: "O",
    ...
    },
    {
      ...
      subject: "초6",
      topic: "선생님 저격 융합 8",
      prompt: "$12.6 \\div 0.3$을 계산할 때 나누어지는 수와 나누는 수에 각각 10을 곱해도 몫과 나머지는 모두 변하지 않는다.",
      answer: "X",
