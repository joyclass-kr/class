(function () {
  ...
  // 초·중·고 교육과정 엄격 반영 120여 개 대용량 수학 개념 OX 정예 데이터 세트
  const mathOxData = [
    // ==========================================
    // 🟡 [초등 3학년] (8문항)
    // ==========================================
    ...
    },
    {
      ...
      subject: "초3",
      topic: "나눗셈",
      prompt: "어떤 자연수를 1로 나누면 그 몫은 항상 1이 된다.",
      answer: "X",
      pitfall: "1로 나눌 때 몫이 1이 된다고 헷갈리기 쉽습니다.",
      reason: "어떤 수를 1로 나누면 몫은 자기 자신(예: $5 \\div 1 = 5$)이 됩니다."
    },
    {
      id: 7,
      subject: "초3",
      ...
      prompt: "직각은 예각보다 크다.",
      answer: "O",
      pitfall: "각의 종류별 크기 비교 기본 개념입니다.",
      reason: "직각은 $90^\\circ$이고 예각은 $0^\\circ$보다 크고 $90^\\circ$보다 작으므로 직각이 더 큽니다."
    },
    {
      id: 8,
      subject: "초3",
      topic: "원",
      prompt: "원의 중심에서 원 위의 한 점까지의 거리는 측정한 위치에 따라 서로 다르다.",
      answer: "X",
      pitfall: "원의 위치별 반지름 크기가 다를 것이라는 착각입니다.",
      reason: "원의 정의상 중심에서 원 위의 어느 점까지 연결해도 그 거리(반지름)는 항상 같습니다."
    },
    ...
    },
    {
      ...
      subject: "초5",
      topic: "분수",
      prompt: "분모가 다른 두 분수를 더할 때는 통분하지 않고 분모는 분모끼리, 분자는 분자끼리 더해도 된다.",
      answer: "X",
      pitfall: "이분모 분수의 덧셈 오개념입니다.",
      reason: "분모가 다를 때는 단위 크기가 다르므로 반드시 공통분모로 **통분한 후** 분자끼리 더해야 합니다."
    },
    {
      id: 25,
      subject: "초5",
    ...
    },
    {
      ...
      subject: "초5",
      topic: "도형과 측정",
      prompt: "평행사변형의 넓이는 밑변의 길이와 높이의 곱으로 구한다.",
      answer: "O",
      pitfall: "평행사변형 넓이 공식 확인 문항입니다.",
      reason: "평행사변형을 잘라 붙이면 직사각형이 되므로 넓이는 (밑변 $\\times$ 높이)가 맞습니다."
    },
    ...
    },
    {
      ...
      subject: "초6",
      topic: "비례식",
      prompt: "모든 비례식에서는 외항의 곱과 내항의 곱이 서로 같다.",
      answer: "O",
      pitfall: "비례식의 핵심 기본 성질입니다.",
      reason: "비례식 $a:b = c:d$ 에서 외항의 곱 $ad$와 내항의 곱 $bc$는 항상 같습니다."
    },
    {
      id: 34,
      subject: "초6",
    ...
    },
    {
      ...
      subject: "초6",
      topic: "공간과 입체",
      prompt: "쌓기나무로 만든 입체도형을 위에서 본 모양만 알면 사용된 쌓기나무의 개수를 정확히 알 수 있다.",
      answer: "X",
      pitfall: "평면 뷰(위에서 본 모양)만으로 입체 수량을 단정짓는 직관적 오류입니다.",
      reason: "위에서 본 모양은 바닥 1층의 배치만 보여줄 뿐, 위로 쌓인 층수는 알 수 없습니다."
    },
