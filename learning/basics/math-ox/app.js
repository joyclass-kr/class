(function () {
  ...
  // 초·중·고 교육과정 용어 엄격 반영 및 정교한 문장 재구성 퀴즈 데이터 세트
  const mathOxData = [
    // ==========================================
    // 🟡 [초등부] (초3 ~ 초6 정예 문항 - 용어 교정 및 '항상' 단어 제거)
    // ==========================================
    {
      id: 1,
      subject: "초3",
      topic: "도형",
      prompt: "각의 두 변의 길이를 길게 그리면 그 각의 크기도 커진다.",
      answer: "X",
    ...
    },
    {
      ...
      subject: "초4",
      topic: "도형",
      prompt: "모든 정사각형은 직사각형이라고 부를 수 있다.",
      answer: "O",
    ...
    },
    {
      ...
      reason: "분모와 분자에 같은 수를 곱하여 만든 분수는 크기가 같은 크기가 같은 분수입니다 (예: $1/2 = 2/4 = 3/6$)."
    },
    {
      id: 10,
      subject: "초5",
    ...
    },
    {
      ...
      subject: "중3",
      topic: "인수분해",
      prompt: "모든 이차식 $ax^2 + bx + c$ 는 실수 범위에서 두 일차식의 곱으로 인수분해할 수 있다.",
      answer: "X",
    ...
    },
    {
      ...
      subject: "중3",
      topic: "삼각비",
      prompt: "모든 예각 $A$에 대하여 삼각비 $\\tan A$의 값은 1보다 작다.",
      answer: "X",
    ...
    },
    {
      ...
      answer: "X",
      pitfall: "한 직선에 평행한 두 평면이 교선을 가지며 만날 가능성을 잊기 쉽습니만.",
