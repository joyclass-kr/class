(function () {
  ...
  // 각의 두 변을 반직선 ㄴㄱ, 반직선 ㄴㄷ으로 명확히 표기한 수학 OX 데이터 세트
  const mathOxData = [
    // ==========================================
    // 🟡 [초등 3학년] (10문항)
    // ==========================================
    ...
    },
    {
      ...
      subject: "초3",
      topic: "각의 정의",
      prompt: "각 $\\text{ㄱㄴㄷ}$을 이루는 두 변은 반직선 $\\text{ㄴㄱ}$과 반직선 $\\text{ㄴㄷ}$이다.",
      answer: "O",
      pitfall: "각을 이루는 두 변이 꼭짓점 ㄴ에서 시작하는 반직선임을 확인하는 기본 정의 성질입니다.",
      reason: "수학에서 각 $\\text{ㄱㄴㄷ}$을 이루는 두 변은 꼭짓점 $\\text{ㄴ}$에서 시작하여 점 $\\text{ㄱ}$과 점 $\\text{ㄷ}$ 방향으로 나아가는 **반직선 $\\text{ㄴㄱ}$과 반직선 $\\text{ㄴㄷ}$**입니다!"
    },
    {
      id: 7,
      subject: "초3",
    ...
    },
    {
      ...
      prompt: "각 $\\text{ㄱㄴㄷ}$을 이루는 두 변은 반직선 $\\text{ㄴㄱ}$과 반직선 $\\text{ㄴㄷ}$이다.",
      answer: "O",
      pitfall: "각을 만드는 두 변이 꼭짓점 ㄴ에서 시작하는 반직선임을 확인하는 명제입니다.",
      reason: "수학에서 각 $\\text{ㄱㄴㄷ}$을 이루는 두 변은 꼭짓점 $\\text{ㄴ}$에서 시작하여 점 $\\text{ㄱ}$과 점 $\\text{ㄷ}$ 방향으로 나아가는 **반직선 $\\text{ㄴㄱ}$과 반직선 $\\text{ㄴㄷ}$**으로 정의됩니다!"
    },
    {
      id: 133,
      subject: "초4",
