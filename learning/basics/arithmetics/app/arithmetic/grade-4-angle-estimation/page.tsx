...
export default function GradeFourAngleEstimationPage() {
  ...
  function renderSheet(answerSheet: boolean) {
    return (
      <div className="a4-sheet counting-sheet mental-math-sheet angle-estimation-sheet" style={{ transform: `scale(${sheetScale})` }}>
        <header className="counting-sheet-header">
          <div className="counting-sheet-title"><span>4학년</span><strong>각도의 어림{answerSheet ? " 정답" : ""}</strong></div>
