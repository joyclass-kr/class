...
export default function GradeSixDecimalTwoPage() {
  ...
  function renderSheet(answerSheet: boolean) {
    return (
      <div className="a4-sheet counting-sheet mental-math-sheet grade-six-decimal-two-sheet" style={{ transform: `scale(${sheetScale})` }}>
        <header className="counting-sheet-header">
          <div className="counting-sheet-title"><span>6학년</span><strong>소수의 곱셈·나눗셈{answerSheet ? " 정답" : ""}</strong></div>
