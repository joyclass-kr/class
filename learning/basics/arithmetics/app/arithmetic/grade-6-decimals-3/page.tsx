...
export default function GradeSixDecimalThreePage() {
  ...
  function renderSheet(answerSheet: boolean) {
    return (
      <div className="a4-sheet counting-sheet mental-math-sheet grade-six-decimal-two-sheet grade-six-decimal-three-sheet" style={{ transform: `scale(${sheetScale})` }}>
        <header className="counting-sheet-header">
          <div className="counting-sheet-title"><span>6학년</span><strong>소수의 나눗셈과 반올림{answerSheet ? " 정답" : ""}</strong></div>
