...
export default function GradeSixFractionPage() {
  ...
  function renderSheet(answerSheet: boolean) {
    return (
      <div className="a4-sheet counting-sheet mental-math-sheet grade-five-fraction-one-sheet grade-six-fraction-sheet" style={{ transform: `scale(${sheetScale})` }}>
        <header className="counting-sheet-header">
          <div className="counting-sheet-title"><span>6학년</span><strong>분수의 곱셈·나눗셈{answerSheet ? " 정답" : ""}</strong></div>
