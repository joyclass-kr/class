...
export const middleSchoolWorksheetCatalog: ArithmeticWorksheet[] = [
  ...
  { grade: "중3", name: "이차함수의 식과 꼭짓점", title: "이차함수의 식과 꼭짓점", route: "/arithmetic/middle-school/quadratic-functions?kind=values-and-forms" },
  { grade: "중3", name: "이차함수: 꼭짓점과 대칭축", title: "이차함수: 꼭짓점과 대칭축", route: "/arithmetic/middle-school/quadratic-functions?kind=vertex-and-axis" },
  { grade: "중3", name: "이차함수: 조건으로 식 구하기", title: "이차함수: 조건으로 식 구하기", route: "/arithmetic/middle-school/quadratic-functions?kind=determine-equation" },
  { grade: "중3", name: "이차함수: 절편과 교점", title: "이차함수: 절편과 교점", route: "/arithmetic/middle-school/quadratic-functions?kind=intercepts-and-intersections" },
