...
export const middleSchoolWorksheetCatalog: ArithmeticWorksheet[] = [
  ...
  { grade: "중1", name: "일차방정식 활용 계산", title: "일차방정식 활용 계산", route: null },

  { grade: "중2", name: "유리수와 순환소수", title: "유리수와 순환소수", route: null },
  { grade: "중2", name: "지수법칙", title: "지수법칙", route: null },
  { grade: "중2", name: "단항식의 곱셈", title: "단항식의 곱셈", route: null },
  { grade: "중2", name: "단항식의 나눗셈", title: "단항식의 나눗셈", route: null },
  { grade: "중2", name: "다항식의 덧셈·뺄셈", title: "다항식의 덧셈·뺄셈", route: null },
  { grade: "중2", name: "일차부등식", title: "일차부등식", route: null },
  { grade: "중2", name: "연립일차방정식 대입법", title: "연립일차방정식 대입법", route: null },
  { grade: "중2", name: "연립일차방정식 가감법", title: "연립일차방정식 가감법", route: null },
  ...
  { grade: "중3", name: "곱셈공식: 완전제곱식", title: "곱셈공식: 완전제곱식", route: null },
  { grade: "중3", name: "곱셈공식: 합과 차", title: "곱셈공식: 합과 차", route: null },
  { grade: "중3", name: "곱셈공식 종합", title: "곱셈공식 종합", route: null },
