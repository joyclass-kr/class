...
export const middleSchoolWorksheetCatalog: ArithmeticWorksheet[] = [
  ...
  { grade: "중2", name: "단항식의 곱셈", title: "단항식의 곱셈", route: "/arithmetic/middle-school/core-calculations?kind=monomial-multiply" },
  { grade: "중2", name: "단항식의 나눗셈", title: "단항식의 나눗셈", route: "/arithmetic/middle-school/core-calculations?kind=monomial-divide" },
  ...
  { grade: "중2", name: "연립일차방정식 대입법", title: "연립일차방정식 대입법", route: "/arithmetic/middle-school/core-calculations?kind=simultaneous-substitution" },
  { grade: "중2", name: "연립일차방정식 가감법", title: "연립일차방정식 가감법", route: "/arithmetic/middle-school/core-calculations?kind=simultaneous-elimination" },
  ...
  { grade: "중3", name: "다항식의 곱셈", title: "다항식의 곱셈", route: "/arithmetic/middle-school/core-calculations?kind=polynomial-multiply" },
  { grade: "중3", name: "곱셈공식: 완전제곱식", title: "곱셈공식: 완전제곱식", route: "/arithmetic/middle-school/core-calculations?kind=formula-square" },
  { grade: "중3", name: "곱셈공식: 합과 차", title: "곱셈공식: 합과 차", route: "/arithmetic/middle-school/core-calculations?kind=formula-sum-difference" },
  { grade: "중3", name: "곱셈공식 종합", title: "곱셈공식 종합", route: "/arithmetic/middle-school/core-calculations?kind=formula-comprehensive" },
  ...
  { grade: "중3", name: "인수분해: x²+(a+b)x+ab", title: "인수분해: x²+(a+b)x+ab", route: "/arithmetic/middle-school/factorization?kind=monic-trinomial" },
  { grade: "중3", name: "인수분해: ax²+bx+c", title: "인수분해: ax²+bx+c", route: "/arithmetic/middle-school/factorization?kind=nonmonic-trinomial" },
  ...
  { grade: "중3", name: "이차함수: 함숫값과 식의 전개", title: "이차함수: 함숫값과 식의 전개", route: "/arithmetic/middle-school/quadratic-functions?kind=values-and-forms" },
  ...
  { grade: "중3", name: "삼각비: 세 변과 삼각비", title: "삼각비: 세 변과 삼각비", route: "/arithmetic/middle-school/trigonometry?kind=ratios" },
  ...
  { grade: "중3", name: "원의 성질: 중심각·원주각·호", title: "원의 성질: 중심각·원주각·호", route: "/arithmetic/middle-school/circle-properties?kind=inscribed-angles" },
  ...
  { grade: "중3", name: "통계: 대푯값 계산", title: "통계: 대푯값 계산", route: "/arithmetic/middle-school/statistics?kind=representative-values" },
